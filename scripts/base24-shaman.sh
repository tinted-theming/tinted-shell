...
color00="00/10/14" # Base 00 - Black
...
if [ -n "$TINTED_SHELL_ENABLE_BASE24_VARS" ]; then
  export BASE24_COLOR_00_HEX="001014"
  export BASE24_COLOR_01_HEX="012026"
  ...
  export BASE24_COLOR_09_HEX="5d8aa9"
