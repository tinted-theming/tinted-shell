...
color08="00/55/00" # Base 03 - Bright Black
...
if [ -n "$TINTED_SHELL_ENABLE_BASE16_VARS" ] || [ -n "$BASE16_SHELL_ENABLE_VARS" ]; then
  export BASE16_COLOR_00_HEX="001100"
  export BASE16_COLOR_01_HEX="003300"
  export BASE16_COLOR_02_HEX="005500"
  export BASE16_COLOR_03_HEX="007700"
  export BASE16_COLOR_04_HEX="009900"
  export BASE16_COLOR_05_HEX="00bb00"
  export BASE16_COLOR_06_HEX="00dd00"
  export BASE16_COLOR_07_HEX="00ff00"
  export BASE16_COLOR_08_HEX="007700"
  export BASE16_COLOR_09_HEX="009900"
  export BASE16_COLOR_0A_HEX="007700"
  export BASE16_COLOR_0B_HEX="00bb00"
  export BASE16_COLOR_0C_HEX="005500"
  export BASE16_COLOR_0D_HEX="009900"
  export BASE16_COLOR_0E_HEX="00bb00"
  export BASE16_COLOR_0F_HEX="005500"
fi
