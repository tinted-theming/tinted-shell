...
if [ -n "$BASE16_SHELL_ENABLE_VARS" ]; then
  export BASE16_COLOR_00_HEX="002b36"
  export BASE16_COLOR_01_HEX="073642"
  export BASE16_COLOR_02_HEX="586e75"
  export BASE16_COLOR_03_HEX="657b83"
  export BASE16_COLOR_04_HEX="839496"
  export BASE16_COLOR_05_HEX="93a1a1"
  export BASE16_COLOR_06_HEX="eee8d5"
