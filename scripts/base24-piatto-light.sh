...
color03="3c/5e/a8" # Base 0A - Yellow
...
color14="82/94/29" # Base 15 - Bright Cyan
color15="f2/f2/f2" # Base 07 - Bright White
color16="cd/6f/34" # Base 09
color17="59/1b/38" # Base 0F
color18="41/41/41" # Base 01
color19="3f/3f/3f" # Base 02
color20="9f/9f/9f" # Base 04
color21="ff/ff/ff" # Base 06
color_foreground="cf/cf/cf" # Base 05
...
if [ -n "$ITERM_SESSION_ID" ]; then
  ...
  put_template_custom Pg cfcfcf # foreground
  put_template_custom Ph ffffff # background
  put_template_custom Pi cfcfcf # bold color
  put_template_custom Pj 3f3f3f # selection color
  put_template_custom Pk cfcfcf # selected text color
  put_template_custom Pl cfcfcf # cursor
...
if [ -n "$TINTED_SHELL_ENABLE_BASE24_VARS" ]; then
  ...
  export BASE24_COLOR_01_HEX="414141"
  export BASE24_COLOR_02_HEX="3f3f3f"
  export BASE24_COLOR_03_HEX="6f6f6f"
  export BASE24_COLOR_04_HEX="9f9f9f"
  export BASE24_COLOR_05_HEX="cfcfcf"
  ...
  export BASE24_COLOR_0A_HEX="3c5ea8"
  export BASE24_COLOR_0B_HEX="66781e"
  export BASE24_COLOR_0C_HEX="66781e"
  ...
  export BASE24_COLOR_15_HEX="829429"
