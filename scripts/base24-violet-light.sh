...
export BASE24_THEME="violet-light"

color00="fc/f4/dc" # Base 00 - Black
...
color07="af/ae/a9" # Base 05 - White
color08="68/6a/6a" # Base 03 - Bright Black
...
color20="8c/8c/8a" # Base 04
color21="d3/d0/c9" # Base 06
color_foreground="af/ae/a9" # Base 05
color_background="fc/f4/dc" # Base 00
...
if [ -n "$TINTED_SHELL_ENABLE_BASE24_VARS" ]; then
  export BASE24_COLOR_00_HEX="fcf4dc"
  export BASE24_COLOR_01_HEX="56595c"
  export BASE24_COLOR_02_HEX="45484b"
  export BASE24_COLOR_03_HEX="686a6a"
  export BASE24_COLOR_04_HEX="8c8c8a"
  export BASE24_COLOR_05_HEX="afaea9"
  export BASE24_COLOR_06_HEX="d3d0c9"
