...
export BASE24_THEME="jackie-brown"

color00="2c/1c/15" # Base 00 - Black
color01="ef/57/34" # Base 08 - Red
color02="2b/af/2b" # Base 0B - Green
color03="00/00/ff" # Base 0A - Yellow
color04="24/6d/b2" # Base 0D - Blue
color05="cf/5e/c0" # Base 0E - Magenta
color06="00/ac/ee" # Base 0C - Cyan
color07="a8/a8/a8" # Base 05 - White
color08="7c/7c/7c" # Base 03 - Bright Black
color09="e5/00/00" # Base 12 - Bright Red
color10="86/a8/3e" # Base 14 - Bright Green
...
color16="bd/be/00" # Base 09
color17="77/2b/1a" # Base 0F
color18="2c/1d/16" # Base 01
color19="66/66/66" # Base 02
color20="92/92/92" # Base 04
color21="bf/bf/bf" # Base 06
color_foreground="a8/a8/a8" # Base 05
color_background="2c/1c/15" # Base 00
...
if [ -n "$TINTED_SHELL_ENABLE_BASE24_VARS" ]; then
  export BASE24_COLOR_00_HEX="2c1c15"
  export BASE24_COLOR_01_HEX="2c1d16"
  ...
  export BASE24_COLOR_08_HEX="ef5734"
  export BASE24_COLOR_09_HEX="bdbe00"
  export BASE24_COLOR_0A_HEX="0000ff"
  export BASE24_COLOR_0B_HEX="2baf2b"
  export BASE24_COLOR_0C_HEX="00acee"
  export BASE24_COLOR_0D_HEX="246db2"
  export BASE24_COLOR_0E_HEX="cf5ec0"
  export BASE24_COLOR_0F_HEX="772b1a"
  ...
  export BASE24_COLOR_14_HEX="86a83e"
