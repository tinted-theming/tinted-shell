...
color00="30/0a/24" # Base 00 - Black
color01="cc/00/00" # Base 08 - Red
color02="4e/9a/06" # Base 0B - Green
color03="72/9f/cf" # Base 0A - Yellow
...
color12="72/9f/cf" # Base 16 - Bright Blue
...
color18="2e/34/36" # Base 01
color19="55/57/53" # Base 02
color20="94/97/91" # Base 04
...
if [ -n "$TINTED_SHELL_ENABLE_BASE24_VARS" ]; then
  export BASE24_COLOR_00_HEX="300a24"
  export BASE24_COLOR_01_HEX="2e3436"
  export BASE24_COLOR_02_HEX="555753"
  export BASE24_COLOR_03_HEX="747772"
  export BASE24_COLOR_04_HEX="949791"
  export BASE24_COLOR_05_HEX="b3b7b0"
  export BASE24_COLOR_06_HEX="d3d7cf"
  export BASE24_COLOR_07_HEX="eeeeec"
  export BASE24_COLOR_08_HEX="cc0000"
  export BASE24_COLOR_09_HEX="c4a000"
  export BASE24_COLOR_0A_HEX="729fcf"
  export BASE24_COLOR_0B_HEX="4e9a06"
  export BASE24_COLOR_0C_HEX="06989a"
  export BASE24_COLOR_0D_HEX="3465a4"
  ...
  export BASE24_COLOR_12_HEX="ef2929"
  export BASE24_COLOR_13_HEX="fce94f"
  export BASE24_COLOR_14_HEX="8ae234"
  export BASE24_COLOR_15_HEX="34e2e2"
  export BASE24_COLOR_16_HEX="729fcf"
