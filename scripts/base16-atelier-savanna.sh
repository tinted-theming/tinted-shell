...
if [ -n "$TINTED_SHELL_ENABLE_BASE16_VARS" ] || [ -n "$BASE16_SHELL_ENABLE_VARS" ]; then
  export BASE16_COLOR_00_HEX="171c19"
  export BASE16_COLOR_01_HEX="232a25"
  export BASE16_COLOR_02_HEX="526057"
  export BASE16_COLOR_03_HEX="5f6d64"
  export BASE16_COLOR_04_HEX="78877d"
  export BASE16_COLOR_05_HEX="87928a"
  export BASE16_COLOR_06_HEX="dfe7e2"
  export BASE16_COLOR_07_HEX="ecf4ee"
