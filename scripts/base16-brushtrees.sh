...
if [ -n "$BASE16_SHELL_ENABLE_VARS" ]; then
  export BASE16_COLOR_00_HEX="e3efef"
  export BASE16_COLOR_01_HEX="c9dbdc"
  export BASE16_COLOR_02_HEX="b0c5c8"
  export BASE16_COLOR_03_HEX="98afb5"
  export BASE16_COLOR_04_HEX="8299a1"
  export BASE16_COLOR_05_HEX="6d828e"
  export BASE16_COLOR_06_HEX="5a6d7a"
  export BASE16_COLOR_07_HEX="485867"
