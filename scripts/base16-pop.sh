...
if [ -n "$BASE16_SHELL_ENABLE_VARS" ]; then
  ...
  export BASE16_COLOR_08_HEX="eb008a"
  export BASE16_COLOR_09_HEX="f29333"
  export BASE16_COLOR_0A_HEX="f8ca12"
  export BASE16_COLOR_0B_HEX="37b349"
  export BASE16_COLOR_0C_HEX="00aabb"
  export BASE16_COLOR_0D_HEX="0e5a94"
  export BASE16_COLOR_0E_HEX="b31e8d"
  export BASE16_COLOR_0F_HEX="7a2d00"
fi
