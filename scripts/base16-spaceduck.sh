...
if [ -n "$TINTED_SHELL_ENABLE_BASE16_VARS" ] || [ -n "$BASE16_SHELL_ENABLE_VARS" ]; then
  export BASE16_COLOR_00_HEX="16172d"
  export BASE16_COLOR_01_HEX="1b1c36"
  export BASE16_COLOR_02_HEX="30365f"
  export BASE16_COLOR_03_HEX="686f9a"
  export BASE16_COLOR_04_HEX="818596"
  export BASE16_COLOR_05_HEX="ecf0c1"
  export BASE16_COLOR_06_HEX="c1c3cc"
  export BASE16_COLOR_07_HEX="ffffff"
  export BASE16_COLOR_08_HEX="e33400"
  export BASE16_COLOR_09_HEX="e39400"
  export BASE16_COLOR_0A_HEX="f2ce00"
  export BASE16_COLOR_0B_HEX="5ccc96"
  export BASE16_COLOR_0C_HEX="00a3cc"
  export BASE16_COLOR_0D_HEX="7a5ccc"
  export BASE16_COLOR_0E_HEX="b3a1e6"
  export BASE16_COLOR_0F_HEX="ce6f8f"
fi
