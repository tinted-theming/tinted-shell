...
if [ -n "$BASE16_SHELL_ENABLE_VARS" ]; then
  export BASE16_COLOR_00_HEX="20201d"
  export BASE16_COLOR_01_HEX="292824"
  export BASE16_COLOR_02_HEX="6e6b5e"
  export BASE16_COLOR_03_HEX="7d7a68"
  export BASE16_COLOR_04_HEX="999580"
  export BASE16_COLOR_05_HEX="a6a28c"
  export BASE16_COLOR_06_HEX="e8e4cf"
  export BASE16_COLOR_07_HEX="fefbec"
