...
color08="31/45/49" # Base 03 - Bright Black
...
if [ -n "$TINTED_SHELL_ENABLE_BASE16_VARS" ] || [ -n "$BASE16_SHELL_ENABLE_VARS" ]; then
  ...
  export BASE16_COLOR_01_HEX="2e3c43"
  export BASE16_COLOR_02_HEX="314549"
  export BASE16_COLOR_03_HEX="546e7a"
  export BASE16_COLOR_04_HEX="b2ccd6"
  export BASE16_COLOR_05_HEX="eeffff"
  export BASE16_COLOR_06_HEX="eeffff"
