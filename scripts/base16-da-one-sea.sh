...
color00="22/27/3d" # Base 00 - Black
...
if [ -n "$BASE16_SHELL_ENABLE_VARS" ]; then
  export BASE16_COLOR_00_HEX="22273d"
  export BASE16_COLOR_01_HEX="374059"
