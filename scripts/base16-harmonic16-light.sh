...
if [ -n "$BASE16_SHELL_ENABLE_VARS" ]; then
  export BASE16_COLOR_00_HEX="f7f9fb"
  export BASE16_COLOR_01_HEX="e5ebf1"
  export BASE16_COLOR_02_HEX="cbd6e2"
  export BASE16_COLOR_03_HEX="aabcce"
  export BASE16_COLOR_04_HEX="627e99"
  export BASE16_COLOR_05_HEX="405c79"
  export BASE16_COLOR_06_HEX="223b54"
  export BASE16_COLOR_07_HEX="0b1c2c"
