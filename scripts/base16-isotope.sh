...
if [ -n "$BASE16_SHELL_ENABLE_VARS" ]; then
  ...
  export BASE16_COLOR_04_HEX="c0c0c0"
  ...
  export BASE16_COLOR_09_HEX="ff9900"
  export BASE16_COLOR_0A_HEX="ff0099"
  export BASE16_COLOR_0B_HEX="33ff00"
  export BASE16_COLOR_0C_HEX="00ffff"
  export BASE16_COLOR_0D_HEX="0066ff"
  export BASE16_COLOR_0E_HEX="cc00ff"
  export BASE16_COLOR_0F_HEX="3300ff"
fi
