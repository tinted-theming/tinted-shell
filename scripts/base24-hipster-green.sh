...
export BASE24_THEME="hipster-green"

color00="0f/0a/05" # Base 00 - Black
color01="b6/20/4a" # Base 08 - Red
...
color16="be/be/00" # Base 09
color17="5b/10/25" # Base 0F
...
color_background="0f/0a/05" # Base 00
...
if [ -n "$TINTED_SHELL_ENABLE_BASE24_VARS" ]; then
  export BASE24_COLOR_00_HEX="0f0a05"
  ...
  export BASE24_COLOR_08_HEX="b6204a"
  export BASE24_COLOR_09_HEX="bebe00"
  ...
  export BASE24_COLOR_0F_HEX="5b1025"
