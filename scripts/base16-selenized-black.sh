...
if [ -n "$TINTED_SHELL_ENABLE_BASE16_VARS" ] || [ -n "$BASE16_SHELL_ENABLE_VARS" ]; then
  ...
  export BASE16_COLOR_02_HEX="3b3b3b"
  export BASE16_COLOR_03_HEX="777777"
  export BASE16_COLOR_04_HEX="777777"
  export BASE16_COLOR_05_HEX="b9b9b9"
  export BASE16_COLOR_06_HEX="dedede"
  export BASE16_COLOR_07_HEX="dedede"
  export BASE16_COLOR_08_HEX="ed4a46"
  export BASE16_COLOR_09_HEX="e67f43"
  export BASE16_COLOR_0A_HEX="dbb32d"
  export BASE16_COLOR_0B_HEX="70b433"
  export BASE16_COLOR_0C_HEX="3fc5b7"
  export BASE16_COLOR_0D_HEX="368aeb"
  export BASE16_COLOR_0E_HEX="a580e2"
  export BASE16_COLOR_0F_HEX="eb6eb7"
fi
