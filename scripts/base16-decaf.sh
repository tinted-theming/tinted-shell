...
if [ -n "$TINTED_SHELL_ENABLE_BASE16_VARS" ] || [ -n "$BASE16_SHELL_ENABLE_VARS" ]; then
  ...
  export BASE16_COLOR_08_HEX="ff7f7b"
  export BASE16_COLOR_09_HEX="ffbf70"
  export BASE16_COLOR_0A_HEX="ffd67c"
  export BASE16_COLOR_0B_HEX="beda78"
  export BASE16_COLOR_0C_HEX="bed6ff"
  export BASE16_COLOR_0D_HEX="90bee1"
  export BASE16_COLOR_0E_HEX="efb3f7"
  export BASE16_COLOR_0F_HEX="ff93b3"
fi
