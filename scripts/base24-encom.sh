...
color01="9f/00/00" # Base 08 - Red
color02="00/8b/00" # Base 0B - Green
...
color14="00/cd/cd" # Base 15 - Bright Cyan
color15="ff/ff/ff" # Base 07 - Bright White
color16="ff/cf/00" # Base 09
color17="4f/00/00" # Base 0F
...
if [ -n "$TINTED_SHELL_ENABLE_BASE24_VARS" ]; then
  ...
  export BASE24_COLOR_08_HEX="9f0000"
  export BASE24_COLOR_09_HEX="ffcf00"
  export BASE24_COLOR_0A_HEX="0000ff"
  export BASE24_COLOR_0B_HEX="008b00"
  export BASE24_COLOR_0C_HEX="008b8b"
  export BASE24_COLOR_0D_HEX="0081ff"
  export BASE24_COLOR_0E_HEX="bc00ca"
  export BASE24_COLOR_0F_HEX="4f0000"
  ...
  export BASE24_COLOR_14_HEX="00ee00"
  export BASE24_COLOR_15_HEX="00cdcd"
