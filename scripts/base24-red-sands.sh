...
export BASE24_THEME="red-sands"

color00="79/24/1e" # Base 00 - Black
color01="ff/3f/00" # Base 08 - Red
color02="00/bb/00" # Base 0B - Green
color03="00/71/ae" # Base 0A - Yellow
color04="00/71/ff" # Base 0D - Blue
...
color09="bb/00/00" # Base 12 - Bright Red
color10="00/bb/00" # Base 14 - Bright Green
color11="e7/b0/00" # Base 13 - Bright Yellow
color12="00/71/ae" # Base 16 - Bright Blue
color13="ff/55/ff" # Base 17 - Bright Magenta
color14="55/ff/ff" # Base 15 - Bright Cyan
color15="ff/ff/ff" # Base 07 - Bright White
color16="e7/b0/00" # Base 09
color17="7f/1f/00" # Base 0F
...
color_background="79/24/1e" # Base 00
...
if [ -n "$TINTED_SHELL_ENABLE_BASE24_VARS" ]; then
  export BASE24_COLOR_00_HEX="79241e"
  ...
  export BASE24_COLOR_08_HEX="ff3f00"
  export BASE24_COLOR_09_HEX="e7b000"
  export BASE24_COLOR_0A_HEX="0071ae"
  export BASE24_COLOR_0B_HEX="00bb00"
  export BASE24_COLOR_0C_HEX="00bbbb"
  export BASE24_COLOR_0D_HEX="0071ff"
  export BASE24_COLOR_0E_HEX="bb00bb"
  export BASE24_COLOR_0F_HEX="7f1f00"
  export BASE24_COLOR_10_HEX="383838"
  export BASE24_COLOR_11_HEX="1c1c1c"
  export BASE24_COLOR_12_HEX="bb0000"
  export BASE24_COLOR_13_HEX="e7b000"
  export BASE24_COLOR_14_HEX="00bb00"
  export BASE24_COLOR_15_HEX="55ffff"
  export BASE24_COLOR_16_HEX="0071ae"
