...
export BASE24_THEME="mathias"

color00="00/00/00" # Base 00 - Black
color01="e5/22/22" # Base 08 - Red
color02="a6/e3/2d" # Base 0B - Green
color03="55/55/ff" # Base 0A - Yellow
color04="c4/8d/ff" # Base 0D - Blue
color05="fa/25/73" # Base 0E - Magenta
color06="67/d9/f0" # Base 0C - Cyan
...
color16="fc/95/1e" # Base 09
color17="72/11/11" # Base 0F
color18="00/00/00" # Base 01
color19="55/55/55" # Base 02
color20="a3/a3/a3" # Base 04
...
if [ -n "$TINTED_SHELL_ENABLE_BASE24_VARS" ]; then
  ...
  export BASE24_COLOR_04_HEX="a3a3a3"
  export BASE24_COLOR_05_HEX="cacaca"
  export BASE24_COLOR_06_HEX="f2f2f2"
  export BASE24_COLOR_07_HEX="ffffff"
  export BASE24_COLOR_08_HEX="e52222"
  export BASE24_COLOR_09_HEX="fc951e"
  export BASE24_COLOR_0A_HEX="5555ff"
  export BASE24_COLOR_0B_HEX="a6e32d"
  export BASE24_COLOR_0C_HEX="67d9f0"
  export BASE24_COLOR_0D_HEX="c48dff"
  export BASE24_COLOR_0E_HEX="fa2573"
  export BASE24_COLOR_0F_HEX="721111"
