...
color00="2a/21/1c" # Base 00 - Black
color01="cc/00/00" # Base 08 - Red
color02="1a/92/1c" # Base 0B - Green
color03="43/a8/ed" # Base 0A - Yellow
...
color12="43/a8/ed" # Base 16 - Bright Blue
color13="ff/80/89" # Base 17 - Bright Magenta
color14="34/e2/e2" # Base 15 - Bright Cyan
color15="ed/ed/ec" # Base 07 - Bright White
color16="ef/e4/3a" # Base 09
...
color_background="2a/21/1c" # Base 00
...
if [ -n "$TINTED_SHELL_ENABLE_BASE24_VARS" ]; then
  export BASE24_COLOR_00_HEX="2a211c"
  ...
  export BASE24_COLOR_09_HEX="efe43a"
  export BASE24_COLOR_0A_HEX="43a8ed"
  export BASE24_COLOR_0B_HEX="1a921c"
  export BASE24_COLOR_0C_HEX="05989a"
  export BASE24_COLOR_0D_HEX="0066ff"
  export BASE24_COLOR_0E_HEX="c5656b"
  ...
  export BASE24_COLOR_13_HEX="fffa5c"
  export BASE24_COLOR_14_HEX="9aff87"
  export BASE24_COLOR_15_HEX="34e2e2"
  export BASE24_COLOR_16_HEX="43a8ed"
  export BASE24_COLOR_17_HEX="ff8089"
fi
