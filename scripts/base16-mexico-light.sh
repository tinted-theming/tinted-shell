...
export BASE16_THEME=mexico-light
...
if [ -n "$BASE16_SHELL_ENABLE_VARS" ]; then
  ...
  export BASE16_COLOR_0A_HEX="f79a0e"
  export BASE16_COLOR_0B_HEX="538947"
  export BASE16_COLOR_0C_HEX="4b8093"
  export BASE16_COLOR_0D_HEX="7cafc2"
  export BASE16_COLOR_0E_HEX="96609e"
