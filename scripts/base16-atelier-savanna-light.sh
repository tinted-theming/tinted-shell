...
if [ -n "$BASE16_SHELL_ENABLE_VARS" ]; then
  export BASE16_COLOR_00_HEX="ecf4ee"
  export BASE16_COLOR_01_HEX="dfe7e2"
  export BASE16_COLOR_02_HEX="87928a"
  export BASE16_COLOR_03_HEX="78877d"
  export BASE16_COLOR_04_HEX="5f6d64"
  export BASE16_COLOR_05_HEX="526057"
  export BASE16_COLOR_06_HEX="232a25"
  export BASE16_COLOR_07_HEX="171c19"
  export BASE16_COLOR_08_HEX="b16139"
  export BASE16_COLOR_09_HEX="9f713c"
  export BASE16_COLOR_0A_HEX="a07e3b"
  export BASE16_COLOR_0B_HEX="489963"
  export BASE16_COLOR_0C_HEX="1c9aa0"
  export BASE16_COLOR_0D_HEX="478c90"
  export BASE16_COLOR_0E_HEX="55859b"
  export BASE16_COLOR_0F_HEX="867469"
fi
