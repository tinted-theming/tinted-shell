...
color08="55/5d/55" # Base 03 - Bright Black
...
if [ -n "$TINTED_SHELL_ENABLE_BASE16_VARS" ] || [ -n "$BASE16_SHELL_ENABLE_VARS" ]; then
  ...
  export BASE16_COLOR_01_HEX="313131"
  export BASE16_COLOR_02_HEX="555d55"
  export BASE16_COLOR_03_HEX="644646"
  export BASE16_COLOR_04_HEX="5a5a5a"
  export BASE16_COLOR_05_HEX="dedee7"
  export BASE16_COLOR_06_HEX="c3c3b4"
  export BASE16_COLOR_07_HEX="ffffe6"
  export BASE16_COLOR_08_HEX="c88c8c"
  export BASE16_COLOR_09_HEX="476c88"
  export BASE16_COLOR_0A_HEX="d8b56d"
  export BASE16_COLOR_0B_HEX="99c899"
  export BASE16_COLOR_0C_HEX="78b4b4"
  export BASE16_COLOR_0D_HEX="537c9c"
  export BASE16_COLOR_0E_HEX="86cacd"
  export BASE16_COLOR_0F_HEX="704f4f"
fi
