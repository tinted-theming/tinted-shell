...
if [ -n "$TINTED_SHELL_ENABLE_BASE16_VARS" ] || [ -n "$BASE16_SHELL_ENABLE_VARS" ]; then
  export BASE16_COLOR_00_HEX="23262b"
  export BASE16_COLOR_01_HEX="303337"
  export BASE16_COLOR_02_HEX="3e4044"
  export BASE16_COLOR_03_HEX="898989"
  export BASE16_COLOR_04_HEX="abaaa8"
  export BASE16_COLOR_05_HEX="bab9b6"
  export BASE16_COLOR_06_HEX="bab9b6"
  export BASE16_COLOR_07_HEX="bab9b6"
  export BASE16_COLOR_08_HEX="ff8782"
  export BASE16_COLOR_09_HEX="e99857"
  export BASE16_COLOR_0A_HEX="cfa546"
  export BASE16_COLOR_0B_HEX="95b659"
  export BASE16_COLOR_0C_HEX="42bda7"
  export BASE16_COLOR_0D_HEX="66b0ef"
  export BASE16_COLOR_0E_HEX="b799ff"
