...
if [ -n "$BASE16_SHELL_ENABLE_VARS" ]; then
  export BASE16_COLOR_00_HEX="f7f7f7"
  export BASE16_COLOR_01_HEX="e3e3e3"
  export BASE16_COLOR_02_HEX="b9b9b9"
  export BASE16_COLOR_03_HEX="ababab"
  export BASE16_COLOR_04_HEX="525252"
  export BASE16_COLOR_05_HEX="464646"
  export BASE16_COLOR_06_HEX="252525"
  export BASE16_COLOR_07_HEX="101010"
