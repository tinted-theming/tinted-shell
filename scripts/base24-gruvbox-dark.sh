...
if [ -n "$TINTED_SHELL_ENABLE_BASE24_VARS" ]; then
  ...
  export BASE24_COLOR_05_HEX="ebdbb2"
  export BASE24_COLOR_06_HEX="fbf1c7"
  export BASE24_COLOR_07_HEX="f9f5d7"
  ...
  export BASE24_COLOR_10_HEX="2a2520"
  export BASE24_COLOR_11_HEX="1d1d1d"
