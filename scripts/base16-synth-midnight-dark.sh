...
if [ -n "$TINTED_SHELL_ENABLE_BASE16_VARS" ] || [ -n "$BASE16_SHELL_ENABLE_VARS" ]; then
  export BASE16_COLOR_00_HEX="050608"
  export BASE16_COLOR_01_HEX="1a1b1c"
  export BASE16_COLOR_02_HEX="28292a"
  export BASE16_COLOR_03_HEX="474849"
  export BASE16_COLOR_04_HEX="a3a5a6"
  export BASE16_COLOR_05_HEX="c1c3c4"
  export BASE16_COLOR_06_HEX="cfd1d2"
  export BASE16_COLOR_07_HEX="dddfe0"
  export BASE16_COLOR_08_HEX="b53b50"
  export BASE16_COLOR_09_HEX="ea770d"
  export BASE16_COLOR_0A_HEX="c9d364"
  export BASE16_COLOR_0B_HEX="06ea61"
  export BASE16_COLOR_0C_HEX="42fff9"
  export BASE16_COLOR_0D_HEX="03aeff"
  export BASE16_COLOR_0E_HEX="ea5ce2"
  export BASE16_COLOR_0F_HEX="cd6320"
fi
