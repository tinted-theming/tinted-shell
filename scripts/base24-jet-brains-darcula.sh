...
color01="fa/53/55" # Base 08 - Red
color02="12/6e/00" # Base 0B - Green
color03="6d/9d/f1" # Base 0A - Yellow
...
color12="6d/9d/f1" # Base 16 - Bright Blue
color13="fb/82/ff" # Base 17 - Bright Magenta
color14="60/d3/d1" # Base 15 - Bright Cyan
color15="ee/ee/ee" # Base 07 - Bright White
color16="c2/c3/00" # Base 09
color17="7d/29/2a" # Base 0F
color18="00/00/00" # Base 01
color19="55/55/55" # Base 02
color20="81/81/81" # Base 04
color21="ad/ad/ad" # Base 06
color_foreground="97/97/97" # Base 05
...
if [ -n "$TINTED_SHELL_ENABLE_BASE24_VARS" ]; then
  ...
  export BASE24_COLOR_03_HEX="6b6b6b"
  export BASE24_COLOR_04_HEX="818181"
  export BASE24_COLOR_05_HEX="979797"
  export BASE24_COLOR_06_HEX="adadad"
  export BASE24_COLOR_07_HEX="eeeeee"
  export BASE24_COLOR_08_HEX="fa5355"
  export BASE24_COLOR_09_HEX="c2c300"
  export BASE24_COLOR_0A_HEX="6d9df1"
  export BASE24_COLOR_0B_HEX="126e00"
  export BASE24_COLOR_0C_HEX="33c2c1"
  export BASE24_COLOR_0D_HEX="4581eb"
  export BASE24_COLOR_0E_HEX="fa54ff"
  export BASE24_COLOR_0F_HEX="7d292a"
  export BASE24_COLOR_10_HEX="383838"
  export BASE24_COLOR_11_HEX="1c1c1c"
  export BASE24_COLOR_12_HEX="fb7172"
  export BASE24_COLOR_13_HEX="ffff00"
  export BASE24_COLOR_14_HEX="67ff4f"
  export BASE24_COLOR_15_HEX="60d3d1"
  export BASE24_COLOR_16_HEX="6d9df1"
  export BASE24_COLOR_17_HEX="fb82ff"
fi
