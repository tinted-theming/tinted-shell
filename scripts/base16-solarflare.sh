...
color08="58/68/75" # Base 03 - Bright Black
...
if [ -n "$TINTED_SHELL_ENABLE_BASE16_VARS" ] || [ -n "$BASE16_SHELL_ENABLE_VARS" ]; then
  export BASE16_COLOR_00_HEX="18262f"
  export BASE16_COLOR_01_HEX="222e38"
  export BASE16_COLOR_02_HEX="586875"
  export BASE16_COLOR_03_HEX="667581"
  export BASE16_COLOR_04_HEX="85939e"
  export BASE16_COLOR_05_HEX="a6afb8"
  export BASE16_COLOR_06_HEX="e8e9ed"
  export BASE16_COLOR_07_HEX="f5f7fa"
