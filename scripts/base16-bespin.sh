...
if [ -n "$TINTED_SHELL_ENABLE_BASE16_VARS" ] || [ -n "$BASE16_SHELL_ENABLE_VARS" ]; then
  export BASE16_COLOR_00_HEX="28211c"
  export BASE16_COLOR_01_HEX="36312e"
  export BASE16_COLOR_02_HEX="5e5d5c"
  export BASE16_COLOR_03_HEX="666666"
  export BASE16_COLOR_04_HEX="797977"
  export BASE16_COLOR_05_HEX="8a8986"
  export BASE16_COLOR_06_HEX="9d9b97"
  export BASE16_COLOR_07_HEX="baae9e"
  export BASE16_COLOR_08_HEX="cf6a4c"
  export BASE16_COLOR_09_HEX="cf7d34"
  export BASE16_COLOR_0A_HEX="f9ee98"
  export BASE16_COLOR_0B_HEX="54be0d"
  export BASE16_COLOR_0C_HEX="afc4db"
  export BASE16_COLOR_0D_HEX="5ea6ea"
  export BASE16_COLOR_0E_HEX="9b859d"
  export BASE16_COLOR_0F_HEX="937121"
fi
