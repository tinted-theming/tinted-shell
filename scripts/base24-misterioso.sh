...
color00="2d/37/43" # Base 00 - Black
...
color07="be/be/bd" # Base 05 - White
...
color20="9b/9b/9a" # Base 04
color21="e1/e1/e0" # Base 06
color_foreground="be/be/bd" # Base 05
color_background="2d/37/43" # Base 00
...
if [ -n "$TINTED_SHELL_ENABLE_BASE24_VARS" ]; then
  export BASE24_COLOR_00_HEX="2d3743"
  export BASE24_COLOR_01_HEX="000000"
  export BASE24_COLOR_02_HEX="555555"
  export BASE24_COLOR_03_HEX="787877"
  export BASE24_COLOR_04_HEX="9b9b9a"
  export BASE24_COLOR_05_HEX="bebebd"
  export BASE24_COLOR_06_HEX="e1e1e0"
