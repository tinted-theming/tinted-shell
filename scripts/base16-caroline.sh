...
if [ -n "$BASE16_SHELL_ENABLE_VARS" ]; then
  export BASE16_COLOR_00_HEX="1c1213"
  export BASE16_COLOR_01_HEX="3a2425"
  export BASE16_COLOR_02_HEX="563837"
  export BASE16_COLOR_03_HEX="6d4745"
  export BASE16_COLOR_04_HEX="8b5d57"
  export BASE16_COLOR_05_HEX="a87569"
  export BASE16_COLOR_06_HEX="c58d7b"
  export BASE16_COLOR_07_HEX="e3a68c"
  export BASE16_COLOR_08_HEX="c24f57"
  export BASE16_COLOR_09_HEX="a63650"
  export BASE16_COLOR_0A_HEX="f28171"
  export BASE16_COLOR_0B_HEX="806c61"
  export BASE16_COLOR_0C_HEX="6b6566"
  export BASE16_COLOR_0D_HEX="684c59"
  export BASE16_COLOR_0E_HEX="a63650"
  export BASE16_COLOR_0F_HEX="893f45"
fi
