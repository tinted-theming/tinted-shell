...
if [ -n "$BASE16_SHELL_ENABLE_VARS" ]; then
  export BASE16_COLOR_00_HEX="2d2d2d"
  export BASE16_COLOR_01_HEX="393939"
  export BASE16_COLOR_02_HEX="515151"
  export BASE16_COLOR_03_HEX="747369"
  export BASE16_COLOR_04_HEX="a09f93"
  export BASE16_COLOR_05_HEX="d3d0c8"
  export BASE16_COLOR_06_HEX="e8e6df"
  export BASE16_COLOR_07_HEX="f2f0ec"
  export BASE16_COLOR_08_HEX="f2777a"
  export BASE16_COLOR_09_HEX="f99157"
  export BASE16_COLOR_0A_HEX="ffcc66"
  export BASE16_COLOR_0B_HEX="99cc99"
  export BASE16_COLOR_0C_HEX="66cccc"
  export BASE16_COLOR_0D_HEX="6699cc"
  export BASE16_COLOR_0E_HEX="cc99cc"
  export BASE16_COLOR_0F_HEX="d27b53"
fi
