...
if [ -n "$TINTED_SHELL_ENABLE_BASE16_VARS" ] || [ -n "$BASE16_SHELL_ENABLE_VARS" ]; then
  export BASE16_COLOR_00_HEX="181b1f"
  export BASE16_COLOR_01_HEX="24272b"
  export BASE16_COLOR_02_HEX="3e4044"
  export BASE16_COLOR_03_HEX="636363"
  export BASE16_COLOR_04_HEX="9e9e9e"
  export BASE16_COLOR_05_HEX="cecece"
  export BASE16_COLOR_06_HEX="fff7ed"
  export BASE16_COLOR_07_HEX="fffdfb"
  export BASE16_COLOR_08_HEX="df7f78"
  export BASE16_COLOR_09_HEX="ce9042"
  export BASE16_COLOR_0A_HEX="9ca748"
  export BASE16_COLOR_0B_HEX="50b584"
  export BASE16_COLOR_0C_HEX="00b3c2"
  export BASE16_COLOR_0D_HEX="61a3e6"
  export BASE16_COLOR_0E_HEX="a48fe1"
  export BASE16_COLOR_0F_HEX="d080b6"
fi
