...
if [ -n "$BASE16_SHELL_ENABLE_VARS" ]; then
  export BASE16_COLOR_00_HEX="232323"
  export BASE16_COLOR_01_HEX="1c1c1c"
  export BASE16_COLOR_02_HEX="4e4e4e"
  export BASE16_COLOR_03_HEX="c0c0c0"
  export BASE16_COLOR_04_HEX="e4e4e4"
  export BASE16_COLOR_05_HEX="dbdbdb"
  export BASE16_COLOR_06_HEX="e4e4e4"
  export BASE16_COLOR_07_HEX="1c1c1c"
