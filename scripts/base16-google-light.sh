...
if [ -n "$TINTED_SHELL_ENABLE_BASE16_VARS" ] || [ -n "$BASE16_SHELL_ENABLE_VARS" ]; then
  ...
  export BASE16_COLOR_02_HEX="c5c8c6"
  export BASE16_COLOR_03_HEX="b4b7b4"
  export BASE16_COLOR_04_HEX="969896"
  export BASE16_COLOR_05_HEX="373b41"
  export BASE16_COLOR_06_HEX="282a2e"
  export BASE16_COLOR_07_HEX="1d1f21"
  export BASE16_COLOR_08_HEX="cc342b"
  export BASE16_COLOR_09_HEX="f96a38"
  export BASE16_COLOR_0A_HEX="fba922"
  export BASE16_COLOR_0B_HEX="198844"
  export BASE16_COLOR_0C_HEX="3971ed"
  export BASE16_COLOR_0D_HEX="3971ed"
  export BASE16_COLOR_0E_HEX="a36ac7"
  export BASE16_COLOR_0F_HEX="3971ed"
fi
