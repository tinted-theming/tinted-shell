...
export BASE24_THEME="obsidian"

color00="27/30/32" # Base 00 - Black
color01="a5/00/01" # Base 08 - Red
color02="00/bb/00" # Base 0B - Green
color03="a0/d6/ff" # Base 0A - Yellow
color04="39/9b/da" # Base 0D - Blue
...
color09="ff/00/03" # Base 12 - Bright Red
color10="92/c7/63" # Base 14 - Bright Green
color11="fe/f7/73" # Base 13 - Bright Yellow
color12="a0/d6/ff" # Base 16 - Bright Blue
color13="ff/55/ff" # Base 17 - Bright Magenta
color14="55/ff/ff" # Base 15 - Bright Cyan
color15="ff/ff/ff" # Base 07 - Bright White
color16="fe/cc/22" # Base 09
color17="52/00/00" # Base 0F
...
color_background="27/30/32" # Base 00
...
if [ -n "$TINTED_SHELL_ENABLE_BASE24_VARS" ]; then
  export BASE24_COLOR_00_HEX="273032"
  ...
  export BASE24_COLOR_08_HEX="a50001"
  export BASE24_COLOR_09_HEX="fecc22"
  export BASE24_COLOR_0A_HEX="a0d6ff"
  export BASE24_COLOR_0B_HEX="00bb00"
  export BASE24_COLOR_0C_HEX="00bbbb"
  export BASE24_COLOR_0D_HEX="399bda"
  export BASE24_COLOR_0E_HEX="bb00bb"
  export BASE24_COLOR_0F_HEX="520000"
  export BASE24_COLOR_10_HEX="383838"
  export BASE24_COLOR_11_HEX="1c1c1c"
  export BASE24_COLOR_12_HEX="ff0003"
  export BASE24_COLOR_13_HEX="fef773"
  export BASE24_COLOR_14_HEX="92c763"
  export BASE24_COLOR_15_HEX="55ffff"
  export BASE24_COLOR_16_HEX="a0d6ff"
