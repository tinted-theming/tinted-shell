...
if [ -n "$BASE16_SHELL_ENABLE_VARS" ]; then
  ...
  export BASE16_COLOR_08_HEX="f5708a"
  export BASE16_COLOR_09_HEX="ee8122"
  export BASE16_COLOR_0A_HEX="b8a300"
  export BASE16_COLOR_0B_HEX="54bc5c"
  export BASE16_COLOR_0C_HEX="00bab3"
  export BASE16_COLOR_0D_HEX="00aff2"
  export BASE16_COLOR_0E_HEX="9095ff"
  export BASE16_COLOR_0F_HEX="d47ada"
fi
