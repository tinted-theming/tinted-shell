...
if [ -n "$BASE16_SHELL_ENABLE_VARS" ]; then
  export BASE16_COLOR_00_HEX="f1efee"
  export BASE16_COLOR_01_HEX="e6e2e0"
  export BASE16_COLOR_02_HEX="a8a19f"
  export BASE16_COLOR_03_HEX="9c9491"
  export BASE16_COLOR_04_HEX="766e6b"
  export BASE16_COLOR_05_HEX="68615e"
  export BASE16_COLOR_06_HEX="2c2421"
  export BASE16_COLOR_07_HEX="1b1918"
