...
color08="d9/d9/d9" # Base 03 - Bright Black
...
if [ -n "$TINTED_SHELL_ENABLE_BASE16_VARS" ] || [ -n "$BASE16_SHELL_ENABLE_VARS" ]; then
  export BASE16_COLOR_00_HEX="f2f2f2"
  export BASE16_COLOR_01_HEX="e5e5e5"
  export BASE16_COLOR_02_HEX="d9d9d9"
  export BASE16_COLOR_03_HEX="cccccc"
  export BASE16_COLOR_04_HEX="ababab"
  export BASE16_COLOR_05_HEX="767676"
  export BASE16_COLOR_06_HEX="414141"
  export BASE16_COLOR_07_HEX="0c0c0c"
  export BASE16_COLOR_08_HEX="c50f1f"
  export BASE16_COLOR_09_HEX="f9f1a5"
  export BASE16_COLOR_0A_HEX="c19c00"
  export BASE16_COLOR_0B_HEX="13a10e"
  export BASE16_COLOR_0C_HEX="3a96dd"
  export BASE16_COLOR_0D_HEX="0037da"
  export BASE16_COLOR_0E_HEX="881798"
  export BASE16_COLOR_0F_HEX="16c60c"
fi
