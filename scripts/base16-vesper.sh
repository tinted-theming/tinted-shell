...
if [ -n "$TINTED_SHELL_ENABLE_BASE16_VARS" ] || [ -n "$BASE16_SHELL_ENABLE_VARS" ]; then
  ...
  export BASE16_COLOR_01_HEX="232323"
  export BASE16_COLOR_02_HEX="222222"
  export BASE16_COLOR_03_HEX="333333"
  export BASE16_COLOR_04_HEX="999999"
  export BASE16_COLOR_05_HEX="b7b7b7"
  export BASE16_COLOR_06_HEX="c1c1c1"
  export BASE16_COLOR_07_HEX="d5d5d5"
  export BASE16_COLOR_08_HEX="de6e6e"
  export BASE16_COLOR_09_HEX="dab083"
  export BASE16_COLOR_0A_HEX="ffc799"
  export BASE16_COLOR_0B_HEX="5f8787"
  export BASE16_COLOR_0C_HEX="60a592"
  export BASE16_COLOR_0D_HEX="8eaaaa"
  export BASE16_COLOR_0E_HEX="d69094"
  export BASE16_COLOR_0F_HEX="876c4f"
fi
