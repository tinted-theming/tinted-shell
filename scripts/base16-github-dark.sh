...
if [ -n "$TINTED_SHELL_ENABLE_BASE16_VARS" ] || [ -n "$BASE16_SHELL_ENABLE_VARS" ]; then
  export BASE16_COLOR_00_HEX="161b22"
  export BASE16_COLOR_01_HEX="30363d"
  ...
  export BASE16_COLOR_08_HEX="f85149"
  export BASE16_COLOR_09_HEX="db6d28"
  export BASE16_COLOR_0A_HEX="bb8009"
  export BASE16_COLOR_0B_HEX="2ea043"
  export BASE16_COLOR_0C_HEX="2a9d9a"
  export BASE16_COLOR_0D_HEX="388bfd"
  export BASE16_COLOR_0E_HEX="a371f7"
  export BASE16_COLOR_0F_HEX="3d2f00"
fi
