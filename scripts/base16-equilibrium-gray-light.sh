...
if [ -n "$BASE16_SHELL_ENABLE_VARS" ]; then
  export BASE16_COLOR_00_HEX="f1f1f1"
  export BASE16_COLOR_01_HEX="e2e2e2"
  export BASE16_COLOR_02_HEX="d4d4d4"
  export BASE16_COLOR_03_HEX="777777"
  export BASE16_COLOR_04_HEX="5e5e5e"
  export BASE16_COLOR_05_HEX="474747"
  export BASE16_COLOR_06_HEX="303030"
  export BASE16_COLOR_07_HEX="1b1b1b"
