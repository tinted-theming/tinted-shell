...
if [ -n "$BASE16_SHELL_ENABLE_VARS" ]; then
  export BASE16_COLOR_00_HEX="efecf4"
  export BASE16_COLOR_01_HEX="e2dfe7"
  export BASE16_COLOR_02_HEX="8b8792"
  export BASE16_COLOR_03_HEX="7e7887"
  export BASE16_COLOR_04_HEX="655f6d"
  export BASE16_COLOR_05_HEX="585260"
  export BASE16_COLOR_06_HEX="26232a"
  export BASE16_COLOR_07_HEX="19171c"
