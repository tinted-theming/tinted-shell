...
color08="4d/59/60" # Base 03 - Bright Black
...
if [ -n "$TINTED_SHELL_ENABLE_BASE16_VARS" ] || [ -n "$BASE16_SHELL_ENABLE_VARS" ]; then
  export BASE16_COLOR_00_HEX="333c43"
  export BASE16_COLOR_01_HEX="3a464c"
  export BASE16_COLOR_02_HEX="4d5960"
  export BASE16_COLOR_03_HEX="859289"
  export BASE16_COLOR_04_HEX="9da9a0"
  export BASE16_COLOR_05_HEX="d3c6aa"
  export BASE16_COLOR_06_HEX="ddd8be"
  export BASE16_COLOR_07_HEX="f3ead3"
