...
set -l color00 "14/28/38" # Base 00 - Black
set -l color01 "ff/23/20" # Base 08 - Red
set -l color02 "3a/a5/ff" # Base 0B - Green
set -l color03 "3c/7d/d2" # Base 0A - Yellow
set -l color04 "8f/f5/86" # Base 0D - Blue
set -l color05 "78/1a/a0" # Base 0E - Magenta
set -l color06 "8f/f5/86" # Base 0C - Cyan
set -l color07 "cc/72/a6" # Base 05 - White
set -l color08 "ee/ca/92" # Base 03 - Bright Black
...
set -l color15 "8f/f5/86" # Base 07 - Bright White
set -l color16 "e9/e7/5c" # Base 09
set -l color17 "7f/11/10" # Base 0F
set -l color18 "14/26/30" # Base 01
set -l color19 "ff/f6/88" # Base 02
set -l color20 "dd/9e/9c" # Base 04
set -l color21 "ba/45/b1" # Base 06
set -l color_foreground "cc/72/a6" # Base 05
set -l color_background "14/28/38" # Base 00
...
set -U fish_color_end cc72a6
set -U fish_color_error brred
set -U fish_color_param dd9e9c
set -U fish_color_valid_path --underline
set -U fish_color_option brcyan
set -U fish_color_comment eeca92
set -U fish_color_selection ba45b1 --bold --background=fff688
set -U fish_color_operator brblue
set -U fish_color_escape brcyan
set -U fish_color_autosuggestion eeca92
...
set -U fish_color_search_match bryellow --background=fff688
set -U fish_color_history_current --bold
set -U fish_pager_color_progress 142630 --background=dd9e9c
set -U fish_pager_color_background normal --background=142838
set -U fish_pager_color_prefix normal --bold
set -U fish_pager_color_completion normal
set -U fish_pager_color_description e9e75c --dim
set -U fish_pager_color_selected_background ba45b1 --background=fff688
set -U fish_pager_color_selected_prefix ba45b1 --bold --background=fff688
set -U fish_pager_color_selected_completion ba45b1
...
# Set theme
set -Ux BASE24_THEME cobalt-neon

# Optionally export variables
if test -n "$TINTED_SHELL_ENABLE_BASE24_VARS"; or test -n "$BASE24_SHELL_ENABLE_VARS"
  set -gx BASE24_COLOR_00_HEX "142838"
  set -gx BASE24_COLOR_01_HEX "142630"
  set -gx BASE24_COLOR_02_HEX "fff688"
  set -gx BASE24_COLOR_03_HEX "eeca92"
  set -gx BASE24_COLOR_04_HEX "dd9e9c"
  set -gx BASE24_COLOR_05_HEX "cc72a6"
  set -gx BASE24_COLOR_06_HEX "ba45b1"
  set -gx BASE24_COLOR_07_HEX "8ff586"
  set -gx BASE24_COLOR_08_HEX "ff2320"
  set -gx BASE24_COLOR_09_HEX "e9e75c"
  set -gx BASE24_COLOR_0A_HEX "3c7dd2"
  set -gx BASE24_COLOR_0B_HEX "3aa5ff"
  set -gx BASE24_COLOR_0C_HEX "8ff586"
  set -gx BASE24_COLOR_0D_HEX "8ff586"
  set -gx BASE24_COLOR_0E_HEX "781aa0"
  set -gx BASE24_COLOR_0F_HEX "7f1110"
end
