...
set -l color00 "eb/f8/ff" # Base 00 - Black
set -l color01 "d2/2d/72" # Base 08 - Red
set -l color02 "56/8c/3b" # Base 0B - Green
set -l color03 "8a/8a/0f" # Base 0A - Yellow
set -l color04 "25/7f/ad" # Base 0D - Blue
set -l color05 "6b/6b/b8" # Base 0E - Magenta
set -l color06 "2d/8f/6f" # Base 0C - Cyan
set -l color07 "51/6d/7b" # Base 05 - White
set -l color08 "71/95/a8" # Base 03 - Bright Black
...
set -l color15 "16/1b/1d" # Base 07 - Bright White
set -l color16 "93/5c/25" # Base 09
set -l color17 "b7/2d/d2" # Base 0F
set -l color18 "c1/e4/f6" # Base 01
set -l color19 "7e/a2/b4" # Base 02
set -l color20 "5a/7b/8c" # Base 04
set -l color21 "1f/29/2e" # Base 06
set -l color_foreground "51/6d/7b" # Base 05
set -l color_background "eb/f8/ff" # Base 00
...
set -U fish_color_end 516d7b
set -U fish_color_error brred
set -U fish_color_param 5a7b8c
set -U fish_color_valid_path --underline
set -U fish_color_option brcyan
set -U fish_color_comment 7195a8
set -U fish_color_selection 1f292e --bold --background=7ea2b4
set -U fish_color_operator brblue
set -U fish_color_escape brcyan
set -U fish_color_autosuggestion 7195a8
...
set -U fish_pager_color_progress c1e4f6 --background=5a7b8c
set -U fish_pager_color_background normal --background=ebf8ff
set -U fish_pager_color_prefix normal --bold
set -U fish_pager_color_completion normal
set -U fish_pager_color_description 935c25 --dim
set -U fish_pager_color_selected_background 1f292e --background=7ea2b4
set -U fish_pager_color_selected_prefix 1f292e --bold --background=7ea2b4
set -U fish_pager_color_selected_completion 1f292e
...
# Set theme
set -Ux BASE16_THEME atelier-lakeside-light

# Optionally export variables
if test -n "$TINTED_SHELL_ENABLE_BASE16_VARS"; or test -n "$BASE16_SHELL_ENABLE_VARS"
  set -gx BASE16_COLOR_00_HEX "ebf8ff"
  set -gx BASE16_COLOR_01_HEX "c1e4f6"
  set -gx BASE16_COLOR_02_HEX "7ea2b4"
  set -gx BASE16_COLOR_03_HEX "7195a8"
  set -gx BASE16_COLOR_04_HEX "5a7b8c"
  set -gx BASE16_COLOR_05_HEX "516d7b"
  set -gx BASE16_COLOR_06_HEX "1f292e"
  set -gx BASE16_COLOR_07_HEX "161b1d"
  set -gx BASE16_COLOR_08_HEX "d22d72"
  set -gx BASE16_COLOR_09_HEX "935c25"
  set -gx BASE16_COLOR_0A_HEX "8a8a0f"
  set -gx BASE16_COLOR_0B_HEX "568c3b"
  set -gx BASE16_COLOR_0C_HEX "2d8f6f"
  set -gx BASE16_COLOR_0D_HEX "257fad"
  set -gx BASE16_COLOR_0E_HEX "6b6bb8"
  set -gx BASE16_COLOR_0F_HEX "b72dd2"
end
