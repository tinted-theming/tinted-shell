...
set -l color00 "23/1f/20" # Base 00 - Black
set -l color01 "ee/2e/24" # Base 08 - Red
set -l color02 "00/85/3e" # Base 0B - Green
set -l color03 "ff/d2/04" # Base 0A - Yellow
set -l color04 "00/9d/dc" # Base 0D - Blue
set -l color05 "98/00/5d" # Base 0E - Magenta
set -l color06 "85/ce/bc" # Base 0C - Cyan
set -l color07 "d9/d8/d8" # Base 05 - White
set -l color08 "73/71/71" # Base 03 - Bright Black
...
set -l color16 "f3/86/a1" # Base 09
set -l color17 "b0/61/10" # Base 0F
set -l color18 "1c/3f/95" # Base 01
set -l color19 "5a/57/58" # Base 02
set -l color20 "95/9c/a1" # Base 04
set -l color21 "e7/e7/e8" # Base 06
set -l color_foreground "d9/d8/d8" # Base 05
set -l color_background "23/1f/20" # Base 00
...
set -U fish_color_end d9d8d8
set -U fish_color_error brred
set -U fish_color_param 959ca1
set -U fish_color_valid_path --underline
set -U fish_color_option brcyan
set -U fish_color_comment 737171
set -U fish_color_selection e7e7e8 --bold --background=5a5758
set -U fish_color_operator brblue
set -U fish_color_escape brcyan
set -U fish_color_autosuggestion 737171
...
set -U fish_pager_color_progress 1c3f95 --background=959ca1
set -U fish_pager_color_background normal --background=231f20
set -U fish_pager_color_prefix normal --bold
set -U fish_pager_color_completion normal
set -U fish_pager_color_description f386a1 --dim
set -U fish_pager_color_selected_background e7e7e8 --background=5a5758
set -U fish_pager_color_selected_prefix e7e7e8 --bold --background=5a5758
set -U fish_pager_color_selected_completion e7e7e8
...
# Set theme
set -Ux BASE16_THEME tube

# Optionally export variables
if test -n "$TINTED_SHELL_ENABLE_BASE16_VARS"; or test -n "$BASE16_SHELL_ENABLE_VARS"
  set -gx BASE16_COLOR_00_HEX "231f20"
  set -gx BASE16_COLOR_01_HEX "1c3f95"
  set -gx BASE16_COLOR_02_HEX "5a5758"
  set -gx BASE16_COLOR_03_HEX "737171"
  set -gx BASE16_COLOR_04_HEX "959ca1"
  set -gx BASE16_COLOR_05_HEX "d9d8d8"
  set -gx BASE16_COLOR_06_HEX "e7e7e8"
  set -gx BASE16_COLOR_07_HEX "ffffff"
  set -gx BASE16_COLOR_08_HEX "ee2e24"
  set -gx BASE16_COLOR_09_HEX "f386a1"
  set -gx BASE16_COLOR_0A_HEX "ffd204"
  set -gx BASE16_COLOR_0B_HEX "00853e"
  set -gx BASE16_COLOR_0C_HEX "85cebc"
  set -gx BASE16_COLOR_0D_HEX "009ddc"
  set -gx BASE16_COLOR_0E_HEX "98005d"
  set -gx BASE16_COLOR_0F_HEX "b06110"
end
