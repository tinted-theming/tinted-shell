...
set -l color00 "fb/f3/db" # Base 00 - Black
set -l color01 "cc/17/29" # Base 08 - Red
set -l color02 "42/8b/00" # Base 0B - Green
set -l color03 "a7/83/00" # Base 0A - Yellow
set -l color04 "00/6d/ce" # Base 0D - Blue
set -l color05 "82/5d/c0" # Base 0E - Magenta
set -l color06 "00/97/8a" # Base 0C - Cyan
set -l color07 "53/67/6d" # Base 05 - White
set -l color08 "90/99/95" # Base 03 - Bright Black
...
set -l color15 "3a/4d/53" # Base 07 - Bright White
set -l color16 "bc/58/19" # Base 09
set -l color17 "c4/43/92" # Base 0F
set -l color18 "ec/e3/cc" # Base 01
set -l color19 "d5/cd/b6" # Base 02
set -l color20 "90/99/95" # Base 04
set -l color21 "3a/4d/53" # Base 06
set -l color_foreground "53/67/6d" # Base 05
set -l color_background "fb/f3/db" # Base 00
...
set -U fish_color_end 53676d
set -U fish_color_error brred
set -U fish_color_param 909995
set -U fish_color_valid_path --underline
set -U fish_color_option brcyan
set -U fish_color_comment 909995
set -U fish_color_selection 3a4d53 --bold --background=d5cdb6
set -U fish_color_operator brblue
set -U fish_color_escape brcyan
set -U fish_color_autosuggestion 909995
...
set -U fish_color_search_match bryellow --background=d5cdb6
set -U fish_color_history_current --bold
set -U fish_pager_color_progress ece3cc --background=909995
set -U fish_pager_color_background normal --background=fbf3db
set -U fish_pager_color_prefix normal --bold
set -U fish_pager_color_completion normal
set -U fish_pager_color_description bc5819 --dim
set -U fish_pager_color_selected_background 3a4d53 --background=d5cdb6
set -U fish_pager_color_selected_prefix 3a4d53 --bold --background=d5cdb6
set -U fish_pager_color_selected_completion 3a4d53
...
# Set theme
set -Ux BASE16_THEME selenized-light

# Optionally export variables
if test -n "$TINTED_SHELL_ENABLE_BASE16_VARS"; or test -n "$BASE16_SHELL_ENABLE_VARS"
  set -gx BASE16_COLOR_00_HEX "fbf3db"
  set -gx BASE16_COLOR_01_HEX "ece3cc"
  set -gx BASE16_COLOR_02_HEX "d5cdb6"
  set -gx BASE16_COLOR_03_HEX "909995"
  set -gx BASE16_COLOR_04_HEX "909995"
  set -gx BASE16_COLOR_05_HEX "53676d"
  set -gx BASE16_COLOR_06_HEX "3a4d53"
  set -gx BASE16_COLOR_07_HEX "3a4d53"
  set -gx BASE16_COLOR_08_HEX "cc1729"
  set -gx BASE16_COLOR_09_HEX "bc5819"
  set -gx BASE16_COLOR_0A_HEX "a78300"
  set -gx BASE16_COLOR_0B_HEX "428b00"
  set -gx BASE16_COLOR_0C_HEX "00978a"
  set -gx BASE16_COLOR_0D_HEX "006dce"
  set -gx BASE16_COLOR_0E_HEX "825dc0"
  set -gx BASE16_COLOR_0F_HEX "c44392"
end
