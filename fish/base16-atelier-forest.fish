...
set -l color00 "1b/19/18" # Base 00 - Black
...
set -l color07 "a8/a1/9f" # Base 05 - White
set -l color08 "76/6e/6b" # Base 03 - Bright Black
...
set -l color15 "f1/ef/ee" # Base 07 - Bright White
set -l color16 "df/53/20" # Base 09
set -l color17 "c3/3f/f3" # Base 0F
set -l color18 "2c/24/21" # Base 01
set -l color19 "68/61/5e" # Base 02
set -l color20 "9c/94/91" # Base 04
set -l color21 "e6/e2/e0" # Base 06
set -l color_foreground "a8/a1/9f" # Base 05
set -l color_background "1b/19/18" # Base 00
...
set -U fish_color_end a8a19f
set -U fish_color_error brred
set -U fish_color_param 9c9491
set -U fish_color_valid_path --underline
set -U fish_color_option brcyan
set -U fish_color_comment 766e6b
set -U fish_color_selection e6e2e0 --bold --background=68615e
set -U fish_color_operator brblue
set -U fish_color_escape brcyan
set -U fish_color_autosuggestion 766e6b
...
set -U fish_pager_color_progress 2c2421 --background=9c9491
set -U fish_pager_color_background normal --background=1b1918
set -U fish_pager_color_prefix normal --bold
set -U fish_pager_color_completion normal
set -U fish_pager_color_description df5320 --dim
set -U fish_pager_color_selected_background e6e2e0 --background=68615e
set -U fish_pager_color_selected_prefix e6e2e0 --bold --background=68615e
set -U fish_pager_color_selected_completion e6e2e0
...
# Set theme
set -Ux BASE16_THEME atelier-forest

# Optionally export variables
if test -n "$TINTED_SHELL_ENABLE_BASE16_VARS"; or test -n "$BASE16_SHELL_ENABLE_VARS"
  set -gx BASE16_COLOR_00_HEX "1b1918"
  set -gx BASE16_COLOR_01_HEX "2c2421"
  set -gx BASE16_COLOR_02_HEX "68615e"
  set -gx BASE16_COLOR_03_HEX "766e6b"
  set -gx BASE16_COLOR_04_HEX "9c9491"
  set -gx BASE16_COLOR_05_HEX "a8a19f"
  set -gx BASE16_COLOR_06_HEX "e6e2e0"
  set -gx BASE16_COLOR_07_HEX "f1efee"
