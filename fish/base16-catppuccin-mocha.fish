...
set -U fish_color_param 585b70
set -U fish_color_valid_path --underline
set -U fish_color_option brcyan
set -U fish_color_comment 45475a
set -U fish_color_selection f5e0dc --bold --background=313244
...
set -U fish_color_search_match bryellow --background=313244
set -U fish_color_history_current --bold
set -U fish_pager_color_progress 181825 --background=585b70
set -U fish_pager_color_background normal --background=1e1e2e
set -U fish_pager_color_prefix normal --bold
set -U fish_pager_color_completion normal
set -U fish_pager_color_description fab387 --dim
set -U fish_pager_color_selected_background f5e0dc --background=313244
set -U fish_pager_color_selected_prefix f5e0dc --bold --background=313244
set -U fish_pager_color_selected_completion f5e0dc
...
# Set theme
set -Ux BASE16_THEME catppuccin-mocha

# Optionally export variables
if test -n "$TINTED_SHELL_ENABLE_BASE16_VARS"; or test -n "$BASE16_SHELL_ENABLE_VARS"
  set -gx BASE16_COLOR_00_HEX "1e1e2e"
  set -gx BASE16_COLOR_01_HEX "181825"
  set -gx BASE16_COLOR_02_HEX "313244"
  set -gx BASE16_COLOR_03_HEX "45475a"
  set -gx BASE16_COLOR_04_HEX "585b70"
  set -gx BASE16_COLOR_05_HEX "cdd6f4"
  set -gx BASE16_COLOR_06_HEX "f5e0dc"
  set -gx BASE16_COLOR_07_HEX "b4befe"
  set -gx BASE16_COLOR_08_HEX "f38ba8"
  set -gx BASE16_COLOR_09_HEX "fab387"
  set -gx BASE16_COLOR_0A_HEX "f9e2af"
  set -gx BASE16_COLOR_0B_HEX "a6e3a1"
  set -gx BASE16_COLOR_0C_HEX "94e2d5"
  set -gx BASE16_COLOR_0D_HEX "89b4fa"
  set -gx BASE16_COLOR_0E_HEX "cba6f7"
  set -gx BASE16_COLOR_0F_HEX "f2cdcd"
end
