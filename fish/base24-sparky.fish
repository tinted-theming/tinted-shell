...
# Set theme
set -Ux BASE24_THEME sparky

# Optionally export variables
if test -n "$TINTED_SHELL_ENABLE_BASE24_VARS"; or test -n "$BASE24_SHELL_ENABLE_VARS"
  set -gx BASE24_COLOR_00_HEX "072b31"
  set -gx BASE24_COLOR_01_HEX "00313c"
  set -gx BASE24_COLOR_02_HEX "003c46"
  set -gx BASE24_COLOR_03_HEX "003b49"
  set -gx BASE24_COLOR_04_HEX "00778b"
  set -gx BASE24_COLOR_05_HEX "f4f5f0"
  set -gx BASE24_COLOR_06_HEX "f5f5f1"
  set -gx BASE24_COLOR_07_HEX "ffffff"
  set -gx BASE24_COLOR_08_HEX "ff585d"
  set -gx BASE24_COLOR_09_HEX "ff8f1c"
  set -gx BASE24_COLOR_0A_HEX "fbdd40"
  set -gx BASE24_COLOR_0B_HEX "78d64b"
  set -gx BASE24_COLOR_0C_HEX "2dccd3"
  set -gx BASE24_COLOR_0D_HEX "4698cb"
  set -gx BASE24_COLOR_0E_HEX "d59ed7"
  set -gx BASE24_COLOR_0F_HEX "9b704d"
end
