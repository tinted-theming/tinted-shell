...
set -U fish_color_selection f5f5f1 --background=003c46
set -U fish_color_operator magenta
set -U fish_color_escape ff8f1c
...
set -U fish_color_search_match yellow --background=003c46
set -U fish_color_history_current --underline=curly
set -U fish_pager_color_progress 00313c --background=00778b
set -U fish_pager_color_background --background=072b31
set -U fish_pager_color_prefix --bold --italics
set -U fish_pager_color_completion normal
set -U fish_pager_color_description ff8f1c
set -U fish_pager_color_selected_background --background=003c46
set -U fish_pager_color_selected_prefix --bold --italics --background=003c46
