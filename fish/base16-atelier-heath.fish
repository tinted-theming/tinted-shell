...
set -l color00 "1b/18/1b" # Base 00 - Black
...
set -l color07 "ab/9b/ab" # Base 05 - White
set -l color08 "77/69/77" # Base 03 - Bright Black
...
set -l color15 "f7/f3/f7" # Base 07 - Bright White
set -l color16 "a6/59/26" # Base 09
set -l color17 "cc/33/cc" # Base 0F
set -l color18 "29/23/29" # Base 01
set -l color19 "69/5d/69" # Base 02
set -l color20 "9e/8f/9e" # Base 04
set -l color21 "d8/ca/d8" # Base 06
set -l color_foreground "ab/9b/ab" # Base 05
set -l color_background "1b/18/1b" # Base 00
...
set -U fish_color_end ab9bab
set -U fish_color_error brred
set -U fish_color_param 9e8f9e
set -U fish_color_valid_path --underline
set -U fish_color_option brcyan
set -U fish_color_comment 776977
set -U fish_color_selection d8cad8 --bold --background=695d69
set -U fish_color_operator brblue
set -U fish_color_escape brcyan
set -U fish_color_autosuggestion 776977
...
set -U fish_pager_color_progress 292329 --background=9e8f9e
set -U fish_pager_color_background normal --background=1b181b
set -U fish_pager_color_prefix normal --bold
set -U fish_pager_color_completion normal
set -U fish_pager_color_description a65926 --dim
set -U fish_pager_color_selected_background d8cad8 --background=695d69
set -U fish_pager_color_selected_prefix d8cad8 --bold --background=695d69
set -U fish_pager_color_selected_completion d8cad8
...
# Set theme
set -Ux BASE16_THEME atelier-heath

# Optionally export variables
if test -n "$TINTED_SHELL_ENABLE_BASE16_VARS"; or test -n "$BASE16_SHELL_ENABLE_VARS"
  set -gx BASE16_COLOR_00_HEX "1b181b"
  set -gx BASE16_COLOR_01_HEX "292329"
  set -gx BASE16_COLOR_02_HEX "695d69"
  set -gx BASE16_COLOR_03_HEX "776977"
  set -gx BASE16_COLOR_04_HEX "9e8f9e"
  set -gx BASE16_COLOR_05_HEX "ab9bab"
  set -gx BASE16_COLOR_06_HEX "d8cad8"
  set -gx BASE16_COLOR_07_HEX "f7f3f7"
