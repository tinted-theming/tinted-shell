...
set -l color00 "13/12/13" # Base 00 - Black
set -l color01 "b0/0b/69" # Base 08 - Red
set -l color02 "9d/df/69" # Base 0B - Green
set -l color03 "ff/cc/00" # Base 0A - Yellow
set -l color04 "00/80/80" # Base 0D - Blue
set -l color05 "a2/40/30" # Base 0E - Magenta
set -l color06 "71/4c/a6" # Base 0C - Cyan
set -l color07 "f1/5c/99" # Base 05 - White
set -l color08 "ff/be/e3" # Base 03 - Bright Black
...
set -l color15 "63/22/27" # Base 07 - Bright White
set -l color16 "ff/91/53" # Base 09
set -l color17 "a2/40/30" # Base 0F
set -l color18 "2f/18/23" # Base 01
set -l color19 "47/22/34" # Base 02
set -l color20 "9b/2a/46" # Base 04
set -l color21 "81/50/6a" # Base 06
set -l color_foreground "f1/5c/99" # Base 05
set -l color_background "13/12/13" # Base 00
...
set -U fish_color_end f15c99
set -U fish_color_error brred
set -U fish_color_param 9b2a46
set -U fish_color_valid_path --underline
set -U fish_color_option brcyan
set -U fish_color_comment ffbee3
set -U fish_color_selection 81506a --bold --background=472234
set -U fish_color_operator brblue
set -U fish_color_escape brcyan
set -U fish_color_autosuggestion ffbee3
...
set -U fish_color_search_match bryellow --background=472234
set -U fish_color_history_current --bold
set -U fish_pager_color_progress 2f1823 --background=9b2a46
set -U fish_pager_color_background normal --background=131213
set -U fish_pager_color_prefix normal --bold
set -U fish_pager_color_completion normal
set -U fish_pager_color_description ff9153 --dim
set -U fish_pager_color_selected_background 81506a --background=472234
set -U fish_pager_color_selected_prefix 81506a --bold --background=472234
set -U fish_pager_color_selected_completion 81506a
...
# Set theme
set -Ux BASE16_THEME pandora

# Optionally export variables
if test -n "$TINTED_SHELL_ENABLE_BASE16_VARS"; or test -n "$BASE16_SHELL_ENABLE_VARS"
  set -gx BASE16_COLOR_00_HEX "131213"
  set -gx BASE16_COLOR_01_HEX "2f1823"
  set -gx BASE16_COLOR_02_HEX "472234"
  set -gx BASE16_COLOR_03_HEX "ffbee3"
  set -gx BASE16_COLOR_04_HEX "9b2a46"
  set -gx BASE16_COLOR_05_HEX "f15c99"
  set -gx BASE16_COLOR_06_HEX "81506a"
  set -gx BASE16_COLOR_07_HEX "632227"
  set -gx BASE16_COLOR_08_HEX "b00b69"
  set -gx BASE16_COLOR_09_HEX "ff9153"
  set -gx BASE16_COLOR_0A_HEX "ffcc00"
  set -gx BASE16_COLOR_0B_HEX "9ddf69"
  set -gx BASE16_COLOR_0C_HEX "714ca6"
  set -gx BASE16_COLOR_0D_HEX "008080"
  set -gx BASE16_COLOR_0E_HEX "a24030"
  set -gx BASE16_COLOR_0F_HEX "a24030"
end
