...
set -U fish_pager_color_background normal --background=19171c
set -U fish_pager_color_prefix normal --bold
set -U fish_pager_color_completion normal
set -U fish_pager_color_description aa573c --dim
set -U fish_pager_color_selected_background e2dfe7 --background=585260
set -U fish_pager_color_selected_prefix e2dfe7 --bold --background=585260
set -U fish_pager_color_selected_completion e2dfe7
