...
set -l color01 "af/49/47" # Base 08 - Red
set -l color02 "55/73/01" # Base 0B - Green
set -l color03 "87/65/00" # Base 0A - Yellow
set -l color04 "18/6d/aa" # Base 0D - Blue
set -l color05 "7b/4e/cb" # Base 0E - Magenta
set -l color06 "08/77/67" # Base 0C - Cyan
set -l color07 "55/55/55" # Base 05 - White
set -l color08 "84/84/84" # Base 03 - Bright Black
...
set -l color15 "55/55/55" # Base 07 - Bright White
set -l color16 "a0/57/0d" # Base 09
set -l color17 "a9/3e/93" # Base 0F
set -l color18 "ed/ed/ed" # Base 01
set -l color19 "db/db/db" # Base 02
set -l color20 "63/63/63" # Base 04
set -l color21 "55/55/55" # Base 06
set -l color_foreground "55/55/55" # Base 05
...
set -U fish_color_end 555555
set -U fish_color_error brred
set -U fish_color_param 636363
set -U fish_color_valid_path --underline
set -U fish_color_option brcyan
set -U fish_color_comment 848484
set -U fish_color_selection 555555 --bold --background=dbdbdb
set -U fish_color_operator brblue
set -U fish_color_escape brcyan
set -U fish_color_autosuggestion 848484
...
set -U fish_color_search_match bryellow --background=dbdbdb
set -U fish_color_history_current --bold
set -U fish_pager_color_progress ededed --background=636363
set -U fish_pager_color_background normal --background=ffffff
set -U fish_pager_color_prefix normal --bold
set -U fish_pager_color_completion normal
set -U fish_pager_color_description a0570d --dim
set -U fish_pager_color_selected_background 555555 --background=dbdbdb
set -U fish_pager_color_selected_prefix 555555 --bold --background=dbdbdb
set -U fish_pager_color_selected_completion 555555
...
# Set theme
set -Ux BASE16_THEME precious-light-white

# Optionally export variables
if test -n "$TINTED_SHELL_ENABLE_BASE16_VARS"; or test -n "$BASE16_SHELL_ENABLE_VARS"
  set -gx BASE16_COLOR_00_HEX "ffffff"
  set -gx BASE16_COLOR_01_HEX "ededed"
  set -gx BASE16_COLOR_02_HEX "dbdbdb"
  set -gx BASE16_COLOR_03_HEX "848484"
  set -gx BASE16_COLOR_04_HEX "636363"
  set -gx BASE16_COLOR_05_HEX "555555"
  set -gx BASE16_COLOR_06_HEX "555555"
  set -gx BASE16_COLOR_07_HEX "555555"
  set -gx BASE16_COLOR_08_HEX "af4947"
  set -gx BASE16_COLOR_09_HEX "a0570d"
  set -gx BASE16_COLOR_0A_HEX "876500"
  set -gx BASE16_COLOR_0B_HEX "557301"
  set -gx BASE16_COLOR_0C_HEX "087767"
  set -gx BASE16_COLOR_0D_HEX "186daa"
  set -gx BASE16_COLOR_0E_HEX "7b4ecb"
  set -gx BASE16_COLOR_0F_HEX "a93e93"
end
