...
set -U fish_color_search_match bryellow --background=484f58
set -U fish_color_history_current --bold
set -U fish_pager_color_progress 30363d --background=8b949e
set -U fish_pager_color_background normal --background=161b22
set -U fish_pager_color_prefix normal --bold
set -U fish_pager_color_completion normal
set -U fish_pager_color_description db6d28 --dim
set -U fish_pager_color_selected_background f0f6fc --background=484f58
set -U fish_pager_color_selected_prefix f0f6fc --bold --background=484f58
...
if test -n "$TINTED_SHELL_ENABLE_BASE24_VARS"; or test -n "$BASE24_SHELL_ENABLE_VARS"
  set -gx BASE24_COLOR_00_HEX "161b22"
  set -gx BASE24_COLOR_01_HEX "30363d"
  ...
  set -gx BASE24_COLOR_08_HEX "f85149"
  set -gx BASE24_COLOR_09_HEX "db6d28"
  set -gx BASE24_COLOR_0A_HEX "bb8009"
  set -gx BASE24_COLOR_0B_HEX "2ea043"
  set -gx BASE24_COLOR_0C_HEX "2a9d9a"
  set -gx BASE24_COLOR_0D_HEX "388bfd"
  set -gx BASE24_COLOR_0E_HEX "a371f7"
  set -gx BASE24_COLOR_0F_HEX "3d2f00"
end
