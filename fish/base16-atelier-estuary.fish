...
set -l color00 "22/22/1b" # Base 00 - Black
...
set -l color07 "92/91/81" # Base 05 - White
set -l color08 "6c/6b/5a" # Base 03 - Bright Black
...
set -l color15 "f4/f3/ec" # Base 07 - Bright White
set -l color16 "ae/73/13" # Base 09
set -l color17 "9d/6c/7c" # Base 0F
set -l color18 "30/2f/27" # Base 01
set -l color19 "5f/5e/4e" # Base 02
set -l color20 "87/85/73" # Base 04
set -l color21 "e7/e6/df" # Base 06
set -l color_foreground "92/91/81" # Base 05
set -l color_background "22/22/1b" # Base 00
...
set -U fish_color_end 929181
set -U fish_color_error brred
set -U fish_color_param 878573
set -U fish_color_valid_path --underline
set -U fish_color_option brcyan
set -U fish_color_comment 6c6b5a
set -U fish_color_selection e7e6df --bold --background=5f5e4e
set -U fish_color_operator brblue
set -U fish_color_escape brcyan
set -U fish_color_autosuggestion 6c6b5a
...
set -U fish_pager_color_progress 302f27 --background=878573
set -U fish_pager_color_background normal --background=22221b
set -U fish_pager_color_prefix normal --bold
set -U fish_pager_color_completion normal
set -U fish_pager_color_description ae7313 --dim
set -U fish_pager_color_selected_background e7e6df --background=5f5e4e
set -U fish_pager_color_selected_prefix e7e6df --bold --background=5f5e4e
set -U fish_pager_color_selected_completion e7e6df
...
# Set theme
set -Ux BASE16_THEME atelier-estuary

# Optionally export variables
if test -n "$TINTED_SHELL_ENABLE_BASE16_VARS"; or test -n "$BASE16_SHELL_ENABLE_VARS"
  set -gx BASE16_COLOR_00_HEX "22221b"
  set -gx BASE16_COLOR_01_HEX "302f27"
  set -gx BASE16_COLOR_02_HEX "5f5e4e"
  set -gx BASE16_COLOR_03_HEX "6c6b5a"
  set -gx BASE16_COLOR_04_HEX "878573"
  set -gx BASE16_COLOR_05_HEX "929181"
  set -gx BASE16_COLOR_06_HEX "e7e6df"
  set -gx BASE16_COLOR_07_HEX "f4f3ec"
