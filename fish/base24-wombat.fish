...
set -l color00 "17/17/17" # Base 00 - Black
set -l color01 "ff/60/5a" # Base 08 - Red
set -l color02 "b1/e8/69" # Base 0B - Green
set -l color03 "a5/c7/ff" # Base 0A - Yellow
set -l color04 "5d/a9/f6" # Base 0D - Blue
set -l color05 "e8/6a/ff" # Base 0E - Magenta
set -l color06 "82/ff/f6" # Base 0C - Cyan
set -l color07 "b2/af/a6" # Base 05 - White
set -l color08 "5c/5b/58" # Base 03 - Bright Black
...
set -l color16 "ea/d8/9c" # Base 09
set -l color17 "7f/30/2d" # Base 0F
set -l color18 "00/00/00" # Base 01
set -l color19 "31/31/31" # Base 02
set -l color20 "87/85/7f" # Base 04
set -l color21 "de/d9/ce" # Base 06
set -l color_foreground "b2/af/a6" # Base 05
set -l color_background "17/17/17" # Base 00
...
set -U fish_color_end b2afa6
set -U fish_color_error brred
set -U fish_color_param 87857f
set -U fish_color_valid_path --underline
set -U fish_color_option brcyan
set -U fish_color_comment 5c5b58
set -U fish_color_selection ded9ce --bold --background=313131
set -U fish_color_operator brblue
set -U fish_color_escape brcyan
set -U fish_color_autosuggestion 5c5b58
...
set -U fish_color_search_match bryellow --background=313131
set -U fish_color_history_current --bold
set -U fish_pager_color_progress 000000 --background=87857f
set -U fish_pager_color_background normal --background=171717
set -U fish_pager_color_prefix normal --bold
set -U fish_pager_color_completion normal
set -U fish_pager_color_description ead89c --dim
set -U fish_pager_color_selected_background ded9ce --background=313131
set -U fish_pager_color_selected_prefix ded9ce --bold --background=313131
set -U fish_pager_color_selected_completion ded9ce
...
# Set theme
set -Ux BASE24_THEME wombat

# Optionally export variables
if test -n "$TINTED_SHELL_ENABLE_BASE24_VARS"; or test -n "$BASE24_SHELL_ENABLE_VARS"
  set -gx BASE24_COLOR_00_HEX "171717"
  set -gx BASE24_COLOR_01_HEX "000000"
  set -gx BASE24_COLOR_02_HEX "313131"
  set -gx BASE24_COLOR_03_HEX "5c5b58"
  set -gx BASE24_COLOR_04_HEX "87857f"
  set -gx BASE24_COLOR_05_HEX "b2afa6"
  set -gx BASE24_COLOR_06_HEX "ded9ce"
  set -gx BASE24_COLOR_07_HEX "fefffe"
  set -gx BASE24_COLOR_08_HEX "ff605a"
  set -gx BASE24_COLOR_09_HEX "ead89c"
  set -gx BASE24_COLOR_0A_HEX "a5c7ff"
  set -gx BASE24_COLOR_0B_HEX "b1e869"
  set -gx BASE24_COLOR_0C_HEX "82fff6"
  set -gx BASE24_COLOR_0D_HEX "5da9f6"
  set -gx BASE24_COLOR_0E_HEX "e86aff"
  set -gx BASE24_COLOR_0F_HEX "7f302d"
end
