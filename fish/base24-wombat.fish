...
set -U fish_color_selection ded9ce --background=313131
set -U fish_color_operator magenta
set -U fish_color_escape ead89c
...
set -U fish_color_search_match yellow --background=313131
set -U fish_color_history_current --underline=curly
set -U fish_pager_color_progress 000000 --background=87857f
set -U fish_pager_color_background --background=171717
set -U fish_pager_color_prefix --bold --italics
set -U fish_pager_color_completion normal
set -U fish_pager_color_description ead89c
set -U fish_pager_color_selected_background --background=313131
set -U fish_pager_color_selected_prefix --bold --italics --background=313131
