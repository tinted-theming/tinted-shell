...
set -l color00 "fe/ed/f3" # Base 00 - Black
set -l color01 "df/2d/52" # Base 08 - Red
set -l color02 "2e/91/6d" # Base 0B - Green
set -l color03 "c2/94/61" # Base 0A - Yellow
set -l color04 "00/6e/93" # Base 0D - Blue
set -l color05 "5e/21/80" # Base 0E - Magenta
set -l color06 "1d/89/91" # Base 0C - Cyan
set -l color07 "56/44/48" # Base 05 - White
set -l color08 "75/5f/64" # Base 03 - Bright Black
...
set -l color15 "33/29/2b" # Base 07 - Bright White
set -l color16 "f6/66/1e" # Base 09
set -l color17 "ba/0d/35" # Base 0F
set -l color18 "f8/e2/e7" # Base 01
set -l color19 "e0/cc/d1" # Base 02
set -l color20 "66/50/55" # Base 04
set -l color21 "42/38/3a" # Base 06
set -l color_foreground "56/44/48" # Base 05
set -l color_background "fe/ed/f3" # Base 00
...
set -U fish_color_end 564448
set -U fish_color_error brred
set -U fish_color_param 665055
set -U fish_color_valid_path --underline
set -U fish_color_option brcyan
set -U fish_color_comment 755f64
set -U fish_color_selection 42383a --bold --background=e0ccd1
set -U fish_color_operator brblue
set -U fish_color_escape brcyan
set -U fish_color_autosuggestion 755f64
...
set -U fish_pager_color_progress f8e2e7 --background=665055
set -U fish_pager_color_background normal --background=feedf3
set -U fish_pager_color_prefix normal --bold
set -U fish_pager_color_completion normal
set -U fish_pager_color_description f6661e --dim
set -U fish_pager_color_selected_background 42383a --background=e0ccd1
set -U fish_pager_color_selected_prefix 42383a --bold --background=e0ccd1
set -U fish_pager_color_selected_completion 42383a
...
# Set theme
set -Ux BASE16_THEME sakura

# Optionally export variables
if test -n "$TINTED_SHELL_ENABLE_BASE16_VARS"; or test -n "$BASE16_SHELL_ENABLE_VARS"
  set -gx BASE16_COLOR_00_HEX "feedf3"
  set -gx BASE16_COLOR_01_HEX "f8e2e7"
  set -gx BASE16_COLOR_02_HEX "e0ccd1"
  set -gx BASE16_COLOR_03_HEX "755f64"
  set -gx BASE16_COLOR_04_HEX "665055"
  set -gx BASE16_COLOR_05_HEX "564448"
  set -gx BASE16_COLOR_06_HEX "42383a"
  set -gx BASE16_COLOR_07_HEX "33292b"
  set -gx BASE16_COLOR_08_HEX "df2d52"
  set -gx BASE16_COLOR_09_HEX "f6661e"
  set -gx BASE16_COLOR_0A_HEX "c29461"
  set -gx BASE16_COLOR_0B_HEX "2e916d"
  set -gx BASE16_COLOR_0C_HEX "1d8991"
  set -gx BASE16_COLOR_0D_HEX "006e93"
  set -gx BASE16_COLOR_0E_HEX "5e2180"
  set -gx BASE16_COLOR_0F_HEX "ba0d35"
end
