...
set -l color01 "fb/9f/b1" # Base 08 - Red
set -l color02 "ac/c2/67" # Base 0B - Green
set -l color03 "dd/b2/6f" # Base 0A - Yellow
set -l color04 "6f/c2/ef" # Base 0D - Blue
set -l color05 "e1/a3/ee" # Base 0E - Magenta
set -l color06 "12/cf/c0" # Base 0C - Cyan
...
set -l color16 "ed/a9/87" # Base 09
...
set -U fish_pager_color_description eda987 --dim
...
if test -n "$TINTED_SHELL_ENABLE_BASE16_VARS"; or test -n "$BASE16_SHELL_ENABLE_VARS"
  ...
  set -gx BASE16_COLOR_08_HEX "fb9fb1"
  set -gx BASE16_COLOR_09_HEX "eda987"
  set -gx BASE16_COLOR_0A_HEX "ddb26f"
  set -gx BASE16_COLOR_0B_HEX "acc267"
  set -gx BASE16_COLOR_0C_HEX "12cfc0"
  set -gx BASE16_COLOR_0D_HEX "6fc2ef"
  set -gx BASE16_COLOR_0E_HEX "e1a3ee"
  set -gx BASE16_COLOR_0F_HEX "deaf8f"
end
