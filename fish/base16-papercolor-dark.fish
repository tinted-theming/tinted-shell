...
set -l color01 "ff/5f/af" # Base 08 - Red
set -l color02 "5f/af/5f" # Base 0B - Green
set -l color03 "ff/af/00" # Base 0A - Yellow
set -l color04 "5f/af/d7" # Base 0D - Blue
set -l color05 "af/87/d7" # Base 0E - Magenta
set -l color06 "00/af/af" # Base 0C - Cyan
set -l color07 "9e/9e/9e" # Base 05 - White
set -l color08 "58/58/58" # Base 03 - Bright Black
...
set -l color15 "d0/d0/d0" # Base 07 - Bright White
set -l color16 "d7/af/5f" # Base 09
set -l color17 "af/00/5f" # Base 0F
set -l color18 "36/36/36" # Base 01
set -l color19 "42/42/42" # Base 02
set -l color20 "80/80/80" # Base 04
set -l color21 "b8/b8/b8" # Base 06
set -l color_foreground "9e/9e/9e" # Base 05
...
if test -n "$ITERM_SESSION_ID"
  put_template_custom Pg 9e9e9e # foreground
  put_template_custom Ph 1c1c1c # background
  put_template_custom Pi 9e9e9e # bold color
  put_template_custom Pj 424242 # selection color
  put_template_custom Pk 9e9e9e # selected text color
  put_template_custom Pl 9e9e9e # cursor
...
set -U fish_color_search_match bryellow --background=424242
set -U fish_color_history_current --bold
set -U fish_pager_color_progress 363636 --background=808080
set -U fish_pager_color_background normal --background=1c1c1c
set -U fish_pager_color_prefix normal --bold
set -U fish_pager_color_completion normal
set -U fish_pager_color_description d7af5f --dim
set -U fish_pager_color_selected_background b8b8b8 --background=424242
set -U fish_pager_color_selected_prefix b8b8b8 --bold --background=424242
set -U fish_pager_color_selected_completion b8b8b8
...
# Set theme
set -Ux BASE16_THEME papercolor-dark

# Optionally export variables
if test -n "$TINTED_SHELL_ENABLE_BASE16_VARS"; or test -n "$BASE16_SHELL_ENABLE_VARS"
  set -gx BASE16_COLOR_00_HEX "1c1c1c"
  set -gx BASE16_COLOR_01_HEX "363636"
  set -gx BASE16_COLOR_02_HEX "424242"
  set -gx BASE16_COLOR_03_HEX "585858"
  set -gx BASE16_COLOR_04_HEX "808080"
  set -gx BASE16_COLOR_05_HEX "9e9e9e"
  set -gx BASE16_COLOR_06_HEX "b8b8b8"
  set -gx BASE16_COLOR_07_HEX "d0d0d0"
  set -gx BASE16_COLOR_08_HEX "ff5faf"
  set -gx BASE16_COLOR_09_HEX "d7af5f"
  set -gx BASE16_COLOR_0A_HEX "ffaf00"
  set -gx BASE16_COLOR_0B_HEX "5faf5f"
  set -gx BASE16_COLOR_0C_HEX "00afaf"
  set -gx BASE16_COLOR_0D_HEX "5fafd7"
  set -gx BASE16_COLOR_0E_HEX "af87d7"
  set -gx BASE16_COLOR_0F_HEX "af005f"
end
