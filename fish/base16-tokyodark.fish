...
set -l color06 "9f/bb/f3" # Base 0C - Cyan
set -l color07 "a0/a8/cd" # Base 05 - White
set -l color08 "35/39/45" # Base 03 - Bright Black
...
set -U fish_color_comment 353945
set -U fish_color_selection abb2bf --bold --background=212234
set -U fish_color_operator brblue
set -U fish_color_escape brcyan
set -U fish_color_autosuggestion 353945
...
set -U fish_pager_color_progress 212234 --background=4a5057
...
set -U fish_pager_color_selected_background abb2bf --background=212234
set -U fish_pager_color_selected_prefix abb2bf --bold --background=212234
set -U fish_pager_color_selected_completion abb2bf
...
if test -n "$TINTED_SHELL_ENABLE_BASE16_VARS"; or test -n "$BASE16_SHELL_ENABLE_VARS"
  ...
  set -gx BASE16_COLOR_0C_HEX "9fbbf3"
