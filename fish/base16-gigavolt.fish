...
set -U fish_pager_color_background normal --background=202126
set -U fish_pager_color_prefix normal --bold
set -U fish_pager_color_completion normal
set -U fish_pager_color_description 19f988 --dim
set -U fish_pager_color_selected_background eff0f9 --background=5a576e
set -U fish_pager_color_selected_prefix eff0f9 --bold --background=5a576e
set -U fish_pager_color_selected_completion eff0f9
