...
set -l color03 "fa/da/d1" # Base 0A - Yellow
...
set -l color16 "f9/ce/c3" # Base 09
set -l color17 "f9/cb/be" # Base 0F
...
# Set theme
set -Ux BASE16_THEME horizon-terminal-light
...
if test -n "$TINTED_SHELL_ENABLE_BASE16_VARS"; or test -n "$BASE16_SHELL_ENABLE_VARS"
  ...
  set -gx BASE16_COLOR_09_HEX "f9cec3"
  set -gx BASE16_COLOR_0A_HEX "fadad1"
  ...
  set -gx BASE16_COLOR_0F_HEX "f9cbbe"
end
