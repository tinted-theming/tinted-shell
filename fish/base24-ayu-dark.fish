...
set -l color00 "0b/0e/14" # Base 00 - Black
set -l color01 "f0/71/78" # Base 08 - Red
set -l color02 "aa/d9/4c" # Base 0B - Green
set -l color03 "ff/b4/54" # Base 0A - Yellow
set -l color04 "59/c2/ff" # Base 0D - Blue
set -l color05 "d2/a6/ff" # Base 0E - Magenta
set -l color06 "95/e6/cb" # Base 0C - Cyan
set -l color07 "e6/e1/cf" # Base 05 - White
set -l color08 "3e/4b/59" # Base 03 - Bright Black
...
set -l color15 "f2/f0/e7" # Base 07 - Bright White
set -l color16 "ff/8f/40" # Base 09
set -l color17 "e6/b4/50" # Base 0F
set -l color18 "13/17/21" # Base 01
set -l color19 "20/22/29" # Base 02
set -l color20 "bf/bd/b6" # Base 04
set -l color21 "ec/e8/db" # Base 06
set -l color_foreground "e6/e1/cf" # Base 05
set -l color_background "0b/0e/14" # Base 00
...
set -U fish_color_end e6e1cf
set -U fish_color_error brred
set -U fish_color_param bfbdb6
set -U fish_color_valid_path --underline
set -U fish_color_option brcyan
set -U fish_color_comment 3e4b59
set -U fish_color_selection ece8db --bold --background=202229
set -U fish_color_operator brblue
set -U fish_color_escape brcyan
set -U fish_color_autosuggestion 3e4b59
...
set -U fish_color_search_match bryellow --background=202229
set -U fish_color_history_current --bold
set -U fish_pager_color_progress 131721 --background=bfbdb6
set -U fish_pager_color_background normal --background=0b0e14
set -U fish_pager_color_prefix normal --bold
set -U fish_pager_color_completion normal
set -U fish_pager_color_description ff8f40 --dim
set -U fish_pager_color_selected_background ece8db --background=202229
set -U fish_pager_color_selected_prefix ece8db --bold --background=202229
set -U fish_pager_color_selected_completion ece8db
...
# Set theme
set -Ux BASE24_THEME ayu-dark

# Optionally export variables
if test -n "$TINTED_SHELL_ENABLE_BASE24_VARS"; or test -n "$BASE24_SHELL_ENABLE_VARS"
  set -gx BASE24_COLOR_00_HEX "0b0e14"
  set -gx BASE24_COLOR_01_HEX "131721"
  set -gx BASE24_COLOR_02_HEX "202229"
  set -gx BASE24_COLOR_03_HEX "3e4b59"
  set -gx BASE24_COLOR_04_HEX "bfbdb6"
  set -gx BASE24_COLOR_05_HEX "e6e1cf"
  set -gx BASE24_COLOR_06_HEX "ece8db"
  set -gx BASE24_COLOR_07_HEX "f2f0e7"
  set -gx BASE24_COLOR_08_HEX "f07178"
  set -gx BASE24_COLOR_09_HEX "ff8f40"
  set -gx BASE24_COLOR_0A_HEX "ffb454"
  set -gx BASE24_COLOR_0B_HEX "aad94c"
  set -gx BASE24_COLOR_0C_HEX "95e6cb"
  set -gx BASE24_COLOR_0D_HEX "59c2ff"
  set -gx BASE24_COLOR_0E_HEX "d2a6ff"
  set -gx BASE24_COLOR_0F_HEX "e6b450"
end
