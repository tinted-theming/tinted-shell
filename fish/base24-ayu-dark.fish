...
set -U fish_color_selection ece8db --background=202229
set -U fish_color_operator magenta
set -U fish_color_escape ff8f40
...
set -U fish_color_search_match yellow --background=202229
set -U fish_color_history_current --underline=curly
set -U fish_pager_color_progress 131721 --background=bfbdb6
set -U fish_pager_color_background --background=0b0e14
set -U fish_pager_color_prefix --bold --italics
set -U fish_pager_color_completion normal
set -U fish_pager_color_description ff8f40
set -U fish_pager_color_selected_background --background=202229
set -U fish_pager_color_selected_prefix --bold --italics --background=202229
