...
set -l color02 "91/b8/59" # Base 0B - Green
set -l color03 "ff/b6/2c" # Base 0A - Yellow
set -l color04 "61/82/b8" # Base 0D - Blue
set -l color05 "7c/4d/ff" # Base 0E - Magenta
set -l color06 "39/ad/b5" # Base 0C - Cyan
set -l color07 "80/cb/c4" # Base 05 - White
set -l color08 "cc/d7/da" # Base 03 - Bright Black
...
set -l color16 "f7/6d/47" # Base 09
set -l color17 "e5/39/35" # Base 0F
set -l color18 "e7/ea/ec" # Base 01
set -l color19 "cc/ea/e7" # Base 02
set -l color20 "87/96/b0" # Base 04
set -l color21 "43/a3/9a" # Base 06
set -l color_foreground "80/cb/c4" # Base 05
...
set -U fish_color_end 80cbc4
set -U fish_color_error brred
set -U fish_color_param 8796b0
set -U fish_color_valid_path --underline
set -U fish_color_option brcyan
set -U fish_color_comment ccd7da
set -U fish_color_selection 43a39a --bold --background=cceae7
set -U fish_color_operator brblue
set -U fish_color_escape brcyan
set -U fish_color_autosuggestion ccd7da
...
set -U fish_pager_color_progress e7eaec --background=8796b0
set -U fish_pager_color_background normal --background=fafafa
set -U fish_pager_color_prefix normal --bold
set -U fish_pager_color_completion normal
set -U fish_pager_color_description f76d47 --dim
set -U fish_pager_color_selected_background 43a39a --background=cceae7
set -U fish_pager_color_selected_prefix 43a39a --bold --background=cceae7
set -U fish_pager_color_selected_completion 43a39a
...
# Set theme
set -Ux BASE16_THEME material-lighter

# Optionally export variables
if test -n "$TINTED_SHELL_ENABLE_BASE16_VARS"; or test -n "$BASE16_SHELL_ENABLE_VARS"
  set -gx BASE16_COLOR_00_HEX "fafafa"
  set -gx BASE16_COLOR_01_HEX "e7eaec"
  set -gx BASE16_COLOR_02_HEX "cceae7"
  set -gx BASE16_COLOR_03_HEX "ccd7da"
  set -gx BASE16_COLOR_04_HEX "8796b0"
  set -gx BASE16_COLOR_05_HEX "80cbc4"
  set -gx BASE16_COLOR_06_HEX "43a39a"
  set -gx BASE16_COLOR_07_HEX "000000"
  set -gx BASE16_COLOR_08_HEX "ff5370"
  set -gx BASE16_COLOR_09_HEX "f76d47"
  set -gx BASE16_COLOR_0A_HEX "ffb62c"
  set -gx BASE16_COLOR_0B_HEX "91b859"
  set -gx BASE16_COLOR_0C_HEX "39adb5"
  set -gx BASE16_COLOR_0D_HEX "6182b8"
  set -gx BASE16_COLOR_0E_HEX "7c4dff"
  set -gx BASE16_COLOR_0F_HEX "e53935"
end
