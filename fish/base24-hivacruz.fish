...
set -l color00 "13/25/37" # Base 00 - Black
...
set -l color_background "13/25/37" # Base 00
...
set -U fish_pager_color_background normal --background=132537
