...
set -l color00 "f9/f5/d7" # Base 00 - Black
set -l color01 "c1/4a/4a" # Base 08 - Red
set -l color02 "6c/78/2e" # Base 0B - Green
set -l color03 "b4/71/09" # Base 0A - Yellow
set -l color04 "45/70/7a" # Base 0D - Blue
set -l color05 "94/5e/80" # Base 0E - Magenta
set -l color06 "4c/7a/5d" # Base 0C - Cyan
set -l color07 "65/47/35" # Base 05 - White
set -l color08 "a8/99/84" # Base 03 - Bright Black
...
set -l color16 "c3/5e/0a" # Base 09
set -l color17 "e7/8a/4e" # Base 0F
set -l color18 "fb/f1/c7" # Base 01
set -l color19 "e0/cf/a9" # Base 02
set -l color20 "c9/b9/9a" # Base 04
set -l color21 "3c/38/36" # Base 06
set -l color_foreground "65/47/35" # Base 05
set -l color_background "f9/f5/d7" # Base 00
...
set -U fish_color_end 654735
set -U fish_color_error brred
set -U fish_color_param c9b99a
set -U fish_color_valid_path --underline
set -U fish_color_option brcyan
set -U fish_color_comment a89984
set -U fish_color_selection 3c3836 --bold --background=e0cfa9
...
set -U fish_color_search_match bryellow --background=e0cfa9
set -U fish_color_history_current --bold
set -U fish_pager_color_progress fbf1c7 --background=c9b99a
set -U fish_pager_color_background normal --background=f9f5d7
set -U fish_pager_color_prefix normal --bold
set -U fish_pager_color_completion normal
set -U fish_pager_color_description c35e0a --dim
set -U fish_pager_color_selected_background 3c3836 --background=e0cfa9
set -U fish_pager_color_selected_prefix 3c3836 --bold --background=e0cfa9
set -U fish_pager_color_selected_completion 3c3836
...
# Set theme
set -Ux BASE16_THEME gruvbox-material-light-hard

# Optionally export variables
if test -n "$TINTED_SHELL_ENABLE_BASE16_VARS"; or test -n "$BASE16_SHELL_ENABLE_VARS"
  set -gx BASE16_COLOR_00_HEX "f9f5d7"
  set -gx BASE16_COLOR_01_HEX "fbf1c7"
  set -gx BASE16_COLOR_02_HEX "e0cfa9"
  set -gx BASE16_COLOR_03_HEX "a89984"
  set -gx BASE16_COLOR_04_HEX "c9b99a"
  set -gx BASE16_COLOR_05_HEX "654735"
  set -gx BASE16_COLOR_06_HEX "3c3836"
  set -gx BASE16_COLOR_07_HEX "282828"
  set -gx BASE16_COLOR_08_HEX "c14a4a"
  set -gx BASE16_COLOR_09_HEX "c35e0a"
  set -gx BASE16_COLOR_0A_HEX "b47109"
  set -gx BASE16_COLOR_0B_HEX "6c782e"
  set -gx BASE16_COLOR_0C_HEX "4c7a5d"
  set -gx BASE16_COLOR_0D_HEX "45707a"
  set -gx BASE16_COLOR_0E_HEX "945e80"
  set -gx BASE16_COLOR_0F_HEX "e78a4e"
end
