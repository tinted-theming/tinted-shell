...
set -U fish_color_selection 171717 --background=fffefe
set -U fish_color_operator magenta
set -U fish_color_escape ccb343
...
set -U fish_color_search_match yellow --background=fffefe
...
set -U fish_pager_color_description ccb343
set -U fish_pager_color_selected_background --background=fffefe
set -U fish_pager_color_selected_prefix --bold --italics --background=fffefe
