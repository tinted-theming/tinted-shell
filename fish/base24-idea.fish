...
set -l color01 "fb/52/55" # Base 08 - Red
set -l color02 "98/b6/1b" # Base 0B - Green
set -l color03 "6c/9b/ed" # Base 0A - Yellow
set -l color04 "43/7e/e6" # Base 0D - Blue
set -l color05 "9d/73/b0" # Base 0E - Magenta
set -l color06 "24/88/86" # Base 0C - Cyan
...
set -l color15 "17/17/17" # Base 07 - Bright White
set -l color16 "cc/b3/43" # Base 09
set -l color17 "7d/29/2a" # Base 0F
set -l color18 "ac/ac/ac" # Base 01
set -l color19 "ff/fe/fe" # Base 02
set -l color20 "8b/8b/8b" # Base 04
set -l color21 "17/17/17" # Base 06
...
set -U fish_color_param 8b8b8b
set -U fish_color_valid_path --underline
set -U fish_color_option brcyan
set -U fish_color_comment c5c5c5
set -U fish_color_selection 171717 --bold --background=fffefe
...
set -U fish_color_search_match bryellow --background=fffefe
set -U fish_color_history_current --bold
set -U fish_pager_color_progress acacac --background=8b8b8b
set -U fish_pager_color_background normal --background=202020
set -U fish_pager_color_prefix normal --bold
set -U fish_pager_color_completion normal
set -U fish_pager_color_description ccb343 --dim
set -U fish_pager_color_selected_background 171717 --background=fffefe
set -U fish_pager_color_selected_prefix 171717 --bold --background=fffefe
set -U fish_pager_color_selected_completion 171717
...
# Set theme
set -Ux BASE24_THEME idea

# Optionally export variables
if test -n "$TINTED_SHELL_ENABLE_BASE24_VARS"; or test -n "$BASE24_SHELL_ENABLE_VARS"
  set -gx BASE24_COLOR_00_HEX "202020"
  set -gx BASE24_COLOR_01_HEX "acacac"
  set -gx BASE24_COLOR_02_HEX "fffefe"
  set -gx BASE24_COLOR_03_HEX "c5c5c5"
  set -gx BASE24_COLOR_04_HEX "8b8b8b"
  set -gx BASE24_COLOR_05_HEX "515151"
  set -gx BASE24_COLOR_06_HEX "171717"
  set -gx BASE24_COLOR_07_HEX "171717"
  set -gx BASE24_COLOR_08_HEX "fb5255"
  set -gx BASE24_COLOR_09_HEX "ccb343"
  set -gx BASE24_COLOR_0A_HEX "6c9bed"
  set -gx BASE24_COLOR_0B_HEX "98b61b"
  set -gx BASE24_COLOR_0C_HEX "248886"
  set -gx BASE24_COLOR_0D_HEX "437ee6"
  set -gx BASE24_COLOR_0E_HEX "9d73b0"
