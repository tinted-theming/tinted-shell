...
set -l color03 "c1/84/01" # Base 0A - Yellow
...
set -l color18 "f0/f0/f1" # Base 01
set -l color19 "e5/e5/e6" # Base 02
...
set -U fish_color_selection 202227 --bold --background=e5e5e6
...
set -U fish_pager_color_progress f0f0f1 --background=696c77
...
set -U fish_pager_color_selected_background 202227 --background=e5e5e6
set -U fish_pager_color_selected_prefix 202227 --bold --background=e5e5e6
...
# Set theme
set -Ux BASE16_THEME one-light

# Optionally export variables
if test -n "$TINTED_SHELL_ENABLE_BASE16_VARS"; or test -n "$BASE16_SHELL_ENABLE_VARS"
  set -gx BASE16_COLOR_00_HEX "fafafa"
  set -gx BASE16_COLOR_01_HEX "f0f0f1"
  set -gx BASE16_COLOR_02_HEX "e5e5e6"
  set -gx BASE16_COLOR_03_HEX "a0a1a7"
  set -gx BASE16_COLOR_04_HEX "696c77"
  set -gx BASE16_COLOR_05_HEX "383a42"
  set -gx BASE16_COLOR_06_HEX "202227"
  set -gx BASE16_COLOR_07_HEX "090a0b"
  set -gx BASE16_COLOR_08_HEX "ca1243"
  set -gx BASE16_COLOR_09_HEX "d75f00"
  set -gx BASE16_COLOR_0A_HEX "c18401"
  set -gx BASE16_COLOR_0B_HEX "50a14f"
  set -gx BASE16_COLOR_0C_HEX "0184bc"
  set -gx BASE16_COLOR_0D_HEX "4078f2"
  set -gx BASE16_COLOR_0E_HEX "a626a4"
  set -gx BASE16_COLOR_0F_HEX "986801"
end
