...
set -U fish_color_selection f0f1ce --background=674c31
set -U fish_color_operator magenta
set -U fish_color_escape e3cd7b
...
set -U fish_color_search_match yellow --background=674c31
set -U fish_color_history_current --underline=curly
set -U fish_pager_color_progress 6e5246 --background=ab9e7f
set -U fish_pager_color_background --background=0a1e24
set -U fish_pager_color_prefix --bold --italics
set -U fish_pager_color_completion normal
set -U fish_pager_color_description e3cd7b
set -U fish_pager_color_selected_background --background=674c31
set -U fish_pager_color_selected_prefix --bold --italics --background=674c31
