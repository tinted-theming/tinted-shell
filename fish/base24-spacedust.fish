...
set -l color00 "0a/1e/24" # Base 00 - Black
set -l color01 "e3/5a/00" # Base 08 - Red
set -l color02 "5c/ab/96" # Base 0B - Green
set -l color03 "67/a0/cd" # Base 0A - Yellow
set -l color04 "0e/54/8b" # Base 0D - Blue
set -l color05 "e3/5a/00" # Base 0E - Magenta
set -l color06 "06/af/c7" # Base 0C - Cyan
set -l color07 "cd/c7/a6" # Base 05 - White
set -l color08 "89/75/58" # Base 03 - Bright Black
...
set -l color15 "fe/ff/f0" # Base 07 - Bright White
set -l color16 "e3/cd/7b" # Base 09
set -l color17 "71/2d/00" # Base 0F
set -l color18 "6e/52/46" # Base 01
set -l color19 "67/4c/31" # Base 02
set -l color20 "ab/9e/7f" # Base 04
set -l color21 "f0/f1/ce" # Base 06
set -l color_foreground "cd/c7/a6" # Base 05
set -l color_background "0a/1e/24" # Base 00
...
set -U fish_color_end cdc7a6
set -U fish_color_error brred
set -U fish_color_param ab9e7f
set -U fish_color_valid_path --underline
set -U fish_color_option brcyan
set -U fish_color_comment 897558
set -U fish_color_selection f0f1ce --bold --background=674c31
set -U fish_color_operator brblue
set -U fish_color_escape brcyan
set -U fish_color_autosuggestion 897558
...
set -U fish_color_search_match bryellow --background=674c31
set -U fish_color_history_current --bold
set -U fish_pager_color_progress 6e5246 --background=ab9e7f
set -U fish_pager_color_background normal --background=0a1e24
set -U fish_pager_color_prefix normal --bold
set -U fish_pager_color_completion normal
set -U fish_pager_color_description e3cd7b --dim
set -U fish_pager_color_selected_background f0f1ce --background=674c31
set -U fish_pager_color_selected_prefix f0f1ce --bold --background=674c31
set -U fish_pager_color_selected_completion f0f1ce
...
# Set theme
set -Ux BASE24_THEME spacedust

# Optionally export variables
if test -n "$TINTED_SHELL_ENABLE_BASE24_VARS"; or test -n "$BASE24_SHELL_ENABLE_VARS"
  set -gx BASE24_COLOR_00_HEX "0a1e24"
  set -gx BASE24_COLOR_01_HEX "6e5246"
  set -gx BASE24_COLOR_02_HEX "674c31"
  set -gx BASE24_COLOR_03_HEX "897558"
  set -gx BASE24_COLOR_04_HEX "ab9e7f"
  set -gx BASE24_COLOR_05_HEX "cdc7a6"
  set -gx BASE24_COLOR_06_HEX "f0f1ce"
  set -gx BASE24_COLOR_07_HEX "fefff0"
  set -gx BASE24_COLOR_08_HEX "e35a00"
  set -gx BASE24_COLOR_09_HEX "e3cd7b"
  set -gx BASE24_COLOR_0A_HEX "67a0cd"
  set -gx BASE24_COLOR_0B_HEX "5cab96"
  set -gx BASE24_COLOR_0C_HEX "06afc7"
  set -gx BASE24_COLOR_0D_HEX "0e548b"
  set -gx BASE24_COLOR_0E_HEX "e35a00"
  set -gx BASE24_COLOR_0F_HEX "712d00"
end
