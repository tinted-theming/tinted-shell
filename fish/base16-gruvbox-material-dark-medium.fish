...
set -l color00 "29/28/28" # Base 00 - Black
...
set -l color_background "29/28/28" # Base 00
...
set -U fish_color_selection ebdbb2 --bold --background=504945
...
set -U fish_pager_color_progress 32302f --background=bdae93
set -U fish_pager_color_background normal --background=292828
set -U fish_pager_color_prefix normal --bold
set -U fish_pager_color_completion normal
set -U fish_pager_color_description e78a4e --dim
set -U fish_pager_color_selected_background ebdbb2 --background=504945
set -U fish_pager_color_selected_prefix ebdbb2 --bold --background=504945
...
# Set theme
set -Ux BASE16_THEME gruvbox-material-dark-medium

# Optionally export variables
if test -n "$TINTED_SHELL_ENABLE_BASE16_VARS"; or test -n "$BASE16_SHELL_ENABLE_VARS"
  set -gx BASE16_COLOR_00_HEX "292828"
