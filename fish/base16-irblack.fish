...
set -l color01 "ff/6c/60" # Base 08 - Red
set -l color02 "a8/ff/60" # Base 0B - Green
set -l color03 "ff/ff/b6" # Base 0A - Yellow
set -l color04 "96/cb/fe" # Base 0D - Blue
set -l color05 "ff/73/fd" # Base 0E - Magenta
set -l color06 "c6/c5/fe" # Base 0C - Cyan
set -l color07 "b5/b3/aa" # Base 05 - White
set -l color08 "6c/6c/66" # Base 03 - Bright Black
...
set -l color15 "fd/fb/ee" # Base 07 - Bright White
set -l color16 "e9/c0/62" # Base 09
set -l color17 "b1/8a/3d" # Base 0F
set -l color18 "24/24/22" # Base 01
set -l color19 "48/48/44" # Base 02
set -l color20 "91/8f/88" # Base 04
set -l color21 "d9/d7/cc" # Base 06
set -l color_foreground "b5/b3/aa" # Base 05
...
set -U fish_color_end b5b3aa
set -U fish_color_error brred
set -U fish_color_param 918f88
set -U fish_color_valid_path --underline
set -U fish_color_option brcyan
set -U fish_color_comment 6c6c66
set -U fish_color_selection d9d7cc --bold --background=484844
set -U fish_color_operator brblue
set -U fish_color_escape brcyan
set -U fish_color_autosuggestion 6c6c66
...
set -U fish_pager_color_progress 242422 --background=918f88
set -U fish_pager_color_background normal --background=000000
set -U fish_pager_color_prefix normal --bold
set -U fish_pager_color_completion normal
set -U fish_pager_color_description e9c062 --dim
set -U fish_pager_color_selected_background d9d7cc --background=484844
set -U fish_pager_color_selected_prefix d9d7cc --bold --background=484844
set -U fish_pager_color_selected_completion d9d7cc
...
# Set theme
set -Ux BASE16_THEME irblack

# Optionally export variables
if test -n "$TINTED_SHELL_ENABLE_BASE16_VARS"; or test -n "$BASE16_SHELL_ENABLE_VARS"
  set -gx BASE16_COLOR_00_HEX "000000"
  set -gx BASE16_COLOR_01_HEX "242422"
  set -gx BASE16_COLOR_02_HEX "484844"
  set -gx BASE16_COLOR_03_HEX "6c6c66"
  set -gx BASE16_COLOR_04_HEX "918f88"
  set -gx BASE16_COLOR_05_HEX "b5b3aa"
  set -gx BASE16_COLOR_06_HEX "d9d7cc"
  set -gx BASE16_COLOR_07_HEX "fdfbee"
  set -gx BASE16_COLOR_08_HEX "ff6c60"
  set -gx BASE16_COLOR_09_HEX "e9c062"
  set -gx BASE16_COLOR_0A_HEX "ffffb6"
  set -gx BASE16_COLOR_0B_HEX "a8ff60"
  set -gx BASE16_COLOR_0C_HEX "c6c5fe"
  set -gx BASE16_COLOR_0D_HEX "96cbfe"
  set -gx BASE16_COLOR_0E_HEX "ff73fd"
  set -gx BASE16_COLOR_0F_HEX "b18a3d"
end
