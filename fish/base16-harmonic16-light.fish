...
set -l color00 "f7/f9/fb" # Base 00 - Black
set -l color01 "bf/8b/56" # Base 08 - Red
set -l color02 "56/bf/8b" # Base 0B - Green
set -l color03 "8b/bf/56" # Base 0A - Yellow
set -l color04 "8b/56/bf" # Base 0D - Blue
set -l color05 "bf/56/8b" # Base 0E - Magenta
set -l color06 "56/8b/bf" # Base 0C - Cyan
set -l color07 "40/5c/79" # Base 05 - White
set -l color08 "aa/bc/ce" # Base 03 - Bright Black
...
set -l color15 "0b/1c/2c" # Base 07 - Bright White
set -l color16 "bf/bf/56" # Base 09
set -l color17 "bf/56/56" # Base 0F
set -l color18 "e5/eb/f1" # Base 01
set -l color19 "cb/d6/e2" # Base 02
set -l color20 "62/7e/99" # Base 04
set -l color21 "22/3b/54" # Base 06
set -l color_foreground "40/5c/79" # Base 05
set -l color_background "f7/f9/fb" # Base 00
...
set -U fish_color_end 405c79
set -U fish_color_error brred
set -U fish_color_param 627e99
set -U fish_color_valid_path --underline
set -U fish_color_option brcyan
set -U fish_color_comment aabcce
set -U fish_color_selection 223b54 --bold --background=cbd6e2
set -U fish_color_operator brblue
set -U fish_color_escape brcyan
set -U fish_color_autosuggestion aabcce
...
set -U fish_pager_color_progress e5ebf1 --background=627e99
set -U fish_pager_color_background normal --background=f7f9fb
set -U fish_pager_color_prefix normal --bold
set -U fish_pager_color_completion normal
set -U fish_pager_color_description bfbf56 --dim
set -U fish_pager_color_selected_background 223b54 --background=cbd6e2
set -U fish_pager_color_selected_prefix 223b54 --bold --background=cbd6e2
set -U fish_pager_color_selected_completion 223b54
...
# Set theme
set -Ux BASE16_THEME harmonic16-light

# Optionally export variables
if test -n "$TINTED_SHELL_ENABLE_BASE16_VARS"; or test -n "$BASE16_SHELL_ENABLE_VARS"
  set -gx BASE16_COLOR_00_HEX "f7f9fb"
  set -gx BASE16_COLOR_01_HEX "e5ebf1"
  set -gx BASE16_COLOR_02_HEX "cbd6e2"
  set -gx BASE16_COLOR_03_HEX "aabcce"
  set -gx BASE16_COLOR_04_HEX "627e99"
  set -gx BASE16_COLOR_05_HEX "405c79"
  set -gx BASE16_COLOR_06_HEX "223b54"
  set -gx BASE16_COLOR_07_HEX "0b1c2c"
  set -gx BASE16_COLOR_08_HEX "bf8b56"
  set -gx BASE16_COLOR_09_HEX "bfbf56"
  set -gx BASE16_COLOR_0A_HEX "8bbf56"
  set -gx BASE16_COLOR_0B_HEX "56bf8b"
  set -gx BASE16_COLOR_0C_HEX "568bbf"
  set -gx BASE16_COLOR_0D_HEX "8b56bf"
  set -gx BASE16_COLOR_0E_HEX "bf568b"
  set -gx BASE16_COLOR_0F_HEX "bf5656"
end
