...
set -U fish_color_selection d9d9d9 --background=262626
set -U fish_color_operator magenta
set -U fish_color_escape b8b87a
...
set -U fish_pager_color_background --background=0d1926
set -U fish_pager_color_prefix --bold --italics
set -U fish_pager_color_completion normal
set -U fish_pager_color_description b8b87a
