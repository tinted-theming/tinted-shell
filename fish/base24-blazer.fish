...
set -l color00 "0d/19/26" # Base 00 - Black
set -l color01 "b8/7a/7a" # Base 08 - Red
set -l color02 "7a/b8/7a" # Base 0B - Green
set -l color03 "bd/bd/db" # Base 0A - Yellow
set -l color04 "7a/7a/b8" # Base 0D - Blue
set -l color05 "b8/7a/b8" # Base 0E - Magenta
set -l color06 "7a/b8/b8" # Base 0C - Cyan
set -l color07 "ac/ac/ac" # Base 05 - White
...
set -l color16 "b8/b8/7a" # Base 09
set -l color17 "5c/3d/3d" # Base 0F
set -l color18 "00/00/00" # Base 01
set -l color19 "26/26/26" # Base 02
set -l color20 "7f/7f/7f" # Base 04
set -l color21 "d9/d9/d9" # Base 06
set -l color_foreground "ac/ac/ac" # Base 05
set -l color_background "0d/19/26" # Base 00
...
set -U fish_color_end acacac
set -U fish_color_error brred
set -U fish_color_param 7f7f7f
set -U fish_color_valid_path --underline
set -U fish_color_option brcyan
set -U fish_color_comment 525252
set -U fish_color_selection d9d9d9 --bold --background=262626
...
set -U fish_pager_color_progress 000000 --background=7f7f7f
set -U fish_pager_color_background normal --background=0d1926
set -U fish_pager_color_prefix normal --bold
set -U fish_pager_color_completion normal
set -U fish_pager_color_description b8b87a --dim
set -U fish_pager_color_selected_background d9d9d9 --background=262626
set -U fish_pager_color_selected_prefix d9d9d9 --bold --background=262626
...
# Set theme
set -Ux BASE24_THEME blazer

# Optionally export variables
if test -n "$TINTED_SHELL_ENABLE_BASE24_VARS"; or test -n "$BASE24_SHELL_ENABLE_VARS"
  set -gx BASE24_COLOR_00_HEX "0d1926"
  set -gx BASE24_COLOR_01_HEX "000000"
  set -gx BASE24_COLOR_02_HEX "262626"
  set -gx BASE24_COLOR_03_HEX "525252"
  set -gx BASE24_COLOR_04_HEX "7f7f7f"
  set -gx BASE24_COLOR_05_HEX "acacac"
  set -gx BASE24_COLOR_06_HEX "d9d9d9"
  set -gx BASE24_COLOR_07_HEX "ffffff"
  set -gx BASE24_COLOR_08_HEX "b87a7a"
  set -gx BASE24_COLOR_09_HEX "b8b87a"
  set -gx BASE24_COLOR_0A_HEX "bdbddb"
  set -gx BASE24_COLOR_0B_HEX "7ab87a"
  set -gx BASE24_COLOR_0C_HEX "7ab8b8"
  set -gx BASE24_COLOR_0D_HEX "7a7ab8"
  set -gx BASE24_COLOR_0E_HEX "b87ab8"
  set -gx BASE24_COLOR_0F_HEX "5c3d3d"
end
