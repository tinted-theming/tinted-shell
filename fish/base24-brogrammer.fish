...
set -U fish_color_selection e3e6ed --background=2a3141
set -U fish_color_operator magenta
set -U fish_color_escape ecb90f
...
set -U fish_color_search_match yellow --background=2a3141
set -U fish_color_history_current --underline=curly
set -U fish_pager_color_progress 1f1f1f --background=d6dae4
set -U fish_pager_color_background --background=131313
set -U fish_pager_color_prefix --bold --italics
set -U fish_pager_color_completion normal
set -U fish_pager_color_description ecb90f
set -U fish_pager_color_selected_background --background=2a3141
set -U fish_pager_color_selected_prefix --bold --italics --background=2a3141
