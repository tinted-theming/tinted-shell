...
set -l color00 "13/13/13" # Base 00 - Black
set -l color01 "f7/11/18" # Base 08 - Red
set -l color02 "2c/c5/5d" # Base 0B - Green
set -l color03 "0f/80/d5" # Base 0A - Yellow
set -l color04 "2a/84/d2" # Base 0D - Blue
set -l color05 "4e/59/b7" # Base 0E - Magenta
set -l color06 "0f/80/d5" # Base 0C - Cyan
set -l color07 "c1/c8/d7" # Base 05 - White
set -l color08 "34/3d/50" # Base 03 - Bright Black
...
set -l color16 "ec/b9/0f" # Base 09
set -l color17 "7b/08/0c" # Base 0F
set -l color18 "1f/1f/1f" # Base 01
set -l color19 "2a/31/41" # Base 02
set -l color20 "d6/da/e4" # Base 04
set -l color21 "e3/e6/ed" # Base 06
set -l color_foreground "c1/c8/d7" # Base 05
set -l color_background "13/13/13" # Base 00
...
set -U fish_color_end c1c8d7
set -U fish_color_error brred
set -U fish_color_param d6dae4
set -U fish_color_valid_path --underline
set -U fish_color_option brcyan
set -U fish_color_comment 343d50
set -U fish_color_selection e3e6ed --bold --background=2a3141
set -U fish_color_operator brblue
set -U fish_color_escape brcyan
set -U fish_color_autosuggestion 343d50
...
set -U fish_color_search_match bryellow --background=2a3141
set -U fish_color_history_current --bold
set -U fish_pager_color_progress 1f1f1f --background=d6dae4
set -U fish_pager_color_background normal --background=131313
set -U fish_pager_color_prefix normal --bold
set -U fish_pager_color_completion normal
set -U fish_pager_color_description ecb90f --dim
set -U fish_pager_color_selected_background e3e6ed --background=2a3141
set -U fish_pager_color_selected_prefix e3e6ed --bold --background=2a3141
set -U fish_pager_color_selected_completion e3e6ed
...
# Set theme
set -Ux BASE24_THEME brogrammer

# Optionally export variables
if test -n "$TINTED_SHELL_ENABLE_BASE24_VARS"; or test -n "$BASE24_SHELL_ENABLE_VARS"
  set -gx BASE24_COLOR_00_HEX "131313"
  set -gx BASE24_COLOR_01_HEX "1f1f1f"
  set -gx BASE24_COLOR_02_HEX "2a3141"
  set -gx BASE24_COLOR_03_HEX "343d50"
  set -gx BASE24_COLOR_04_HEX "d6dae4"
  set -gx BASE24_COLOR_05_HEX "c1c8d7"
  set -gx BASE24_COLOR_06_HEX "e3e6ed"
  set -gx BASE24_COLOR_07_HEX "ffffff"
  set -gx BASE24_COLOR_08_HEX "f71118"
  set -gx BASE24_COLOR_09_HEX "ecb90f"
  set -gx BASE24_COLOR_0A_HEX "0f80d5"
  set -gx BASE24_COLOR_0B_HEX "2cc55d"
  set -gx BASE24_COLOR_0C_HEX "0f80d5"
  set -gx BASE24_COLOR_0D_HEX "2a84d2"
  set -gx BASE24_COLOR_0E_HEX "4e59b7"
  set -gx BASE24_COLOR_0F_HEX "7b080c"
end
