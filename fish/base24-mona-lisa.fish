...
set -l color00 "11/0b/0d" # Base 00 - Black
set -l color01 "9b/28/1b" # Base 08 - Red
set -l color02 "62/61/32" # Base 0B - Green
set -l color03 "9e/b2/b3" # Base 0A - Yellow
set -l color04 "51/5b/5c" # Base 0D - Blue
set -l color05 "9b/1d/29" # Base 0E - Magenta
set -l color06 "58/80/56" # Base 0C - Cyan
set -l color07 "da/b1/4e" # Base 05 - White
set -l color08 "a2/67/34" # Base 03 - Bright Black
...
set -l color15 "ff/e5/97" # Base 07 - Bright White
set -l color16 "c2/6e/27" # Base 09
set -l color17 "4d/14/0d" # Base 0F
set -l color18 "34/1a/0d" # Base 01
set -l color19 "87/42/27" # Base 02
set -l color20 "be/8c/41" # Base 04
set -l color21 "f6/d7/5c" # Base 06
set -l color_foreground "da/b1/4e" # Base 05
set -l color_background "11/0b/0d" # Base 00
...
set -U fish_color_end dab14e
set -U fish_color_error brred
set -U fish_color_param be8c41
set -U fish_color_valid_path --underline
set -U fish_color_option brcyan
set -U fish_color_comment a26734
set -U fish_color_selection f6d75c --bold --background=874227
set -U fish_color_operator brblue
set -U fish_color_escape brcyan
set -U fish_color_autosuggestion a26734
...
set -U fish_color_search_match bryellow --background=874227
set -U fish_color_history_current --bold
set -U fish_pager_color_progress 341a0d --background=be8c41
set -U fish_pager_color_background normal --background=110b0d
set -U fish_pager_color_prefix normal --bold
set -U fish_pager_color_completion normal
set -U fish_pager_color_description c26e27 --dim
set -U fish_pager_color_selected_background f6d75c --background=874227
set -U fish_pager_color_selected_prefix f6d75c --bold --background=874227
set -U fish_pager_color_selected_completion f6d75c
...
# Set theme
set -Ux BASE24_THEME mona-lisa

# Optionally export variables
if test -n "$TINTED_SHELL_ENABLE_BASE24_VARS"; or test -n "$BASE24_SHELL_ENABLE_VARS"
  set -gx BASE24_COLOR_00_HEX "110b0d"
  set -gx BASE24_COLOR_01_HEX "341a0d"
  set -gx BASE24_COLOR_02_HEX "874227"
  set -gx BASE24_COLOR_03_HEX "a26734"
  set -gx BASE24_COLOR_04_HEX "be8c41"
  set -gx BASE24_COLOR_05_HEX "dab14e"
  set -gx BASE24_COLOR_06_HEX "f6d75c"
  set -gx BASE24_COLOR_07_HEX "ffe597"
  set -gx BASE24_COLOR_08_HEX "9b281b"
  set -gx BASE24_COLOR_09_HEX "c26e27"
  set -gx BASE24_COLOR_0A_HEX "9eb2b3"
  set -gx BASE24_COLOR_0B_HEX "626132"
  set -gx BASE24_COLOR_0C_HEX "588056"
  set -gx BASE24_COLOR_0D_HEX "515b5c"
  set -gx BASE24_COLOR_0E_HEX "9b1d29"
  set -gx BASE24_COLOR_0F_HEX "4d140d"
end
