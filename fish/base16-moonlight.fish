...
set -l color01 "ff/53/70" # Base 08 - Red
set -l color02 "2d/f4/c0" # Base 0B - Green
set -l color03 "ff/c7/77" # Base 0A - Yellow
set -l color04 "40/ff/ff" # Base 0D - Blue
set -l color05 "b9/94/f1" # Base 0E - Magenta
set -l color06 "04/d1/f9" # Base 0C - Cyan
set -l color07 "a3/ac/e1" # Base 05 - White
set -l color08 "74/8c/d6" # Base 03 - Bright Black
...
set -l color15 "ef/43/fa" # Base 07 - Bright White
set -l color16 "f6/7f/81" # Base 09
set -l color17 "ec/b2/f0" # Base 0F
set -l color18 "40/3c/64" # Base 01
set -l color19 "59/63/99" # Base 02
set -l color20 "a1/ab/e0" # Base 04
set -l color21 "b4/a4/f4" # Base 06
set -l color_foreground "a3/ac/e1" # Base 05
...
set -U fish_color_end a3ace1
set -U fish_color_error brred
set -U fish_color_param a1abe0
set -U fish_color_valid_path --underline
set -U fish_color_option brcyan
set -U fish_color_comment 748cd6
set -U fish_color_selection b4a4f4 --bold --background=596399
set -U fish_color_operator brblue
set -U fish_color_escape brcyan
set -U fish_color_autosuggestion 748cd6
...
set -U fish_color_search_match bryellow --background=596399
set -U fish_color_history_current --bold
set -U fish_pager_color_progress 403c64 --background=a1abe0
set -U fish_pager_color_background normal --background=212337
set -U fish_pager_color_prefix normal --bold
set -U fish_pager_color_completion normal
set -U fish_pager_color_description f67f81 --dim
set -U fish_pager_color_selected_background b4a4f4 --background=596399
set -U fish_pager_color_selected_prefix b4a4f4 --bold --background=596399
set -U fish_pager_color_selected_completion b4a4f4
...
# Set theme
set -Ux BASE16_THEME moonlight

# Optionally export variables
if test -n "$TINTED_SHELL_ENABLE_BASE16_VARS"; or test -n "$BASE16_SHELL_ENABLE_VARS"
  set -gx BASE16_COLOR_00_HEX "212337"
  set -gx BASE16_COLOR_01_HEX "403c64"
  set -gx BASE16_COLOR_02_HEX "596399"
  set -gx BASE16_COLOR_03_HEX "748cd6"
  set -gx BASE16_COLOR_04_HEX "a1abe0"
  set -gx BASE16_COLOR_05_HEX "a3ace1"
  set -gx BASE16_COLOR_06_HEX "b4a4f4"
  set -gx BASE16_COLOR_07_HEX "ef43fa"
  set -gx BASE16_COLOR_08_HEX "ff5370"
  set -gx BASE16_COLOR_09_HEX "f67f81"
  set -gx BASE16_COLOR_0A_HEX "ffc777"
  set -gx BASE16_COLOR_0B_HEX "2df4c0"
  set -gx BASE16_COLOR_0C_HEX "04d1f9"
  set -gx BASE16_COLOR_0D_HEX "40ffff"
  set -gx BASE16_COLOR_0E_HEX "b994f1"
  set -gx BASE16_COLOR_0F_HEX "ecb2f0"
end
