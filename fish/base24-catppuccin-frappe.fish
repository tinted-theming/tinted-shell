...
set -U fish_pager_color_background normal --background=303446
set -U fish_pager_color_prefix normal --bold
set -U fish_pager_color_completion normal
set -U fish_pager_color_description ef9f76 --dim
set -U fish_pager_color_selected_background f2d5cf --background=414559
set -U fish_pager_color_selected_prefix f2d5cf --bold --background=414559
set -U fish_pager_color_selected_completion f2d5cf
...
# Set theme
set -Ux BASE24_THEME catppuccin-frappe

# Optionally export variables
if test -n "$TINTED_SHELL_ENABLE_BASE24_VARS"; or test -n "$BASE24_SHELL_ENABLE_VARS"
  set -gx BASE24_COLOR_00_HEX "303446"
  set -gx BASE24_COLOR_01_HEX "292c3c"
  set -gx BASE24_COLOR_02_HEX "414559"
  set -gx BASE24_COLOR_03_HEX "51576d"
  set -gx BASE24_COLOR_04_HEX "626880"
  set -gx BASE24_COLOR_05_HEX "c6d0f5"
  set -gx BASE24_COLOR_06_HEX "f2d5cf"
  set -gx BASE24_COLOR_07_HEX "babbf1"
  set -gx BASE24_COLOR_08_HEX "e78284"
  set -gx BASE24_COLOR_09_HEX "ef9f76"
  set -gx BASE24_COLOR_0A_HEX "e5c890"
  set -gx BASE24_COLOR_0B_HEX "a6d189"
  set -gx BASE24_COLOR_0C_HEX "81c8be"
  set -gx BASE24_COLOR_0D_HEX "8caaee"
  set -gx BASE24_COLOR_0E_HEX "ca9ee6"
  set -gx BASE24_COLOR_0F_HEX "eebebe"
end
