...
set -U fish_color_end bbb2ad
set -U fish_color_error brred
set -U fish_color_param 877e86
set -U fish_color_valid_path --underline
set -U fish_color_option brcyan
set -U fish_color_comment 534a5e
set -U fish_color_selection f0e7d5 --bold --background=1f1637
...
set -U fish_color_search_match bryellow --background=1f1637
set -U fish_color_history_current --bold
set -U fish_pager_color_progress 0a4b61 --background=877e86
set -U fish_pager_color_background normal --background=1c0b28
set -U fish_pager_color_prefix normal --bold
set -U fish_pager_color_completion normal
set -U fish_pager_color_description e9b8a7 --dim
set -U fish_pager_color_selected_background f0e7d5 --background=1f1637
set -U fish_pager_color_selected_prefix f0e7d5 --bold --background=1f1637
set -U fish_pager_color_selected_completion f0e7d5
