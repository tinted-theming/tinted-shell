...
set -U fish_color_selection cbccd1 --background=343a52
set -U fish_color_operator magenta
set -U fish_color_escape a9b1d6
...
set -U fish_color_search_match yellow --background=343a52
set -U fish_color_history_current --underline=curly
set -U fish_pager_color_progress 16161e --background=787c99
set -U fish_pager_color_background --background=24283b
set -U fish_pager_color_prefix --bold --italics
set -U fish_pager_color_completion normal
set -U fish_pager_color_description a9b1d6
set -U fish_pager_color_selected_background --background=343a52
set -U fish_pager_color_selected_prefix --bold --italics --background=343a52
