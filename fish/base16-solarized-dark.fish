...
set -l color00 "00/2b/36" # Base 00 - Black
...
set -l color05 "6c/71/c4" # Base 0E - Magenta
set -l color06 "2a/a1/98" # Base 0C - Cyan
set -l color07 "93/a1/a1" # Base 05 - White
set -l color08 "65/7b/83" # Base 03 - Bright Black
...
set -l color17 "d3/36/82" # Base 0F
set -l color18 "07/36/42" # Base 01
set -l color19 "58/6e/75" # Base 02
set -l color20 "83/94/96" # Base 04
set -l color21 "ee/e8/d5" # Base 06
set -l color_foreground "93/a1/a1" # Base 05
set -l color_background "00/2b/36" # Base 00
...
set -U fish_color_end 93a1a1
set -U fish_color_error brred
set -U fish_color_param 839496
set -U fish_color_valid_path --underline
set -U fish_color_option brcyan
set -U fish_color_comment 657b83
set -U fish_color_selection eee8d5 --bold --background=586e75
...
set -U fish_pager_color_progress 073642 --background=839496
set -U fish_pager_color_background normal --background=002b36
set -U fish_pager_color_prefix normal --bold
set -U fish_pager_color_completion normal
set -U fish_pager_color_description cb4b16 --dim
set -U fish_pager_color_selected_background eee8d5 --background=586e75
set -U fish_pager_color_selected_prefix eee8d5 --bold --background=586e75
set -U fish_pager_color_selected_completion eee8d5
...
# Set theme
set -Ux BASE16_THEME solarized-dark

# Optionally export variables
if test -n "$TINTED_SHELL_ENABLE_BASE16_VARS"; or test -n "$BASE16_SHELL_ENABLE_VARS"
  set -gx BASE16_COLOR_00_HEX "002b36"
  set -gx BASE16_COLOR_01_HEX "073642"
  set -gx BASE16_COLOR_02_HEX "586e75"
  set -gx BASE16_COLOR_03_HEX "657b83"
  set -gx BASE16_COLOR_04_HEX "839496"
  set -gx BASE16_COLOR_05_HEX "93a1a1"
  set -gx BASE16_COLOR_06_HEX "eee8d5"
  set -gx BASE16_COLOR_07_HEX "fdf6e3"
  set -gx BASE16_COLOR_08_HEX "dc322f"
  set -gx BASE16_COLOR_09_HEX "cb4b16"
  set -gx BASE16_COLOR_0A_HEX "b58900"
  set -gx BASE16_COLOR_0B_HEX "859900"
  set -gx BASE16_COLOR_0C_HEX "2aa198"
  set -gx BASE16_COLOR_0D_HEX "268bd2"
  set -gx BASE16_COLOR_0E_HEX "6c71c4"
  set -gx BASE16_COLOR_0F_HEX "d33682"
end
