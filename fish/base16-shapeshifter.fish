...
set -l color00 "f9/f9/f9" # Base 00 - Black
set -l color01 "e9/2f/2f" # Base 08 - Red
set -l color02 "0e/d8/39" # Base 0B - Green
set -l color03 "dd/dd/13" # Base 0A - Yellow
set -l color04 "3b/48/e3" # Base 0D - Blue
set -l color05 "f9/96/e2" # Base 0E - Magenta
set -l color06 "23/ed/da" # Base 0C - Cyan
set -l color07 "10/20/15" # Base 05 - White
set -l color08 "55/55/55" # Base 03 - Bright Black
...
set -l color16 "e0/94/48" # Base 09
set -l color17 "69/54/2d" # Base 0F
set -l color18 "e0/e0/e0" # Base 01
set -l color19 "ab/ab/ab" # Base 02
set -l color20 "34/34/34" # Base 04
set -l color21 "04/04/04" # Base 06
set -l color_foreground "10/20/15" # Base 05
set -l color_background "f9/f9/f9" # Base 00
...
set -U fish_pager_color_progress e0e0e0 --background=343434
set -U fish_pager_color_background normal --background=f9f9f9
set -U fish_pager_color_prefix normal --bold
set -U fish_pager_color_completion normal
set -U fish_pager_color_description e09448 --dim
set -U fish_pager_color_selected_background 040404 --background=ababab
set -U fish_pager_color_selected_prefix 040404 --bold --background=ababab
set -U fish_pager_color_selected_completion 040404
...
# Set theme
set -Ux BASE16_THEME shapeshifter

# Optionally export variables
if test -n "$TINTED_SHELL_ENABLE_BASE16_VARS"; or test -n "$BASE16_SHELL_ENABLE_VARS"
  set -gx BASE16_COLOR_00_HEX "f9f9f9"
  set -gx BASE16_COLOR_01_HEX "e0e0e0"
  set -gx BASE16_COLOR_02_HEX "ababab"
  set -gx BASE16_COLOR_03_HEX "555555"
  set -gx BASE16_COLOR_04_HEX "343434"
  set -gx BASE16_COLOR_05_HEX "102015"
  set -gx BASE16_COLOR_06_HEX "040404"
  set -gx BASE16_COLOR_07_HEX "000000"
  set -gx BASE16_COLOR_08_HEX "e92f2f"
  set -gx BASE16_COLOR_09_HEX "e09448"
  set -gx BASE16_COLOR_0A_HEX "dddd13"
  set -gx BASE16_COLOR_0B_HEX "0ed839"
  set -gx BASE16_COLOR_0C_HEX "23edda"
  set -gx BASE16_COLOR_0D_HEX "3b48e3"
  set -gx BASE16_COLOR_0E_HEX "f996e2"
  set -gx BASE16_COLOR_0F_HEX "69542d"
end
