...
set -l color02 "72/89/05" # Base 0B - Green
set -l color03 "70/81/83" # Base 0A - Yellow
set -l color04 "20/75/c7" # Base 0D - Blue
set -l color05 "c6/1b/6e" # Base 0E - Magenta
set -l color06 "25/91/85" # Base 0C - Cyan
set -l color07 "c0/c0/b0" # Base 05 - White
set -l color08 "6e/7c/7b" # Base 03 - Bright Black
...
set -l color19 "46/5a/61" # Base 02
set -l color20 "97/9e/96" # Base 04
set -l color21 "e9/e2/cb" # Base 06
set -l color_foreground "c0/c0/b0" # Base 05
...
set -U fish_color_end c0c0b0
set -U fish_color_error brred
set -U fish_color_param 979e96
set -U fish_color_valid_path --underline
set -U fish_color_option brcyan
set -U fish_color_comment 6e7c7b
set -U fish_color_selection e9e2cb --bold --background=465a61
set -U fish_color_operator brblue
set -U fish_color_escape brcyan
set -U fish_color_autosuggestion 6e7c7b
...
set -U fish_color_search_match bryellow --background=465a61
set -U fish_color_history_current --bold
set -U fish_pager_color_progress 002731 --background=979e96
...
set -U fish_pager_color_selected_background e9e2cb --background=465a61
set -U fish_pager_color_selected_prefix e9e2cb --bold --background=465a61
...
# Set theme
set -Ux BASE24_THEME solarized-dark-patched
...
if test -n "$TINTED_SHELL_ENABLE_BASE24_VARS"; or test -n "$BASE24_SHELL_ENABLE_VARS"
  ...
  set -gx BASE24_COLOR_02_HEX "465a61"
  set -gx BASE24_COLOR_03_HEX "6e7c7b"
  set -gx BASE24_COLOR_04_HEX "979e96"
  set -gx BASE24_COLOR_05_HEX "c0c0b0"
  ...
  set -gx BASE24_COLOR_0A_HEX "708183"
  set -gx BASE24_COLOR_0B_HEX "728905"
