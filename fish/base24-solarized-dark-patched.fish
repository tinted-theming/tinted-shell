...
set -U fish_color_selection e9e2cb --background=465a61
...
set -U fish_color_search_match yellow --background=465a61
...
set -U fish_pager_color_selected_background --background=465a61
set -U fish_pager_color_selected_prefix --bold --italics --background=465a61
