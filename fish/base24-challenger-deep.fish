...
set -l color00 "1e/1c/31" # Base 00 - Black
set -l color01 "ff/54/58" # Base 08 - Red
set -l color02 "62/d1/96" # Base 0B - Green
set -l color03 "91/dd/ff" # Base 0A - Yellow
set -l color04 "65/b2/ff" # Base 0D - Blue
set -l color05 "90/6c/ff" # Base 0E - Magenta
set -l color06 "63/f2/f1" # Base 0C - Cyan
set -l color07 "92/9b/b6" # Base 05 - White
set -l color08 "6a/6c/8a" # Base 03 - Bright Black
...
set -l color15 "cb/e3/e7" # Base 07 - Bright White
set -l color16 "ff/b3/78" # Base 09
set -l color17 "7f/2a/2c" # Base 0F
set -l color18 "14/11/27" # Base 01
set -l color19 "56/55/75" # Base 02
set -l color20 "7e/84/a0" # Base 04
set -l color21 "a6/b3/cc" # Base 06
set -l color_foreground "92/9b/b6" # Base 05
set -l color_background "1e/1c/31" # Base 00
...
set -U fish_color_end 929bb6
set -U fish_color_error brred
set -U fish_color_param 7e84a0
set -U fish_color_valid_path --underline
set -U fish_color_option brcyan
set -U fish_color_comment 6a6c8a
set -U fish_color_selection a6b3cc --bold --background=565575
set -U fish_color_operator brblue
set -U fish_color_escape brcyan
set -U fish_color_autosuggestion 6a6c8a
...
set -U fish_color_search_match bryellow --background=565575
set -U fish_color_history_current --bold
set -U fish_pager_color_progress 141127 --background=7e84a0
set -U fish_pager_color_background normal --background=1e1c31
set -U fish_pager_color_prefix normal --bold
set -U fish_pager_color_completion normal
set -U fish_pager_color_description ffb378 --dim
set -U fish_pager_color_selected_background a6b3cc --background=565575
set -U fish_pager_color_selected_prefix a6b3cc --bold --background=565575
set -U fish_pager_color_selected_completion a6b3cc
...
# Set theme
set -Ux BASE24_THEME challenger-deep

# Optionally export variables
if test -n "$TINTED_SHELL_ENABLE_BASE24_VARS"; or test -n "$BASE24_SHELL_ENABLE_VARS"
  set -gx BASE24_COLOR_00_HEX "1e1c31"
  set -gx BASE24_COLOR_01_HEX "141127"
  set -gx BASE24_COLOR_02_HEX "565575"
  set -gx BASE24_COLOR_03_HEX "6a6c8a"
  set -gx BASE24_COLOR_04_HEX "7e84a0"
  set -gx BASE24_COLOR_05_HEX "929bb6"
  set -gx BASE24_COLOR_06_HEX "a6b3cc"
  set -gx BASE24_COLOR_07_HEX "cbe3e7"
  set -gx BASE24_COLOR_08_HEX "ff5458"
  set -gx BASE24_COLOR_09_HEX "ffb378"
  set -gx BASE24_COLOR_0A_HEX "91ddff"
  set -gx BASE24_COLOR_0B_HEX "62d196"
  set -gx BASE24_COLOR_0C_HEX "63f2f1"
  set -gx BASE24_COLOR_0D_HEX "65b2ff"
  set -gx BASE24_COLOR_0E_HEX "906cff"
  set -gx BASE24_COLOR_0F_HEX "7f2a2c"
end
