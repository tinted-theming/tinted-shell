...
set -l color01 "fd/88/6b" # Base 08 - Red
set -l color02 "32/cc/dc" # Base 0B - Green
set -l color03 "fe/cb/6e" # Base 0A - Yellow
set -l color04 "20/bc/fc" # Base 0D - Blue
set -l color05 "ba/8c/fc" # Base 0E - Magenta
set -l color06 "ac/dd/fd" # Base 0C - Cyan
set -l color07 "d0/d0/d0" # Base 05 - White
set -l color08 "74/74/74" # Base 03 - Bright Black
...
set -l color16 "fc/47/69" # Base 09
set -l color17 "b1/5f/4a" # Base 0F
set -l color18 "15/15/15" # Base 01
set -l color19 "46/46/46" # Base 02
set -l color20 "b9/b9/b9" # Base 04
...
set -U fish_color_end d0d0d0
set -U fish_color_error brred
set -U fish_color_param b9b9b9
set -U fish_color_valid_path --underline
set -U fish_color_option brcyan
set -U fish_color_comment 747474
set -U fish_color_selection e8e8e8 --bold --background=464646
set -U fish_color_operator brblue
set -U fish_color_escape brcyan
set -U fish_color_autosuggestion 747474
...
set -U fish_pager_color_progress 151515 --background=b9b9b9
set -U fish_pager_color_background normal --background=181818
set -U fish_pager_color_prefix normal --bold
set -U fish_pager_color_completion normal
set -U fish_pager_color_description fc4769 --dim
set -U fish_pager_color_selected_background e8e8e8 --background=464646
set -U fish_pager_color_selected_prefix e8e8e8 --bold --background=464646
...
# Set theme
set -Ux BASE16_THEME framer

# Optionally export variables
if test -n "$TINTED_SHELL_ENABLE_BASE16_VARS"; or test -n "$BASE16_SHELL_ENABLE_VARS"
  set -gx BASE16_COLOR_00_HEX "181818"
  set -gx BASE16_COLOR_01_HEX "151515"
  set -gx BASE16_COLOR_02_HEX "464646"
  set -gx BASE16_COLOR_03_HEX "747474"
  set -gx BASE16_COLOR_04_HEX "b9b9b9"
  set -gx BASE16_COLOR_05_HEX "d0d0d0"
  set -gx BASE16_COLOR_06_HEX "e8e8e8"
  set -gx BASE16_COLOR_07_HEX "eeeeee"
  set -gx BASE16_COLOR_08_HEX "fd886b"
  set -gx BASE16_COLOR_09_HEX "fc4769"
  set -gx BASE16_COLOR_0A_HEX "fecb6e"
  set -gx BASE16_COLOR_0B_HEX "32ccdc"
  set -gx BASE16_COLOR_0C_HEX "acddfd"
  set -gx BASE16_COLOR_0D_HEX "20bcfc"
  set -gx BASE16_COLOR_0E_HEX "ba8cfc"
  set -gx BASE16_COLOR_0F_HEX "b15f4a"
end
