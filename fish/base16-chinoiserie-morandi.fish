...
set -l color01 "c0/60/61" # Base 08 - Red
set -l color02 "8c/a0/7b" # Base 0B - Green
set -l color03 "e5/bc/84" # Base 0A - Yellow
set -l color04 "83/9e/c9" # Base 0D - Blue
set -l color05 "98/a1/d8" # Base 0E - Magenta
set -l color06 "5e/8c/9b" # Base 0C - Cyan
...
set -l color16 "ff/93/7f" # Base 09
set -l color17 "d9/cd/b4" # Base 0F
...
set -U fish_pager_color_description ff937f --dim
...
# Set theme
set -Ux BASE16_THEME chinoiserie-morandi
...
if test -n "$TINTED_SHELL_ENABLE_BASE16_VARS"; or test -n "$BASE16_SHELL_ENABLE_VARS"
  ...
  set -gx BASE16_COLOR_08_HEX "c06061"
  set -gx BASE16_COLOR_09_HEX "ff937f"
  set -gx BASE16_COLOR_0A_HEX "e5bc84"
  set -gx BASE16_COLOR_0B_HEX "8ca07b"
  set -gx BASE16_COLOR_0C_HEX "5e8c9b"
  set -gx BASE16_COLOR_0D_HEX "839ec9"
  set -gx BASE16_COLOR_0E_HEX "98a1d8"
  set -gx BASE16_COLOR_0F_HEX "d9cdb4"
end
