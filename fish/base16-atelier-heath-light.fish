...
set -l color00 "f7/f3/f7" # Base 00 - Black
set -l color01 "ca/40/2b" # Base 08 - Red
set -l color02 "91/8b/3b" # Base 0B - Green
set -l color03 "bb/8a/35" # Base 0A - Yellow
set -l color04 "51/6a/ec" # Base 0D - Blue
set -l color05 "7b/59/c0" # Base 0E - Magenta
set -l color06 "15/93/93" # Base 0C - Cyan
set -l color07 "69/5d/69" # Base 05 - White
set -l color08 "9e/8f/9e" # Base 03 - Bright Black
...
set -l color15 "1b/18/1b" # Base 07 - Bright White
set -l color16 "a6/59/26" # Base 09
set -l color17 "cc/33/cc" # Base 0F
set -l color18 "d8/ca/d8" # Base 01
set -l color19 "ab/9b/ab" # Base 02
set -l color20 "77/69/77" # Base 04
set -l color21 "29/23/29" # Base 06
set -l color_foreground "69/5d/69" # Base 05
set -l color_background "f7/f3/f7" # Base 00
...
set -U fish_color_end 695d69
set -U fish_color_error brred
set -U fish_color_param 776977
set -U fish_color_valid_path --underline
set -U fish_color_option brcyan
set -U fish_color_comment 9e8f9e
set -U fish_color_selection 292329 --bold --background=ab9bab
set -U fish_color_operator brblue
set -U fish_color_escape brcyan
set -U fish_color_autosuggestion 9e8f9e
...
set -U fish_pager_color_progress d8cad8 --background=776977
set -U fish_pager_color_background normal --background=f7f3f7
set -U fish_pager_color_prefix normal --bold
set -U fish_pager_color_completion normal
set -U fish_pager_color_description a65926 --dim
set -U fish_pager_color_selected_background 292329 --background=ab9bab
set -U fish_pager_color_selected_prefix 292329 --bold --background=ab9bab
set -U fish_pager_color_selected_completion 292329
...
# Set theme
set -Ux BASE16_THEME atelier-heath-light

# Optionally export variables
if test -n "$TINTED_SHELL_ENABLE_BASE16_VARS"; or test -n "$BASE16_SHELL_ENABLE_VARS"
  set -gx BASE16_COLOR_00_HEX "f7f3f7"
  set -gx BASE16_COLOR_01_HEX "d8cad8"
  set -gx BASE16_COLOR_02_HEX "ab9bab"
  set -gx BASE16_COLOR_03_HEX "9e8f9e"
  set -gx BASE16_COLOR_04_HEX "776977"
  set -gx BASE16_COLOR_05_HEX "695d69"
  set -gx BASE16_COLOR_06_HEX "292329"
  set -gx BASE16_COLOR_07_HEX "1b181b"
  set -gx BASE16_COLOR_08_HEX "ca402b"
  set -gx BASE16_COLOR_09_HEX "a65926"
  set -gx BASE16_COLOR_0A_HEX "bb8a35"
  set -gx BASE16_COLOR_0B_HEX "918b3b"
  set -gx BASE16_COLOR_0C_HEX "159393"
  set -gx BASE16_COLOR_0D_HEX "516aec"
  set -gx BASE16_COLOR_0E_HEX "7b59c0"
  set -gx BASE16_COLOR_0F_HEX "cc33cc"
end
