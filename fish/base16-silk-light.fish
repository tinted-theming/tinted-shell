...
set -l color00 "e9/f1/ef" # Base 00 - Black
set -l color01 "cf/43/2e" # Base 08 - Red
set -l color02 "6c/a3/8c" # Base 0B - Green
set -l color03 "cf/ad/25" # Base 0A - Yellow
set -l color04 "39/aa/c9" # Base 0D - Blue
set -l color05 "6e/65/82" # Base 0E - Magenta
set -l color06 "32/9c/a2" # Base 0C - Cyan
set -l color07 "38/51/56" # Base 05 - White
set -l color08 "5c/78/7b" # Base 03 - Bright Black
...
set -l color15 "d2/fa/ff" # Base 07 - Bright White
set -l color16 "d2/7f/46" # Base 09
set -l color17 "86/53/69" # Base 0F
set -l color18 "cc/d4/d3" # Base 01
set -l color19 "90/b7/b6" # Base 02
set -l color20 "4b/5b/5f" # Base 04
set -l color21 "0e/3c/46" # Base 06
set -l color_foreground "38/51/56" # Base 05
set -l color_background "e9/f1/ef" # Base 00
...
set -U fish_color_end 385156
set -U fish_color_error brred
set -U fish_color_param 4b5b5f
set -U fish_color_valid_path --underline
set -U fish_color_option brcyan
set -U fish_color_comment 5c787b
set -U fish_color_selection 0e3c46 --bold --background=90b7b6
set -U fish_color_operator brblue
set -U fish_color_escape brcyan
set -U fish_color_autosuggestion 5c787b
...
set -U fish_pager_color_progress ccd4d3 --background=4b5b5f
set -U fish_pager_color_background normal --background=e9f1ef
set -U fish_pager_color_prefix normal --bold
set -U fish_pager_color_completion normal
set -U fish_pager_color_description d27f46 --dim
set -U fish_pager_color_selected_background 0e3c46 --background=90b7b6
set -U fish_pager_color_selected_prefix 0e3c46 --bold --background=90b7b6
set -U fish_pager_color_selected_completion 0e3c46
...
# Set theme
set -Ux BASE16_THEME silk-light

# Optionally export variables
if test -n "$TINTED_SHELL_ENABLE_BASE16_VARS"; or test -n "$BASE16_SHELL_ENABLE_VARS"
  set -gx BASE16_COLOR_00_HEX "e9f1ef"
  set -gx BASE16_COLOR_01_HEX "ccd4d3"
  set -gx BASE16_COLOR_02_HEX "90b7b6"
  set -gx BASE16_COLOR_03_HEX "5c787b"
  set -gx BASE16_COLOR_04_HEX "4b5b5f"
  set -gx BASE16_COLOR_05_HEX "385156"
  set -gx BASE16_COLOR_06_HEX "0e3c46"
  set -gx BASE16_COLOR_07_HEX "d2faff"
  set -gx BASE16_COLOR_08_HEX "cf432e"
  set -gx BASE16_COLOR_09_HEX "d27f46"
  set -gx BASE16_COLOR_0A_HEX "cfad25"
  set -gx BASE16_COLOR_0B_HEX "6ca38c"
  set -gx BASE16_COLOR_0C_HEX "329ca2"
  set -gx BASE16_COLOR_0D_HEX "39aac9"
  set -gx BASE16_COLOR_0E_HEX "6e6582"
  set -gx BASE16_COLOR_0F_HEX "865369"
end
