...
set -U fish_color_selection dadbdb --background=616568
set -U fish_color_operator magenta
set -U fish_color_escape ffcb3d
...
set -U fish_color_search_match yellow --background=616568
set -U fish_color_history_current --underline=curly
set -U fish_pager_color_progress 43474c --background=9ea0a2
set -U fish_pager_color_background --background=252a2f
set -U fish_pager_color_prefix --bold --italics
set -U fish_pager_color_completion normal
set -U fish_pager_color_description ffcb3d
set -U fish_pager_color_selected_background --background=616568
set -U fish_pager_color_selected_prefix --bold --italics --background=616568
