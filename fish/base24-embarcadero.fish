...
set -l color00 "25/2a/2f" # Base 00 - Black
set -l color01 "ed/5d/86" # Base 08 - Red
set -l color02 "20/c2/90" # Base 0B - Green
set -l color03 "eb/82/4d" # Base 0A - Yellow
set -l color04 "40/80/d0" # Base 0D - Blue
set -l color05 "a0/70/d0" # Base 0E - Magenta
set -l color06 "02/ef/ef" # Base 0C - Cyan
set -l color07 "bc/bd/c0" # Base 05 - White
set -l color08 "7f/82/85" # Base 03 - Bright Black
...
set -l color15 "f8/f8/f8" # Base 07 - Bright White
set -l color16 "ff/cb/3d" # Base 09
set -l color17 "50/50/9f" # Base 0F
set -l color18 "43/47/4c" # Base 01
set -l color19 "61/65/68" # Base 02
set -l color20 "9e/a0/a2" # Base 04
set -l color21 "da/db/db" # Base 06
set -l color_foreground "bc/bd/c0" # Base 05
set -l color_background "25/2a/2f" # Base 00
...
set -U fish_color_end bcbdc0
set -U fish_color_error brred
set -U fish_color_param 9ea0a2
set -U fish_color_valid_path --underline
set -U fish_color_option brcyan
set -U fish_color_comment 7f8285
set -U fish_color_selection dadbdb --bold --background=616568
set -U fish_color_operator brblue
set -U fish_color_escape brcyan
set -U fish_color_autosuggestion 7f8285
...
set -U fish_color_search_match bryellow --background=616568
set -U fish_color_history_current --bold
set -U fish_pager_color_progress 43474c --background=9ea0a2
set -U fish_pager_color_background normal --background=252a2f
set -U fish_pager_color_prefix normal --bold
set -U fish_pager_color_completion normal
set -U fish_pager_color_description ffcb3d --dim
set -U fish_pager_color_selected_background dadbdb --background=616568
set -U fish_pager_color_selected_prefix dadbdb --bold --background=616568
set -U fish_pager_color_selected_completion dadbdb
...
# Set theme
set -Ux BASE24_THEME embarcadero

# Optionally export variables
if test -n "$TINTED_SHELL_ENABLE_BASE24_VARS"; or test -n "$BASE24_SHELL_ENABLE_VARS"
  set -gx BASE24_COLOR_00_HEX "252a2f"
  set -gx BASE24_COLOR_01_HEX "43474c"
  set -gx BASE24_COLOR_02_HEX "616568"
  set -gx BASE24_COLOR_03_HEX "7f8285"
  set -gx BASE24_COLOR_04_HEX "9ea0a2"
  set -gx BASE24_COLOR_05_HEX "bcbdc0"
  set -gx BASE24_COLOR_06_HEX "dadbdb"
  set -gx BASE24_COLOR_07_HEX "f8f8f8"
  set -gx BASE24_COLOR_08_HEX "ed5d86"
  set -gx BASE24_COLOR_09_HEX "ffcb3d"
  set -gx BASE24_COLOR_0A_HEX "eb824d"
  set -gx BASE24_COLOR_0B_HEX "20c290"
  set -gx BASE24_COLOR_0C_HEX "02efef"
  set -gx BASE24_COLOR_0D_HEX "4080d0"
  set -gx BASE24_COLOR_0E_HEX "a070d0"
  set -gx BASE24_COLOR_0F_HEX "50509f"
end
