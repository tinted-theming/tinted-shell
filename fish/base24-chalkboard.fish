...
set -U fish_color_selection d9d9d9 --background=323232
set -U fish_color_operator magenta
set -U fish_color_escape c2c372
...
set -U fish_color_search_match yellow --background=323232
set -U fish_color_history_current --underline=curly
set -U fish_pager_color_progress 000000 --background=858585
set -U fish_pager_color_background --background=29262f
set -U fish_pager_color_prefix --bold --italics
set -U fish_pager_color_completion normal
set -U fish_pager_color_description c2c372
set -U fish_pager_color_selected_background --background=323232
set -U fish_pager_color_selected_prefix --bold --italics --background=323232
