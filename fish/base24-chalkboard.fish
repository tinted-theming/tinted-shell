...
set -l color00 "29/26/2f" # Base 00 - Black
set -l color01 "c3/73/72" # Base 08 - Red
set -l color02 "72/c3/73" # Base 0B - Green
set -l color03 "aa/aa/db" # Base 0A - Yellow
set -l color04 "73/72/c3" # Base 0D - Blue
set -l color05 "c3/72/c2" # Base 0E - Magenta
set -l color06 "72/c2/c3" # Base 0C - Cyan
set -l color07 "af/af/af" # Base 05 - White
set -l color08 "5b/5b/5b" # Base 03 - Bright Black
...
set -l color16 "c2/c3/72" # Base 09
set -l color17 "61/39/39" # Base 0F
set -l color18 "00/00/00" # Base 01
set -l color19 "32/32/32" # Base 02
set -l color20 "85/85/85" # Base 04
set -l color21 "d9/d9/d9" # Base 06
set -l color_foreground "af/af/af" # Base 05
set -l color_background "29/26/2f" # Base 00
...
if test -n "$ITERM_SESSION_ID"
  ...
  put_template_custom Ph 29262f # background
  ...
  put_template_custom Pm 29262f # cursor text
else
...
set -U fish_color_param 858585
set -U fish_color_valid_path --underline
set -U fish_color_option brcyan
set -U fish_color_comment 5b5b5b
set -U fish_color_selection d9d9d9 --bold --background=323232
set -U fish_color_operator brblue
set -U fish_color_escape brcyan
set -U fish_color_autosuggestion 5b5b5b
...
set -U fish_pager_color_progress 000000 --background=858585
set -U fish_pager_color_background normal --background=29262f
set -U fish_pager_color_prefix normal --bold
set -U fish_pager_color_completion normal
set -U fish_pager_color_description c2c372 --dim
set -U fish_pager_color_selected_background d9d9d9 --background=323232
set -U fish_pager_color_selected_prefix d9d9d9 --bold --background=323232
set -U fish_pager_color_selected_completion d9d9d9
...
# Set theme
set -Ux BASE24_THEME chalkboard

# Optionally export variables
if test -n "$TINTED_SHELL_ENABLE_BASE24_VARS"; or test -n "$BASE24_SHELL_ENABLE_VARS"
  set -gx BASE24_COLOR_00_HEX "29262f"
  set -gx BASE24_COLOR_01_HEX "000000"
  set -gx BASE24_COLOR_02_HEX "323232"
  set -gx BASE24_COLOR_03_HEX "5b5b5b"
  set -gx BASE24_COLOR_04_HEX "858585"
  set -gx BASE24_COLOR_05_HEX "afafaf"
  set -gx BASE24_COLOR_06_HEX "d9d9d9"
  set -gx BASE24_COLOR_07_HEX "ffffff"
  set -gx BASE24_COLOR_08_HEX "c37372"
  set -gx BASE24_COLOR_09_HEX "c2c372"
  set -gx BASE24_COLOR_0A_HEX "aaaadb"
  set -gx BASE24_COLOR_0B_HEX "72c373"
  set -gx BASE24_COLOR_0C_HEX "72c2c3"
  set -gx BASE24_COLOR_0D_HEX "7372c3"
  set -gx BASE24_COLOR_0E_HEX "c372c2"
  set -gx BASE24_COLOR_0F_HEX "613939"
end
