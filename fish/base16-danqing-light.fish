...
set -l color00 "fc/fe/fd" # Base 00 - Black
set -l color01 "f9/90/6f" # Base 08 - Red
set -l color02 "8a/b3/61" # Base 0B - Green
set -l color03 "f0/c2/39" # Base 0A - Yellow
set -l color04 "b0/a4/e3" # Base 0D - Blue
set -l color05 "cc/a4/e3" # Base 0E - Magenta
set -l color06 "30/df/f3" # Base 0C - Cyan
set -l color07 "5a/60/5d" # Base 05 - White
set -l color08 "ca/d8/d2" # Base 03 - Bright Black
...
set -l color15 "2d/30/2f" # Base 07 - Bright White
set -l color16 "b3/8a/61" # Base 09
set -l color17 "ca/69/24" # Base 0F
set -l color18 "ec/f6/f2" # Base 01
set -l color19 "e0/f0/ef" # Base 02
set -l color20 "9d/a8/a3" # Base 04
set -l color21 "43/48/46" # Base 06
set -l color_foreground "5a/60/5d" # Base 05
set -l color_background "fc/fe/fd" # Base 00
...
set -U fish_color_end 5a605d
set -U fish_color_error brred
set -U fish_color_param 9da8a3
set -U fish_color_valid_path --underline
set -U fish_color_option brcyan
set -U fish_color_comment cad8d2
set -U fish_color_selection 434846 --bold --background=e0f0ef
set -U fish_color_operator brblue
set -U fish_color_escape brcyan
set -U fish_color_autosuggestion cad8d2
...
set -U fish_color_search_match bryellow --background=e0f0ef
set -U fish_color_history_current --bold
set -U fish_pager_color_progress ecf6f2 --background=9da8a3
set -U fish_pager_color_background normal --background=fcfefd
set -U fish_pager_color_prefix normal --bold
set -U fish_pager_color_completion normal
set -U fish_pager_color_description b38a61 --dim
set -U fish_pager_color_selected_background 434846 --background=e0f0ef
set -U fish_pager_color_selected_prefix 434846 --bold --background=e0f0ef
set -U fish_pager_color_selected_completion 434846
...
# Set theme
set -Ux BASE16_THEME danqing-light

# Optionally export variables
if test -n "$TINTED_SHELL_ENABLE_BASE16_VARS"; or test -n "$BASE16_SHELL_ENABLE_VARS"
  set -gx BASE16_COLOR_00_HEX "fcfefd"
  set -gx BASE16_COLOR_01_HEX "ecf6f2"
  set -gx BASE16_COLOR_02_HEX "e0f0ef"
  set -gx BASE16_COLOR_03_HEX "cad8d2"
  set -gx BASE16_COLOR_04_HEX "9da8a3"
  set -gx BASE16_COLOR_05_HEX "5a605d"
  set -gx BASE16_COLOR_06_HEX "434846"
  set -gx BASE16_COLOR_07_HEX "2d302f"
  set -gx BASE16_COLOR_08_HEX "f9906f"
  set -gx BASE16_COLOR_09_HEX "b38a61"
  set -gx BASE16_COLOR_0A_HEX "f0c239"
  set -gx BASE16_COLOR_0B_HEX "8ab361"
  set -gx BASE16_COLOR_0C_HEX "30dff3"
  set -gx BASE16_COLOR_0D_HEX "b0a4e3"
  set -gx BASE16_COLOR_0E_HEX "cca4e3"
  set -gx BASE16_COLOR_0F_HEX "ca6924"
end
