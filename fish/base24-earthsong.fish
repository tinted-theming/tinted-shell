...
set -l color00 "28/24/20" # Base 00 - Black
set -l color01 "c8/41/34" # Base 08 - Red
set -l color02 "84/c4/4b" # Base 0B - Green
set -l color03 "5e/d9/ff" # Base 0A - Yellow
set -l color04 "13/97/b9" # Base 0D - Blue
set -l color05 "d0/62/3c" # Base 0E - Magenta
set -l color06 "4f/94/52" # Base 0C - Cyan
set -l color07 "c5/ab/93" # Base 05 - White
set -l color08 "85/77/69" # Base 03 - Bright Black
...
set -l color15 "f6/f6/ec" # Base 07 - Bright White
set -l color16 "f4/ae/2e" # Base 09
set -l color17 "64/20/1a" # Base 0F
set -l color18 "11/14/17" # Base 01
set -l color19 "66/5e/54" # Base 02
set -l color20 "a5/91/7e" # Base 04
set -l color21 "e5/c5/a9" # Base 06
set -l color_foreground "c5/ab/93" # Base 05
set -l color_background "28/24/20" # Base 00
...
set -U fish_color_end c5ab93
set -U fish_color_error brred
set -U fish_color_param a5917e
set -U fish_color_valid_path --underline
set -U fish_color_option brcyan
set -U fish_color_comment 857769
set -U fish_color_selection e5c5a9 --bold --background=665e54
set -U fish_color_operator brblue
set -U fish_color_escape brcyan
set -U fish_color_autosuggestion 857769
...
set -U fish_color_search_match bryellow --background=665e54
set -U fish_color_history_current --bold
set -U fish_pager_color_progress 111417 --background=a5917e
set -U fish_pager_color_background normal --background=282420
set -U fish_pager_color_prefix normal --bold
set -U fish_pager_color_completion normal
set -U fish_pager_color_description f4ae2e --dim
set -U fish_pager_color_selected_background e5c5a9 --background=665e54
set -U fish_pager_color_selected_prefix e5c5a9 --bold --background=665e54
set -U fish_pager_color_selected_completion e5c5a9
...
# Set theme
set -Ux BASE24_THEME earthsong

# Optionally export variables
if test -n "$TINTED_SHELL_ENABLE_BASE24_VARS"; or test -n "$BASE24_SHELL_ENABLE_VARS"
  set -gx BASE24_COLOR_00_HEX "282420"
  set -gx BASE24_COLOR_01_HEX "111417"
  set -gx BASE24_COLOR_02_HEX "665e54"
  set -gx BASE24_COLOR_03_HEX "857769"
  set -gx BASE24_COLOR_04_HEX "a5917e"
  set -gx BASE24_COLOR_05_HEX "c5ab93"
  set -gx BASE24_COLOR_06_HEX "e5c5a9"
  set -gx BASE24_COLOR_07_HEX "f6f6ec"
  set -gx BASE24_COLOR_08_HEX "c84134"
  set -gx BASE24_COLOR_09_HEX "f4ae2e"
  set -gx BASE24_COLOR_0A_HEX "5ed9ff"
  set -gx BASE24_COLOR_0B_HEX "84c44b"
  set -gx BASE24_COLOR_0C_HEX "4f9452"
  set -gx BASE24_COLOR_0D_HEX "1397b9"
  set -gx BASE24_COLOR_0E_HEX "d0623c"
  set -gx BASE24_COLOR_0F_HEX "64201a"
end
