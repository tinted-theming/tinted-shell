...
set -l color00 "10/08/14" # Base 00 - Black
set -l color01 "90/27/4b" # Base 08 - Red
set -l color02 "23/80/1c" # Base 0B - Green
set -l color03 "8f/b9/f9" # Base 0A - Yellow
set -l color04 "64/80/af" # Base 0D - Blue
set -l color05 "66/4d/96" # Base 0E - Magenta
set -l color06 "8a/aa/bd" # Base 0C - Cyan
set -l color07 "49/42/5a" # Base 05 - White
set -l color08 "39/34/46" # Base 03 - Bright Black
...
set -l color15 "9d/8b/bd" # Base 07 - Bright White
set -l color16 "b4/9d/27" # Base 09
set -l color17 "48/13/25" # Base 0F
set -l color18 "24/1f/2a" # Base 01
set -l color19 "31/2d/3c" # Base 02
set -l color20 "41/3b/50" # Base 04
set -l color21 "51/49/65" # Base 06
set -l color_foreground "49/42/5a" # Base 05
set -l color_background "10/08/14" # Base 00
...
set -U fish_color_end 49425a
set -U fish_color_error brred
set -U fish_color_param 413b50
set -U fish_color_valid_path --underline
set -U fish_color_option brcyan
set -U fish_color_comment 393446
set -U fish_color_selection 514965 --bold --background=312d3c
set -U fish_color_operator brblue
set -U fish_color_escape brcyan
set -U fish_color_autosuggestion 393446
...
set -U fish_color_search_match bryellow --background=312d3c
set -U fish_color_history_current --bold
set -U fish_pager_color_progress 241f2a --background=413b50
set -U fish_pager_color_background normal --background=100814
set -U fish_pager_color_prefix normal --bold
set -U fish_pager_color_completion normal
set -U fish_pager_color_description b49d27 --dim
set -U fish_pager_color_selected_background 514965 --background=312d3c
set -U fish_pager_color_selected_prefix 514965 --bold --background=312d3c
set -U fish_pager_color_selected_completion 514965
...
# Set theme
set -Ux BASE24_THEME royal

# Optionally export variables
if test -n "$TINTED_SHELL_ENABLE_BASE24_VARS"; or test -n "$BASE24_SHELL_ENABLE_VARS"
  set -gx BASE24_COLOR_00_HEX "100814"
  set -gx BASE24_COLOR_01_HEX "241f2a"
  set -gx BASE24_COLOR_02_HEX "312d3c"
  set -gx BASE24_COLOR_03_HEX "393446"
  set -gx BASE24_COLOR_04_HEX "413b50"
  set -gx BASE24_COLOR_05_HEX "49425a"
  set -gx BASE24_COLOR_06_HEX "514965"
  set -gx BASE24_COLOR_07_HEX "9d8bbd"
  set -gx BASE24_COLOR_08_HEX "90274b"
  set -gx BASE24_COLOR_09_HEX "b49d27"
  set -gx BASE24_COLOR_0A_HEX "8fb9f9"
  set -gx BASE24_COLOR_0B_HEX "23801c"
  set -gx BASE24_COLOR_0C_HEX "8aaabd"
  set -gx BASE24_COLOR_0D_HEX "6480af"
  set -gx BASE24_COLOR_0E_HEX "664d96"
  set -gx BASE24_COLOR_0F_HEX "481325"
end
