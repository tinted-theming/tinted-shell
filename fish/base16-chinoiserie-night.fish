...
# Scheme name: Chinoiserie Night
# Scheme author: Di Wang (https://cs.cmu.edu/~diw3)
# Template author: Tinted Theming (https://github.com/tinted-theming)

set -l color00 "1d/1d/1d" # Base 00 - Black
set -l color01 "f0/7c/82" # Base 08 - Red
set -l color02 "b2/cf/87" # Base 0B - Green
set -l color03 "f4/ce/69" # Base 0A - Yellow
set -l color04 "8f/b2/c9" # Base 0D - Blue
set -l color05 "be/9d/b9" # Base 0E - Magenta
set -l color06 "b0/d5/df" # Base 0C - Cyan
set -l color07 "c4/cb/cf" # Base 05 - White
set -l color08 "91/80/72" # Base 03 - Bright Black
...
set -l color15 "ff/fe/f9" # Base 07 - Bright White
set -l color16 "f4/a8/3a" # Base 09
set -l color17 "b8/94/85" # Base 0F
set -l color18 "28/28/28" # Base 01
set -l color19 "37/37/37" # Base 02
set -l color20 "bd/ae/ad" # Base 04
set -l color21 "ee/e7/f2" # Base 06
set -l color_foreground "c4/cb/cf" # Base 05
...
set -U fish_color_end c4cbcf
set -U fish_color_error brred
set -U fish_color_param bdaead
set -U fish_color_valid_path --underline
set -U fish_color_option brcyan
set -U fish_color_comment 918072
set -U fish_color_selection eee7f2 --bold --background=373737
set -U fish_color_operator brblue
set -U fish_color_escape brcyan
set -U fish_color_autosuggestion 918072
...
set -U fish_color_search_match bryellow --background=373737
set -U fish_color_history_current --bold
set -U fish_pager_color_progress 282828 --background=bdaead
set -U fish_pager_color_background normal --background=1d1d1d
set -U fish_pager_color_prefix normal --bold
set -U fish_pager_color_completion normal
set -U fish_pager_color_description f4a83a --dim
set -U fish_pager_color_selected_background eee7f2 --background=373737
set -U fish_pager_color_selected_prefix eee7f2 --bold --background=373737
set -U fish_pager_color_selected_completion eee7f2
...
# Set theme
set -Ux BASE16_THEME chinoiserie-night

# Optionally export variables
if test -n "$TINTED_SHELL_ENABLE_BASE16_VARS"; or test -n "$BASE16_SHELL_ENABLE_VARS"
  set -gx BASE16_COLOR_00_HEX "1d1d1d"
  set -gx BASE16_COLOR_01_HEX "282828"
  set -gx BASE16_COLOR_02_HEX "373737"
  set -gx BASE16_COLOR_03_HEX "918072"
  set -gx BASE16_COLOR_04_HEX "bdaead"
  set -gx BASE16_COLOR_05_HEX "c4cbcf"
  set -gx BASE16_COLOR_06_HEX "eee7f2"
  set -gx BASE16_COLOR_07_HEX "fffef9"
  set -gx BASE16_COLOR_08_HEX "f07c82"
  set -gx BASE16_COLOR_09_HEX "f4a83a"
  set -gx BASE16_COLOR_0A_HEX "f4ce69"
  set -gx BASE16_COLOR_0B_HEX "b2cf87"
  set -gx BASE16_COLOR_0C_HEX "b0d5df"
  set -gx BASE16_COLOR_0D_HEX "8fb2c9"
  set -gx BASE16_COLOR_0E_HEX "be9db9"
  set -gx BASE16_COLOR_0F_HEX "b89485"
end
