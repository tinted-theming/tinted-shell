...
set -l color08 "99/99/99" # Base 03 - Bright Black
...
set -U fish_color_autosuggestion 999999
...
# Set theme
set -Ux BASE16_THEME tomorrow-night-eighties
...
if test -n "$TINTED_SHELL_ENABLE_BASE16_VARS"; or test -n "$BASE16_SHELL_ENABLE_VARS"
  ...
  set -gx BASE16_COLOR_03_HEX "999999"
