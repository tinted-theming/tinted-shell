...
set -l color00 "f4/fb/f4" # Base 00 - Black
set -l color01 "e6/19/3c" # Base 08 - Red
set -l color02 "29/a3/29" # Base 0B - Green
set -l color03 "98/98/1b" # Base 0A - Yellow
set -l color04 "3d/62/f5" # Base 0D - Blue
set -l color05 "ad/2b/ee" # Base 0E - Magenta
set -l color06 "19/99/b3" # Base 0C - Cyan
set -l color07 "5e/6e/5e" # Base 05 - White
set -l color08 "80/99/80" # Base 03 - Bright Black
...
set -l color15 "13/15/13" # Base 07 - Bright White
set -l color16 "87/71/1d" # Base 09
set -l color17 "e6/19/c3" # Base 0F
set -l color18 "cf/e8/cf" # Base 01
set -l color19 "8c/a6/8c" # Base 02
set -l color20 "68/7d/68" # Base 04
set -l color21 "24/29/24" # Base 06
set -l color_foreground "5e/6e/5e" # Base 05
set -l color_background "f4/fb/f4" # Base 00
...
set -U fish_color_end 5e6e5e
set -U fish_color_error brred
set -U fish_color_param 687d68
set -U fish_color_valid_path --underline
set -U fish_color_option brcyan
set -U fish_color_comment 809980
set -U fish_color_selection 242924 --bold --background=8ca68c
set -U fish_color_operator brblue
set -U fish_color_escape brcyan
set -U fish_color_autosuggestion 809980
...
set -U fish_pager_color_progress cfe8cf --background=687d68
set -U fish_pager_color_background normal --background=f4fbf4
set -U fish_pager_color_prefix normal --bold
set -U fish_pager_color_completion normal
set -U fish_pager_color_description 87711d --dim
set -U fish_pager_color_selected_background 242924 --background=8ca68c
set -U fish_pager_color_selected_prefix 242924 --bold --background=8ca68c
set -U fish_pager_color_selected_completion 242924
...
# Set theme
set -Ux BASE16_THEME atelier-seaside-light

# Optionally export variables
if test -n "$TINTED_SHELL_ENABLE_BASE16_VARS"; or test -n "$BASE16_SHELL_ENABLE_VARS"
  set -gx BASE16_COLOR_00_HEX "f4fbf4"
  set -gx BASE16_COLOR_01_HEX "cfe8cf"
  set -gx BASE16_COLOR_02_HEX "8ca68c"
  set -gx BASE16_COLOR_03_HEX "809980"
  set -gx BASE16_COLOR_04_HEX "687d68"
  set -gx BASE16_COLOR_05_HEX "5e6e5e"
  set -gx BASE16_COLOR_06_HEX "242924"
  set -gx BASE16_COLOR_07_HEX "131513"
  set -gx BASE16_COLOR_08_HEX "e6193c"
  set -gx BASE16_COLOR_09_HEX "87711d"
  set -gx BASE16_COLOR_0A_HEX "98981b"
  set -gx BASE16_COLOR_0B_HEX "29a329"
  set -gx BASE16_COLOR_0C_HEX "1999b3"
  set -gx BASE16_COLOR_0D_HEX "3d62f5"
  set -gx BASE16_COLOR_0E_HEX "ad2bee"
  set -gx BASE16_COLOR_0F_HEX "e619c3"
end
