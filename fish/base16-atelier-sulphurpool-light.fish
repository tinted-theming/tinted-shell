...
set -l color15 "20/27/46" # Base 07 - Bright White
set -l color16 "c7/6b/29" # Base 09
set -l color17 "9c/63/7a" # Base 0F
set -l color18 "df/e2/f1" # Base 01
set -l color19 "97/9d/b4" # Base 02
set -l color20 "6b/73/94" # Base 04
set -l color21 "29/32/56" # Base 06
set -l color_foreground "5e/66/87" # Base 05
set -l color_background "f5/f7/ff" # Base 00
...
set -U fish_color_end 5e6687
set -U fish_color_error brred
set -U fish_color_param 6b7394
set -U fish_color_valid_path --underline
set -U fish_color_option brcyan
set -U fish_color_comment 898ea4
set -U fish_color_selection 293256 --bold --background=979db4
set -U fish_color_operator brblue
set -U fish_color_escape brcyan
set -U fish_color_autosuggestion 898ea4
...
set -U fish_pager_color_progress dfe2f1 --background=6b7394
set -U fish_pager_color_background normal --background=f5f7ff
set -U fish_pager_color_prefix normal --bold
set -U fish_pager_color_completion normal
set -U fish_pager_color_description c76b29 --dim
set -U fish_pager_color_selected_background 293256 --background=979db4
set -U fish_pager_color_selected_prefix 293256 --bold --background=979db4
set -U fish_pager_color_selected_completion 293256
...
# Set theme
set -Ux BASE16_THEME atelier-sulphurpool-light

# Optionally export variables
if test -n "$TINTED_SHELL_ENABLE_BASE16_VARS"; or test -n "$BASE16_SHELL_ENABLE_VARS"
  set -gx BASE16_COLOR_00_HEX "f5f7ff"
  set -gx BASE16_COLOR_01_HEX "dfe2f1"
  set -gx BASE16_COLOR_02_HEX "979db4"
  set -gx BASE16_COLOR_03_HEX "898ea4"
  set -gx BASE16_COLOR_04_HEX "6b7394"
  set -gx BASE16_COLOR_05_HEX "5e6687"
  set -gx BASE16_COLOR_06_HEX "293256"
  set -gx BASE16_COLOR_07_HEX "202746"
  set -gx BASE16_COLOR_08_HEX "c94922"
  set -gx BASE16_COLOR_09_HEX "c76b29"
  set -gx BASE16_COLOR_0A_HEX "c08b30"
  set -gx BASE16_COLOR_0B_HEX "ac9739"
  set -gx BASE16_COLOR_0C_HEX "22a2c9"
  set -gx BASE16_COLOR_0D_HEX "3d8fd1"
  set -gx BASE16_COLOR_0E_HEX "6679cc"
  set -gx BASE16_COLOR_0F_HEX "9c637a"
end
