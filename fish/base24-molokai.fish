...
set -l color01 "fa/25/73" # Base 08 - Red
set -l color02 "97/e1/23" # Base 0B - Green
set -l color03 "00/af/ff" # Base 0A - Yellow
set -l color04 "0f/7f/cf" # Base 0D - Blue
set -l color05 "87/00/ff" # Base 0E - Magenta
set -l color06 "42/a7/cf" # Base 0C - Cyan
...
set -l color16 "df/d4/60" # Base 09
set -l color17 "7d/12/39" # Base 0F
set -l color18 "12/12/12" # Base 01
...
if test -n "$TINTED_SHELL_ENABLE_BASE24_VARS"; or test -n "$BASE24_SHELL_ENABLE_VARS"
  ...
  set -gx BASE24_COLOR_08_HEX "fa2573"
  set -gx BASE24_COLOR_09_HEX "dfd460"
  set -gx BASE24_COLOR_0A_HEX "00afff"
  set -gx BASE24_COLOR_0B_HEX "97e123"
  set -gx BASE24_COLOR_0C_HEX "42a7cf"
  set -gx BASE24_COLOR_0D_HEX "0f7fcf"
  set -gx BASE24_COLOR_0E_HEX "8700ff"
  set -gx BASE24_COLOR_0F_HEX "7d1239"
end
