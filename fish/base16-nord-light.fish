...
set -l color00 "e5/e9/f0" # Base 00 - Black
set -l color01 "99/32/4b" # Base 08 - Red
set -l color02 "4f/89/4c" # Base 0B - Green
set -l color03 "9a/75/00" # Base 0A - Yellow
set -l color04 "3b/6e/a8" # Base 0D - Blue
set -l color05 "97/36/5b" # Base 0E - Magenta
set -l color06 "39/8e/ac" # Base 0C - Cyan
set -l color07 "2e/34/40" # Base 05 - White
set -l color08 "ae/ba/cf" # Base 03 - Bright Black
...
set -l color15 "29/83/8d" # Base 07 - Bright White
set -l color16 "ac/44/26" # Base 09
set -l color17 "52/72/af" # Base 0F
set -l color18 "c2/d0/e7" # Base 01
set -l color19 "b8/c5/db" # Base 02
set -l color20 "60/72/8c" # Base 04
set -l color21 "3b/42/52" # Base 06
set -l color_foreground "2e/34/40" # Base 05
set -l color_background "e5/e9/f0" # Base 00
...
set -U fish_color_end 2e3440
set -U fish_color_error brred
set -U fish_color_param 60728c
set -U fish_color_valid_path --underline
set -U fish_color_option brcyan
set -U fish_color_comment aebacf
set -U fish_color_selection 3b4252 --bold --background=b8c5db
set -U fish_color_operator brblue
set -U fish_color_escape brcyan
set -U fish_color_autosuggestion aebacf
...
set -U fish_color_search_match bryellow --background=b8c5db
set -U fish_color_history_current --bold
set -U fish_pager_color_progress c2d0e7 --background=60728c
set -U fish_pager_color_background normal --background=e5e9f0
set -U fish_pager_color_prefix normal --bold
set -U fish_pager_color_completion normal
set -U fish_pager_color_description ac4426 --dim
set -U fish_pager_color_selected_background 3b4252 --background=b8c5db
set -U fish_pager_color_selected_prefix 3b4252 --bold --background=b8c5db
set -U fish_pager_color_selected_completion 3b4252
...
# Set theme
set -Ux BASE16_THEME nord-light

# Optionally export variables
if test -n "$TINTED_SHELL_ENABLE_BASE16_VARS"; or test -n "$BASE16_SHELL_ENABLE_VARS"
  set -gx BASE16_COLOR_00_HEX "e5e9f0"
  set -gx BASE16_COLOR_01_HEX "c2d0e7"
  set -gx BASE16_COLOR_02_HEX "b8c5db"
  set -gx BASE16_COLOR_03_HEX "aebacf"
  set -gx BASE16_COLOR_04_HEX "60728c"
  set -gx BASE16_COLOR_05_HEX "2e3440"
  set -gx BASE16_COLOR_06_HEX "3b4252"
  set -gx BASE16_COLOR_07_HEX "29838d"
  set -gx BASE16_COLOR_08_HEX "99324b"
  set -gx BASE16_COLOR_09_HEX "ac4426"
  set -gx BASE16_COLOR_0A_HEX "9a7500"
  set -gx BASE16_COLOR_0B_HEX "4f894c"
  set -gx BASE16_COLOR_0C_HEX "398eac"
  set -gx BASE16_COLOR_0D_HEX "3b6ea8"
  set -gx BASE16_COLOR_0E_HEX "97365b"
  set -gx BASE16_COLOR_0F_HEX "5272af"
end
