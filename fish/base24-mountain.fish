...
set -U fish_color_selection e7e7e7 --background=262626
set -U fish_color_operator magenta
set -U fish_color_escape c6a679
...
set -U fish_pager_color_background --background=0f0f0f
set -U fish_pager_color_prefix --bold --italics
set -U fish_pager_color_completion normal
set -U fish_pager_color_description c6a679
