...
set -l color16 "c6/a6/79" # Base 09
...
set -U fish_pager_color_description c6a679 --dim
...
# Set theme
set -Ux BASE24_THEME mountain

# Optionally export variables
if test -n "$TINTED_SHELL_ENABLE_BASE24_VARS"; or test -n "$BASE24_SHELL_ENABLE_VARS"
  set -gx BASE24_COLOR_00_HEX "0f0f0f"
  set -gx BASE24_COLOR_01_HEX "191919"
  set -gx BASE24_COLOR_02_HEX "262626"
  set -gx BASE24_COLOR_03_HEX "393939"
  set -gx BASE24_COLOR_04_HEX "4c4c4c"
  set -gx BASE24_COLOR_05_HEX "cacaca"
  set -gx BASE24_COLOR_06_HEX "e7e7e7"
  set -gx BASE24_COLOR_07_HEX "f0f0f0"
  set -gx BASE24_COLOR_08_HEX "ac8a8c"
  set -gx BASE24_COLOR_09_HEX "c6a679"
  set -gx BASE24_COLOR_0A_HEX "aca98a"
  set -gx BASE24_COLOR_0B_HEX "8aac8b"
  set -gx BASE24_COLOR_0C_HEX "8aabac"
  set -gx BASE24_COLOR_0D_HEX "8f8aac"
  set -gx BASE24_COLOR_0E_HEX "ac8aac"
  set -gx BASE24_COLOR_0F_HEX "ac8a8c"
end
