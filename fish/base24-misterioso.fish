...
set -l color00 "2d/37/43" # Base 00 - Black
set -l color01 "ff/42/42" # Base 08 - Red
set -l color02 "74/af/68" # Base 0B - Green
set -l color03 "23/d7/d7" # Base 0A - Yellow
set -l color04 "33/8f/86" # Base 0D - Blue
set -l color05 "94/13/e5" # Base 0E - Magenta
set -l color06 "23/d7/d7" # Base 0C - Cyan
set -l color07 "be/be/bd" # Base 05 - White
set -l color08 "78/78/77" # Base 03 - Bright Black
...
set -l color16 "ff/ad/29" # Base 09
set -l color17 "7f/21/21" # Base 0F
set -l color18 "00/00/00" # Base 01
set -l color19 "55/55/55" # Base 02
set -l color20 "9b/9b/9a" # Base 04
set -l color21 "e1/e1/e0" # Base 06
set -l color_foreground "be/be/bd" # Base 05
set -l color_background "2d/37/43" # Base 00
...
if test -n "$ITERM_SESSION_ID"
  put_template_custom Pg bebebd # foreground
  put_template_custom Ph 2d3743 # background
  put_template_custom Pi bebebd # bold color
  put_template_custom Pj 555555 # selection color
  put_template_custom Pk bebebd # selected text color
  put_template_custom Pl bebebd # cursor
  put_template_custom Pm 2d3743 # cursor text
else
...
set -U fish_color_end bebebd
set -U fish_color_error brred
set -U fish_color_param 9b9b9a
set -U fish_color_valid_path --underline
set -U fish_color_option brcyan
set -U fish_color_comment 787877
set -U fish_color_selection e1e1e0 --bold --background=555555
set -U fish_color_operator brblue
set -U fish_color_escape brcyan
set -U fish_color_autosuggestion 787877
...
set -U fish_pager_color_progress 000000 --background=9b9b9a
set -U fish_pager_color_background normal --background=2d3743
set -U fish_pager_color_prefix normal --bold
set -U fish_pager_color_completion normal
set -U fish_pager_color_description ffad29 --dim
set -U fish_pager_color_selected_background e1e1e0 --background=555555
set -U fish_pager_color_selected_prefix e1e1e0 --bold --background=555555
set -U fish_pager_color_selected_completion e1e1e0
...
# Set theme
set -Ux BASE24_THEME misterioso

# Optionally export variables
if test -n "$TINTED_SHELL_ENABLE_BASE24_VARS"; or test -n "$BASE24_SHELL_ENABLE_VARS"
  set -gx BASE24_COLOR_00_HEX "2d3743"
  set -gx BASE24_COLOR_01_HEX "000000"
  set -gx BASE24_COLOR_02_HEX "555555"
  set -gx BASE24_COLOR_03_HEX "787877"
  set -gx BASE24_COLOR_04_HEX "9b9b9a"
  set -gx BASE24_COLOR_05_HEX "bebebd"
  set -gx BASE24_COLOR_06_HEX "e1e1e0"
  set -gx BASE24_COLOR_07_HEX "ffffff"
  set -gx BASE24_COLOR_08_HEX "ff4242"
  set -gx BASE24_COLOR_09_HEX "ffad29"
  set -gx BASE24_COLOR_0A_HEX "23d7d7"
  set -gx BASE24_COLOR_0B_HEX "74af68"
  set -gx BASE24_COLOR_0C_HEX "23d7d7"
  set -gx BASE24_COLOR_0D_HEX "338f86"
  set -gx BASE24_COLOR_0E_HEX "9413e5"
  set -gx BASE24_COLOR_0F_HEX "7f2121"
end
