...
set -l color19 "46/46/46" # Base 02
set -l color20 "ab/ab/ab" # Base 04
set -l color21 "e3/e3/e3" # Base 06
...
set -U fish_color_selection e3e3e3 --bold --background=464646
...
set -U fish_pager_color_progress 252525 --background=ababab
...
set -U fish_pager_color_selected_background e3e3e3 --background=464646
set -U fish_pager_color_selected_prefix e3e3e3 --bold --background=464646
set -U fish_pager_color_selected_completion e3e3e3
...
# Set theme
set -Ux BASE16_THEME grayscale-dark
