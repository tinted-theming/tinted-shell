...
set -l color00 "1a/1a/2f" # Base 00 - Black
set -l color01 "ff/66/2a" # Base 08 - Red
set -l color02 "8c/d9/7c" # Base 0B - Green
set -l color03 "ff/d1/5e" # Base 0A - Yellow
set -l color04 "2b/92/6f" # Base 0D - Blue
set -l color05 "1b/82/5f" # Base 0E - Magenta
set -l color06 "4c/ad/83" # Base 0C - Cyan
set -l color07 "81/81/75" # Base 05 - White
set -l color08 "31/31/40" # Base 03 - Bright Black
...
set -l color15 "ff/f8/e1" # Base 07 - Bright White
set -l color16 "ff/77/3a" # Base 09
set -l color17 "b4/d9/7c" # Base 0F
set -l color18 "20/20/30" # Base 01
set -l color19 "2a/2a/3f" # Base 02
set -l color20 "51/51/55" # Base 04
set -l color21 "ff/f2/d1" # Base 06
set -l color_foreground "81/81/75" # Base 05
set -l color_background "1a/1a/2f" # Base 00
...
set -U fish_color_end 818175
set -U fish_color_error brred
set -U fish_color_param 515155
set -U fish_color_valid_path --underline
set -U fish_color_option brcyan
set -U fish_color_comment 313140
set -U fish_color_selection fff2d1 --bold --background=2a2a3f
set -U fish_color_operator brblue
set -U fish_color_escape brcyan
set -U fish_color_autosuggestion 313140
...
set -U fish_color_search_match bryellow --background=2a2a3f
set -U fish_color_history_current --bold
set -U fish_pager_color_progress 202030 --background=515155
set -U fish_pager_color_background normal --background=1a1a2f
set -U fish_pager_color_prefix normal --bold
set -U fish_pager_color_completion normal
set -U fish_pager_color_description ff773a --dim
set -U fish_pager_color_selected_background fff2d1 --background=2a2a3f
set -U fish_pager_color_selected_prefix fff2d1 --bold --background=2a2a3f
set -U fish_pager_color_selected_completion fff2d1
...
# Set theme
set -Ux BASE16_THEME lime

# Optionally export variables
if test -n "$TINTED_SHELL_ENABLE_BASE16_VARS"; or test -n "$BASE16_SHELL_ENABLE_VARS"
  set -gx BASE16_COLOR_00_HEX "1a1a2f"
  set -gx BASE16_COLOR_01_HEX "202030"
  set -gx BASE16_COLOR_02_HEX "2a2a3f"
  set -gx BASE16_COLOR_03_HEX "313140"
  set -gx BASE16_COLOR_04_HEX "515155"
  set -gx BASE16_COLOR_05_HEX "818175"
  set -gx BASE16_COLOR_06_HEX "fff2d1"
  set -gx BASE16_COLOR_07_HEX "fff8e1"
  set -gx BASE16_COLOR_08_HEX "ff662a"
  set -gx BASE16_COLOR_09_HEX "ff773a"
  set -gx BASE16_COLOR_0A_HEX "ffd15e"
  set -gx BASE16_COLOR_0B_HEX "8cd97c"
  set -gx BASE16_COLOR_0C_HEX "4cad83"
  set -gx BASE16_COLOR_0D_HEX "2b926f"
  set -gx BASE16_COLOR_0E_HEX "1b825f"
  set -gx BASE16_COLOR_0F_HEX "b4d97c"
end
