...
set -l color01 "ef/a6/a2" # Base 08 - Red
set -l color02 "80/c9/90" # Base 0B - Green
set -l color03 "e6/a3/dc" # Base 0A - Yellow
set -l color04 "50/ca/cd" # Base 0D - Blue
set -l color05 "e0/af/85" # Base 0E - Magenta
set -l color06 "c8/c8/74" # Base 0C - Cyan
set -l color07 "c0/c0/c0" # Base 05 - White
set -l color08 "45/45/45" # Base 03 - Bright Black
...
set -l color15 "45/45/45" # Base 07 - Bright White
set -l color16 "a3/b8/ef" # Base 09
set -l color17 "80/80/80" # Base 0F
set -l color18 "45/45/45" # Base 01
set -l color19 "45/45/45" # Base 02
set -l color20 "80/80/80" # Base 04
set -l color21 "c0/c0/c0" # Base 06
...
set -U fish_color_selection c0c0c0 --bold --background=454545
...
set -U fish_pager_color_progress 454545 --background=808080
set -U fish_pager_color_background normal --background=101010
set -U fish_pager_color_prefix normal --bold
set -U fish_pager_color_completion normal
set -U fish_pager_color_description a3b8ef --dim
set -U fish_pager_color_selected_background c0c0c0 --background=454545
set -U fish_pager_color_selected_prefix c0c0c0 --bold --background=454545
set -U fish_pager_color_selected_completion c0c0c0
...
# Set theme
set -Ux BASE16_THEME qualia

# Optionally export variables
if test -n "$TINTED_SHELL_ENABLE_BASE16_VARS"; or test -n "$BASE16_SHELL_ENABLE_VARS"
  set -gx BASE16_COLOR_00_HEX "101010"
  set -gx BASE16_COLOR_01_HEX "454545"
  set -gx BASE16_COLOR_02_HEX "454545"
  set -gx BASE16_COLOR_03_HEX "454545"
  set -gx BASE16_COLOR_04_HEX "808080"
  set -gx BASE16_COLOR_05_HEX "c0c0c0"
  set -gx BASE16_COLOR_06_HEX "c0c0c0"
  set -gx BASE16_COLOR_07_HEX "454545"
  set -gx BASE16_COLOR_08_HEX "efa6a2"
  set -gx BASE16_COLOR_09_HEX "a3b8ef"
  set -gx BASE16_COLOR_0A_HEX "e6a3dc"
  set -gx BASE16_COLOR_0B_HEX "80c990"
  set -gx BASE16_COLOR_0C_HEX "c8c874"
  set -gx BASE16_COLOR_0D_HEX "50cacd"
  set -gx BASE16_COLOR_0E_HEX "e0af85"
  set -gx BASE16_COLOR_0F_HEX "808080"
end
