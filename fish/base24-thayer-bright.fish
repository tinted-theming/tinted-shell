...
set -l color01 "f9/26/72" # Base 08 - Red
set -l color02 "4d/f7/40" # Base 0B - Green
set -l color03 "3f/78/ff" # Base 0A - Yellow
set -l color04 "26/56/d6" # Base 0D - Blue
set -l color05 "8c/54/fe" # Base 0E - Magenta
set -l color06 "37/c8/b4" # Base 0C - Cyan
set -l color07 "ad/ad/a9" # Base 05 - White
set -l color08 "6f/71/70" # Base 03 - Bright Black
...
set -l color15 "f8/f8/f2" # Base 07 - Bright White
set -l color16 "f3/fd/21" # Base 09
set -l color17 "7c/13/39" # Base 0F
set -l color18 "1b/1d/1e" # Base 01
set -l color19 "50/53/54" # Base 02
set -l color20 "8e/8f/8d" # Base 04
set -l color21 "cc/cc/c6" # Base 06
set -l color_foreground "ad/ad/a9" # Base 05
...
set -U fish_color_end adada9
set -U fish_color_error brred
set -U fish_color_param 8e8f8d
set -U fish_color_valid_path --underline
set -U fish_color_option brcyan
set -U fish_color_comment 6f7170
set -U fish_color_selection ccccc6 --bold --background=505354
set -U fish_color_operator brblue
set -U fish_color_escape brcyan
set -U fish_color_autosuggestion 6f7170
...
set -U fish_pager_color_progress 1b1d1e --background=8e8f8d
set -U fish_pager_color_background normal --background=1b1d1e
set -U fish_pager_color_prefix normal --bold
set -U fish_pager_color_completion normal
set -U fish_pager_color_description f3fd21 --dim
set -U fish_pager_color_selected_background ccccc6 --background=505354
set -U fish_pager_color_selected_prefix ccccc6 --bold --background=505354
set -U fish_pager_color_selected_completion ccccc6
...
# Set theme
set -Ux BASE24_THEME thayer-bright
...
if test -n "$TINTED_SHELL_ENABLE_BASE24_VARS"; or test -n "$BASE24_SHELL_ENABLE_VARS"
  ...
  set -gx BASE24_COLOR_03_HEX "6f7170"
  set -gx BASE24_COLOR_04_HEX "8e8f8d"
  set -gx BASE24_COLOR_05_HEX "adada9"
  set -gx BASE24_COLOR_06_HEX "ccccc6"
  set -gx BASE24_COLOR_07_HEX "f8f8f2"
  set -gx BASE24_COLOR_08_HEX "f92672"
  set -gx BASE24_COLOR_09_HEX "f3fd21"
  set -gx BASE24_COLOR_0A_HEX "3f78ff"
  set -gx BASE24_COLOR_0B_HEX "4df740"
  set -gx BASE24_COLOR_0C_HEX "37c8b4"
  set -gx BASE24_COLOR_0D_HEX "2656d6"
  set -gx BASE24_COLOR_0E_HEX "8c54fe"
  set -gx BASE24_COLOR_0F_HEX "7c1339"
end
