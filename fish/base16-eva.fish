...
set -l color02 "66/ff/66" # Base 0B - Green
set -l color03 "ff/ff/66" # Base 0A - Yellow
set -l color04 "15/f4/ee" # Base 0D - Blue
...
if test -n "$TINTED_SHELL_ENABLE_BASE16_VARS"; or test -n "$BASE16_SHELL_ENABLE_VARS"
  ...
  set -gx BASE16_COLOR_0A_HEX "ffff66"
  set -gx BASE16_COLOR_0B_HEX "66ff66"
  set -gx BASE16_COLOR_0C_HEX "4b8f77"
  set -gx BASE16_COLOR_0D_HEX "15f4ee"
