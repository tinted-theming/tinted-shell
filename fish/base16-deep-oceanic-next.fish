...
set -U fish_color_end d4e1e8
set -U fish_color_error brred
set -U fish_color_param 0093a3
set -U fish_color_valid_path --underline
set -U fish_color_option brcyan
set -U fish_color_comment 004852
set -U fish_color_selection e0e9ef --bold --background=003640
...
set -U fish_color_search_match bryellow --background=003640
set -U fish_color_history_current --bold
set -U fish_pager_color_progress 002931 --background=0093a3
set -U fish_pager_color_background normal --background=001c1f
set -U fish_pager_color_prefix normal --bold
set -U fish_pager_color_completion normal
set -U fish_pager_color_description e37552 --dim
set -U fish_pager_color_selected_background e0e9ef --background=003640
set -U fish_pager_color_selected_prefix e0e9ef --bold --background=003640
set -U fish_pager_color_selected_completion e0e9ef
...
# Set theme
set -Ux BASE16_THEME deep-oceanic-next

# Optionally export variables
if test -n "$TINTED_SHELL_ENABLE_BASE16_VARS"; or test -n "$BASE16_SHELL_ENABLE_VARS"
  set -gx BASE16_COLOR_00_HEX "001c1f"
  set -gx BASE16_COLOR_01_HEX "002931"
  set -gx BASE16_COLOR_02_HEX "003640"
  set -gx BASE16_COLOR_03_HEX "004852"
  set -gx BASE16_COLOR_04_HEX "0093a3"
  set -gx BASE16_COLOR_05_HEX "d4e1e8"
  set -gx BASE16_COLOR_06_HEX "e0e9ef"
  set -gx BASE16_COLOR_07_HEX "f2f7f9"
  set -gx BASE16_COLOR_08_HEX "d3464d"
  set -gx BASE16_COLOR_09_HEX "e37552"
  set -gx BASE16_COLOR_0A_HEX "f3b863"
  set -gx BASE16_COLOR_0B_HEX "63b784"
  set -gx BASE16_COLOR_0C_HEX "4fb7ae"
  set -gx BASE16_COLOR_0D_HEX "568ccf"
  set -gx BASE16_COLOR_0E_HEX "8b66d6"
  set -gx BASE16_COLOR_0F_HEX "d0658e"
end
