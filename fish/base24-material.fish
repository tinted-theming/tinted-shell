...
set -l color00 "ea/ea/ea" # Base 00 - Black
...
set -l color_background "ea/ea/ea" # Base 00
...
set -U fish_pager_color_background normal --background=eaeaea
