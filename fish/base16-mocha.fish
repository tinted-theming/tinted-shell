...
set -l color00 "3b/32/28" # Base 00 - Black
set -l color01 "cb/60/77" # Base 08 - Red
set -l color02 "be/b5/5b" # Base 0B - Green
set -l color03 "f4/bc/87" # Base 0A - Yellow
set -l color04 "8a/b3/b5" # Base 0D - Blue
set -l color05 "a8/9b/b9" # Base 0E - Magenta
set -l color06 "7b/bd/a4" # Base 0C - Cyan
set -l color07 "d0/c8/c6" # Base 05 - White
set -l color08 "7e/70/5a" # Base 03 - Bright Black
...
set -l color15 "f5/ee/eb" # Base 07 - Bright White
set -l color16 "d2/8b/71" # Base 09
set -l color17 "bb/95/84" # Base 0F
set -l color18 "53/46/36" # Base 01
set -l color19 "64/52/40" # Base 02
set -l color20 "b8/af/ad" # Base 04
set -l color21 "e9/e1/dd" # Base 06
set -l color_foreground "d0/c8/c6" # Base 05
set -l color_background "3b/32/28" # Base 00
...
set -U fish_color_end d0c8c6
set -U fish_color_error brred
set -U fish_color_param b8afad
set -U fish_color_valid_path --underline
set -U fish_color_option brcyan
set -U fish_color_comment 7e705a
set -U fish_color_selection e9e1dd --bold --background=645240
set -U fish_color_operator brblue
set -U fish_color_escape brcyan
set -U fish_color_autosuggestion 7e705a
...
set -U fish_pager_color_progress 534636 --background=b8afad
set -U fish_pager_color_background normal --background=3b3228
set -U fish_pager_color_prefix normal --bold
set -U fish_pager_color_completion normal
set -U fish_pager_color_description d28b71 --dim
set -U fish_pager_color_selected_background e9e1dd --background=645240
set -U fish_pager_color_selected_prefix e9e1dd --bold --background=645240
set -U fish_pager_color_selected_completion e9e1dd
...
# Set theme
set -Ux BASE16_THEME mocha

# Optionally export variables
if test -n "$TINTED_SHELL_ENABLE_BASE16_VARS"; or test -n "$BASE16_SHELL_ENABLE_VARS"
  set -gx BASE16_COLOR_00_HEX "3b3228"
  set -gx BASE16_COLOR_01_HEX "534636"
  set -gx BASE16_COLOR_02_HEX "645240"
  set -gx BASE16_COLOR_03_HEX "7e705a"
  set -gx BASE16_COLOR_04_HEX "b8afad"
  set -gx BASE16_COLOR_05_HEX "d0c8c6"
  set -gx BASE16_COLOR_06_HEX "e9e1dd"
  set -gx BASE16_COLOR_07_HEX "f5eeeb"
  set -gx BASE16_COLOR_08_HEX "cb6077"
  set -gx BASE16_COLOR_09_HEX "d28b71"
  set -gx BASE16_COLOR_0A_HEX "f4bc87"
  set -gx BASE16_COLOR_0B_HEX "beb55b"
  set -gx BASE16_COLOR_0C_HEX "7bbda4"
  set -gx BASE16_COLOR_0D_HEX "8ab3b5"
  set -gx BASE16_COLOR_0E_HEX "a89bb9"
  set -gx BASE16_COLOR_0F_HEX "bb9584"
end
