...
set -l color01 "ff/7f/7b" # Base 08 - Red
set -l color02 "be/da/78" # Base 0B - Green
set -l color03 "ff/d6/7c" # Base 0A - Yellow
set -l color04 "90/be/e1" # Base 0D - Blue
set -l color05 "ef/b3/f7" # Base 0E - Magenta
...
set -l color16 "ff/bf/70" # Base 09
set -l color17 "ff/93/b3" # Base 0F
...
set -U fish_pager_color_description ffbf70 --dim
...
if test -n "$TINTED_SHELL_ENABLE_BASE16_VARS"; or test -n "$BASE16_SHELL_ENABLE_VARS"
  ...
  set -gx BASE16_COLOR_08_HEX "ff7f7b"
  set -gx BASE16_COLOR_09_HEX "ffbf70"
  set -gx BASE16_COLOR_0A_HEX "ffd67c"
  set -gx BASE16_COLOR_0B_HEX "beda78"
  set -gx BASE16_COLOR_0C_HEX "bed6ff"
  set -gx BASE16_COLOR_0D_HEX "90bee1"
  set -gx BASE16_COLOR_0E_HEX "efb3f7"
  set -gx BASE16_COLOR_0F_HEX "ff93b3"
end
