...
set -l color00 "20/27/46" # Base 00 - Black
set -l color01 "c9/49/22" # Base 08 - Red
set -l color02 "ac/97/39" # Base 0B - Green
set -l color03 "89/8e/a4" # Base 0A - Yellow
set -l color04 "3d/8f/d1" # Base 0D - Blue
set -l color05 "66/79/cc" # Base 0E - Magenta
set -l color06 "22/a2/c9" # Base 0C - Cyan
set -l color07 "8c/92/ac" # Base 05 - White
set -l color08 "76/7d/9c" # Base 03 - Bright Black
...
set -l color15 "f5/f7/ff" # Base 07 - Bright White
set -l color16 "c0/8b/30" # Base 09
set -l color17 "64/24/11" # Base 0F
set -l color18 "20/27/46" # Base 01
set -l color19 "6b/73/94" # Base 02
set -l color20 "81/88/a4" # Base 04
set -l color21 "97/9d/b4" # Base 06
set -l color_foreground "8c/92/ac" # Base 05
set -l color_background "20/27/46" # Base 00
...
set -U fish_color_end 8c92ac
set -U fish_color_error brred
set -U fish_color_param 8188a4
set -U fish_color_valid_path --underline
set -U fish_color_option brcyan
set -U fish_color_comment 767d9c
set -U fish_color_selection 979db4 --bold --background=6b7394
set -U fish_color_operator brblue
set -U fish_color_escape brcyan
set -U fish_color_autosuggestion 767d9c
...
set -U fish_color_search_match bryellow --background=6b7394
set -U fish_color_history_current --bold
set -U fish_pager_color_progress 202746 --background=8188a4
set -U fish_pager_color_background normal --background=202746
set -U fish_pager_color_prefix normal --bold
set -U fish_pager_color_completion normal
set -U fish_pager_color_description c08b30 --dim
set -U fish_pager_color_selected_background 979db4 --background=6b7394
set -U fish_pager_color_selected_prefix 979db4 --bold --background=6b7394
set -U fish_pager_color_selected_completion 979db4
...
# Set theme
set -Ux BASE24_THEME atelier-sulphurpool

# Optionally export variables
if test -n "$TINTED_SHELL_ENABLE_BASE24_VARS"; or test -n "$BASE24_SHELL_ENABLE_VARS"
  set -gx BASE24_COLOR_00_HEX "202746"
  set -gx BASE24_COLOR_01_HEX "202746"
  set -gx BASE24_COLOR_02_HEX "6b7394"
  set -gx BASE24_COLOR_03_HEX "767d9c"
  set -gx BASE24_COLOR_04_HEX "8188a4"
  set -gx BASE24_COLOR_05_HEX "8c92ac"
  set -gx BASE24_COLOR_06_HEX "979db4"
  set -gx BASE24_COLOR_07_HEX "f5f7ff"
  set -gx BASE24_COLOR_08_HEX "c94922"
  set -gx BASE24_COLOR_09_HEX "c08b30"
  set -gx BASE24_COLOR_0A_HEX "898ea4"
  set -gx BASE24_COLOR_0B_HEX "ac9739"
  set -gx BASE24_COLOR_0C_HEX "22a2c9"
  set -gx BASE24_COLOR_0D_HEX "3d8fd1"
  set -gx BASE24_COLOR_0E_HEX "6679cc"
  set -gx BASE24_COLOR_0F_HEX "642411"
end
