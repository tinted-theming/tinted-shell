...
set -l color08 "5a/52/4c" # Base 03 - Bright Black
...
set -l color18 "2a/28/27" # Base 01
...
set -U fish_pager_color_progress 2a2827 --background=bdae93
...
# Set theme
set -Ux BASE16_THEME gruvbox-material-dark-hard

# Optionally export variables
if test -n "$TINTED_SHELL_ENABLE_BASE16_VARS"; or test -n "$BASE16_SHELL_ENABLE_VARS"
  set -gx BASE16_COLOR_00_HEX "202020"
  set -gx BASE16_COLOR_01_HEX "2a2827"
  set -gx BASE16_COLOR_02_HEX "504945"
  set -gx BASE16_COLOR_03_HEX "5a524c"
