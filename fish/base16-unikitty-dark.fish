...
set -l color04 "79/6a/f5" # Base 0D - Blue
set -l color05 "bb/60/ea" # Base 0E - Magenta
set -l color06 "14/9b/da" # Base 0C - Cyan
set -l color07 "bc/ba/be" # Base 05 - White
set -l color08 "83/80/85" # Base 03 - Bright Black
...
set -l color15 "f5/f4/f7" # Base 07 - Bright White
set -l color16 "d6/54/07" # Base 09
set -l color17 "c7/20/ca" # Base 0F
set -l color18 "4a/46/4d" # Base 01
set -l color19 "66/63/69" # Base 02
set -l color20 "9f/9d/a2" # Base 04
set -l color21 "d8/d7/da" # Base 06
set -l color_foreground "bc/ba/be" # Base 05
...
set -U fish_color_end bcbabe
set -U fish_color_error brred
set -U fish_color_param 9f9da2
set -U fish_color_valid_path --underline
set -U fish_color_option brcyan
set -U fish_color_comment 838085
set -U fish_color_selection d8d7da --bold --background=666369
set -U fish_color_operator brblue
set -U fish_color_escape brcyan
set -U fish_color_autosuggestion 838085
...
set -U fish_pager_color_progress 4a464d --background=9f9da2
...
set -U fish_pager_color_selected_background d8d7da --background=666369
set -U fish_pager_color_selected_prefix d8d7da --bold --background=666369
set -U fish_pager_color_selected_completion d8d7da
...
# Set theme
set -Ux BASE16_THEME unikitty-dark

# Optionally export variables
if test -n "$TINTED_SHELL_ENABLE_BASE16_VARS"; or test -n "$BASE16_SHELL_ENABLE_VARS"
  set -gx BASE16_COLOR_00_HEX "2e2a31"
  set -gx BASE16_COLOR_01_HEX "4a464d"
  set -gx BASE16_COLOR_02_HEX "666369"
  set -gx BASE16_COLOR_03_HEX "838085"
  set -gx BASE16_COLOR_04_HEX "9f9da2"
  set -gx BASE16_COLOR_05_HEX "bcbabe"
  set -gx BASE16_COLOR_06_HEX "d8d7da"
  set -gx BASE16_COLOR_07_HEX "f5f4f7"
  ...
  set -gx BASE16_COLOR_0D_HEX "796af5"
  set -gx BASE16_COLOR_0E_HEX "bb60ea"
  set -gx BASE16_COLOR_0F_HEX "c720ca"
end
