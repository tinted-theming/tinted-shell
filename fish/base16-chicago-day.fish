...
set -l color15 "1e/2a/24" # Base 07 - Bright White
set -l color16 "f9/46/1c" # Base 09
set -l color17 "62/36/1b" # Base 0F
set -l color18 "d1/e0/d7" # Base 01
set -l color19 "b9/d0/c3" # Base 02
set -l color20 "4b/5a/51" # Base 04
set -l color21 "2a/3b/32" # Base 06
set -l color_foreground "36/4c/40" # Base 05
set -l color_background "e8/f0/ea" # Base 00
...
set -U fish_color_end 364c40
set -U fish_color_error brred
set -U fish_color_param 4b5a51
set -U fish_color_valid_path --underline
set -U fish_color_option brcyan
set -U fish_color_comment 8a9a91
set -U fish_color_selection 2a3b32 --bold --background=b9d0c3
set -U fish_color_operator brblue
set -U fish_color_escape brcyan
set -U fish_color_autosuggestion 8a9a91
...
set -U fish_color_search_match bryellow --background=b9d0c3
set -U fish_color_history_current --bold
set -U fish_pager_color_progress d1e0d7 --background=4b5a51
set -U fish_pager_color_background normal --background=e8f0ea
set -U fish_pager_color_prefix normal --bold
set -U fish_pager_color_completion normal
set -U fish_pager_color_description f9461c --dim
set -U fish_pager_color_selected_background 2a3b32 --background=b9d0c3
set -U fish_pager_color_selected_prefix 2a3b32 --bold --background=b9d0c3
set -U fish_pager_color_selected_completion 2a3b32
...
# Set theme
set -Ux BASE16_THEME chicago-day

# Optionally export variables
if test -n "$TINTED_SHELL_ENABLE_BASE16_VARS"; or test -n "$BASE16_SHELL_ENABLE_VARS"
  set -gx BASE16_COLOR_00_HEX "e8f0ea"
  set -gx BASE16_COLOR_01_HEX "d1e0d7"
  set -gx BASE16_COLOR_02_HEX "b9d0c3"
  set -gx BASE16_COLOR_03_HEX "8a9a91"
  set -gx BASE16_COLOR_04_HEX "4b5a51"
  set -gx BASE16_COLOR_05_HEX "364c40"
  set -gx BASE16_COLOR_06_HEX "2a3b32"
  set -gx BASE16_COLOR_07_HEX "1e2a24"
  set -gx BASE16_COLOR_08_HEX "c60c30"
  set -gx BASE16_COLOR_09_HEX "f9461c"
  set -gx BASE16_COLOR_0A_HEX "968400"
