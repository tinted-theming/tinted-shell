...
set -l color00 "ff/7a/d3" # Base 00 - Black
set -l color01 "a8/0f/20" # Base 08 - Red
set -l color02 "ba/fc/8b" # Base 0B - Green
set -l color03 "ee/df/4b" # Base 0A - Yellow
set -l color04 "14/5f/cd" # Base 0D - Blue
set -l color05 "ff/36/a2" # Base 0E - Magenta
set -l color06 "6b/d0/bc" # Base 0C - Cyan
set -l color07 "b9/b1/b8" # Base 05 - White
set -l color08 "69/67/69" # Base 03 - Bright Black
...
set -l color15 "ff/f2/fd" # Base 07 - Bright White
set -l color16 "ee/aa/4b" # Base 09
set -l color17 "54/07/10" # Base 0F
set -l color18 "0c/0c/0c" # Base 01
set -l color19 "42/42/42" # Base 02
set -l color20 "91/8c/91" # Base 04
set -l color21 "e1/d6/e0" # Base 06
set -l color_foreground "b9/b1/b8" # Base 05
set -l color_background "ff/7a/d3" # Base 00
...
set -U fish_color_end b9b1b8
set -U fish_color_error brred
set -U fish_color_param 918c91
set -U fish_color_valid_path --underline
set -U fish_color_option brcyan
set -U fish_color_comment 696769
set -U fish_color_selection e1d6e0 --bold --background=424242
set -U fish_color_operator brblue
set -U fish_color_escape brcyan
set -U fish_color_autosuggestion 696769
...
set -U fish_pager_color_progress 0c0c0c --background=918c91
set -U fish_pager_color_background normal --background=ff7ad3
set -U fish_pager_color_prefix normal --bold
set -U fish_pager_color_completion normal
set -U fish_pager_color_description eeaa4b --dim
set -U fish_pager_color_selected_background e1d6e0 --background=424242
set -U fish_pager_color_selected_prefix e1d6e0 --bold --background=424242
set -U fish_pager_color_selected_completion e1d6e0
...
# Set theme
set -Ux BASE24_THEME unikitty

# Optionally export variables
if test -n "$TINTED_SHELL_ENABLE_BASE24_VARS"; or test -n "$BASE24_SHELL_ENABLE_VARS"
  set -gx BASE24_COLOR_00_HEX "ff7ad3"
  set -gx BASE24_COLOR_01_HEX "0c0c0c"
  set -gx BASE24_COLOR_02_HEX "424242"
  set -gx BASE24_COLOR_03_HEX "696769"
  set -gx BASE24_COLOR_04_HEX "918c91"
  set -gx BASE24_COLOR_05_HEX "b9b1b8"
  set -gx BASE24_COLOR_06_HEX "e1d6e0"
  set -gx BASE24_COLOR_07_HEX "fff2fd"
  set -gx BASE24_COLOR_08_HEX "a80f20"
  set -gx BASE24_COLOR_09_HEX "eeaa4b"
  set -gx BASE24_COLOR_0A_HEX "eedf4b"
  set -gx BASE24_COLOR_0B_HEX "bafc8b"
  set -gx BASE24_COLOR_0C_HEX "6bd0bc"
  set -gx BASE24_COLOR_0D_HEX "145fcd"
  set -gx BASE24_COLOR_0E_HEX "ff36a2"
  set -gx BASE24_COLOR_0F_HEX "540710"
end
