...
set -U fish_color_selection e1d6e0 --background=424242
set -U fish_color_operator magenta
set -U fish_color_escape eeaa4b
...
set -U fish_pager_color_background --background=ff7ad3
set -U fish_pager_color_prefix --bold --italics
set -U fish_pager_color_completion normal
set -U fish_pager_color_description eeaa4b
