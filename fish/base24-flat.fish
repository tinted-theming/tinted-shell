...
set -U fish_color_end 8c939a
set -U fish_color_error brred
set -U fish_color_param 68717b
set -U fish_color_valid_path --underline
set -U fish_color_option brcyan
set -U fish_color_comment 444e5b
set -U fish_color_selection b0b6ba --bold --background=2e2e45
...
set -U fish_color_search_match bryellow --background=2e2e45
set -U fish_color_history_current --bold
set -U fish_pager_color_progress 1d2845 --background=68717b
set -U fish_pager_color_background normal --background=082845
set -U fish_pager_color_prefix normal --bold
set -U fish_pager_color_completion normal
set -U fish_pager_color_description e58d11 --dim
set -U fish_pager_color_selected_background b0b6ba --background=2e2e45
set -U fish_pager_color_selected_prefix b0b6ba --bold --background=2e2e45
set -U fish_pager_color_selected_completion b0b6ba
