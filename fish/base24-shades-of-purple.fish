...
set -l color00 "1e/1d/40" # Base 00 - Black
set -l color01 "d9/04/29" # Base 08 - Red
set -l color02 "3a/d9/00" # Base 0B - Green
set -l color03 "68/71/ff" # Base 0A - Yellow
set -l color04 "69/43/ff" # Base 0D - Blue
set -l color05 "ff/2b/70" # Base 0E - Magenta
...
set -l color16 "ff/e7/00" # Base 09
set -l color17 "6c/02/14" # Base 0F
...
set -l color_background "1e/1d/40" # Base 00
...
set -U fish_pager_color_progress 000000 --background=979797
set -U fish_pager_color_background normal --background=1e1d40
set -U fish_pager_color_prefix normal --bold
set -U fish_pager_color_completion normal
set -U fish_pager_color_description ffe700 --dim
...
if test -n "$TINTED_SHELL_ENABLE_BASE24_VARS"; or test -n "$BASE24_SHELL_ENABLE_VARS"
  ...
  set -gx BASE24_COLOR_08_HEX "d90429"
  set -gx BASE24_COLOR_09_HEX "ffe700"
  set -gx BASE24_COLOR_0A_HEX "6871ff"
  set -gx BASE24_COLOR_0B_HEX "3ad900"
  set -gx BASE24_COLOR_0C_HEX "00c5c7"
  set -gx BASE24_COLOR_0D_HEX "6943ff"
  set -gx BASE24_COLOR_0E_HEX "ff2b70"
  set -gx BASE24_COLOR_0F_HEX "6c0214"
end
