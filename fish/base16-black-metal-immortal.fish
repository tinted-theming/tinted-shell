...
set -l color02 "77/99/bb" # Base 0B - Green
set -l color03 "55/66/77" # Base 0A - Yellow
...
# Set theme
set -Ux BASE16_THEME black-metal-immortal
...
if test -n "$TINTED_SHELL_ENABLE_BASE16_VARS"; or test -n "$BASE16_SHELL_ENABLE_VARS"
  ...
  set -gx BASE16_COLOR_0A_HEX "556677"
  set -gx BASE16_COLOR_0B_HEX "7799bb"
