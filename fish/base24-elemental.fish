...
set -l color00 "21/21/1c" # Base 00 - Black
set -l color01 "97/28/0f" # Base 08 - Red
set -l color02 "47/99/42" # Base 0B - Green
set -l color03 "78/d8/d8" # Base 0A - Yellow
set -l color04 "49/7f/7d" # Base 0D - Blue
set -l color05 "7e/4e/2e" # Base 0E - Magenta
set -l color06 "38/7f/58" # Base 0C - Cyan
set -l color07 "75/6f/68" # Base 05 - White
set -l color08 "5f/5d/50" # Base 03 - Bright Black
...
set -l color16 "7f/71/10" # Base 09
set -l color17 "4b/14/07" # Base 0F
set -l color18 "3c/3b/30" # Base 01
set -l color19 "54/54/44" # Base 02
set -l color20 "6a/66/5c" # Base 04
set -l color21 "80/79/74" # Base 06
set -l color_foreground "75/6f/68" # Base 05
set -l color_background "21/21/1c" # Base 00
...
set -U fish_color_end 756f68
set -U fish_color_error brred
set -U fish_color_param 6a665c
set -U fish_color_valid_path --underline
set -U fish_color_option brcyan
set -U fish_color_comment 5f5d50
set -U fish_color_selection 807974 --bold --background=545444
set -U fish_color_operator brblue
set -U fish_color_escape brcyan
set -U fish_color_autosuggestion 5f5d50
...
set -U fish_color_search_match bryellow --background=545444
set -U fish_color_history_current --bold
set -U fish_pager_color_progress 3c3b30 --background=6a665c
set -U fish_pager_color_background normal --background=21211c
set -U fish_pager_color_prefix normal --bold
set -U fish_pager_color_completion normal
set -U fish_pager_color_description 7f7110 --dim
set -U fish_pager_color_selected_background 807974 --background=545444
set -U fish_pager_color_selected_prefix 807974 --bold --background=545444
set -U fish_pager_color_selected_completion 807974
...
# Set theme
set -Ux BASE24_THEME elemental

# Optionally export variables
if test -n "$TINTED_SHELL_ENABLE_BASE24_VARS"; or test -n "$BASE24_SHELL_ENABLE_VARS"
  set -gx BASE24_COLOR_00_HEX "21211c"
  set -gx BASE24_COLOR_01_HEX "3c3b30"
  set -gx BASE24_COLOR_02_HEX "545444"
  set -gx BASE24_COLOR_03_HEX "5f5d50"
  set -gx BASE24_COLOR_04_HEX "6a665c"
  set -gx BASE24_COLOR_05_HEX "756f68"
  set -gx BASE24_COLOR_06_HEX "807974"
  set -gx BASE24_COLOR_07_HEX "fff1e8"
  set -gx BASE24_COLOR_08_HEX "97280f"
  set -gx BASE24_COLOR_09_HEX "7f7110"
  set -gx BASE24_COLOR_0A_HEX "78d8d8"
  set -gx BASE24_COLOR_0B_HEX "479942"
  set -gx BASE24_COLOR_0C_HEX "387f58"
  set -gx BASE24_COLOR_0D_HEX "497f7d"
  set -gx BASE24_COLOR_0E_HEX "7e4e2e"
  set -gx BASE24_COLOR_0F_HEX "4b1407"
end
