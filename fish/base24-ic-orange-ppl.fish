...
set -U fish_color_selection ffc88a --background=6a4e29
set -U fish_color_operator magenta
set -U fish_color_escape caae00
...
set -U fish_color_search_match yellow --background=6a4e29
set -U fish_color_history_current --underline=curly
set -U fish_pager_color_progress 000000 --background=b48b59
set -U fish_pager_color_background --background=262626
set -U fish_pager_color_prefix --bold --italics
set -U fish_pager_color_completion normal
set -U fish_pager_color_description caae00
set -U fish_pager_color_selected_background --background=6a4e29
set -U fish_pager_color_selected_prefix --bold --italics --background=6a4e29
