...
set -l color00 "26/26/26" # Base 00 - Black
set -l color01 "c0/39/00" # Base 08 - Red
set -l color02 "a3/a9/00" # Base 0B - Green
set -l color03 "ff/bd/54" # Base 0A - Yellow
set -l color04 "bd/6c/00" # Base 0D - Blue
set -l color05 "fb/5d/00" # Base 0E - Magenta
set -l color06 "f7/94/00" # Base 0C - Cyan
set -l color07 "d9/a9/71" # Base 05 - White
set -l color08 "8f/6c/41" # Base 03 - Bright Black
...
set -l color15 "f9/f9/fe" # Base 07 - Bright White
set -l color16 "ca/ae/00" # Base 09
set -l color17 "60/1c/00" # Base 0F
set -l color18 "00/00/00" # Base 01
set -l color19 "6a/4e/29" # Base 02
set -l color20 "b4/8b/59" # Base 04
set -l color21 "ff/c8/8a" # Base 06
set -l color_foreground "d9/a9/71" # Base 05
set -l color_background "26/26/26" # Base 00
...
set -U fish_color_end d9a971
set -U fish_color_error brred
set -U fish_color_param b48b59
set -U fish_color_valid_path --underline
set -U fish_color_option brcyan
set -U fish_color_comment 8f6c41
set -U fish_color_selection ffc88a --bold --background=6a4e29
set -U fish_color_operator brblue
set -U fish_color_escape brcyan
set -U fish_color_autosuggestion 8f6c41
...
set -U fish_color_search_match bryellow --background=6a4e29
set -U fish_color_history_current --bold
set -U fish_pager_color_progress 000000 --background=b48b59
set -U fish_pager_color_background normal --background=262626
set -U fish_pager_color_prefix normal --bold
set -U fish_pager_color_completion normal
set -U fish_pager_color_description caae00 --dim
set -U fish_pager_color_selected_background ffc88a --background=6a4e29
set -U fish_pager_color_selected_prefix ffc88a --bold --background=6a4e29
set -U fish_pager_color_selected_completion ffc88a
...
# Set theme
set -Ux BASE24_THEME ic-orange-ppl
...
if test -n "$TINTED_SHELL_ENABLE_BASE24_VARS"; or test -n "$BASE24_SHELL_ENABLE_VARS"
  ...
  set -gx BASE24_COLOR_02_HEX "6a4e29"
  set -gx BASE24_COLOR_03_HEX "8f6c41"
  set -gx BASE24_COLOR_04_HEX "b48b59"
  set -gx BASE24_COLOR_05_HEX "d9a971"
  set -gx BASE24_COLOR_06_HEX "ffc88a"
  set -gx BASE24_COLOR_07_HEX "f9f9fe"
  set -gx BASE24_COLOR_08_HEX "c03900"
  set -gx BASE24_COLOR_09_HEX "caae00"
  set -gx BASE24_COLOR_0A_HEX "ffbd54"
  set -gx BASE24_COLOR_0B_HEX "a3a900"
  set -gx BASE24_COLOR_0C_HEX "f79400"
  set -gx BASE24_COLOR_0D_HEX "bd6c00"
  set -gx BASE24_COLOR_0E_HEX "fb5d00"
  set -gx BASE24_COLOR_0F_HEX "601c00"
end
