...
set -l color00 "29/2a/37" # Base 00 - Black
set -l color01 "ec/6a/88" # Base 08 - Red
set -l color02 "3f/da/a4" # Base 0B - Green
set -l color03 "e1/c6/97" # Base 0A - Yellow
set -l color04 "3f/c6/de" # Base 0D - Blue
set -l color05 "be/95/ff" # Base 0E - Magenta
set -l color06 "ff/7e/b6" # Base 0C - Cyan
set -l color07 "c0/cb/e3" # Base 05 - White
set -l color08 "45/47/5d" # Base 03 - Bright Black
...
set -l color16 "ef/b9/93" # Base 09
set -l color17 "8b/8d/a9" # Base 0F
set -l color18 "34/35/45" # Base 01
set -l color19 "3c/3e/51" # Base 02
set -l color20 "50/52/6b" # Base 04
set -l color21 "d9/e0/ee" # Base 06
set -l color_foreground "c0/cb/e3" # Base 05
set -l color_background "29/2a/37" # Base 00
...
set -U fish_color_end c0cbe3
set -U fish_color_error brred
set -U fish_color_param 50526b
set -U fish_color_valid_path --underline
set -U fish_color_option brcyan
set -U fish_color_comment 45475d
set -U fish_color_selection d9e0ee --bold --background=3c3e51
set -U fish_color_operator brblue
set -U fish_color_escape brcyan
set -U fish_color_autosuggestion 45475d
...
set -U fish_color_search_match bryellow --background=3c3e51
set -U fish_color_history_current --bold
set -U fish_pager_color_progress 343545 --background=50526b
set -U fish_pager_color_background normal --background=292a37
set -U fish_pager_color_prefix normal --bold
set -U fish_pager_color_completion normal
set -U fish_pager_color_description efb993 --dim
set -U fish_pager_color_selected_background d9e0ee --background=3c3e51
set -U fish_pager_color_selected_prefix d9e0ee --bold --background=3c3e51
set -U fish_pager_color_selected_completion d9e0ee
...
# Set theme
set -Ux BASE16_THEME jabuti

# Optionally export variables
if test -n "$TINTED_SHELL_ENABLE_BASE16_VARS"; or test -n "$BASE16_SHELL_ENABLE_VARS"
  set -gx BASE16_COLOR_00_HEX "292a37"
  set -gx BASE16_COLOR_01_HEX "343545"
  set -gx BASE16_COLOR_02_HEX "3c3e51"
  set -gx BASE16_COLOR_03_HEX "45475d"
  set -gx BASE16_COLOR_04_HEX "50526b"
  set -gx BASE16_COLOR_05_HEX "c0cbe3"
  set -gx BASE16_COLOR_06_HEX "d9e0ee"
  set -gx BASE16_COLOR_07_HEX "ffffff"
  set -gx BASE16_COLOR_08_HEX "ec6a88"
  set -gx BASE16_COLOR_09_HEX "efb993"
  set -gx BASE16_COLOR_0A_HEX "e1c697"
  set -gx BASE16_COLOR_0B_HEX "3fdaa4"
  set -gx BASE16_COLOR_0C_HEX "ff7eb6"
  set -gx BASE16_COLOR_0D_HEX "3fc6de"
  set -gx BASE16_COLOR_0E_HEX "be95ff"
  set -gx BASE16_COLOR_0F_HEX "8b8da9"
end
