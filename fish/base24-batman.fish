...
set -l color01 "e6/db/43" # Base 08 - Red
set -l color02 "c8/be/46" # Base 0B - Green
set -l color03 "90/94/95" # Base 0A - Yellow
set -l color04 "73/70/74" # Base 0D - Blue
set -l color05 "73/72/71" # Base 0E - Magenta
set -l color06 "61/5f/5e" # Base 0C - Cyan
set -l color07 "a7/a8/a3" # Base 05 - White
set -l color08 "6d/6f/6e" # Base 03 - Bright Black
...
set -l color15 "da/da/d5" # Base 07 - Bright White
set -l color16 "f3/fd/21" # Base 09
set -l color17 "73/6d/21" # Base 0F
set -l color18 "1b/1d/1e" # Base 01
set -l color19 "50/53/54" # Base 02
set -l color20 "8a/8c/89" # Base 04
set -l color21 "c5/c5/be" # Base 06
set -l color_foreground "a7/a8/a3" # Base 05
...
set -U fish_color_end a7a8a3
set -U fish_color_error brred
set -U fish_color_param 8a8c89
set -U fish_color_valid_path --underline
set -U fish_color_option brcyan
set -U fish_color_comment 6d6f6e
set -U fish_color_selection c5c5be --bold --background=505354
set -U fish_color_operator brblue
set -U fish_color_escape brcyan
set -U fish_color_autosuggestion 6d6f6e
...
set -U fish_pager_color_progress 1b1d1e --background=8a8c89
...
set -U fish_pager_color_selected_background c5c5be --background=505354
set -U fish_pager_color_selected_prefix c5c5be --bold --background=505354
set -U fish_pager_color_selected_completion c5c5be
...
if test -n "$TINTED_SHELL_ENABLE_BASE24_VARS"; or test -n "$BASE24_SHELL_ENABLE_VARS"
  ...
  set -gx BASE24_COLOR_03_HEX "6d6f6e"
  set -gx BASE24_COLOR_04_HEX "8a8c89"
  set -gx BASE24_COLOR_05_HEX "a7a8a3"
  set -gx BASE24_COLOR_06_HEX "c5c5be"
  set -gx BASE24_COLOR_07_HEX "dadad5"
  set -gx BASE24_COLOR_08_HEX "e6db43"
  set -gx BASE24_COLOR_09_HEX "f3fd21"
  set -gx BASE24_COLOR_0A_HEX "909495"
  set -gx BASE24_COLOR_0B_HEX "c8be46"
  set -gx BASE24_COLOR_0C_HEX "615f5e"
  set -gx BASE24_COLOR_0D_HEX "737074"
  set -gx BASE24_COLOR_0E_HEX "737271"
  set -gx BASE24_COLOR_0F_HEX "736d21"
end
