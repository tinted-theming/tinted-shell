...
set -U fish_color_selection f1f1f1 --background=2d2d2d
set -U fish_color_operator magenta
set -U fish_color_escape d2a700
...
set -U fish_color_search_match yellow --background=2d2d2d
set -U fish_color_history_current --underline=curly
set -U fish_pager_color_progress 080808 --background=8f8f8f
set -U fish_pager_color_background --background=151144
set -U fish_pager_color_prefix --bold --italics
set -U fish_pager_color_completion normal
set -U fish_pager_color_description d2a700
set -U fish_pager_color_selected_background --background=2d2d2d
set -U fish_pager_color_selected_prefix --bold --italics --background=2d2d2d
