...
set -l color00 "15/11/44" # Base 00 - Black
set -l color01 "ff/82/72" # Base 08 - Red
set -l color02 "00/c1/72" # Base 0B - Green
set -l color03 "c1/e3/fe" # Base 0A - Yellow
set -l color04 "00/71/cf" # Base 0D - Blue
set -l color05 "ff/8f/fd" # Base 0E - Magenta
set -l color06 "6b/ff/dc" # Base 0C - Cyan
set -l color07 "c0/c0/c0" # Base 05 - White
set -l color08 "5e/5e/5e" # Base 03 - Bright Black
...
set -l color16 "d2/a7/00" # Base 09
set -l color17 "7f/41/39" # Base 0F
set -l color18 "08/08/08" # Base 01
set -l color19 "2d/2d/2d" # Base 02
set -l color20 "8f/8f/8f" # Base 04
set -l color21 "f1/f1/f1" # Base 06
set -l color_foreground "c0/c0/c0" # Base 05
set -l color_background "15/11/44" # Base 00
...
set -U fish_color_end c0c0c0
set -U fish_color_error brred
set -U fish_color_param 8f8f8f
set -U fish_color_valid_path --underline
set -U fish_color_option brcyan
set -U fish_color_comment 5e5e5e
set -U fish_color_selection f1f1f1 --bold --background=2d2d2d
set -U fish_color_operator brblue
set -U fish_color_escape brcyan
set -U fish_color_autosuggestion 5e5e5e
...
set -U fish_color_search_match bryellow --background=2d2d2d
set -U fish_color_history_current --bold
set -U fish_pager_color_progress 080808 --background=8f8f8f
set -U fish_pager_color_background normal --background=151144
set -U fish_pager_color_prefix normal --bold
set -U fish_pager_color_completion normal
set -U fish_pager_color_description d2a700 --dim
set -U fish_pager_color_selected_background f1f1f1 --background=2d2d2d
set -U fish_pager_color_selected_prefix f1f1f1 --bold --background=2d2d2d
...
# Set theme
set -Ux BASE24_THEME cyberdyne

# Optionally export variables
if test -n "$TINTED_SHELL_ENABLE_BASE24_VARS"; or test -n "$BASE24_SHELL_ENABLE_VARS"
  set -gx BASE24_COLOR_00_HEX "151144"
  set -gx BASE24_COLOR_01_HEX "080808"
  set -gx BASE24_COLOR_02_HEX "2d2d2d"
  set -gx BASE24_COLOR_03_HEX "5e5e5e"
  set -gx BASE24_COLOR_04_HEX "8f8f8f"
  set -gx BASE24_COLOR_05_HEX "c0c0c0"
  set -gx BASE24_COLOR_06_HEX "f1f1f1"
  set -gx BASE24_COLOR_07_HEX "feffff"
  set -gx BASE24_COLOR_08_HEX "ff8272"
  set -gx BASE24_COLOR_09_HEX "d2a700"
  set -gx BASE24_COLOR_0A_HEX "c1e3fe"
  set -gx BASE24_COLOR_0B_HEX "00c172"
  set -gx BASE24_COLOR_0C_HEX "6bffdc"
  set -gx BASE24_COLOR_0D_HEX "0071cf"
