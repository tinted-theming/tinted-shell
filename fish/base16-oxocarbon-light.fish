...
set -l color00 "f2/f4/f8" # Base 00 - Black
set -l color01 "ff/7e/b6" # Base 08 - Red
set -l color02 "42/be/65" # Base 0B - Green
set -l color03 "ff/6f/00" # Base 0A - Yellow
set -l color04 "0f/62/fe" # Base 0D - Blue
set -l color05 "be/95/ff" # Base 0E - Magenta
set -l color06 "67/3a/b7" # Base 0C - Cyan
set -l color07 "52/5f/70" # Base 05 - White
set -l color08 "a1/ac/ba" # Base 03 - Bright Black
...
set -l color15 "27/2d/35" # Base 07 - Bright White
set -l color16 "ee/53/96" # Base 09
set -l color17 "80/38/00" # Base 0F
set -l color18 "dd/e1/e6" # Base 01
set -l color19 "be/c6/cf" # Base 02
set -l color20 "68/78/8d" # Base 04
set -l color21 "3d/46/52" # Base 06
set -l color_foreground "52/5f/70" # Base 05
set -l color_background "f2/f4/f8" # Base 00
...
set -U fish_color_end 525f70
set -U fish_color_error brred
set -U fish_color_param 68788d
set -U fish_color_valid_path --underline
set -U fish_color_option brcyan
set -U fish_color_comment a1acba
set -U fish_color_selection 3d4652 --bold --background=bec6cf
set -U fish_color_operator brblue
set -U fish_color_escape brcyan
set -U fish_color_autosuggestion a1acba
...
set -U fish_color_search_match bryellow --background=bec6cf
set -U fish_color_history_current --bold
set -U fish_pager_color_progress dde1e6 --background=68788d
set -U fish_pager_color_background normal --background=f2f4f8
set -U fish_pager_color_prefix normal --bold
set -U fish_pager_color_completion normal
set -U fish_pager_color_description ee5396 --dim
set -U fish_pager_color_selected_background 3d4652 --background=bec6cf
set -U fish_pager_color_selected_prefix 3d4652 --bold --background=bec6cf
set -U fish_pager_color_selected_completion 3d4652
...
# Set theme
set -Ux BASE16_THEME oxocarbon-light

# Optionally export variables
if test -n "$TINTED_SHELL_ENABLE_BASE16_VARS"; or test -n "$BASE16_SHELL_ENABLE_VARS"
  set -gx BASE16_COLOR_00_HEX "f2f4f8"
  set -gx BASE16_COLOR_01_HEX "dde1e6"
  set -gx BASE16_COLOR_02_HEX "bec6cf"
  set -gx BASE16_COLOR_03_HEX "a1acba"
  set -gx BASE16_COLOR_04_HEX "68788d"
  set -gx BASE16_COLOR_05_HEX "525f70"
  set -gx BASE16_COLOR_06_HEX "3d4652"
  set -gx BASE16_COLOR_07_HEX "272d35"
  set -gx BASE16_COLOR_08_HEX "ff7eb6"
  set -gx BASE16_COLOR_09_HEX "ee5396"
  set -gx BASE16_COLOR_0A_HEX "ff6f00"
  set -gx BASE16_COLOR_0B_HEX "42be65"
  set -gx BASE16_COLOR_0C_HEX "673ab7"
  set -gx BASE16_COLOR_0D_HEX "0f62fe"
  set -gx BASE16_COLOR_0E_HEX "be95ff"
  set -gx BASE16_COLOR_0F_HEX "803800"
end
