...
set -l color01 "bb/00/00" # Base 08 - Red
set -l color02 "03/f6/22" # Base 0B - Green
set -l color03 "62/ca/e7" # Base 0A - Yellow
set -l color04 "63/d0/f0" # Base 0D - Blue
set -l color05 "ce/6f/da" # Base 0E - Magenta
set -l color06 "00/d9/df" # Base 0C - Cyan
...
set -l color16 "f2/f0/67" # Base 09
set -l color17 "5d/00/00" # Base 0F
...
# Set theme
set -Ux BASE24_THEME night-lion-v2
...
if test -n "$TINTED_SHELL_ENABLE_BASE24_VARS"; or test -n "$BASE24_SHELL_ENABLE_VARS"
  ...
  set -gx BASE24_COLOR_08_HEX "bb0000"
  set -gx BASE24_COLOR_09_HEX "f2f067"
  set -gx BASE24_COLOR_0A_HEX "62cae7"
  set -gx BASE24_COLOR_0B_HEX "03f622"
  set -gx BASE24_COLOR_0C_HEX "00d9df"
  set -gx BASE24_COLOR_0D_HEX "63d0f0"
  set -gx BASE24_COLOR_0E_HEX "ce6fda"
  set -gx BASE24_COLOR_0F_HEX "5d0000"
end
