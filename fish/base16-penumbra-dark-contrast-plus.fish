...
set -l color00 "18/1b/1f" # Base 00 - Black
...
set -l color07 "ce/ce/ce" # Base 05 - White
...
set -l color18 "24/27/2b" # Base 01
set -l color19 "3e/40/44" # Base 02
set -l color20 "9e/9e/9e" # Base 04
set -l color21 "ff/f7/ed" # Base 06
set -l color_foreground "ce/ce/ce" # Base 05
set -l color_background "18/1b/1f" # Base 00
...
set -U fish_pager_color_progress 24272b --background=9e9e9e
set -U fish_pager_color_background normal --background=181b1f
