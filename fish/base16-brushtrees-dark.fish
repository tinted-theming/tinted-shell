...
set -l color00 "48/58/67" # Base 00 - Black
set -l color01 "b3/86/86" # Base 08 - Red
set -l color02 "87/b3/86" # Base 0B - Green
set -l color03 "aa/b3/86" # Base 0A - Yellow
set -l color04 "86/8c/b3" # Base 0D - Blue
set -l color05 "b3/86/b2" # Base 0E - Magenta
set -l color06 "86/b3/b3" # Base 0C - Cyan
set -l color07 "b0/c5/c8" # Base 05 - White
set -l color08 "82/99/a1" # Base 03 - Bright Black
...
set -l color15 "e3/ef/ef" # Base 07 - Bright White
set -l color16 "d8/bb/a2" # Base 09
set -l color17 "b3/9f/9f" # Base 0F
set -l color18 "5a/6d/7a" # Base 01
set -l color19 "6d/82/8e" # Base 02
set -l color20 "98/af/b5" # Base 04
set -l color21 "c9/db/dc" # Base 06
set -l color_foreground "b0/c5/c8" # Base 05
set -l color_background "48/58/67" # Base 00
...
set -U fish_color_end b0c5c8
set -U fish_color_error brred
set -U fish_color_param 98afb5
set -U fish_color_valid_path --underline
set -U fish_color_option brcyan
set -U fish_color_comment 8299a1
set -U fish_color_selection c9dbdc --bold --background=6d828e
set -U fish_color_operator brblue
set -U fish_color_escape brcyan
set -U fish_color_autosuggestion 8299a1
...
set -U fish_pager_color_progress 5a6d7a --background=98afb5
set -U fish_pager_color_background normal --background=485867
set -U fish_pager_color_prefix normal --bold
set -U fish_pager_color_completion normal
set -U fish_pager_color_description d8bba2 --dim
set -U fish_pager_color_selected_background c9dbdc --background=6d828e
set -U fish_pager_color_selected_prefix c9dbdc --bold --background=6d828e
set -U fish_pager_color_selected_completion c9dbdc
...
# Set theme
set -Ux BASE16_THEME brushtrees-dark

# Optionally export variables
if test -n "$TINTED_SHELL_ENABLE_BASE16_VARS"; or test -n "$BASE16_SHELL_ENABLE_VARS"
  set -gx BASE16_COLOR_00_HEX "485867"
  set -gx BASE16_COLOR_01_HEX "5a6d7a"
  set -gx BASE16_COLOR_02_HEX "6d828e"
  set -gx BASE16_COLOR_03_HEX "8299a1"
  set -gx BASE16_COLOR_04_HEX "98afb5"
  set -gx BASE16_COLOR_05_HEX "b0c5c8"
  set -gx BASE16_COLOR_06_HEX "c9dbdc"
  set -gx BASE16_COLOR_07_HEX "e3efef"
  set -gx BASE16_COLOR_08_HEX "b38686"
  set -gx BASE16_COLOR_09_HEX "d8bba2"
  set -gx BASE16_COLOR_0A_HEX "aab386"
  set -gx BASE16_COLOR_0B_HEX "87b386"
  set -gx BASE16_COLOR_0C_HEX "86b3b3"
  set -gx BASE16_COLOR_0D_HEX "868cb3"
  set -gx BASE16_COLOR_0E_HEX "b386b2"
  set -gx BASE16_COLOR_0F_HEX "b39f9f"
end
