...
set -l color00 "2e/2a/31" # Base 00 - Black
set -l color01 "d8/13/7f" # Base 08 - Red
set -l color02 "17/ad/98" # Base 0B - Green
set -l color03 "dc/8a/0e" # Base 0A - Yellow
set -l color04 "78/64/fa" # Base 0D - Blue
set -l color05 "b3/3c/e8" # Base 0E - Magenta
set -l color06 "14/9b/da" # Base 0C - Cyan
set -l color07 "c3/c2/c4" # Base 05 - White
set -l color08 "87/85/89" # Base 03 - Bright Black
...
set -l color17 "d4/1a/cd" # Base 0F
set -l color18 "4b/48/4e" # Base 01
set -l color19 "69/66/6b" # Base 02
set -l color20 "a5/a3/a6" # Base 04
set -l color21 "e1/e0/e1" # Base 06
set -l color_foreground "c3/c2/c4" # Base 05
set -l color_background "2e/2a/31" # Base 00
...
set -U fish_color_end c3c2c4
set -U fish_color_error brred
set -U fish_color_param a5a3a6
set -U fish_color_valid_path --underline
set -U fish_color_option brcyan
set -U fish_color_comment 878589
set -U fish_color_selection e1e0e1 --bold --background=69666b
set -U fish_color_operator brblue
set -U fish_color_escape brcyan
set -U fish_color_autosuggestion 878589
...
set -U fish_color_search_match bryellow --background=69666b
set -U fish_color_history_current --bold
set -U fish_pager_color_progress 4b484e --background=a5a3a6
set -U fish_pager_color_background normal --background=2e2a31
set -U fish_pager_color_prefix normal --bold
set -U fish_pager_color_completion normal
set -U fish_pager_color_description d65407 --dim
set -U fish_pager_color_selected_background e1e0e1 --background=69666b
set -U fish_pager_color_selected_prefix e1e0e1 --bold --background=69666b
set -U fish_pager_color_selected_completion e1e0e1
...
# Set theme
set -Ux BASE16_THEME unikitty-reversible

# Optionally export variables
if test -n "$TINTED_SHELL_ENABLE_BASE16_VARS"; or test -n "$BASE16_SHELL_ENABLE_VARS"
  set -gx BASE16_COLOR_00_HEX "2e2a31"
  set -gx BASE16_COLOR_01_HEX "4b484e"
  set -gx BASE16_COLOR_02_HEX "69666b"
  set -gx BASE16_COLOR_03_HEX "878589"
  set -gx BASE16_COLOR_04_HEX "a5a3a6"
  set -gx BASE16_COLOR_05_HEX "c3c2c4"
  set -gx BASE16_COLOR_06_HEX "e1e0e1"
  ...
  set -gx BASE16_COLOR_0D_HEX "7864fa"
  set -gx BASE16_COLOR_0E_HEX "b33ce8"
  set -gx BASE16_COLOR_0F_HEX "d41acd"
end
