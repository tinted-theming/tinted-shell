...
set -l color01 "f7/27/29" # Base 08 - Red
set -l color02 "32/89/5c" # Base 0B - Green
set -l color03 "15/6f/fe" # Base 0A - Yellow
set -l color04 "12/5c/cf" # Base 0D - Blue
set -l color05 "9f/00/bc" # Base 0E - Magenta
set -l color06 "32/c2/c0" # Base 0C - Cyan
set -l color07 "9a/9b/9a" # Base 05 - White
set -l color08 "6b/6d/6a" # Base 03 - Bright Black
...
set -l color16 "f9/6f/1c" # Base 09
set -l color17 "7b/13/14" # Base 0F
set -l color18 "00/00/00" # Base 01
set -l color19 "54/57/53" # Base 02
set -l color20 "83/84/82" # Base 04
set -l color21 "b2/b2/b2" # Base 06
set -l color_foreground "9a/9b/9a" # Base 05
...
set -U fish_color_end 9a9b9a
set -U fish_color_error brred
set -U fish_color_param 838482
set -U fish_color_valid_path --underline
set -U fish_color_option brcyan
set -U fish_color_comment 6b6d6a
set -U fish_color_selection b2b2b2 --bold --background=545753
set -U fish_color_operator brblue
set -U fish_color_escape brcyan
set -U fish_color_autosuggestion 6b6d6a
...
set -U fish_color_search_match bryellow --background=545753
set -U fish_color_history_current --bold
set -U fish_pager_color_progress 000000 --background=838482
set -U fish_pager_color_background normal --background=ffffff
set -U fish_pager_color_prefix normal --bold
set -U fish_pager_color_completion normal
set -U fish_pager_color_description f96f1c --dim
set -U fish_pager_color_selected_background b2b2b2 --background=545753
set -U fish_pager_color_selected_prefix b2b2b2 --bold --background=545753
set -U fish_pager_color_selected_completion b2b2b2
...
if test -n "$TINTED_SHELL_ENABLE_BASE24_VARS"; or test -n "$BASE24_SHELL_ENABLE_VARS"
  ...
  set -gx BASE24_COLOR_03_HEX "6b6d6a"
  set -gx BASE24_COLOR_04_HEX "838482"
  set -gx BASE24_COLOR_05_HEX "9a9b9a"
  set -gx BASE24_COLOR_06_HEX "b2b2b2"
  set -gx BASE24_COLOR_07_HEX "ededec"
  set -gx BASE24_COLOR_08_HEX "f72729"
  set -gx BASE24_COLOR_09_HEX "f96f1c"
  set -gx BASE24_COLOR_0A_HEX "156ffe"
  set -gx BASE24_COLOR_0B_HEX "32895c"
  set -gx BASE24_COLOR_0C_HEX "32c2c0"
  set -gx BASE24_COLOR_0D_HEX "125ccf"
  set -gx BASE24_COLOR_0E_HEX "9f00bc"
  set -gx BASE24_COLOR_0F_HEX "7b1314"
end
