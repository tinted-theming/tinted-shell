...
set -l color00 "20/21/24" # Base 00 - Black
set -l color01 "f4/43/36" # Base 08 - Red
set -l color02 "00/e6/76" # Base 0B - Green
set -l color03 "ff/eb/3b" # Base 0A - Yellow
set -l color04 "21/96/f3" # Base 0D - Blue
set -l color05 "67/3a/b7" # Base 0E - Magenta
set -l color06 "00/bc/d4" # Base 0C - Cyan
set -l color07 "80/86/8b" # Base 05 - White
set -l color08 "44/46/4d" # Base 03 - Bright Black
...
set -l color16 "ff/98/00" # Base 09
set -l color17 "8d/6e/63" # Base 0F
set -l color18 "27/29/2c" # Base 01
set -l color19 "32/36/39" # Base 02
set -l color20 "67/6c/71" # Base 04
set -l color21 "9e/9e/9e" # Base 06
set -l color_foreground "80/86/8b" # Base 05
set -l color_background "20/21/24" # Base 00
...
set -U fish_color_end 80868b
set -U fish_color_error brred
set -U fish_color_param 676c71
set -U fish_color_valid_path --underline
set -U fish_color_option brcyan
set -U fish_color_comment 44464d
set -U fish_color_selection 9e9e9e --bold --background=323639
set -U fish_color_operator brblue
set -U fish_color_escape brcyan
set -U fish_color_autosuggestion 44464d
...
set -U fish_pager_color_progress 27292c --background=676c71
set -U fish_pager_color_background normal --background=202124
set -U fish_pager_color_prefix normal --bold
set -U fish_pager_color_completion normal
set -U fish_pager_color_description ff9800 --dim
set -U fish_pager_color_selected_background 9e9e9e --background=323639
set -U fish_pager_color_selected_prefix 9e9e9e --bold --background=323639
set -U fish_pager_color_selected_completion 9e9e9e
...
# Set theme
set -Ux BASE16_THEME material-vivid

# Optionally export variables
if test -n "$TINTED_SHELL_ENABLE_BASE16_VARS"; or test -n "$BASE16_SHELL_ENABLE_VARS"
  set -gx BASE16_COLOR_00_HEX "202124"
  set -gx BASE16_COLOR_01_HEX "27292c"
  set -gx BASE16_COLOR_02_HEX "323639"
  set -gx BASE16_COLOR_03_HEX "44464d"
  set -gx BASE16_COLOR_04_HEX "676c71"
  set -gx BASE16_COLOR_05_HEX "80868b"
  set -gx BASE16_COLOR_06_HEX "9e9e9e"
  set -gx BASE16_COLOR_07_HEX "ffffff"
  set -gx BASE16_COLOR_08_HEX "f44336"
  set -gx BASE16_COLOR_09_HEX "ff9800"
  set -gx BASE16_COLOR_0A_HEX "ffeb3b"
  set -gx BASE16_COLOR_0B_HEX "00e676"
  set -gx BASE16_COLOR_0C_HEX "00bcd4"
  set -gx BASE16_COLOR_0D_HEX "2196f3"
  set -gx BASE16_COLOR_0E_HEX "673ab7"
  set -gx BASE16_COLOR_0F_HEX "8d6e63"
end
