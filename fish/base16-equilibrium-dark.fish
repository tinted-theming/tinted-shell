...
set -U fish_pager_color_background normal --background=0c1118
set -U fish_pager_color_prefix normal --bold
set -U fish_pager_color_completion normal
set -U fish_pager_color_description df5923 --dim
set -U fish_pager_color_selected_background cac6bd --background=22262d
set -U fish_pager_color_selected_prefix cac6bd --bold --background=22262d
set -U fish_pager_color_selected_completion cac6bd
