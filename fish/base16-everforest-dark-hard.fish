...
set -l color00 "27/2e/33" # Base 00 - Black
...
set -l color15 "ff/fb/ef" # Base 07 - Bright White
set -l color16 "e6/98/75" # Base 09
set -l color17 "9d/a9/a0" # Base 0F
set -l color18 "2e/38/3c" # Base 01
set -l color19 "41/4b/50" # Base 02
set -l color20 "9d/a9/a0" # Base 04
set -l color21 "ed/ea/da" # Base 06
set -l color_foreground "d3/c6/aa" # Base 05
set -l color_background "27/2e/33" # Base 00
...
set -U fish_color_selection edeada --bold --background=414b50
...
set -U fish_color_search_match bryellow --background=414b50
set -U fish_color_history_current --bold
set -U fish_pager_color_progress 2e383c --background=9da9a0
set -U fish_pager_color_background normal --background=272e33
set -U fish_pager_color_prefix normal --bold
set -U fish_pager_color_completion normal
set -U fish_pager_color_description e69875 --dim
set -U fish_pager_color_selected_background edeada --background=414b50
set -U fish_pager_color_selected_prefix edeada --bold --background=414b50
set -U fish_pager_color_selected_completion edeada
...
# Set theme
set -Ux BASE16_THEME everforest-dark-hard

# Optionally export variables
if test -n "$TINTED_SHELL_ENABLE_BASE16_VARS"; or test -n "$BASE16_SHELL_ENABLE_VARS"
  set -gx BASE16_COLOR_00_HEX "272e33"
  set -gx BASE16_COLOR_01_HEX "2e383c"
  set -gx BASE16_COLOR_02_HEX "414b50"
  set -gx BASE16_COLOR_03_HEX "859289"
  set -gx BASE16_COLOR_04_HEX "9da9a0"
  set -gx BASE16_COLOR_05_HEX "d3c6aa"
  set -gx BASE16_COLOR_06_HEX "edeada"
  set -gx BASE16_COLOR_07_HEX "fffbef"
