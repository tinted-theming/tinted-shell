...
set -l color02 "dd/99/99" # Base 0B - Green
set -l color03 "a0/66/66" # Base 0A - Yellow
...
# Set theme
set -Ux BASE16_THEME black-metal
...
if test -n "$TINTED_SHELL_ENABLE_BASE16_VARS"; or test -n "$BASE16_SHELL_ENABLE_VARS"
  ...
  set -gx BASE16_COLOR_0A_HEX "a06666"
  set -gx BASE16_COLOR_0B_HEX "dd9999"
