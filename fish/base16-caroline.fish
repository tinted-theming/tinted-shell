...
set -l color00 "1c/12/13" # Base 00 - Black
set -l color01 "c2/4f/57" # Base 08 - Red
set -l color02 "80/6c/61" # Base 0B - Green
set -l color03 "f2/81/71" # Base 0A - Yellow
set -l color04 "68/4c/59" # Base 0D - Blue
set -l color05 "a6/36/50" # Base 0E - Magenta
set -l color06 "6b/65/66" # Base 0C - Cyan
set -l color07 "a8/75/69" # Base 05 - White
set -l color08 "6d/47/45" # Base 03 - Bright Black
...
set -l color15 "e3/a6/8c" # Base 07 - Bright White
set -l color16 "a6/36/50" # Base 09
set -l color17 "89/3f/45" # Base 0F
set -l color18 "3a/24/25" # Base 01
set -l color19 "56/38/37" # Base 02
set -l color20 "8b/5d/57" # Base 04
set -l color21 "c5/8d/7b" # Base 06
set -l color_foreground "a8/75/69" # Base 05
set -l color_background "1c/12/13" # Base 00
...
set -U fish_color_end a87569
set -U fish_color_error brred
set -U fish_color_param 8b5d57
set -U fish_color_valid_path --underline
set -U fish_color_option brcyan
set -U fish_color_comment 6d4745
set -U fish_color_selection c58d7b --bold --background=563837
set -U fish_color_operator brblue
set -U fish_color_escape brcyan
set -U fish_color_autosuggestion 6d4745
...
set -U fish_color_search_match bryellow --background=563837
set -U fish_color_history_current --bold
set -U fish_pager_color_progress 3a2425 --background=8b5d57
set -U fish_pager_color_background normal --background=1c1213
set -U fish_pager_color_prefix normal --bold
set -U fish_pager_color_completion normal
set -U fish_pager_color_description a63650 --dim
set -U fish_pager_color_selected_background c58d7b --background=563837
set -U fish_pager_color_selected_prefix c58d7b --bold --background=563837
set -U fish_pager_color_selected_completion c58d7b
...
# Set theme
set -Ux BASE16_THEME caroline

# Optionally export variables
if test -n "$TINTED_SHELL_ENABLE_BASE16_VARS"; or test -n "$BASE16_SHELL_ENABLE_VARS"
  set -gx BASE16_COLOR_00_HEX "1c1213"
  set -gx BASE16_COLOR_01_HEX "3a2425"
  set -gx BASE16_COLOR_02_HEX "563837"
  set -gx BASE16_COLOR_03_HEX "6d4745"
  set -gx BASE16_COLOR_04_HEX "8b5d57"
  set -gx BASE16_COLOR_05_HEX "a87569"
  set -gx BASE16_COLOR_06_HEX "c58d7b"
  set -gx BASE16_COLOR_07_HEX "e3a68c"
  set -gx BASE16_COLOR_08_HEX "c24f57"
  set -gx BASE16_COLOR_09_HEX "a63650"
  set -gx BASE16_COLOR_0A_HEX "f28171"
  set -gx BASE16_COLOR_0B_HEX "806c61"
  set -gx BASE16_COLOR_0C_HEX "6b6566"
  set -gx BASE16_COLOR_0D_HEX "684c59"
  set -gx BASE16_COLOR_0E_HEX "a63650"
  set -gx BASE16_COLOR_0F_HEX "893f45"
end
