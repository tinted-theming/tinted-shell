...
set -l color01 "c8/5a/46" # Base 08 - Red
set -l color02 "64/c8/3c" # Base 0B - Green
set -l color03 "a6/7a/50" # Base 0A - Yellow
set -l color04 "54/82/af" # Base 0D - Blue
set -l color05 "94/72/b4" # Base 0E - Magenta
set -l color06 "46/8c/78" # Base 0C - Cyan
set -l color07 "00/ff/00" # Base 05 - White
set -l color08 "7c/8d/7c" # Base 03 - Bright Black
...
set -l color15 "d8/e2/dc" # Base 07 - Bright White
set -l color16 "c8/64/28" # Base 09
set -l color17 "b3/7c/5e" # Base 0F
set -l color18 "4a/80/6c" # Base 01
set -l color19 "4a/8d/7e" # Base 02
set -l color20 "91/98/93" # Base 04
set -l color21 "c4/ce/c4" # Base 06
set -l color_foreground "00/ff/00" # Base 05
...
set -U fish_color_end 00ff00
set -U fish_color_error brred
set -U fish_color_param 919893
set -U fish_color_valid_path --underline
set -U fish_color_option brcyan
set -U fish_color_comment 7c8d7c
set -U fish_color_selection c4cec4 --bold --background=4a8d7e
set -U fish_color_operator brblue
set -U fish_color_escape brcyan
set -U fish_color_autosuggestion 7c8d7c
...
set -U fish_color_search_match bryellow --background=4a8d7e
set -U fish_color_history_current --bold
set -U fish_pager_color_progress 4a806c --background=919893
set -U fish_pager_color_background normal --background=000000
set -U fish_pager_color_prefix normal --bold
set -U fish_pager_color_completion normal
set -U fish_pager_color_description c86428 --dim
set -U fish_pager_color_selected_background c4cec4 --background=4a8d7e
set -U fish_pager_color_selected_prefix c4cec4 --bold --background=4a8d7e
set -U fish_pager_color_selected_completion c4cec4
...
# Set theme
set -Ux BASE16_THEME digital-rain

# Optionally export variables
if test -n "$TINTED_SHELL_ENABLE_BASE16_VARS"; or test -n "$BASE16_SHELL_ENABLE_VARS"
  set -gx BASE16_COLOR_00_HEX "000000"
  set -gx BASE16_COLOR_01_HEX "4a806c"
  set -gx BASE16_COLOR_02_HEX "4a8d7e"
  set -gx BASE16_COLOR_03_HEX "7c8d7c"
  set -gx BASE16_COLOR_04_HEX "919893"
  set -gx BASE16_COLOR_05_HEX "00ff00"
  set -gx BASE16_COLOR_06_HEX "c4cec4"
  set -gx BASE16_COLOR_07_HEX "d8e2dc"
  set -gx BASE16_COLOR_08_HEX "c85a46"
  set -gx BASE16_COLOR_09_HEX "c86428"
  set -gx BASE16_COLOR_0A_HEX "a67a50"
  set -gx BASE16_COLOR_0B_HEX "64c83c"
  set -gx BASE16_COLOR_0C_HEX "468c78"
  set -gx BASE16_COLOR_0D_HEX "5482af"
  set -gx BASE16_COLOR_0E_HEX "9472b4"
  set -gx BASE16_COLOR_0F_HEX "b37c5e"
end
