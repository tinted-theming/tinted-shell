...
set -l color02 "f8/f7/f2" # Base 0B - Green
set -l color03 "79/24/1f" # Base 0A - Yellow
...
# Set theme
set -Ux BASE16_THEME black-metal-venom
...
if test -n "$TINTED_SHELL_ENABLE_BASE16_VARS"; or test -n "$BASE16_SHELL_ENABLE_VARS"
  ...
  set -gx BASE16_COLOR_0A_HEX "79241f"
  set -gx BASE16_COLOR_0B_HEX "f8f7f2"
