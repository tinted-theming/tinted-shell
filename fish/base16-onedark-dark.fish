...
set -l color01 "ef/59/6f" # Base 08 - Red
set -l color02 "89/ca/78" # Base 0B - Green
set -l color03 "e5/c0/7b" # Base 0A - Yellow
set -l color04 "61/af/ef" # Base 0D - Blue
set -l color05 "d5/5f/de" # Base 0E - Magenta
set -l color06 "2b/ba/c5" # Base 0C - Cyan
set -l color07 "ab/b2/bf" # Base 05 - White
set -l color08 "43/48/52" # Base 03 - Bright Black
...
set -l color18 "1c/1f/24" # Base 01
set -l color19 "2c/31/3a" # Base 02
...
set -U fish_color_comment 434852
set -U fish_color_selection b6bdca --bold --background=2c313a
set -U fish_color_operator brblue
set -U fish_color_escape brcyan
set -U fish_color_autosuggestion 434852
...
set -U fish_color_search_match bryellow --background=2c313a
set -U fish_color_history_current --bold
set -U fish_pager_color_progress 1c1f24 --background=565c64
...
set -U fish_pager_color_selected_background b6bdca --background=2c313a
set -U fish_pager_color_selected_prefix b6bdca --bold --background=2c313a
...
# Set theme
set -Ux BASE16_THEME onedark-dark

# Optionally export variables
if test -n "$TINTED_SHELL_ENABLE_BASE16_VARS"; or test -n "$BASE16_SHELL_ENABLE_VARS"
  set -gx BASE16_COLOR_00_HEX "000000"
  set -gx BASE16_COLOR_01_HEX "1c1f24"
  set -gx BASE16_COLOR_02_HEX "2c313a"
  set -gx BASE16_COLOR_03_HEX "434852"
  ...
  set -gx BASE16_COLOR_08_HEX "ef596f"
  set -gx BASE16_COLOR_09_HEX "d19a66"
  set -gx BASE16_COLOR_0A_HEX "e5c07b"
  set -gx BASE16_COLOR_0B_HEX "89ca78"
  set -gx BASE16_COLOR_0C_HEX "2bbac5"
  set -gx BASE16_COLOR_0D_HEX "61afef"
  set -gx BASE16_COLOR_0E_HEX "d55fde"
