...
set -l color00 "32/30/2f" # Base 00 - Black
set -l color01 "ea/69/62" # Base 08 - Red
set -l color02 "a9/b6/65" # Base 0B - Green
set -l color03 "d8/a6/57" # Base 0A - Yellow
set -l color04 "7d/ae/a3" # Base 0D - Blue
set -l color05 "d3/86/9b" # Base 0E - Magenta
set -l color06 "89/b4/82" # Base 0C - Cyan
set -l color07 "dd/c7/a1" # Base 05 - White
set -l color08 "7c/6f/64" # Base 03 - Bright Black
...
set -l color15 "fb/f1/c7" # Base 07 - Bright White
set -l color16 "e7/8a/4e" # Base 09
set -l color17 "bd/6f/3e" # Base 0F
set -l color18 "3c/38/36" # Base 01
set -l color19 "5a/52/4c" # Base 02
set -l color20 "bd/ae/93" # Base 04
set -l color21 "eb/db/b2" # Base 06
set -l color_foreground "dd/c7/a1" # Base 05
set -l color_background "32/30/2f" # Base 00
...
set -U fish_color_search_match bryellow --background=5a524c
set -U fish_color_history_current --bold
set -U fish_pager_color_progress 3c3836 --background=bdae93
set -U fish_pager_color_background normal --background=32302f
set -U fish_pager_color_prefix normal --bold
set -U fish_pager_color_completion normal
set -U fish_pager_color_description e78a4e --dim
set -U fish_pager_color_selected_background ebdbb2 --background=5a524c
set -U fish_pager_color_selected_prefix ebdbb2 --bold --background=5a524c
...
# Set theme
set -Ux BASE16_THEME gruvbox-material-dark-soft

# Optionally export variables
if test -n "$TINTED_SHELL_ENABLE_BASE16_VARS"; or test -n "$BASE16_SHELL_ENABLE_VARS"
  set -gx BASE16_COLOR_00_HEX "32302f"
  set -gx BASE16_COLOR_01_HEX "3c3836"
  set -gx BASE16_COLOR_02_HEX "5a524c"
  set -gx BASE16_COLOR_03_HEX "7c6f64"
  set -gx BASE16_COLOR_04_HEX "bdae93"
  set -gx BASE16_COLOR_05_HEX "ddc7a1"
  set -gx BASE16_COLOR_06_HEX "ebdbb2"
  set -gx BASE16_COLOR_07_HEX "fbf1c7"
  set -gx BASE16_COLOR_08_HEX "ea6962"
  set -gx BASE16_COLOR_09_HEX "e78a4e"
  set -gx BASE16_COLOR_0A_HEX "d8a657"
  set -gx BASE16_COLOR_0B_HEX "a9b665"
  set -gx BASE16_COLOR_0C_HEX "89b482"
  set -gx BASE16_COLOR_0D_HEX "7daea3"
  set -gx BASE16_COLOR_0E_HEX "d3869b"
  set -gx BASE16_COLOR_0F_HEX "bd6f3e"
end
