...
set -l color00 "2d/2d/2d" # Base 00 - Black
set -l color01 "f2/77/7a" # Base 08 - Red
set -l color02 "99/cc/99" # Base 0B - Green
set -l color03 "ff/cc/66" # Base 0A - Yellow
set -l color04 "66/99/cc" # Base 0D - Blue
set -l color05 "cc/99/cc" # Base 0E - Magenta
set -l color06 "66/cc/cc" # Base 0C - Cyan
set -l color07 "d3/d0/c8" # Base 05 - White
set -l color08 "74/73/69" # Base 03 - Bright Black
...
set -l color15 "f2/f0/ec" # Base 07 - Bright White
set -l color16 "f9/91/57" # Base 09
set -l color17 "d2/7b/53" # Base 0F
set -l color18 "39/39/39" # Base 01
set -l color19 "51/51/51" # Base 02
set -l color20 "a0/9f/93" # Base 04
set -l color21 "e8/e6/df" # Base 06
set -l color_foreground "d3/d0/c8" # Base 05
set -l color_background "2d/2d/2d" # Base 00
...
set -U fish_color_end d3d0c8
set -U fish_color_error brred
set -U fish_color_param a09f93
set -U fish_color_valid_path --underline
set -U fish_color_option brcyan
set -U fish_color_comment 747369
set -U fish_color_selection e8e6df --bold --background=515151
...
set -U fish_pager_color_progress 393939 --background=a09f93
set -U fish_pager_color_background normal --background=2d2d2d
set -U fish_pager_color_prefix normal --bold
set -U fish_pager_color_completion normal
set -U fish_pager_color_description f99157 --dim
set -U fish_pager_color_selected_background e8e6df --background=515151
set -U fish_pager_color_selected_prefix e8e6df --bold --background=515151
set -U fish_pager_color_selected_completion e8e6df
...
# Set theme
set -Ux BASE16_THEME eighties

# Optionally export variables
if test -n "$TINTED_SHELL_ENABLE_BASE16_VARS"; or test -n "$BASE16_SHELL_ENABLE_VARS"
  set -gx BASE16_COLOR_00_HEX "2d2d2d"
  set -gx BASE16_COLOR_01_HEX "393939"
  set -gx BASE16_COLOR_02_HEX "515151"
  set -gx BASE16_COLOR_03_HEX "747369"
  set -gx BASE16_COLOR_04_HEX "a09f93"
  set -gx BASE16_COLOR_05_HEX "d3d0c8"
  set -gx BASE16_COLOR_06_HEX "e8e6df"
  set -gx BASE16_COLOR_07_HEX "f2f0ec"
  set -gx BASE16_COLOR_08_HEX "f2777a"
  set -gx BASE16_COLOR_09_HEX "f99157"
  set -gx BASE16_COLOR_0A_HEX "ffcc66"
  set -gx BASE16_COLOR_0B_HEX "99cc99"
  set -gx BASE16_COLOR_0C_HEX "66cccc"
  set -gx BASE16_COLOR_0D_HEX "6699cc"
  set -gx BASE16_COLOR_0E_HEX "cc99cc"
