...
set -l color00 "1f/1f/1f" # Base 00 - Black
set -l color01 "d6/db/e5" # Base 08 - Red
set -l color02 "f3/bd/09" # Base 0B - Green
set -l color03 "1d/d3/61" # Base 0A - Yellow
set -l color04 "53/50/b9" # Base 0D - Blue
set -l color05 "0f/7d/db" # Base 0E - Magenta
set -l color06 "10/81/d6" # Base 0C - Cyan
set -l color07 "4e/5a/b7" # Base 05 - White
set -l color08 "ec/ba/0f" # Base 03 - Bright Black
...
set -l color15 "d6/db/e5" # Base 07 - Bright White
set -l color16 "de/35/2e" # Base 09
set -l color17 "ff/ff/ff" # Base 0F
set -l color18 "f8/11/18" # Base 01
set -l color19 "2d/c5/5e" # Base 02
set -l color20 "2a/84/d2" # Base 04
set -l color21 "10/81/d6" # Base 06
set -l color_foreground "4e/5a/b7" # Base 05
set -l color_background "1f/1f/1f" # Base 00
...
set -U fish_color_end 4e5ab7
set -U fish_color_error brred
set -U fish_color_param 2a84d2
set -U fish_color_valid_path --underline
set -U fish_color_option brcyan
set -U fish_color_comment ecba0f
set -U fish_color_selection 1081d6 --bold --background=2dc55e
set -U fish_color_operator brblue
set -U fish_color_escape brcyan
set -U fish_color_autosuggestion ecba0f
...
set -U fish_pager_color_progress f81118 --background=2a84d2
set -U fish_pager_color_background normal --background=1f1f1f
set -U fish_pager_color_prefix normal --bold
set -U fish_pager_color_completion normal
set -U fish_pager_color_description de352e --dim
set -U fish_pager_color_selected_background 1081d6 --background=2dc55e
set -U fish_pager_color_selected_prefix 1081d6 --bold --background=2dc55e
set -U fish_pager_color_selected_completion 1081d6
...
# Set theme
set -Ux BASE16_THEME brogrammer

# Optionally export variables
if test -n "$TINTED_SHELL_ENABLE_BASE16_VARS"; or test -n "$BASE16_SHELL_ENABLE_VARS"
  set -gx BASE16_COLOR_00_HEX "1f1f1f"
  set -gx BASE16_COLOR_01_HEX "f81118"
  set -gx BASE16_COLOR_02_HEX "2dc55e"
  set -gx BASE16_COLOR_03_HEX "ecba0f"
  set -gx BASE16_COLOR_04_HEX "2a84d2"
  set -gx BASE16_COLOR_05_HEX "4e5ab7"
  set -gx BASE16_COLOR_06_HEX "1081d6"
  set -gx BASE16_COLOR_07_HEX "d6dbe5"
  set -gx BASE16_COLOR_08_HEX "d6dbe5"
  set -gx BASE16_COLOR_09_HEX "de352e"
  set -gx BASE16_COLOR_0A_HEX "1dd361"
  set -gx BASE16_COLOR_0B_HEX "f3bd09"
  set -gx BASE16_COLOR_0C_HEX "1081d6"
  set -gx BASE16_COLOR_0D_HEX "5350b9"
  set -gx BASE16_COLOR_0E_HEX "0f7ddb"
  set -gx BASE16_COLOR_0F_HEX "ffffff"
end
