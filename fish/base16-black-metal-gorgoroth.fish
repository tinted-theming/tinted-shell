...
set -l color02 "9b/8d/7f" # Base 0B - Green
set -l color03 "8c/7f/70" # Base 0A - Yellow
...
# Set theme
set -Ux BASE16_THEME black-metal-gorgoroth
...
if test -n "$TINTED_SHELL_ENABLE_BASE16_VARS"; or test -n "$BASE16_SHELL_ENABLE_VARS"
  ...
  set -gx BASE16_COLOR_0A_HEX "8c7f70"
  set -gx BASE16_COLOR_0B_HEX "9b8d7f"
