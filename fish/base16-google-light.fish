...
set -l color01 "cc/34/2b" # Base 08 - Red
set -l color02 "19/88/44" # Base 0B - Green
set -l color03 "fb/a9/22" # Base 0A - Yellow
set -l color04 "39/71/ed" # Base 0D - Blue
set -l color05 "a3/6a/c7" # Base 0E - Magenta
set -l color06 "39/71/ed" # Base 0C - Cyan
set -l color07 "37/3b/41" # Base 05 - White
set -l color08 "b4/b7/b4" # Base 03 - Bright Black
...
set -l color15 "1d/1f/21" # Base 07 - Bright White
set -l color16 "f9/6a/38" # Base 09
set -l color17 "39/71/ed" # Base 0F
set -l color18 "e0/e0/e0" # Base 01
set -l color19 "c5/c8/c6" # Base 02
set -l color20 "96/98/96" # Base 04
set -l color21 "28/2a/2e" # Base 06
set -l color_foreground "37/3b/41" # Base 05
...
set -U fish_color_end 373b41
set -U fish_color_error brred
set -U fish_color_param 969896
set -U fish_color_valid_path --underline
set -U fish_color_option brcyan
set -U fish_color_comment b4b7b4
set -U fish_color_selection 282a2e --bold --background=c5c8c6
set -U fish_color_operator brblue
set -U fish_color_escape brcyan
set -U fish_color_autosuggestion b4b7b4
...
set -U fish_pager_color_progress e0e0e0 --background=969896
set -U fish_pager_color_background normal --background=ffffff
set -U fish_pager_color_prefix normal --bold
set -U fish_pager_color_completion normal
set -U fish_pager_color_description f96a38 --dim
set -U fish_pager_color_selected_background 282a2e --background=c5c8c6
set -U fish_pager_color_selected_prefix 282a2e --bold --background=c5c8c6
set -U fish_pager_color_selected_completion 282a2e
...
# Set theme
set -Ux BASE16_THEME google-light
...
if test -n "$TINTED_SHELL_ENABLE_BASE16_VARS"; or test -n "$BASE16_SHELL_ENABLE_VARS"
  ...
  set -gx BASE16_COLOR_02_HEX "c5c8c6"
  set -gx BASE16_COLOR_03_HEX "b4b7b4"
  set -gx BASE16_COLOR_04_HEX "969896"
  set -gx BASE16_COLOR_05_HEX "373b41"
  set -gx BASE16_COLOR_06_HEX "282a2e"
  set -gx BASE16_COLOR_07_HEX "1d1f21"
  set -gx BASE16_COLOR_08_HEX "cc342b"
  set -gx BASE16_COLOR_09_HEX "f96a38"
  set -gx BASE16_COLOR_0A_HEX "fba922"
  set -gx BASE16_COLOR_0B_HEX "198844"
  set -gx BASE16_COLOR_0C_HEX "3971ed"
  set -gx BASE16_COLOR_0D_HEX "3971ed"
  set -gx BASE16_COLOR_0E_HEX "a36ac7"
  set -gx BASE16_COLOR_0F_HEX "3971ed"
end
