...
set -l color00 "f5/f0/e7" # Base 00 - Black
set -l color01 "d0/20/23" # Base 08 - Red
set -l color02 "63/72/00" # Base 0B - Green
set -l color03 "9d/6f/00" # Base 0A - Yellow
set -l color04 "00/73/b5" # Base 0D - Blue
set -l color05 "4e/66/b6" # Base 0E - Magenta
set -l color06 "00/7a/72" # Base 0C - Cyan
set -l color07 "43/47/4e" # Base 05 - White
set -l color08 "73/77/7f" # Base 03 - Bright Black
...
set -l color15 "18/1c/22" # Base 07 - Bright White
set -l color16 "bf/3e/05" # Base 09
set -l color17 "c4/27/75" # Base 0F
set -l color18 "e7/e2/d9" # Base 01
set -l color19 "d8/d4/cb" # Base 02
set -l color20 "5a/5f/66" # Base 04
set -l color21 "2c/31/38" # Base 06
set -l color_foreground "43/47/4e" # Base 05
set -l color_background "f5/f0/e7" # Base 00
...
set -U fish_color_end 43474e
set -U fish_color_error brred
set -U fish_color_param 5a5f66
set -U fish_color_valid_path --underline
set -U fish_color_option brcyan
set -U fish_color_comment 73777f
set -U fish_color_selection 2c3138 --bold --background=d8d4cb
set -U fish_color_operator brblue
set -U fish_color_escape brcyan
set -U fish_color_autosuggestion 73777f
...
set -U fish_pager_color_progress e7e2d9 --background=5a5f66
set -U fish_pager_color_background normal --background=f5f0e7
set -U fish_pager_color_prefix normal --bold
set -U fish_pager_color_completion normal
set -U fish_pager_color_description bf3e05 --dim
set -U fish_pager_color_selected_background 2c3138 --background=d8d4cb
set -U fish_pager_color_selected_prefix 2c3138 --bold --background=d8d4cb
set -U fish_pager_color_selected_completion 2c3138
...
# Set theme
set -Ux BASE16_THEME equilibrium-light

# Optionally export variables
if test -n "$TINTED_SHELL_ENABLE_BASE16_VARS"; or test -n "$BASE16_SHELL_ENABLE_VARS"
  set -gx BASE16_COLOR_00_HEX "f5f0e7"
  set -gx BASE16_COLOR_01_HEX "e7e2d9"
  set -gx BASE16_COLOR_02_HEX "d8d4cb"
  set -gx BASE16_COLOR_03_HEX "73777f"
  set -gx BASE16_COLOR_04_HEX "5a5f66"
  set -gx BASE16_COLOR_05_HEX "43474e"
  set -gx BASE16_COLOR_06_HEX "2c3138"
  set -gx BASE16_COLOR_07_HEX "181c22"
  set -gx BASE16_COLOR_08_HEX "d02023"
  set -gx BASE16_COLOR_09_HEX "bf3e05"
  set -gx BASE16_COLOR_0A_HEX "9d6f00"
  set -gx BASE16_COLOR_0B_HEX "637200"
  set -gx BASE16_COLOR_0C_HEX "007a72"
  set -gx BASE16_COLOR_0D_HEX "0073b5"
  set -gx BASE16_COLOR_0E_HEX "4e66b6"
  set -gx BASE16_COLOR_0F_HEX "c42775"
end
