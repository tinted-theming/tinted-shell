...
set -l color01 "ff/1b/00" # Base 08 - Red
set -l color02 "a5/df/55" # Base 0B - Green
set -l color03 "89/bd/ff" # Base 0A - Yellow
set -l color04 "48/63/87" # Base 0D - Blue
set -l color05 "fc/5e/f0" # Base 0E - Magenta
set -l color06 "85/e9/fe" # Base 0C - Cyan
...
set -l color15 "db/db/db" # Base 07 - Bright White
set -l color16 "fb/e7/4a" # Base 09
set -l color17 "7f/0d/00" # Base 0F
set -l color18 "57/57/57" # Base 01
set -l color19 "25/25/25" # Base 02
set -l color20 "78/78/78" # Base 04
set -l color21 "cb/cb/cb" # Base 06
...
set -U fish_color_selection cbcbcb --bold --background=252525
...
set -U fish_color_search_match bryellow --background=252525
set -U fish_color_history_current --bold
set -U fish_pager_color_progress 575757 --background=787878
set -U fish_pager_color_background normal --background=000000
set -U fish_pager_color_prefix normal --bold
set -U fish_pager_color_completion normal
set -U fish_pager_color_description fbe74a --dim
set -U fish_pager_color_selected_background cbcbcb --background=252525
set -U fish_pager_color_selected_prefix cbcbcb --bold --background=252525
set -U fish_pager_color_selected_completion cbcbcb
...
# Set theme
set -Ux BASE24_THEME hurtado

# Optionally export variables
if test -n "$TINTED_SHELL_ENABLE_BASE24_VARS"; or test -n "$BASE24_SHELL_ENABLE_VARS"
  set -gx BASE24_COLOR_00_HEX "000000"
  set -gx BASE24_COLOR_01_HEX "575757"
  set -gx BASE24_COLOR_02_HEX "252525"
  set -gx BASE24_COLOR_03_HEX "4e4e4e"
  set -gx BASE24_COLOR_04_HEX "787878"
  set -gx BASE24_COLOR_05_HEX "a1a1a1"
  set -gx BASE24_COLOR_06_HEX "cbcbcb"
  set -gx BASE24_COLOR_07_HEX "dbdbdb"
  set -gx BASE24_COLOR_08_HEX "ff1b00"
  set -gx BASE24_COLOR_09_HEX "fbe74a"
  set -gx BASE24_COLOR_0A_HEX "89bdff"
  set -gx BASE24_COLOR_0B_HEX "a5df55"
  set -gx BASE24_COLOR_0C_HEX "85e9fe"
  set -gx BASE24_COLOR_0D_HEX "486387"
  set -gx BASE24_COLOR_0E_HEX "fc5ef0"
  set -gx BASE24_COLOR_0F_HEX "7f0d00"
end
