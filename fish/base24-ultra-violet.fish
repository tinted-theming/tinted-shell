...
set -l color00 "24/27/28" # Base 00 - Black
set -l color01 "ff/00/90" # Base 08 - Red
set -l color02 "b5/ff/00" # Base 0B - Green
set -l color03 "7f/eb/ff" # Base 0A - Yellow
set -l color04 "47/df/fb" # Base 0D - Blue
set -l color05 "d6/30/ff" # Base 0E - Magenta
set -l color06 "0e/ff/bb" # Base 0C - Cyan
set -l color07 "c1/c2/c2" # Base 05 - White
set -l color08 "81/84/84" # Base 03 - Bright Black
...
set -l color15 "f9/f9/f4" # Base 07 - Bright White
set -l color16 "ff/f7/27" # Base 09
set -l color17 "7f/00/48" # Base 0F
set -l color18 "23/26/28" # Base 01
set -l color19 "62/65/66" # Base 02
set -l color20 "a1/a3/a3" # Base 04
set -l color21 "e1/e1/e1" # Base 06
set -l color_foreground "c1/c2/c2" # Base 05
set -l color_background "24/27/28" # Base 00
...
set -U fish_color_end c1c2c2
set -U fish_color_error brred
set -U fish_color_param a1a3a3
set -U fish_color_valid_path --underline
set -U fish_color_option brcyan
set -U fish_color_comment 818484
set -U fish_color_selection e1e1e1 --bold --background=626566
set -U fish_color_operator brblue
set -U fish_color_escape brcyan
set -U fish_color_autosuggestion 818484
...
set -U fish_color_search_match bryellow --background=626566
set -U fish_color_history_current --bold
set -U fish_pager_color_progress 232628 --background=a1a3a3
set -U fish_pager_color_background normal --background=242728
set -U fish_pager_color_prefix normal --bold
set -U fish_pager_color_completion normal
set -U fish_pager_color_description fff727 --dim
set -U fish_pager_color_selected_background e1e1e1 --background=626566
set -U fish_pager_color_selected_prefix e1e1e1 --bold --background=626566
set -U fish_pager_color_selected_completion e1e1e1
...
# Set theme
set -Ux BASE24_THEME ultra-violet

# Optionally export variables
if test -n "$TINTED_SHELL_ENABLE_BASE24_VARS"; or test -n "$BASE24_SHELL_ENABLE_VARS"
  set -gx BASE24_COLOR_00_HEX "242728"
  set -gx BASE24_COLOR_01_HEX "232628"
  set -gx BASE24_COLOR_02_HEX "626566"
  set -gx BASE24_COLOR_03_HEX "818484"
  set -gx BASE24_COLOR_04_HEX "a1a3a3"
  set -gx BASE24_COLOR_05_HEX "c1c2c2"
  set -gx BASE24_COLOR_06_HEX "e1e1e1"
  set -gx BASE24_COLOR_07_HEX "f9f9f4"
  set -gx BASE24_COLOR_08_HEX "ff0090"
  set -gx BASE24_COLOR_09_HEX "fff727"
  set -gx BASE24_COLOR_0A_HEX "7febff"
  set -gx BASE24_COLOR_0B_HEX "b5ff00"
  set -gx BASE24_COLOR_0C_HEX "0effbb"
  set -gx BASE24_COLOR_0D_HEX "47dffb"
  set -gx BASE24_COLOR_0E_HEX "d630ff"
  set -gx BASE24_COLOR_0F_HEX "7f0048"
end
