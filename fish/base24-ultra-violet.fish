...
set -U fish_color_selection e1e1e1 --background=626566
set -U fish_color_operator magenta
set -U fish_color_escape fff727
...
set -U fish_color_search_match yellow --background=626566
set -U fish_color_history_current --underline=curly
set -U fish_pager_color_progress 232628 --background=a1a3a3
set -U fish_pager_color_background --background=242728
set -U fish_pager_color_prefix --bold --italics
set -U fish_pager_color_completion normal
set -U fish_pager_color_description fff727
set -U fish_pager_color_selected_background --background=626566
set -U fish_pager_color_selected_prefix --bold --italics --background=626566
