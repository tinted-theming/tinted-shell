...
set -l color00 "00/1e/26" # Base 00 - Black
set -l color01 "d0/1b/24" # Base 08 - Red
set -l color02 "6b/be/6c" # Base 0B - Green
set -l color03 "17/8d/c7" # Base 0A - Yellow
set -l color04 "20/75/c7" # Base 0D - Blue
set -l color05 "c6/1b/6e" # Base 0E - Magenta
set -l color06 "25/91/85" # Base 0C - Cyan
set -l color07 "ae/c2/ba" # Base 05 - White
set -l color08 "3a/82/98" # Base 03 - Bright Black
...
set -l color15 "fc/f4/dc" # Base 07 - Bright White
set -l color16 "a5/77/05" # Base 09
set -l color17 "68/0d/12" # Base 0F
set -l color18 "00/27/31" # Base 01
set -l color19 "00/63/88" # Base 02
set -l color20 "74/a2/a9" # Base 04
set -l color21 "e9/e2/cb" # Base 06
set -l color_foreground "ae/c2/ba" # Base 05
set -l color_background "00/1e/26" # Base 00
...
set -U fish_color_end aec2ba
set -U fish_color_error brred
set -U fish_color_param 74a2a9
set -U fish_color_valid_path --underline
set -U fish_color_option brcyan
set -U fish_color_comment 3a8298
set -U fish_color_selection e9e2cb --bold --background=006388
set -U fish_color_operator brblue
set -U fish_color_escape brcyan
set -U fish_color_autosuggestion 3a8298
...
set -U fish_color_search_match bryellow --background=006388
set -U fish_color_history_current --bold
set -U fish_pager_color_progress 002731 --background=74a2a9
set -U fish_pager_color_background normal --background=001e26
set -U fish_pager_color_prefix normal --bold
set -U fish_pager_color_completion normal
set -U fish_pager_color_description a57705 --dim
set -U fish_pager_color_selected_background e9e2cb --background=006388
set -U fish_pager_color_selected_prefix e9e2cb --bold --background=006388
set -U fish_pager_color_selected_completion e9e2cb
...
# Set theme
set -Ux BASE24_THEME solarized-dark-higher-contrast

# Optionally export variables
if test -n "$TINTED_SHELL_ENABLE_BASE24_VARS"; or test -n "$BASE24_SHELL_ENABLE_VARS"
  set -gx BASE24_COLOR_00_HEX "001e26"
  set -gx BASE24_COLOR_01_HEX "002731"
  set -gx BASE24_COLOR_02_HEX "006388"
  set -gx BASE24_COLOR_03_HEX "3a8298"
  set -gx BASE24_COLOR_04_HEX "74a2a9"
  set -gx BASE24_COLOR_05_HEX "aec2ba"
  set -gx BASE24_COLOR_06_HEX "e9e2cb"
  set -gx BASE24_COLOR_07_HEX "fcf4dc"
  set -gx BASE24_COLOR_08_HEX "d01b24"
  set -gx BASE24_COLOR_09_HEX "a57705"
  set -gx BASE24_COLOR_0A_HEX "178dc7"
  set -gx BASE24_COLOR_0B_HEX "6bbe6c"
  set -gx BASE24_COLOR_0C_HEX "259185"
  set -gx BASE24_COLOR_0D_HEX "2075c7"
  set -gx BASE24_COLOR_0E_HEX "c61b6e"
  set -gx BASE24_COLOR_0F_HEX "680d12"
end
