...
set -U fish_color_end ceced3
set -U fish_color_error brred
set -U fish_color_param 9fa0aa
set -U fish_color_valid_path --underline
set -U fish_color_option brcyan
set -U fish_color_comment 707281
set -U fish_color_selection fdfdfd --bold --background=414458
...
set -U fish_color_search_match bryellow --background=414458
set -U fish_color_history_current --bold
set -U fish_pager_color_progress 282a36 --background=9fa0aa
set -U fish_pager_color_background normal --background=1d1f28
set -U fish_pager_color_prefix normal --bold
set -U fish_pager_color_completion normal
set -U fish_pager_color_description f2a272 --dim
set -U fish_pager_color_selected_background fdfdfd --background=414458
set -U fish_pager_color_selected_prefix fdfdfd --bold --background=414458
set -U fish_pager_color_selected_completion fdfdfd
