...
set -l color00 "f5/f5/f5" # Base 00 - Black
set -l color01 "ac/41/42" # Base 08 - Red
set -l color02 "90/a9/59" # Base 0B - Green
set -l color03 "f4/bf/75" # Base 0A - Yellow
set -l color04 "6a/9f/b5" # Base 0D - Blue
set -l color05 "aa/75/9f" # Base 0E - Magenta
set -l color06 "75/b5/aa" # Base 0C - Cyan
set -l color07 "30/30/30" # Base 05 - White
set -l color08 "b0/b0/b0" # Base 03 - Bright Black
...
set -l color15 "15/15/15" # Base 07 - Bright White
set -l color16 "d2/84/45" # Base 09
set -l color17 "8f/55/36" # Base 0F
set -l color18 "e0/e0/e0" # Base 01
set -l color19 "d0/d0/d0" # Base 02
set -l color20 "50/50/50" # Base 04
set -l color21 "20/20/20" # Base 06
set -l color_foreground "30/30/30" # Base 05
set -l color_background "f5/f5/f5" # Base 00
...
set -U fish_pager_color_progress e0e0e0 --background=505050
set -U fish_pager_color_background normal --background=f5f5f5
set -U fish_pager_color_prefix normal --bold
set -U fish_pager_color_completion normal
set -U fish_pager_color_description d28445 --dim
set -U fish_pager_color_selected_background 202020 --background=d0d0d0
set -U fish_pager_color_selected_prefix 202020 --bold --background=d0d0d0
set -U fish_pager_color_selected_completion 202020
...
# Set theme
set -Ux BASE16_THEME classic-light

# Optionally export variables
if test -n "$TINTED_SHELL_ENABLE_BASE16_VARS"; or test -n "$BASE16_SHELL_ENABLE_VARS"
  set -gx BASE16_COLOR_00_HEX "f5f5f5"
  set -gx BASE16_COLOR_01_HEX "e0e0e0"
  set -gx BASE16_COLOR_02_HEX "d0d0d0"
  set -gx BASE16_COLOR_03_HEX "b0b0b0"
  set -gx BASE16_COLOR_04_HEX "505050"
  set -gx BASE16_COLOR_05_HEX "303030"
  set -gx BASE16_COLOR_06_HEX "202020"
  set -gx BASE16_COLOR_07_HEX "151515"
  set -gx BASE16_COLOR_08_HEX "ac4142"
  set -gx BASE16_COLOR_09_HEX "d28445"
  set -gx BASE16_COLOR_0A_HEX "f4bf75"
  set -gx BASE16_COLOR_0B_HEX "90a959"
  set -gx BASE16_COLOR_0C_HEX "75b5aa"
  set -gx BASE16_COLOR_0D_HEX "6a9fb5"
  set -gx BASE16_COLOR_0E_HEX "aa759f"
  set -gx BASE16_COLOR_0F_HEX "8f5536"
end
