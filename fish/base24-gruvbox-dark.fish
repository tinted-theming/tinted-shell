...
# Set theme
set -Ux BASE24_THEME gruvbox-dark

# Optionally export variables
if test -n "$TINTED_SHELL_ENABLE_BASE24_VARS"; or test -n "$BASE24_SHELL_ENABLE_VARS"
  set -gx BASE24_COLOR_00_HEX "282828"
  set -gx BASE24_COLOR_01_HEX "3c3836"
  set -gx BASE24_COLOR_02_HEX "504945"
  set -gx BASE24_COLOR_03_HEX "665c54"
  set -gx BASE24_COLOR_04_HEX "928374"
  set -gx BASE24_COLOR_05_HEX "ebdbb2"
  set -gx BASE24_COLOR_06_HEX "fbf1c7"
  set -gx BASE24_COLOR_07_HEX "f9f5d7"
  set -gx BASE24_COLOR_08_HEX "cc241d"
  set -gx BASE24_COLOR_09_HEX "d65d0e"
  set -gx BASE24_COLOR_0A_HEX "d79921"
  set -gx BASE24_COLOR_0B_HEX "98971a"
  set -gx BASE24_COLOR_0C_HEX "689d6a"
  set -gx BASE24_COLOR_0D_HEX "458588"
  set -gx BASE24_COLOR_0E_HEX "b16286"
  set -gx BASE24_COLOR_0F_HEX "9d0006"
end
