...
set -l color00 "e0/e0/e0" # Base 00 - Black
set -l color01 "84/00/00" # Base 08 - Red
set -l color02 "73/00/73" # Base 0B - Green
set -l color03 "75/5b/00" # Base 0A - Yellow
set -l color04 "00/73/00" # Base 0D - Blue
set -l color05 "00/00/90" # Base 0E - Magenta
set -l color06 "75/5b/00" # Base 0C - Cyan
set -l color07 "00/00/00" # Base 05 - White
set -l color08 "70/70/70" # Base 03 - Bright Black
...
set -l color15 "c4/d9/c4" # Base 07 - Bright White
set -l color16 "00/65/65" # Base 09
set -l color17 "75/5b/00" # Base 0F
set -l color18 "d0/da/d0" # Base 01
set -l color19 "d0/d0/d0" # Base 02
set -l color20 "20/20/20" # Base 04
set -l color21 "f8/f8/f8" # Base 06
set -l color_foreground "00/00/00" # Base 05
set -l color_background "e0/e0/e0" # Base 00
...
set -U fish_color_comment 707070
set -U fish_color_selection f8f8f8 --bold --background=d0d0d0
set -U fish_color_operator brblue
set -U fish_color_escape brcyan
set -U fish_color_autosuggestion 707070
...
set -U fish_pager_color_progress d0dad0 --background=202020
set -U fish_pager_color_background normal --background=e0e0e0
set -U fish_pager_color_prefix normal --bold
set -U fish_pager_color_completion normal
set -U fish_pager_color_description 006565 --dim
set -U fish_pager_color_selected_background f8f8f8 --background=d0d0d0
set -U fish_pager_color_selected_prefix f8f8f8 --bold --background=d0d0d0
set -U fish_pager_color_selected_completion f8f8f8
...
# Set theme
set -Ux BASE16_THEME dirtysea

# Optionally export variables
if test -n "$TINTED_SHELL_ENABLE_BASE16_VARS"; or test -n "$BASE16_SHELL_ENABLE_VARS"
  set -gx BASE16_COLOR_00_HEX "e0e0e0"
  set -gx BASE16_COLOR_01_HEX "d0dad0"
  set -gx BASE16_COLOR_02_HEX "d0d0d0"
  set -gx BASE16_COLOR_03_HEX "707070"
  set -gx BASE16_COLOR_04_HEX "202020"
  set -gx BASE16_COLOR_05_HEX "000000"
  set -gx BASE16_COLOR_06_HEX "f8f8f8"
  set -gx BASE16_COLOR_07_HEX "c4d9c4"
  set -gx BASE16_COLOR_08_HEX "840000"
  set -gx BASE16_COLOR_09_HEX "006565"
  set -gx BASE16_COLOR_0A_HEX "755b00"
  set -gx BASE16_COLOR_0B_HEX "730073"
  set -gx BASE16_COLOR_0C_HEX "755b00"
  set -gx BASE16_COLOR_0D_HEX "007300"
  set -gx BASE16_COLOR_0E_HEX "000090"
  set -gx BASE16_COLOR_0F_HEX "755b00"
end
