...
set -l color01 "aa/00/00" # Base 08 - Red
set -l color02 "00/aa/00" # Base 0B - Green
set -l color03 "ff/ff/55" # Base 0A - Yellow
set -l color04 "55/55/ff" # Base 0D - Blue
set -l color05 "ff/55/ff" # Base 0E - Magenta
set -l color06 "00/aa/aa" # Base 0C - Cyan
...
set -l color16 "ff/55/55" # Base 09
set -l color17 "aa/55/00" # Base 0F
...
set -U fish_pager_color_progress 333333 --background=888888
set -U fish_pager_color_background normal --background=000000
set -U fish_pager_color_prefix normal --bold
set -U fish_pager_color_completion normal
set -U fish_pager_color_description ff5555 --dim
set -U fish_pager_color_selected_background cccccc --background=444444
set -U fish_pager_color_selected_prefix cccccc --bold --background=444444
...
if test -n "$TINTED_SHELL_ENABLE_BASE16_VARS"; or test -n "$BASE16_SHELL_ENABLE_VARS"
  ...
  set -gx BASE16_COLOR_02_HEX "444444"
  set -gx BASE16_COLOR_03_HEX "555555"
  set -gx BASE16_COLOR_04_HEX "888888"
  set -gx BASE16_COLOR_05_HEX "aaaaaa"
  set -gx BASE16_COLOR_06_HEX "cccccc"
  set -gx BASE16_COLOR_07_HEX "ffffff"
  set -gx BASE16_COLOR_08_HEX "aa0000"
  set -gx BASE16_COLOR_09_HEX "ff5555"
  set -gx BASE16_COLOR_0A_HEX "ffff55"
  set -gx BASE16_COLOR_0B_HEX "00aa00"
  set -gx BASE16_COLOR_0C_HEX "00aaaa"
  set -gx BASE16_COLOR_0D_HEX "5555ff"
  set -gx BASE16_COLOR_0E_HEX "ff55ff"
  set -gx BASE16_COLOR_0F_HEX "aa5500"
end
