...
set -l color00 "0e/0c/15" # Base 00 - Black
set -l color01 "64/00/2c" # Base 08 - Red
set -l color02 "5d/73/1a" # Base 0B - Green
set -l color03 "40/a4/cf" # Base 0A - Yellow
set -l color04 "1d/6d/a1" # Base 0D - Blue
set -l color05 "b7/07/7e" # Base 0E - Magenta
set -l color06 "42/a3/8c" # Base 0C - Cyan
set -l color07 "c3/af/9d" # Base 05 - White
set -l color08 "63/4e/67" # Base 03 - Bright Black
...
set -l color15 "ff/f5/db" # Base 07 - Bright White
set -l color16 "cd/75/1c" # Base 09
set -l color17 "32/00/16" # Base 0F
set -l color18 "08/00/2e" # Base 01
set -l color19 "33/1e/4d" # Base 02
set -l color20 "93/7f/82" # Base 04
set -l color21 "f3/e0/b8" # Base 06
set -l color_foreground "c3/af/9d" # Base 05
set -l color_background "0e/0c/15" # Base 00
...
set -U fish_color_end c3af9d
set -U fish_color_error brred
set -U fish_color_param 937f82
set -U fish_color_valid_path --underline
set -U fish_color_option brcyan
set -U fish_color_comment 634e67
set -U fish_color_selection f3e0b8 --bold --background=331e4d
set -U fish_color_operator brblue
set -U fish_color_escape brcyan
set -U fish_color_autosuggestion 634e67
...
set -U fish_color_search_match bryellow --background=331e4d
set -U fish_color_history_current --bold
set -U fish_pager_color_progress 08002e --background=937f82
set -U fish_pager_color_background normal --background=0e0c15
set -U fish_pager_color_prefix normal --bold
set -U fish_pager_color_completion normal
set -U fish_pager_color_description cd751c --dim
set -U fish_pager_color_selected_background f3e0b8 --background=331e4d
set -U fish_pager_color_selected_prefix f3e0b8 --bold --background=331e4d
set -U fish_pager_color_selected_completion f3e0b8
...
# Set theme
set -Ux BASE24_THEME floraverse

# Optionally export variables
if test -n "$TINTED_SHELL_ENABLE_BASE24_VARS"; or test -n "$BASE24_SHELL_ENABLE_VARS"
  set -gx BASE24_COLOR_00_HEX "0e0c15"
  set -gx BASE24_COLOR_01_HEX "08002e"
  set -gx BASE24_COLOR_02_HEX "331e4d"
  set -gx BASE24_COLOR_03_HEX "634e67"
  set -gx BASE24_COLOR_04_HEX "937f82"
  set -gx BASE24_COLOR_05_HEX "c3af9d"
  set -gx BASE24_COLOR_06_HEX "f3e0b8"
  set -gx BASE24_COLOR_07_HEX "fff5db"
  set -gx BASE24_COLOR_08_HEX "64002c"
  set -gx BASE24_COLOR_09_HEX "cd751c"
  set -gx BASE24_COLOR_0A_HEX "40a4cf"
  set -gx BASE24_COLOR_0B_HEX "5d731a"
  set -gx BASE24_COLOR_0C_HEX "42a38c"
  set -gx BASE24_COLOR_0D_HEX "1d6da1"
  set -gx BASE24_COLOR_0E_HEX "b7077e"
  set -gx BASE24_COLOR_0F_HEX "320016"
end
