...
set -U fish_color_selection f3e0b8 --background=331e4d
set -U fish_color_operator magenta
set -U fish_color_escape cd751c
...
set -U fish_color_search_match yellow --background=331e4d
set -U fish_color_history_current --underline=curly
set -U fish_pager_color_progress 08002e --background=937f82
set -U fish_pager_color_background --background=0e0c15
set -U fish_pager_color_prefix --bold --italics
set -U fish_pager_color_completion normal
set -U fish_pager_color_description cd751c
set -U fish_pager_color_selected_background --background=331e4d
set -U fish_pager_color_selected_prefix --bold --italics --background=331e4d
