...
set -l color00 "2b/2b/2b" # Base 00 - Black
set -l color01 "da/49/39" # Base 08 - Red
set -l color02 "a5/c2/61" # Base 0B - Green
set -l color03 "ff/c6/6d" # Base 0A - Yellow
set -l color04 "6d/9c/be" # Base 0D - Blue
set -l color05 "b6/b3/eb" # Base 0E - Magenta
set -l color06 "51/9f/50" # Base 0C - Cyan
set -l color07 "e6/e1/dc" # Base 05 - White
set -l color08 "5a/64/7e" # Base 03 - Bright Black
...
set -l color15 "f9/f7/f3" # Base 07 - Bright White
set -l color16 "cc/78/33" # Base 09
set -l color17 "bc/94/58" # Base 0F
set -l color18 "27/29/35" # Base 01
set -l color19 "3a/40/55" # Base 02
set -l color20 "d4/cf/c9" # Base 04
set -l color21 "f4/f1/ed" # Base 06
set -l color_foreground "e6/e1/dc" # Base 05
set -l color_background "2b/2b/2b" # Base 00
...
set -U fish_color_end e6e1dc
set -U fish_color_error brred
set -U fish_color_param d4cfc9
set -U fish_color_valid_path --underline
set -U fish_color_option brcyan
set -U fish_color_comment 5a647e
set -U fish_color_selection f4f1ed --bold --background=3a4055
set -U fish_color_operator brblue
set -U fish_color_escape brcyan
set -U fish_color_autosuggestion 5a647e
...
set -U fish_pager_color_progress 272935 --background=d4cfc9
set -U fish_pager_color_background normal --background=2b2b2b
set -U fish_pager_color_prefix normal --bold
set -U fish_pager_color_completion normal
set -U fish_pager_color_description cc7833 --dim
set -U fish_pager_color_selected_background f4f1ed --background=3a4055
set -U fish_pager_color_selected_prefix f4f1ed --bold --background=3a4055
set -U fish_pager_color_selected_completion f4f1ed
...
# Set theme
set -Ux BASE16_THEME railscasts

# Optionally export variables
if test -n "$TINTED_SHELL_ENABLE_BASE16_VARS"; or test -n "$BASE16_SHELL_ENABLE_VARS"
  set -gx BASE16_COLOR_00_HEX "2b2b2b"
  set -gx BASE16_COLOR_01_HEX "272935"
  set -gx BASE16_COLOR_02_HEX "3a4055"
  set -gx BASE16_COLOR_03_HEX "5a647e"
  set -gx BASE16_COLOR_04_HEX "d4cfc9"
  set -gx BASE16_COLOR_05_HEX "e6e1dc"
  set -gx BASE16_COLOR_06_HEX "f4f1ed"
  set -gx BASE16_COLOR_07_HEX "f9f7f3"
  set -gx BASE16_COLOR_08_HEX "da4939"
  set -gx BASE16_COLOR_09_HEX "cc7833"
  set -gx BASE16_COLOR_0A_HEX "ffc66d"
  set -gx BASE16_COLOR_0B_HEX "a5c261"
  set -gx BASE16_COLOR_0C_HEX "519f50"
  set -gx BASE16_COLOR_0D_HEX "6d9cbe"
  set -gx BASE16_COLOR_0E_HEX "b6b3eb"
  set -gx BASE16_COLOR_0F_HEX "bc9458"
end
