...
set -l color00 "24/27/2b" # Base 00 - Black
...
set -l color07 "be/be/be" # Base 05 - White
...
set -l color18 "30/33/38" # Base 01
set -l color19 "3e/40/44" # Base 02
set -l color20 "8f/8f/8f" # Base 04
set -l color21 "ff/f7/ed" # Base 06
set -l color_foreground "be/be/be" # Base 05
set -l color_background "24/27/2b" # Base 00
...
set -U fish_pager_color_progress 303338 --background=8f8f8f
set -U fish_pager_color_background normal --background=24272b
