...
set -l color02 "00/ff/00" # Base 0B - Green
set -l color03 "ff/ff/00" # Base 0A - Yellow
set -l color04 "00/00/ff" # Base 0D - Blue
set -l color05 "ff/00/ff" # Base 0E - Magenta
set -l color06 "00/ff/ff" # Base 0C - Cyan
...
set -U fish_pager_color_progress 2a2a2a --background=a1a1a1
...
if test -n "$TINTED_SHELL_ENABLE_BASE16_VARS"; or test -n "$BASE16_SHELL_ENABLE_VARS"
  ...
  set -gx BASE16_COLOR_0B_HEX "00ff00"
  set -gx BASE16_COLOR_0C_HEX "00ffff"
  set -gx BASE16_COLOR_0D_HEX "0000ff"
  set -gx BASE16_COLOR_0E_HEX "ff00ff"
