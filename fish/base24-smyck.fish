...
set -U fish_color_selection a0a0a0 --background=7a7a7a
set -U fish_color_operator magenta
set -U fish_color_escape c4a400
...
set -U fish_color_search_match yellow --background=7a7a7a
set -U fish_color_history_current --underline=curly
set -U fish_pager_color_progress 000000 --background=8d8d8d
set -U fish_pager_color_background --background=1b1b1b
set -U fish_pager_color_prefix --bold --italics
set -U fish_pager_color_completion normal
set -U fish_pager_color_description c4a400
set -U fish_pager_color_selected_background --background=7a7a7a
set -U fish_pager_color_selected_prefix --bold --italics --background=7a7a7a
