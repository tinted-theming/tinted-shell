...
set -l color00 "1b/1b/1b" # Base 00 - Black
set -l color01 "b7/41/31" # Base 08 - Red
set -l color02 "7d/a9/00" # Base 0B - Green
set -l color03 "8d/cf/f0" # Base 0A - Yellow
set -l color04 "62/a3/c4" # Base 0D - Blue
set -l color05 "b9/8a/cc" # Base 0E - Magenta
set -l color06 "20/73/83" # Base 0C - Cyan
set -l color07 "96/96/96" # Base 05 - White
set -l color08 "83/83/83" # Base 03 - Bright Black
...
set -l color16 "c4/a4/00" # Base 09
set -l color17 "5b/20/18" # Base 0F
set -l color18 "00/00/00" # Base 01
set -l color19 "7a/7a/7a" # Base 02
set -l color20 "8d/8d/8d" # Base 04
set -l color21 "a0/a0/a0" # Base 06
set -l color_foreground "96/96/96" # Base 05
set -l color_background "1b/1b/1b" # Base 00
...
set -U fish_color_comment 838383
set -U fish_color_selection a0a0a0 --bold --background=7a7a7a
set -U fish_color_operator brblue
set -U fish_color_escape brcyan
set -U fish_color_autosuggestion 838383
...
set -U fish_color_search_match bryellow --background=7a7a7a
set -U fish_color_history_current --bold
set -U fish_pager_color_progress 000000 --background=8d8d8d
set -U fish_pager_color_background normal --background=1b1b1b
set -U fish_pager_color_prefix normal --bold
set -U fish_pager_color_completion normal
set -U fish_pager_color_description c4a400 --dim
set -U fish_pager_color_selected_background a0a0a0 --background=7a7a7a
set -U fish_pager_color_selected_prefix a0a0a0 --bold --background=7a7a7a
set -U fish_pager_color_selected_completion a0a0a0
...
# Set theme
set -Ux BASE24_THEME smyck

# Optionally export variables
if test -n "$TINTED_SHELL_ENABLE_BASE24_VARS"; or test -n "$BASE24_SHELL_ENABLE_VARS"
  set -gx BASE24_COLOR_00_HEX "1b1b1b"
  set -gx BASE24_COLOR_01_HEX "000000"
  set -gx BASE24_COLOR_02_HEX "7a7a7a"
  set -gx BASE24_COLOR_03_HEX "838383"
  set -gx BASE24_COLOR_04_HEX "8d8d8d"
  set -gx BASE24_COLOR_05_HEX "969696"
  set -gx BASE24_COLOR_06_HEX "a0a0a0"
  set -gx BASE24_COLOR_07_HEX "f7f7f7"
  set -gx BASE24_COLOR_08_HEX "b74131"
  set -gx BASE24_COLOR_09_HEX "c4a400"
  set -gx BASE24_COLOR_0A_HEX "8dcff0"
  set -gx BASE24_COLOR_0B_HEX "7da900"
  set -gx BASE24_COLOR_0C_HEX "207383"
  set -gx BASE24_COLOR_0D_HEX "62a3c4"
  set -gx BASE24_COLOR_0E_HEX "b98acc"
  set -gx BASE24_COLOR_0F_HEX "5b2018"
end
