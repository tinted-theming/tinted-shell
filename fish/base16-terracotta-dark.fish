...
set -l color00 "24/1d/1a" # Base 00 - Black
set -l color01 "f6/99/8f" # Base 08 - Red
set -l color02 "b6/c6/8a" # Base 0B - Green
set -l color03 "ff/c3/7a" # Base 0A - Yellow
set -l color04 "b0/a4/c3" # Base 0D - Blue
set -l color05 "d8/a2/b0" # Base 0E - Magenta
set -l color06 "c0/bc/db" # Base 0C - Cyan
set -l color07 "b8/a5/9d" # Base 05 - White
set -l color08 "59/47/40" # Base 03 - Bright Black
...
set -l color15 "dc/d2/ce" # Base 07 - Bright White
set -l color16 "ff/a8/88" # Base 09
set -l color17 "f1/ae/97" # Base 0F
set -l color18 "36/2b/27" # Base 01
set -l color19 "47/39/33" # Base 02
set -l color20 "a7/8e/84" # Base 04
set -l color21 "ca/bb/b5" # Base 06
set -l color_foreground "b8/a5/9d" # Base 05
set -l color_background "24/1d/1a" # Base 00
...
set -U fish_color_end b8a59d
set -U fish_color_error brred
set -U fish_color_param a78e84
set -U fish_color_valid_path --underline
set -U fish_color_option brcyan
set -U fish_color_comment 594740
set -U fish_color_selection cabbb5 --bold --background=473933
set -U fish_color_operator brblue
set -U fish_color_escape brcyan
set -U fish_color_autosuggestion 594740
...
set -U fish_color_search_match bryellow --background=473933
set -U fish_color_history_current --bold
set -U fish_pager_color_progress 362b27 --background=a78e84
set -U fish_pager_color_background normal --background=241d1a
set -U fish_pager_color_prefix normal --bold
set -U fish_pager_color_completion normal
set -U fish_pager_color_description ffa888 --dim
set -U fish_pager_color_selected_background cabbb5 --background=473933
set -U fish_pager_color_selected_prefix cabbb5 --bold --background=473933
set -U fish_pager_color_selected_completion cabbb5
...
# Set theme
set -Ux BASE16_THEME terracotta-dark

# Optionally export variables
if test -n "$TINTED_SHELL_ENABLE_BASE16_VARS"; or test -n "$BASE16_SHELL_ENABLE_VARS"
  set -gx BASE16_COLOR_00_HEX "241d1a"
  set -gx BASE16_COLOR_01_HEX "362b27"
  set -gx BASE16_COLOR_02_HEX "473933"
  set -gx BASE16_COLOR_03_HEX "594740"
  set -gx BASE16_COLOR_04_HEX "a78e84"
  set -gx BASE16_COLOR_05_HEX "b8a59d"
  set -gx BASE16_COLOR_06_HEX "cabbb5"
  set -gx BASE16_COLOR_07_HEX "dcd2ce"
  set -gx BASE16_COLOR_08_HEX "f6998f"
  set -gx BASE16_COLOR_09_HEX "ffa888"
  set -gx BASE16_COLOR_0A_HEX "ffc37a"
  set -gx BASE16_COLOR_0B_HEX "b6c68a"
  set -gx BASE16_COLOR_0C_HEX "c0bcdb"
  set -gx BASE16_COLOR_0D_HEX "b0a4c3"
  set -gx BASE16_COLOR_0E_HEX "d8a2b0"
  set -gx BASE16_COLOR_0F_HEX "f1ae97"
end
