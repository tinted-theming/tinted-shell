...
set -l color00 "22/27/3d" # Base 00 - Black
set -l color01 "fa/78/83" # Base 08 - Red
set -l color02 "98/c3/79" # Base 0B - Green
set -l color03 "ff/94/70" # Base 0A - Yellow
set -l color04 "6b/b8/ff" # Base 0D - Blue
set -l color05 "e7/99/ff" # Base 0E - Magenta
set -l color06 "8a/f5/ff" # Base 0C - Cyan
set -l color07 "ff/ff/ff" # Base 05 - White
set -l color08 "87/8d/96" # Base 03 - Bright Black
...
set -l color16 "ff/c3/87" # Base 09
set -l color17 "b3/68/4f" # Base 0F
set -l color18 "37/40/59" # Base 01
set -l color19 "52/58/66" # Base 02
set -l color20 "c8/c8/c8" # Base 04
set -l color21 "ff/ff/ff" # Base 06
set -l color_foreground "ff/ff/ff" # Base 05
set -l color_background "22/27/3d" # Base 00
...
if test -n "$ITERM_SESSION_ID"
  ...
  put_template_custom Ph 22273d # background
  ...
  put_template_custom Pm 22273d # cursor text
else
...
set -U fish_color_param c8c8c8
set -U fish_color_valid_path --underline
set -U fish_color_option brcyan
set -U fish_color_comment 878d96
set -U fish_color_selection ffffff --bold --background=525866
set -U fish_color_operator brblue
set -U fish_color_escape brcyan
set -U fish_color_autosuggestion 878d96
...
set -U fish_color_search_match bryellow --background=525866
set -U fish_color_history_current --bold
set -U fish_pager_color_progress 374059 --background=c8c8c8
set -U fish_pager_color_background normal --background=22273d
set -U fish_pager_color_prefix normal --bold
set -U fish_pager_color_completion normal
set -U fish_pager_color_description ffc387 --dim
set -U fish_pager_color_selected_background ffffff --background=525866
set -U fish_pager_color_selected_prefix ffffff --bold --background=525866
...
# Set theme
set -Ux BASE16_THEME da-one-sea

# Optionally export variables
if test -n "$TINTED_SHELL_ENABLE_BASE16_VARS"; or test -n "$BASE16_SHELL_ENABLE_VARS"
  set -gx BASE16_COLOR_00_HEX "22273d"
  set -gx BASE16_COLOR_01_HEX "374059"
  set -gx BASE16_COLOR_02_HEX "525866"
  set -gx BASE16_COLOR_03_HEX "878d96"
  set -gx BASE16_COLOR_04_HEX "c8c8c8"
  set -gx BASE16_COLOR_05_HEX "ffffff"
  set -gx BASE16_COLOR_06_HEX "ffffff"
  set -gx BASE16_COLOR_07_HEX "ffffff"
  set -gx BASE16_COLOR_08_HEX "fa7883"
  set -gx BASE16_COLOR_09_HEX "ffc387"
  set -gx BASE16_COLOR_0A_HEX "ff9470"
  set -gx BASE16_COLOR_0B_HEX "98c379"
  set -gx BASE16_COLOR_0C_HEX "8af5ff"
  set -gx BASE16_COLOR_0D_HEX "6bb8ff"
  set -gx BASE16_COLOR_0E_HEX "e799ff"
