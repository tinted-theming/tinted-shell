...
set -l color00 "2c/1c/15" # Base 00 - Black
set -l color01 "ef/57/34" # Base 08 - Red
set -l color02 "2b/af/2b" # Base 0B - Green
set -l color03 "00/00/ff" # Base 0A - Yellow
set -l color04 "24/6d/b2" # Base 0D - Blue
set -l color05 "cf/5e/c0" # Base 0E - Magenta
set -l color06 "00/ac/ee" # Base 0C - Cyan
...
set -l color16 "bd/be/00" # Base 09
set -l color17 "77/2b/1a" # Base 0F
set -l color18 "2c/1d/16" # Base 01
...
set -l color_background "2c/1c/15" # Base 00
...
if test -n "$ITERM_SESSION_ID"
  ...
  put_template_custom Ph 2c1c15 # background
  ...
  put_template_custom Pm 2c1c15 # cursor text
else
...
set -U fish_color_param 929292
set -U fish_color_valid_path --underline
set -U fish_color_option brcyan
set -U fish_color_comment 7c7c7c
set -U fish_color_selection bfbfbf --bold --background=666666
...
set -U fish_pager_color_progress 2c1d16 --background=929292
set -U fish_pager_color_background normal --background=2c1c15
set -U fish_pager_color_prefix normal --bold
set -U fish_pager_color_completion normal
set -U fish_pager_color_description bdbe00 --dim
set -U fish_pager_color_selected_background bfbfbf --background=666666
set -U fish_pager_color_selected_prefix bfbfbf --bold --background=666666
...
# Set theme
set -Ux BASE24_THEME jackie-brown

# Optionally export variables
if test -n "$TINTED_SHELL_ENABLE_BASE24_VARS"; or test -n "$BASE24_SHELL_ENABLE_VARS"
  set -gx BASE24_COLOR_00_HEX "2c1c15"
  set -gx BASE24_COLOR_01_HEX "2c1d16"
  ...
  set -gx BASE24_COLOR_08_HEX "ef5734"
  set -gx BASE24_COLOR_09_HEX "bdbe00"
  set -gx BASE24_COLOR_0A_HEX "0000ff"
  set -gx BASE24_COLOR_0B_HEX "2baf2b"
  set -gx BASE24_COLOR_0C_HEX "00acee"
  set -gx BASE24_COLOR_0D_HEX "246db2"
  set -gx BASE24_COLOR_0E_HEX "cf5ec0"
  set -gx BASE24_COLOR_0F_HEX "772b1a"
end
