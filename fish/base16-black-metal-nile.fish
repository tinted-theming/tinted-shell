...
set -l color02 "aa/99/88" # Base 0B - Green
set -l color03 "77/77/55" # Base 0A - Yellow
...
# Set theme
set -Ux BASE16_THEME black-metal-nile
...
if test -n "$TINTED_SHELL_ENABLE_BASE16_VARS"; or test -n "$BASE16_SHELL_ENABLE_VARS"
  ...
  set -gx BASE16_COLOR_0A_HEX "777755"
  set -gx BASE16_COLOR_0B_HEX "aa9988"
