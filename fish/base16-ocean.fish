...
set -l color15 "ef/f1/f5" # Base 07 - Bright White
...
set -l color21 "df/e1/e8" # Base 06
set -l color_foreground "c0/c5/ce" # Base 05
set -l color_background "2b/30/3b" # Base 00
...
set -U fish_color_end c0c5ce
set -U fish_color_error brred
set -U fish_color_param a7adba
set -U fish_color_valid_path --underline
set -U fish_color_option brcyan
set -U fish_color_comment 65737e
set -U fish_color_selection dfe1e8 --bold --background=4f5b66
set -U fish_color_operator brblue
set -U fish_color_escape brcyan
set -U fish_color_autosuggestion 65737e
...
set -U fish_pager_color_progress 343d46 --background=a7adba
set -U fish_pager_color_background normal --background=2b303b
set -U fish_pager_color_prefix normal --bold
set -U fish_pager_color_completion normal
set -U fish_pager_color_description d08770 --dim
set -U fish_pager_color_selected_background dfe1e8 --background=4f5b66
set -U fish_pager_color_selected_prefix dfe1e8 --bold --background=4f5b66
set -U fish_pager_color_selected_completion dfe1e8
...
# Set theme
set -Ux BASE16_THEME ocean

# Optionally export variables
if test -n "$TINTED_SHELL_ENABLE_BASE16_VARS"; or test -n "$BASE16_SHELL_ENABLE_VARS"
  set -gx BASE16_COLOR_00_HEX "2b303b"
  set -gx BASE16_COLOR_01_HEX "343d46"
  set -gx BASE16_COLOR_02_HEX "4f5b66"
  set -gx BASE16_COLOR_03_HEX "65737e"
  set -gx BASE16_COLOR_04_HEX "a7adba"
  set -gx BASE16_COLOR_05_HEX "c0c5ce"
  set -gx BASE16_COLOR_06_HEX "dfe1e8"
  set -gx BASE16_COLOR_07_HEX "eff1f5"
  ...
  set -gx BASE16_COLOR_0C_HEX "96b5b4"
  set -gx BASE16_COLOR_0D_HEX "8fa1b3"
  set -gx BASE16_COLOR_0E_HEX "b48ead"
  set -gx BASE16_COLOR_0F_HEX "ab7967"
end
