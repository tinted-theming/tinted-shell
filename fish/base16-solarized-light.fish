...
set -U fish_pager_color_selected_background 073642 --background=93a1a1
set -U fish_pager_color_selected_prefix 073642 --bold --background=93a1a1
set -U fish_pager_color_selected_completion 073642
...
# Set theme
set -Ux BASE16_THEME solarized-light

# Optionally export variables
if test -n "$TINTED_SHELL_ENABLE_BASE16_VARS"; or test -n "$BASE16_SHELL_ENABLE_VARS"
  set -gx BASE16_COLOR_00_HEX "fdf6e3"
  set -gx BASE16_COLOR_01_HEX "eee8d5"
  set -gx BASE16_COLOR_02_HEX "93a1a1"
  set -gx BASE16_COLOR_03_HEX "839496"
  set -gx BASE16_COLOR_04_HEX "657b83"
  set -gx BASE16_COLOR_05_HEX "586e75"
  set -gx BASE16_COLOR_06_HEX "073642"
  set -gx BASE16_COLOR_07_HEX "002b36"
