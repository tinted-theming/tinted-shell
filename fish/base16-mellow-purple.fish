...
set -l color00 "1e/05/28" # Base 00 - Black
set -l color01 "00/d9/e9" # Base 08 - Red
set -l color02 "05/cb/0d" # Base 0B - Green
set -l color03 "95/5a/e7" # Base 0A - Yellow
set -l color04 "55/00/68" # Base 0D - Blue
set -l color05 "89/91/bb" # Base 0E - Magenta
set -l color06 "b9/00/b1" # Base 0C - Cyan
set -l color07 "ff/ee/ff" # Base 05 - White
set -l color08 "32/0f/55" # Base 03 - Bright Black
...
set -l color15 "f8/c0/ff" # Base 07 - Bright White
set -l color16 "aa/00/a3" # Base 09
set -l color17 "4d/6f/ff" # Base 0F
set -l color18 "1a/09/2d" # Base 01
set -l color19 "33/13/54" # Base 02
set -l color20 "87/35/82" # Base 04
set -l color21 "ff/ee/ff" # Base 06
set -l color_foreground "ff/ee/ff" # Base 05
set -l color_background "1e/05/28" # Base 00
...
set -U fish_color_end ffeeff
set -U fish_color_error brred
set -U fish_color_param 873582
set -U fish_color_valid_path --underline
set -U fish_color_option brcyan
set -U fish_color_comment 320f55
set -U fish_color_selection ffeeff --bold --background=331354
set -U fish_color_operator brblue
set -U fish_color_escape brcyan
set -U fish_color_autosuggestion 320f55
...
set -U fish_pager_color_progress 1a092d --background=873582
set -U fish_pager_color_background normal --background=1e0528
set -U fish_pager_color_prefix normal --bold
set -U fish_pager_color_completion normal
set -U fish_pager_color_description aa00a3 --dim
set -U fish_pager_color_selected_background ffeeff --background=331354
set -U fish_pager_color_selected_prefix ffeeff --bold --background=331354
set -U fish_pager_color_selected_completion ffeeff
...
# Set theme
set -Ux BASE16_THEME mellow-purple

# Optionally export variables
if test -n "$TINTED_SHELL_ENABLE_BASE16_VARS"; or test -n "$BASE16_SHELL_ENABLE_VARS"
  set -gx BASE16_COLOR_00_HEX "1e0528"
  set -gx BASE16_COLOR_01_HEX "1a092d"
  set -gx BASE16_COLOR_02_HEX "331354"
  set -gx BASE16_COLOR_03_HEX "320f55"
  set -gx BASE16_COLOR_04_HEX "873582"
  set -gx BASE16_COLOR_05_HEX "ffeeff"
  set -gx BASE16_COLOR_06_HEX "ffeeff"
  set -gx BASE16_COLOR_07_HEX "f8c0ff"
  set -gx BASE16_COLOR_08_HEX "00d9e9"
  set -gx BASE16_COLOR_09_HEX "aa00a3"
  set -gx BASE16_COLOR_0A_HEX "955ae7"
  set -gx BASE16_COLOR_0B_HEX "05cb0d"
  set -gx BASE16_COLOR_0C_HEX "b900b1"
  set -gx BASE16_COLOR_0D_HEX "550068"
  set -gx BASE16_COLOR_0E_HEX "8991bb"
  set -gx BASE16_COLOR_0F_HEX "4d6fff"
end
