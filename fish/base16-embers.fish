...
set -l color00 "16/13/0f" # Base 00 - Black
...
set -l color07 "a3/9a/90" # Base 05 - White
set -l color08 "5a/50/47" # Base 03 - Bright Black
...
set -l color15 "db/d6/d1" # Base 07 - Bright White
set -l color16 "82/82/57" # Base 09
set -l color17 "82/57/57" # Base 0F
set -l color18 "2c/26/20" # Base 01
set -l color19 "43/3b/32" # Base 02
set -l color20 "8a/80/75" # Base 04
set -l color21 "be/b6/ae" # Base 06
set -l color_foreground "a3/9a/90" # Base 05
set -l color_background "16/13/0f" # Base 00
...
set -U fish_color_end a39a90
set -U fish_color_error brred
set -U fish_color_param 8a8075
set -U fish_color_valid_path --underline
set -U fish_color_option brcyan
set -U fish_color_comment 5a5047
set -U fish_color_selection beb6ae --bold --background=433b32
set -U fish_color_operator brblue
set -U fish_color_escape brcyan
set -U fish_color_autosuggestion 5a5047
...
set -U fish_pager_color_progress 2c2620 --background=8a8075
set -U fish_pager_color_background normal --background=16130f
set -U fish_pager_color_prefix normal --bold
set -U fish_pager_color_completion normal
set -U fish_pager_color_description 828257 --dim
set -U fish_pager_color_selected_background beb6ae --background=433b32
set -U fish_pager_color_selected_prefix beb6ae --bold --background=433b32
set -U fish_pager_color_selected_completion beb6ae
...
# Set theme
set -Ux BASE16_THEME embers

# Optionally export variables
if test -n "$TINTED_SHELL_ENABLE_BASE16_VARS"; or test -n "$BASE16_SHELL_ENABLE_VARS"
  set -gx BASE16_COLOR_00_HEX "16130f"
  set -gx BASE16_COLOR_01_HEX "2c2620"
  set -gx BASE16_COLOR_02_HEX "433b32"
  set -gx BASE16_COLOR_03_HEX "5a5047"
  set -gx BASE16_COLOR_04_HEX "8a8075"
  set -gx BASE16_COLOR_05_HEX "a39a90"
  set -gx BASE16_COLOR_06_HEX "beb6ae"
  set -gx BASE16_COLOR_07_HEX "dbd6d1"
