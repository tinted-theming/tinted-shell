...
set -l color01 "c0/6c/43" # Base 08 - Red
set -l color02 "af/b9/79" # Base 0B - Green
set -l color03 "5a/5d/61" # Base 0A - Yellow
set -l color04 "44/46/49" # Base 0D - Blue
set -l color05 "b4/be/7b" # Base 0E - Magenta
set -l color06 "77/82/84" # Base 0C - Cyan
set -l color07 "c8/c8/a7" # Base 05 - White
set -l color08 "5c/5c/51" # Base 03 - Bright Black
...
set -l color15 "fe/ff/d3" # Base 07 - Bright White
set -l color16 "c2/a8/6c" # Base 09
set -l color17 "60/36/21" # Base 0F
set -l color18 "14/14/14" # Base 01
set -l color19 "26/26/26" # Base 02
set -l color20 "92/92/7c" # Base 04
set -l color21 "fe/ff/d3" # Base 06
set -l color_foreground "c8/c8/a7" # Base 05
...
set -U fish_color_end c8c8a7
set -U fish_color_error brred
set -U fish_color_param 92927c
set -U fish_color_valid_path --underline
set -U fish_color_option brcyan
set -U fish_color_comment 5c5c51
set -U fish_color_selection feffd3 --bold --background=262626
set -U fish_color_operator brblue
set -U fish_color_escape brcyan
set -U fish_color_autosuggestion 5c5c51
...
set -U fish_pager_color_progress 141414 --background=92927c
set -U fish_pager_color_background normal --background=141414
set -U fish_pager_color_prefix normal --bold
set -U fish_pager_color_completion normal
set -U fish_pager_color_description c2a86c --dim
set -U fish_pager_color_selected_background feffd3 --background=262626
set -U fish_pager_color_selected_prefix feffd3 --bold --background=262626
set -U fish_pager_color_selected_completion feffd3
...
# Set theme
set -Ux BASE24_THEME twilight

# Optionally export variables
if test -n "$TINTED_SHELL_ENABLE_BASE24_VARS"; or test -n "$BASE24_SHELL_ENABLE_VARS"
  set -gx BASE24_COLOR_00_HEX "141414"
  set -gx BASE24_COLOR_01_HEX "141414"
  set -gx BASE24_COLOR_02_HEX "262626"
  set -gx BASE24_COLOR_03_HEX "5c5c51"
  set -gx BASE24_COLOR_04_HEX "92927c"
  set -gx BASE24_COLOR_05_HEX "c8c8a7"
  set -gx BASE24_COLOR_06_HEX "feffd3"
  set -gx BASE24_COLOR_07_HEX "feffd3"
  set -gx BASE24_COLOR_08_HEX "c06c43"
  set -gx BASE24_COLOR_09_HEX "c2a86c"
  set -gx BASE24_COLOR_0A_HEX "5a5d61"
  set -gx BASE24_COLOR_0B_HEX "afb979"
  set -gx BASE24_COLOR_0C_HEX "778284"
  set -gx BASE24_COLOR_0D_HEX "444649"
  set -gx BASE24_COLOR_0E_HEX "b4be7b"
  set -gx BASE24_COLOR_0F_HEX "603621"
end
