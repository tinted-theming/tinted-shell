...
set -l color00 "0f/11/15" # Base 00 - Black
set -l color01 "ff/56/7f" # Base 08 - Red
set -l color02 "00/ff/9b" # Base 0B - Green
set -l color03 "68/71/ff" # Base 0A - Yellow
set -l color04 "00/b0/fe" # Base 0D - Blue
set -l color05 "d4/7b/fe" # Base 0E - Magenta
set -l color06 "75/c1/fe" # Base 0C - Cyan
set -l color07 "af/af/af" # Base 05 - White
set -l color08 "7f/7f/7f" # Base 03 - Bright Black
...
set -l color16 "fe/fc/57" # Base 09
set -l color17 "7f/2b/3f" # Base 0F
set -l color18 "10/11/16" # Base 01
set -l color19 "67/67/67" # Base 02
set -l color20 "97/97/97" # Base 04
set -l color21 "c7/c7/c7" # Base 06
set -l color_foreground "af/af/af" # Base 05
set -l color_background "0f/11/15" # Base 00
...
if test -n "$ITERM_SESSION_ID"
  ...
  put_template_custom Ph 0f1115 # background
  ...
  put_template_custom Pm 0f1115 # cursor text
else
...
set -U fish_color_end afafaf
set -U fish_color_error brred
set -U fish_color_param 979797
set -U fish_color_valid_path --underline
set -U fish_color_option brcyan
set -U fish_color_comment 7f7f7f
set -U fish_color_selection c7c7c7 --bold --background=676767
...
set -U fish_color_search_match bryellow --background=676767
set -U fish_color_history_current --bold
set -U fish_pager_color_progress 101116 --background=979797
set -U fish_pager_color_background normal --background=0f1115
set -U fish_pager_color_prefix normal --bold
set -U fish_pager_color_completion normal
set -U fish_pager_color_description fefc57 --dim
set -U fish_pager_color_selected_background c7c7c7 --background=676767
set -U fish_pager_color_selected_prefix c7c7c7 --bold --background=676767
set -U fish_pager_color_selected_completion c7c7c7
...
# Set theme
set -Ux BASE24_THEME blue-matrix

# Optionally export variables
if test -n "$TINTED_SHELL_ENABLE_BASE24_VARS"; or test -n "$BASE24_SHELL_ENABLE_VARS"
  set -gx BASE24_COLOR_00_HEX "0f1115"
  set -gx BASE24_COLOR_01_HEX "101116"
  set -gx BASE24_COLOR_02_HEX "676767"
  set -gx BASE24_COLOR_03_HEX "7f7f7f"
  set -gx BASE24_COLOR_04_HEX "979797"
  set -gx BASE24_COLOR_05_HEX "afafaf"
  set -gx BASE24_COLOR_06_HEX "c7c7c7"
  set -gx BASE24_COLOR_07_HEX "feffff"
  set -gx BASE24_COLOR_08_HEX "ff567f"
  set -gx BASE24_COLOR_09_HEX "fefc57"
  set -gx BASE24_COLOR_0A_HEX "6871ff"
  set -gx BASE24_COLOR_0B_HEX "00ff9b"
  set -gx BASE24_COLOR_0C_HEX "75c1fe"
  set -gx BASE24_COLOR_0D_HEX "00b0fe"
  set -gx BASE24_COLOR_0E_HEX "d47bfe"
  set -gx BASE24_COLOR_0F_HEX "7f2b3f"
end
