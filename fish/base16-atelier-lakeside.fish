...
set -l color00 "16/1b/1d" # Base 00 - Black
...
set -l color07 "7e/a2/b4" # Base 05 - White
set -l color08 "5a/7b/8c" # Base 03 - Bright Black
...
set -l color15 "eb/f8/ff" # Base 07 - Bright White
set -l color16 "93/5c/25" # Base 09
set -l color17 "b7/2d/d2" # Base 0F
set -l color18 "1f/29/2e" # Base 01
set -l color19 "51/6d/7b" # Base 02
set -l color20 "71/95/a8" # Base 04
set -l color21 "c1/e4/f6" # Base 06
set -l color_foreground "7e/a2/b4" # Base 05
set -l color_background "16/1b/1d" # Base 00
...
set -U fish_color_end 7ea2b4
set -U fish_color_error brred
set -U fish_color_param 7195a8
set -U fish_color_valid_path --underline
set -U fish_color_option brcyan
set -U fish_color_comment 5a7b8c
set -U fish_color_selection c1e4f6 --bold --background=516d7b
set -U fish_color_operator brblue
set -U fish_color_escape brcyan
set -U fish_color_autosuggestion 5a7b8c
...
set -U fish_pager_color_progress 1f292e --background=7195a8
set -U fish_pager_color_background normal --background=161b1d
set -U fish_pager_color_prefix normal --bold
set -U fish_pager_color_completion normal
set -U fish_pager_color_description 935c25 --dim
set -U fish_pager_color_selected_background c1e4f6 --background=516d7b
set -U fish_pager_color_selected_prefix c1e4f6 --bold --background=516d7b
set -U fish_pager_color_selected_completion c1e4f6
...
# Set theme
set -Ux BASE16_THEME atelier-lakeside

# Optionally export variables
if test -n "$TINTED_SHELL_ENABLE_BASE16_VARS"; or test -n "$BASE16_SHELL_ENABLE_VARS"
  set -gx BASE16_COLOR_00_HEX "161b1d"
  set -gx BASE16_COLOR_01_HEX "1f292e"
  set -gx BASE16_COLOR_02_HEX "516d7b"
  set -gx BASE16_COLOR_03_HEX "5a7b8c"
  set -gx BASE16_COLOR_04_HEX "7195a8"
  set -gx BASE16_COLOR_05_HEX "7ea2b4"
  set -gx BASE16_COLOR_06_HEX "c1e4f6"
  set -gx BASE16_COLOR_07_HEX "ebf8ff"
