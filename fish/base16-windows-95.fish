...
set -l color16 "a8/54/00" # Base 09
set -l color17 "00/a8/00" # Base 0F
set -l color18 "1c/1c/1c" # Base 01
set -l color19 "38/38/38" # Base 02
set -l color20 "7e/7e/7e" # Base 04
set -l color21 "d2/d2/d2" # Base 06
...
set -U fish_pager_color_progress 1c1c1c --background=7e7e7e
set -U fish_pager_color_background normal --background=000000
set -U fish_pager_color_prefix normal --bold
set -U fish_pager_color_completion normal
set -U fish_pager_color_description a85400 --dim
set -U fish_pager_color_selected_background d2d2d2 --background=383838
set -U fish_pager_color_selected_prefix d2d2d2 --bold --background=383838
set -U fish_pager_color_selected_completion d2d2d2
...
# Set theme
set -Ux BASE16_THEME windows-95
...
if test -n "$TINTED_SHELL_ENABLE_BASE16_VARS"; or test -n "$BASE16_SHELL_ENABLE_VARS"
  ...
  set -gx BASE16_COLOR_05_HEX "a8a8a8"
  set -gx BASE16_COLOR_06_HEX "d2d2d2"
  set -gx BASE16_COLOR_07_HEX "fcfcfc"
  set -gx BASE16_COLOR_08_HEX "fc5454"
  set -gx BASE16_COLOR_09_HEX "a85400"
  ...
  set -gx BASE16_COLOR_0F_HEX "00a800"
end
