...
set -l color00 "f1/e3/d1" # Base 00 - Black
set -l color01 "d0/97/00" # Base 08 - Red
set -l color02 "90/8d/6a" # Base 0B - Green
set -l color03 "99/33/33" # Base 0A - Yellow
set -l color04 "bf/79/79" # Base 0D - Blue
set -l color05 "9e/55/81" # Base 0E - Magenta
set -l color06 "d0/97/00" # Base 0C - Cyan
set -l color07 "64/51/3e" # Base 05 - White
set -l color08 "b5/a4/92" # Base 03 - Bright Black
...
set -l color15 "8c/7b/68" # Base 07 - Bright White
set -l color16 "64/51/3e" # Base 09
set -l color17 "75/85/8c" # Base 0F
set -l color18 "dd/ce/bc" # Base 01
set -l color19 "c9/b9/a7" # Base 02
set -l color20 "a0/90/7d" # Base 04
set -l color21 "78/66/53" # Base 06
set -l color_foreground "64/51/3e" # Base 05
set -l color_background "f1/e3/d1" # Base 00
...
set -U fish_color_end 64513e
set -U fish_color_error brred
set -U fish_color_param a0907d
set -U fish_color_valid_path --underline
set -U fish_color_option brcyan
set -U fish_color_comment b5a492
set -U fish_color_selection 786653 --bold --background=c9b9a7
set -U fish_color_operator brblue
set -U fish_color_escape brcyan
set -U fish_color_autosuggestion b5a492
...
set -U fish_color_search_match bryellow --background=c9b9a7
set -U fish_color_history_current --bold
set -U fish_pager_color_progress ddcebc --background=a0907d
set -U fish_pager_color_background normal --background=f1e3d1
set -U fish_pager_color_prefix normal --bold
set -U fish_pager_color_completion normal
set -U fish_pager_color_description 64513e --dim
set -U fish_pager_color_selected_background 786653 --background=c9b9a7
set -U fish_pager_color_selected_prefix 786653 --bold --background=c9b9a7
set -U fish_pager_color_selected_completion 786653
...
# Set theme
set -Ux BASE16_THEME swamp-light

# Optionally export variables
if test -n "$TINTED_SHELL_ENABLE_BASE16_VARS"; or test -n "$BASE16_SHELL_ENABLE_VARS"
  set -gx BASE16_COLOR_00_HEX "f1e3d1"
  set -gx BASE16_COLOR_01_HEX "ddcebc"
  set -gx BASE16_COLOR_02_HEX "c9b9a7"
  set -gx BASE16_COLOR_03_HEX "b5a492"
  set -gx BASE16_COLOR_04_HEX "a0907d"
  set -gx BASE16_COLOR_05_HEX "64513e"
  set -gx BASE16_COLOR_06_HEX "786653"
  set -gx BASE16_COLOR_07_HEX "8c7b68"
  set -gx BASE16_COLOR_08_HEX "d09700"
  set -gx BASE16_COLOR_09_HEX "64513e"
  set -gx BASE16_COLOR_0A_HEX "993333"
  set -gx BASE16_COLOR_0B_HEX "908d6a"
  set -gx BASE16_COLOR_0C_HEX "d09700"
  set -gx BASE16_COLOR_0D_HEX "bf7979"
  set -gx BASE16_COLOR_0E_HEX "9e5581"
  set -gx BASE16_COLOR_0F_HEX "75858c"
end
