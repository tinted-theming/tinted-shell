...
set -l color00 "fa/fb/fc" # Base 00 - Black
set -l color01 "d7/3a/49" # Base 08 - Red
set -l color02 "28/a7/45" # Base 0B - Green
set -l color03 "ff/d3/3d" # Base 0A - Yellow
set -l color04 "03/66/d6" # Base 0D - Blue
set -l color05 "ea/4a/aa" # Base 0E - Magenta
set -l color06 "79/b8/ff" # Base 0C - Cyan
set -l color07 "2f/36/3d" # Base 05 - White
set -l color08 "95/9d/a5" # Base 03 - Bright Black
...
set -l color15 "1b/1f/23" # Base 07 - Bright White
set -l color16 "f6/6a/0a" # Base 09
set -l color17 "a0/41/00" # Base 0F
set -l color18 "e1/e4/e8" # Base 01
set -l color19 "d1/d5/da" # Base 02
set -l color20 "44/4d/56" # Base 04
set -l color21 "24/29/2e" # Base 06
set -l color_foreground "2f/36/3d" # Base 05
set -l color_background "fa/fb/fc" # Base 00
...
set -U fish_color_end 2f363d
set -U fish_color_error brred
set -U fish_color_param 444d56
set -U fish_color_valid_path --underline
set -U fish_color_option brcyan
set -U fish_color_comment 959da5
set -U fish_color_selection 24292e --bold --background=d1d5da
set -U fish_color_operator brblue
set -U fish_color_escape brcyan
set -U fish_color_autosuggestion 959da5
...
set -U fish_pager_color_progress e1e4e8 --background=444d56
set -U fish_pager_color_background normal --background=fafbfc
set -U fish_pager_color_prefix normal --bold
set -U fish_pager_color_completion normal
set -U fish_pager_color_description f66a0a --dim
set -U fish_pager_color_selected_background 24292e --background=d1d5da
set -U fish_pager_color_selected_prefix 24292e --bold --background=d1d5da
set -U fish_pager_color_selected_completion 24292e
...
# Set theme
set -Ux BASE16_THEME primer-light

# Optionally export variables
if test -n "$TINTED_SHELL_ENABLE_BASE16_VARS"; or test -n "$BASE16_SHELL_ENABLE_VARS"
  set -gx BASE16_COLOR_00_HEX "fafbfc"
  set -gx BASE16_COLOR_01_HEX "e1e4e8"
  set -gx BASE16_COLOR_02_HEX "d1d5da"
  set -gx BASE16_COLOR_03_HEX "959da5"
  set -gx BASE16_COLOR_04_HEX "444d56"
  set -gx BASE16_COLOR_05_HEX "2f363d"
  set -gx BASE16_COLOR_06_HEX "24292e"
  set -gx BASE16_COLOR_07_HEX "1b1f23"
  set -gx BASE16_COLOR_08_HEX "d73a49"
  set -gx BASE16_COLOR_09_HEX "f66a0a"
  set -gx BASE16_COLOR_0A_HEX "ffd33d"
  set -gx BASE16_COLOR_0B_HEX "28a745"
  set -gx BASE16_COLOR_0C_HEX "79b8ff"
  set -gx BASE16_COLOR_0D_HEX "0366d6"
  set -gx BASE16_COLOR_0E_HEX "ea4aaa"
  set -gx BASE16_COLOR_0F_HEX "a04100"
end
