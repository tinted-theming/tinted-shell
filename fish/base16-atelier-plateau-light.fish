...
set -l color00 "f4/ec/ec" # Base 00 - Black
...
set -l color07 "58/50/50" # Base 05 - White
set -l color08 "7e/77/77" # Base 03 - Bright Black
...
set -l color15 "1b/18/18" # Base 07 - Bright White
set -l color16 "b4/5a/3c" # Base 09
set -l color17 "bd/51/87" # Base 0F
set -l color18 "e7/df/df" # Base 01
set -l color19 "8a/85/85" # Base 02
set -l color20 "65/5d/5d" # Base 04
set -l color21 "29/24/24" # Base 06
set -l color_foreground "58/50/50" # Base 05
set -l color_background "f4/ec/ec" # Base 00
...
set -U fish_color_end 585050
set -U fish_color_error brred
set -U fish_color_param 655d5d
set -U fish_color_valid_path --underline
set -U fish_color_option brcyan
set -U fish_color_comment 7e7777
set -U fish_color_selection 292424 --bold --background=8a8585
set -U fish_color_operator brblue
set -U fish_color_escape brcyan
set -U fish_color_autosuggestion 7e7777
...
set -U fish_pager_color_progress e7dfdf --background=655d5d
set -U fish_pager_color_background normal --background=f4ecec
set -U fish_pager_color_prefix normal --bold
set -U fish_pager_color_completion normal
set -U fish_pager_color_description b45a3c --dim
set -U fish_pager_color_selected_background 292424 --background=8a8585
set -U fish_pager_color_selected_prefix 292424 --bold --background=8a8585
set -U fish_pager_color_selected_completion 292424
...
# Set theme
set -Ux BASE16_THEME atelier-plateau-light

# Optionally export variables
if test -n "$TINTED_SHELL_ENABLE_BASE16_VARS"; or test -n "$BASE16_SHELL_ENABLE_VARS"
  set -gx BASE16_COLOR_00_HEX "f4ecec"
  set -gx BASE16_COLOR_01_HEX "e7dfdf"
  set -gx BASE16_COLOR_02_HEX "8a8585"
  set -gx BASE16_COLOR_03_HEX "7e7777"
  set -gx BASE16_COLOR_04_HEX "655d5d"
  set -gx BASE16_COLOR_05_HEX "585050"
  set -gx BASE16_COLOR_06_HEX "292424"
  set -gx BASE16_COLOR_07_HEX "1b1818"
