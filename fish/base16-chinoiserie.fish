...
set -l color01 "c0/48/51" # Base 08 - Red
set -l color02 "42/86/75" # Base 0B - Green
set -l color03 "d6/a0/1d" # Base 0A - Yellow
set -l color04 "81/5c/94" # Base 0D - Blue
set -l color05 "c0/8e/af" # Base 0E - Magenta
set -l color06 "2b/73/af" # Base 0C - Cyan
set -l color07 "4a/40/35" # Base 05 - White
set -l color08 "80/76/6e" # Base 03 - Bright Black
...
set -l color15 "13/11/24" # Base 07 - Bright White
set -l color16 "fb/8b/05" # Base 09
set -l color17 "94/58/33" # Base 0F
set -l color18 "e0/e0/e0" # Base 01
set -l color19 "d6/d6/d6" # Base 02
set -l color20 "91/80/72" # Base 04
set -l color21 "2f/2f/35" # Base 06
set -l color_foreground "4a/40/35" # Base 05
...
if test -n "$ITERM_SESSION_ID"
  put_template_custom Pg 4a4035 # foreground
  put_template_custom Ph ffffff # background
  put_template_custom Pi 4a4035 # bold color
  put_template_custom Pj d6d6d6 # selection color
  put_template_custom Pk 4a4035 # selected text color
  put_template_custom Pl 4a4035 # cursor
...
set -U fish_color_end 4a4035
set -U fish_color_error brred
set -U fish_color_param 918072
set -U fish_color_valid_path --underline
set -U fish_color_option brcyan
set -U fish_color_comment 80766e
set -U fish_color_selection 2f2f35 --bold --background=d6d6d6
set -U fish_color_operator brblue
set -U fish_color_escape brcyan
set -U fish_color_autosuggestion 80766e
...
set -U fish_pager_color_progress e0e0e0 --background=918072
set -U fish_pager_color_background normal --background=ffffff
set -U fish_pager_color_prefix normal --bold
set -U fish_pager_color_completion normal
set -U fish_pager_color_description fb8b05 --dim
set -U fish_pager_color_selected_background 2f2f35 --background=d6d6d6
set -U fish_pager_color_selected_prefix 2f2f35 --bold --background=d6d6d6
set -U fish_pager_color_selected_completion 2f2f35
...
# Set theme
set -Ux BASE16_THEME chinoiserie

# Optionally export variables
if test -n "$TINTED_SHELL_ENABLE_BASE16_VARS"; or test -n "$BASE16_SHELL_ENABLE_VARS"
  set -gx BASE16_COLOR_00_HEX "ffffff"
  set -gx BASE16_COLOR_01_HEX "e0e0e0"
  set -gx BASE16_COLOR_02_HEX "d6d6d6"
  set -gx BASE16_COLOR_03_HEX "80766e"
  set -gx BASE16_COLOR_04_HEX "918072"
  set -gx BASE16_COLOR_05_HEX "4a4035"
  set -gx BASE16_COLOR_06_HEX "2f2f35"
  set -gx BASE16_COLOR_07_HEX "131124"
  set -gx BASE16_COLOR_08_HEX "c04851"
  set -gx BASE16_COLOR_09_HEX "fb8b05"
  set -gx BASE16_COLOR_0A_HEX "d6a01d"
  set -gx BASE16_COLOR_0B_HEX "428675"
  set -gx BASE16_COLOR_0C_HEX "2b73af"
  set -gx BASE16_COLOR_0D_HEX "815c94"
  set -gx BASE16_COLOR_0E_HEX "c08eaf"
  set -gx BASE16_COLOR_0F_HEX "945833"
end
