...
set -l color00 "0a/09/20" # Base 00 - Black
set -l color01 "f7/68/a3" # Base 08 - Red
set -l color02 "a2/fa/a8" # Base 0B - Green
set -l color03 "f7/d6/68" # Base 0A - Yellow
set -l color04 "25/8f/c4" # Base 0D - Blue
set -l color05 "c3/68/f7" # Base 0E - Magenta
set -l color06 "a2/fa/f0" # Base 0C - Cyan
set -l color07 "60/6b/ac" # Base 05 - White
set -l color08 "33/37/73" # Base 03 - Bright Black
...
set -l color15 "9a/aa/e5" # Base 07 - Bright White
set -l color16 "f7/89/68" # Base 09
set -l color17 "b8/56/00" # Base 0F
set -l color18 "13/13/3a" # Base 01
set -l color19 "23/25/5a" # Base 02
set -l color20 "4a/52/93" # Base 04
set -l color21 "79/86/c5" # Base 06
set -l color_foreground "60/6b/ac" # Base 05
set -l color_background "0a/09/20" # Base 00
...
set -U fish_color_end 606bac
set -U fish_color_error brred
set -U fish_color_param 4a5293
set -U fish_color_valid_path --underline
set -U fish_color_option brcyan
set -U fish_color_comment 333773
set -U fish_color_selection 7986c5 --bold --background=23255a
set -U fish_color_operator brblue
set -U fish_color_escape brcyan
set -U fish_color_autosuggestion 333773
...
set -U fish_color_search_match bryellow --background=23255a
set -U fish_color_history_current --bold
set -U fish_pager_color_progress 13133a --background=4a5293
set -U fish_pager_color_background normal --background=0a0920
set -U fish_pager_color_prefix normal --bold
set -U fish_pager_color_completion normal
set -U fish_pager_color_description f78968 --dim
set -U fish_pager_color_selected_background 7986c5 --background=23255a
set -U fish_pager_color_selected_prefix 7986c5 --bold --background=23255a
set -U fish_pager_color_selected_completion 7986c5
...
# Set theme
set -Ux BASE16_THEME eris

# Optionally export variables
if test -n "$TINTED_SHELL_ENABLE_BASE16_VARS"; or test -n "$BASE16_SHELL_ENABLE_VARS"
  set -gx BASE16_COLOR_00_HEX "0a0920"
  set -gx BASE16_COLOR_01_HEX "13133a"
  set -gx BASE16_COLOR_02_HEX "23255a"
  set -gx BASE16_COLOR_03_HEX "333773"
  set -gx BASE16_COLOR_04_HEX "4a5293"
  set -gx BASE16_COLOR_05_HEX "606bac"
  set -gx BASE16_COLOR_06_HEX "7986c5"
  set -gx BASE16_COLOR_07_HEX "9aaae5"
  set -gx BASE16_COLOR_08_HEX "f768a3"
  set -gx BASE16_COLOR_09_HEX "f78968"
  set -gx BASE16_COLOR_0A_HEX "f7d668"
  set -gx BASE16_COLOR_0B_HEX "a2faa8"
  set -gx BASE16_COLOR_0C_HEX "a2faf0"
  set -gx BASE16_COLOR_0D_HEX "258fc4"
  set -gx BASE16_COLOR_0E_HEX "c368f7"
  set -gx BASE16_COLOR_0F_HEX "b85600"
end
