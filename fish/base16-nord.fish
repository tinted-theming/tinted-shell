...
set -l color00 "2e/34/40" # Base 00 - Black
set -l color01 "bf/61/6a" # Base 08 - Red
set -l color02 "a3/be/8c" # Base 0B - Green
set -l color03 "eb/cb/8b" # Base 0A - Yellow
set -l color04 "81/a1/c1" # Base 0D - Blue
set -l color05 "b4/8e/ad" # Base 0E - Magenta
set -l color06 "88/c0/d0" # Base 0C - Cyan
set -l color07 "e5/e9/f0" # Base 05 - White
set -l color08 "4c/56/6a" # Base 03 - Bright Black
...
set -l color15 "8f/bc/bb" # Base 07 - Bright White
set -l color16 "d0/87/70" # Base 09
set -l color17 "5e/81/ac" # Base 0F
set -l color18 "3b/42/52" # Base 01
set -l color19 "43/4c/5e" # Base 02
set -l color20 "d8/de/e9" # Base 04
set -l color21 "ec/ef/f4" # Base 06
set -l color_foreground "e5/e9/f0" # Base 05
set -l color_background "2e/34/40" # Base 00
...
set -U fish_color_selection eceff4 --bold --background=434c5e
...
set -U fish_pager_color_progress 3b4252 --background=d8dee9
set -U fish_pager_color_background normal --background=2e3440
set -U fish_pager_color_prefix normal --bold
set -U fish_pager_color_completion normal
set -U fish_pager_color_description d08770 --dim
set -U fish_pager_color_selected_background eceff4 --background=434c5e
set -U fish_pager_color_selected_prefix eceff4 --bold --background=434c5e
set -U fish_pager_color_selected_completion eceff4
...
# Set theme
set -Ux BASE16_THEME nord

# Optionally export variables
if test -n "$TINTED_SHELL_ENABLE_BASE16_VARS"; or test -n "$BASE16_SHELL_ENABLE_VARS"
  set -gx BASE16_COLOR_00_HEX "2e3440"
  set -gx BASE16_COLOR_01_HEX "3b4252"
  set -gx BASE16_COLOR_02_HEX "434c5e"
  set -gx BASE16_COLOR_03_HEX "4c566a"
  set -gx BASE16_COLOR_04_HEX "d8dee9"
  set -gx BASE16_COLOR_05_HEX "e5e9f0"
  set -gx BASE16_COLOR_06_HEX "eceff4"
  set -gx BASE16_COLOR_07_HEX "8fbcbb"
  set -gx BASE16_COLOR_08_HEX "bf616a"
  set -gx BASE16_COLOR_09_HEX "d08770"
  set -gx BASE16_COLOR_0A_HEX "ebcb8b"
  set -gx BASE16_COLOR_0B_HEX "a3be8c"
  set -gx BASE16_COLOR_0C_HEX "88c0d0"
  set -gx BASE16_COLOR_0D_HEX "81a1c1"
  set -gx BASE16_COLOR_0E_HEX "b48ead"
  set -gx BASE16_COLOR_0F_HEX "5e81ac"
end
