...
set -l color00 "ef/ec/f4" # Base 00 - Black
...
set -l color07 "58/52/60" # Base 05 - White
set -l color08 "7e/78/87" # Base 03 - Bright Black
...
set -l color15 "19/17/1c" # Base 07 - Bright White
set -l color16 "aa/57/3c" # Base 09
set -l color17 "bf/40/bf" # Base 0F
set -l color18 "e2/df/e7" # Base 01
set -l color19 "8b/87/92" # Base 02
set -l color20 "65/5f/6d" # Base 04
set -l color21 "26/23/2a" # Base 06
set -l color_foreground "58/52/60" # Base 05
set -l color_background "ef/ec/f4" # Base 00
...
set -U fish_color_end 585260
set -U fish_color_error brred
set -U fish_color_param 655f6d
set -U fish_color_valid_path --underline
set -U fish_color_option brcyan
set -U fish_color_comment 7e7887
set -U fish_color_selection 26232a --bold --background=8b8792
set -U fish_color_operator brblue
set -U fish_color_escape brcyan
set -U fish_color_autosuggestion 7e7887
...
set -U fish_pager_color_progress e2dfe7 --background=655f6d
set -U fish_pager_color_background normal --background=efecf4
set -U fish_pager_color_prefix normal --bold
set -U fish_pager_color_completion normal
set -U fish_pager_color_description aa573c --dim
set -U fish_pager_color_selected_background 26232a --background=8b8792
set -U fish_pager_color_selected_prefix 26232a --bold --background=8b8792
set -U fish_pager_color_selected_completion 26232a
...
# Set theme
set -Ux BASE16_THEME atelier-cave-light

# Optionally export variables
if test -n "$TINTED_SHELL_ENABLE_BASE16_VARS"; or test -n "$BASE16_SHELL_ENABLE_VARS"
  set -gx BASE16_COLOR_00_HEX "efecf4"
  set -gx BASE16_COLOR_01_HEX "e2dfe7"
  set -gx BASE16_COLOR_02_HEX "8b8792"
  set -gx BASE16_COLOR_03_HEX "7e7887"
  set -gx BASE16_COLOR_04_HEX "655f6d"
  set -gx BASE16_COLOR_05_HEX "585260"
  set -gx BASE16_COLOR_06_HEX "26232a"
  set -gx BASE16_COLOR_07_HEX "19171c"
