...
set -U fish_color_selection 000000 --background=dddee8
set -U fish_color_operator magenta
set -U fish_color_escape d44d16
...
set -U fish_color_search_match yellow --background=dddee8
set -U fish_color_history_current --underline=curly
set -U fish_pager_color_progress cbccd4 --background=6f6f74
set -U fish_pager_color_background --background=f7f7f7
set -U fish_pager_color_prefix --bold --italics
set -U fish_pager_color_completion normal
set -U fish_pager_color_description d44d16
set -U fish_pager_color_selected_background --background=dddee8
set -U fish_pager_color_selected_prefix --bold --italics --background=dddee8
