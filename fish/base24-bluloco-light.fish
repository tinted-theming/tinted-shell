...
set -l color00 "f7/f7/f7" # Base 00 - Black
set -l color01 "c8/0d/41" # Base 08 - Red
set -l color02 "20/88/39" # Base 0B - Green
set -l color03 "10/85/d9" # Base 0A - Yellow
set -l color04 "1d/44/dd" # Base 0D - Blue
set -l color05 "6d/1b/ed" # Base 0E - Magenta
set -l color06 "1e/4d/7a" # Base 0C - Cyan
set -l color07 "38/38/3a" # Base 05 - White
set -l color08 "a6/a7/ae" # Base 03 - Bright Black
...
set -l color15 "1c/1d/21" # Base 07 - Bright White
set -l color16 "d4/4d/16" # Base 09
set -l color17 "64/06/20" # Base 0F
set -l color18 "cb/cc/d4" # Base 01
set -l color19 "dd/de/e8" # Base 02
set -l color20 "6f/6f/74" # Base 04
set -l color21 "00/00/00" # Base 06
set -l color_foreground "38/38/3a" # Base 05
set -l color_background "f7/f7/f7" # Base 00
...
set -U fish_color_end 38383a
set -U fish_color_error brred
set -U fish_color_param 6f6f74
set -U fish_color_valid_path --underline
set -U fish_color_option brcyan
set -U fish_color_comment a6a7ae
set -U fish_color_selection 000000 --bold --background=dddee8
set -U fish_color_operator brblue
set -U fish_color_escape brcyan
set -U fish_color_autosuggestion a6a7ae
...
set -U fish_color_search_match bryellow --background=dddee8
set -U fish_color_history_current --bold
set -U fish_pager_color_progress cbccd4 --background=6f6f74
set -U fish_pager_color_background normal --background=f7f7f7
set -U fish_pager_color_prefix normal --bold
set -U fish_pager_color_completion normal
set -U fish_pager_color_description d44d16 --dim
set -U fish_pager_color_selected_background 000000 --background=dddee8
set -U fish_pager_color_selected_prefix 000000 --bold --background=dddee8
...
# Set theme
set -Ux BASE24_THEME bluloco-light

# Optionally export variables
if test -n "$TINTED_SHELL_ENABLE_BASE24_VARS"; or test -n "$BASE24_SHELL_ENABLE_VARS"
  set -gx BASE24_COLOR_00_HEX "f7f7f7"
  set -gx BASE24_COLOR_01_HEX "cbccd4"
  set -gx BASE24_COLOR_02_HEX "dddee8"
  set -gx BASE24_COLOR_03_HEX "a6a7ae"
  set -gx BASE24_COLOR_04_HEX "6f6f74"
  set -gx BASE24_COLOR_05_HEX "38383a"
  set -gx BASE24_COLOR_06_HEX "000000"
  set -gx BASE24_COLOR_07_HEX "1c1d21"
  set -gx BASE24_COLOR_08_HEX "c80d41"
  set -gx BASE24_COLOR_09_HEX "d44d16"
  set -gx BASE24_COLOR_0A_HEX "1085d9"
  set -gx BASE24_COLOR_0B_HEX "208839"
  set -gx BASE24_COLOR_0C_HEX "1e4d7a"
  set -gx BASE24_COLOR_0D_HEX "1d44dd"
  set -gx BASE24_COLOR_0E_HEX "6d1bed"
  set -gx BASE24_COLOR_0F_HEX "640620"
end
