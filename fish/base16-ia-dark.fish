...
set -l color01 "d8/85/68" # Base 08 - Red
set -l color02 "83/a4/71" # Base 0B - Green
set -l color03 "b9/93/53" # Base 0A - Yellow
set -l color04 "8e/cc/dd" # Base 0D - Blue
set -l color05 "b9/8e/b2" # Base 0E - Magenta
set -l color06 "7c/9c/ae" # Base 0C - Cyan
set -l color07 "cc/cc/cc" # Base 05 - White
...
set -l color16 "d8/68/68" # Base 09
set -l color17 "8b/6c/37" # Base 0F
set -l color18 "22/22/22" # Base 01
set -l color19 "1d/41/4d" # Base 02
set -l color20 "b8/b8/b8" # Base 04
set -l color21 "e8/e8/e8" # Base 06
set -l color_foreground "cc/cc/cc" # Base 05
...
set -U fish_pager_color_progress 222222 --background=b8b8b8
set -U fish_pager_color_background normal --background=1a1a1a
set -U fish_pager_color_prefix normal --bold
set -U fish_pager_color_completion normal
set -U fish_pager_color_description d86868 --dim
set -U fish_pager_color_selected_background e8e8e8 --background=1d414d
set -U fish_pager_color_selected_prefix e8e8e8 --bold --background=1d414d
...
# Set theme
set -Ux BASE16_THEME ia-dark

# Optionally export variables
if test -n "$TINTED_SHELL_ENABLE_BASE16_VARS"; or test -n "$BASE16_SHELL_ENABLE_VARS"
  set -gx BASE16_COLOR_00_HEX "1a1a1a"
  set -gx BASE16_COLOR_01_HEX "222222"
  set -gx BASE16_COLOR_02_HEX "1d414d"
  set -gx BASE16_COLOR_03_HEX "767676"
  set -gx BASE16_COLOR_04_HEX "b8b8b8"
  set -gx BASE16_COLOR_05_HEX "cccccc"
  set -gx BASE16_COLOR_06_HEX "e8e8e8"
  set -gx BASE16_COLOR_07_HEX "f8f8f8"
  set -gx BASE16_COLOR_08_HEX "d88568"
  set -gx BASE16_COLOR_09_HEX "d86868"
  set -gx BASE16_COLOR_0A_HEX "b99353"
  set -gx BASE16_COLOR_0B_HEX "83a471"
  set -gx BASE16_COLOR_0C_HEX "7c9cae"
  set -gx BASE16_COLOR_0D_HEX "8eccdd"
  set -gx BASE16_COLOR_0E_HEX "b98eb2"
