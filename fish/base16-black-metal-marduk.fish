...
set -l color02 "a5/aa/a7" # Base 0B - Green
set -l color03 "62/6b/67" # Base 0A - Yellow
...
# Set theme
set -Ux BASE16_THEME black-metal-marduk
...
if test -n "$TINTED_SHELL_ENABLE_BASE16_VARS"; or test -n "$BASE16_SHELL_ENABLE_VARS"
  ...
  set -gx BASE16_COLOR_0A_HEX "626b67"
  set -gx BASE16_COLOR_0B_HEX "a5aaa7"
