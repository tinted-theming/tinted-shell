...
set -l color00 "26/24/27" # Base 00 - Black
set -l color01 "ff/72/72" # Base 08 - Red
set -l color02 "bc/df/59" # Base 0B - Green
set -l color03 "ff/ca/58" # Base 0A - Yellow
set -l color04 "49/ca/e4" # Base 0D - Blue
set -l color05 "a0/93/e2" # Base 0E - Magenta
set -l color06 "ae/e8/f4" # Base 0C - Cyan
set -l color07 "fc/fc/fc" # Base 05 - White
set -l color08 "67/65/67" # Base 03 - Bright Black
...
set -l color15 "fc/fc/fc" # Base 07 - Bright White
set -l color16 "fc/9d/6f" # Base 09
set -l color17 "ff/87/87" # Base 0F
set -l color18 "3b/39/3c" # Base 01
set -l color19 "51/4f/52" # Base 02
set -l color20 "7c/7b/7d" # Base 04
set -l color21 "ea/e9/eb" # Base 06
set -l color_foreground "fc/fc/fc" # Base 05
set -l color_background "26/24/27" # Base 00
...
set -U fish_color_end fcfcfc
set -U fish_color_error brred
set -U fish_color_param 7c7b7d
set -U fish_color_valid_path --underline
set -U fish_color_option brcyan
set -U fish_color_comment 676567
set -U fish_color_selection eae9eb --bold --background=514f52
set -U fish_color_operator brblue
set -U fish_color_escape brcyan
set -U fish_color_autosuggestion 676567
...
set -U fish_color_search_match bryellow --background=514f52
set -U fish_color_history_current --bold
set -U fish_pager_color_progress 3b393c --background=7c7b7d
set -U fish_pager_color_background normal --background=262427
set -U fish_pager_color_prefix normal --bold
set -U fish_pager_color_completion normal
set -U fish_pager_color_description fc9d6f --dim
set -U fish_pager_color_selected_background eae9eb --background=514f52
set -U fish_pager_color_selected_prefix eae9eb --bold --background=514f52
set -U fish_pager_color_selected_completion eae9eb
...
# Set theme
set -Ux BASE16_THEME 0x96f

# Optionally export variables
if test -n "$TINTED_SHELL_ENABLE_BASE16_VARS"; or test -n "$BASE16_SHELL_ENABLE_VARS"
  set -gx BASE16_COLOR_00_HEX "262427"
  set -gx BASE16_COLOR_01_HEX "3b393c"
  set -gx BASE16_COLOR_02_HEX "514f52"
  set -gx BASE16_COLOR_03_HEX "676567"
  set -gx BASE16_COLOR_04_HEX "7c7b7d"
  set -gx BASE16_COLOR_05_HEX "fcfcfc"
  set -gx BASE16_COLOR_06_HEX "eae9eb"
  set -gx BASE16_COLOR_07_HEX "fcfcfc"
  set -gx BASE16_COLOR_08_HEX "ff7272"
  set -gx BASE16_COLOR_09_HEX "fc9d6f"
  set -gx BASE16_COLOR_0A_HEX "ffca58"
  set -gx BASE16_COLOR_0B_HEX "bcdf59"
  set -gx BASE16_COLOR_0C_HEX "aee8f4"
  set -gx BASE16_COLOR_0D_HEX "49cae4"
  set -gx BASE16_COLOR_0E_HEX "a093e2"
  set -gx BASE16_COLOR_0F_HEX "ff8787"
end
