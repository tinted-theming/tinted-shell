...
set -l color19 "38/38/38" # Base 02
...
set -U fish_color_selection e8e8e8 --bold --background=383838
...
set -U fish_pager_color_progress 282828 --background=b8b8b8
...
set -U fish_pager_color_selected_background e8e8e8 --background=383838
set -U fish_pager_color_selected_prefix e8e8e8 --bold --background=383838
...
# Set theme
set -Ux BASE16_THEME default-dark
...
if test -n "$TINTED_SHELL_ENABLE_BASE16_VARS"; or test -n "$BASE16_SHELL_ENABLE_VARS"
  ...
  set -gx BASE16_COLOR_02_HEX "383838"
