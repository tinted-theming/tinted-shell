...
set -l color00 "17/19/1e" # Base 00 - Black
set -l color01 "ff/29/a8" # Base 08 - Red
set -l color02 "0b/ad/ff" # Base 0B - Green
set -l color03 "f0/ff/aa" # Base 0A - Yellow
set -l color04 "00/ea/ff" # Base 0D - Blue
set -l color05 "00/f6/d9" # Base 0E - Magenta
set -l color06 "82/65/ff" # Base 0C - Cyan
set -l color07 "8b/9c/be" # Base 05 - White
set -l color08 "38/3a/47" # Base 03 - Bright Black
...
set -l color15 "f4/f4/f7" # Base 07 - Bright White
set -l color16 "85/ff/e0" # Base 09
set -l color17 "ff/3d/81" # Base 0F
set -l color18 "22/26/2d" # Base 01
set -l color19 "3c/3f/4c" # Base 02
set -l color20 "55/5e/70" # Base 04
set -l color21 "b2/bf/d9" # Base 06
set -l color_foreground "8b/9c/be" # Base 05
set -l color_background "17/19/1e" # Base 00
...
set -U fish_color_end 8b9cbe
set -U fish_color_error brred
set -U fish_color_param 555e70
set -U fish_color_valid_path --underline
set -U fish_color_option brcyan
set -U fish_color_comment 383a47
set -U fish_color_selection b2bfd9 --bold --background=3c3f4c
set -U fish_color_operator brblue
set -U fish_color_escape brcyan
set -U fish_color_autosuggestion 383a47
...
set -U fish_color_search_match bryellow --background=3c3f4c
set -U fish_color_history_current --bold
set -U fish_pager_color_progress 22262d --background=555e70
set -U fish_pager_color_background normal --background=17191e
set -U fish_pager_color_prefix normal --bold
set -U fish_pager_color_completion normal
set -U fish_pager_color_description 85ffe0 --dim
set -U fish_pager_color_selected_background b2bfd9 --background=3c3f4c
set -U fish_pager_color_selected_prefix b2bfd9 --bold --background=3c3f4c
set -U fish_pager_color_selected_completion b2bfd9
...
# Set theme
set -Ux BASE16_THEME vice

# Optionally export variables
if test -n "$TINTED_SHELL_ENABLE_BASE16_VARS"; or test -n "$BASE16_SHELL_ENABLE_VARS"
  set -gx BASE16_COLOR_00_HEX "17191e"
  set -gx BASE16_COLOR_01_HEX "22262d"
  set -gx BASE16_COLOR_02_HEX "3c3f4c"
  set -gx BASE16_COLOR_03_HEX "383a47"
  set -gx BASE16_COLOR_04_HEX "555e70"
  set -gx BASE16_COLOR_05_HEX "8b9cbe"
  set -gx BASE16_COLOR_06_HEX "b2bfd9"
  set -gx BASE16_COLOR_07_HEX "f4f4f7"
  set -gx BASE16_COLOR_08_HEX "ff29a8"
  set -gx BASE16_COLOR_09_HEX "85ffe0"
  set -gx BASE16_COLOR_0A_HEX "f0ffaa"
  set -gx BASE16_COLOR_0B_HEX "0badff"
  set -gx BASE16_COLOR_0C_HEX "8265ff"
  set -gx BASE16_COLOR_0D_HEX "00eaff"
  set -gx BASE16_COLOR_0E_HEX "00f6d9"
  set -gx BASE16_COLOR_0F_HEX "ff3d81"
end
