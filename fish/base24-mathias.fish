...
set -l color01 "e5/22/22" # Base 08 - Red
set -l color02 "a6/e3/2d" # Base 0B - Green
set -l color03 "55/55/ff" # Base 0A - Yellow
set -l color04 "c4/8d/ff" # Base 0D - Blue
set -l color05 "fa/25/73" # Base 0E - Magenta
set -l color06 "67/d9/f0" # Base 0C - Cyan
...
set -l color16 "fc/95/1e" # Base 09
set -l color17 "72/11/11" # Base 0F
set -l color18 "00/00/00" # Base 01
set -l color19 "55/55/55" # Base 02
set -l color20 "a3/a3/a3" # Base 04
...
set -U fish_color_param a3a3a3
set -U fish_color_valid_path --underline
set -U fish_color_option brcyan
set -U fish_color_comment 7c7c7c
set -U fish_color_selection f2f2f2 --bold --background=555555
...
set -U fish_pager_color_progress 000000 --background=a3a3a3
set -U fish_pager_color_background normal --background=000000
set -U fish_pager_color_prefix normal --bold
set -U fish_pager_color_completion normal
set -U fish_pager_color_description fc951e --dim
set -U fish_pager_color_selected_background f2f2f2 --background=555555
set -U fish_pager_color_selected_prefix f2f2f2 --bold --background=555555
...
if test -n "$TINTED_SHELL_ENABLE_BASE24_VARS"; or test -n "$BASE24_SHELL_ENABLE_VARS"
  ...
  set -gx BASE24_COLOR_04_HEX "a3a3a3"
  set -gx BASE24_COLOR_05_HEX "cacaca"
  set -gx BASE24_COLOR_06_HEX "f2f2f2"
  set -gx BASE24_COLOR_07_HEX "ffffff"
  set -gx BASE24_COLOR_08_HEX "e52222"
  set -gx BASE24_COLOR_09_HEX "fc951e"
  set -gx BASE24_COLOR_0A_HEX "5555ff"
  set -gx BASE24_COLOR_0B_HEX "a6e32d"
  set -gx BASE24_COLOR_0C_HEX "67d9f0"
  set -gx BASE24_COLOR_0D_HEX "c48dff"
  set -gx BASE24_COLOR_0E_HEX "fa2573"
  set -gx BASE24_COLOR_0F_HEX "721111"
end
