...
set -l color16 "f9/a9/59" # Base 09
set -l color17 "f9/73/94" # Base 0F
...
set -U fish_color_selection e0e0e0 --bold --background=515151
...
set -U fish_pager_color_progress 393939 --background=b4b7b4
set -U fish_pager_color_background normal --background=2d2d2d
set -U fish_pager_color_prefix normal --bold
set -U fish_pager_color_completion normal
set -U fish_pager_color_description f9a959 --dim
set -U fish_pager_color_selected_background e0e0e0 --background=515151
set -U fish_pager_color_selected_prefix e0e0e0 --bold --background=515151
...
if test -n "$TINTED_SHELL_ENABLE_BASE16_VARS"; or test -n "$BASE16_SHELL_ENABLE_VARS"
  ...
  set -gx BASE16_COLOR_04_HEX "b4b7b4"
  set -gx BASE16_COLOR_05_HEX "cccccc"
  set -gx BASE16_COLOR_06_HEX "e0e0e0"
  set -gx BASE16_COLOR_07_HEX "ffffff"
  set -gx BASE16_COLOR_08_HEX "d25252"
  set -gx BASE16_COLOR_09_HEX "f9a959"
  set -gx BASE16_COLOR_0A_HEX "ffc66d"
  set -gx BASE16_COLOR_0B_HEX "a5c261"
  set -gx BASE16_COLOR_0C_HEX "bed6ff"
  set -gx BASE16_COLOR_0D_HEX "6c99bb"
  set -gx BASE16_COLOR_0E_HEX "d197d9"
  set -gx BASE16_COLOR_0F_HEX "f97394"
end
