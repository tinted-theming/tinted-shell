...
set -U fish_pager_color_background normal --background=103c48
set -U fish_pager_color_prefix normal --bold
set -U fish_pager_color_completion normal
set -U fish_pager_color_description ed8649 --dim
set -U fish_pager_color_selected_background cad8d9 --background=2d5b69
set -U fish_pager_color_selected_prefix cad8d9 --bold --background=2d5b69
set -U fish_pager_color_selected_completion cad8d9
