...
set -l color00 "14/1f/2e" # Base 00 - Black
set -l color01 "ff/fa/b1" # Base 08 - Red
set -l color02 "80/ff/80" # Base 0B - Green
set -l color03 "91/cc/ff" # Base 0A - Yellow
set -l color04 "a2/cf/f5" # Base 0D - Blue
set -l color05 "00/99/ff" # Base 0E - Magenta
set -l color06 "80/ff/80" # Base 0C - Cyan
set -l color07 "ff/cc/33" # Base 05 - White
set -l color08 "a0/ff/a0" # Base 03 - Bright Black
...
set -l color15 "37/57/80" # Base 07 - Bright White
set -l color16 "ff/80/80" # Base 09
set -l color17 "e7/e7/e7" # Base 0F
set -l color18 "1e/5c/1e" # Base 01
set -l color19 "27/3e/5c" # Base 02
set -l color20 "1e/5c/1e" # Base 04
set -l color21 "91/cc/ff" # Base 06
set -l color_foreground "ff/cc/33" # Base 05
set -l color_background "14/1f/2e" # Base 00
...
set -U fish_color_end ffcc33
set -U fish_color_error brred
set -U fish_color_param 1e5c1e
set -U fish_color_valid_path --underline
set -U fish_color_option brcyan
set -U fish_color_comment a0ffa0
set -U fish_color_selection 91ccff --bold --background=273e5c
set -U fish_color_operator brblue
set -U fish_color_escape brcyan
set -U fish_color_autosuggestion a0ffa0
...
set -U fish_color_search_match bryellow --background=273e5c
set -U fish_color_history_current --bold
set -U fish_pager_color_progress 1e5c1e --background=1e5c1e
set -U fish_pager_color_background normal --background=141f2e
set -U fish_pager_color_prefix normal --bold
set -U fish_pager_color_completion normal
set -U fish_pager_color_description ff8080 --dim
set -U fish_pager_color_selected_background 91ccff --background=273e5c
set -U fish_pager_color_selected_prefix 91ccff --bold --background=273e5c
set -U fish_pager_color_selected_completion 91ccff
...
# Set theme
set -Ux BASE16_THEME blueforest

# Optionally export variables
if test -n "$TINTED_SHELL_ENABLE_BASE16_VARS"; or test -n "$BASE16_SHELL_ENABLE_VARS"
  set -gx BASE16_COLOR_00_HEX "141f2e"
  set -gx BASE16_COLOR_01_HEX "1e5c1e"
  set -gx BASE16_COLOR_02_HEX "273e5c"
  set -gx BASE16_COLOR_03_HEX "a0ffa0"
  set -gx BASE16_COLOR_04_HEX "1e5c1e"
  set -gx BASE16_COLOR_05_HEX "ffcc33"
  set -gx BASE16_COLOR_06_HEX "91ccff"
  set -gx BASE16_COLOR_07_HEX "375780"
  set -gx BASE16_COLOR_08_HEX "fffab1"
  set -gx BASE16_COLOR_09_HEX "ff8080"
  set -gx BASE16_COLOR_0A_HEX "91ccff"
  set -gx BASE16_COLOR_0B_HEX "80ff80"
  set -gx BASE16_COLOR_0C_HEX "80ff80"
  set -gx BASE16_COLOR_0D_HEX "a2cff5"
  set -gx BASE16_COLOR_0E_HEX "0099ff"
  set -gx BASE16_COLOR_0F_HEX "e7e7e7"
end
