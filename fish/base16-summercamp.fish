...
set -l color00 "1c/18/10" # Base 00 - Black
set -l color01 "e3/51/42" # Base 08 - Red
set -l color02 "5c/eb/5a" # Base 0B - Green
set -l color03 "f2/ff/27" # Base 0A - Yellow
set -l color04 "48/9b/f0" # Base 0D - Blue
set -l color05 "ff/80/80" # Base 0E - Magenta
set -l color06 "5a/eb/bc" # Base 0C - Cyan
set -l color07 "73/6e/55" # Base 05 - White
set -l color08 "50/4b/38" # Base 03 - Bright Black
...
set -l color15 "f8/f5/de" # Base 07 - Bright White
set -l color16 "fb/a1/1b" # Base 09
set -l color17 "f6/9b/e7" # Base 0F
set -l color18 "2a/26/1c" # Base 01
set -l color19 "3a/35/27" # Base 02
set -l color20 "5f/5b/45" # Base 04
set -l color21 "ba/b6/96" # Base 06
set -l color_foreground "73/6e/55" # Base 05
set -l color_background "1c/18/10" # Base 00
...
set -U fish_color_end 736e55
set -U fish_color_error brred
set -U fish_color_param 5f5b45
set -U fish_color_valid_path --underline
set -U fish_color_option brcyan
set -U fish_color_comment 504b38
set -U fish_color_selection bab696 --bold --background=3a3527
set -U fish_color_operator brblue
set -U fish_color_escape brcyan
set -U fish_color_autosuggestion 504b38
...
set -U fish_pager_color_progress 2a261c --background=5f5b45
set -U fish_pager_color_background normal --background=1c1810
set -U fish_pager_color_prefix normal --bold
set -U fish_pager_color_completion normal
set -U fish_pager_color_description fba11b --dim
set -U fish_pager_color_selected_background bab696 --background=3a3527
set -U fish_pager_color_selected_prefix bab696 --bold --background=3a3527
set -U fish_pager_color_selected_completion bab696
...
# Set theme
set -Ux BASE16_THEME summercamp

# Optionally export variables
if test -n "$TINTED_SHELL_ENABLE_BASE16_VARS"; or test -n "$BASE16_SHELL_ENABLE_VARS"
  set -gx BASE16_COLOR_00_HEX "1c1810"
  set -gx BASE16_COLOR_01_HEX "2a261c"
  set -gx BASE16_COLOR_02_HEX "3a3527"
  set -gx BASE16_COLOR_03_HEX "504b38"
  set -gx BASE16_COLOR_04_HEX "5f5b45"
  set -gx BASE16_COLOR_05_HEX "736e55"
  set -gx BASE16_COLOR_06_HEX "bab696"
  set -gx BASE16_COLOR_07_HEX "f8f5de"
  set -gx BASE16_COLOR_08_HEX "e35142"
  set -gx BASE16_COLOR_09_HEX "fba11b"
  set -gx BASE16_COLOR_0A_HEX "f2ff27"
  set -gx BASE16_COLOR_0B_HEX "5ceb5a"
  set -gx BASE16_COLOR_0C_HEX "5aebbc"
  set -gx BASE16_COLOR_0D_HEX "489bf0"
  set -gx BASE16_COLOR_0E_HEX "ff8080"
  set -gx BASE16_COLOR_0F_HEX "f69be7"
end
