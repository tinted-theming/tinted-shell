...
set -l color00 "26/32/38" # Base 00 - Black
set -l color01 "f0/71/78" # Base 08 - Red
set -l color02 "c3/e8/8d" # Base 0B - Green
set -l color03 "ff/cb/6b" # Base 0A - Yellow
set -l color04 "82/aa/ff" # Base 0D - Blue
set -l color05 "c7/92/ea" # Base 0E - Magenta
set -l color06 "89/dd/ff" # Base 0C - Cyan
set -l color07 "ee/ff/ff" # Base 05 - White
set -l color08 "54/6e/7a" # Base 03 - Bright Black
...
set -l color18 "2e/3c/43" # Base 01
set -l color19 "31/45/49" # Base 02
set -l color20 "b2/cc/d6" # Base 04
set -l color21 "ee/ff/ff" # Base 06
set -l color_foreground "ee/ff/ff" # Base 05
set -l color_background "26/32/38" # Base 00
...
set -U fish_color_end eeffff
set -U fish_color_error brred
set -U fish_color_param b2ccd6
set -U fish_color_valid_path --underline
set -U fish_color_option brcyan
set -U fish_color_comment 546e7a
set -U fish_color_selection eeffff --bold --background=314549
set -U fish_color_operator brblue
set -U fish_color_escape brcyan
set -U fish_color_autosuggestion 546e7a
...
set -U fish_pager_color_progress 2e3c43 --background=b2ccd6
set -U fish_pager_color_background normal --background=263238
set -U fish_pager_color_prefix normal --bold
set -U fish_pager_color_completion normal
set -U fish_pager_color_description f78c6c --dim
set -U fish_pager_color_selected_background eeffff --background=314549
set -U fish_pager_color_selected_prefix eeffff --bold --background=314549
set -U fish_pager_color_selected_completion eeffff
...
# Set theme
set -Ux BASE16_THEME material

# Optionally export variables
if test -n "$TINTED_SHELL_ENABLE_BASE16_VARS"; or test -n "$BASE16_SHELL_ENABLE_VARS"
  set -gx BASE16_COLOR_00_HEX "263238"
  set -gx BASE16_COLOR_01_HEX "2e3c43"
  set -gx BASE16_COLOR_02_HEX "314549"
  set -gx BASE16_COLOR_03_HEX "546e7a"
  set -gx BASE16_COLOR_04_HEX "b2ccd6"
  set -gx BASE16_COLOR_05_HEX "eeffff"
  set -gx BASE16_COLOR_06_HEX "eeffff"
  set -gx BASE16_COLOR_07_HEX "ffffff"
  set -gx BASE16_COLOR_08_HEX "f07178"
  set -gx BASE16_COLOR_09_HEX "f78c6c"
  set -gx BASE16_COLOR_0A_HEX "ffcb6b"
  set -gx BASE16_COLOR_0B_HEX "c3e88d"
  set -gx BASE16_COLOR_0C_HEX "89ddff"
