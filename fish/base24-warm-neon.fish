...
set -l color00 "3f/3f/3f" # Base 00 - Black
set -l color01 "e2/43/45" # Base 08 - Red
set -l color02 "38/b1/39" # Base 0B - Green
set -l color03 "7a/90/d5" # Base 0A - Yellow
set -l color04 "42/60/c5" # Base 0D - Blue
set -l color05 "f8/1f/fb" # Base 0E - Magenta
set -l color06 "29/ba/d3" # Base 0C - Cyan
set -l color07 "dc/c9/ba" # Base 05 - White
set -l color08 "f2/eb/e6" # Base 03 - Bright Black
...
set -l color15 "d8/c8/bb" # Base 07 - Bright White
set -l color16 "da/e1/45" # Base 09
set -l color17 "71/21/22" # Base 0F
set -l color18 "00/00/00" # Base 01
set -l color19 "fd/fc/fc" # Base 02
set -l color20 "e7/da/d0" # Base 04
set -l color21 "d0/b8/a3" # Base 06
set -l color_foreground "dc/c9/ba" # Base 05
set -l color_background "3f/3f/3f" # Base 00
...
set -U fish_color_end dcc9ba
set -U fish_color_error brred
set -U fish_color_param e7dad0
set -U fish_color_valid_path --underline
set -U fish_color_option brcyan
set -U fish_color_comment f2ebe6
set -U fish_color_selection d0b8a3 --bold --background=fdfcfc
set -U fish_color_operator brblue
set -U fish_color_escape brcyan
set -U fish_color_autosuggestion f2ebe6
...
set -U fish_color_search_match bryellow --background=fdfcfc
set -U fish_color_history_current --bold
set -U fish_pager_color_progress 000000 --background=e7dad0
set -U fish_pager_color_background normal --background=3f3f3f
set -U fish_pager_color_prefix normal --bold
set -U fish_pager_color_completion normal
set -U fish_pager_color_description dae145 --dim
set -U fish_pager_color_selected_background d0b8a3 --background=fdfcfc
set -U fish_pager_color_selected_prefix d0b8a3 --bold --background=fdfcfc
set -U fish_pager_color_selected_completion d0b8a3
...
# Set theme
set -Ux BASE24_THEME warm-neon

# Optionally export variables
if test -n "$TINTED_SHELL_ENABLE_BASE24_VARS"; or test -n "$BASE24_SHELL_ENABLE_VARS"
  set -gx BASE24_COLOR_00_HEX "3f3f3f"
  set -gx BASE24_COLOR_01_HEX "000000"
  set -gx BASE24_COLOR_02_HEX "fdfcfc"
  set -gx BASE24_COLOR_03_HEX "f2ebe6"
  set -gx BASE24_COLOR_04_HEX "e7dad0"
  set -gx BASE24_COLOR_05_HEX "dcc9ba"
  set -gx BASE24_COLOR_06_HEX "d0b8a3"
  set -gx BASE24_COLOR_07_HEX "d8c8bb"
  set -gx BASE24_COLOR_08_HEX "e24345"
  set -gx BASE24_COLOR_09_HEX "dae145"
  set -gx BASE24_COLOR_0A_HEX "7a90d5"
  set -gx BASE24_COLOR_0B_HEX "38b139"
  set -gx BASE24_COLOR_0C_HEX "29bad3"
  set -gx BASE24_COLOR_0D_HEX "4260c5"
  set -gx BASE24_COLOR_0E_HEX "f81ffb"
  set -gx BASE24_COLOR_0F_HEX "712122"
end
