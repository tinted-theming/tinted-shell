...
set -U fish_color_selection d0b8a3 --background=fdfcfc
set -U fish_color_operator magenta
set -U fish_color_escape dae145
...
set -U fish_color_search_match yellow --background=fdfcfc
set -U fish_color_history_current --underline=curly
set -U fish_pager_color_progress 000000 --background=e7dad0
set -U fish_pager_color_background --background=3f3f3f
set -U fish_pager_color_prefix --bold --italics
set -U fish_pager_color_completion normal
set -U fish_pager_color_description dae145
set -U fish_pager_color_selected_background --background=fdfcfc
set -U fish_pager_color_selected_prefix --bold --italics --background=fdfcfc
