...
set -U fish_color_selection f1f1f1 --background=485161
set -U fish_color_operator magenta
set -U fish_color_escape e5c62f
...
set -U fish_color_search_match yellow --background=485161
set -U fish_color_history_current --underline=curly
set -U fish_pager_color_progress 16141e --background=9ca1a9
set -U fish_pager_color_background --background=191322
set -U fish_pager_color_prefix --bold --italics
set -U fish_pager_color_completion normal
set -U fish_pager_color_description e5c62f
set -U fish_pager_color_selected_background --background=485161
set -U fish_pager_color_selected_prefix --bold --italics --background=485161
