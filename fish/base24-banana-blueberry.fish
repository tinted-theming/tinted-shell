...
set -l color00 "19/13/22" # Base 00 - Black
set -l color01 "ff/6a/7e" # Base 08 - Red
set -l color02 "00/bc/9b" # Base 0B - Green
set -l color03 "91/ff/f3" # Base 0A - Yellow
set -l color04 "22/e8/df" # Base 0D - Blue
set -l color05 "dc/39/69" # Base 0E - Magenta
set -l color06 "55/b6/c1" # Base 0C - Cyan
set -l color07 "c6/c9/cd" # Base 05 - White
set -l color08 "72/79/85" # Base 03 - Bright Black
...
set -l color16 "e5/c6/2f" # Base 09
set -l color17 "7f/35/3f" # Base 0F
set -l color18 "16/14/1e" # Base 01
set -l color19 "48/51/61" # Base 02
set -l color20 "9c/a1/a9" # Base 04
set -l color21 "f1/f1/f1" # Base 06
set -l color_foreground "c6/c9/cd" # Base 05
set -l color_background "19/13/22" # Base 00
...
set -U fish_color_end c6c9cd
set -U fish_color_error brred
set -U fish_color_param 9ca1a9
set -U fish_color_valid_path --underline
set -U fish_color_option brcyan
set -U fish_color_comment 727985
set -U fish_color_selection f1f1f1 --bold --background=485161
set -U fish_color_operator brblue
set -U fish_color_escape brcyan
set -U fish_color_autosuggestion 727985
...
set -U fish_color_search_match bryellow --background=485161
set -U fish_color_history_current --bold
set -U fish_pager_color_progress 16141e --background=9ca1a9
set -U fish_pager_color_background normal --background=191322
set -U fish_pager_color_prefix normal --bold
set -U fish_pager_color_completion normal
set -U fish_pager_color_description e5c62f --dim
set -U fish_pager_color_selected_background f1f1f1 --background=485161
set -U fish_pager_color_selected_prefix f1f1f1 --bold --background=485161
...
# Set theme
set -Ux BASE24_THEME banana-blueberry

# Optionally export variables
if test -n "$TINTED_SHELL_ENABLE_BASE24_VARS"; or test -n "$BASE24_SHELL_ENABLE_VARS"
  set -gx BASE24_COLOR_00_HEX "191322"
  set -gx BASE24_COLOR_01_HEX "16141e"
  set -gx BASE24_COLOR_02_HEX "485161"
  set -gx BASE24_COLOR_03_HEX "727985"
  set -gx BASE24_COLOR_04_HEX "9ca1a9"
  set -gx BASE24_COLOR_05_HEX "c6c9cd"
  set -gx BASE24_COLOR_06_HEX "f1f1f1"
  set -gx BASE24_COLOR_07_HEX "feffff"
  set -gx BASE24_COLOR_08_HEX "ff6a7e"
  set -gx BASE24_COLOR_09_HEX "e5c62f"
  set -gx BASE24_COLOR_0A_HEX "91fff3"
  set -gx BASE24_COLOR_0B_HEX "00bc9b"
  set -gx BASE24_COLOR_0C_HEX "55b6c1"
  set -gx BASE24_COLOR_0D_HEX "22e8df"
  set -gx BASE24_COLOR_0E_HEX "dc3969"
  set -gx BASE24_COLOR_0F_HEX "7f353f"
end
