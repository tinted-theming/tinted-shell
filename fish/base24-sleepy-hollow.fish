...
set -U fish_color_end 968684
set -U fish_color_error brred
set -U fish_color_param 7e7278
set -U fish_color_valid_path --underline
set -U fish_color_option brcyan
set -U fish_color_comment 665e6c
set -U fish_color_selection af9a91 --bold --background=4e4b60
...
set -U fish_color_search_match bryellow --background=4e4b60
set -U fish_color_history_current --bold
set -U fish_pager_color_progress 572000 --background=7e7278
set -U fish_pager_color_background normal --background=121213
set -U fish_pager_color_prefix normal --bold
set -U fish_pager_color_completion normal
set -U fish_pager_color_description b45600 --dim
set -U fish_pager_color_selected_background af9a91 --background=4e4b60
set -U fish_pager_color_selected_prefix af9a91 --bold --background=4e4b60
set -U fish_pager_color_selected_completion af9a91
