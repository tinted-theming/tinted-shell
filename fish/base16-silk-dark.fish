...
set -l color00 "0e/3c/46" # Base 00 - Black
set -l color01 "fb/69/53" # Base 08 - Red
set -l color02 "73/d8/ad" # Base 0B - Green
set -l color03 "fc/e3/80" # Base 0A - Yellow
set -l color04 "46/bd/dd" # Base 0D - Blue
set -l color05 "75/6b/8a" # Base 0E - Magenta
set -l color06 "3f/b2/b9" # Base 0C - Cyan
set -l color07 "c7/db/dd" # Base 05 - White
set -l color08 "58/70/73" # Base 03 - Bright Black
...
set -l color16 "fc/ab/74" # Base 09
set -l color17 "9b/64/7b" # Base 0F
set -l color18 "1d/49/4e" # Base 01
set -l color19 "2a/50/54" # Base 02
set -l color20 "9d/c8/cd" # Base 04
set -l color21 "cb/f2/f7" # Base 06
set -l color_foreground "c7/db/dd" # Base 05
set -l color_background "0e/3c/46" # Base 00
...
set -U fish_color_end c7dbdd
set -U fish_color_error brred
set -U fish_color_param 9dc8cd
set -U fish_color_valid_path --underline
set -U fish_color_option brcyan
set -U fish_color_comment 587073
set -U fish_color_selection cbf2f7 --bold --background=2a5054
set -U fish_color_operator brblue
set -U fish_color_escape brcyan
set -U fish_color_autosuggestion 587073
...
set -U fish_pager_color_progress 1d494e --background=9dc8cd
set -U fish_pager_color_background normal --background=0e3c46
set -U fish_pager_color_prefix normal --bold
set -U fish_pager_color_completion normal
set -U fish_pager_color_description fcab74 --dim
set -U fish_pager_color_selected_background cbf2f7 --background=2a5054
set -U fish_pager_color_selected_prefix cbf2f7 --bold --background=2a5054
set -U fish_pager_color_selected_completion cbf2f7
...
# Set theme
set -Ux BASE16_THEME silk-dark

# Optionally export variables
if test -n "$TINTED_SHELL_ENABLE_BASE16_VARS"; or test -n "$BASE16_SHELL_ENABLE_VARS"
  set -gx BASE16_COLOR_00_HEX "0e3c46"
  set -gx BASE16_COLOR_01_HEX "1d494e"
  set -gx BASE16_COLOR_02_HEX "2a5054"
  set -gx BASE16_COLOR_03_HEX "587073"
  set -gx BASE16_COLOR_04_HEX "9dc8cd"
  set -gx BASE16_COLOR_05_HEX "c7dbdd"
  set -gx BASE16_COLOR_06_HEX "cbf2f7"
  set -gx BASE16_COLOR_07_HEX "d2faff"
  set -gx BASE16_COLOR_08_HEX "fb6953"
  set -gx BASE16_COLOR_09_HEX "fcab74"
  set -gx BASE16_COLOR_0A_HEX "fce380"
  set -gx BASE16_COLOR_0B_HEX "73d8ad"
  set -gx BASE16_COLOR_0C_HEX "3fb2b9"
  set -gx BASE16_COLOR_0D_HEX "46bddd"
  set -gx BASE16_COLOR_0E_HEX "756b8a"
  set -gx BASE16_COLOR_0F_HEX "9b647b"
end
