...
set -l color00 "fe/fb/ec" # Base 00 - Black
set -l color01 "d7/37/37" # Base 08 - Red
set -l color02 "60/ac/39" # Base 0B - Green
set -l color03 "ae/95/13" # Base 0A - Yellow
set -l color04 "66/84/e1" # Base 0D - Blue
set -l color05 "b8/54/d4" # Base 0E - Magenta
set -l color06 "1f/ad/83" # Base 0C - Cyan
set -l color07 "6e/6b/5e" # Base 05 - White
set -l color08 "99/95/80" # Base 03 - Bright Black
...
set -l color15 "20/20/1d" # Base 07 - Bright White
set -l color16 "b6/56/11" # Base 09
set -l color17 "d4/35/52" # Base 0F
set -l color18 "e8/e4/cf" # Base 01
set -l color19 "a6/a2/8c" # Base 02
set -l color20 "7d/7a/68" # Base 04
set -l color21 "29/28/24" # Base 06
set -l color_foreground "6e/6b/5e" # Base 05
set -l color_background "fe/fb/ec" # Base 00
...
set -U fish_color_end 6e6b5e
set -U fish_color_error brred
set -U fish_color_param 7d7a68
set -U fish_color_valid_path --underline
set -U fish_color_option brcyan
set -U fish_color_comment 999580
set -U fish_color_selection 292824 --bold --background=a6a28c
set -U fish_color_operator brblue
set -U fish_color_escape brcyan
set -U fish_color_autosuggestion 999580
...
set -U fish_pager_color_progress e8e4cf --background=7d7a68
set -U fish_pager_color_background normal --background=fefbec
set -U fish_pager_color_prefix normal --bold
set -U fish_pager_color_completion normal
set -U fish_pager_color_description b65611 --dim
set -U fish_pager_color_selected_background 292824 --background=a6a28c
set -U fish_pager_color_selected_prefix 292824 --bold --background=a6a28c
set -U fish_pager_color_selected_completion 292824
...
# Set theme
set -Ux BASE16_THEME atelier-dune-light

# Optionally export variables
if test -n "$TINTED_SHELL_ENABLE_BASE16_VARS"; or test -n "$BASE16_SHELL_ENABLE_VARS"
  set -gx BASE16_COLOR_00_HEX "fefbec"
  set -gx BASE16_COLOR_01_HEX "e8e4cf"
  set -gx BASE16_COLOR_02_HEX "a6a28c"
  set -gx BASE16_COLOR_03_HEX "999580"
  set -gx BASE16_COLOR_04_HEX "7d7a68"
  set -gx BASE16_COLOR_05_HEX "6e6b5e"
  set -gx BASE16_COLOR_06_HEX "292824"
  set -gx BASE16_COLOR_07_HEX "20201d"
  set -gx BASE16_COLOR_08_HEX "d73737"
  set -gx BASE16_COLOR_09_HEX "b65611"
  set -gx BASE16_COLOR_0A_HEX "ae9513"
  set -gx BASE16_COLOR_0B_HEX "60ac39"
  set -gx BASE16_COLOR_0C_HEX "1fad83"
  set -gx BASE16_COLOR_0D_HEX "6684e1"
  set -gx BASE16_COLOR_0E_HEX "b854d4"
  set -gx BASE16_COLOR_0F_HEX "d43552"
end
