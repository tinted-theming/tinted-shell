...
set -l color00 "f1/ec/f1" # Base 00 - Black
set -l color01 "fe/3e/31" # Base 08 - Red
set -l color02 "47/f7/4c" # Base 0B - Green
set -l color03 "f7/e2/03" # Base 0A - Yellow
set -l color04 "29/31/df" # Base 0D - Blue
set -l color05 "61/1f/ce" # Base 0E - Magenta
set -l color06 "0f/9c/fd" # Base 0C - Cyan
set -l color07 "51/51/51" # Base 05 - White
set -l color08 "b5/b4/b6" # Base 03 - Bright Black
...
set -l color15 "2d/2c/2c" # Base 07 - Bright White
set -l color16 "fe/6d/08" # Base 09
set -l color17 "b1/6f/40" # Base 0F
set -l color18 "e0/de/e0" # Base 01
set -l color19 "d8/d5/d5" # Base 02
set -l color20 "97/95/98" # Base 04
set -l color21 "47/45/45" # Base 06
set -l color_foreground "51/51/51" # Base 05
set -l color_background "f1/ec/f1" # Base 00
...
set -U fish_color_end 515151
set -U fish_color_error brred
set -U fish_color_param 979598
set -U fish_color_valid_path --underline
set -U fish_color_option brcyan
set -U fish_color_comment b5b4b6
set -U fish_color_selection 474545 --bold --background=d8d5d5
set -U fish_color_operator brblue
set -U fish_color_escape brcyan
set -U fish_color_autosuggestion b5b4b6
...
set -U fish_pager_color_progress e0dee0 --background=979598
set -U fish_pager_color_background normal --background=f1ecf1
set -U fish_pager_color_prefix normal --bold
set -U fish_pager_color_completion normal
set -U fish_pager_color_description fe6d08 --dim
set -U fish_pager_color_selected_background 474545 --background=d8d5d5
set -U fish_pager_color_selected_prefix 474545 --bold --background=d8d5d5
set -U fish_pager_color_selected_completion 474545
...
# Set theme
set -Ux BASE16_THEME fruit-soda

# Optionally export variables
if test -n "$TINTED_SHELL_ENABLE_BASE16_VARS"; or test -n "$BASE16_SHELL_ENABLE_VARS"
  set -gx BASE16_COLOR_00_HEX "f1ecf1"
  set -gx BASE16_COLOR_01_HEX "e0dee0"
  set -gx BASE16_COLOR_02_HEX "d8d5d5"
  set -gx BASE16_COLOR_03_HEX "b5b4b6"
  set -gx BASE16_COLOR_04_HEX "979598"
  set -gx BASE16_COLOR_05_HEX "515151"
  set -gx BASE16_COLOR_06_HEX "474545"
  set -gx BASE16_COLOR_07_HEX "2d2c2c"
  set -gx BASE16_COLOR_08_HEX "fe3e31"
  set -gx BASE16_COLOR_09_HEX "fe6d08"
  set -gx BASE16_COLOR_0A_HEX "f7e203"
  set -gx BASE16_COLOR_0B_HEX "47f74c"
  set -gx BASE16_COLOR_0C_HEX "0f9cfd"
  set -gx BASE16_COLOR_0D_HEX "2931df"
  set -gx BASE16_COLOR_0E_HEX "611fce"
  set -gx BASE16_COLOR_0F_HEX "b16f40"
end
