...
set -l color01 "cd/af/95" # Base 08 - Red
set -l color02 "a7/ff/60" # Base 0B - Green
set -l color03 "86/bd/c9" # Base 0A - Yellow
set -l color04 "75/a5/b0" # Base 0D - Blue
set -l color05 "ff/73/fd" # Base 0E - Magenta
set -l color06 "59/64/7e" # Base 0C - Cyan
...
set -l color16 "bf/bb/1f" # Base 09
set -l color17 "66/57/4a" # Base 0F
...
set -U fish_pager_color_description bfbb1f --dim
...
# Set theme
set -Ux BASE24_THEME rippedcasts
...
if test -n "$TINTED_SHELL_ENABLE_BASE24_VARS"; or test -n "$BASE24_SHELL_ENABLE_VARS"
  ...
  set -gx BASE24_COLOR_08_HEX "cdaf95"
  set -gx BASE24_COLOR_09_HEX "bfbb1f"
  set -gx BASE24_COLOR_0A_HEX "86bdc9"
  set -gx BASE24_COLOR_0B_HEX "a7ff60"
  set -gx BASE24_COLOR_0C_HEX "59647e"
  set -gx BASE24_COLOR_0D_HEX "75a5b0"
  set -gx BASE24_COLOR_0E_HEX "ff73fd"
  set -gx BASE24_COLOR_0F_HEX "66574a"
end
