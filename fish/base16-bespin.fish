...
set -U fish_pager_color_background normal --background=28211c
set -U fish_pager_color_prefix normal --bold
set -U fish_pager_color_completion normal
set -U fish_pager_color_description cf7d34 --dim
set -U fish_pager_color_selected_background 9d9b97 --background=5e5d5c
set -U fish_pager_color_selected_prefix 9d9b97 --bold --background=5e5d5c
set -U fish_pager_color_selected_completion 9d9b97
