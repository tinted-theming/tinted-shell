...
set -l color00 "13/1f/1f" # Base 00 - Black
set -l color01 "d7/58/6e" # Base 08 - Red
set -l color02 "59/d6/78" # Base 0B - Green
set -l color03 "df/e7/54" # Base 0A - Yellow
set -l color04 "4e/d2/d2" # Base 0D - Blue
set -l color05 "a8/74/e0" # Base 0E - Magenta
set -l color06 "76/db/d2" # Base 0C - Cyan
set -l color07 "98/c1/a3" # Base 05 - White
set -l color08 "3e/5c/53" # Base 03 - Bright Black
...
set -l color15 "aa/cb/cb" # Base 07 - Bright White
set -l color16 "e6/b4/66" # Base 09
set -l color17 "c0/5a/8f" # Base 0F
set -l color18 "21/31/32" # Base 01
set -l color19 "27/3d/3c" # Base 02
set -l color20 "6d/98/77" # Base 04
set -l color21 "a5/cb/b9" # Base 06
set -l color_foreground "98/c1/a3" # Base 05
set -l color_background "13/1f/1f" # Base 00
...
set -U fish_color_end 98c1a3
set -U fish_color_error brred
set -U fish_color_param 6d9877
set -U fish_color_valid_path --underline
set -U fish_color_option brcyan
set -U fish_color_comment 3e5c53
set -U fish_color_selection a5cbb9 --bold --background=273d3c
set -U fish_color_operator brblue
set -U fish_color_escape brcyan
set -U fish_color_autosuggestion 3e5c53
...
set -U fish_color_search_match bryellow --background=273d3c
set -U fish_color_history_current --bold
set -U fish_pager_color_progress 213132 --background=6d9877
set -U fish_pager_color_background normal --background=131f1f
set -U fish_pager_color_prefix normal --bold
set -U fish_pager_color_completion normal
set -U fish_pager_color_description e6b466 --dim
set -U fish_pager_color_selected_background a5cbb9 --background=273d3c
set -U fish_pager_color_selected_prefix a5cbb9 --bold --background=273d3c
set -U fish_pager_color_selected_completion a5cbb9
...
# Set theme
set -Ux BASE16_THEME valua

# Optionally export variables
if test -n "$TINTED_SHELL_ENABLE_BASE16_VARS"; or test -n "$BASE16_SHELL_ENABLE_VARS"
  set -gx BASE16_COLOR_00_HEX "131f1f"
  set -gx BASE16_COLOR_01_HEX "213132"
  set -gx BASE16_COLOR_02_HEX "273d3c"
  set -gx BASE16_COLOR_03_HEX "3e5c53"
  set -gx BASE16_COLOR_04_HEX "6d9877"
  set -gx BASE16_COLOR_05_HEX "98c1a3"
  set -gx BASE16_COLOR_06_HEX "a5cbb9"
  set -gx BASE16_COLOR_07_HEX "aacbcb"
  set -gx BASE16_COLOR_08_HEX "d7586e"
  set -gx BASE16_COLOR_09_HEX "e6b466"
  set -gx BASE16_COLOR_0A_HEX "dfe754"
  set -gx BASE16_COLOR_0B_HEX "59d678"
  set -gx BASE16_COLOR_0C_HEX "76dbd2"
  set -gx BASE16_COLOR_0D_HEX "4ed2d2"
  set -gx BASE16_COLOR_0E_HEX "a874e0"
  set -gx BASE16_COLOR_0F_HEX "c05a8f"
end
