...
set -l color01 "5f/87/87" # Base 08 - Red
set -l color02 "d0/df/ee" # Base 0B - Green
set -l color03 "5f/81/a5" # Base 0A - Yellow
set -l color04 "88/88/88" # Base 0D - Blue
set -l color05 "99/99/99" # Base 0E - Magenta
set -l color06 "aa/aa/aa" # Base 0C - Cyan
set -l color07 "c1/c1/c1" # Base 05 - White
...
set -l color15 "c1/c1/c1" # Base 07 - Bright White
set -l color16 "aa/aa/aa" # Base 09
set -l color17 "44/44/44" # Base 0F
set -l color18 "12/12/12" # Base 01
set -l color19 "22/22/22" # Base 02
set -l color20 "99/99/99" # Base 04
set -l color21 "99/99/99" # Base 06
set -l color_foreground "c1/c1/c1" # Base 05
...
set -U fish_pager_color_progress 121212 --background=999999
set -U fish_pager_color_background normal --background=000000
set -U fish_pager_color_prefix normal --bold
set -U fish_pager_color_completion normal
set -U fish_pager_color_description aaaaaa --dim
set -U fish_pager_color_selected_background 999999 --background=222222
set -U fish_pager_color_selected_prefix 999999 --bold --background=222222
set -U fish_pager_color_selected_completion 999999
...
# Set theme
set -Ux BASE16_THEME black-metal-dark-funeral

# Optionally export variables
if test -n "$TINTED_SHELL_ENABLE_BASE16_VARS"; or test -n "$BASE16_SHELL_ENABLE_VARS"
  set -gx BASE16_COLOR_00_HEX "000000"
  set -gx BASE16_COLOR_01_HEX "121212"
  set -gx BASE16_COLOR_02_HEX "222222"
  set -gx BASE16_COLOR_03_HEX "333333"
  set -gx BASE16_COLOR_04_HEX "999999"
  set -gx BASE16_COLOR_05_HEX "c1c1c1"
  set -gx BASE16_COLOR_06_HEX "999999"
  set -gx BASE16_COLOR_07_HEX "c1c1c1"
  set -gx BASE16_COLOR_08_HEX "5f8787"
  set -gx BASE16_COLOR_09_HEX "aaaaaa"
  set -gx BASE16_COLOR_0A_HEX "5f81a5"
  set -gx BASE16_COLOR_0B_HEX "d0dfee"
  set -gx BASE16_COLOR_0C_HEX "aaaaaa"
  set -gx BASE16_COLOR_0D_HEX "888888"
  set -gx BASE16_COLOR_0E_HEX "999999"
  set -gx BASE16_COLOR_0F_HEX "444444"
end
