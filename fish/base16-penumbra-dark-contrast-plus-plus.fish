...
set -l color00 "0d/0f/13" # Base 00 - Black
...
set -l color07 "de/de/de" # Base 05 - White
set -l color08 "63/63/63" # Base 03 - Bright Black
...
set -l color15 "ff/fd/fb" # Base 07 - Bright White
set -l color16 "e0/9f/47" # Base 09
set -l color17 "e5/8c/c5" # Base 0F
set -l color18 "18/1b/1f" # Base 01
set -l color19 "3e/40/44" # Base 02
set -l color20 "ae/ae/ae" # Base 04
set -l color21 "ff/f7/ed" # Base 06
set -l color_foreground "de/de/de" # Base 05
set -l color_background "0d/0f/13" # Base 00
...
set -U fish_color_end dedede
set -U fish_color_error brred
set -U fish_color_param aeaeae
set -U fish_color_valid_path --underline
set -U fish_color_option brcyan
set -U fish_color_comment 636363
set -U fish_color_selection fff7ed --bold --background=3e4044
set -U fish_color_operator brblue
set -U fish_color_escape brcyan
set -U fish_color_autosuggestion 636363
...
set -U fish_color_search_match bryellow --background=3e4044
set -U fish_color_history_current --bold
set -U fish_pager_color_progress 181b1f --background=aeaeae
set -U fish_pager_color_background normal --background=0d0f13
set -U fish_pager_color_prefix normal --bold
set -U fish_pager_color_completion normal
set -U fish_pager_color_description e09f47 --dim
set -U fish_pager_color_selected_background fff7ed --background=3e4044
set -U fish_pager_color_selected_prefix fff7ed --bold --background=3e4044
set -U fish_pager_color_selected_completion fff7ed
...
# Set theme
set -Ux BASE16_THEME penumbra-dark-contrast-plus-plus

# Optionally export variables
if test -n "$TINTED_SHELL_ENABLE_BASE16_VARS"; or test -n "$BASE16_SHELL_ENABLE_VARS"
  set -gx BASE16_COLOR_00_HEX "0d0f13"
  set -gx BASE16_COLOR_01_HEX "181b1f"
  set -gx BASE16_COLOR_02_HEX "3e4044"
  set -gx BASE16_COLOR_03_HEX "636363"
  set -gx BASE16_COLOR_04_HEX "aeaeae"
  set -gx BASE16_COLOR_05_HEX "dedede"
  set -gx BASE16_COLOR_06_HEX "fff7ed"
  set -gx BASE16_COLOR_07_HEX "fffdfb"
