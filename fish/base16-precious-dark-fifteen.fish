...
set -l color00 "23/26/2b" # Base 00 - Black
set -l color01 "ff/87/82" # Base 08 - Red
set -l color02 "95/b6/59" # Base 0B - Green
set -l color03 "cf/a5/46" # Base 0A - Yellow
set -l color04 "66/b0/ef" # Base 0D - Blue
set -l color05 "b7/99/ff" # Base 0E - Magenta
set -l color06 "42/bd/a7" # Base 0C - Cyan
set -l color07 "ba/b9/b6" # Base 05 - White
set -l color08 "89/89/89" # Base 03 - Bright Black
...
set -l color15 "ba/b9/b6" # Base 07 - Bright White
set -l color16 "e9/98/57" # Base 09
set -l color17 "f3/82/d8" # Base 0F
set -l color18 "30/33/37" # Base 01
set -l color19 "3e/40/44" # Base 02
set -l color20 "ab/aa/a8" # Base 04
set -l color21 "ba/b9/b6" # Base 06
set -l color_foreground "ba/b9/b6" # Base 05
set -l color_background "23/26/2b" # Base 00
...
set -U fish_color_end bab9b6
set -U fish_color_error brred
set -U fish_color_param abaaa8
set -U fish_color_valid_path --underline
set -U fish_color_option brcyan
set -U fish_color_comment 898989
set -U fish_color_selection bab9b6 --bold --background=3e4044
set -U fish_color_operator brblue
set -U fish_color_escape brcyan
set -U fish_color_autosuggestion 898989
...
set -U fish_pager_color_progress 303337 --background=abaaa8
set -U fish_pager_color_background normal --background=23262b
set -U fish_pager_color_prefix normal --bold
set -U fish_pager_color_completion normal
set -U fish_pager_color_description e99857 --dim
set -U fish_pager_color_selected_background bab9b6 --background=3e4044
set -U fish_pager_color_selected_prefix bab9b6 --bold --background=3e4044
set -U fish_pager_color_selected_completion bab9b6
...
# Set theme
set -Ux BASE16_THEME precious-dark-fifteen

# Optionally export variables
if test -n "$TINTED_SHELL_ENABLE_BASE16_VARS"; or test -n "$BASE16_SHELL_ENABLE_VARS"
  set -gx BASE16_COLOR_00_HEX "23262b"
  set -gx BASE16_COLOR_01_HEX "303337"
  set -gx BASE16_COLOR_02_HEX "3e4044"
  set -gx BASE16_COLOR_03_HEX "898989"
  set -gx BASE16_COLOR_04_HEX "abaaa8"
  set -gx BASE16_COLOR_05_HEX "bab9b6"
  set -gx BASE16_COLOR_06_HEX "bab9b6"
  set -gx BASE16_COLOR_07_HEX "bab9b6"
  set -gx BASE16_COLOR_08_HEX "ff8782"
  set -gx BASE16_COLOR_09_HEX "e99857"
  set -gx BASE16_COLOR_0A_HEX "cfa546"
  set -gx BASE16_COLOR_0B_HEX "95b659"
  set -gx BASE16_COLOR_0C_HEX "42bda7"
  set -gx BASE16_COLOR_0D_HEX "66b0ef"
  set -gx BASE16_COLOR_0E_HEX "b799ff"
  set -gx BASE16_COLOR_0F_HEX "f382d8"
end
