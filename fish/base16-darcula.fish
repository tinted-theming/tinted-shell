...
set -l color01 "4e/ad/e5" # Base 08 - Red
set -l color02 "6a/87/59" # Base 0B - Green
set -l color03 "bb/b5/29" # Base 0A - Yellow
set -l color04 "98/76/aa" # Base 0D - Blue
set -l color05 "cc/78/32" # Base 0E - Magenta
set -l color06 "62/97/55" # Base 0C - Cyan
set -l color07 "a9/b7/c6" # Base 05 - White
set -l color08 "60/63/66" # Base 03 - Bright Black
...
set -l color16 "68/97/57" # Base 09
set -l color17 "80/80/80" # Base 0F
set -l color18 "32/32/32" # Base 01
set -l color19 "32/32/32" # Base 02
set -l color20 "a4/a3/a3" # Base 04
set -l color21 "ff/c6/6d" # Base 06
set -l color_foreground "a9/b7/c6" # Base 05
...
set -U fish_color_end a9b7c6
set -U fish_color_error brred
set -U fish_color_param a4a3a3
set -U fish_color_valid_path --underline
set -U fish_color_option brcyan
set -U fish_color_comment 606366
set -U fish_color_selection ffc66d --bold --background=323232
set -U fish_color_operator brblue
set -U fish_color_escape brcyan
set -U fish_color_autosuggestion 606366
...
set -U fish_pager_color_progress 323232 --background=a4a3a3
set -U fish_pager_color_background normal --background=2b2b2b
set -U fish_pager_color_prefix normal --bold
set -U fish_pager_color_completion normal
set -U fish_pager_color_description 689757 --dim
set -U fish_pager_color_selected_background ffc66d --background=323232
set -U fish_pager_color_selected_prefix ffc66d --bold --background=323232
set -U fish_pager_color_selected_completion ffc66d
...
# Set theme
set -Ux BASE16_THEME darcula

# Optionally export variables
if test -n "$TINTED_SHELL_ENABLE_BASE16_VARS"; or test -n "$BASE16_SHELL_ENABLE_VARS"
  set -gx BASE16_COLOR_00_HEX "2b2b2b"
  set -gx BASE16_COLOR_01_HEX "323232"
  set -gx BASE16_COLOR_02_HEX "323232"
  set -gx BASE16_COLOR_03_HEX "606366"
  set -gx BASE16_COLOR_04_HEX "a4a3a3"
  set -gx BASE16_COLOR_05_HEX "a9b7c6"
  set -gx BASE16_COLOR_06_HEX "ffc66d"
  set -gx BASE16_COLOR_07_HEX "ffffff"
  set -gx BASE16_COLOR_08_HEX "4eade5"
  set -gx BASE16_COLOR_09_HEX "689757"
  set -gx BASE16_COLOR_0A_HEX "bbb529"
  set -gx BASE16_COLOR_0B_HEX "6a8759"
  set -gx BASE16_COLOR_0C_HEX "629755"
  set -gx BASE16_COLOR_0D_HEX "9876aa"
  set -gx BASE16_COLOR_0E_HEX "cc7832"
