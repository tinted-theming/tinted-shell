...
set -l color00 "2c/2c/2c" # Base 00 - Black
set -l color01 "fe/26/35" # Base 08 - Red
set -l color02 "41/a6/38" # Base 0B - Green
set -l color03 "2e/fa/eb" # Base 0A - Yellow
set -l color04 "2e/c3/b9" # Base 0D - Blue
set -l color05 "50/a0/96" # Base 0E - Magenta
set -l color06 "3c/a0/78" # Base 0C - Cyan
set -l color07 "ad/d5/b6" # Base 05 - White
set -l color08 "3b/84/3e" # Base 03 - Bright Black
...
set -l color15 "e0/f1/dc" # Base 07 - Bright White
set -l color16 "76/a8/30" # Base 09
set -l color17 "7f/13/1a" # Base 0F
set -l color18 "01/44/01" # Base 01
set -l color19 "02/5c/02" # Base 02
set -l color20 "74/ad/7a" # Base 04
set -l color21 "e6/fe/f2" # Base 06
set -l color_foreground "ad/d5/b6" # Base 05
set -l color_background "2c/2c/2c" # Base 00
...
set -U fish_color_end add5b6
set -U fish_color_error brred
set -U fish_color_param 74ad7a
set -U fish_color_valid_path --underline
set -U fish_color_option brcyan
set -U fish_color_comment 3b843e
set -U fish_color_selection e6fef2 --bold --background=025c02
set -U fish_color_operator brblue
set -U fish_color_escape brcyan
set -U fish_color_autosuggestion 3b843e
...
set -U fish_color_search_match bryellow --background=025c02
set -U fish_color_history_current --bold
set -U fish_pager_color_progress 014401 --background=74ad7a
set -U fish_pager_color_background normal --background=2c2c2c
set -U fish_pager_color_prefix normal --bold
set -U fish_pager_color_completion normal
set -U fish_pager_color_description 76a830 --dim
set -U fish_pager_color_selected_background e6fef2 --background=025c02
set -U fish_pager_color_selected_prefix e6fef2 --bold --background=025c02
set -U fish_pager_color_selected_completion e6fef2
...
# Set theme
set -Ux BASE24_THEME ic-green-ppl

# Optionally export variables
if test -n "$TINTED_SHELL_ENABLE_BASE24_VARS"; or test -n "$BASE24_SHELL_ENABLE_VARS"
  set -gx BASE24_COLOR_00_HEX "2c2c2c"
  set -gx BASE24_COLOR_01_HEX "014401"
  set -gx BASE24_COLOR_02_HEX "025c02"
  set -gx BASE24_COLOR_03_HEX "3b843e"
  set -gx BASE24_COLOR_04_HEX "74ad7a"
  set -gx BASE24_COLOR_05_HEX "add5b6"
  set -gx BASE24_COLOR_06_HEX "e6fef2"
  set -gx BASE24_COLOR_07_HEX "e0f1dc"
  set -gx BASE24_COLOR_08_HEX "fe2635"
  set -gx BASE24_COLOR_09_HEX "76a830"
  set -gx BASE24_COLOR_0A_HEX "2efaeb"
  set -gx BASE24_COLOR_0B_HEX "41a638"
  set -gx BASE24_COLOR_0C_HEX "3ca078"
  set -gx BASE24_COLOR_0D_HEX "2ec3b9"
  set -gx BASE24_COLOR_0E_HEX "50a096"
  set -gx BASE24_COLOR_0F_HEX "7f131a"
end
