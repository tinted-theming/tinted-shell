...
set -l color02 "59/d5/00" # Base 0B - Green
set -l color03 "ef/ca/00" # Base 0A - Yellow
set -l color04 "00/a1/ff" # Base 0D - Blue
set -l color05 "c1/7e/cb" # Base 0E - Magenta
set -l color06 "00/d0/d6" # Base 0C - Cyan
...
set -l color16 "ef/9b/00" # Base 09
...
set -U fish_pager_color_description ef9b00 --dim
...
# Set theme
set -Ux BASE24_THEME tango-adapted
...
if test -n "$TINTED_SHELL_ENABLE_BASE24_VARS"; or test -n "$BASE24_SHELL_ENABLE_VARS"
  ...
  set -gx BASE24_COLOR_09_HEX "ef9b00"
  set -gx BASE24_COLOR_0A_HEX "efca00"
  set -gx BASE24_COLOR_0B_HEX "59d500"
  set -gx BASE24_COLOR_0C_HEX "00d0d6"
  set -gx BASE24_COLOR_0D_HEX "00a1ff"
  set -gx BASE24_COLOR_0E_HEX "c17ecb"
