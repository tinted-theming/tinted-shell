...
set -l color00 "16/17/2d" # Base 00 - Black
set -l color01 "e3/34/00" # Base 08 - Red
set -l color02 "5c/cc/96" # Base 0B - Green
set -l color03 "f2/ce/00" # Base 0A - Yellow
set -l color04 "7a/5c/cc" # Base 0D - Blue
set -l color05 "b3/a1/e6" # Base 0E - Magenta
set -l color06 "00/a3/cc" # Base 0C - Cyan
set -l color07 "ec/f0/c1" # Base 05 - White
set -l color08 "68/6f/9a" # Base 03 - Bright Black
...
set -l color16 "e3/94/00" # Base 09
set -l color17 "ce/6f/8f" # Base 0F
set -l color18 "1b/1c/36" # Base 01
set -l color19 "30/36/5f" # Base 02
set -l color20 "81/85/96" # Base 04
set -l color21 "c1/c3/cc" # Base 06
set -l color_foreground "ec/f0/c1" # Base 05
set -l color_background "16/17/2d" # Base 00
...
set -U fish_color_end ecf0c1
set -U fish_color_error brred
set -U fish_color_param 818596
set -U fish_color_valid_path --underline
set -U fish_color_option brcyan
set -U fish_color_comment 686f9a
set -U fish_color_selection c1c3cc --bold --background=30365f
set -U fish_color_operator brblue
set -U fish_color_escape brcyan
set -U fish_color_autosuggestion 686f9a
...
set -U fish_color_search_match bryellow --background=30365f
set -U fish_color_history_current --bold
set -U fish_pager_color_progress 1b1c36 --background=818596
set -U fish_pager_color_background normal --background=16172d
set -U fish_pager_color_prefix normal --bold
set -U fish_pager_color_completion normal
set -U fish_pager_color_description e39400 --dim
set -U fish_pager_color_selected_background c1c3cc --background=30365f
set -U fish_pager_color_selected_prefix c1c3cc --bold --background=30365f
set -U fish_pager_color_selected_completion c1c3cc
...
# Set theme
set -Ux BASE16_THEME spaceduck

# Optionally export variables
if test -n "$TINTED_SHELL_ENABLE_BASE16_VARS"; or test -n "$BASE16_SHELL_ENABLE_VARS"
  set -gx BASE16_COLOR_00_HEX "16172d"
  set -gx BASE16_COLOR_01_HEX "1b1c36"
  set -gx BASE16_COLOR_02_HEX "30365f"
  set -gx BASE16_COLOR_03_HEX "686f9a"
  set -gx BASE16_COLOR_04_HEX "818596"
  set -gx BASE16_COLOR_05_HEX "ecf0c1"
  set -gx BASE16_COLOR_06_HEX "c1c3cc"
  set -gx BASE16_COLOR_07_HEX "ffffff"
  set -gx BASE16_COLOR_08_HEX "e33400"
  set -gx BASE16_COLOR_09_HEX "e39400"
  set -gx BASE16_COLOR_0A_HEX "f2ce00"
  set -gx BASE16_COLOR_0B_HEX "5ccc96"
  set -gx BASE16_COLOR_0C_HEX "00a3cc"
  set -gx BASE16_COLOR_0D_HEX "7a5ccc"
  set -gx BASE16_COLOR_0E_HEX "b3a1e6"
  set -gx BASE16_COLOR_0F_HEX "ce6f8f"
end
