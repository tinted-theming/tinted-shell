...
set -l color01 "fa/28/34" # Base 08 - Red
set -l color02 "97/e1/23" # Base 0B - Green
set -l color03 "fe/f2/0a" # Base 0A - Yellow
set -l color04 "04/42/fe" # Base 0D - Blue
set -l color05 "f8/00/f8" # Base 0E - Magenta
set -l color06 "01/b6/ed" # Base 0C - Cyan
set -l color07 "df/df/df" # Base 05 - White
...
set -l color16 "fe/c5/0a" # Base 09
set -l color17 "7d/14/1a" # Base 0F
set -l color18 "32/32/32" # Base 01
set -l color19 "42/42/42" # Base 02
set -l color20 "c0/c0/c0" # Base 04
set -l color21 "f1/f1/f1" # Base 06
set -l color_foreground "df/df/df" # Base 05
...
set -U fish_pager_color_progress 323232 --background=c0c0c0
set -U fish_pager_color_background normal --background=121212
set -U fish_pager_color_prefix normal --bold
set -U fish_pager_color_completion normal
set -U fish_pager_color_description fec50a --dim
set -U fish_pager_color_selected_background f1f1f1 --background=424242
set -U fish_pager_color_selected_prefix f1f1f1 --bold --background=424242
...
# Set theme
set -Ux BASE24_THEME monokai-vivid
...
if test -n "$TINTED_SHELL_ENABLE_BASE24_VARS"; or test -n "$BASE24_SHELL_ENABLE_VARS"
  ...
  set -gx BASE24_COLOR_04_HEX "c0c0c0"
  set -gx BASE24_COLOR_05_HEX "dfdfdf"
  set -gx BASE24_COLOR_06_HEX "f1f1f1"
  set -gx BASE24_COLOR_07_HEX "ffffff"
  set -gx BASE24_COLOR_08_HEX "fa2834"
  set -gx BASE24_COLOR_09_HEX "fec50a"
  set -gx BASE24_COLOR_0A_HEX "fef20a"
  set -gx BASE24_COLOR_0B_HEX "97e123"
  set -gx BASE24_COLOR_0C_HEX "01b6ed"
  set -gx BASE24_COLOR_0D_HEX "0442fe"
  set -gx BASE24_COLOR_0E_HEX "f800f8"
  set -gx BASE24_COLOR_0F_HEX "7d141a"
end
