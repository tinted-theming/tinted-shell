...
set -l color00 "1f/1f/28" # Base 00 - Black
set -l color01 "c3/40/43" # Base 08 - Red
set -l color02 "76/94/6a" # Base 0B - Green
set -l color03 "c0/a3/6e" # Base 0A - Yellow
set -l color04 "7e/9c/d8" # Base 0D - Blue
set -l color05 "95/7f/b8" # Base 0E - Magenta
set -l color06 "6a/95/89" # Base 0C - Cyan
set -l color07 "dc/d7/ba" # Base 05 - White
set -l color08 "54/54/6d" # Base 03 - Bright Black
...
set -l color15 "71/7c/7c" # Base 07 - Bright White
set -l color16 "ff/a0/66" # Base 09
set -l color17 "d2/7e/99" # Base 0F
set -l color18 "16/16/1d" # Base 01
set -l color19 "22/32/49" # Base 02
set -l color20 "72/71/69" # Base 04
set -l color21 "c8/c0/93" # Base 06
set -l color_foreground "dc/d7/ba" # Base 05
set -l color_background "1f/1f/28" # Base 00
...
set -U fish_color_end dcd7ba
set -U fish_color_error brred
set -U fish_color_param 727169
set -U fish_color_valid_path --underline
set -U fish_color_option brcyan
set -U fish_color_comment 54546d
set -U fish_color_selection c8c093 --bold --background=223249
...
set -U fish_color_search_match bryellow --background=223249
set -U fish_color_history_current --bold
set -U fish_pager_color_progress 16161d --background=727169
set -U fish_pager_color_background normal --background=1f1f28
set -U fish_pager_color_prefix normal --bold
set -U fish_pager_color_completion normal
set -U fish_pager_color_description ffa066 --dim
set -U fish_pager_color_selected_background c8c093 --background=223249
set -U fish_pager_color_selected_prefix c8c093 --bold --background=223249
...
# Set theme
set -Ux BASE16_THEME kanagawa

# Optionally export variables
if test -n "$TINTED_SHELL_ENABLE_BASE16_VARS"; or test -n "$BASE16_SHELL_ENABLE_VARS"
  set -gx BASE16_COLOR_00_HEX "1f1f28"
  set -gx BASE16_COLOR_01_HEX "16161d"
  set -gx BASE16_COLOR_02_HEX "223249"
  set -gx BASE16_COLOR_03_HEX "54546d"
  set -gx BASE16_COLOR_04_HEX "727169"
  set -gx BASE16_COLOR_05_HEX "dcd7ba"
  set -gx BASE16_COLOR_06_HEX "c8c093"
  set -gx BASE16_COLOR_07_HEX "717c7c"
  set -gx BASE16_COLOR_08_HEX "c34043"
  set -gx BASE16_COLOR_09_HEX "ffa066"
  set -gx BASE16_COLOR_0A_HEX "c0a36e"
  set -gx BASE16_COLOR_0B_HEX "76946a"
  set -gx BASE16_COLOR_0C_HEX "6a9589"
  set -gx BASE16_COLOR_0D_HEX "7e9cd8"
  set -gx BASE16_COLOR_0E_HEX "957fb8"
  set -gx BASE16_COLOR_0F_HEX "d27e99"
end
