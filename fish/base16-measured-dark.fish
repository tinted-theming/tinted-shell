...
set -l color00 "00/21/1f" # Base 00 - Black
set -l color01 "ce/7e/8e" # Base 08 - Red
set -l color02 "56/c1/6f" # Base 0B - Green
set -l color03 "bf/ac/4e" # Base 0A - Yellow
set -l color04 "88/b0/da" # Base 0D - Blue
set -l color05 "b3/9b/e0" # Base 0E - Magenta
set -l color06 "62/c0/be" # Base 0C - Cyan
set -l color07 "dc/dc/dc" # Base 05 - White
set -l color08 "ab/ab/ab" # Base 03 - Bright Black
...
set -l color15 "f5/f5/f5" # Base 07 - Bright White
set -l color16 "dc/a3/7c" # Base 09
set -l color17 "d8/9a/ba" # Base 0F
set -l color18 "00/3a/38" # Base 01
set -l color19 "00/54/53" # Base 02
set -l color20 "c3/c3/c3" # Base 04
set -l color21 "ef/ef/ef" # Base 06
set -l color_foreground "dc/dc/dc" # Base 05
set -l color_background "00/21/1f" # Base 00
...
set -U fish_color_end dcdcdc
set -U fish_color_error brred
set -U fish_color_param c3c3c3
set -U fish_color_valid_path --underline
set -U fish_color_option brcyan
set -U fish_color_comment ababab
set -U fish_color_selection efefef --bold --background=005453
...
set -U fish_color_search_match bryellow --background=005453
set -U fish_color_history_current --bold
set -U fish_pager_color_progress 003a38 --background=c3c3c3
set -U fish_pager_color_background normal --background=00211f
set -U fish_pager_color_prefix normal --bold
set -U fish_pager_color_completion normal
set -U fish_pager_color_description dca37c --dim
set -U fish_pager_color_selected_background efefef --background=005453
set -U fish_pager_color_selected_prefix efefef --bold --background=005453
set -U fish_pager_color_selected_completion efefef
...
# Set theme
set -Ux BASE16_THEME measured-dark

# Optionally export variables
if test -n "$TINTED_SHELL_ENABLE_BASE16_VARS"; or test -n "$BASE16_SHELL_ENABLE_VARS"
  set -gx BASE16_COLOR_00_HEX "00211f"
  set -gx BASE16_COLOR_01_HEX "003a38"
  set -gx BASE16_COLOR_02_HEX "005453"
  set -gx BASE16_COLOR_03_HEX "ababab"
  set -gx BASE16_COLOR_04_HEX "c3c3c3"
  set -gx BASE16_COLOR_05_HEX "dcdcdc"
  set -gx BASE16_COLOR_06_HEX "efefef"
  set -gx BASE16_COLOR_07_HEX "f5f5f5"
  set -gx BASE16_COLOR_08_HEX "ce7e8e"
  set -gx BASE16_COLOR_09_HEX "dca37c"
  set -gx BASE16_COLOR_0A_HEX "bfac4e"
  set -gx BASE16_COLOR_0B_HEX "56c16f"
  set -gx BASE16_COLOR_0C_HEX "62c0be"
  set -gx BASE16_COLOR_0D_HEX "88b0da"
  set -gx BASE16_COLOR_0E_HEX "b39be0"
  set -gx BASE16_COLOR_0F_HEX "d89aba"
end
