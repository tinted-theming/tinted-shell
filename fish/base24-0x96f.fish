...
set -U fish_color_selection eae9eb --background=514f52
set -U fish_color_operator magenta
set -U fish_color_escape fc9d6f
...
set -U fish_color_search_match yellow --background=514f52
set -U fish_color_history_current --underline=curly
set -U fish_pager_color_progress 3b393c --background=7c7b7d
set -U fish_pager_color_background --background=262427
set -U fish_pager_color_prefix --bold --italics
set -U fish_pager_color_completion normal
set -U fish_pager_color_description fc9d6f
set -U fish_pager_color_selected_background --background=514f52
set -U fish_pager_color_selected_prefix --bold --italics --background=514f52
