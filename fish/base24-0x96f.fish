...
# Set theme
set -Ux BASE24_THEME 0x96f

# Optionally export variables
if test -n "$TINTED_SHELL_ENABLE_BASE24_VARS"; or test -n "$BASE24_SHELL_ENABLE_VARS"
  set -gx BASE24_COLOR_00_HEX "262427"
  set -gx BASE24_COLOR_01_HEX "3b393c"
  set -gx BASE24_COLOR_02_HEX "514f52"
  set -gx BASE24_COLOR_03_HEX "676567"
  set -gx BASE24_COLOR_04_HEX "7c7b7d"
  set -gx BASE24_COLOR_05_HEX "fcfcfc"
  set -gx BASE24_COLOR_06_HEX "eae9eb"
  set -gx BASE24_COLOR_07_HEX "fcfcfc"
  set -gx BASE24_COLOR_08_HEX "ff7272"
  set -gx BASE24_COLOR_09_HEX "fc9d6f"
  set -gx BASE24_COLOR_0A_HEX "ffca58"
  set -gx BASE24_COLOR_0B_HEX "bcdf59"
  set -gx BASE24_COLOR_0C_HEX "aee8f4"
  set -gx BASE24_COLOR_0D_HEX "49cae4"
  set -gx BASE24_COLOR_0E_HEX "a093e2"
  set -gx BASE24_COLOR_0F_HEX "ff8787"
end
