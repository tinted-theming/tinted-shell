...
set -l color08 "88/88/88" # Base 03 - Bright Black
...
set -l color19 "58/58/58" # Base 02
...
if test -n "$ITERM_SESSION_ID"
  ...
  put_template_custom Pj 585858 # selection color
...
set -U fish_color_comment 888888
set -U fish_color_selection ffffff --bold --background=585858
...
set -U fish_color_search_match bryellow --background=585858
set -U fish_color_history_current --bold
set -U fish_pager_color_progress 282828 --background=c8c8c8
...
set -U fish_pager_color_selected_background ffffff --background=585858
set -U fish_pager_color_selected_prefix ffffff --bold --background=585858
...
# Set theme
set -Ux BASE16_THEME da-one-gray
...
if test -n "$TINTED_SHELL_ENABLE_BASE16_VARS"; or test -n "$BASE16_SHELL_ENABLE_VARS"
  ...
  set -gx BASE16_COLOR_02_HEX "585858"
  set -gx BASE16_COLOR_03_HEX "888888"
