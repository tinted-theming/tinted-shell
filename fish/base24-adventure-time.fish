...
set -l color00 "1e/1c/44" # Base 00 - Black
set -l color01 "bc/00/13" # Base 08 - Red
set -l color02 "49/b1/17" # Base 0B - Green
set -l color03 "18/96/c6" # Base 0A - Yellow
set -l color04 "0f/49/c6" # Base 0D - Blue
set -l color05 "66/59/92" # Base 0E - Magenta
set -l color06 "6f/a4/97" # Base 0C - Cyan
set -l color07 "cd/c3/bf" # Base 05 - White
set -l color08 "78/93/bf" # Base 03 - Bright Black
...
set -l color15 "f5/f4/fb" # Base 07 - Bright White
set -l color16 "e6/74/1d" # Base 09
set -l color17 "5e/00/09" # Base 0F
set -l color18 "05/04/04" # Base 01
set -l color19 "4e/7b/bf" # Base 02
set -l color20 "a3/ab/bf" # Base 04
set -l color21 "f8/db/c0" # Base 06
set -l color_foreground "cd/c3/bf" # Base 05
set -l color_background "1e/1c/44" # Base 00
...
set -U fish_color_end cdc3bf
set -U fish_color_error brred
set -U fish_color_param a3abbf
set -U fish_color_valid_path --underline
set -U fish_color_option brcyan
set -U fish_color_comment 7893bf
set -U fish_color_selection f8dbc0 --bold --background=4e7bbf
set -U fish_color_operator brblue
set -U fish_color_escape brcyan
set -U fish_color_autosuggestion 7893bf
...
set -U fish_color_search_match bryellow --background=4e7bbf
set -U fish_color_history_current --bold
set -U fish_pager_color_progress 050404 --background=a3abbf
set -U fish_pager_color_background normal --background=1e1c44
set -U fish_pager_color_prefix normal --bold
set -U fish_pager_color_completion normal
set -U fish_pager_color_description e6741d --dim
set -U fish_pager_color_selected_background f8dbc0 --background=4e7bbf
set -U fish_pager_color_selected_prefix f8dbc0 --bold --background=4e7bbf
set -U fish_pager_color_selected_completion f8dbc0
...
# Set theme
set -Ux BASE24_THEME adventure-time

# Optionally export variables
if test -n "$TINTED_SHELL_ENABLE_BASE24_VARS"; or test -n "$BASE24_SHELL_ENABLE_VARS"
  set -gx BASE24_COLOR_00_HEX "1e1c44"
  set -gx BASE24_COLOR_01_HEX "050404"
  set -gx BASE24_COLOR_02_HEX "4e7bbf"
  set -gx BASE24_COLOR_03_HEX "7893bf"
  set -gx BASE24_COLOR_04_HEX "a3abbf"
  set -gx BASE24_COLOR_05_HEX "cdc3bf"
  set -gx BASE24_COLOR_06_HEX "f8dbc0"
  set -gx BASE24_COLOR_07_HEX "f5f4fb"
  set -gx BASE24_COLOR_08_HEX "bc0013"
  set -gx BASE24_COLOR_09_HEX "e6741d"
  set -gx BASE24_COLOR_0A_HEX "1896c6"
  set -gx BASE24_COLOR_0B_HEX "49b117"
  set -gx BASE24_COLOR_0C_HEX "6fa497"
  set -gx BASE24_COLOR_0D_HEX "0f49c6"
  set -gx BASE24_COLOR_0E_HEX "665992"
  set -gx BASE24_COLOR_0F_HEX "5e0009"
end
