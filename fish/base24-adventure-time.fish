...
set -U fish_color_selection f8dbc0 --background=4e7bbf
set -U fish_color_operator magenta
set -U fish_color_escape e6741d
...
set -U fish_color_search_match yellow --background=4e7bbf
set -U fish_color_history_current --underline=curly
set -U fish_pager_color_progress 050404 --background=a3abbf
set -U fish_pager_color_background --background=1e1c44
set -U fish_pager_color_prefix --bold --italics
set -U fish_pager_color_completion normal
set -U fish_pager_color_description e6741d
set -U fish_pager_color_selected_background --background=4e7bbf
set -U fish_pager_color_selected_prefix --bold --italics --background=4e7bbf
