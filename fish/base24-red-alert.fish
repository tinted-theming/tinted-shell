...
set -U fish_color_selection d6d6d6 --bold --background=262626
...
set -U fish_pager_color_background normal --background=762423
set -U fish_pager_color_prefix normal --bold
set -U fish_pager_color_completion normal
set -U fish_pager_color_description beb86b --dim
set -U fish_pager_color_selected_background d6d6d6 --background=262626
set -U fish_pager_color_selected_prefix d6d6d6 --bold --background=262626
set -U fish_pager_color_selected_completion d6d6d6
