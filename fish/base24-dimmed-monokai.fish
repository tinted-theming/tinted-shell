...
set -l color00 "1e/1e/1e" # Base 00 - Black
set -l color01 "be/3e/48" # Base 08 - Red
set -l color02 "86/9a/3a" # Base 0B - Green
set -l color03 "17/6c/e3" # Base 0A - Yellow
set -l color04 "4e/76/a1" # Base 0D - Blue
set -l color05 "85/5b/8d" # Base 0E - Magenta
set -l color06 "56/8e/a3" # Base 0C - Cyan
set -l color07 "ac/af/ac" # Base 05 - White
set -l color08 "94/95/93" # Base 03 - Bright Black
...
set -l color15 "fc/ff/b8" # Base 07 - Bright White
set -l color16 "c4/a5/35" # Base 09
set -l color17 "5f/1f/24" # Base 0F
set -l color18 "3a/3c/43" # Base 01
set -l color19 "88/89/87" # Base 02
set -l color20 "a0/a2/a0" # Base 04
set -l color21 "b8/bc/b9" # Base 06
set -l color_foreground "ac/af/ac" # Base 05
set -l color_background "1e/1e/1e" # Base 00
...
set -U fish_color_end acafac
set -U fish_color_error brred
set -U fish_color_param a0a2a0
set -U fish_color_valid_path --underline
set -U fish_color_option brcyan
set -U fish_color_comment 949593
set -U fish_color_selection b8bcb9 --bold --background=888987
set -U fish_color_operator brblue
set -U fish_color_escape brcyan
set -U fish_color_autosuggestion 949593
...
set -U fish_color_search_match bryellow --background=888987
set -U fish_color_history_current --bold
set -U fish_pager_color_progress 3a3c43 --background=a0a2a0
set -U fish_pager_color_background normal --background=1e1e1e
set -U fish_pager_color_prefix normal --bold
set -U fish_pager_color_completion normal
set -U fish_pager_color_description c4a535 --dim
set -U fish_pager_color_selected_background b8bcb9 --background=888987
set -U fish_pager_color_selected_prefix b8bcb9 --bold --background=888987
set -U fish_pager_color_selected_completion b8bcb9
...
# Set theme
set -Ux BASE24_THEME dimmed-monokai

# Optionally export variables
if test -n "$TINTED_SHELL_ENABLE_BASE24_VARS"; or test -n "$BASE24_SHELL_ENABLE_VARS"
  set -gx BASE24_COLOR_00_HEX "1e1e1e"
  set -gx BASE24_COLOR_01_HEX "3a3c43"
  set -gx BASE24_COLOR_02_HEX "888987"
  set -gx BASE24_COLOR_03_HEX "949593"
  set -gx BASE24_COLOR_04_HEX "a0a2a0"
  set -gx BASE24_COLOR_05_HEX "acafac"
  set -gx BASE24_COLOR_06_HEX "b8bcb9"
  set -gx BASE24_COLOR_07_HEX "fcffb8"
  set -gx BASE24_COLOR_08_HEX "be3e48"
  set -gx BASE24_COLOR_09_HEX "c4a535"
  set -gx BASE24_COLOR_0A_HEX "176ce3"
  set -gx BASE24_COLOR_0B_HEX "869a3a"
  set -gx BASE24_COLOR_0C_HEX "568ea3"
  set -gx BASE24_COLOR_0D_HEX "4e76a1"
  set -gx BASE24_COLOR_0E_HEX "855b8d"
  set -gx BASE24_COLOR_0F_HEX "5f1f24"
end
