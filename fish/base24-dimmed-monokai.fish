...
set -U fish_color_selection b8bcb9 --background=888987
set -U fish_color_operator magenta
set -U fish_color_escape c4a535
...
set -U fish_color_search_match yellow --background=888987
set -U fish_color_history_current --underline=curly
set -U fish_pager_color_progress 3a3c43 --background=a0a2a0
set -U fish_pager_color_background --background=1e1e1e
set -U fish_pager_color_prefix --bold --italics
set -U fish_pager_color_completion normal
set -U fish_pager_color_description c4a535
set -U fish_pager_color_selected_background --background=888987
set -U fish_pager_color_selected_prefix --bold --italics --background=888987
