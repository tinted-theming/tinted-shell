...
set -l color00 "0f/16/0f" # Base 00 - Black
set -l color01 "7f/2b/26" # Base 08 - Red
set -l color02 "2f/7e/25" # Base 0B - Green
set -l color03 "00/a9/df" # Base 0A - Yellow
set -l color04 "2f/69/7f" # Base 0D - Blue
set -l color05 "47/57/7e" # Base 0E - Magenta
set -l color06 "31/7f/76" # Base 0C - Cyan
set -l color07 "5a/6f/5c" # Base 05 - White
set -l color08 "46/54/2a" # Base 03 - Bright Black
...
set -l color15 "73/f9/90" # Base 07 - Bright White
set -l color16 "70/7f/23" # Base 09
set -l color17 "3f/15/13" # Base 0F
set -l color18 "11/26/15" # Base 01
set -l color19 "3c/47/11" # Base 02
set -l color20 "50/62/43" # Base 04
set -l color21 "64/7d/75" # Base 06
set -l color_foreground "5a/6f/5c" # Base 05
set -l color_background "0f/16/0f" # Base 00
...
set -U fish_color_end 5a6f5c
set -U fish_color_error brred
set -U fish_color_param 506243
set -U fish_color_valid_path --underline
set -U fish_color_option brcyan
set -U fish_color_comment 46542a
set -U fish_color_selection 647d75 --bold --background=3c4711
set -U fish_color_operator brblue
set -U fish_color_escape brcyan
set -U fish_color_autosuggestion 46542a
...
set -U fish_color_search_match bryellow --background=3c4711
set -U fish_color_history_current --bold
set -U fish_pager_color_progress 112615 --background=506243
set -U fish_pager_color_background normal --background=0f160f
set -U fish_pager_color_prefix normal --bold
set -U fish_pager_color_completion normal
set -U fish_pager_color_description 707f23 --dim
set -U fish_pager_color_selected_background 647d75 --background=3c4711
set -U fish_pager_color_selected_prefix 647d75 --bold --background=3c4711
set -U fish_pager_color_selected_completion 647d75
...
# Set theme
set -Ux BASE24_THEME alien-blood

# Optionally export variables
if test -n "$TINTED_SHELL_ENABLE_BASE24_VARS"; or test -n "$BASE24_SHELL_ENABLE_VARS"
  set -gx BASE24_COLOR_00_HEX "0f160f"
  set -gx BASE24_COLOR_01_HEX "112615"
  set -gx BASE24_COLOR_02_HEX "3c4711"
  set -gx BASE24_COLOR_03_HEX "46542a"
  set -gx BASE24_COLOR_04_HEX "506243"
  set -gx BASE24_COLOR_05_HEX "5a6f5c"
  set -gx BASE24_COLOR_06_HEX "647d75"
  set -gx BASE24_COLOR_07_HEX "73f990"
  set -gx BASE24_COLOR_08_HEX "7f2b26"
  set -gx BASE24_COLOR_09_HEX "707f23"
  set -gx BASE24_COLOR_0A_HEX "00a9df"
  set -gx BASE24_COLOR_0B_HEX "2f7e25"
  set -gx BASE24_COLOR_0C_HEX "317f76"
  set -gx BASE24_COLOR_0D_HEX "2f697f"
  set -gx BASE24_COLOR_0E_HEX "47577e"
  set -gx BASE24_COLOR_0F_HEX "3f1513"
end
