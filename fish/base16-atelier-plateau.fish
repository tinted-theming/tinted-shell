...
set -U fish_pager_color_background normal --background=1b1818
set -U fish_pager_color_prefix normal --bold
set -U fish_pager_color_completion normal
set -U fish_pager_color_description b45a3c --dim
set -U fish_pager_color_selected_background e7dfdf --background=585050
set -U fish_pager_color_selected_prefix e7dfdf --bold --background=585050
set -U fish_pager_color_selected_completion e7dfdf
