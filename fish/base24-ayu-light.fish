...
set -U fish_color_selection 4e5257 --background=d2d4d8
set -U fish_color_operator magenta
set -U fish_color_escape fa8d3e
...
set -U fish_color_search_match yellow --background=d2d4d8
set -U fish_color_history_current --underline=curly
set -U fish_pager_color_progress edeff1 --background=8a9199
set -U fish_pager_color_background --background=f8f9fa
set -U fish_pager_color_prefix --bold --italics
set -U fish_pager_color_completion normal
set -U fish_pager_color_description fa8d3e
set -U fish_pager_color_selected_background --background=d2d4d8
set -U fish_pager_color_selected_prefix --bold --italics --background=d2d4d8
