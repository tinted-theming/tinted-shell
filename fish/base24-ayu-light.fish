...
# Set theme
set -Ux BASE24_THEME ayu-light

# Optionally export variables
if test -n "$TINTED_SHELL_ENABLE_BASE24_VARS"; or test -n "$BASE24_SHELL_ENABLE_VARS"
  set -gx BASE24_COLOR_00_HEX "f8f9fa"
  set -gx BASE24_COLOR_01_HEX "edeff1"
  set -gx BASE24_COLOR_02_HEX "d2d4d8"
  set -gx BASE24_COLOR_03_HEX "a0a6ac"
  set -gx BASE24_COLOR_04_HEX "8a9199"
  set -gx BASE24_COLOR_05_HEX "5c6166"
  set -gx BASE24_COLOR_06_HEX "4e5257"
  set -gx BASE24_COLOR_07_HEX "404447"
  set -gx BASE24_COLOR_08_HEX "f07171"
  set -gx BASE24_COLOR_09_HEX "fa8d3e"
  set -gx BASE24_COLOR_0A_HEX "f2ae49"
  set -gx BASE24_COLOR_0B_HEX "6cbf49"
  set -gx BASE24_COLOR_0C_HEX "4cbf99"
  set -gx BASE24_COLOR_0D_HEX "399ee6"
  set -gx BASE24_COLOR_0E_HEX "a37acc"
  set -gx BASE24_COLOR_0F_HEX "e6ba7e"
end
