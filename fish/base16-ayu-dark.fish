...
# Set theme
set -Ux BASE16_THEME ayu-dark

# Optionally export variables
if test -n "$TINTED_SHELL_ENABLE_BASE16_VARS"; or test -n "$BASE16_SHELL_ENABLE_VARS"
  set -gx BASE16_COLOR_00_HEX "0b0e14"
  set -gx BASE16_COLOR_01_HEX "131721"
  set -gx BASE16_COLOR_02_HEX "202229"
  set -gx BASE16_COLOR_03_HEX "3e4b59"
  set -gx BASE16_COLOR_04_HEX "bfbdb6"
  set -gx BASE16_COLOR_05_HEX "e6e1cf"
  set -gx BASE16_COLOR_06_HEX "ece8db"
  set -gx BASE16_COLOR_07_HEX "f2f0e7"
  set -gx BASE16_COLOR_08_HEX "f07178"
  set -gx BASE16_COLOR_09_HEX "ff8f40"
  set -gx BASE16_COLOR_0A_HEX "ffb454"
  set -gx BASE16_COLOR_0B_HEX "aad94c"
  set -gx BASE16_COLOR_0C_HEX "95e6cb"
  set -gx BASE16_COLOR_0D_HEX "59c2ff"
  set -gx BASE16_COLOR_0E_HEX "d2a6ff"
  set -gx BASE16_COLOR_0F_HEX "e6b450"
end
