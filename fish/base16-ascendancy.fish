...
set -l color01 "d0/50/00" # Base 08 - Red
set -l color02 "b8/bb/26" # Base 0B - Green
set -l color03 "ff/cc/1b" # Base 0A - Yellow
set -l color04 "45/85/88" # Base 0D - Blue
set -l color05 "fa/bd/2f" # Base 0E - Magenta
set -l color06 "8f/3f/71" # Base 0C - Cyan
set -l color07 "d5/c7/a1" # Base 05 - White
set -l color08 "92/83/74" # Base 03 - Bright Black
...
set -l color17 "b5/9b/4d" # Base 0F
set -l color18 "21/2f/3d" # Base 01
set -l color19 "50/49/45" # Base 02
set -l color20 "bd/ae/93" # Base 04
set -l color21 "eb/db/b2" # Base 06
set -l color_foreground "d5/c7/a1" # Base 05
...
set -U fish_pager_color_progress 212f3d --background=bdae93
