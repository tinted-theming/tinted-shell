...
set -l color01 "e9/3c/58" # Base 08 - Red
set -l color02 "ef/af/8e" # Base 0B - Green
set -l color03 "ef/b9/93" # Base 0A - Yellow
set -l color04 "df/52/73" # Base 0D - Blue
set -l color05 "b0/72/d1" # Base 0E - Magenta
set -l color06 "24/a8/b4" # Base 0C - Cyan
...
set -l color16 "e5/8d/7d" # Base 09
set -l color17 "e4/a3/82" # Base 0F
...
set -U fish_pager_color_description e58d7d --dim
...
# Set theme
set -Ux BASE16_THEME horizon-dark
...
if test -n "$TINTED_SHELL_ENABLE_BASE16_VARS"; or test -n "$BASE16_SHELL_ENABLE_VARS"
  ...
  set -gx BASE16_COLOR_08_HEX "e93c58"
  set -gx BASE16_COLOR_09_HEX "e58d7d"
  set -gx BASE16_COLOR_0A_HEX "efb993"
  set -gx BASE16_COLOR_0B_HEX "efaf8e"
  set -gx BASE16_COLOR_0C_HEX "24a8b4"
  set -gx BASE16_COLOR_0D_HEX "df5273"
  set -gx BASE16_COLOR_0E_HEX "b072d1"
  set -gx BASE16_COLOR_0F_HEX "e4a382"
end
