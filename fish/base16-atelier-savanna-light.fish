...
set -l color00 "ec/f4/ee" # Base 00 - Black
set -l color01 "b1/61/39" # Base 08 - Red
set -l color02 "48/99/63" # Base 0B - Green
set -l color03 "a0/7e/3b" # Base 0A - Yellow
set -l color04 "47/8c/90" # Base 0D - Blue
set -l color05 "55/85/9b" # Base 0E - Magenta
set -l color06 "1c/9a/a0" # Base 0C - Cyan
set -l color07 "52/60/57" # Base 05 - White
set -l color08 "78/87/7d" # Base 03 - Bright Black
...
set -l color15 "17/1c/19" # Base 07 - Bright White
set -l color16 "9f/71/3c" # Base 09
set -l color17 "86/74/69" # Base 0F
set -l color18 "df/e7/e2" # Base 01
set -l color19 "87/92/8a" # Base 02
set -l color20 "5f/6d/64" # Base 04
set -l color21 "23/2a/25" # Base 06
set -l color_foreground "52/60/57" # Base 05
set -l color_background "ec/f4/ee" # Base 00
...
set -U fish_color_end 526057
set -U fish_color_error brred
set -U fish_color_param 5f6d64
set -U fish_color_valid_path --underline
set -U fish_color_option brcyan
set -U fish_color_comment 78877d
set -U fish_color_selection 232a25 --bold --background=87928a
set -U fish_color_operator brblue
set -U fish_color_escape brcyan
set -U fish_color_autosuggestion 78877d
...
set -U fish_pager_color_progress dfe7e2 --background=5f6d64
set -U fish_pager_color_background normal --background=ecf4ee
set -U fish_pager_color_prefix normal --bold
set -U fish_pager_color_completion normal
set -U fish_pager_color_description 9f713c --dim
set -U fish_pager_color_selected_background 232a25 --background=87928a
set -U fish_pager_color_selected_prefix 232a25 --bold --background=87928a
set -U fish_pager_color_selected_completion 232a25
...
# Set theme
set -Ux BASE16_THEME atelier-savanna-light

# Optionally export variables
if test -n "$TINTED_SHELL_ENABLE_BASE16_VARS"; or test -n "$BASE16_SHELL_ENABLE_VARS"
  set -gx BASE16_COLOR_00_HEX "ecf4ee"
  set -gx BASE16_COLOR_01_HEX "dfe7e2"
  set -gx BASE16_COLOR_02_HEX "87928a"
  set -gx BASE16_COLOR_03_HEX "78877d"
  set -gx BASE16_COLOR_04_HEX "5f6d64"
  set -gx BASE16_COLOR_05_HEX "526057"
  set -gx BASE16_COLOR_06_HEX "232a25"
  set -gx BASE16_COLOR_07_HEX "171c19"
  set -gx BASE16_COLOR_08_HEX "b16139"
  set -gx BASE16_COLOR_09_HEX "9f713c"
  set -gx BASE16_COLOR_0A_HEX "a07e3b"
  set -gx BASE16_COLOR_0B_HEX "489963"
  set -gx BASE16_COLOR_0C_HEX "1c9aa0"
  set -gx BASE16_COLOR_0D_HEX "478c90"
  set -gx BASE16_COLOR_0E_HEX "55859b"
  set -gx BASE16_COLOR_0F_HEX "867469"
end
