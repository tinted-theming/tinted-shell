...
set -l color00 "f5/f4/f0" # Base 00 - Black
set -l color01 "9e/3e/3e" # Base 08 - Red
set -l color02 "38/70/50" # Base 0B - Green
set -l color03 "7d/68/20" # Base 0A - Yellow
set -l color04 "34/68/a8" # Base 0D - Blue
set -l color05 "64/38/a0" # Base 0E - Magenta
set -l color06 "28/70/70" # Base 0C - Cyan
set -l color07 "1f/1c/16" # Base 05 - White
set -l color08 "91/88/7d" # Base 03 - Bright Black
...
set -l color15 "fe/fc/fa" # Base 07 - Bright White
set -l color16 "8f/5d/22" # Base 09
set -l color17 "94/3a/68" # Base 0F
set -l color18 "e8/e7/e3" # Base 01
set -l color19 "d5/d2/cb" # Base 02
set -l color20 "74/6c/62" # Base 04
set -l color21 "6e/64/59" # Base 06
set -l color_foreground "1f/1c/16" # Base 05
set -l color_background "f5/f4/f0" # Base 00
...
set -U fish_color_end 1f1c16
set -U fish_color_error brred
set -U fish_color_param 746c62
set -U fish_color_valid_path --underline
set -U fish_color_option brcyan
set -U fish_color_comment 91887d
set -U fish_color_selection 6e6459 --bold --background=d5d2cb
set -U fish_color_operator brblue
set -U fish_color_escape brcyan
set -U fish_color_autosuggestion 91887d
...
set -U fish_color_search_match bryellow --background=d5d2cb
set -U fish_color_history_current --bold
set -U fish_pager_color_progress e8e7e3 --background=746c62
set -U fish_pager_color_background normal --background=f5f4f0
set -U fish_pager_color_prefix normal --bold
set -U fish_pager_color_completion normal
set -U fish_pager_color_description 8f5d22 --dim
set -U fish_pager_color_selected_background 6e6459 --background=d5d2cb
set -U fish_pager_color_selected_prefix 6e6459 --bold --background=d5d2cb
set -U fish_pager_color_selected_completion 6e6459
...
# Set theme
set -Ux BASE16_THEME kissa-latte

# Optionally export variables
if test -n "$TINTED_SHELL_ENABLE_BASE16_VARS"; or test -n "$BASE16_SHELL_ENABLE_VARS"
  set -gx BASE16_COLOR_00_HEX "f5f4f0"
  set -gx BASE16_COLOR_01_HEX "e8e7e3"
  set -gx BASE16_COLOR_02_HEX "d5d2cb"
  set -gx BASE16_COLOR_03_HEX "91887d"
  set -gx BASE16_COLOR_04_HEX "746c62"
  set -gx BASE16_COLOR_05_HEX "1f1c16"
  set -gx BASE16_COLOR_06_HEX "6e6459"
  set -gx BASE16_COLOR_07_HEX "fefcfa"
  set -gx BASE16_COLOR_08_HEX "9e3e3e"
  set -gx BASE16_COLOR_09_HEX "8f5d22"
  set -gx BASE16_COLOR_0A_HEX "7d6820"
  set -gx BASE16_COLOR_0B_HEX "387050"
  set -gx BASE16_COLOR_0C_HEX "287070"
  set -gx BASE16_COLOR_0D_HEX "3468a8"
  set -gx BASE16_COLOR_0E_HEX "6438a0"
  set -gx BASE16_COLOR_0F_HEX "943a68"
end
