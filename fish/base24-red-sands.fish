...
set -l color00 "79/24/1e" # Base 00 - Black
set -l color01 "ff/3f/00" # Base 08 - Red
set -l color02 "00/bb/00" # Base 0B - Green
set -l color03 "00/71/ae" # Base 0A - Yellow
set -l color04 "00/71/ff" # Base 0D - Blue
set -l color05 "bb/00/bb" # Base 0E - Magenta
set -l color06 "00/bb/bb" # Base 0C - Cyan
set -l color07 "a1/a1/a1" # Base 05 - White
set -l color08 "6e/6e/6e" # Base 03 - Bright Black
...
set -l color16 "e7/b0/00" # Base 09
set -l color17 "7f/1f/00" # Base 0F
set -l color18 "00/00/00" # Base 01
set -l color19 "55/55/55" # Base 02
set -l color20 "88/88/88" # Base 04
set -l color21 "bb/bb/bb" # Base 06
set -l color_foreground "a1/a1/a1" # Base 05
set -l color_background "79/24/1e" # Base 00
...
if test -n "$ITERM_SESSION_ID"
  ...
  put_template_custom Ph 79241e # background
  ...
  put_template_custom Pm 79241e # cursor text
else
...
set -U fish_color_end a1a1a1
set -U fish_color_error brred
set -U fish_color_param 888888
set -U fish_color_valid_path --underline
set -U fish_color_option brcyan
set -U fish_color_comment 6e6e6e
set -U fish_color_selection bbbbbb --bold --background=555555
set -U fish_color_operator brblue
set -U fish_color_escape brcyan
set -U fish_color_autosuggestion 6e6e6e
...
set -U fish_pager_color_progress 000000 --background=888888
set -U fish_pager_color_background normal --background=79241e
set -U fish_pager_color_prefix normal --bold
set -U fish_pager_color_completion normal
set -U fish_pager_color_description e7b000 --dim
set -U fish_pager_color_selected_background bbbbbb --background=555555
set -U fish_pager_color_selected_prefix bbbbbb --bold --background=555555
set -U fish_pager_color_selected_completion bbbbbb
...
# Set theme
set -Ux BASE24_THEME red-sands

# Optionally export variables
if test -n "$TINTED_SHELL_ENABLE_BASE24_VARS"; or test -n "$BASE24_SHELL_ENABLE_VARS"
  set -gx BASE24_COLOR_00_HEX "79241e"
  set -gx BASE24_COLOR_01_HEX "000000"
  set -gx BASE24_COLOR_02_HEX "555555"
  set -gx BASE24_COLOR_03_HEX "6e6e6e"
  set -gx BASE24_COLOR_04_HEX "888888"
  set -gx BASE24_COLOR_05_HEX "a1a1a1"
  set -gx BASE24_COLOR_06_HEX "bbbbbb"
  set -gx BASE24_COLOR_07_HEX "ffffff"
  set -gx BASE24_COLOR_08_HEX "ff3f00"
  set -gx BASE24_COLOR_09_HEX "e7b000"
  set -gx BASE24_COLOR_0A_HEX "0071ae"
  set -gx BASE24_COLOR_0B_HEX "00bb00"
  set -gx BASE24_COLOR_0C_HEX "00bbbb"
  set -gx BASE24_COLOR_0D_HEX "0071ff"
  set -gx BASE24_COLOR_0E_HEX "bb00bb"
  set -gx BASE24_COLOR_0F_HEX "7f1f00"
end
