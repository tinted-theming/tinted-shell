...
set -l color07 "80/80/80" # Base 05 - White
...
set -l color16 "ff/ff/00" # Base 09
set -l color17 "00/ff/00" # Base 0F
set -l color18 "ea/ea/ea" # Base 01
set -l color19 "d5/d5/d5" # Base 02
set -l color20 "a0/a0/a0" # Base 04
set -l color21 "40/40/40" # Base 06
set -l color_foreground "80/80/80" # Base 05
...
set -U fish_pager_color_progress eaeaea --background=a0a0a0
set -U fish_pager_color_background normal --background=ffffff
set -U fish_pager_color_prefix normal --bold
set -U fish_pager_color_completion normal
set -U fish_pager_color_description ffff00 --dim
set -U fish_pager_color_selected_background 404040 --background=d5d5d5
set -U fish_pager_color_selected_prefix 404040 --bold --background=d5d5d5
...
if test -n "$TINTED_SHELL_ENABLE_BASE16_VARS"; or test -n "$BASE16_SHELL_ENABLE_VARS"
  ...
  set -gx BASE16_COLOR_0F_HEX "00ff00"
end
