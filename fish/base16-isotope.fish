...
set -l color02 "33/ff/00" # Base 0B - Green
set -l color03 "ff/00/99" # Base 0A - Yellow
set -l color04 "00/66/ff" # Base 0D - Blue
set -l color05 "cc/00/ff" # Base 0E - Magenta
...
set -l color16 "ff/99/00" # Base 09
set -l color17 "33/00/ff" # Base 0F
...
set -U fish_color_selection e0e0e0 --bold --background=606060
...
set -U fish_pager_color_progress 404040 --background=c0c0c0
set -U fish_pager_color_background normal --background=000000
set -U fish_pager_color_prefix normal --bold
set -U fish_pager_color_completion normal
set -U fish_pager_color_description ff9900 --dim
set -U fish_pager_color_selected_background e0e0e0 --background=606060
set -U fish_pager_color_selected_prefix e0e0e0 --bold --background=606060
...
if test -n "$TINTED_SHELL_ENABLE_BASE16_VARS"; or test -n "$BASE16_SHELL_ENABLE_VARS"
  ...
  set -gx BASE16_COLOR_04_HEX "c0c0c0"
  ...
  set -gx BASE16_COLOR_09_HEX "ff9900"
  set -gx BASE16_COLOR_0A_HEX "ff0099"
  set -gx BASE16_COLOR_0B_HEX "33ff00"
  set -gx BASE16_COLOR_0C_HEX "00ffff"
  set -gx BASE16_COLOR_0D_HEX "0066ff"
  set -gx BASE16_COLOR_0E_HEX "cc00ff"
  set -gx BASE16_COLOR_0F_HEX "3300ff"
end
