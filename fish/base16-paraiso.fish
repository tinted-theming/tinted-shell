...
set -l color00 "2f/1e/2e" # Base 00 - Black
set -l color01 "ef/61/55" # Base 08 - Red
set -l color02 "48/b6/85" # Base 0B - Green
set -l color03 "fe/c4/18" # Base 0A - Yellow
set -l color04 "06/b6/ef" # Base 0D - Blue
set -l color05 "81/5b/a4" # Base 0E - Magenta
set -l color06 "5b/c4/bf" # Base 0C - Cyan
set -l color07 "a3/9e/9b" # Base 05 - White
set -l color08 "77/6e/71" # Base 03 - Bright Black
...
set -l color15 "e7/e9/db" # Base 07 - Bright White
set -l color16 "f9/9b/15" # Base 09
set -l color17 "e9/6b/a8" # Base 0F
set -l color18 "41/32/3f" # Base 01
set -l color19 "4f/42/4c" # Base 02
set -l color20 "8d/86/87" # Base 04
set -l color21 "b9/b6/b0" # Base 06
set -l color_foreground "a3/9e/9b" # Base 05
set -l color_background "2f/1e/2e" # Base 00
...
set -U fish_color_end a39e9b
set -U fish_color_error brred
set -U fish_color_param 8d8687
set -U fish_color_valid_path --underline
set -U fish_color_option brcyan
set -U fish_color_comment 776e71
set -U fish_color_selection b9b6b0 --bold --background=4f424c
set -U fish_color_operator brblue
set -U fish_color_escape brcyan
set -U fish_color_autosuggestion 776e71
...
set -U fish_pager_color_progress 41323f --background=8d8687
set -U fish_pager_color_background normal --background=2f1e2e
set -U fish_pager_color_prefix normal --bold
set -U fish_pager_color_completion normal
set -U fish_pager_color_description f99b15 --dim
set -U fish_pager_color_selected_background b9b6b0 --background=4f424c
set -U fish_pager_color_selected_prefix b9b6b0 --bold --background=4f424c
set -U fish_pager_color_selected_completion b9b6b0
...
# Set theme
set -Ux BASE16_THEME paraiso

# Optionally export variables
if test -n "$TINTED_SHELL_ENABLE_BASE16_VARS"; or test -n "$BASE16_SHELL_ENABLE_VARS"
  set -gx BASE16_COLOR_00_HEX "2f1e2e"
  set -gx BASE16_COLOR_01_HEX "41323f"
  set -gx BASE16_COLOR_02_HEX "4f424c"
  set -gx BASE16_COLOR_03_HEX "776e71"
  set -gx BASE16_COLOR_04_HEX "8d8687"
  set -gx BASE16_COLOR_05_HEX "a39e9b"
  set -gx BASE16_COLOR_06_HEX "b9b6b0"
  set -gx BASE16_COLOR_07_HEX "e7e9db"
  set -gx BASE16_COLOR_08_HEX "ef6155"
  set -gx BASE16_COLOR_09_HEX "f99b15"
  set -gx BASE16_COLOR_0A_HEX "fec418"
  set -gx BASE16_COLOR_0B_HEX "48b685"
  set -gx BASE16_COLOR_0C_HEX "5bc4bf"
  set -gx BASE16_COLOR_0D_HEX "06b6ef"
  set -gx BASE16_COLOR_0E_HEX "815ba4"
  set -gx BASE16_COLOR_0F_HEX "e96ba8"
end
