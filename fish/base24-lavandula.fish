...
set -l color00 "05/00/14" # Base 00 - Black
set -l color01 "7c/15/25" # Base 08 - Red
set -l color02 "33/7e/6f" # Base 0B - Green
set -l color03 "8e/86/df" # Base 0A - Yellow
set -l color04 "4f/4a/7f" # Base 0D - Blue
set -l color05 "59/3f/7e" # Base 0E - Magenta
set -l color06 "57/76/7f" # Base 0C - Cyan
set -l color07 "64/5d/6f" # Base 05 - White
set -l color08 "46/3c/53" # Base 03 - Bright Black
...
set -l color15 "8c/91/fa" # Base 07 - Bright White
set -l color16 "7f/6f/49" # Base 09
set -l color17 "3e/0a/12" # Base 0F
set -l color18 "23/00/45" # Base 01
set -l color19 "37/2c/46" # Base 02
set -l color20 "55/4d/61" # Base 04
set -l color21 "73/6e/7d" # Base 06
set -l color_foreground "64/5d/6f" # Base 05
set -l color_background "05/00/14" # Base 00
...
set -U fish_color_end 645d6f
set -U fish_color_error brred
set -U fish_color_param 554d61
set -U fish_color_valid_path --underline
set -U fish_color_option brcyan
set -U fish_color_comment 463c53
set -U fish_color_selection 736e7d --bold --background=372c46
set -U fish_color_operator brblue
set -U fish_color_escape brcyan
set -U fish_color_autosuggestion 463c53
...
set -U fish_color_search_match bryellow --background=372c46
set -U fish_color_history_current --bold
set -U fish_pager_color_progress 230045 --background=554d61
set -U fish_pager_color_background normal --background=050014
set -U fish_pager_color_prefix normal --bold
set -U fish_pager_color_completion normal
set -U fish_pager_color_description 7f6f49 --dim
set -U fish_pager_color_selected_background 736e7d --background=372c46
set -U fish_pager_color_selected_prefix 736e7d --bold --background=372c46
set -U fish_pager_color_selected_completion 736e7d
...
# Set theme
set -Ux BASE24_THEME lavandula

# Optionally export variables
if test -n "$TINTED_SHELL_ENABLE_BASE24_VARS"; or test -n "$BASE24_SHELL_ENABLE_VARS"
  set -gx BASE24_COLOR_00_HEX "050014"
  set -gx BASE24_COLOR_01_HEX "230045"
  set -gx BASE24_COLOR_02_HEX "372c46"
  set -gx BASE24_COLOR_03_HEX "463c53"
  set -gx BASE24_COLOR_04_HEX "554d61"
  set -gx BASE24_COLOR_05_HEX "645d6f"
  set -gx BASE24_COLOR_06_HEX "736e7d"
  set -gx BASE24_COLOR_07_HEX "8c91fa"
  set -gx BASE24_COLOR_08_HEX "7c1525"
  set -gx BASE24_COLOR_09_HEX "7f6f49"
  set -gx BASE24_COLOR_0A_HEX "8e86df"
  set -gx BASE24_COLOR_0B_HEX "337e6f"
  set -gx BASE24_COLOR_0C_HEX "57767f"
  set -gx BASE24_COLOR_0D_HEX "4f4a7f"
  set -gx BASE24_COLOR_0E_HEX "593f7e"
  set -gx BASE24_COLOR_0F_HEX "3e0a12"
end
