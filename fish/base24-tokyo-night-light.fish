...
set -l color01 "34/3b/59" # Base 08 - Red
set -l color02 "48/5e/30" # Base 0B - Green
set -l color03 "16/67/75" # Base 0A - Yellow
set -l color04 "34/54/8a" # Base 0D - Blue
set -l color05 "5a/4a/78" # Base 0E - Magenta
set -l color06 "3e/69/68" # Base 0C - Cyan
set -l color07 "34/3b/59" # Base 05 - White
...
# Set theme
set -Ux BASE24_THEME tokyo-night-light

# Optionally export variables
if test -n "$TINTED_SHELL_ENABLE_BASE24_VARS"; or test -n "$BASE24_SHELL_ENABLE_VARS"
  set -gx BASE24_COLOR_00_HEX "d5d6db"
  set -gx BASE24_COLOR_01_HEX "cbccd1"
  set -gx BASE24_COLOR_02_HEX "dfe0e5"
  set -gx BASE24_COLOR_03_HEX "9699a3"
  set -gx BASE24_COLOR_04_HEX "4c505e"
  set -gx BASE24_COLOR_05_HEX "343b59"
  set -gx BASE24_COLOR_06_HEX "1a1b26"
  set -gx BASE24_COLOR_07_HEX "1a1b26"
  set -gx BASE24_COLOR_08_HEX "343b59"
  set -gx BASE24_COLOR_09_HEX "965027"
  set -gx BASE24_COLOR_0A_HEX "166775"
  set -gx BASE24_COLOR_0B_HEX "485e30"
  set -gx BASE24_COLOR_0C_HEX "3e6968"
  set -gx BASE24_COLOR_0D_HEX "34548a"
  set -gx BASE24_COLOR_0E_HEX "5a4a78"
  set -gx BASE24_COLOR_0F_HEX "8c4351"
end
