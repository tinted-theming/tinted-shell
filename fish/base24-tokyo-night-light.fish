...
set -U fish_color_selection 1a1b26 --background=dfe0e5
set -U fish_color_operator magenta
set -U fish_color_escape 965027
...
set -U fish_color_search_match yellow --background=dfe0e5
set -U fish_color_history_current --underline=curly
set -U fish_pager_color_progress cbccd1 --background=4c505e
set -U fish_pager_color_background --background=d5d6db
set -U fish_pager_color_prefix --bold --italics
set -U fish_pager_color_completion normal
set -U fish_pager_color_description 965027
set -U fish_pager_color_selected_background --background=dfe0e5
set -U fish_pager_color_selected_prefix --bold --italics --background=dfe0e5
