...
set -l color00 "2b/21/3c" # Base 00 - Black
set -l color01 "c7/99/87" # Base 08 - Red
set -l color02 "ac/c7/9b" # Base 0B - Green
set -l color03 "c7/c6/91" # Base 0A - Yellow
set -l color04 "a5/aa/d4" # Base 0D - Blue
set -l color05 "c5/94/ff" # Base 0E - Magenta
set -l color06 "9b/c7/bf" # Base 0C - Cyan
set -l color07 "99/8b/ad" # Base 05 - White
set -l color08 "65/59/78" # Base 03 - Bright Black
...
set -l color15 "eb/dc/ff" # Base 07 - Bright White
set -l color16 "88/65/c6" # Base 09
set -l color17 "c7/ab/87" # Base 0F
set -l color18 "36/2b/48" # Base 01
set -l color19 "4d/41/60" # Base 02
set -l color20 "7f/71/92" # Base 04
set -l color21 "b4/a5/c8" # Base 06
set -l color_foreground "99/8b/ad" # Base 05
set -l color_background "2b/21/3c" # Base 00
...
set -U fish_color_end 998bad
set -U fish_color_error brred
set -U fish_color_param 7f7192
set -U fish_color_valid_path --underline
set -U fish_color_option brcyan
set -U fish_color_comment 655978
set -U fish_color_selection b4a5c8 --bold --background=4d4160
set -U fish_color_operator brblue
set -U fish_color_escape brcyan
set -U fish_color_autosuggestion 655978
...
set -U fish_color_search_match bryellow --background=4d4160
set -U fish_color_history_current --bold
set -U fish_pager_color_progress 362b48 --background=7f7192
set -U fish_pager_color_background normal --background=2b213c
set -U fish_pager_color_prefix normal --bold
set -U fish_pager_color_completion normal
set -U fish_pager_color_description 8865c6 --dim
set -U fish_pager_color_selected_background b4a5c8 --background=4d4160
set -U fish_pager_color_selected_prefix b4a5c8 --bold --background=4d4160
set -U fish_pager_color_selected_completion b4a5c8
...
# Set theme
set -Ux BASE16_THEME stella

# Optionally export variables
if test -n "$TINTED_SHELL_ENABLE_BASE16_VARS"; or test -n "$BASE16_SHELL_ENABLE_VARS"
  set -gx BASE16_COLOR_00_HEX "2b213c"
  set -gx BASE16_COLOR_01_HEX "362b48"
  set -gx BASE16_COLOR_02_HEX "4d4160"
  set -gx BASE16_COLOR_03_HEX "655978"
  set -gx BASE16_COLOR_04_HEX "7f7192"
  set -gx BASE16_COLOR_05_HEX "998bad"
  set -gx BASE16_COLOR_06_HEX "b4a5c8"
  set -gx BASE16_COLOR_07_HEX "ebdcff"
  set -gx BASE16_COLOR_08_HEX "c79987"
  set -gx BASE16_COLOR_09_HEX "8865c6"
  set -gx BASE16_COLOR_0A_HEX "c7c691"
  set -gx BASE16_COLOR_0B_HEX "acc79b"
  set -gx BASE16_COLOR_0C_HEX "9bc7bf"
  set -gx BASE16_COLOR_0D_HEX "a5aad4"
  set -gx BASE16_COLOR_0E_HEX "c594ff"
  set -gx BASE16_COLOR_0F_HEX "c7ab87"
end
