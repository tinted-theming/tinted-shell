...
set -l color02 "5e/de/8f" # Base 0B - Green
set -l color03 "55/55/ff" # Base 0A - Yellow
set -l color04 "26/6a/d7" # Base 0D - Blue
...
# Set theme
set -Ux BASE24_THEME night-lion-v1
...
if test -n "$TINTED_SHELL_ENABLE_BASE24_VARS"; or test -n "$BASE24_SHELL_ENABLE_VARS"
  ...
  set -gx BASE24_COLOR_0A_HEX "5555ff"
  set -gx BASE24_COLOR_0B_HEX "5ede8f"
  set -gx BASE24_COLOR_0C_HEX "00d9df"
  set -gx BASE24_COLOR_0D_HEX "266ad7"
