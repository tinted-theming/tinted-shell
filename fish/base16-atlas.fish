...
set -U fish_pager_color_background normal --background=002635
set -U fish_pager_color_prefix normal --bold
set -U fish_pager_color_completion normal
set -U fish_pager_color_description f08e48 --dim
set -U fish_pager_color_selected_background e6e6dc --background=517f8d
set -U fish_pager_color_selected_prefix e6e6dc --bold --background=517f8d
set -U fish_pager_color_selected_completion e6e6dc
