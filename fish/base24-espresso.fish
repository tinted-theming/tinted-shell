...
set -l color01 "d2/51/51" # Base 08 - Red
set -l color02 "a5/c2/61" # Base 0B - Green
set -l color03 "8a/b7/d9" # Base 0A - Yellow
set -l color04 "6c/99/bb" # Base 0D - Blue
set -l color05 "d1/97/d9" # Base 0E - Magenta
...
set -l color17 "69/28/28" # Base 0F
set -l color18 "34/34/34" # Base 01
...
set -U fish_pager_color_progress 343434 --background=a0a09f
...
if test -n "$TINTED_SHELL_ENABLE_BASE24_VARS"; or test -n "$BASE24_SHELL_ENABLE_VARS"
  ...
  set -gx BASE24_COLOR_08_HEX "d25151"
  set -gx BASE24_COLOR_09_HEX "ffc66d"
  set -gx BASE24_COLOR_0A_HEX "8ab7d9"
  set -gx BASE24_COLOR_0B_HEX "a5c261"
  set -gx BASE24_COLOR_0C_HEX "bed6ff"
  set -gx BASE24_COLOR_0D_HEX "6c99bb"
  set -gx BASE24_COLOR_0E_HEX "d197d9"
  set -gx BASE24_COLOR_0F_HEX "692828"
end
