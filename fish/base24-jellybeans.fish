...
set -U fish_color_selection dedede --background=bdbdbd
set -U fish_color_operator magenta
set -U fish_color_escape ffba7b
...
set -U fish_pager_color_background --background=121212
set -U fish_pager_color_prefix --bold --italics
set -U fish_pager_color_completion normal
set -U fish_pager_color_description ffba7b
