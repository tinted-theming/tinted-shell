...
set -l color00 "12/12/12" # Base 00 - Black
set -l color01 "e2/73/73" # Base 08 - Red
set -l color02 "93/b9/79" # Base 0B - Green
set -l color03 "b1/d8/f6" # Base 0A - Yellow
set -l color04 "97/be/dc" # Base 0D - Blue
set -l color05 "e1/c0/fa" # Base 0E - Magenta
set -l color06 "00/98/8e" # Base 0C - Cyan
set -l color07 "d5/d5/d5" # Base 05 - White
set -l color08 "c5/c5/c5" # Base 03 - Bright Black
...
set -l color16 "ff/ba/7b" # Base 09
set -l color17 "71/39/39" # Base 0F
set -l color18 "92/92/92" # Base 01
...
set -l color_background "12/12/12" # Base 00
...
set -U fish_color_comment c5c5c5
set -U fish_color_selection dedede --bold --background=bdbdbd
set -U fish_color_operator brblue
set -U fish_color_escape brcyan
set -U fish_color_autosuggestion c5c5c5
...
set -U fish_color_search_match bryellow --background=bdbdbd
set -U fish_color_history_current --bold
set -U fish_pager_color_progress 929292 --background=cdcdcd
set -U fish_pager_color_background normal --background=121212
set -U fish_pager_color_prefix normal --bold
set -U fish_pager_color_completion normal
set -U fish_pager_color_description ffba7b --dim
set -U fish_pager_color_selected_background dedede --background=bdbdbd
set -U fish_pager_color_selected_prefix dedede --bold --background=bdbdbd
...
# Set theme
set -Ux BASE24_THEME jellybeans

# Optionally export variables
if test -n "$TINTED_SHELL_ENABLE_BASE24_VARS"; or test -n "$BASE24_SHELL_ENABLE_VARS"
  set -gx BASE24_COLOR_00_HEX "121212"
  set -gx BASE24_COLOR_01_HEX "929292"
  set -gx BASE24_COLOR_02_HEX "bdbdbd"
  set -gx BASE24_COLOR_03_HEX "c5c5c5"
  set -gx BASE24_COLOR_04_HEX "cdcdcd"
  set -gx BASE24_COLOR_05_HEX "d5d5d5"
  set -gx BASE24_COLOR_06_HEX "dedede"
  set -gx BASE24_COLOR_07_HEX "ffffff"
  set -gx BASE24_COLOR_08_HEX "e27373"
  set -gx BASE24_COLOR_09_HEX "ffba7b"
  set -gx BASE24_COLOR_0A_HEX "b1d8f6"
  set -gx BASE24_COLOR_0B_HEX "93b979"
  set -gx BASE24_COLOR_0C_HEX "00988e"
  set -gx BASE24_COLOR_0D_HEX "97bedc"
  set -gx BASE24_COLOR_0E_HEX "e1c0fa"
  set -gx BASE24_COLOR_0F_HEX "713939"
end
