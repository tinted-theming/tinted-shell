...
set -l color00 "f5/f7/fa" # Base 00 - Black
set -l color01 "ef/52/53" # Base 08 - Red
set -l color02 "7c/c8/44" # Base 0B - Green
set -l color03 "e4/b5/1c" # Base 0A - Yellow
set -l color04 "33/b5/e1" # Base 0D - Blue
set -l color05 "a3/63/d5" # Base 0E - Magenta
set -l color06 "52/cb/b0" # Base 0C - Cyan
set -l color07 "58/68/75" # Base 05 - White
set -l color08 "85/93/9e" # Base 03 - Bright Black
...
set -l color15 "18/26/2f" # Base 07 - Bright White
set -l color16 "e6/6b/2b" # Base 09
set -l color17 "d7/3c/9a" # Base 0F
set -l color18 "e8/e9/ed" # Base 01
set -l color19 "a6/af/b8" # Base 02
set -l color20 "66/75/81" # Base 04
set -l color21 "22/2e/38" # Base 06
set -l color_foreground "58/68/75" # Base 05
set -l color_background "f5/f7/fa" # Base 00
...
set -U fish_color_end 586875
set -U fish_color_error brred
set -U fish_color_param 667581
set -U fish_color_valid_path --underline
set -U fish_color_option brcyan
set -U fish_color_comment 85939e
set -U fish_color_selection 222e38 --bold --background=a6afb8
set -U fish_color_operator brblue
set -U fish_color_escape brcyan
set -U fish_color_autosuggestion 85939e
...
set -U fish_pager_color_progress e8e9ed --background=667581
set -U fish_pager_color_background normal --background=f5f7fa
set -U fish_pager_color_prefix normal --bold
set -U fish_pager_color_completion normal
set -U fish_pager_color_description e66b2b --dim
set -U fish_pager_color_selected_background 222e38 --background=a6afb8
set -U fish_pager_color_selected_prefix 222e38 --bold --background=a6afb8
set -U fish_pager_color_selected_completion 222e38
...
# Set theme
set -Ux BASE16_THEME solarflare-light

# Optionally export variables
if test -n "$TINTED_SHELL_ENABLE_BASE16_VARS"; or test -n "$BASE16_SHELL_ENABLE_VARS"
  set -gx BASE16_COLOR_00_HEX "f5f7fa"
  set -gx BASE16_COLOR_01_HEX "e8e9ed"
  set -gx BASE16_COLOR_02_HEX "a6afb8"
  set -gx BASE16_COLOR_03_HEX "85939e"
  set -gx BASE16_COLOR_04_HEX "667581"
  set -gx BASE16_COLOR_05_HEX "586875"
  set -gx BASE16_COLOR_06_HEX "222e38"
  set -gx BASE16_COLOR_07_HEX "18262f"
  set -gx BASE16_COLOR_08_HEX "ef5253"
  set -gx BASE16_COLOR_09_HEX "e66b2b"
  set -gx BASE16_COLOR_0A_HEX "e4b51c"
  set -gx BASE16_COLOR_0B_HEX "7cc844"
  set -gx BASE16_COLOR_0C_HEX "52cbb0"
  set -gx BASE16_COLOR_0D_HEX "33b5e1"
  set -gx BASE16_COLOR_0E_HEX "a363d5"
  set -gx BASE16_COLOR_0F_HEX "d73c9a"
end
