...
set -l color01 "c0/99/ff" # Base 08 - Red
...
set -l color07 "c8/d3/f5" # Base 05 - White
set -l color08 "44/4a/73" # Base 03 - Bright Black
...
set -l color19 "2f/33/4d" # Base 02
set -l color20 "82/8b/b8" # Base 04
set -l color21 "b4/c2/f0" # Base 06
set -l color_foreground "c8/d3/f5" # Base 05
...
set -U fish_color_end c8d3f5
set -U fish_color_error brred
set -U fish_color_param 828bb8
set -U fish_color_valid_path --underline
set -U fish_color_option brcyan
set -U fish_color_comment 444a73
set -U fish_color_selection b4c2f0 --bold --background=2f334d
set -U fish_color_operator brblue
set -U fish_color_escape brcyan
set -U fish_color_autosuggestion 444a73
...
set -U fish_color_search_match bryellow --background=2f334d
set -U fish_color_history_current --bold
set -U fish_pager_color_progress 1e2030 --background=828bb8
...
set -U fish_pager_color_selected_background b4c2f0 --background=2f334d
set -U fish_pager_color_selected_prefix b4c2f0 --bold --background=2f334d
set -U fish_pager_color_selected_completion b4c2f0
...
# Set theme
set -Ux BASE24_THEME tokyo-night-moon
...
if test -n "$TINTED_SHELL_ENABLE_BASE24_VARS"; or test -n "$BASE24_SHELL_ENABLE_VARS"
  ...
  set -gx BASE24_COLOR_02_HEX "2f334d"
  set -gx BASE24_COLOR_03_HEX "444a73"
  set -gx BASE24_COLOR_04_HEX "828bb8"
  set -gx BASE24_COLOR_05_HEX "c8d3f5"
  set -gx BASE24_COLOR_06_HEX "b4c2f0"
  set -gx BASE24_COLOR_07_HEX "c8d3f5"
  set -gx BASE24_COLOR_08_HEX "c099ff"
  set -gx BASE24_COLOR_09_HEX "ffc777"
  set -gx BASE24_COLOR_0A_HEX "ffc777"
  set -gx BASE24_COLOR_0B_HEX "c3e88d"
  set -gx BASE24_COLOR_0C_HEX "86e1fc"
  set -gx BASE24_COLOR_0D_HEX "82aaff"
  set -gx BASE24_COLOR_0E_HEX "fca7ea"
  set -gx BASE24_COLOR_0F_HEX "c53b53"
end
