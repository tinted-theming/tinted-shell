...
set -l color19 "32/37/4d" # Base 02
...
set -U fish_color_selection 959dcb --bold --background=32374d
...
set -U fish_pager_color_selected_background 959dcb --background=32374d
set -U fish_pager_color_selected_prefix 959dcb --bold --background=32374d
...
# Set theme
set -Ux BASE16_THEME material-palenight
...
if test -n "$TINTED_SHELL_ENABLE_BASE16_VARS"; or test -n "$BASE16_SHELL_ENABLE_VARS"
  ...
  set -gx BASE16_COLOR_02_HEX "32374d"
