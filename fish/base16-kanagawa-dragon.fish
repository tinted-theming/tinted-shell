...
set -l color00 "18/16/16" # Base 00 - Black
set -l color01 "c4/74/6e" # Base 08 - Red
set -l color02 "8a/9a/7b" # Base 0B - Green
set -l color03 "c4/b2/8a" # Base 0A - Yellow
set -l color04 "8b/a4/b0" # Base 0D - Blue
set -l color05 "a2/92/a3" # Base 0E - Magenta
set -l color06 "8e/a4/a2" # Base 0C - Cyan
set -l color07 "c5/c9/c5" # Base 05 - White
set -l color08 "62/5e/5a" # Base 03 - Bright Black
...
set -l color15 "c5/c9/c5" # Base 07 - Bright White
set -l color16 "b6/92/7b" # Base 09
set -l color17 "b9/8d/7b" # Base 0F
set -l color18 "28/27/27" # Base 01
set -l color19 "39/38/36" # Base 02
set -l color20 "73/7c/73" # Base 04
set -l color21 "c8/c0/93" # Base 06
set -l color_foreground "c5/c9/c5" # Base 05
set -l color_background "18/16/16" # Base 00
...
set -U fish_color_end c5c9c5
set -U fish_color_error brred
set -U fish_color_param 737c73
set -U fish_color_valid_path --underline
set -U fish_color_option brcyan
set -U fish_color_comment 625e5a
set -U fish_color_selection c8c093 --bold --background=393836
set -U fish_color_operator brblue
set -U fish_color_escape brcyan
set -U fish_color_autosuggestion 625e5a
...
set -U fish_color_search_match bryellow --background=393836
set -U fish_color_history_current --bold
set -U fish_pager_color_progress 282727 --background=737c73
set -U fish_pager_color_background normal --background=181616
set -U fish_pager_color_prefix normal --bold
set -U fish_pager_color_completion normal
set -U fish_pager_color_description b6927b --dim
set -U fish_pager_color_selected_background c8c093 --background=393836
set -U fish_pager_color_selected_prefix c8c093 --bold --background=393836
set -U fish_pager_color_selected_completion c8c093
...
# Set theme
set -Ux BASE16_THEME kanagawa-dragon

# Optionally export variables
if test -n "$TINTED_SHELL_ENABLE_BASE16_VARS"; or test -n "$BASE16_SHELL_ENABLE_VARS"
  set -gx BASE16_COLOR_00_HEX "181616"
  set -gx BASE16_COLOR_01_HEX "282727"
  set -gx BASE16_COLOR_02_HEX "393836"
  set -gx BASE16_COLOR_03_HEX "625e5a"
  set -gx BASE16_COLOR_04_HEX "737c73"
  set -gx BASE16_COLOR_05_HEX "c5c9c5"
  set -gx BASE16_COLOR_06_HEX "c8c093"
  set -gx BASE16_COLOR_07_HEX "c5c9c5"
  set -gx BASE16_COLOR_08_HEX "c4746e"
  set -gx BASE16_COLOR_09_HEX "b6927b"
  set -gx BASE16_COLOR_0A_HEX "c4b28a"
  set -gx BASE16_COLOR_0B_HEX "8a9a7b"
  set -gx BASE16_COLOR_0C_HEX "8ea4a2"
  set -gx BASE16_COLOR_0D_HEX "8ba4b0"
  set -gx BASE16_COLOR_0E_HEX "a292a3"
  set -gx BASE16_COLOR_0F_HEX "b98d7b"
end
