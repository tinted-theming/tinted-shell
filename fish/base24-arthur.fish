...
set -l color01 "cd/5c/5c" # Base 08 - Red
set -l color02 "86/af/80" # Base 0B - Green
set -l color03 "87/ce/eb" # Base 0A - Yellow
set -l color04 "64/95/ed" # Base 0D - Blue
set -l color05 "de/b8/87" # Base 0E - Magenta
set -l color06 "b0/c4/de" # Base 0C - Cyan
set -l color07 "a1/90/83" # Base 05 - White
set -l color08 "6e/5d/59" # Base 03 - Bright Black
...
set -l color15 "dd/cc/bb" # Base 07 - Bright White
set -l color16 "e8/ae/5b" # Base 09
set -l color17 "66/2e/2e" # Base 0F
set -l color18 "3d/35/2a" # Base 01
set -l color19 "55/44/44" # Base 02
set -l color20 "88/77/6e" # Base 04
set -l color21 "bb/aa/99" # Base 06
set -l color_foreground "a1/90/83" # Base 05
...
set -U fish_color_end a19083
set -U fish_color_error brred
set -U fish_color_param 88776e
set -U fish_color_valid_path --underline
set -U fish_color_option brcyan
set -U fish_color_comment 6e5d59
set -U fish_color_selection bbaa99 --bold --background=554444
set -U fish_color_operator brblue
set -U fish_color_escape brcyan
set -U fish_color_autosuggestion 6e5d59
...
set -U fish_color_search_match bryellow --background=554444
set -U fish_color_history_current --bold
set -U fish_pager_color_progress 3d352a --background=88776e
set -U fish_pager_color_background normal --background=1c1c1c
set -U fish_pager_color_prefix normal --bold
set -U fish_pager_color_completion normal
set -U fish_pager_color_description e8ae5b --dim
set -U fish_pager_color_selected_background bbaa99 --background=554444
set -U fish_pager_color_selected_prefix bbaa99 --bold --background=554444
set -U fish_pager_color_selected_completion bbaa99
...
# Set theme
set -Ux BASE24_THEME arthur

# Optionally export variables
if test -n "$TINTED_SHELL_ENABLE_BASE24_VARS"; or test -n "$BASE24_SHELL_ENABLE_VARS"
  set -gx BASE24_COLOR_00_HEX "1c1c1c"
  set -gx BASE24_COLOR_01_HEX "3d352a"
  set -gx BASE24_COLOR_02_HEX "554444"
  set -gx BASE24_COLOR_03_HEX "6e5d59"
  set -gx BASE24_COLOR_04_HEX "88776e"
  set -gx BASE24_COLOR_05_HEX "a19083"
  set -gx BASE24_COLOR_06_HEX "bbaa99"
  set -gx BASE24_COLOR_07_HEX "ddccbb"
  set -gx BASE24_COLOR_08_HEX "cd5c5c"
  set -gx BASE24_COLOR_09_HEX "e8ae5b"
  set -gx BASE24_COLOR_0A_HEX "87ceeb"
  set -gx BASE24_COLOR_0B_HEX "86af80"
  set -gx BASE24_COLOR_0C_HEX "b0c4de"
  set -gx BASE24_COLOR_0D_HEX "6495ed"
  set -gx BASE24_COLOR_0E_HEX "deb887"
  set -gx BASE24_COLOR_0F_HEX "662e2e"
end
