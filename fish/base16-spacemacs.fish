...
set -l color00 "1f/20/22" # Base 00 - Black
set -l color01 "f2/24/1f" # Base 08 - Red
set -l color02 "67/b1/1d" # Base 0B - Green
set -l color03 "b1/95/1d" # Base 0A - Yellow
set -l color04 "4f/97/d7" # Base 0D - Blue
set -l color05 "a3/1d/b1" # Base 0E - Magenta
set -l color06 "2d/95/74" # Base 0C - Cyan
set -l color07 "a3/a3/a3" # Base 05 - White
...
set -l color16 "ff/a5/00" # Base 09
set -l color17 "b0/30/60" # Base 0F
set -l color18 "28/28/28" # Base 01
set -l color19 "44/41/55" # Base 02
set -l color20 "b8/b8/b8" # Base 04
set -l color21 "e8/e8/e8" # Base 06
set -l color_foreground "a3/a3/a3" # Base 05
set -l color_background "1f/20/22" # Base 00
...
set -U fish_pager_color_background normal --background=1f2022
set -U fish_pager_color_prefix normal --bold
set -U fish_pager_color_completion normal
set -U fish_pager_color_description ffa500 --dim
set -U fish_pager_color_selected_background e8e8e8 --background=444155
set -U fish_pager_color_selected_prefix e8e8e8 --bold --background=444155
...
# Set theme
set -Ux BASE16_THEME spacemacs

# Optionally export variables
if test -n "$TINTED_SHELL_ENABLE_BASE16_VARS"; or test -n "$BASE16_SHELL_ENABLE_VARS"
  set -gx BASE16_COLOR_00_HEX "1f2022"
  set -gx BASE16_COLOR_01_HEX "282828"
  set -gx BASE16_COLOR_02_HEX "444155"
  set -gx BASE16_COLOR_03_HEX "585858"
  set -gx BASE16_COLOR_04_HEX "b8b8b8"
  set -gx BASE16_COLOR_05_HEX "a3a3a3"
  set -gx BASE16_COLOR_06_HEX "e8e8e8"
  set -gx BASE16_COLOR_07_HEX "f8f8f8"
  set -gx BASE16_COLOR_08_HEX "f2241f"
  set -gx BASE16_COLOR_09_HEX "ffa500"
  set -gx BASE16_COLOR_0A_HEX "b1951d"
  set -gx BASE16_COLOR_0B_HEX "67b11d"
  set -gx BASE16_COLOR_0C_HEX "2d9574"
  set -gx BASE16_COLOR_0D_HEX "4f97d7"
  set -gx BASE16_COLOR_0E_HEX "a31db1"
  set -gx BASE16_COLOR_0F_HEX "b03060"
end
