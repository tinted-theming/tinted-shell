...
set -l color01 "ff/5c/57" # Base 08 - Red
set -l color02 "5a/f7/8e" # Base 0B - Green
set -l color03 "f3/f9/9d" # Base 0A - Yellow
set -l color04 "57/c7/ff" # Base 0D - Blue
set -l color05 "ff/6a/c1" # Base 0E - Magenta
set -l color06 "9a/ed/fe" # Base 0C - Cyan
set -l color07 "e2/e4/e5" # Base 05 - White
set -l color08 "78/78/7e" # Base 03 - Bright Black
...
set -l color15 "f1/f1/f0" # Base 07 - Bright White
set -l color16 "ff/9f/43" # Base 09
set -l color17 "b2/64/3c" # Base 0F
set -l color18 "34/35/3e" # Base 01
set -l color19 "43/45/4f" # Base 02
set -l color20 "a5/a5/a9" # Base 04
set -l color21 "ef/f0/eb" # Base 06
set -l color_foreground "e2/e4/e5" # Base 05
...
set -U fish_color_end e2e4e5
set -U fish_color_error brred
set -U fish_color_param a5a5a9
set -U fish_color_valid_path --underline
set -U fish_color_option brcyan
set -U fish_color_comment 78787e
set -U fish_color_selection eff0eb --bold --background=43454f
set -U fish_color_operator brblue
set -U fish_color_escape brcyan
set -U fish_color_autosuggestion 78787e
...
set -U fish_pager_color_progress 34353e --background=a5a5a9
set -U fish_pager_color_background normal --background=282a36
set -U fish_pager_color_prefix normal --bold
set -U fish_pager_color_completion normal
set -U fish_pager_color_description ff9f43 --dim
set -U fish_pager_color_selected_background eff0eb --background=43454f
set -U fish_pager_color_selected_prefix eff0eb --bold --background=43454f
set -U fish_pager_color_selected_completion eff0eb
...
# Set theme
set -Ux BASE16_THEME snazzy

# Optionally export variables
if test -n "$TINTED_SHELL_ENABLE_BASE16_VARS"; or test -n "$BASE16_SHELL_ENABLE_VARS"
  set -gx BASE16_COLOR_00_HEX "282a36"
  set -gx BASE16_COLOR_01_HEX "34353e"
  set -gx BASE16_COLOR_02_HEX "43454f"
  set -gx BASE16_COLOR_03_HEX "78787e"
  set -gx BASE16_COLOR_04_HEX "a5a5a9"
  set -gx BASE16_COLOR_05_HEX "e2e4e5"
  set -gx BASE16_COLOR_06_HEX "eff0eb"
  set -gx BASE16_COLOR_07_HEX "f1f1f0"
  set -gx BASE16_COLOR_08_HEX "ff5c57"
  set -gx BASE16_COLOR_09_HEX "ff9f43"
  set -gx BASE16_COLOR_0A_HEX "f3f99d"
  set -gx BASE16_COLOR_0B_HEX "5af78e"
  set -gx BASE16_COLOR_0C_HEX "9aedfe"
  set -gx BASE16_COLOR_0D_HEX "57c7ff"
  set -gx BASE16_COLOR_0E_HEX "ff6ac1"
  set -gx BASE16_COLOR_0F_HEX "b2643c"
end
