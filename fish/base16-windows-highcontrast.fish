...
set -l color01 "fc/54/54" # Base 08 - Red
set -l color02 "54/fc/54" # Base 0B - Green
set -l color03 "fc/fc/54" # Base 0A - Yellow
set -l color04 "54/54/fc" # Base 0D - Blue
set -l color05 "fc/54/fc" # Base 0E - Magenta
set -l color06 "54/fc/fc" # Base 0C - Cyan
set -l color07 "c0/c0/c0" # Base 05 - White
set -l color08 "54/54/54" # Base 03 - Bright Black
...
set -l color16 "80/80/00" # Base 09
set -l color17 "00/80/00" # Base 0F
set -l color18 "1c/1c/1c" # Base 01
set -l color19 "38/38/38" # Base 02
set -l color20 "a2/a2/a2" # Base 04
...
set -U fish_color_comment 545454
set -U fish_color_selection dedede --bold --background=383838
set -U fish_color_operator brblue
set -U fish_color_escape brcyan
set -U fish_color_autosuggestion 545454
...
set -U fish_pager_color_progress 1c1c1c --background=a2a2a2
set -U fish_pager_color_background normal --background=000000
set -U fish_pager_color_prefix normal --bold
set -U fish_pager_color_completion normal
set -U fish_pager_color_description 808000 --dim
set -U fish_pager_color_selected_background dedede --background=383838
set -U fish_pager_color_selected_prefix dedede --bold --background=383838
...
# Set theme
set -Ux BASE16_THEME windows-highcontrast
...
if test -n "$TINTED_SHELL_ENABLE_BASE16_VARS"; or test -n "$BASE16_SHELL_ENABLE_VARS"
  ...
  set -gx BASE16_COLOR_03_HEX "545454"
  set -gx BASE16_COLOR_04_HEX "a2a2a2"
  set -gx BASE16_COLOR_05_HEX "c0c0c0"
  set -gx BASE16_COLOR_06_HEX "dedede"
  set -gx BASE16_COLOR_07_HEX "fcfcfc"
  set -gx BASE16_COLOR_08_HEX "fc5454"
  set -gx BASE16_COLOR_09_HEX "808000"
  set -gx BASE16_COLOR_0A_HEX "fcfc54"
  set -gx BASE16_COLOR_0B_HEX "54fc54"
  set -gx BASE16_COLOR_0C_HEX "54fcfc"
  set -gx BASE16_COLOR_0D_HEX "5454fc"
  set -gx BASE16_COLOR_0E_HEX "fc54fc"
  set -gx BASE16_COLOR_0F_HEX "008000"
end
