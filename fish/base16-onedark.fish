...
set -l color01 "e0/6c/75" # Base 08 - Red
set -l color02 "98/c3/79" # Base 0B - Green
set -l color03 "e5/c0/7b" # Base 0A - Yellow
set -l color04 "61/af/ef" # Base 0D - Blue
set -l color05 "c6/78/dd" # Base 0E - Magenta
set -l color06 "56/b6/c2" # Base 0C - Cyan
...
set -l color15 "c8/cc/d4" # Base 07 - Bright White
set -l color16 "d1/9a/66" # Base 09
set -l color17 "be/50/46" # Base 0F
set -l color18 "35/3b/45" # Base 01
set -l color19 "3e/44/51" # Base 02
set -l color20 "56/5c/64" # Base 04
set -l color21 "b6/bd/ca" # Base 06
...
set -U fish_color_selection b6bdca --bold --background=3e4451
...
set -U fish_pager_color_progress 353b45 --background=565c64
set -U fish_pager_color_background normal --background=282c34
set -U fish_pager_color_prefix normal --bold
set -U fish_pager_color_completion normal
set -U fish_pager_color_description d19a66 --dim
set -U fish_pager_color_selected_background b6bdca --background=3e4451
set -U fish_pager_color_selected_prefix b6bdca --bold --background=3e4451
set -U fish_pager_color_selected_completion b6bdca
...
if test -n "$TINTED_SHELL_ENABLE_BASE16_VARS"; or test -n "$BASE16_SHELL_ENABLE_VARS"
  set -gx BASE16_COLOR_00_HEX "282c34"
  set -gx BASE16_COLOR_01_HEX "353b45"
  set -gx BASE16_COLOR_02_HEX "3e4451"
  set -gx BASE16_COLOR_03_HEX "545862"
  set -gx BASE16_COLOR_04_HEX "565c64"
  set -gx BASE16_COLOR_05_HEX "abb2bf"
  set -gx BASE16_COLOR_06_HEX "b6bdca"
  set -gx BASE16_COLOR_07_HEX "c8ccd4"
  set -gx BASE16_COLOR_08_HEX "e06c75"
  set -gx BASE16_COLOR_09_HEX "d19a66"
  set -gx BASE16_COLOR_0A_HEX "e5c07b"
  set -gx BASE16_COLOR_0B_HEX "98c379"
  set -gx BASE16_COLOR_0C_HEX "56b6c2"
  set -gx BASE16_COLOR_0D_HEX "61afef"
  set -gx BASE16_COLOR_0E_HEX "c678dd"
  set -gx BASE16_COLOR_0F_HEX "be5046"
end
