...
set -l color01 "34/3b/58" # Base 08 - Red
...
# Set theme
set -Ux BASE16_THEME tokyo-night-light
...
if test -n "$TINTED_SHELL_ENABLE_BASE16_VARS"; or test -n "$BASE16_SHELL_ENABLE_VARS"
  ...
  set -gx BASE16_COLOR_05_HEX "343b59"
  set -gx BASE16_COLOR_06_HEX "1a1b26"
  set -gx BASE16_COLOR_07_HEX "1a1b26"
  set -gx BASE16_COLOR_08_HEX "343b58"
  set -gx BASE16_COLOR_09_HEX "965027"
  set -gx BASE16_COLOR_0A_HEX "166775"
  set -gx BASE16_COLOR_0B_HEX "485e30"
  set -gx BASE16_COLOR_0C_HEX "3e6968"
  set -gx BASE16_COLOR_0D_HEX "34548a"
  set -gx BASE16_COLOR_0E_HEX "5a4a78"
  set -gx BASE16_COLOR_0F_HEX "8c4351"
end
