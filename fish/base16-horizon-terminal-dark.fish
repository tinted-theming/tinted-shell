...
set -l color00 "1c/1e/26" # Base 00 - Black
set -l color01 "e9/56/78" # Base 08 - Red
set -l color02 "29/d3/98" # Base 0B - Green
set -l color03 "fa/c2/9a" # Base 0A - Yellow
set -l color04 "26/bb/d9" # Base 0D - Blue
set -l color05 "ee/64/ac" # Base 0E - Magenta
set -l color06 "59/e1/e3" # Base 0C - Cyan
set -l color07 "cb/ce/d0" # Base 05 - White
set -l color08 "6f/6f/70" # Base 03 - Bright Black
...
set -l color15 "e3/e6/ee" # Base 07 - Bright White
set -l color16 "fa/b7/95" # Base 09
set -l color17 "f0/93/83" # Base 0F
set -l color18 "23/25/30" # Base 01
set -l color19 "2e/30/3e" # Base 02
set -l color20 "9d/a0/a2" # Base 04
set -l color21 "dc/df/e4" # Base 06
set -l color_foreground "cb/ce/d0" # Base 05
set -l color_background "1c/1e/26" # Base 00
...
set -U fish_color_end cbced0
set -U fish_color_error brred
set -U fish_color_param 9da0a2
set -U fish_color_valid_path --underline
set -U fish_color_option brcyan
set -U fish_color_comment 6f6f70
set -U fish_color_selection dcdfe4 --bold --background=2e303e
set -U fish_color_operator brblue
set -U fish_color_escape brcyan
set -U fish_color_autosuggestion 6f6f70
...
set -U fish_pager_color_progress 232530 --background=9da0a2
set -U fish_pager_color_background normal --background=1c1e26
set -U fish_pager_color_prefix normal --bold
set -U fish_pager_color_completion normal
set -U fish_pager_color_description fab795 --dim
set -U fish_pager_color_selected_background dcdfe4 --background=2e303e
set -U fish_pager_color_selected_prefix dcdfe4 --bold --background=2e303e
set -U fish_pager_color_selected_completion dcdfe4
...
# Set theme
set -Ux BASE16_THEME horizon-terminal-dark

# Optionally export variables
if test -n "$TINTED_SHELL_ENABLE_BASE16_VARS"; or test -n "$BASE16_SHELL_ENABLE_VARS"
  set -gx BASE16_COLOR_00_HEX "1c1e26"
  set -gx BASE16_COLOR_01_HEX "232530"
  set -gx BASE16_COLOR_02_HEX "2e303e"
  set -gx BASE16_COLOR_03_HEX "6f6f70"
  set -gx BASE16_COLOR_04_HEX "9da0a2"
  set -gx BASE16_COLOR_05_HEX "cbced0"
  set -gx BASE16_COLOR_06_HEX "dcdfe4"
  set -gx BASE16_COLOR_07_HEX "e3e6ee"
  set -gx BASE16_COLOR_08_HEX "e95678"
  set -gx BASE16_COLOR_09_HEX "fab795"
  set -gx BASE16_COLOR_0A_HEX "fac29a"
  set -gx BASE16_COLOR_0B_HEX "29d398"
  set -gx BASE16_COLOR_0C_HEX "59e1e3"
  set -gx BASE16_COLOR_0D_HEX "26bbd9"
  set -gx BASE16_COLOR_0E_HEX "ee64ac"
  set -gx BASE16_COLOR_0F_HEX "f09383"
end
