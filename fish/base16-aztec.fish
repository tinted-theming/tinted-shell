...
set -l color00 "10/16/00" # Base 00 - Black
set -l color01 "ee/2e/00" # Base 08 - Red
set -l color02 "63/d9/32" # Base 0B - Green
set -l color03 "ee/bb/00" # Base 0A - Yellow
set -l color04 "5b/4a/9f" # Base 0D - Blue
set -l color05 "88/3e/9f" # Base 0E - Magenta
set -l color06 "3d/94/a5" # Base 0C - Cyan
set -l color07 "ff/da/51" # Base 05 - White
set -l color08 "2e/2e/05" # Base 03 - Bright Black
...
set -l color15 "ff/eb/a0" # Base 07 - Bright White
set -l color16 "ee/88/00" # Base 09
set -l color17 "a9/28/b9" # Base 0F
set -l color18 "1a/1e/01" # Base 01
set -l color19 "24/26/04" # Base 02
set -l color20 "ff/d1/29" # Base 04
set -l color21 "ff/e1/78" # Base 06
set -l color_foreground "ff/da/51" # Base 05
set -l color_background "10/16/00" # Base 00
...
set -U fish_color_end ffda51
set -U fish_color_error brred
set -U fish_color_param ffd129
set -U fish_color_valid_path --underline
set -U fish_color_option brcyan
set -U fish_color_comment 2e2e05
set -U fish_color_selection ffe178 --bold --background=242604
set -U fish_color_operator brblue
set -U fish_color_escape brcyan
set -U fish_color_autosuggestion 2e2e05
...
set -U fish_color_search_match bryellow --background=242604
set -U fish_color_history_current --bold
set -U fish_pager_color_progress 1a1e01 --background=ffd129
set -U fish_pager_color_background normal --background=101600
set -U fish_pager_color_prefix normal --bold
set -U fish_pager_color_completion normal
set -U fish_pager_color_description ee8800 --dim
set -U fish_pager_color_selected_background ffe178 --background=242604
set -U fish_pager_color_selected_prefix ffe178 --bold --background=242604
set -U fish_pager_color_selected_completion ffe178
...
# Set theme
set -Ux BASE16_THEME aztec

# Optionally export variables
if test -n "$TINTED_SHELL_ENABLE_BASE16_VARS"; or test -n "$BASE16_SHELL_ENABLE_VARS"
  set -gx BASE16_COLOR_00_HEX "101600"
  set -gx BASE16_COLOR_01_HEX "1a1e01"
  set -gx BASE16_COLOR_02_HEX "242604"
  set -gx BASE16_COLOR_03_HEX "2e2e05"
  set -gx BASE16_COLOR_04_HEX "ffd129"
  set -gx BASE16_COLOR_05_HEX "ffda51"
  set -gx BASE16_COLOR_06_HEX "ffe178"
  set -gx BASE16_COLOR_07_HEX "ffeba0"
  set -gx BASE16_COLOR_08_HEX "ee2e00"
  set -gx BASE16_COLOR_09_HEX "ee8800"
  set -gx BASE16_COLOR_0A_HEX "eebb00"
  set -gx BASE16_COLOR_0B_HEX "63d932"
  set -gx BASE16_COLOR_0C_HEX "3d94a5"
  set -gx BASE16_COLOR_0D_HEX "5b4a9f"
  set -gx BASE16_COLOR_0E_HEX "883e9f"
  set -gx BASE16_COLOR_0F_HEX "a928b9"
end
