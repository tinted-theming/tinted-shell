...
set -l color00 "ef/f1/f5" # Base 00 - Black
set -l color01 "d2/0f/39" # Base 08 - Red
set -l color02 "40/a0/2b" # Base 0B - Green
set -l color03 "df/8e/1d" # Base 0A - Yellow
set -l color04 "1e/66/f5" # Base 0D - Blue
set -l color05 "88/39/ef" # Base 0E - Magenta
set -l color06 "17/92/99" # Base 0C - Cyan
set -l color07 "4c/4f/69" # Base 05 - White
set -l color08 "bc/c0/cc" # Base 03 - Bright Black
...
set -l color15 "72/87/fd" # Base 07 - Bright White
set -l color16 "fe/64/0b" # Base 09
set -l color17 "dd/78/78" # Base 0F
set -l color18 "e6/e9/ef" # Base 01
set -l color19 "cc/d0/da" # Base 02
set -l color20 "ac/b0/be" # Base 04
set -l color21 "dc/8a/78" # Base 06
set -l color_foreground "4c/4f/69" # Base 05
set -l color_background "ef/f1/f5" # Base 00
...
set -U fish_color_param acb0be
set -U fish_color_valid_path --underline
set -U fish_color_option brcyan
set -U fish_color_comment bcc0cc
set -U fish_color_selection dc8a78 --bold --background=ccd0da
set -U fish_color_operator brblue
set -U fish_color_escape brcyan
set -U fish_color_autosuggestion bcc0cc
...
set -U fish_color_search_match bryellow --background=ccd0da
set -U fish_color_history_current --bold
set -U fish_pager_color_progress e6e9ef --background=acb0be
set -U fish_pager_color_background normal --background=eff1f5
set -U fish_pager_color_prefix normal --bold
set -U fish_pager_color_completion normal
set -U fish_pager_color_description fe640b --dim
set -U fish_pager_color_selected_background dc8a78 --background=ccd0da
set -U fish_pager_color_selected_prefix dc8a78 --bold --background=ccd0da
set -U fish_pager_color_selected_completion dc8a78
...
# Set theme
set -Ux BASE24_THEME catppuccin-latte

# Optionally export variables
if test -n "$TINTED_SHELL_ENABLE_BASE24_VARS"; or test -n "$BASE24_SHELL_ENABLE_VARS"
  set -gx BASE24_COLOR_00_HEX "eff1f5"
  set -gx BASE24_COLOR_01_HEX "e6e9ef"
  set -gx BASE24_COLOR_02_HEX "ccd0da"
  set -gx BASE24_COLOR_03_HEX "bcc0cc"
  set -gx BASE24_COLOR_04_HEX "acb0be"
  set -gx BASE24_COLOR_05_HEX "4c4f69"
  set -gx BASE24_COLOR_06_HEX "dc8a78"
  set -gx BASE24_COLOR_07_HEX "7287fd"
  set -gx BASE24_COLOR_08_HEX "d20f39"
  set -gx BASE24_COLOR_09_HEX "fe640b"
  set -gx BASE24_COLOR_0A_HEX "df8e1d"
  set -gx BASE24_COLOR_0B_HEX "40a02b"
  set -gx BASE24_COLOR_0C_HEX "179299"
  set -gx BASE24_COLOR_0D_HEX "1e66f5"
  set -gx BASE24_COLOR_0E_HEX "8839ef"
  set -gx BASE24_COLOR_0F_HEX "dd7878"
end
