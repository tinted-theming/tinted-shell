...
set -U fish_color_selection dc8a78 --background=ccd0da
...
set -U fish_color_search_match yellow --background=ccd0da
set -U fish_color_history_current --underline=curly
set -U fish_pager_color_progress e6e9ef --background=acb0be
set -U fish_pager_color_background --background=eff1f5
set -U fish_pager_color_prefix --bold --italics
set -U fish_pager_color_completion normal
set -U fish_pager_color_description fe640b
set -U fish_pager_color_selected_background --background=ccd0da
set -U fish_pager_color_selected_prefix --bold --italics --background=ccd0da
