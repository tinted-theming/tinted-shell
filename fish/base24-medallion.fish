...
set -l color00 "1d/18/08" # Base 00 - Black
set -l color01 "b5/4c/00" # Base 08 - Red
set -l color02 "7c/8a/16" # Base 0B - Green
set -l color03 "ab/b8/ff" # Base 0A - Yellow
set -l color04 "60/6b/af" # Base 0D - Blue
set -l color05 "8b/59/90" # Base 0E - Magenta
set -l color06 "90/6b/25" # Base 0C - Cyan
set -l color07 "ae/a5/78" # Base 05 - White
set -l color08 "78/6d/38" # Base 03 - Bright Black
...
set -l color15 "fe/d5/97" # Base 07 - Bright White
set -l color16 "d2/bd/25" # Base 09
set -l color17 "5a/26/00" # Base 0F
set -l color18 "00/00/00" # Base 01
set -l color19 "5e/51/18" # Base 02
set -l color20 "93/89/58" # Base 04
set -l color21 "c9/c1/99" # Base 06
set -l color_foreground "ae/a5/78" # Base 05
set -l color_background "1d/18/08" # Base 00
...
set -U fish_color_end aea578
set -U fish_color_error brred
set -U fish_color_param 938958
set -U fish_color_valid_path --underline
set -U fish_color_option brcyan
set -U fish_color_comment 786d38
set -U fish_color_selection c9c199 --bold --background=5e5118
set -U fish_color_operator brblue
set -U fish_color_escape brcyan
set -U fish_color_autosuggestion 786d38
...
set -U fish_color_search_match bryellow --background=5e5118
set -U fish_color_history_current --bold
set -U fish_pager_color_progress 000000 --background=938958
set -U fish_pager_color_background normal --background=1d1808
set -U fish_pager_color_prefix normal --bold
set -U fish_pager_color_completion normal
set -U fish_pager_color_description d2bd25 --dim
set -U fish_pager_color_selected_background c9c199 --background=5e5118
set -U fish_pager_color_selected_prefix c9c199 --bold --background=5e5118
set -U fish_pager_color_selected_completion c9c199
...
# Set theme
set -Ux BASE24_THEME medallion

# Optionally export variables
if test -n "$TINTED_SHELL_ENABLE_BASE24_VARS"; or test -n "$BASE24_SHELL_ENABLE_VARS"
  set -gx BASE24_COLOR_00_HEX "1d1808"
  set -gx BASE24_COLOR_01_HEX "000000"
  set -gx BASE24_COLOR_02_HEX "5e5118"
  set -gx BASE24_COLOR_03_HEX "786d38"
  set -gx BASE24_COLOR_04_HEX "938958"
  set -gx BASE24_COLOR_05_HEX "aea578"
  set -gx BASE24_COLOR_06_HEX "c9c199"
  set -gx BASE24_COLOR_07_HEX "fed597"
  set -gx BASE24_COLOR_08_HEX "b54c00"
  set -gx BASE24_COLOR_09_HEX "d2bd25"
  set -gx BASE24_COLOR_0A_HEX "abb8ff"
  set -gx BASE24_COLOR_0B_HEX "7c8a16"
  set -gx BASE24_COLOR_0C_HEX "906b25"
  set -gx BASE24_COLOR_0D_HEX "606baf"
  set -gx BASE24_COLOR_0E_HEX "8b5990"
  set -gx BASE24_COLOR_0F_HEX "5a2600"
end
