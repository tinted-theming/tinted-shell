...
set -U fish_color_selection c9c199 --background=5e5118
set -U fish_color_operator magenta
set -U fish_color_escape d2bd25
...
set -U fish_color_search_match yellow --background=5e5118
set -U fish_color_history_current --underline=curly
set -U fish_pager_color_progress 000000 --background=938958
set -U fish_pager_color_background --background=1d1808
set -U fish_pager_color_prefix --bold --italics
set -U fish_pager_color_completion normal
set -U fish_pager_color_description d2bd25
set -U fish_pager_color_selected_background --background=5e5118
set -U fish_pager_color_selected_prefix --bold --italics --background=5e5118
