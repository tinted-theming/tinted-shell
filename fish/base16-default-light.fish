...
set -l color00 "f8/f8/f8" # Base 00 - Black
set -l color01 "ab/46/42" # Base 08 - Red
set -l color02 "a1/b5/6c" # Base 0B - Green
set -l color03 "f7/ca/88" # Base 0A - Yellow
set -l color04 "7c/af/c2" # Base 0D - Blue
set -l color05 "ba/8b/af" # Base 0E - Magenta
set -l color06 "86/c1/b9" # Base 0C - Cyan
set -l color07 "38/38/38" # Base 05 - White
set -l color08 "b8/b8/b8" # Base 03 - Bright Black
...
set -l color15 "18/18/18" # Base 07 - Bright White
set -l color16 "dc/96/56" # Base 09
set -l color17 "a1/69/46" # Base 0F
set -l color18 "e8/e8/e8" # Base 01
set -l color19 "d8/d8/d8" # Base 02
set -l color20 "58/58/58" # Base 04
set -l color21 "28/28/28" # Base 06
set -l color_foreground "38/38/38" # Base 05
set -l color_background "f8/f8/f8" # Base 00
...
set -U fish_color_end 383838
set -U fish_color_error brred
set -U fish_color_param 585858
set -U fish_color_valid_path --underline
set -U fish_color_option brcyan
set -U fish_color_comment b8b8b8
set -U fish_color_selection 282828 --bold --background=d8d8d8
...
set -U fish_pager_color_progress e8e8e8 --background=585858
set -U fish_pager_color_background normal --background=f8f8f8
set -U fish_pager_color_prefix normal --bold
set -U fish_pager_color_completion normal
set -U fish_pager_color_description dc9656 --dim
set -U fish_pager_color_selected_background 282828 --background=d8d8d8
set -U fish_pager_color_selected_prefix 282828 --bold --background=d8d8d8
set -U fish_pager_color_selected_completion 282828
...
# Set theme
set -Ux BASE16_THEME default-light

# Optionally export variables
if test -n "$TINTED_SHELL_ENABLE_BASE16_VARS"; or test -n "$BASE16_SHELL_ENABLE_VARS"
  set -gx BASE16_COLOR_00_HEX "f8f8f8"
  set -gx BASE16_COLOR_01_HEX "e8e8e8"
  set -gx BASE16_COLOR_02_HEX "d8d8d8"
  set -gx BASE16_COLOR_03_HEX "b8b8b8"
  set -gx BASE16_COLOR_04_HEX "585858"
  set -gx BASE16_COLOR_05_HEX "383838"
  set -gx BASE16_COLOR_06_HEX "282828"
  set -gx BASE16_COLOR_07_HEX "181818"
  set -gx BASE16_COLOR_08_HEX "ab4642"
  set -gx BASE16_COLOR_09_HEX "dc9656"
  set -gx BASE16_COLOR_0A_HEX "f7ca88"
  set -gx BASE16_COLOR_0B_HEX "a1b56c"
  set -gx BASE16_COLOR_0C_HEX "86c1b9"
  set -gx BASE16_COLOR_0D_HEX "7cafc2"
  set -gx BASE16_COLOR_0E_HEX "ba8baf"
