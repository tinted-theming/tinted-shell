...
set -l color01 "c8/8c/8c" # Base 08 - Red
set -l color02 "99/c8/99" # Base 0B - Green
set -l color03 "d8/b5/6d" # Base 0A - Yellow
set -l color04 "53/7c/9c" # Base 0D - Blue
set -l color05 "86/ca/cd" # Base 0E - Magenta
set -l color06 "78/b4/b4" # Base 0C - Cyan
set -l color07 "de/de/e7" # Base 05 - White
set -l color08 "64/46/46" # Base 03 - Bright Black
...
set -l color15 "ff/ff/e6" # Base 07 - Bright White
set -l color16 "47/6c/88" # Base 09
set -l color17 "70/4f/4f" # Base 0F
set -l color18 "31/31/31" # Base 01
set -l color19 "55/5d/55" # Base 02
set -l color20 "5a/5a/5a" # Base 04
set -l color21 "c3/c3/b4" # Base 06
set -l color_foreground "de/de/e7" # Base 05
...
set -U fish_color_end dedee7
set -U fish_color_error brred
set -U fish_color_param 5a5a5a
set -U fish_color_valid_path --underline
set -U fish_color_option brcyan
set -U fish_color_comment 644646
set -U fish_color_selection c3c3b4 --bold --background=555d55
set -U fish_color_operator brblue
set -U fish_color_escape brcyan
set -U fish_color_autosuggestion 644646
...
set -U fish_pager_color_progress 313131 --background=5a5a5a
set -U fish_pager_color_background normal --background=222222
set -U fish_pager_color_prefix normal --bold
set -U fish_pager_color_completion normal
set -U fish_pager_color_description 476c88 --dim
set -U fish_pager_color_selected_background c3c3b4 --background=555d55
set -U fish_pager_color_selected_prefix c3c3b4 --bold --background=555d55
set -U fish_pager_color_selected_completion c3c3b4
...
# Set theme
set -Ux BASE16_THEME kimber

# Optionally export variables
if test -n "$TINTED_SHELL_ENABLE_BASE16_VARS"; or test -n "$BASE16_SHELL_ENABLE_VARS"
  set -gx BASE16_COLOR_00_HEX "222222"
  set -gx BASE16_COLOR_01_HEX "313131"
  set -gx BASE16_COLOR_02_HEX "555d55"
  set -gx BASE16_COLOR_03_HEX "644646"
  set -gx BASE16_COLOR_04_HEX "5a5a5a"
  set -gx BASE16_COLOR_05_HEX "dedee7"
  set -gx BASE16_COLOR_06_HEX "c3c3b4"
  set -gx BASE16_COLOR_07_HEX "ffffe6"
  set -gx BASE16_COLOR_08_HEX "c88c8c"
  set -gx BASE16_COLOR_09_HEX "476c88"
  set -gx BASE16_COLOR_0A_HEX "d8b56d"
  set -gx BASE16_COLOR_0B_HEX "99c899"
  set -gx BASE16_COLOR_0C_HEX "78b4b4"
  set -gx BASE16_COLOR_0D_HEX "537c9c"
  set -gx BASE16_COLOR_0E_HEX "86cacd"
  set -gx BASE16_COLOR_0F_HEX "704f4f"
end
