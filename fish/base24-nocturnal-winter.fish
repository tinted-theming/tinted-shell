...
set -l color00 "0d/0d/17" # Base 00 - Black
set -l color01 "f1/2d/52" # Base 08 - Red
set -l color02 "08/cd/7d" # Base 0B - Green
set -l color03 "60/95/fe" # Base 0A - Yellow
set -l color04 "30/81/df" # Base 0D - Blue
set -l color05 "fe/2a/6c" # Base 0E - Magenta
set -l color06 "09/c8/7a" # Base 0C - Cyan
set -l color07 "dc/dc/dc" # Base 05 - White
set -l color08 "9e/9e/9e" # Base 03 - Bright Black
...
set -l color16 "f5/f0/79" # Base 09
set -l color17 "78/16/29" # Base 0F
set -l color18 "4c/4c/4c" # Base 01
set -l color19 "7f/7f/7f" # Base 02
set -l color20 "bd/bd/bd" # Base 04
set -l color21 "fb/fb/fb" # Base 06
set -l color_foreground "dc/dc/dc" # Base 05
set -l color_background "0d/0d/17" # Base 00
...
set -U fish_color_param bdbdbd
set -U fish_color_valid_path --underline
set -U fish_color_option brcyan
set -U fish_color_comment 9e9e9e
set -U fish_color_selection fbfbfb --bold --background=7f7f7f
...
set -U fish_color_search_match bryellow --background=7f7f7f
set -U fish_color_history_current --bold
set -U fish_pager_color_progress 4c4c4c --background=bdbdbd
set -U fish_pager_color_background normal --background=0d0d17
set -U fish_pager_color_prefix normal --bold
set -U fish_pager_color_completion normal
set -U fish_pager_color_description f5f079 --dim
set -U fish_pager_color_selected_background fbfbfb --background=7f7f7f
set -U fish_pager_color_selected_prefix fbfbfb --bold --background=7f7f7f
set -U fish_pager_color_selected_completion fbfbfb
...
# Set theme
set -Ux BASE24_THEME nocturnal-winter

# Optionally export variables
if test -n "$TINTED_SHELL_ENABLE_BASE24_VARS"; or test -n "$BASE24_SHELL_ENABLE_VARS"
  set -gx BASE24_COLOR_00_HEX "0d0d17"
  set -gx BASE24_COLOR_01_HEX "4c4c4c"
  set -gx BASE24_COLOR_02_HEX "7f7f7f"
  set -gx BASE24_COLOR_03_HEX "9e9e9e"
  set -gx BASE24_COLOR_04_HEX "bdbdbd"
  set -gx BASE24_COLOR_05_HEX "dcdcdc"
  set -gx BASE24_COLOR_06_HEX "fbfbfb"
  set -gx BASE24_COLOR_07_HEX "ffffff"
  set -gx BASE24_COLOR_08_HEX "f12d52"
  set -gx BASE24_COLOR_09_HEX "f5f079"
  set -gx BASE24_COLOR_0A_HEX "6095fe"
  set -gx BASE24_COLOR_0B_HEX "08cd7d"
  set -gx BASE24_COLOR_0C_HEX "09c87a"
  set -gx BASE24_COLOR_0D_HEX "3081df"
  set -gx BASE24_COLOR_0E_HEX "fe2a6c"
  set -gx BASE24_COLOR_0F_HEX "781629"
end
