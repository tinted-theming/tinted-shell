...
set -U fish_color_selection fbfbfb --background=7f7f7f
set -U fish_color_operator magenta
set -U fish_color_escape f5f079
...
set -U fish_color_search_match yellow --background=7f7f7f
set -U fish_color_history_current --underline=curly
set -U fish_pager_color_progress 4c4c4c --background=bdbdbd
set -U fish_pager_color_background --background=0d0d17
set -U fish_pager_color_prefix --bold --italics
set -U fish_pager_color_completion normal
set -U fish_pager_color_description f5f079
set -U fish_pager_color_selected_background --background=7f7f7f
set -U fish_pager_color_selected_prefix --bold --italics --background=7f7f7f
