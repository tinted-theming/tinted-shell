...
set -l color03 "fd/cc/59" # Base 0A - Yellow
set -l color04 "12/90/bf" # Base 0D - Blue
set -l color05 "c8/5e/7c" # Base 0E - Magenta
set -l color06 "14/9b/93" # Base 0C - Cyan
set -l color07 "b9/b5/b8" # Base 05 - White
set -l color08 "79/73/79" # Base 03 - Bright Black
...
set -l color16 "fd/8b/19" # Base 09
set -l color17 "b3/35/08" # Base 0F
set -l color18 "43/3b/42" # Base 01
set -l color19 "5c/54/5b" # Base 02
set -l color20 "98/94/98" # Base 04
set -l color21 "d5/d3/d5" # Base 06
set -l color_foreground "b9/b5/b8" # Base 05
...
set -U fish_color_end b9b5b8
set -U fish_color_error brred
set -U fish_color_param 989498
set -U fish_color_valid_path --underline
set -U fish_color_option brcyan
set -U fish_color_comment 797379
set -U fish_color_selection d5d3d5 --bold --background=5c545b
set -U fish_color_operator brblue
set -U fish_color_escape brcyan
set -U fish_color_autosuggestion 797379
...
set -U fish_pager_color_progress 433b42 --background=989498
set -U fish_pager_color_background normal --background=322931
set -U fish_pager_color_prefix normal --bold
set -U fish_pager_color_completion normal
set -U fish_pager_color_description fd8b19 --dim
set -U fish_pager_color_selected_background d5d3d5 --background=5c545b
set -U fish_pager_color_selected_prefix d5d3d5 --bold --background=5c545b
set -U fish_pager_color_selected_completion d5d3d5
...
# Set theme
set -Ux BASE16_THEME hopscotch

# Optionally export variables
if test -n "$TINTED_SHELL_ENABLE_BASE16_VARS"; or test -n "$BASE16_SHELL_ENABLE_VARS"
  set -gx BASE16_COLOR_00_HEX "322931"
  set -gx BASE16_COLOR_01_HEX "433b42"
  set -gx BASE16_COLOR_02_HEX "5c545b"
  set -gx BASE16_COLOR_03_HEX "797379"
  set -gx BASE16_COLOR_04_HEX "989498"
  set -gx BASE16_COLOR_05_HEX "b9b5b8"
  set -gx BASE16_COLOR_06_HEX "d5d3d5"
  set -gx BASE16_COLOR_07_HEX "ffffff"
  set -gx BASE16_COLOR_08_HEX "dd464c"
  set -gx BASE16_COLOR_09_HEX "fd8b19"
  set -gx BASE16_COLOR_0A_HEX "fdcc59"
  set -gx BASE16_COLOR_0B_HEX "8fc13e"
  set -gx BASE16_COLOR_0C_HEX "149b93"
  set -gx BASE16_COLOR_0D_HEX "1290bf"
  set -gx BASE16_COLOR_0E_HEX "c85e7c"
  set -gx BASE16_COLOR_0F_HEX "b33508"
end
