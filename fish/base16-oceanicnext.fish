...
set -U fish_color_selection cdd3de --bold --background=4f5b66
...
set -U fish_pager_color_background normal --background=1b2b34
set -U fish_pager_color_prefix normal --bold
set -U fish_pager_color_completion normal
set -U fish_pager_color_description f99157 --dim
set -U fish_pager_color_selected_background cdd3de --background=4f5b66
set -U fish_pager_color_selected_prefix cdd3de --bold --background=4f5b66
set -U fish_pager_color_selected_completion cdd3de
...
if test -n "$TINTED_SHELL_ENABLE_BASE16_VARS"; or test -n "$BASE16_SHELL_ENABLE_VARS"
  ...
  set -gx BASE16_COLOR_06_HEX "cdd3de"
  set -gx BASE16_COLOR_07_HEX "d8dee9"
  set -gx BASE16_COLOR_08_HEX "ec5f67"
  set -gx BASE16_COLOR_09_HEX "f99157"
  set -gx BASE16_COLOR_0A_HEX "fac863"
  set -gx BASE16_COLOR_0B_HEX "99c794"
  set -gx BASE16_COLOR_0C_HEX "5fb3b3"
  set -gx BASE16_COLOR_0D_HEX "6699cc"
  set -gx BASE16_COLOR_0E_HEX "c594c5"
