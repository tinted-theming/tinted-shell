...
set -l color01 "ca/73/6c" # Base 08 - Red
set -l color02 "47/a4/77" # Base 0B - Green
set -l color03 "8d/97/41" # Base 0A - Yellow
set -l color04 "57/94/d0" # Base 0D - Blue
set -l color05 "94/81/cc" # Base 0E - Magenta
set -l color06 "00/a2/af" # Base 0C - Cyan
set -l color07 "63/63/63" # Base 05 - White
set -l color08 "be/be/be" # Base 03 - Bright Black
...
set -l color15 "24/27/2b" # Base 07 - Bright White
set -l color16 "ba/82/3a" # Base 09
set -l color17 "bc/73/a4" # Base 0F
set -l color18 "ff/f7/ed" # Base 01
set -l color19 "f2/e6/d4" # Base 02
set -l color20 "8f/8f/8f" # Base 04
set -l color21 "30/33/38" # Base 06
...
set -U fish_color_param 8f8f8f
set -U fish_color_valid_path --underline
set -U fish_color_option brcyan
set -U fish_color_comment bebebe
set -U fish_color_selection 303338 --bold --background=f2e6d4
set -U fish_color_operator brblue
set -U fish_color_escape brcyan
set -U fish_color_autosuggestion bebebe
...
set -U fish_pager_color_progress fff7ed --background=8f8f8f
set -U fish_pager_color_background normal --background=fffdfb
set -U fish_pager_color_prefix normal --bold
set -U fish_pager_color_completion normal
set -U fish_pager_color_description ba823a --dim
set -U fish_pager_color_selected_background 303338 --background=f2e6d4
set -U fish_pager_color_selected_prefix 303338 --bold --background=f2e6d4
set -U fish_pager_color_selected_completion 303338
...
# Set theme
set -Ux BASE16_THEME penumbra-light
...
if test -n "$TINTED_SHELL_ENABLE_BASE16_VARS"; or test -n "$BASE16_SHELL_ENABLE_VARS"
  ...
  set -gx BASE16_COLOR_03_HEX "bebebe"
  set -gx BASE16_COLOR_04_HEX "8f8f8f"
  set -gx BASE16_COLOR_05_HEX "636363"
  set -gx BASE16_COLOR_06_HEX "303338"
  set -gx BASE16_COLOR_07_HEX "24272b"
  set -gx BASE16_COLOR_08_HEX "ca736c"
  set -gx BASE16_COLOR_09_HEX "ba823a"
  set -gx BASE16_COLOR_0A_HEX "8d9741"
  set -gx BASE16_COLOR_0B_HEX "47a477"
  set -gx BASE16_COLOR_0C_HEX "00a2af"
  set -gx BASE16_COLOR_0D_HEX "5794d0"
  set -gx BASE16_COLOR_0E_HEX "9481cc"
  set -gx BASE16_COLOR_0F_HEX "bc73a4"
end
