...
set -l color00 "0e/09/1d" # Base 00 - Black
set -l color01 "c5/32/53" # Base 08 - Red
set -l color02 "a6/8e/5a" # Base 0B - Green
set -l color03 "ff/65/65" # Base 0A - Yellow
set -l color04 "6e/60/80" # Base 0D - Blue
set -l color05 "a4/57/82" # Base 0E - Magenta
set -l color06 "8c/97/85" # Base 0C - Cyan
set -l color07 "aa/55/6f" # Base 05 - White
set -l color08 "74/31/6b" # Base 03 - Bright Black
...
set -l color15 "dc/8f/7c" # Base 07 - Bright White
set -l color16 "ea/4d/60" # Base 09
set -l color17 "98/4d/51" # Base 0F
set -l color18 "2a/15/3c" # Base 01
set -l color19 "4b/20/54" # Base 02
set -l color20 "8c/40/6f" # Base 04
set -l color21 "c4/68/6d" # Base 06
set -l color_foreground "aa/55/6f" # Base 05
set -l color_background "0e/09/1d" # Base 00
...
set -U fish_color_end aa556f
set -U fish_color_error brred
set -U fish_color_param 8c406f
set -U fish_color_valid_path --underline
set -U fish_color_option brcyan
set -U fish_color_comment 74316b
set -U fish_color_selection c4686d --bold --background=4b2054
set -U fish_color_operator brblue
set -U fish_color_escape brcyan
set -U fish_color_autosuggestion 74316b
...
set -U fish_pager_color_progress 2a153c --background=8c406f
set -U fish_pager_color_background normal --background=0e091d
set -U fish_pager_color_prefix normal --bold
set -U fish_pager_color_completion normal
set -U fish_pager_color_description ea4d60 --dim
set -U fish_pager_color_selected_background c4686d --background=4b2054
set -U fish_pager_color_selected_prefix c4686d --bold --background=4b2054
set -U fish_pager_color_selected_completion c4686d
...
# Set theme
set -Ux BASE16_THEME tarot

# Optionally export variables
if test -n "$TINTED_SHELL_ENABLE_BASE16_VARS"; or test -n "$BASE16_SHELL_ENABLE_VARS"
  set -gx BASE16_COLOR_00_HEX "0e091d"
  set -gx BASE16_COLOR_01_HEX "2a153c"
  set -gx BASE16_COLOR_02_HEX "4b2054"
  set -gx BASE16_COLOR_03_HEX "74316b"
  set -gx BASE16_COLOR_04_HEX "8c406f"
  set -gx BASE16_COLOR_05_HEX "aa556f"
  set -gx BASE16_COLOR_06_HEX "c4686d"
  set -gx BASE16_COLOR_07_HEX "dc8f7c"
  set -gx BASE16_COLOR_08_HEX "c53253"
  set -gx BASE16_COLOR_09_HEX "ea4d60"
  set -gx BASE16_COLOR_0A_HEX "ff6565"
  set -gx BASE16_COLOR_0B_HEX "a68e5a"
  set -gx BASE16_COLOR_0C_HEX "8c9785"
  set -gx BASE16_COLOR_0D_HEX "6e6080"
  set -gx BASE16_COLOR_0E_HEX "a45782"
  set -gx BASE16_COLOR_0F_HEX "984d51"
end
