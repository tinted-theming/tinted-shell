...
set -l color00 "24/1b/26" # Base 00 - Black
set -l color01 "87/7b/b6" # Base 08 - Red
set -l color02 "c9/65/bf" # Base 0B - Green
set -l color03 "a8/4a/73" # Base 0A - Yellow
set -l color04 "6a/9e/b5" # Base 0D - Blue
set -l color05 "78/a3/8f" # Base 0E - Magenta
set -l color06 "9c/5f/ce" # Base 0C - Cyan
set -l color07 "ee/d5/d9" # Base 05 - White
set -l color08 "6c/3c/b2" # Base 03 - Bright Black
...
set -l color15 "e4/cc/d0" # Base 07 - Bright White
set -l color16 "de/5b/44" # Base 09
set -l color17 "a3/a0/79" # Base 0F
set -l color18 "2f/2a/3f" # Base 01
set -l color19 "46/35/4a" # Base 02
set -l color20 "7e/5f/83" # Base 04
set -l color21 "d9/c2/c6" # Base 06
set -l color_foreground "ee/d5/d9" # Base 05
set -l color_background "24/1b/26" # Base 00
...
set -U fish_color_end eed5d9
set -U fish_color_error brred
set -U fish_color_param 7e5f83
set -U fish_color_valid_path --underline
set -U fish_color_option brcyan
set -U fish_color_comment 6c3cb2
set -U fish_color_selection d9c2c6 --bold --background=46354a
set -U fish_color_operator brblue
set -U fish_color_escape brcyan
set -U fish_color_autosuggestion 6c3cb2
...
set -U fish_color_search_match bryellow --background=46354a
set -U fish_color_history_current --bold
set -U fish_pager_color_progress 2f2a3f --background=7e5f83
set -U fish_pager_color_background normal --background=241b26
set -U fish_pager_color_prefix normal --bold
set -U fish_pager_color_completion normal
set -U fish_pager_color_description de5b44 --dim
set -U fish_pager_color_selected_background d9c2c6 --background=46354a
set -U fish_pager_color_selected_prefix d9c2c6 --bold --background=46354a
set -U fish_pager_color_selected_completion d9c2c6
...
# Set theme
set -Ux BASE16_THEME uwunicorn

# Optionally export variables
if test -n "$TINTED_SHELL_ENABLE_BASE16_VARS"; or test -n "$BASE16_SHELL_ENABLE_VARS"
  set -gx BASE16_COLOR_00_HEX "241b26"
  set -gx BASE16_COLOR_01_HEX "2f2a3f"
  set -gx BASE16_COLOR_02_HEX "46354a"
  set -gx BASE16_COLOR_03_HEX "6c3cb2"
  set -gx BASE16_COLOR_04_HEX "7e5f83"
  set -gx BASE16_COLOR_05_HEX "eed5d9"
  set -gx BASE16_COLOR_06_HEX "d9c2c6"
  set -gx BASE16_COLOR_07_HEX "e4ccd0"
  set -gx BASE16_COLOR_08_HEX "877bb6"
  set -gx BASE16_COLOR_09_HEX "de5b44"
  set -gx BASE16_COLOR_0A_HEX "a84a73"
  set -gx BASE16_COLOR_0B_HEX "c965bf"
  set -gx BASE16_COLOR_0C_HEX "9c5fce"
  set -gx BASE16_COLOR_0D_HEX "6a9eb5"
  set -gx BASE16_COLOR_0E_HEX "78a38f"
  set -gx BASE16_COLOR_0F_HEX "a3a079"
end
