...
set -l color00 "f6/f6/f6" # Base 00 - Black
set -l color01 "9c/5a/02" # Base 08 - Red
set -l color02 "38/78/1c" # Base 0B - Green
set -l color03 "c4/82/18" # Base 0A - Yellow
set -l color04 "48/ba/c2" # Base 0D - Blue
set -l color05 "a9/45/98" # Base 0E - Magenta
set -l color06 "2d/6b/b1" # Base 0C - Cyan
...
set -l color16 "c4/3e/18" # Base 09
set -l color17 "8b/6c/37" # Base 0F
set -l color18 "de/de/de" # Base 01
set -l color19 "bd/e5/f2" # Base 02
set -l color20 "76/76/76" # Base 04
set -l color21 "e8/e8/e8" # Base 06
set -l color_foreground "18/18/18" # Base 05
set -l color_background "f6/f6/f6" # Base 00
...
set -U fish_color_selection e8e8e8 --bold --background=bde5f2
...
set -U fish_pager_color_progress dedede --background=767676
set -U fish_pager_color_background normal --background=f6f6f6
set -U fish_pager_color_prefix normal --bold
set -U fish_pager_color_completion normal
set -U fish_pager_color_description c43e18 --dim
set -U fish_pager_color_selected_background e8e8e8 --background=bde5f2
set -U fish_pager_color_selected_prefix e8e8e8 --bold --background=bde5f2
set -U fish_pager_color_selected_completion e8e8e8
...
# Set theme
set -Ux BASE16_THEME ia-light

# Optionally export variables
if test -n "$TINTED_SHELL_ENABLE_BASE16_VARS"; or test -n "$BASE16_SHELL_ENABLE_VARS"
  set -gx BASE16_COLOR_00_HEX "f6f6f6"
  set -gx BASE16_COLOR_01_HEX "dedede"
  set -gx BASE16_COLOR_02_HEX "bde5f2"
  set -gx BASE16_COLOR_03_HEX "898989"
  set -gx BASE16_COLOR_04_HEX "767676"
  set -gx BASE16_COLOR_05_HEX "181818"
  set -gx BASE16_COLOR_06_HEX "e8e8e8"
  set -gx BASE16_COLOR_07_HEX "f8f8f8"
  set -gx BASE16_COLOR_08_HEX "9c5a02"
  set -gx BASE16_COLOR_09_HEX "c43e18"
  set -gx BASE16_COLOR_0A_HEX "c48218"
  set -gx BASE16_COLOR_0B_HEX "38781c"
  set -gx BASE16_COLOR_0C_HEX "2d6bb1"
  set -gx BASE16_COLOR_0D_HEX "48bac2"
  set -gx BASE16_COLOR_0E_HEX "a94598"
  set -gx BASE16_COLOR_0F_HEX "8b6c37"
end
