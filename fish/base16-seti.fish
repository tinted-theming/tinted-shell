...
set -l color00 "15/17/18" # Base 00 - Black
set -l color01 "cd/3f/45" # Base 08 - Red
set -l color02 "9f/ca/56" # Base 0B - Green
set -l color03 "e6/cd/69" # Base 0A - Yellow
set -l color04 "55/b5/db" # Base 0D - Blue
set -l color05 "a0/74/c4" # Base 0E - Magenta
set -l color06 "55/db/be" # Base 0C - Cyan
set -l color07 "d6/d6/d6" # Base 05 - White
set -l color08 "41/53/5b" # Base 03 - Bright Black
...
set -l color16 "db/7b/55" # Base 09
set -l color17 "8a/55/3f" # Base 0F
set -l color18 "28/2a/2b" # Base 01
set -l color19 "3b/75/8c" # Base 02
set -l color20 "43/a5/d5" # Base 04
set -l color21 "ee/ee/ee" # Base 06
set -l color_foreground "d6/d6/d6" # Base 05
set -l color_background "15/17/18" # Base 00
...
set -U fish_color_end d6d6d6
set -U fish_color_error brred
set -U fish_color_param 43a5d5
set -U fish_color_valid_path --underline
set -U fish_color_option brcyan
set -U fish_color_comment 41535b
set -U fish_color_selection eeeeee --bold --background=3b758c
set -U fish_color_operator brblue
set -U fish_color_escape brcyan
set -U fish_color_autosuggestion 41535b
...
set -U fish_pager_color_progress 282a2b --background=43a5d5
set -U fish_pager_color_background normal --background=151718
set -U fish_pager_color_prefix normal --bold
set -U fish_pager_color_completion normal
set -U fish_pager_color_description db7b55 --dim
set -U fish_pager_color_selected_background eeeeee --background=3b758c
set -U fish_pager_color_selected_prefix eeeeee --bold --background=3b758c
...
# Set theme
set -Ux BASE16_THEME seti

# Optionally export variables
if test -n "$TINTED_SHELL_ENABLE_BASE16_VARS"; or test -n "$BASE16_SHELL_ENABLE_VARS"
  set -gx BASE16_COLOR_00_HEX "151718"
  set -gx BASE16_COLOR_01_HEX "282a2b"
  set -gx BASE16_COLOR_02_HEX "3b758c"
  set -gx BASE16_COLOR_03_HEX "41535b"
  set -gx BASE16_COLOR_04_HEX "43a5d5"
  set -gx BASE16_COLOR_05_HEX "d6d6d6"
  set -gx BASE16_COLOR_06_HEX "eeeeee"
  set -gx BASE16_COLOR_07_HEX "ffffff"
  set -gx BASE16_COLOR_08_HEX "cd3f45"
  set -gx BASE16_COLOR_09_HEX "db7b55"
  set -gx BASE16_COLOR_0A_HEX "e6cd69"
  set -gx BASE16_COLOR_0B_HEX "9fca56"
  set -gx BASE16_COLOR_0C_HEX "55dbbe"
  set -gx BASE16_COLOR_0D_HEX "55b5db"
  set -gx BASE16_COLOR_0E_HEX "a074c4"
  set -gx BASE16_COLOR_0F_HEX "8a553f"
end
