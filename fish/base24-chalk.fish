...
set -l color00 "15/15/15" # Base 00 - Black
set -l color01 "fa/85/9c" # Base 08 - Red
set -l color02 "a1/bb/54" # Base 0B - Green
set -l color03 "dd/b2/6f" # Base 0A - Yellow
set -l color04 "5a/b9/ed" # Base 0D - Blue
set -l color05 "db/8f/ea" # Base 0E - Magenta
set -l color06 "10/bc/ad" # Base 0C - Cyan
...
set -l color16 "ea/99/71" # Base 09
set -l color17 "de/af/8f" # Base 0F
...
set -l color_background "15/15/15" # Base 00
...
set -U fish_color_selection e0e0e0 --bold --background=303030
...
set -U fish_pager_color_background normal --background=151515
set -U fish_pager_color_prefix normal --bold
set -U fish_pager_color_completion normal
set -U fish_pager_color_description ea9971 --dim
set -U fish_pager_color_selected_background e0e0e0 --background=303030
set -U fish_pager_color_selected_prefix e0e0e0 --bold --background=303030
...
# Set theme
set -Ux BASE24_THEME chalk

# Optionally export variables
if test -n "$TINTED_SHELL_ENABLE_BASE24_VARS"; or test -n "$BASE24_SHELL_ENABLE_VARS"
  set -gx BASE24_COLOR_00_HEX "151515"
  set -gx BASE24_COLOR_01_HEX "202020"
  set -gx BASE24_COLOR_02_HEX "303030"
  set -gx BASE24_COLOR_03_HEX "505050"
  set -gx BASE24_COLOR_04_HEX "b0b0b0"
  set -gx BASE24_COLOR_05_HEX "d0d0d0"
  set -gx BASE24_COLOR_06_HEX "e0e0e0"
  set -gx BASE24_COLOR_07_HEX "f5f5f5"
  set -gx BASE24_COLOR_08_HEX "fa859c"
  set -gx BASE24_COLOR_09_HEX "ea9971"
  set -gx BASE24_COLOR_0A_HEX "ddb26f"
  set -gx BASE24_COLOR_0B_HEX "a1bb54"
  set -gx BASE24_COLOR_0C_HEX "10bcad"
  set -gx BASE24_COLOR_0D_HEX "5ab9ed"
  set -gx BASE24_COLOR_0E_HEX "db8fea"
  set -gx BASE24_COLOR_0F_HEX "deaf8f"
end
