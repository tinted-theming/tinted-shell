...
set -l color01 "ed/5a/56" # Base 08 - Red
set -l color02 "ae/b8/31" # Base 0B - Green
set -l color03 "fb/b9/57" # Base 0A - Yellow
set -l color04 "81/a2/a2" # Base 0D - Blue
set -l color05 "cf/89/97" # Base 0E - Magenta
set -l color06 "88/b6/8d" # Base 0C - Cyan
...
set -l color16 "fc/8c/23" # Base 09
set -l color17 "cd/62/27" # Base 0F
...
set -U fish_pager_color_description fc8c23 --dim
...
# Set theme
set -Ux BASE16_THEME chinoiserie-midnight
...
if test -n "$TINTED_SHELL_ENABLE_BASE16_VARS"; or test -n "$BASE16_SHELL_ENABLE_VARS"
  ...
  set -gx BASE16_COLOR_08_HEX "ed5a56"
  set -gx BASE16_COLOR_09_HEX "fc8c23"
  set -gx BASE16_COLOR_0A_HEX "fbb957"
  set -gx BASE16_COLOR_0B_HEX "aeb831"
  set -gx BASE16_COLOR_0C_HEX "88b68d"
  set -gx BASE16_COLOR_0D_HEX "81a2a2"
  set -gx BASE16_COLOR_0E_HEX "cf8997"
  set -gx BASE16_COLOR_0F_HEX "cd6227"
end
