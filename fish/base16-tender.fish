...
set -l color00 "28/28/28" # Base 00 - Black
set -l color01 "f4/37/53" # Base 08 - Red
set -l color02 "c9/d0/5c" # Base 0B - Green
set -l color03 "ff/c2/4b" # Base 0A - Yellow
set -l color04 "b3/de/ef" # Base 0D - Blue
set -l color05 "d3/b9/87" # Base 0E - Magenta
set -l color06 "73/ce/f4" # Base 0C - Cyan
set -l color07 "ee/ee/ee" # Base 05 - White
set -l color08 "4c/4c/4c" # Base 03 - Bright Black
...
set -l color16 "dc/96/56" # Base 09
set -l color17 "a1/69/46" # Base 0F
set -l color18 "38/38/38" # Base 01
set -l color19 "48/48/48" # Base 02
set -l color20 "b8/b8/b8" # Base 04
set -l color21 "e8/e8/e8" # Base 06
set -l color_foreground "ee/ee/ee" # Base 05
set -l color_background "28/28/28" # Base 00
...
set -U fish_color_end eeeeee
set -U fish_color_error brred
set -U fish_color_param b8b8b8
set -U fish_color_valid_path --underline
set -U fish_color_option brcyan
set -U fish_color_comment 4c4c4c
set -U fish_color_selection e8e8e8 --bold --background=484848
set -U fish_color_operator brblue
set -U fish_color_escape brcyan
set -U fish_color_autosuggestion 4c4c4c
...
set -U fish_pager_color_progress 383838 --background=b8b8b8
set -U fish_pager_color_background normal --background=282828
set -U fish_pager_color_prefix normal --bold
set -U fish_pager_color_completion normal
set -U fish_pager_color_description dc9656 --dim
set -U fish_pager_color_selected_background e8e8e8 --background=484848
set -U fish_pager_color_selected_prefix e8e8e8 --bold --background=484848
...
# Set theme
set -Ux BASE16_THEME tender

# Optionally export variables
if test -n "$TINTED_SHELL_ENABLE_BASE16_VARS"; or test -n "$BASE16_SHELL_ENABLE_VARS"
  set -gx BASE16_COLOR_00_HEX "282828"
  set -gx BASE16_COLOR_01_HEX "383838"
  set -gx BASE16_COLOR_02_HEX "484848"
  set -gx BASE16_COLOR_03_HEX "4c4c4c"
  set -gx BASE16_COLOR_04_HEX "b8b8b8"
  set -gx BASE16_COLOR_05_HEX "eeeeee"
  set -gx BASE16_COLOR_06_HEX "e8e8e8"
  set -gx BASE16_COLOR_07_HEX "feffff"
  set -gx BASE16_COLOR_08_HEX "f43753"
  set -gx BASE16_COLOR_09_HEX "dc9656"
  set -gx BASE16_COLOR_0A_HEX "ffc24b"
  set -gx BASE16_COLOR_0B_HEX "c9d05c"
  set -gx BASE16_COLOR_0C_HEX "73cef4"
  set -gx BASE16_COLOR_0D_HEX "b3deef"
  set -gx BASE16_COLOR_0E_HEX "d3b987"
  set -gx BASE16_COLOR_0F_HEX "a16946"
end
