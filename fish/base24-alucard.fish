...
set -U fish_color_selection 1f1f1f --background=cfcfde
set -U fish_color_operator magenta
set -U fish_color_escape a34d14
...
set -U fish_color_search_match yellow --background=cfcfde
set -U fish_color_history_current --underline=curly
set -U fish_pager_color_progress ceccc0 --background=4c4a3d
set -U fish_pager_color_background --background=fffbeb
set -U fish_pager_color_prefix --bold --italics
set -U fish_pager_color_completion normal
set -U fish_pager_color_description a34d14
set -U fish_pager_color_selected_background --background=cfcfde
set -U fish_pager_color_selected_prefix --bold --italics --background=cfcfde
