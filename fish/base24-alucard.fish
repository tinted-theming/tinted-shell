...
set -l color00 "ff/fb/eb" # Base 00 - Black
set -l color01 "cb/3a/2a" # Base 08 - Red
set -l color02 "14/71/0a" # Base 0B - Green
set -l color03 "84/6e/15" # Base 0A - Yellow
set -l color04 "64/4a/c9" # Base 0D - Blue
set -l color05 "a3/14/4d" # Base 0E - Magenta
set -l color06 "03/6a/96" # Base 0C - Cyan
set -l color07 "1f/1f/1f" # Base 05 - White
set -l color08 "6c/66/4b" # Base 03 - Bright Black
...
set -l color15 "2c/2b/31" # Base 07 - Bright White
set -l color16 "a3/4d/14" # Base 09
set -l color17 "79/22/19" # Base 0F
set -l color18 "ce/cc/c0" # Base 01
set -l color19 "cf/cf/de" # Base 02
set -l color20 "4c/4a/3d" # Base 04
set -l color21 "1f/1f/1f" # Base 06
set -l color_foreground "1f/1f/1f" # Base 05
set -l color_background "ff/fb/eb" # Base 00
...
set -U fish_color_end 1f1f1f
set -U fish_color_error brred
set -U fish_color_param 4c4a3d
...
set -U fish_color_search_match bryellow --background=cfcfde
set -U fish_color_history_current --bold
set -U fish_pager_color_progress ceccc0 --background=4c4a3d
set -U fish_pager_color_background normal --background=fffbeb
set -U fish_pager_color_prefix normal --bold
set -U fish_pager_color_completion normal
set -U fish_pager_color_description a34d14 --dim
set -U fish_pager_color_selected_background 1f1f1f --background=cfcfde
set -U fish_pager_color_selected_prefix 1f1f1f --bold --background=cfcfde
set -U fish_pager_color_selected_completion 1f1f1f
...
# Set theme
set -Ux BASE24_THEME alucard

# Optionally export variables
if test -n "$TINTED_SHELL_ENABLE_BASE24_VARS"; or test -n "$BASE24_SHELL_ENABLE_VARS"
  set -gx BASE24_COLOR_00_HEX "fffbeb"
  set -gx BASE24_COLOR_01_HEX "ceccc0"
  set -gx BASE24_COLOR_02_HEX "cfcfde"
  set -gx BASE24_COLOR_03_HEX "6c664b"
  set -gx BASE24_COLOR_04_HEX "4c4a3d"
  set -gx BASE24_COLOR_05_HEX "1f1f1f"
  set -gx BASE24_COLOR_06_HEX "1f1f1f"
  set -gx BASE24_COLOR_07_HEX "2c2b31"
  set -gx BASE24_COLOR_08_HEX "cb3a2a"
  set -gx BASE24_COLOR_09_HEX "a34d14"
  set -gx BASE24_COLOR_0A_HEX "846e15"
  set -gx BASE24_COLOR_0B_HEX "14710a"
  set -gx BASE24_COLOR_0C_HEX "036a96"
  set -gx BASE24_COLOR_0D_HEX "644ac9"
  set -gx BASE24_COLOR_0E_HEX "a3144d"
  set -gx BASE24_COLOR_0F_HEX "792219"
end
