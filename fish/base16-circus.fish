...
set -l color01 "dc/65/7d" # Base 08 - Red
set -l color02 "84/b9/7c" # Base 0B - Green
set -l color03 "c3/ba/63" # Base 0A - Yellow
set -l color04 "63/9e/e4" # Base 0D - Blue
set -l color05 "b8/88/e2" # Base 0E - Magenta
set -l color06 "4b/b1/a7" # Base 0C - Cyan
set -l color07 "a7/a7/a7" # Base 05 - White
set -l color08 "5f/5a/60" # Base 03 - Bright Black
...
set -l color16 "4b/b1/a7" # Base 09
set -l color17 "b8/88/e2" # Base 0F
set -l color18 "20/20/20" # Base 01
set -l color19 "30/30/30" # Base 02
set -l color20 "50/50/50" # Base 04
set -l color21 "80/80/80" # Base 06
set -l color_foreground "a7/a7/a7" # Base 05
...
set -U fish_color_end a7a7a7
set -U fish_color_error brred
set -U fish_color_param 505050
set -U fish_color_valid_path --underline
set -U fish_color_option brcyan
set -U fish_color_comment 5f5a60
set -U fish_color_selection 808080 --bold --background=303030
set -U fish_color_operator brblue
set -U fish_color_escape brcyan
set -U fish_color_autosuggestion 5f5a60
...
set -U fish_pager_color_progress 202020 --background=505050
set -U fish_pager_color_background normal --background=191919
set -U fish_pager_color_prefix normal --bold
set -U fish_pager_color_completion normal
set -U fish_pager_color_description 4bb1a7 --dim
set -U fish_pager_color_selected_background 808080 --background=303030
set -U fish_pager_color_selected_prefix 808080 --bold --background=303030
set -U fish_pager_color_selected_completion 808080
...
if test -n "$TINTED_SHELL_ENABLE_BASE16_VARS"; or test -n "$BASE16_SHELL_ENABLE_VARS"
  ...
  set -gx BASE16_COLOR_03_HEX "5f5a60"
  set -gx BASE16_COLOR_04_HEX "505050"
  set -gx BASE16_COLOR_05_HEX "a7a7a7"
  set -gx BASE16_COLOR_06_HEX "808080"
  set -gx BASE16_COLOR_07_HEX "ffffff"
  set -gx BASE16_COLOR_08_HEX "dc657d"
  set -gx BASE16_COLOR_09_HEX "4bb1a7"
  set -gx BASE16_COLOR_0A_HEX "c3ba63"
  set -gx BASE16_COLOR_0B_HEX "84b97c"
  set -gx BASE16_COLOR_0C_HEX "4bb1a7"
  set -gx BASE16_COLOR_0D_HEX "639ee4"
  set -gx BASE16_COLOR_0E_HEX "b888e2"
  set -gx BASE16_COLOR_0F_HEX "b888e2"
end
