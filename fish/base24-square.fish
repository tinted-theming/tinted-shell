...
set -l color00 "1a/1a/1a" # Base 00 - Black
set -l color01 "e9/89/7c" # Base 08 - Red
set -l color02 "b6/37/7d" # Base 0B - Green
set -l color03 "b6/de/fb" # Base 0A - Yellow
set -l color04 "a9/cd/eb" # Base 0D - Blue
set -l color05 "75/50/7b" # Base 0E - Magenta
set -l color06 "c9/ca/ec" # Base 0C - Cyan
set -l color07 "ba/ba/ba" # Base 05 - White
set -l color08 "4b/4b/4b" # Base 03 - Bright Black
...
set -l color16 "ec/eb/be" # Base 09
set -l color17 "74/44/3e" # Base 0F
set -l color18 "05/05/05" # Base 01
set -l color19 "14/14/14" # Base 02
set -l color20 "83/83/83" # Base 04
set -l color21 "f2/f2/f2" # Base 06
set -l color_foreground "ba/ba/ba" # Base 05
set -l color_background "1a/1a/1a" # Base 00
...
set -U fish_color_end bababa
set -U fish_color_error brred
set -U fish_color_param 838383
set -U fish_color_valid_path --underline
set -U fish_color_option brcyan
set -U fish_color_comment 4b4b4b
set -U fish_color_selection f2f2f2 --bold --background=141414
set -U fish_color_operator brblue
set -U fish_color_escape brcyan
set -U fish_color_autosuggestion 4b4b4b
...
set -U fish_color_search_match bryellow --background=141414
set -U fish_color_history_current --bold
set -U fish_pager_color_progress 050505 --background=838383
set -U fish_pager_color_background normal --background=1a1a1a
set -U fish_pager_color_prefix normal --bold
set -U fish_pager_color_completion normal
set -U fish_pager_color_description ecebbe --dim
set -U fish_pager_color_selected_background f2f2f2 --background=141414
set -U fish_pager_color_selected_prefix f2f2f2 --bold --background=141414
set -U fish_pager_color_selected_completion f2f2f2
...
# Set theme
set -Ux BASE24_THEME square

# Optionally export variables
if test -n "$TINTED_SHELL_ENABLE_BASE24_VARS"; or test -n "$BASE24_SHELL_ENABLE_VARS"
  set -gx BASE24_COLOR_00_HEX "1a1a1a"
  set -gx BASE24_COLOR_01_HEX "050505"
  set -gx BASE24_COLOR_02_HEX "141414"
  set -gx BASE24_COLOR_03_HEX "4b4b4b"
  set -gx BASE24_COLOR_04_HEX "838383"
  set -gx BASE24_COLOR_05_HEX "bababa"
  set -gx BASE24_COLOR_06_HEX "f2f2f2"
  set -gx BASE24_COLOR_07_HEX "e2e2e2"
  set -gx BASE24_COLOR_08_HEX "e9897c"
  set -gx BASE24_COLOR_09_HEX "ecebbe"
  set -gx BASE24_COLOR_0A_HEX "b6defb"
  set -gx BASE24_COLOR_0B_HEX "b6377d"
  set -gx BASE24_COLOR_0C_HEX "c9caec"
  set -gx BASE24_COLOR_0D_HEX "a9cdeb"
  set -gx BASE24_COLOR_0E_HEX "75507b"
  set -gx BASE24_COLOR_0F_HEX "74443e"
end
