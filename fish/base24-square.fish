...
set -U fish_color_selection f2f2f2 --background=141414
set -U fish_color_operator magenta
set -U fish_color_escape ecebbe
...
set -U fish_color_search_match yellow --background=141414
set -U fish_color_history_current --underline=curly
set -U fish_pager_color_progress 050505 --background=838383
set -U fish_pager_color_background --background=1a1a1a
set -U fish_pager_color_prefix --bold --italics
set -U fish_pager_color_completion normal
set -U fish_pager_color_description ecebbe
set -U fish_pager_color_selected_background --background=141414
set -U fish_pager_color_selected_prefix --bold --italics --background=141414
