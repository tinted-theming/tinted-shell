...
set -l color00 "17/1e/1f" # Base 00 - Black
set -l color01 "ff/46/58" # Base 08 - Red
set -l color02 "49/91/80" # Base 0B - Green
set -l color03 "fd/b1/1f" # Base 0A - Yellow
set -l color04 "49/80/91" # Base 0D - Blue
set -l color05 "9b/c0/c8" # Base 0E - Magenta
set -l color06 "66/d9/ef" # Base 0C - Cyan
set -l color07 "c7/c7/a5" # Base 05 - White
set -l color08 "55/5e/5f" # Base 03 - Bright Black
...
set -l color15 "e1/ea/ef" # Base 07 - Bright White
set -l color16 "e6/db/74" # Base 09
set -l color17 "d2/7b/53" # Base 0F
set -l color18 "25/2c/2d" # Base 01
set -l color19 "37/3c/3d" # Base 02
set -l color20 "81/8f/80" # Base 04
set -l color21 "e3/e3/c8" # Base 06
set -l color_foreground "c7/c7/a5" # Base 05
set -l color_background "17/1e/1f" # Base 00
...
set -U fish_color_end c7c7a5
set -U fish_color_error brred
set -U fish_color_param 818f80
set -U fish_color_valid_path --underline
set -U fish_color_option brcyan
set -U fish_color_comment 555e5f
set -U fish_color_selection e3e3c8 --bold --background=373c3d
set -U fish_color_operator brblue
set -U fish_color_escape brcyan
set -U fish_color_autosuggestion 555e5f
...
set -U fish_pager_color_progress 252c2d --background=818f80
set -U fish_pager_color_background normal --background=171e1f
set -U fish_pager_color_prefix normal --bold
set -U fish_pager_color_completion normal
set -U fish_pager_color_description e6db74 --dim
set -U fish_pager_color_selected_background e3e3c8 --background=373c3d
set -U fish_pager_color_selected_prefix e3e3c8 --bold --background=373c3d
set -U fish_pager_color_selected_completion e3e3c8
...
# Set theme
set -Ux BASE16_THEME darkmoss

# Optionally export variables
if test -n "$TINTED_SHELL_ENABLE_BASE16_VARS"; or test -n "$BASE16_SHELL_ENABLE_VARS"
  set -gx BASE16_COLOR_00_HEX "171e1f"
  set -gx BASE16_COLOR_01_HEX "252c2d"
  set -gx BASE16_COLOR_02_HEX "373c3d"
  set -gx BASE16_COLOR_03_HEX "555e5f"
  set -gx BASE16_COLOR_04_HEX "818f80"
  set -gx BASE16_COLOR_05_HEX "c7c7a5"
  set -gx BASE16_COLOR_06_HEX "e3e3c8"
  set -gx BASE16_COLOR_07_HEX "e1eaef"
  set -gx BASE16_COLOR_08_HEX "ff4658"
  set -gx BASE16_COLOR_09_HEX "e6db74"
  set -gx BASE16_COLOR_0A_HEX "fdb11f"
  set -gx BASE16_COLOR_0B_HEX "499180"
  set -gx BASE16_COLOR_0C_HEX "66d9ef"
  set -gx BASE16_COLOR_0D_HEX "498091"
  set -gx BASE16_COLOR_0E_HEX "9bc0c8"
  set -gx BASE16_COLOR_0F_HEX "d27b53"
end
