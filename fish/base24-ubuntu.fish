...
set -l color00 "30/0a/24" # Base 00 - Black
set -l color01 "cc/00/00" # Base 08 - Red
set -l color02 "4e/9a/06" # Base 0B - Green
set -l color03 "72/9f/cf" # Base 0A - Yellow
...
set -l color08 "74/77/72" # Base 03 - Bright Black
...
set -l color16 "c4/a0/00" # Base 09
set -l color17 "66/00/00" # Base 0F
set -l color18 "2e/34/36" # Base 01
set -l color19 "55/57/53" # Base 02
set -l color20 "94/97/91" # Base 04
set -l color21 "d3/d7/cf" # Base 06
set -l color_foreground "b3/b7/b0" # Base 05
set -l color_background "30/0a/24" # Base 00
...
if test -n "$ITERM_SESSION_ID"
  ...
  put_template_custom Ph 300a24 # background
  put_template_custom Pi b3b7b0 # bold color
  put_template_custom Pj 555753 # selection color
  put_template_custom Pk b3b7b0 # selected text color
  put_template_custom Pl b3b7b0 # cursor
  put_template_custom Pm 300a24 # cursor text
else
...
set -U fish_color_end b3b7b0
set -U fish_color_error brred
set -U fish_color_param 949791
set -U fish_color_valid_path --underline
set -U fish_color_option brcyan
set -U fish_color_comment 747772
set -U fish_color_selection d3d7cf --bold --background=555753
set -U fish_color_operator brblue
set -U fish_color_escape brcyan
set -U fish_color_autosuggestion 747772
...
set -U fish_color_search_match bryellow --background=555753
set -U fish_color_history_current --bold
set -U fish_pager_color_progress 2e3436 --background=949791
set -U fish_pager_color_background normal --background=300a24
set -U fish_pager_color_prefix normal --bold
set -U fish_pager_color_completion normal
set -U fish_pager_color_description c4a000 --dim
set -U fish_pager_color_selected_background d3d7cf --background=555753
set -U fish_pager_color_selected_prefix d3d7cf --bold --background=555753
set -U fish_pager_color_selected_completion d3d7cf
...
# Set theme
set -Ux BASE24_THEME ubuntu

# Optionally export variables
if test -n "$TINTED_SHELL_ENABLE_BASE24_VARS"; or test -n "$BASE24_SHELL_ENABLE_VARS"
  set -gx BASE24_COLOR_00_HEX "300a24"
  set -gx BASE24_COLOR_01_HEX "2e3436"
  set -gx BASE24_COLOR_02_HEX "555753"
  set -gx BASE24_COLOR_03_HEX "747772"
  set -gx BASE24_COLOR_04_HEX "949791"
  set -gx BASE24_COLOR_05_HEX "b3b7b0"
  set -gx BASE24_COLOR_06_HEX "d3d7cf"
  set -gx BASE24_COLOR_07_HEX "eeeeec"
  set -gx BASE24_COLOR_08_HEX "cc0000"
  set -gx BASE24_COLOR_09_HEX "c4a000"
  set -gx BASE24_COLOR_0A_HEX "729fcf"
  set -gx BASE24_COLOR_0B_HEX "4e9a06"
  set -gx BASE24_COLOR_0C_HEX "06989a"
  set -gx BASE24_COLOR_0D_HEX "3465a4"
