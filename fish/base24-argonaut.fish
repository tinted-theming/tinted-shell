...
set -l color00 "0d/0f/18" # Base 00 - Black
set -l color01 "ff/00/0f" # Base 08 - Red
set -l color02 "8c/e0/0a" # Base 0B - Green
set -l color03 "00/92/ff" # Base 0A - Yellow
set -l color04 "00/8d/f8" # Base 0D - Blue
set -l color05 "6c/43/a5" # Base 0E - Magenta
set -l color06 "00/d7/eb" # Base 0C - Cyan
...
set -l color16 "ff/b9/00" # Base 09
set -l color17 "7f/00/07" # Base 0F
set -l color18 "22/22/22" # Base 01
set -l color19 "44/44/44" # Base 02
set -l color20 "a1/a1/a1" # Base 04
set -l color21 "ff/ff/ff" # Base 06
set -l color_foreground "d0/d0/d0" # Base 05
set -l color_background "0d/0f/18" # Base 00
...
set -U fish_color_comment 727272
set -U fish_color_selection ffffff --bold --background=444444
set -U fish_color_operator brblue
set -U fish_color_escape brcyan
set -U fish_color_autosuggestion 727272
...
set -U fish_color_search_match bryellow --background=444444
set -U fish_color_history_current --bold
set -U fish_pager_color_progress 222222 --background=a1a1a1
set -U fish_pager_color_background normal --background=0d0f18
set -U fish_pager_color_prefix normal --bold
set -U fish_pager_color_completion normal
set -U fish_pager_color_description ffb900 --dim
set -U fish_pager_color_selected_background ffffff --background=444444
set -U fish_pager_color_selected_prefix ffffff --bold --background=444444
...
# Set theme
set -Ux BASE24_THEME argonaut

# Optionally export variables
if test -n "$TINTED_SHELL_ENABLE_BASE24_VARS"; or test -n "$BASE24_SHELL_ENABLE_VARS"
  set -gx BASE24_COLOR_00_HEX "0d0f18"
  set -gx BASE24_COLOR_01_HEX "222222"
  set -gx BASE24_COLOR_02_HEX "444444"
  set -gx BASE24_COLOR_03_HEX "727272"
  set -gx BASE24_COLOR_04_HEX "a1a1a1"
  set -gx BASE24_COLOR_05_HEX "d0d0d0"
  set -gx BASE24_COLOR_06_HEX "ffffff"
  set -gx BASE24_COLOR_07_HEX "ffffff"
  set -gx BASE24_COLOR_08_HEX "ff000f"
  set -gx BASE24_COLOR_09_HEX "ffb900"
  set -gx BASE24_COLOR_0A_HEX "0092ff"
  set -gx BASE24_COLOR_0B_HEX "8ce00a"
  set -gx BASE24_COLOR_0C_HEX "00d7eb"
  set -gx BASE24_COLOR_0D_HEX "008df8"
  set -gx BASE24_COLOR_0E_HEX "6c43a5"
  set -gx BASE24_COLOR_0F_HEX "7f0007"
end
