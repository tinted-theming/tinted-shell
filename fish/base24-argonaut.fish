...
set -U fish_color_selection ffffff --background=444444
set -U fish_color_operator magenta
set -U fish_color_escape ffb900
...
set -U fish_color_search_match yellow --background=444444
set -U fish_color_history_current --underline=curly
set -U fish_pager_color_progress 222222 --background=a1a1a1
set -U fish_pager_color_background --background=0d0f18
set -U fish_pager_color_prefix --bold --italics
set -U fish_pager_color_completion normal
set -U fish_pager_color_description ffb900
set -U fish_pager_color_selected_background --background=444444
set -U fish_pager_color_selected_prefix --bold --italics --background=444444
