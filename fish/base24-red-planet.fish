...
set -l color00 "22/22/22" # Base 00 - Black
set -l color01 "8c/34/32" # Base 08 - Red
set -l color02 "72/82/71" # Base 0B - Green
set -l color03 "60/82/7e" # Base 0A - Yellow
set -l color04 "69/80/9e" # Base 0D - Blue
set -l color05 "89/64/92" # Base 0E - Magenta
set -l color06 "5b/83/90" # Base 0C - Cyan
set -l color07 "a4/99/8c" # Base 05 - White
set -l color08 "7b/77/73" # Base 03 - Bright Black
...
set -l color15 "d6/bf/b8" # Base 07 - Bright White
set -l color16 "e8/bf/6a" # Base 09
set -l color17 "46/1a/19" # Base 0F
set -l color18 "20/1f/1f" # Base 01
set -l color19 "67/67/67" # Base 02
set -l color20 "90/88/80" # Base 04
set -l color21 "b9/aa/99" # Base 06
set -l color_foreground "a4/99/8c" # Base 05
set -l color_background "22/22/22" # Base 00
...
set -U fish_color_end a4998c
set -U fish_color_error brred
set -U fish_color_param 908880
set -U fish_color_valid_path --underline
set -U fish_color_option brcyan
set -U fish_color_comment 7b7773
set -U fish_color_selection b9aa99 --bold --background=676767
set -U fish_color_operator brblue
set -U fish_color_escape brcyan
set -U fish_color_autosuggestion 7b7773
...
set -U fish_pager_color_progress 201f1f --background=908880
set -U fish_pager_color_background normal --background=222222
set -U fish_pager_color_prefix normal --bold
set -U fish_pager_color_completion normal
set -U fish_pager_color_description e8bf6a --dim
set -U fish_pager_color_selected_background b9aa99 --background=676767
set -U fish_pager_color_selected_prefix b9aa99 --bold --background=676767
set -U fish_pager_color_selected_completion b9aa99
...
# Set theme
set -Ux BASE24_THEME red-planet

# Optionally export variables
if test -n "$TINTED_SHELL_ENABLE_BASE24_VARS"; or test -n "$BASE24_SHELL_ENABLE_VARS"
  set -gx BASE24_COLOR_00_HEX "222222"
  set -gx BASE24_COLOR_01_HEX "201f1f"
  set -gx BASE24_COLOR_02_HEX "676767"
  set -gx BASE24_COLOR_03_HEX "7b7773"
  set -gx BASE24_COLOR_04_HEX "908880"
  set -gx BASE24_COLOR_05_HEX "a4998c"
  set -gx BASE24_COLOR_06_HEX "b9aa99"
  set -gx BASE24_COLOR_07_HEX "d6bfb8"
  set -gx BASE24_COLOR_08_HEX "8c3432"
  set -gx BASE24_COLOR_09_HEX "e8bf6a"
  set -gx BASE24_COLOR_0A_HEX "60827e"
  set -gx BASE24_COLOR_0B_HEX "728271"
  set -gx BASE24_COLOR_0C_HEX "5b8390"
  set -gx BASE24_COLOR_0D_HEX "69809e"
  set -gx BASE24_COLOR_0E_HEX "896492"
  set -gx BASE24_COLOR_0F_HEX "461a19"
end
