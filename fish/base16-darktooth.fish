...
set -l color01 "fb/54/3f" # Base 08 - Red
set -l color02 "95/c0/85" # Base 0B - Green
set -l color03 "fa/c0/3b" # Base 0A - Yellow
set -l color04 "0d/66/78" # Base 0D - Blue
set -l color05 "8f/46/73" # Base 0E - Magenta
set -l color06 "8b/a5/9b" # Base 0C - Cyan
...
set -l color16 "fe/86/25" # Base 09
set -l color17 "a8/73/22" # Base 0F
set -l color18 "32/30/2f" # Base 01
...
set -U fish_color_selection d5c4a1 --bold --background=504945
...
set -U fish_pager_color_progress 32302f --background=928374
set -U fish_pager_color_background normal --background=1d2021
set -U fish_pager_color_prefix normal --bold
set -U fish_pager_color_completion normal
set -U fish_pager_color_description fe8625 --dim
set -U fish_pager_color_selected_background d5c4a1 --background=504945
set -U fish_pager_color_selected_prefix d5c4a1 --bold --background=504945
...
if test -n "$TINTED_SHELL_ENABLE_BASE16_VARS"; or test -n "$BASE16_SHELL_ENABLE_VARS"
  ...
  set -gx BASE16_COLOR_08_HEX "fb543f"
  set -gx BASE16_COLOR_09_HEX "fe8625"
  set -gx BASE16_COLOR_0A_HEX "fac03b"
  set -gx BASE16_COLOR_0B_HEX "95c085"
  set -gx BASE16_COLOR_0C_HEX "8ba59b"
  set -gx BASE16_COLOR_0D_HEX "0d6678"
  set -gx BASE16_COLOR_0E_HEX "8f4673"
