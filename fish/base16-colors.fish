...
set -l color01 "ff/41/36" # Base 08 - Red
set -l color02 "2e/cc/40" # Base 0B - Green
set -l color03 "ff/dc/00" # Base 0A - Yellow
set -l color04 "00/74/d9" # Base 0D - Blue
set -l color05 "b1/0d/c9" # Base 0E - Magenta
set -l color06 "7f/db/ff" # Base 0C - Cyan
set -l color07 "bb/bb/bb" # Base 05 - White
...
set -U fish_pager_color_progress 333333 --background=999999
set -U fish_pager_color_background normal --background=111111
set -U fish_pager_color_prefix normal --bold
set -U fish_pager_color_completion normal
set -U fish_pager_color_description ff851b --dim
set -U fish_pager_color_selected_background dddddd --background=555555
set -U fish_pager_color_selected_prefix dddddd --bold --background=555555
...
# Set theme
set -Ux BASE16_THEME colors

# Optionally export variables
if test -n "$TINTED_SHELL_ENABLE_BASE16_VARS"; or test -n "$BASE16_SHELL_ENABLE_VARS"
  set -gx BASE16_COLOR_00_HEX "111111"
  set -gx BASE16_COLOR_01_HEX "333333"
  set -gx BASE16_COLOR_02_HEX "555555"
  set -gx BASE16_COLOR_03_HEX "777777"
  set -gx BASE16_COLOR_04_HEX "999999"
  set -gx BASE16_COLOR_05_HEX "bbbbbb"
  set -gx BASE16_COLOR_06_HEX "dddddd"
  set -gx BASE16_COLOR_07_HEX "ffffff"
  set -gx BASE16_COLOR_08_HEX "ff4136"
  set -gx BASE16_COLOR_09_HEX "ff851b"
  set -gx BASE16_COLOR_0A_HEX "ffdc00"
  set -gx BASE16_COLOR_0B_HEX "2ecc40"
  set -gx BASE16_COLOR_0C_HEX "7fdbff"
  set -gx BASE16_COLOR_0D_HEX "0074d9"
  set -gx BASE16_COLOR_0E_HEX "b10dc9"
  set -gx BASE16_COLOR_0F_HEX "85144b"
end
