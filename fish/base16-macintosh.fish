...
set -l color01 "dd/09/07" # Base 08 - Red
set -l color02 "1f/b7/14" # Base 0B - Green
set -l color03 "fb/f3/05" # Base 0A - Yellow
set -l color04 "00/00/d3" # Base 0D - Blue
set -l color05 "47/00/a5" # Base 0E - Magenta
set -l color06 "02/ab/ea" # Base 0C - Cyan
...
set -l color16 "ff/64/03" # Base 09
set -l color17 "90/71/3a" # Base 0F
set -l color18 "40/40/40" # Base 01
set -l color19 "40/40/40" # Base 02
...
set -U fish_color_selection c0c0c0 --bold --background=404040
...
set -U fish_pager_color_description ff6403 --dim
set -U fish_pager_color_selected_background c0c0c0 --background=404040
set -U fish_pager_color_selected_prefix c0c0c0 --bold --background=404040
...
if test -n "$TINTED_SHELL_ENABLE_BASE16_VARS"; or test -n "$BASE16_SHELL_ENABLE_VARS"
  ...
  set -gx BASE16_COLOR_02_HEX "404040"
  ...
  set -gx BASE16_COLOR_08_HEX "dd0907"
  set -gx BASE16_COLOR_09_HEX "ff6403"
  set -gx BASE16_COLOR_0A_HEX "fbf305"
  set -gx BASE16_COLOR_0B_HEX "1fb714"
  set -gx BASE16_COLOR_0C_HEX "02abea"
  set -gx BASE16_COLOR_0D_HEX "0000d3"
  set -gx BASE16_COLOR_0E_HEX "4700a5"
  set -gx BASE16_COLOR_0F_HEX "90713a"
end
