...
set -l color00 "1f/24/30" # Base 00 - Black
set -l color01 "f2/87/79" # Base 08 - Red
set -l color02 "d5/ff/80" # Base 0B - Green
set -l color03 "ff/d1/73" # Base 0A - Yellow
set -l color04 "73/d0/ff" # Base 0D - Blue
set -l color05 "d4/bf/ff" # Base 0E - Magenta
set -l color06 "95/e6/cb" # Base 0C - Cyan
set -l color07 "cc/ca/c2" # Base 05 - White
set -l color08 "4a/50/59" # Base 03 - Bright Black
...
set -l color15 "f3/f4/f5" # Base 07 - Bright White
set -l color16 "ff/ad/66" # Base 09
set -l color17 "f2/79/83" # Base 0F
set -l color18 "24/29/36" # Base 01
set -l color19 "32/38/44" # Base 02
set -l color20 "70/7a/8c" # Base 04
set -l color21 "d9/d7/ce" # Base 06
set -l color_foreground "cc/ca/c2" # Base 05
set -l color_background "1f/24/30" # Base 00
...
set -U fish_color_end cccac2
set -U fish_color_error brred
set -U fish_color_param 707a8c
set -U fish_color_valid_path --underline
set -U fish_color_option brcyan
set -U fish_color_comment 4a5059
set -U fish_color_selection d9d7ce --bold --background=323844
set -U fish_color_operator brblue
set -U fish_color_escape brcyan
set -U fish_color_autosuggestion 4a5059
...
set -U fish_color_search_match bryellow --background=323844
set -U fish_color_history_current --bold
set -U fish_pager_color_progress 242936 --background=707a8c
set -U fish_pager_color_background normal --background=1f2430
set -U fish_pager_color_prefix normal --bold
set -U fish_pager_color_completion normal
set -U fish_pager_color_description ffad66 --dim
set -U fish_pager_color_selected_background d9d7ce --background=323844
set -U fish_pager_color_selected_prefix d9d7ce --bold --background=323844
set -U fish_pager_color_selected_completion d9d7ce
...
# Set theme
set -Ux BASE24_THEME ayu-mirage

# Optionally export variables
if test -n "$TINTED_SHELL_ENABLE_BASE24_VARS"; or test -n "$BASE24_SHELL_ENABLE_VARS"
  set -gx BASE24_COLOR_00_HEX "1f2430"
  set -gx BASE24_COLOR_01_HEX "242936"
  set -gx BASE24_COLOR_02_HEX "323844"
  set -gx BASE24_COLOR_03_HEX "4a5059"
  set -gx BASE24_COLOR_04_HEX "707a8c"
  set -gx BASE24_COLOR_05_HEX "cccac2"
  set -gx BASE24_COLOR_06_HEX "d9d7ce"
  set -gx BASE24_COLOR_07_HEX "f3f4f5"
  set -gx BASE24_COLOR_08_HEX "f28779"
  set -gx BASE24_COLOR_09_HEX "ffad66"
  set -gx BASE24_COLOR_0A_HEX "ffd173"
  set -gx BASE24_COLOR_0B_HEX "d5ff80"
  set -gx BASE24_COLOR_0C_HEX "95e6cb"
  set -gx BASE24_COLOR_0D_HEX "73d0ff"
  set -gx BASE24_COLOR_0E_HEX "d4bfff"
  set -gx BASE24_COLOR_0F_HEX "f27983"
end
