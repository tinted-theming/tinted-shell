...
set -U fish_color_selection b9b5b8 --background=797379
set -U fish_color_operator magenta
set -U fish_color_escape fdcc59
...
set -U fish_color_search_match yellow --background=797379
set -U fish_color_history_current --underline=curly
set -U fish_pager_color_progress 322931 --background=999498
set -U fish_pager_color_background --background=322931
set -U fish_pager_color_prefix --bold --italics
set -U fish_pager_color_completion normal
set -U fish_pager_color_description fdcc59
set -U fish_pager_color_selected_background --background=797379
set -U fish_pager_color_selected_prefix --bold --italics --background=797379
