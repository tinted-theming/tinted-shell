...
set -l color00 "32/29/31" # Base 00 - Black
set -l color01 "dd/46/4c" # Base 08 - Red
set -l color02 "8f/c1/3e" # Base 0B - Green
set -l color03 "98/94/98" # Base 0A - Yellow
set -l color04 "12/90/bf" # Base 0D - Blue
set -l color05 "c8/5e/7c" # Base 0E - Magenta
set -l color06 "14/9b/93" # Base 0C - Cyan
set -l color07 "a9/a4/a8" # Base 05 - White
set -l color08 "89/83/88" # Base 03 - Bright Black
...
set -l color16 "fd/cc/59" # Base 09
set -l color17 "6e/23/26" # Base 0F
set -l color18 "32/29/31" # Base 01
set -l color19 "79/73/79" # Base 02
set -l color20 "99/94/98" # Base 04
set -l color21 "b9/b5/b8" # Base 06
set -l color_foreground "a9/a4/a8" # Base 05
set -l color_background "32/29/31" # Base 00
...
set -U fish_color_end a9a4a8
set -U fish_color_error brred
set -U fish_color_param 999498
set -U fish_color_valid_path --underline
set -U fish_color_option brcyan
set -U fish_color_comment 898388
set -U fish_color_selection b9b5b8 --bold --background=797379
set -U fish_color_operator brblue
set -U fish_color_escape brcyan
set -U fish_color_autosuggestion 898388
...
set -U fish_color_search_match bryellow --background=797379
set -U fish_color_history_current --bold
set -U fish_pager_color_progress 322931 --background=999498
set -U fish_pager_color_background normal --background=322931
set -U fish_pager_color_prefix normal --bold
set -U fish_pager_color_completion normal
set -U fish_pager_color_description fdcc59 --dim
set -U fish_pager_color_selected_background b9b5b8 --background=797379
set -U fish_pager_color_selected_prefix b9b5b8 --bold --background=797379
set -U fish_pager_color_selected_completion b9b5b8
...
# Set theme
set -Ux BASE24_THEME hopscotch

# Optionally export variables
if test -n "$TINTED_SHELL_ENABLE_BASE24_VARS"; or test -n "$BASE24_SHELL_ENABLE_VARS"
  set -gx BASE24_COLOR_00_HEX "322931"
  set -gx BASE24_COLOR_01_HEX "322931"
  set -gx BASE24_COLOR_02_HEX "797379"
  set -gx BASE24_COLOR_03_HEX "898388"
  set -gx BASE24_COLOR_04_HEX "999498"
  set -gx BASE24_COLOR_05_HEX "a9a4a8"
  set -gx BASE24_COLOR_06_HEX "b9b5b8"
  set -gx BASE24_COLOR_07_HEX "ffffff"
  set -gx BASE24_COLOR_08_HEX "dd464c"
  set -gx BASE24_COLOR_09_HEX "fdcc59"
  set -gx BASE24_COLOR_0A_HEX "989498"
  set -gx BASE24_COLOR_0B_HEX "8fc13e"
  set -gx BASE24_COLOR_0C_HEX "149b93"
  set -gx BASE24_COLOR_0D_HEX "1290bf"
  set -gx BASE24_COLOR_0E_HEX "c85e7c"
  set -gx BASE24_COLOR_0F_HEX "6e2326"
end
