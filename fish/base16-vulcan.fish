...
set -l color00 "04/15/23" # Base 00 - Black
set -l color01 "81/85/91" # Base 08 - Red
set -l color02 "97/7d/7c" # Base 0B - Green
set -l color03 "ad/b4/b9" # Base 0A - Yellow
set -l color04 "97/7d/7c" # Base 0D - Blue
set -l color05 "91/98/a3" # Base 0E - Magenta
set -l color06 "97/7d/7c" # Base 0C - Cyan
set -l color07 "5b/77/8c" # Base 05 - White
set -l color08 "7a/57/59" # Base 03 - Bright Black
...
set -l color15 "21/4d/68" # Base 07 - Bright White
set -l color16 "91/98/a3" # Base 09
set -l color17 "97/7d/7c" # Base 0F
set -l color18 "12/23/39" # Base 01
set -l color19 "00/35/52" # Base 02
set -l color20 "6b/69/77" # Base 04
set -l color21 "33/32/38" # Base 06
set -l color_foreground "5b/77/8c" # Base 05
set -l color_background "04/15/23" # Base 00
...
set -U fish_color_end 5b778c
set -U fish_color_error brred
set -U fish_color_param 6b6977
set -U fish_color_valid_path --underline
set -U fish_color_option brcyan
set -U fish_color_comment 7a5759
set -U fish_color_selection 333238 --bold --background=003552
set -U fish_color_operator brblue
set -U fish_color_escape brcyan
set -U fish_color_autosuggestion 7a5759
...
set -U fish_pager_color_progress 122339 --background=6b6977
set -U fish_pager_color_background normal --background=041523
set -U fish_pager_color_prefix normal --bold
set -U fish_pager_color_completion normal
set -U fish_pager_color_description 9198a3 --dim
set -U fish_pager_color_selected_background 333238 --background=003552
set -U fish_pager_color_selected_prefix 333238 --bold --background=003552
set -U fish_pager_color_selected_completion 333238
...
# Set theme
set -Ux BASE16_THEME vulcan

# Optionally export variables
if test -n "$TINTED_SHELL_ENABLE_BASE16_VARS"; or test -n "$BASE16_SHELL_ENABLE_VARS"
  set -gx BASE16_COLOR_00_HEX "041523"
  set -gx BASE16_COLOR_01_HEX "122339"
  set -gx BASE16_COLOR_02_HEX "003552"
  set -gx BASE16_COLOR_03_HEX "7a5759"
  set -gx BASE16_COLOR_04_HEX "6b6977"
  set -gx BASE16_COLOR_05_HEX "5b778c"
  set -gx BASE16_COLOR_06_HEX "333238"
  set -gx BASE16_COLOR_07_HEX "214d68"
  set -gx BASE16_COLOR_08_HEX "818591"
  set -gx BASE16_COLOR_09_HEX "9198a3"
  set -gx BASE16_COLOR_0A_HEX "adb4b9"
  set -gx BASE16_COLOR_0B_HEX "977d7c"
  set -gx BASE16_COLOR_0C_HEX "977d7c"
  set -gx BASE16_COLOR_0D_HEX "977d7c"
  set -gx BASE16_COLOR_0E_HEX "9198a3"
  set -gx BASE16_COLOR_0F_HEX "977d7c"
end
