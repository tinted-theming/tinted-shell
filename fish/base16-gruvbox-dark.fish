...
set -l color01 "cc/24/1d" # Base 08 - Red
set -l color02 "98/97/1a" # Base 0B - Green
set -l color03 "d7/99/21" # Base 0A - Yellow
set -l color04 "45/85/88" # Base 0D - Blue
set -l color05 "b1/62/86" # Base 0E - Magenta
set -l color06 "68/9d/6a" # Base 0C - Cyan
set -l color07 "eb/db/b2" # Base 05 - White
set -l color08 "66/5c/54" # Base 03 - Bright Black
...
set -l color15 "f9/f5/d7" # Base 07 - Bright White
set -l color16 "d6/5d/0e" # Base 09
set -l color17 "9d/00/06" # Base 0F
set -l color18 "3c/38/36" # Base 01
set -l color19 "50/49/45" # Base 02
set -l color20 "92/83/74" # Base 04
set -l color21 "fb/f1/c7" # Base 06
set -l color_foreground "eb/db/b2" # Base 05
...
set -U fish_color_selection fbf1c7 --bold --background=504945
...
set -U fish_pager_color_progress 3c3836 --background=928374
set -U fish_pager_color_background normal --background=282828
set -U fish_pager_color_prefix normal --bold
set -U fish_pager_color_completion normal
set -U fish_pager_color_description d65d0e --dim
set -U fish_pager_color_selected_background fbf1c7 --background=504945
set -U fish_pager_color_selected_prefix fbf1c7 --bold --background=504945
set -U fish_pager_color_selected_completion fbf1c7
...
# Set theme
set -Ux BASE16_THEME gruvbox-dark
...
if test -n "$TINTED_SHELL_ENABLE_BASE16_VARS"; or test -n "$BASE16_SHELL_ENABLE_VARS"
  ...
  set -gx BASE16_COLOR_02_HEX "504945"
  set -gx BASE16_COLOR_03_HEX "665c54"
  set -gx BASE16_COLOR_04_HEX "928374"
  set -gx BASE16_COLOR_05_HEX "ebdbb2"
  set -gx BASE16_COLOR_06_HEX "fbf1c7"
  set -gx BASE16_COLOR_07_HEX "f9f5d7"
  set -gx BASE16_COLOR_08_HEX "cc241d"
  set -gx BASE16_COLOR_09_HEX "d65d0e"
  set -gx BASE16_COLOR_0A_HEX "d79921"
  set -gx BASE16_COLOR_0B_HEX "98971a"
  set -gx BASE16_COLOR_0C_HEX "689d6a"
  set -gx BASE16_COLOR_0D_HEX "458588"
  set -gx BASE16_COLOR_0E_HEX "b16286"
  set -gx BASE16_COLOR_0F_HEX "9d0006"
end
