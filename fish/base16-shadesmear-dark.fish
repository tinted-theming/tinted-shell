...
set -l color00 "23/23/23" # Base 00 - Black
...
set -l color07 "db/db/db" # Base 05 - White
set -l color08 "c0/c0/c0" # Base 03 - Bright Black
...
set -l color15 "1c/1c/1c" # Base 07 - Bright White
set -l color16 "a6/42/70" # Base 09
set -l color17 "6d/6d/6d" # Base 0F
set -l color18 "1c/1c/1c" # Base 01
set -l color19 "4e/4e/4e" # Base 02
set -l color20 "e4/e4/e4" # Base 04
set -l color21 "e4/e4/e4" # Base 06
set -l color_foreground "db/db/db" # Base 05
set -l color_background "23/23/23" # Base 00
...
set -U fish_color_end dbdbdb
set -U fish_color_error brred
set -U fish_color_param e4e4e4
set -U fish_color_valid_path --underline
set -U fish_color_option brcyan
set -U fish_color_comment c0c0c0
set -U fish_color_selection e4e4e4 --bold --background=4e4e4e
...
set -U fish_pager_color_progress 1c1c1c --background=e4e4e4
set -U fish_pager_color_background normal --background=232323
set -U fish_pager_color_prefix normal --bold
set -U fish_pager_color_completion normal
set -U fish_pager_color_description a64270 --dim
set -U fish_pager_color_selected_background e4e4e4 --background=4e4e4e
set -U fish_pager_color_selected_prefix e4e4e4 --bold --background=4e4e4e
...
# Set theme
set -Ux BASE16_THEME shadesmear-dark

# Optionally export variables
if test -n "$TINTED_SHELL_ENABLE_BASE16_VARS"; or test -n "$BASE16_SHELL_ENABLE_VARS"
  set -gx BASE16_COLOR_00_HEX "232323"
  set -gx BASE16_COLOR_01_HEX "1c1c1c"
  set -gx BASE16_COLOR_02_HEX "4e4e4e"
  set -gx BASE16_COLOR_03_HEX "c0c0c0"
  set -gx BASE16_COLOR_04_HEX "e4e4e4"
  set -gx BASE16_COLOR_05_HEX "dbdbdb"
  set -gx BASE16_COLOR_06_HEX "e4e4e4"
  set -gx BASE16_COLOR_07_HEX "1c1c1c"
