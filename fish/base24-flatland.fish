...
set -l color01 "f1/82/38" # Base 08 - Red
set -l color02 "9e/d2/64" # Base 0B - Green
set -l color03 "61/b8/d0" # Base 0A - Yellow
set -l color04 "4f/96/be" # Base 0D - Blue
set -l color05 "69/5a/bb" # Base 0E - Magenta
set -l color06 "d5/38/64" # Base 0C - Cyan
set -l color07 "c5/c6/c4" # Base 05 - White
set -l color08 "54/55/52" # Base 03 - Bright Black
...
set -l color15 "fe/ff/fe" # Base 07 - Bright White
set -l color16 "f3/ef/6d" # Base 09
set -l color17 "78/41/1c" # Base 0F
set -l color18 "1c/1d/19" # Base 01
set -l color19 "1c/1d/19" # Base 02
set -l color20 "8d/8e/8b" # Base 04
set -l color21 "fe/ff/fe" # Base 06
set -l color_foreground "c5/c6/c4" # Base 05
...
set -U fish_color_end c5c6c4
set -U fish_color_error brred
set -U fish_color_param 8d8e8b
set -U fish_color_valid_path --underline
set -U fish_color_option brcyan
set -U fish_color_comment 545552
set -U fish_color_selection fefffe --bold --background=1c1d19
set -U fish_color_operator brblue
set -U fish_color_escape brcyan
set -U fish_color_autosuggestion 545552
...
set -U fish_color_search_match bryellow --background=1c1d19
set -U fish_color_history_current --bold
set -U fish_pager_color_progress 1c1d19 --background=8d8e8b
set -U fish_pager_color_background normal --background=1c1e20
set -U fish_pager_color_prefix normal --bold
set -U fish_pager_color_completion normal
set -U fish_pager_color_description f3ef6d --dim
set -U fish_pager_color_selected_background fefffe --background=1c1d19
set -U fish_pager_color_selected_prefix fefffe --bold --background=1c1d19
set -U fish_pager_color_selected_completion fefffe
...
# Set theme
set -Ux BASE24_THEME flatland

# Optionally export variables
if test -n "$TINTED_SHELL_ENABLE_BASE24_VARS"; or test -n "$BASE24_SHELL_ENABLE_VARS"
  set -gx BASE24_COLOR_00_HEX "1c1e20"
  set -gx BASE24_COLOR_01_HEX "1c1d19"
  set -gx BASE24_COLOR_02_HEX "1c1d19"
  set -gx BASE24_COLOR_03_HEX "545552"
  set -gx BASE24_COLOR_04_HEX "8d8e8b"
  set -gx BASE24_COLOR_05_HEX "c5c6c4"
  set -gx BASE24_COLOR_06_HEX "fefffe"
  set -gx BASE24_COLOR_07_HEX "fefffe"
  set -gx BASE24_COLOR_08_HEX "f18238"
  set -gx BASE24_COLOR_09_HEX "f3ef6d"
  set -gx BASE24_COLOR_0A_HEX "61b8d0"
  set -gx BASE24_COLOR_0B_HEX "9ed264"
  set -gx BASE24_COLOR_0C_HEX "d53864"
  set -gx BASE24_COLOR_0D_HEX "4f96be"
  set -gx BASE24_COLOR_0E_HEX "695abb"
  set -gx BASE24_COLOR_0F_HEX "78411c"
end
