...
set -l color00 "17/15/17" # Base 00 - Black
set -l color01 "ff/a6/00" # Base 08 - Red
set -l color02 "ff/00/66" # Base 0B - Green
set -l color03 "20/df/6c" # Base 0A - Yellow
set -l color04 "00/ff/ff" # Base 0D - Blue
set -l color05 "00/7f/ff" # Base 0E - Magenta
set -l color06 "66/00/ff" # Base 0C - Cyan
set -l color07 "f5/f5/f5" # Base 05 - White
set -l color08 "38/33/38" # Base 03 - Bright Black
...
set -l color16 "00/ff/66" # Base 09
set -l color17 "df/20/6c" # Base 0F
set -l color18 "1b/18/1b" # Base 01
set -l color19 "1d/1b/1d" # Base 02
set -l color20 "e7/db/db" # Base 04
set -l color21 "ff/ff/ff" # Base 06
set -l color_foreground "f5/f5/f5" # Base 05
set -l color_background "17/15/17" # Base 00
...
set -U fish_color_end f5f5f5
set -U fish_color_error brred
set -U fish_color_param e7dbdb
set -U fish_color_valid_path --underline
set -U fish_color_option brcyan
set -U fish_color_comment 383338
set -U fish_color_selection ffffff --bold --background=1d1b1d
set -U fish_color_operator brblue
set -U fish_color_escape brcyan
set -U fish_color_autosuggestion 383338
...
set -U fish_pager_color_progress 1b181b --background=e7dbdb
set -U fish_pager_color_background normal --background=171517
set -U fish_pager_color_prefix normal --bold
set -U fish_pager_color_completion normal
set -U fish_pager_color_description 00ff66 --dim
set -U fish_pager_color_selected_background ffffff --background=1d1b1d
set -U fish_pager_color_selected_prefix ffffff --bold --background=1d1b1d
...
# Set theme
set -Ux BASE16_THEME pinky

# Optionally export variables
if test -n "$TINTED_SHELL_ENABLE_BASE16_VARS"; or test -n "$BASE16_SHELL_ENABLE_VARS"
  set -gx BASE16_COLOR_00_HEX "171517"
  set -gx BASE16_COLOR_01_HEX "1b181b"
  set -gx BASE16_COLOR_02_HEX "1d1b1d"
  set -gx BASE16_COLOR_03_HEX "383338"
  set -gx BASE16_COLOR_04_HEX "e7dbdb"
  set -gx BASE16_COLOR_05_HEX "f5f5f5"
  set -gx BASE16_COLOR_06_HEX "ffffff"
  set -gx BASE16_COLOR_07_HEX "f7f3f7"
  set -gx BASE16_COLOR_08_HEX "ffa600"
  set -gx BASE16_COLOR_09_HEX "00ff66"
  set -gx BASE16_COLOR_0A_HEX "20df6c"
  set -gx BASE16_COLOR_0B_HEX "ff0066"
  set -gx BASE16_COLOR_0C_HEX "6600ff"
  set -gx BASE16_COLOR_0D_HEX "00ffff"
  set -gx BASE16_COLOR_0E_HEX "007fff"
  set -gx BASE16_COLOR_0F_HEX "df206c"
end
