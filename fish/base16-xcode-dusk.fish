...
set -l color00 "28/2b/35" # Base 00 - Black
set -l color01 "b2/18/89" # Base 08 - Red
set -l color02 "df/00/02" # Base 0B - Green
set -l color03 "43/82/88" # Base 0A - Yellow
set -l color04 "79/0e/ad" # Base 0D - Blue
set -l color05 "b2/18/89" # Base 0E - Magenta
set -l color06 "00/a0/be" # Base 0C - Cyan
set -l color07 "93/95/99" # Base 05 - White
set -l color08 "68/6a/71" # Base 03 - Bright Black
...
set -l color15 "be/bf/c2" # Base 07 - Bright White
set -l color16 "78/6d/c5" # Base 09
set -l color17 "c7/7c/48" # Base 0F
set -l color18 "3d/40/48" # Base 01
set -l color19 "53/55/5d" # Base 02
set -l color20 "7e/80/86" # Base 04
set -l color21 "a9/aa/ae" # Base 06
set -l color_foreground "93/95/99" # Base 05
set -l color_background "28/2b/35" # Base 00
...
set -U fish_color_end 939599
set -U fish_color_error brred
set -U fish_color_param 7e8086
set -U fish_color_valid_path --underline
set -U fish_color_option brcyan
set -U fish_color_comment 686a71
set -U fish_color_selection a9aaae --bold --background=53555d
set -U fish_color_operator brblue
set -U fish_color_escape brcyan
set -U fish_color_autosuggestion 686a71
...
set -U fish_pager_color_progress 3d4048 --background=7e8086
set -U fish_pager_color_background normal --background=282b35
set -U fish_pager_color_prefix normal --bold
set -U fish_pager_color_completion normal
set -U fish_pager_color_description 786dc5 --dim
set -U fish_pager_color_selected_background a9aaae --background=53555d
set -U fish_pager_color_selected_prefix a9aaae --bold --background=53555d
set -U fish_pager_color_selected_completion a9aaae
...
# Set theme
set -Ux BASE16_THEME xcode-dusk

# Optionally export variables
if test -n "$TINTED_SHELL_ENABLE_BASE16_VARS"; or test -n "$BASE16_SHELL_ENABLE_VARS"
  set -gx BASE16_COLOR_00_HEX "282b35"
  set -gx BASE16_COLOR_01_HEX "3d4048"
  set -gx BASE16_COLOR_02_HEX "53555d"
  set -gx BASE16_COLOR_03_HEX "686a71"
  set -gx BASE16_COLOR_04_HEX "7e8086"
  set -gx BASE16_COLOR_05_HEX "939599"
  set -gx BASE16_COLOR_06_HEX "a9aaae"
  set -gx BASE16_COLOR_07_HEX "bebfc2"
  set -gx BASE16_COLOR_08_HEX "b21889"
  set -gx BASE16_COLOR_09_HEX "786dc5"
  set -gx BASE16_COLOR_0A_HEX "438288"
  set -gx BASE16_COLOR_0B_HEX "df0002"
  set -gx BASE16_COLOR_0C_HEX "00a0be"
  set -gx BASE16_COLOR_0D_HEX "790ead"
  set -gx BASE16_COLOR_0E_HEX "b21889"
  set -gx BASE16_COLOR_0F_HEX "c77c48"
end
