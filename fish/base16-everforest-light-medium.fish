...
set -l color15 "2d/35/3b" # Base 07 - Bright White
set -l color16 "f5/7d/26" # Base 09
set -l color17 "82/91/81" # Base 0F
set -l color18 "f4/f0/d9" # Base 01
set -l color19 "e6/e2/cc" # Base 02
set -l color20 "82/91/81" # Base 04
set -l color21 "47/52/58" # Base 06
...
if test -n "$ITERM_SESSION_ID"
  ...
  put_template_custom Pj e6e2cc # selection color
...
set -U fish_color_selection 475258 --bold --background=e6e2cc
...
set -U fish_color_search_match bryellow --background=e6e2cc
set -U fish_color_history_current --bold
set -U fish_pager_color_progress f4f0d9 --background=829181
set -U fish_pager_color_background normal --background=fdf6e3
set -U fish_pager_color_prefix normal --bold
set -U fish_pager_color_completion normal
set -U fish_pager_color_description f57d26 --dim
set -U fish_pager_color_selected_background 475258 --background=e6e2cc
set -U fish_pager_color_selected_prefix 475258 --bold --background=e6e2cc
set -U fish_pager_color_selected_completion 475258
...
# Set theme
set -Ux BASE16_THEME everforest-light-medium

# Optionally export variables
if test -n "$TINTED_SHELL_ENABLE_BASE16_VARS"; or test -n "$BASE16_SHELL_ENABLE_VARS"
  set -gx BASE16_COLOR_00_HEX "fdf6e3"
  set -gx BASE16_COLOR_01_HEX "f4f0d9"
  set -gx BASE16_COLOR_02_HEX "e6e2cc"
  set -gx BASE16_COLOR_03_HEX "939f91"
  set -gx BASE16_COLOR_04_HEX "829181"
  set -gx BASE16_COLOR_05_HEX "5c6a72"
  set -gx BASE16_COLOR_06_HEX "475258"
  set -gx BASE16_COLOR_07_HEX "2d353b"
