...
set -l color00 "0b/1c/2c" # Base 00 - Black
...
set -l color07 "cb/d6/e2" # Base 05 - White
set -l color08 "62/7e/99" # Base 03 - Bright Black
...
set -l color15 "f7/f9/fb" # Base 07 - Bright White
set -l color16 "bf/bf/56" # Base 09
set -l color17 "bf/56/56" # Base 0F
set -l color18 "22/3b/54" # Base 01
set -l color19 "40/5c/79" # Base 02
set -l color20 "aa/bc/ce" # Base 04
set -l color21 "e5/eb/f1" # Base 06
set -l color_foreground "cb/d6/e2" # Base 05
set -l color_background "0b/1c/2c" # Base 00
...
set -U fish_color_end cbd6e2
set -U fish_color_error brred
set -U fish_color_param aabcce
set -U fish_color_valid_path --underline
set -U fish_color_option brcyan
set -U fish_color_comment 627e99
set -U fish_color_selection e5ebf1 --bold --background=405c79
set -U fish_color_operator brblue
set -U fish_color_escape brcyan
set -U fish_color_autosuggestion 627e99
...
set -U fish_pager_color_progress 223b54 --background=aabcce
set -U fish_pager_color_background normal --background=0b1c2c
set -U fish_pager_color_prefix normal --bold
set -U fish_pager_color_completion normal
set -U fish_pager_color_description bfbf56 --dim
set -U fish_pager_color_selected_background e5ebf1 --background=405c79
set -U fish_pager_color_selected_prefix e5ebf1 --bold --background=405c79
set -U fish_pager_color_selected_completion e5ebf1
...
# Set theme
set -Ux BASE16_THEME harmonic16-dark

# Optionally export variables
if test -n "$TINTED_SHELL_ENABLE_BASE16_VARS"; or test -n "$BASE16_SHELL_ENABLE_VARS"
  set -gx BASE16_COLOR_00_HEX "0b1c2c"
  set -gx BASE16_COLOR_01_HEX "223b54"
  set -gx BASE16_COLOR_02_HEX "405c79"
  set -gx BASE16_COLOR_03_HEX "627e99"
  set -gx BASE16_COLOR_04_HEX "aabcce"
  set -gx BASE16_COLOR_05_HEX "cbd6e2"
  set -gx BASE16_COLOR_06_HEX "e5ebf1"
  set -gx BASE16_COLOR_07_HEX "f7f9fb"
