...
set -l color00 "1f/16/26" # Base 00 - Black
set -l color01 "d9/40/85" # Base 08 - Red
set -l color02 "2a/b2/50" # Base 0B - Green
set -l color03 "2f/8b/b9" # Base 0A - Yellow
set -l color04 "88/3c/dc" # Base 0D - Blue
set -l color05 "ec/ec/ec" # Base 0E - Magenta
set -l color06 "c1/b8/b7" # Base 0C - Cyan
set -l color07 "bf/e1/d8" # Base 05 - White
set -l color08 "3f/b3/ce" # Base 03 - Bright Black
...
set -l color15 "e4/83/8d" # Base 07 - Bright White
set -l color16 "ff/d1/6f" # Base 09
set -l color17 "6c/20/42" # Base 0F
set -l color18 "00/05/06" # Base 01
set -l color19 "00/9c/c9" # Base 02
set -l color20 "7f/ca/d3" # Base 04
set -l color21 "ff/f8/dd" # Base 06
set -l color_foreground "bf/e1/d8" # Base 05
set -l color_background "1f/16/26" # Base 00
...
set -U fish_color_end bfe1d8
set -U fish_color_error brred
set -U fish_color_param 7fcad3
set -U fish_color_valid_path --underline
set -U fish_color_option brcyan
set -U fish_color_comment 3fb3ce
set -U fish_color_selection fff8dd --bold --background=009cc9
set -U fish_color_operator brblue
set -U fish_color_escape brcyan
set -U fish_color_autosuggestion 3fb3ce
...
set -U fish_color_search_match bryellow --background=009cc9
set -U fish_color_history_current --bold
set -U fish_pager_color_progress 000506 --background=7fcad3
set -U fish_pager_color_background normal --background=1f1626
set -U fish_pager_color_prefix normal --bold
set -U fish_pager_color_completion normal
set -U fish_pager_color_description ffd16f --dim
set -U fish_pager_color_selected_background fff8dd --background=009cc9
set -U fish_pager_color_selected_prefix fff8dd --bold --background=009cc9
set -U fish_pager_color_selected_completion fff8dd
...
# Set theme
set -Ux BASE24_THEME wild-cherry

# Optionally export variables
if test -n "$TINTED_SHELL_ENABLE_BASE24_VARS"; or test -n "$BASE24_SHELL_ENABLE_VARS"
  set -gx BASE24_COLOR_00_HEX "1f1626"
  set -gx BASE24_COLOR_01_HEX "000506"
  set -gx BASE24_COLOR_02_HEX "009cc9"
  set -gx BASE24_COLOR_03_HEX "3fb3ce"
  set -gx BASE24_COLOR_04_HEX "7fcad3"
  set -gx BASE24_COLOR_05_HEX "bfe1d8"
  set -gx BASE24_COLOR_06_HEX "fff8dd"
  set -gx BASE24_COLOR_07_HEX "e4838d"
  set -gx BASE24_COLOR_08_HEX "d94085"
  set -gx BASE24_COLOR_09_HEX "ffd16f"
  set -gx BASE24_COLOR_0A_HEX "2f8bb9"
  set -gx BASE24_COLOR_0B_HEX "2ab250"
  set -gx BASE24_COLOR_0C_HEX "c1b8b7"
  set -gx BASE24_COLOR_0D_HEX "883cdc"
  set -gx BASE24_COLOR_0E_HEX "ececec"
  set -gx BASE24_COLOR_0F_HEX "6c2042"
end
