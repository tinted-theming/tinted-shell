...
set -U fish_color_selection fff8dd --background=009cc9
set -U fish_color_operator magenta
set -U fish_color_escape ffd16f
...
set -U fish_color_search_match yellow --background=009cc9
set -U fish_color_history_current --underline=curly
set -U fish_pager_color_progress 000506 --background=7fcad3
set -U fish_pager_color_background --background=1f1626
set -U fish_pager_color_prefix --bold --italics
set -U fish_pager_color_completion normal
set -U fish_pager_color_description ffd16f
set -U fish_pager_color_selected_background --background=009cc9
set -U fish_pager_color_selected_prefix --bold --italics --background=009cc9
