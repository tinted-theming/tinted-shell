...
set -l color01 "83/a5/98" # Base 08 - Red
set -l color02 "52/8b/8b" # Base 0B - Green
set -l color03 "a0/7e/3b" # Base 0A - Yellow
set -l color04 "83/a5/98" # Base 0D - Blue
set -l color05 "d7/5f/5f" # Base 0E - Magenta
set -l color06 "83/a5/98" # Base 0C - Cyan
set -l color07 "a8/99/84" # Base 05 - White
...
set -l color15 "fd/f4/c1" # Base 07 - Bright White
set -l color16 "a0/7e/3b" # Base 09
set -l color17 "a8/73/22" # Base 0F
set -l color18 "2c/32/3b" # Base 01
set -l color19 "3e/44/51" # Base 02
set -l color20 "92/83/74" # Base 04
set -l color21 "d5/c4/a1" # Base 06
set -l color_foreground "a8/99/84" # Base 05
...
set -U fish_color_selection d5c4a1 --bold --background=3e4451
...
set -U fish_pager_color_progress 2c323b --background=928374
set -U fish_pager_color_background normal --background=282c34
set -U fish_pager_color_prefix normal --bold
set -U fish_pager_color_completion normal
set -U fish_pager_color_description a07e3b --dim
set -U fish_pager_color_selected_background d5c4a1 --background=3e4451
set -U fish_pager_color_selected_prefix d5c4a1 --bold --background=3e4451
set -U fish_pager_color_selected_completion d5c4a1
...
# Set theme
set -Ux BASE16_THEME sandcastle

# Optionally export variables
if test -n "$TINTED_SHELL_ENABLE_BASE16_VARS"; or test -n "$BASE16_SHELL_ENABLE_VARS"
  set -gx BASE16_COLOR_00_HEX "282c34"
  set -gx BASE16_COLOR_01_HEX "2c323b"
  set -gx BASE16_COLOR_02_HEX "3e4451"
  set -gx BASE16_COLOR_03_HEX "665c54"
  set -gx BASE16_COLOR_04_HEX "928374"
  set -gx BASE16_COLOR_05_HEX "a89984"
  set -gx BASE16_COLOR_06_HEX "d5c4a1"
  set -gx BASE16_COLOR_07_HEX "fdf4c1"
  set -gx BASE16_COLOR_08_HEX "83a598"
  set -gx BASE16_COLOR_09_HEX "a07e3b"
  set -gx BASE16_COLOR_0A_HEX "a07e3b"
  set -gx BASE16_COLOR_0B_HEX "528b8b"
  set -gx BASE16_COLOR_0C_HEX "83a598"
  set -gx BASE16_COLOR_0D_HEX "83a598"
  set -gx BASE16_COLOR_0E_HEX "d75f5f"
  set -gx BASE16_COLOR_0F_HEX "a87322"
end
