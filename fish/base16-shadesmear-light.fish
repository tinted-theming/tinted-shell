...
set -l color00 "db/db/db" # Base 00 - Black
set -l color01 "cc/54/50" # Base 08 - Red
set -l color02 "71/98/3b" # Base 0B - Green
set -l color03 "30/78/78" # Base 0A - Yellow
set -l color04 "37/63/88" # Base 0D - Blue
set -l color05 "d7/ab/54" # Base 0E - Magenta
set -l color06 "c5/7d/42" # Base 0C - Cyan
set -l color07 "23/23/23" # Base 05 - White
set -l color08 "4e/4e/4e" # Base 03 - Bright Black
...
set -l color15 "e4/e4/e4" # Base 07 - Bright White
set -l color16 "a6/42/70" # Base 09
set -l color17 "6d/6d/6d" # Base 0F
set -l color18 "e4/e4/e4" # Base 01
set -l color19 "c0/c0/c0" # Base 02
set -l color20 "1c/1c/1c" # Base 04
set -l color21 "1c/1c/1c" # Base 06
set -l color_foreground "23/23/23" # Base 05
set -l color_background "db/db/db" # Base 00
...
set -U fish_color_end 232323
set -U fish_color_error brred
set -U fish_color_param 1c1c1c
set -U fish_color_valid_path --underline
set -U fish_color_option brcyan
set -U fish_color_comment 4e4e4e
set -U fish_color_selection 1c1c1c --bold --background=c0c0c0
...
set -U fish_pager_color_progress e4e4e4 --background=1c1c1c
set -U fish_pager_color_background normal --background=dbdbdb
set -U fish_pager_color_prefix normal --bold
set -U fish_pager_color_completion normal
set -U fish_pager_color_description a64270 --dim
set -U fish_pager_color_selected_background 1c1c1c --background=c0c0c0
set -U fish_pager_color_selected_prefix 1c1c1c --bold --background=c0c0c0
set -U fish_pager_color_selected_completion 1c1c1c
...
# Set theme
set -Ux BASE16_THEME shadesmear-light

# Optionally export variables
if test -n "$TINTED_SHELL_ENABLE_BASE16_VARS"; or test -n "$BASE16_SHELL_ENABLE_VARS"
  set -gx BASE16_COLOR_00_HEX "dbdbdb"
  set -gx BASE16_COLOR_01_HEX "e4e4e4"
  set -gx BASE16_COLOR_02_HEX "c0c0c0"
  set -gx BASE16_COLOR_03_HEX "4e4e4e"
  set -gx BASE16_COLOR_04_HEX "1c1c1c"
  set -gx BASE16_COLOR_05_HEX "232323"
  set -gx BASE16_COLOR_06_HEX "1c1c1c"
  set -gx BASE16_COLOR_07_HEX "e4e4e4"
  set -gx BASE16_COLOR_08_HEX "cc5450"
  set -gx BASE16_COLOR_09_HEX "a64270"
  set -gx BASE16_COLOR_0A_HEX "307878"
  set -gx BASE16_COLOR_0B_HEX "71983b"
  set -gx BASE16_COLOR_0C_HEX "c57d42"
  set -gx BASE16_COLOR_0D_HEX "376388"
  set -gx BASE16_COLOR_0E_HEX "d7ab54"
  set -gx BASE16_COLOR_0F_HEX "6d6d6d"
end
