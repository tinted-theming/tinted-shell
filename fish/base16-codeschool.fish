...
set -l color00 "23/2c/31" # Base 00 - Black
set -l color01 "2a/54/91" # Base 08 - Red
set -l color02 "23/79/86" # Base 0B - Green
set -l color03 "a0/3b/1e" # Base 0A - Yellow
set -l color04 "48/4d/79" # Base 0D - Blue
set -l color05 "c5/98/20" # Base 0E - Magenta
set -l color06 "b0/2f/30" # Base 0C - Cyan
set -l color07 "9e/a7/a6" # Base 05 - White
set -l color08 "3f/49/44" # Base 03 - Bright Black
...
set -l color15 "b5/d8/f6" # Base 07 - Bright White
set -l color16 "43/82/0d" # Base 09
set -l color17 "c9/83/44" # Base 0F
set -l color18 "1c/36/57" # Base 01
set -l color19 "2a/34/3a" # Base 02
set -l color20 "84/89/8c" # Base 04
set -l color21 "a7/cf/a3" # Base 06
set -l color_foreground "9e/a7/a6" # Base 05
set -l color_background "23/2c/31" # Base 00
...
set -U fish_color_end 9ea7a6
set -U fish_color_error brred
set -U fish_color_param 84898c
set -U fish_color_valid_path --underline
set -U fish_color_option brcyan
set -U fish_color_comment 3f4944
set -U fish_color_selection a7cfa3 --bold --background=2a343a
set -U fish_color_operator brblue
set -U fish_color_escape brcyan
set -U fish_color_autosuggestion 3f4944
...
set -U fish_pager_color_progress 1c3657 --background=84898c
set -U fish_pager_color_background normal --background=232c31
set -U fish_pager_color_prefix normal --bold
set -U fish_pager_color_completion normal
set -U fish_pager_color_description 43820d --dim
set -U fish_pager_color_selected_background a7cfa3 --background=2a343a
set -U fish_pager_color_selected_prefix a7cfa3 --bold --background=2a343a
set -U fish_pager_color_selected_completion a7cfa3
...
# Set theme
set -Ux BASE16_THEME codeschool

# Optionally export variables
if test -n "$TINTED_SHELL_ENABLE_BASE16_VARS"; or test -n "$BASE16_SHELL_ENABLE_VARS"
  set -gx BASE16_COLOR_00_HEX "232c31"
  set -gx BASE16_COLOR_01_HEX "1c3657"
  set -gx BASE16_COLOR_02_HEX "2a343a"
  set -gx BASE16_COLOR_03_HEX "3f4944"
  set -gx BASE16_COLOR_04_HEX "84898c"
  set -gx BASE16_COLOR_05_HEX "9ea7a6"
  set -gx BASE16_COLOR_06_HEX "a7cfa3"
  set -gx BASE16_COLOR_07_HEX "b5d8f6"
  set -gx BASE16_COLOR_08_HEX "2a5491"
  set -gx BASE16_COLOR_09_HEX "43820d"
  set -gx BASE16_COLOR_0A_HEX "a03b1e"
  set -gx BASE16_COLOR_0B_HEX "237986"
  set -gx BASE16_COLOR_0C_HEX "b02f30"
  set -gx BASE16_COLOR_0D_HEX "484d79"
  set -gx BASE16_COLOR_0E_HEX "c59820"
  set -gx BASE16_COLOR_0F_HEX "c98344"
end
