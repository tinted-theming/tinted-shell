...
set -l color02 "79/ff/0f" # Base 0B - Green
set -l color03 "70/9a/ed" # Base 0A - Yellow
set -l color04 "38/6b/d7" # Base 0D - Blue
set -l color05 "b3/49/be" # Base 0E - Magenta
set -l color06 "66/cc/ff" # Base 0C - Cyan
set -l color07 "a5/a5/a5" # Base 05 - White
set -l color08 "7b/7b/7b" # Base 03 - Bright Black
...
set -l color16 "e7/bf/00" # Base 09
set -l color17 "7f/00/00" # Base 0F
set -l color18 "2a/2a/2a" # Base 01
set -l color19 "66/66/66" # Base 02
set -l color20 "90/90/90" # Base 04
set -l color21 "bb/bb/bb" # Base 06
set -l color_foreground "a5/a5/a5" # Base 05
...
set -U fish_color_end a5a5a5
set -U fish_color_error brred
set -U fish_color_param 909090
set -U fish_color_valid_path --underline
set -U fish_color_option brcyan
set -U fish_color_comment 7b7b7b
set -U fish_color_selection bbbbbb --bold --background=666666
set -U fish_color_operator brblue
set -U fish_color_escape brcyan
set -U fish_color_autosuggestion 7b7b7b
...
set -U fish_pager_color_progress 2a2a2a --background=909090
set -U fish_pager_color_background normal --background=000000
set -U fish_pager_color_prefix normal --bold
set -U fish_pager_color_completion normal
set -U fish_pager_color_description e7bf00 --dim
set -U fish_pager_color_selected_background bbbbbb --background=666666
set -U fish_pager_color_selected_prefix bbbbbb --bold --background=666666
...
# Set theme
set -Ux BASE24_THEME paul-millr

# Optionally export variables
if test -n "$TINTED_SHELL_ENABLE_BASE24_VARS"; or test -n "$BASE24_SHELL_ENABLE_VARS"
  set -gx BASE24_COLOR_00_HEX "000000"
  set -gx BASE24_COLOR_01_HEX "2a2a2a"
  set -gx BASE24_COLOR_02_HEX "666666"
  set -gx BASE24_COLOR_03_HEX "7b7b7b"
  set -gx BASE24_COLOR_04_HEX "909090"
  set -gx BASE24_COLOR_05_HEX "a5a5a5"
  set -gx BASE24_COLOR_06_HEX "bbbbbb"
  set -gx BASE24_COLOR_07_HEX "ffffff"
  set -gx BASE24_COLOR_08_HEX "ff0000"
  set -gx BASE24_COLOR_09_HEX "e7bf00"
  set -gx BASE24_COLOR_0A_HEX "709aed"
  set -gx BASE24_COLOR_0B_HEX "79ff0f"
  set -gx BASE24_COLOR_0C_HEX "66ccff"
  set -gx BASE24_COLOR_0D_HEX "386bd7"
  set -gx BASE24_COLOR_0E_HEX "b349be"
