...
set -l color01 "3d/38/39" # Base 08 - Red
set -l color02 "d6/8c/67" # Base 0B - Green
set -l color03 "8b/ae/68" # Base 0A - Yellow
set -l color04 "cf/86/c1" # Base 0D - Blue
set -l color05 "65/b8/c1" # Base 0E - Magenta
set -l color06 "61/ab/da" # Base 0C - Cyan
set -l color07 "b2/79/a7" # Base 05 - White
set -l color08 "b7/7e/64" # Base 03 - Bright Black
...
set -l color15 "bb/bb/bb" # Base 07 - Bright White
set -l color16 "e8/83/8f" # Base 09
set -l color17 "8e/8e/8e" # Base 0F
set -l color18 "de/6e/7c" # Base 01
set -l color19 "81/9b/69" # Base 02
set -l color20 "60/99/c0" # Base 04
set -l color21 "66/a5/ad" # Base 06
set -l color_foreground "b2/79/a7" # Base 05
...
set -U fish_color_end b279a7
set -U fish_color_error brred
set -U fish_color_param 6099c0
set -U fish_color_valid_path --underline
set -U fish_color_option brcyan
set -U fish_color_comment b77e64
set -U fish_color_selection 66a5ad --bold --background=819b69
set -U fish_color_operator brblue
set -U fish_color_escape brcyan
set -U fish_color_autosuggestion b77e64
...
set -U fish_pager_color_progress de6e7c --background=6099c0
set -U fish_pager_color_background normal --background=191919
set -U fish_pager_color_prefix normal --bold
set -U fish_pager_color_completion normal
set -U fish_pager_color_description e8838f --dim
set -U fish_pager_color_selected_background 66a5ad --background=819b69
set -U fish_pager_color_selected_prefix 66a5ad --bold --background=819b69
set -U fish_pager_color_selected_completion 66a5ad
...
# Set theme
set -Ux BASE16_THEME zenbones

# Optionally export variables
if test -n "$TINTED_SHELL_ENABLE_BASE16_VARS"; or test -n "$BASE16_SHELL_ENABLE_VARS"
  set -gx BASE16_COLOR_00_HEX "191919"
  set -gx BASE16_COLOR_01_HEX "de6e7c"
  set -gx BASE16_COLOR_02_HEX "819b69"
  set -gx BASE16_COLOR_03_HEX "b77e64"
  set -gx BASE16_COLOR_04_HEX "6099c0"
  set -gx BASE16_COLOR_05_HEX "b279a7"
  set -gx BASE16_COLOR_06_HEX "66a5ad"
  set -gx BASE16_COLOR_07_HEX "bbbbbb"
  set -gx BASE16_COLOR_08_HEX "3d3839"
  set -gx BASE16_COLOR_09_HEX "e8838f"
  set -gx BASE16_COLOR_0A_HEX "8bae68"
  set -gx BASE16_COLOR_0B_HEX "d68c67"
  set -gx BASE16_COLOR_0C_HEX "61abda"
  set -gx BASE16_COLOR_0D_HEX "cf86c1"
  set -gx BASE16_COLOR_0E_HEX "65b8c1"
  set -gx BASE16_COLOR_0F_HEX "8e8e8e"
end
