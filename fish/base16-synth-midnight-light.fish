...
set -l color00 "dd/df/e0" # Base 00 - Black
...
set -l color07 "28/29/2a" # Base 05 - White
set -l color08 "a3/a5/a6" # Base 03 - Bright Black
...
set -l color15 "05/06/08" # Base 07 - Bright White
set -l color16 "ea/77/0d" # Base 09
set -l color17 "cd/63/20" # Base 0F
set -l color18 "cf/d1/d2" # Base 01
set -l color19 "c1/c3/c4" # Base 02
set -l color20 "47/48/49" # Base 04
set -l color21 "1a/1b/1c" # Base 06
set -l color_foreground "28/29/2a" # Base 05
set -l color_background "dd/df/e0" # Base 00
...
set -U fish_color_end 28292a
set -U fish_color_error brred
set -U fish_color_param 474849
set -U fish_color_valid_path --underline
set -U fish_color_option brcyan
set -U fish_color_comment a3a5a6
set -U fish_color_selection 1a1b1c --bold --background=c1c3c4
set -U fish_color_operator brblue
set -U fish_color_escape brcyan
set -U fish_color_autosuggestion a3a5a6
...
set -U fish_pager_color_progress cfd1d2 --background=474849
set -U fish_pager_color_background normal --background=dddfe0
set -U fish_pager_color_prefix normal --bold
set -U fish_pager_color_completion normal
set -U fish_pager_color_description ea770d --dim
set -U fish_pager_color_selected_background 1a1b1c --background=c1c3c4
set -U fish_pager_color_selected_prefix 1a1b1c --bold --background=c1c3c4
set -U fish_pager_color_selected_completion 1a1b1c
...
# Set theme
set -Ux BASE16_THEME synth-midnight-light

# Optionally export variables
if test -n "$TINTED_SHELL_ENABLE_BASE16_VARS"; or test -n "$BASE16_SHELL_ENABLE_VARS"
  set -gx BASE16_COLOR_00_HEX "dddfe0"
  set -gx BASE16_COLOR_01_HEX "cfd1d2"
  set -gx BASE16_COLOR_02_HEX "c1c3c4"
  set -gx BASE16_COLOR_03_HEX "a3a5a6"
  set -gx BASE16_COLOR_04_HEX "474849"
  set -gx BASE16_COLOR_05_HEX "28292a"
  set -gx BASE16_COLOR_06_HEX "1a1b1c"
  set -gx BASE16_COLOR_07_HEX "050608"
