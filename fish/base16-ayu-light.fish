...
set -l color00 "f8/f9/fa" # Base 00 - Black
set -l color01 "f0/71/71" # Base 08 - Red
set -l color02 "6c/bf/49" # Base 0B - Green
set -l color03 "f2/ae/49" # Base 0A - Yellow
set -l color04 "39/9e/e6" # Base 0D - Blue
set -l color05 "a3/7a/cc" # Base 0E - Magenta
set -l color06 "4c/bf/99" # Base 0C - Cyan
set -l color07 "5c/61/66" # Base 05 - White
set -l color08 "a0/a6/ac" # Base 03 - Bright Black
...
set -l color15 "40/44/47" # Base 07 - Bright White
set -l color16 "fa/8d/3e" # Base 09
set -l color17 "e6/ba/7e" # Base 0F
set -l color18 "ed/ef/f1" # Base 01
set -l color19 "d2/d4/d8" # Base 02
set -l color20 "8a/91/99" # Base 04
set -l color21 "4e/52/57" # Base 06
set -l color_foreground "5c/61/66" # Base 05
set -l color_background "f8/f9/fa" # Base 00
...
set -U fish_color_end 5c6166
set -U fish_color_error brred
set -U fish_color_param 8a9199
set -U fish_color_valid_path --underline
set -U fish_color_option brcyan
set -U fish_color_comment a0a6ac
set -U fish_color_selection 4e5257 --bold --background=d2d4d8
set -U fish_color_operator brblue
set -U fish_color_escape brcyan
set -U fish_color_autosuggestion a0a6ac
...
set -U fish_color_search_match bryellow --background=d2d4d8
set -U fish_color_history_current --bold
set -U fish_pager_color_progress edeff1 --background=8a9199
set -U fish_pager_color_background normal --background=f8f9fa
set -U fish_pager_color_prefix normal --bold
set -U fish_pager_color_completion normal
set -U fish_pager_color_description fa8d3e --dim
set -U fish_pager_color_selected_background 4e5257 --background=d2d4d8
set -U fish_pager_color_selected_prefix 4e5257 --bold --background=d2d4d8
set -U fish_pager_color_selected_completion 4e5257
...
# Set theme
set -Ux BASE16_THEME ayu-light

# Optionally export variables
if test -n "$TINTED_SHELL_ENABLE_BASE16_VARS"; or test -n "$BASE16_SHELL_ENABLE_VARS"
  set -gx BASE16_COLOR_00_HEX "f8f9fa"
  set -gx BASE16_COLOR_01_HEX "edeff1"
  set -gx BASE16_COLOR_02_HEX "d2d4d8"
  set -gx BASE16_COLOR_03_HEX "a0a6ac"
  set -gx BASE16_COLOR_04_HEX "8a9199"
  set -gx BASE16_COLOR_05_HEX "5c6166"
  set -gx BASE16_COLOR_06_HEX "4e5257"
  set -gx BASE16_COLOR_07_HEX "404447"
  set -gx BASE16_COLOR_08_HEX "f07171"
  set -gx BASE16_COLOR_09_HEX "fa8d3e"
  set -gx BASE16_COLOR_0A_HEX "f2ae49"
  set -gx BASE16_COLOR_0B_HEX "6cbf49"
  set -gx BASE16_COLOR_0C_HEX "4cbf99"
  set -gx BASE16_COLOR_0D_HEX "399ee6"
  set -gx BASE16_COLOR_0E_HEX "a37acc"
  set -gx BASE16_COLOR_0F_HEX "e6ba7e"
end
