...
set -l color00 "38/38/38" # Base 00 - Black
set -l color01 "dc/a3/a3" # Base 08 - Red
set -l color02 "5f/7f/5f" # Base 0B - Green
set -l color03 "e0/cf/9f" # Base 0A - Yellow
set -l color04 "7c/b8/bb" # Base 0D - Blue
set -l color05 "dc/8c/c3" # Base 0E - Magenta
set -l color06 "93/e0/e3" # Base 0C - Cyan
set -l color07 "dc/dc/cc" # Base 05 - White
...
set -l color16 "df/af/8f" # Base 09
set -l color17 "00/00/00" # Base 0F
set -l color18 "40/40/40" # Base 01
set -l color19 "60/60/60" # Base 02
set -l color20 "80/80/80" # Base 04
set -l color21 "c0/c0/c0" # Base 06
set -l color_foreground "dc/dc/cc" # Base 05
set -l color_background "38/38/38" # Base 00
...
set -U fish_pager_color_progress 404040 --background=808080
set -U fish_pager_color_background normal --background=383838
set -U fish_pager_color_prefix normal --bold
set -U fish_pager_color_completion normal
set -U fish_pager_color_description dfaf8f --dim
set -U fish_pager_color_selected_background c0c0c0 --background=606060
set -U fish_pager_color_selected_prefix c0c0c0 --bold --background=606060
...
# Set theme
set -Ux BASE16_THEME zenburn

# Optionally export variables
if test -n "$TINTED_SHELL_ENABLE_BASE16_VARS"; or test -n "$BASE16_SHELL_ENABLE_VARS"
  set -gx BASE16_COLOR_00_HEX "383838"
  set -gx BASE16_COLOR_01_HEX "404040"
  set -gx BASE16_COLOR_02_HEX "606060"
  set -gx BASE16_COLOR_03_HEX "6f6f6f"
  set -gx BASE16_COLOR_04_HEX "808080"
  set -gx BASE16_COLOR_05_HEX "dcdccc"
  set -gx BASE16_COLOR_06_HEX "c0c0c0"
  set -gx BASE16_COLOR_07_HEX "ffffff"
  set -gx BASE16_COLOR_08_HEX "dca3a3"
  set -gx BASE16_COLOR_09_HEX "dfaf8f"
  set -gx BASE16_COLOR_0A_HEX "e0cf9f"
  set -gx BASE16_COLOR_0B_HEX "5f7f5f"
  set -gx BASE16_COLOR_0C_HEX "93e0e3"
  set -gx BASE16_COLOR_0D_HEX "7cb8bb"
  set -gx BASE16_COLOR_0E_HEX "dc8cc3"
  set -gx BASE16_COLOR_0F_HEX "000000"
end
