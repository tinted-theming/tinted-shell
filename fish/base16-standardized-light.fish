...
set -l color01 "d0/3e/3e" # Base 08 - Red
set -l color02 "31/86/1f" # Base 0B - Green
set -l color03 "ad/82/00" # Base 0A - Yellow
set -l color04 "31/73/c5" # Base 0D - Blue
set -l color05 "9e/57/c2" # Base 0E - Magenta
set -l color06 "00/99/8f" # Base 0C - Cyan
...
set -l color15 "22/22/22" # Base 07 - Bright White
set -l color16 "d7/69/1d" # Base 09
set -l color17 "89/50/25" # Base 0F
set -l color18 "ee/ee/ee" # Base 01
set -l color19 "cc/cc/cc" # Base 02
set -l color20 "76/76/76" # Base 04
set -l color21 "33/33/33" # Base 06
...
set -U fish_color_search_match bryellow --background=cccccc
set -U fish_color_history_current --bold
set -U fish_pager_color_progress eeeeee --background=767676
set -U fish_pager_color_background normal --background=ffffff
set -U fish_pager_color_prefix normal --bold
set -U fish_pager_color_completion normal
set -U fish_pager_color_description d7691d --dim
set -U fish_pager_color_selected_background 333333 --background=cccccc
set -U fish_pager_color_selected_prefix 333333 --bold --background=cccccc
set -U fish_pager_color_selected_completion 333333
...
# Set theme
set -Ux BASE16_THEME standardized-light

# Optionally export variables
if test -n "$TINTED_SHELL_ENABLE_BASE16_VARS"; or test -n "$BASE16_SHELL_ENABLE_VARS"
  set -gx BASE16_COLOR_00_HEX "ffffff"
  set -gx BASE16_COLOR_01_HEX "eeeeee"
  set -gx BASE16_COLOR_02_HEX "cccccc"
  set -gx BASE16_COLOR_03_HEX "767676"
  set -gx BASE16_COLOR_04_HEX "767676"
  set -gx BASE16_COLOR_05_HEX "444444"
  set -gx BASE16_COLOR_06_HEX "333333"
  set -gx BASE16_COLOR_07_HEX "222222"
  set -gx BASE16_COLOR_08_HEX "d03e3e"
  set -gx BASE16_COLOR_09_HEX "d7691d"
  set -gx BASE16_COLOR_0A_HEX "ad8200"
  set -gx BASE16_COLOR_0B_HEX "31861f"
  set -gx BASE16_COLOR_0C_HEX "00998f"
  set -gx BASE16_COLOR_0D_HEX "3173c5"
  set -gx BASE16_COLOR_0E_HEX "9e57c2"
  set -gx BASE16_COLOR_0F_HEX "895025"
end
