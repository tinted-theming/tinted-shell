...
set -l color00 "34/3d/46" # Base 00 - Black
set -l color01 "d5/4e/53" # Base 08 - Red
set -l color02 "b9/ca/4a" # Base 0B - Green
set -l color03 "e7/c5/47" # Base 0A - Yellow
set -l color04 "7a/a6/da" # Base 0D - Blue
set -l color05 "c3/97/d8" # Base 0E - Magenta
set -l color06 "70/c0/b1" # Base 0C - Cyan
set -l color07 "df/e1/e8" # Base 05 - White
set -l color08 "a7/ad/ba" # Base 03 - Bright Black
...
set -l color16 "e7/8c/45" # Base 09
set -l color17 "9a/80/6d" # Base 0F
set -l color18 "4f/5b/66" # Base 01
set -l color19 "65/73/7e" # Base 02
set -l color20 "c0/c5/ce" # Base 04
set -l color21 "ef/f1/f5" # Base 06
set -l color_foreground "df/e1/e8" # Base 05
set -l color_background "34/3d/46" # Base 00
...
set -U fish_color_end dfe1e8
set -U fish_color_error brred
set -U fish_color_param c0c5ce
set -U fish_color_valid_path --underline
set -U fish_color_option brcyan
set -U fish_color_comment a7adba
set -U fish_color_selection eff1f5 --bold --background=65737e
set -U fish_color_operator brblue
set -U fish_color_escape brcyan
set -U fish_color_autosuggestion a7adba
...
set -U fish_color_search_match bryellow --background=65737e
set -U fish_color_history_current --bold
set -U fish_pager_color_progress 4f5b66 --background=c0c5ce
set -U fish_pager_color_background normal --background=343d46
set -U fish_pager_color_prefix normal --bold
set -U fish_pager_color_completion normal
set -U fish_pager_color_description e78c45 --dim
set -U fish_pager_color_selected_background eff1f5 --background=65737e
set -U fish_pager_color_selected_prefix eff1f5 --bold --background=65737e
set -U fish_pager_color_selected_completion eff1f5
...
# Set theme
set -Ux BASE16_THEME yesterday-bright

# Optionally export variables
if test -n "$TINTED_SHELL_ENABLE_BASE16_VARS"; or test -n "$BASE16_SHELL_ENABLE_VARS"
  set -gx BASE16_COLOR_00_HEX "343d46"
  set -gx BASE16_COLOR_01_HEX "4f5b66"
  set -gx BASE16_COLOR_02_HEX "65737e"
  set -gx BASE16_COLOR_03_HEX "a7adba"
  set -gx BASE16_COLOR_04_HEX "c0c5ce"
  set -gx BASE16_COLOR_05_HEX "dfe1e8"
  set -gx BASE16_COLOR_06_HEX "eff1f5"
  set -gx BASE16_COLOR_07_HEX "ffffff"
  set -gx BASE16_COLOR_08_HEX "d54e53"
  set -gx BASE16_COLOR_09_HEX "e78c45"
  set -gx BASE16_COLOR_0A_HEX "e7c547"
  set -gx BASE16_COLOR_0B_HEX "b9ca4a"
  set -gx BASE16_COLOR_0C_HEX "70c0b1"
  set -gx BASE16_COLOR_0D_HEX "7aa6da"
  set -gx BASE16_COLOR_0E_HEX "c397d8"
  set -gx BASE16_COLOR_0F_HEX "9a806d"
end
