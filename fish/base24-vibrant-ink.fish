...
set -l color01 "ff/66/00" # Base 08 - Red
set -l color02 "cc/ff/04" # Base 0B - Green
set -l color03 "00/00/ff" # Base 0A - Yellow
set -l color04 "44/b3/cc" # Base 0D - Blue
set -l color05 "99/33/cc" # Base 0E - Magenta
set -l color06 "44/b3/cc" # Base 0C - Cyan
set -l color07 "cd/cd/cd" # Base 05 - White
set -l color08 "7d/7d/7d" # Base 03 - Bright Black
...
set -l color16 "ff/cc/00" # Base 09
set -l color17 "7f/33/00" # Base 0F
set -l color18 "87/87/87" # Base 01
...
set -U fish_color_comment 7d7d7d
set -U fish_color_selection f5f5f5 --bold --background=555555
...
set -U fish_pager_color_progress 878787 --background=a5a5a5
set -U fish_pager_color_background normal --background=000000
set -U fish_pager_color_prefix normal --bold
set -U fish_pager_color_completion normal
set -U fish_pager_color_description ffcc00 --dim
set -U fish_pager_color_selected_background f5f5f5 --background=555555
set -U fish_pager_color_selected_prefix f5f5f5 --bold --background=555555
...
# Set theme
set -Ux BASE24_THEME vibrant-ink

# Optionally export variables
if test -n "$TINTED_SHELL_ENABLE_BASE24_VARS"; or test -n "$BASE24_SHELL_ENABLE_VARS"
  set -gx BASE24_COLOR_00_HEX "000000"
  set -gx BASE24_COLOR_01_HEX "878787"
  set -gx BASE24_COLOR_02_HEX "555555"
  set -gx BASE24_COLOR_03_HEX "7d7d7d"
  set -gx BASE24_COLOR_04_HEX "a5a5a5"
  set -gx BASE24_COLOR_05_HEX "cdcdcd"
  set -gx BASE24_COLOR_06_HEX "f5f5f5"
  set -gx BASE24_COLOR_07_HEX "e5e5e5"
  set -gx BASE24_COLOR_08_HEX "ff6600"
  set -gx BASE24_COLOR_09_HEX "ffcc00"
  set -gx BASE24_COLOR_0A_HEX "0000ff"
  set -gx BASE24_COLOR_0B_HEX "ccff04"
  set -gx BASE24_COLOR_0C_HEX "44b3cc"
  set -gx BASE24_COLOR_0D_HEX "44b3cc"
  set -gx BASE24_COLOR_0E_HEX "9933cc"
  set -gx BASE24_COLOR_0F_HEX "7f3300"
end
