...
set -l color00 "3c/4c/55" # Base 00 - Black
set -l color01 "83/af/e5" # Base 08 - Red
set -l color02 "7f/c1/ca" # Base 0B - Green
set -l color03 "a8/ce/93" # Base 0A - Yellow
set -l color04 "83/af/e5" # Base 0D - Blue
set -l color05 "9a/93/e1" # Base 0E - Magenta
set -l color06 "f2/c3/8f" # Base 0C - Cyan
set -l color07 "c5/d4/dd" # Base 05 - White
set -l color08 "89/9b/a6" # Base 03 - Bright Black
...
set -l color15 "55/68/73" # Base 07 - Bright White
set -l color16 "7f/c1/ca" # Base 09
set -l color17 "f2/c3/8f" # Base 0F
set -l color18 "55/68/73" # Base 01
set -l color19 "6a/7d/89" # Base 02
set -l color20 "89/9b/a6" # Base 04
set -l color21 "89/9b/a6" # Base 06
set -l color_foreground "c5/d4/dd" # Base 05
set -l color_background "3c/4c/55" # Base 00
...
set -U fish_color_end c5d4dd
set -U fish_color_error brred
set -U fish_color_param 899ba6
set -U fish_color_valid_path --underline
set -U fish_color_option brcyan
set -U fish_color_comment 899ba6
set -U fish_color_selection 899ba6 --bold --background=6a7d89
set -U fish_color_operator brblue
set -U fish_color_escape brcyan
set -U fish_color_autosuggestion 899ba6
...
set -U fish_pager_color_progress 556873 --background=899ba6
set -U fish_pager_color_background normal --background=3c4c55
set -U fish_pager_color_prefix normal --bold
set -U fish_pager_color_completion normal
set -U fish_pager_color_description 7fc1ca --dim
set -U fish_pager_color_selected_background 899ba6 --background=6a7d89
set -U fish_pager_color_selected_prefix 899ba6 --bold --background=6a7d89
set -U fish_pager_color_selected_completion 899ba6
...
# Set theme
set -Ux BASE16_THEME nova

# Optionally export variables
if test -n "$TINTED_SHELL_ENABLE_BASE16_VARS"; or test -n "$BASE16_SHELL_ENABLE_VARS"
  set -gx BASE16_COLOR_00_HEX "3c4c55"
  set -gx BASE16_COLOR_01_HEX "556873"
  set -gx BASE16_COLOR_02_HEX "6a7d89"
  set -gx BASE16_COLOR_03_HEX "899ba6"
  set -gx BASE16_COLOR_04_HEX "899ba6"
  set -gx BASE16_COLOR_05_HEX "c5d4dd"
  set -gx BASE16_COLOR_06_HEX "899ba6"
  set -gx BASE16_COLOR_07_HEX "556873"
  set -gx BASE16_COLOR_08_HEX "83afe5"
  set -gx BASE16_COLOR_09_HEX "7fc1ca"
  set -gx BASE16_COLOR_0A_HEX "a8ce93"
  set -gx BASE16_COLOR_0B_HEX "7fc1ca"
  set -gx BASE16_COLOR_0C_HEX "f2c38f"
  set -gx BASE16_COLOR_0D_HEX "83afe5"
  set -gx BASE16_COLOR_0E_HEX "9a93e1"
  set -gx BASE16_COLOR_0F_HEX "f2c38f"
end
