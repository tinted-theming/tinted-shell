...
set -U fish_color_end cdbb9b
set -U fish_color_error brred
set -U fish_color_param a59984
set -U fish_color_valid_path --underline
set -U fish_color_option brcyan
set -U fish_color_comment 7d776c
set -U fish_color_selection f5deb3 --bold --background=555555
...
set -U fish_pager_color_background normal --background=333333
set -U fish_pager_color_prefix normal --bold
set -U fish_pager_color_completion normal
set -U fish_pager_color_description f0e68c --dim
set -U fish_pager_color_selected_background f5deb3 --background=555555
set -U fish_pager_color_selected_prefix f5deb3 --bold --background=555555
set -U fish_pager_color_selected_completion f5deb3
