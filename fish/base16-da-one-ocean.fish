...
set -l color00 "17/17/26" # Base 00 - Black
...
set -l color18 "22/27/3d" # Base 01
...
set -l color_background "17/17/26" # Base 00
...
set -U fish_pager_color_progress 22273d --background=c8c8c8
set -U fish_pager_color_background normal --background=171726
...
# Set theme
set -Ux BASE16_THEME da-one-ocean

# Optionally export variables
if test -n "$TINTED_SHELL_ENABLE_BASE16_VARS"; or test -n "$BASE16_SHELL_ENABLE_VARS"
  set -gx BASE16_COLOR_00_HEX "171726"
  set -gx BASE16_COLOR_01_HEX "22273d"
