...
set -l color00 "29/2d/3e" # Base 00 - Black
set -l color01 "6e/98/e1" # Base 08 - Red
set -l color02 "78/c0/6e" # Base 0B - Green
set -l color03 "e0/a5/57" # Base 0A - Yellow
set -l color04 "82/aa/ff" # Base 0D - Blue
set -l color05 "c7/92/ea" # Base 0E - Magenta
set -l color06 "83/b7/e5" # Base 0C - Cyan
set -l color07 "95/9d/cb" # Base 05 - White
set -l color08 "67/6e/95" # Base 03 - Bright Black
...
set -l color16 "f7/8c/6c" # Base 09
set -l color17 "ff/53/70" # Base 0F
set -l color18 "44/42/67" # Base 01
set -l color19 "5c/59/8b" # Base 02
set -l color20 "87/96/b0" # Base 04
set -l color21 "95/9d/cb" # Base 06
set -l color_foreground "95/9d/cb" # Base 05
set -l color_background "29/2d/3e" # Base 00
...
set -U fish_color_end 959dcb
set -U fish_color_error brred
set -U fish_color_param 8796b0
set -U fish_color_valid_path --underline
set -U fish_color_option brcyan
set -U fish_color_comment 676e95
set -U fish_color_selection 959dcb --bold --background=5c598b
...
set -U fish_color_search_match bryellow --background=5c598b
set -U fish_color_history_current --bold
set -U fish_pager_color_progress 444267 --background=8796b0
set -U fish_pager_color_background normal --background=292d3e
set -U fish_pager_color_prefix normal --bold
set -U fish_pager_color_completion normal
set -U fish_pager_color_description f78c6c --dim
set -U fish_pager_color_selected_background 959dcb --background=5c598b
set -U fish_pager_color_selected_prefix 959dcb --bold --background=5c598b
set -U fish_pager_color_selected_completion 959dcb
...
# Set theme
set -Ux BASE16_THEME katy

# Optionally export variables
if test -n "$TINTED_SHELL_ENABLE_BASE16_VARS"; or test -n "$BASE16_SHELL_ENABLE_VARS"
  set -gx BASE16_COLOR_00_HEX "292d3e"
  set -gx BASE16_COLOR_01_HEX "444267"
  set -gx BASE16_COLOR_02_HEX "5c598b"
  set -gx BASE16_COLOR_03_HEX "676e95"
  set -gx BASE16_COLOR_04_HEX "8796b0"
  set -gx BASE16_COLOR_05_HEX "959dcb"
  set -gx BASE16_COLOR_06_HEX "959dcb"
  set -gx BASE16_COLOR_07_HEX "ffffff"
  set -gx BASE16_COLOR_08_HEX "6e98e1"
  set -gx BASE16_COLOR_09_HEX "f78c6c"
  set -gx BASE16_COLOR_0A_HEX "e0a557"
  set -gx BASE16_COLOR_0B_HEX "78c06e"
  set -gx BASE16_COLOR_0C_HEX "83b7e5"
  set -gx BASE16_COLOR_0D_HEX "82aaff"
  set -gx BASE16_COLOR_0E_HEX "c792ea"
  set -gx BASE16_COLOR_0F_HEX "ff5370"
end
