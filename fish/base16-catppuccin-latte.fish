...
# Set theme
set -Ux BASE16_THEME catppuccin-latte

# Optionally export variables
if test -n "$TINTED_SHELL_ENABLE_BASE16_VARS"; or test -n "$BASE16_SHELL_ENABLE_VARS"
  set -gx BASE16_COLOR_00_HEX "eff1f5"
  set -gx BASE16_COLOR_01_HEX "e6e9ef"
  set -gx BASE16_COLOR_02_HEX "ccd0da"
  set -gx BASE16_COLOR_03_HEX "bcc0cc"
  set -gx BASE16_COLOR_04_HEX "acb0be"
  set -gx BASE16_COLOR_05_HEX "4c4f69"
  set -gx BASE16_COLOR_06_HEX "dc8a78"
  set -gx BASE16_COLOR_07_HEX "7287fd"
  set -gx BASE16_COLOR_08_HEX "d20f39"
  set -gx BASE16_COLOR_09_HEX "fe640b"
  set -gx BASE16_COLOR_0A_HEX "df8e1d"
  set -gx BASE16_COLOR_0B_HEX "40a02b"
  set -gx BASE16_COLOR_0C_HEX "179299"
  set -gx BASE16_COLOR_0D_HEX "1e66f5"
  set -gx BASE16_COLOR_0E_HEX "8839ef"
  set -gx BASE16_COLOR_0F_HEX "dd7878"
end
