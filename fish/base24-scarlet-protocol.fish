...
set -l color00 "1b/15/3c" # Base 00 - Black
set -l color01 "ff/00/51" # Base 08 - Red
set -l color02 "00/dc/84" # Base 0B - Green
set -l color03 "68/71/ff" # Base 0A - Yellow
set -l color04 "02/71/b6" # Base 0D - Blue
set -l color05 "c9/30/c7" # Base 0E - Magenta
set -l color06 "00/c5/c7" # Base 0C - Cyan
...
set -l color16 "fa/f9/45" # Base 09
set -l color17 "7f/00/28" # Base 0F
...
set -l color_background "1b/15/3c" # Base 00
...
set -U fish_pager_color_background normal --background=1b153c
set -U fish_pager_color_prefix normal --bold
set -U fish_pager_color_completion normal
set -U fish_pager_color_description faf945 --dim
...
if test -n "$TINTED_SHELL_ENABLE_BASE24_VARS"; or test -n "$BASE24_SHELL_ENABLE_VARS"
  ...
  set -gx BASE24_COLOR_08_HEX "ff0051"
  set -gx BASE24_COLOR_09_HEX "faf945"
  set -gx BASE24_COLOR_0A_HEX "6871ff"
  set -gx BASE24_COLOR_0B_HEX "00dc84"
  set -gx BASE24_COLOR_0C_HEX "00c5c7"
  set -gx BASE24_COLOR_0D_HEX "0271b6"
  set -gx BASE24_COLOR_0E_HEX "c930c7"
  set -gx BASE24_COLOR_0F_HEX "7f0028"
end
