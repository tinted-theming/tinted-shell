...
set -l color01 "d3/5a/5f" # Base 08 - Red
set -l color02 "af/ba/66" # Base 0B - Green
set -l color03 "e5/d2/89" # Base 0A - Yellow
set -l color04 "a0/b9/d5" # Base 0D - Blue
set -l color05 "bf/92/d5" # Base 0E - Magenta
set -l color06 "91/be/b6" # Base 0C - Cyan
set -l color07 "a6/a6/a6" # Base 05 - White
set -l color08 "6f/6f/6f" # Base 03 - Bright Black
...
set -l color15 "d9/d9/d9" # Base 07 - Bright White
set -l color16 "e5/af/89" # Base 09
set -l color17 "69/2d/2f" # Base 0F
set -l color18 "31/31/31" # Base 01
set -l color19 "4f/4f/4f" # Base 02
set -l color20 "8c/8c/8c" # Base 04
set -l color21 "bf/bf/bf" # Base 06
set -l color_foreground "a6/a6/a6" # Base 05
...
set -U fish_color_end a6a6a6
set -U fish_color_error brred
set -U fish_color_param 8c8c8c
set -U fish_color_valid_path --underline
set -U fish_color_option brcyan
set -U fish_color_comment 6f6f6f
set -U fish_color_selection bfbfbf --bold --background=4f4f4f
set -U fish_color_operator brblue
set -U fish_color_escape brcyan
set -U fish_color_autosuggestion 6f6f6f
...
set -U fish_color_search_match bryellow --background=4f4f4f
set -U fish_color_history_current --bold
set -U fish_pager_color_progress 313131 --background=8c8c8c
set -U fish_pager_color_background normal --background=212121
set -U fish_pager_color_prefix normal --bold
set -U fish_pager_color_completion normal
set -U fish_pager_color_description e5af89 --dim
set -U fish_pager_color_selected_background bfbfbf --background=4f4f4f
set -U fish_pager_color_selected_prefix bfbfbf --bold --background=4f4f4f
set -U fish_pager_color_selected_completion bfbfbf
...
# Set theme
set -Ux BASE24_THEME later-this-evening

# Optionally export variables
if test -n "$TINTED_SHELL_ENABLE_BASE24_VARS"; or test -n "$BASE24_SHELL_ENABLE_VARS"
  set -gx BASE24_COLOR_00_HEX "212121"
  set -gx BASE24_COLOR_01_HEX "313131"
  set -gx BASE24_COLOR_02_HEX "4f4f4f"
  set -gx BASE24_COLOR_03_HEX "6f6f6f"
  set -gx BASE24_COLOR_04_HEX "8c8c8c"
  set -gx BASE24_COLOR_05_HEX "a6a6a6"
  set -gx BASE24_COLOR_06_HEX "bfbfbf"
  set -gx BASE24_COLOR_07_HEX "d9d9d9"
  set -gx BASE24_COLOR_08_HEX "d35a5f"
  set -gx BASE24_COLOR_09_HEX "e5af89"
  set -gx BASE24_COLOR_0A_HEX "e5d289"
  set -gx BASE24_COLOR_0B_HEX "afba66"
  set -gx BASE24_COLOR_0C_HEX "91beb6"
  set -gx BASE24_COLOR_0D_HEX "a0b9d5"
  set -gx BASE24_COLOR_0E_HEX "bf92d5"
  set -gx BASE24_COLOR_0F_HEX "692d2f"
end
