...
set -l color01 "fb/49/34" # Base 08 - Red
set -l color02 "b8/bb/26" # Base 0B - Green
set -l color03 "fa/bd/2f" # Base 0A - Yellow
set -l color04 "83/a5/98" # Base 0D - Blue
set -l color05 "d3/86/9b" # Base 0E - Magenta
set -l color06 "8e/c0/7c" # Base 0C - Cyan
set -l color07 "d5/c4/a1" # Base 05 - White
...
set -l color16 "fe/80/19" # Base 09
...
set -l color_foreground "d5/c4/a1" # Base 05
...
set -U fish_pager_color_description fe8019 --dim
...
# Set theme
set -Ux BASE16_THEME gruvbox-dark-medium
...
if test -n "$TINTED_SHELL_ENABLE_BASE16_VARS"; or test -n "$BASE16_SHELL_ENABLE_VARS"
  ...
  set -gx BASE16_COLOR_05_HEX "d5c4a1"
  set -gx BASE16_COLOR_06_HEX "ebdbb2"
  set -gx BASE16_COLOR_07_HEX "fbf1c7"
  set -gx BASE16_COLOR_08_HEX "fb4934"
  set -gx BASE16_COLOR_09_HEX "fe8019"
  set -gx BASE16_COLOR_0A_HEX "fabd2f"
  set -gx BASE16_COLOR_0B_HEX "b8bb26"
  set -gx BASE16_COLOR_0C_HEX "8ec07c"
