...
set -l color00 "2a/1e/1d" # Base 00 - Black
set -l color01 "be/2d/26" # Base 08 - Red
set -l color02 "6b/a0/8a" # Base 0B - Green
set -l color03 "b8/d3/ed" # Base 0A - Yellow
set -l color04 "5a/86/ac" # Base 0D - Blue
set -l color05 "ab/80/a6" # Base 0E - Magenta
set -l color06 "74/a5/ac" # Base 0C - Cyan
set -l color07 "cd/be/9b" # Base 05 - White
set -l color08 "ab/86/64" # Base 03 - Bright Black
...
set -l color15 "ff/f9/d4" # Base 07 - Bright White
set -l color16 "e9/9c/29" # Base 09
set -l color17 "5f/16/13" # Base 0F
set -l color18 "57/3d/25" # Base 01
set -l color19 "9a/6b/49" # Base 02
set -l color20 "bc/a2/80" # Base 04
set -l color21 "df/da/b7" # Base 06
set -l color_foreground "cd/be/9b" # Base 05
set -l color_background "2a/1e/1d" # Base 00
...
set -U fish_color_end cdbe9b
set -U fish_color_error brred
set -U fish_color_param bca280
set -U fish_color_valid_path --underline
set -U fish_color_option brcyan
set -U fish_color_comment ab8664
set -U fish_color_selection dfdab7 --bold --background=9a6b49
set -U fish_color_operator brblue
set -U fish_color_escape brcyan
set -U fish_color_autosuggestion ab8664
...
set -U fish_color_search_match bryellow --background=9a6b49
set -U fish_color_history_current --bold
set -U fish_pager_color_progress 573d25 --background=bca280
set -U fish_pager_color_background normal --background=2a1e1d
set -U fish_pager_color_prefix normal --bold
set -U fish_pager_color_completion normal
set -U fish_pager_color_description e99c29 --dim
set -U fish_pager_color_selected_background dfdab7 --background=9a6b49
set -U fish_pager_color_selected_prefix dfdab7 --bold --background=9a6b49
set -U fish_pager_color_selected_completion dfdab7
...
# Set theme
set -Ux BASE24_THEME birds-of-paradise

# Optionally export variables
if test -n "$TINTED_SHELL_ENABLE_BASE24_VARS"; or test -n "$BASE24_SHELL_ENABLE_VARS"
  set -gx BASE24_COLOR_00_HEX "2a1e1d"
  set -gx BASE24_COLOR_01_HEX "573d25"
  set -gx BASE24_COLOR_02_HEX "9a6b49"
  set -gx BASE24_COLOR_03_HEX "ab8664"
  set -gx BASE24_COLOR_04_HEX "bca280"
  set -gx BASE24_COLOR_05_HEX "cdbe9b"
  set -gx BASE24_COLOR_06_HEX "dfdab7"
  set -gx BASE24_COLOR_07_HEX "fff9d4"
  set -gx BASE24_COLOR_08_HEX "be2d26"
  set -gx BASE24_COLOR_09_HEX "e99c29"
  set -gx BASE24_COLOR_0A_HEX "b8d3ed"
  set -gx BASE24_COLOR_0B_HEX "6ba08a"
  set -gx BASE24_COLOR_0C_HEX "74a5ac"
  set -gx BASE24_COLOR_0D_HEX "5a86ac"
  set -gx BASE24_COLOR_0E_HEX "ab80a6"
