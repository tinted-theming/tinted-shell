...
set -U fish_color_selection dfdab7 --background=9a6b49
set -U fish_color_operator magenta
set -U fish_color_escape e99c29
...
set -U fish_color_search_match yellow --background=9a6b49
set -U fish_color_history_current --underline=curly
set -U fish_pager_color_progress 573d25 --background=bca280
set -U fish_pager_color_background --background=2a1e1d
set -U fish_pager_color_prefix --bold --italics
set -U fish_pager_color_completion normal
set -U fish_pager_color_description e99c29
set -U fish_pager_color_selected_background --background=9a6b49
set -U fish_pager_color_selected_prefix --bold --italics --background=9a6b49
