...
set -U fish_pager_color_progress 282a2e --background=b4b7b4
...
set -U fish_pager_color_selected_background e0e0e0 --background=373b41
set -U fish_pager_color_selected_prefix e0e0e0 --bold --background=373b41
...
# Set theme
set -Ux BASE16_THEME google-dark
...
if test -n "$TINTED_SHELL_ENABLE_BASE16_VARS"; or test -n "$BASE16_SHELL_ENABLE_VARS"
  ...
  set -gx BASE16_COLOR_02_HEX "373b41"
  set -gx BASE16_COLOR_03_HEX "969896"
  set -gx BASE16_COLOR_04_HEX "b4b7b4"
  set -gx BASE16_COLOR_05_HEX "c5c8c6"
