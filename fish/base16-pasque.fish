...
set -l color00 "27/1c/3a" # Base 00 - Black
set -l color01 "a9/22/58" # Base 08 - Red
set -l color02 "c6/91/4b" # Base 0B - Green
set -l color03 "80/4e/ad" # Base 0A - Yellow
set -l color04 "8e/7d/c6" # Base 0D - Blue
set -l color05 "95/3b/9d" # Base 0E - Magenta
set -l color06 "72/63/aa" # Base 0C - Cyan
set -l color07 "de/dc/df" # Base 05 - White
set -l color08 "5d/57/66" # Base 03 - Bright Black
...
set -l color15 "bb/aa/dd" # Base 07 - Bright White
set -l color16 "91/88/89" # Base 09
set -l color17 "59/32/5c" # Base 0F
set -l color18 "10/03/23" # Base 01
set -l color19 "3e/2d/5c" # Base 02
set -l color20 "be/bc/bf" # Base 04
set -l color21 "ed/ea/ef" # Base 06
set -l color_foreground "de/dc/df" # Base 05
set -l color_background "27/1c/3a" # Base 00
...
set -U fish_color_end dedcdf
set -U fish_color_error brred
set -U fish_color_param bebcbf
set -U fish_color_valid_path --underline
set -U fish_color_option brcyan
set -U fish_color_comment 5d5766
set -U fish_color_selection edeaef --bold --background=3e2d5c
set -U fish_color_operator brblue
set -U fish_color_escape brcyan
set -U fish_color_autosuggestion 5d5766
...
set -U fish_pager_color_progress 100323 --background=bebcbf
set -U fish_pager_color_background normal --background=271c3a
set -U fish_pager_color_prefix normal --bold
set -U fish_pager_color_completion normal
set -U fish_pager_color_description 918889 --dim
set -U fish_pager_color_selected_background edeaef --background=3e2d5c
set -U fish_pager_color_selected_prefix edeaef --bold --background=3e2d5c
set -U fish_pager_color_selected_completion edeaef
...
# Set theme
set -Ux BASE16_THEME pasque

# Optionally export variables
if test -n "$TINTED_SHELL_ENABLE_BASE16_VARS"; or test -n "$BASE16_SHELL_ENABLE_VARS"
  set -gx BASE16_COLOR_00_HEX "271c3a"
  set -gx BASE16_COLOR_01_HEX "100323"
  set -gx BASE16_COLOR_02_HEX "3e2d5c"
  set -gx BASE16_COLOR_03_HEX "5d5766"
  set -gx BASE16_COLOR_04_HEX "bebcbf"
  set -gx BASE16_COLOR_05_HEX "dedcdf"
  set -gx BASE16_COLOR_06_HEX "edeaef"
  set -gx BASE16_COLOR_07_HEX "bbaadd"
  set -gx BASE16_COLOR_08_HEX "a92258"
  set -gx BASE16_COLOR_09_HEX "918889"
  set -gx BASE16_COLOR_0A_HEX "804ead"
  set -gx BASE16_COLOR_0B_HEX "c6914b"
  set -gx BASE16_COLOR_0C_HEX "7263aa"
  set -gx BASE16_COLOR_0D_HEX "8e7dc6"
  set -gx BASE16_COLOR_0E_HEX "953b9d"
  set -gx BASE16_COLOR_0F_HEX "59325c"
end
