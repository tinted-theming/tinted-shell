...
set -U fish_color_selection ffba81 --background=100b22
set -U fish_color_operator magenta
set -U fish_color_escape efdeab
...
set -U fish_color_search_match yellow --background=100b22
set -U fish_color_history_current --underline=curly
set -U fish_pager_color_progress 0a041f --background=876251
set -U fish_pager_color_background --background=2a1a4a
set -U fish_pager_color_prefix --bold --italics
set -U fish_pager_color_completion normal
set -U fish_pager_color_description efdeab
set -U fish_pager_color_selected_background --background=100b22
set -U fish_pager_color_selected_prefix --bold --italics --background=100b22
