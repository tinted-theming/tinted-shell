...
set -l color00 "2a/1a/4a" # Base 00 - Black
set -l color01 "ff/78/6c" # Base 08 - Red
set -l color02 "98/b4/81" # Base 0B - Green
set -l color03 "79/da/ed" # Base 0A - Yellow
set -l color04 "66/d9/ef" # Base 0D - Blue
set -l color05 "e6/8e/cd" # Base 0E - Magenta
set -l color06 "b9/8c/ff" # Base 0C - Cyan
set -l color07 "c3/8e/69" # Base 05 - White
set -l color08 "4b/36/39" # Base 03 - Bright Black
...
set -l color15 "b9/ae/d3" # Base 07 - Bright White
set -l color16 "ef/de/ab" # Base 09
set -l color17 "7f/3c/36" # Base 0F
set -l color18 "0a/04/1f" # Base 01
set -l color19 "10/0b/22" # Base 02
set -l color20 "87/62/51" # Base 04
set -l color21 "ff/ba/81" # Base 06
set -l color_foreground "c3/8e/69" # Base 05
set -l color_background "2a/1a/4a" # Base 00
...
set -U fish_color_end c38e69
set -U fish_color_error brred
set -U fish_color_param 876251
set -U fish_color_valid_path --underline
set -U fish_color_option brcyan
set -U fish_color_comment 4b3639
set -U fish_color_selection ffba81 --bold --background=100b22
set -U fish_color_operator brblue
set -U fish_color_escape brcyan
set -U fish_color_autosuggestion 4b3639
...
set -U fish_color_search_match bryellow --background=100b22
set -U fish_color_history_current --bold
set -U fish_pager_color_progress 0a041f --background=876251
set -U fish_pager_color_background normal --background=2a1a4a
set -U fish_pager_color_prefix normal --bold
set -U fish_pager_color_completion normal
set -U fish_pager_color_description efdeab --dim
set -U fish_pager_color_selected_background ffba81 --background=100b22
set -U fish_pager_color_selected_prefix ffba81 --bold --background=100b22
set -U fish_pager_color_selected_completion ffba81
...
# Set theme
set -Ux BASE24_THEME purplepeter

# Optionally export variables
if test -n "$TINTED_SHELL_ENABLE_BASE24_VARS"; or test -n "$BASE24_SHELL_ENABLE_VARS"
  set -gx BASE24_COLOR_00_HEX "2a1a4a"
  set -gx BASE24_COLOR_01_HEX "0a041f"
  set -gx BASE24_COLOR_02_HEX "100b22"
  set -gx BASE24_COLOR_03_HEX "4b3639"
  set -gx BASE24_COLOR_04_HEX "876251"
  set -gx BASE24_COLOR_05_HEX "c38e69"
  set -gx BASE24_COLOR_06_HEX "ffba81"
  set -gx BASE24_COLOR_07_HEX "b9aed3"
  set -gx BASE24_COLOR_08_HEX "ff786c"
  set -gx BASE24_COLOR_09_HEX "efdeab"
  set -gx BASE24_COLOR_0A_HEX "79daed"
  set -gx BASE24_COLOR_0B_HEX "98b481"
  set -gx BASE24_COLOR_0C_HEX "b98cff"
  set -gx BASE24_COLOR_0D_HEX "66d9ef"
  set -gx BASE24_COLOR_0E_HEX "e68ecd"
  set -gx BASE24_COLOR_0F_HEX "7f3c36"
end
