...
set -l color00 "13/15/13" # Base 00 - Black
...
set -l color07 "8c/a6/8c" # Base 05 - White
set -l color08 "68/7d/68" # Base 03 - Bright Black
...
set -l color15 "f4/fb/f4" # Base 07 - Bright White
set -l color16 "87/71/1d" # Base 09
set -l color17 "e6/19/c3" # Base 0F
set -l color18 "24/29/24" # Base 01
set -l color19 "5e/6e/5e" # Base 02
set -l color20 "80/99/80" # Base 04
set -l color21 "cf/e8/cf" # Base 06
set -l color_foreground "8c/a6/8c" # Base 05
set -l color_background "13/15/13" # Base 00
...
set -U fish_color_end 8ca68c
set -U fish_color_error brred
set -U fish_color_param 809980
set -U fish_color_valid_path --underline
set -U fish_color_option brcyan
set -U fish_color_comment 687d68
set -U fish_color_selection cfe8cf --bold --background=5e6e5e
set -U fish_color_operator brblue
set -U fish_color_escape brcyan
set -U fish_color_autosuggestion 687d68
...
set -U fish_pager_color_progress 242924 --background=809980
set -U fish_pager_color_background normal --background=131513
set -U fish_pager_color_prefix normal --bold
set -U fish_pager_color_completion normal
set -U fish_pager_color_description 87711d --dim
set -U fish_pager_color_selected_background cfe8cf --background=5e6e5e
set -U fish_pager_color_selected_prefix cfe8cf --bold --background=5e6e5e
set -U fish_pager_color_selected_completion cfe8cf
...
# Set theme
set -Ux BASE16_THEME atelier-seaside

# Optionally export variables
if test -n "$TINTED_SHELL_ENABLE_BASE16_VARS"; or test -n "$BASE16_SHELL_ENABLE_VARS"
  set -gx BASE16_COLOR_00_HEX "131513"
  set -gx BASE16_COLOR_01_HEX "242924"
  set -gx BASE16_COLOR_02_HEX "5e6e5e"
  set -gx BASE16_COLOR_03_HEX "687d68"
  set -gx BASE16_COLOR_04_HEX "809980"
  set -gx BASE16_COLOR_05_HEX "8ca68c"
  set -gx BASE16_COLOR_06_HEX "cfe8cf"
  set -gx BASE16_COLOR_07_HEX "f4fbf4"
