...
set -l color07 "97/9d/b4" # Base 05 - White
set -l color08 "6b/73/94" # Base 03 - Bright Black
...
set -l color18 "29/32/56" # Base 01
set -l color19 "5e/66/87" # Base 02
set -l color20 "89/8e/a4" # Base 04
set -l color21 "df/e2/f1" # Base 06
set -l color_foreground "97/9d/b4" # Base 05
...
set -U fish_pager_color_progress 293256 --background=898ea4
...
set -U fish_pager_color_selected_background dfe2f1 --background=5e6687
set -U fish_pager_color_selected_prefix dfe2f1 --bold --background=5e6687
set -U fish_pager_color_selected_completion dfe2f1
...
# Set theme
set -Ux BASE16_THEME atelier-sulphurpool

# Optionally export variables
if test -n "$TINTED_SHELL_ENABLE_BASE16_VARS"; or test -n "$BASE16_SHELL_ENABLE_VARS"
  set -gx BASE16_COLOR_00_HEX "202746"
  set -gx BASE16_COLOR_01_HEX "293256"
  set -gx BASE16_COLOR_02_HEX "5e6687"
  set -gx BASE16_COLOR_03_HEX "6b7394"
  set -gx BASE16_COLOR_04_HEX "898ea4"
  set -gx BASE16_COLOR_05_HEX "979db4"
  set -gx BASE16_COLOR_06_HEX "dfe2f1"
  set -gx BASE16_COLOR_07_HEX "f5f7ff"
