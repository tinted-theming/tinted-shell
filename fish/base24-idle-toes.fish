...
set -l color00 "32/32/32" # Base 00 - Black
set -l color01 "d2/52/52" # Base 08 - Red
set -l color02 "7f/e1/73" # Base 0B - Green
set -l color03 "5e/b7/f7" # Base 0A - Yellow
set -l color04 "40/98/ff" # Base 0D - Blue
set -l color05 "f5/7f/ff" # Base 0E - Magenta
set -l color06 "be/d6/ff" # Base 0C - Cyan
set -l color07 "c7/c7/c5" # Base 05 - White
set -l color08 "79/79/79" # Base 03 - Bright Black
...
set -l color16 "ff/c6/6d" # Base 09
set -l color17 "69/29/29" # Base 0F
set -l color18 "32/32/32" # Base 01
set -l color19 "53/53/53" # Base 02
set -l color20 "a0/a0/9f" # Base 04
set -l color21 "ee/ee/ec" # Base 06
set -l color_foreground "c7/c7/c5" # Base 05
set -l color_background "32/32/32" # Base 00
...
set -U fish_color_end c7c7c5
set -U fish_color_error brred
set -U fish_color_param a0a09f
set -U fish_color_valid_path --underline
set -U fish_color_option brcyan
set -U fish_color_comment 797979
set -U fish_color_selection eeeeec --bold --background=535353
set -U fish_color_operator brblue
set -U fish_color_escape brcyan
set -U fish_color_autosuggestion 797979
...
set -U fish_pager_color_progress 323232 --background=a0a09f
set -U fish_pager_color_background normal --background=323232
set -U fish_pager_color_prefix normal --bold
set -U fish_pager_color_completion normal
set -U fish_pager_color_description ffc66d --dim
set -U fish_pager_color_selected_background eeeeec --background=535353
set -U fish_pager_color_selected_prefix eeeeec --bold --background=535353
set -U fish_pager_color_selected_completion eeeeec
...
# Set theme
set -Ux BASE24_THEME idle-toes

# Optionally export variables
if test -n "$TINTED_SHELL_ENABLE_BASE24_VARS"; or test -n "$BASE24_SHELL_ENABLE_VARS"
  set -gx BASE24_COLOR_00_HEX "323232"
  set -gx BASE24_COLOR_01_HEX "323232"
  set -gx BASE24_COLOR_02_HEX "535353"
  set -gx BASE24_COLOR_03_HEX "797979"
  set -gx BASE24_COLOR_04_HEX "a0a09f"
  set -gx BASE24_COLOR_05_HEX "c7c7c5"
  set -gx BASE24_COLOR_06_HEX "eeeeec"
  set -gx BASE24_COLOR_07_HEX "ffffff"
  set -gx BASE24_COLOR_08_HEX "d25252"
  set -gx BASE24_COLOR_09_HEX "ffc66d"
  set -gx BASE24_COLOR_0A_HEX "5eb7f7"
  set -gx BASE24_COLOR_0B_HEX "7fe173"
  set -gx BASE24_COLOR_0C_HEX "bed6ff"
  set -gx BASE24_COLOR_0D_HEX "4098ff"
  set -gx BASE24_COLOR_0E_HEX "f57fff"
  set -gx BASE24_COLOR_0F_HEX "692929"
end
