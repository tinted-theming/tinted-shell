...
set -l color01 "e1/5d/67" # Base 08 - Red
set -l color02 "5d/b1/29" # Base 0B - Green
set -l color03 "e1/b3/1a" # Base 0A - Yellow
set -l color04 "00/a3/f2" # Base 0D - Blue
set -l color05 "b4/6e/e0" # Base 0E - Magenta
set -l color06 "21/c9/92" # Base 0C - Cyan
...
set -l color16 "fc/80/4e" # Base 09
set -l color17 "b8/7d/28" # Base 0F
set -l color18 "30/30/30" # Base 01
set -l color19 "55/55/55" # Base 02
set -l color20 "89/89/89" # Base 04
...
set -U fish_color_param 898989
set -U fish_color_valid_path --underline
set -U fish_color_option brcyan
set -U fish_color_comment 898989
set -U fish_color_selection e0e0e0 --bold --background=555555
...
set -U fish_pager_color_progress 303030 --background=898989
set -U fish_pager_color_background normal --background=222222
set -U fish_pager_color_prefix normal --bold
set -U fish_pager_color_completion normal
set -U fish_pager_color_description fc804e --dim
set -U fish_pager_color_selected_background e0e0e0 --background=555555
set -U fish_pager_color_selected_prefix e0e0e0 --bold --background=555555
...
# Set theme
set -Ux BASE16_THEME standardized-dark
...
if test -n "$TINTED_SHELL_ENABLE_BASE16_VARS"; or test -n "$BASE16_SHELL_ENABLE_VARS"
  ...
  set -gx BASE16_COLOR_02_HEX "555555"
  set -gx BASE16_COLOR_03_HEX "898989"
  set -gx BASE16_COLOR_04_HEX "898989"
  set -gx BASE16_COLOR_05_HEX "c0c0c0"
  set -gx BASE16_COLOR_06_HEX "e0e0e0"
  set -gx BASE16_COLOR_07_HEX "ffffff"
  set -gx BASE16_COLOR_08_HEX "e15d67"
  set -gx BASE16_COLOR_09_HEX "fc804e"
  set -gx BASE16_COLOR_0A_HEX "e1b31a"
  set -gx BASE16_COLOR_0B_HEX "5db129"
  set -gx BASE16_COLOR_0C_HEX "21c992"
  set -gx BASE16_COLOR_0D_HEX "00a3f2"
  set -gx BASE16_COLOR_0E_HEX "b46ee0"
  set -gx BASE16_COLOR_0F_HEX "b87d28"
end
