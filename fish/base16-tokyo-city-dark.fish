...
set -l color03 "b7/c5/d3" # Base 0A - Yellow
...
set -l color17 "bb/9a/f7" # Base 0F
...
set -U fish_pager_color_background normal --background=171d23
set -U fish_pager_color_prefix normal --bold
set -U fish_pager_color_completion normal
set -U fish_pager_color_description ff9e64 --dim
set -U fish_pager_color_selected_background f6f6f8 --background=28323a
set -U fish_pager_color_selected_prefix f6f6f8 --bold --background=28323a
set -U fish_pager_color_selected_completion f6f6f8
...
# Set theme
set -Ux BASE16_THEME tokyo-city-dark
...
if test -n "$TINTED_SHELL_ENABLE_BASE16_VARS"; or test -n "$BASE16_SHELL_ENABLE_VARS"
  ...
  set -gx BASE16_COLOR_0A_HEX "b7c5d3"
  ...
  set -gx BASE16_COLOR_0F_HEX "bb9af7"
end
