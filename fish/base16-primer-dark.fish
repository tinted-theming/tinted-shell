...
set -l color00 "01/04/09" # Base 00 - Black
set -l color01 "ff/7b/72" # Base 08 - Red
set -l color02 "3f/b9/50" # Base 0B - Green
set -l color03 "d2/99/22" # Base 0A - Yellow
set -l color04 "58/a6/ff" # Base 0D - Blue
set -l color05 "f7/78/ba" # Base 0E - Magenta
set -l color06 "a5/d6/ff" # Base 0C - Cyan
set -l color07 "b1/ba/c4" # Base 05 - White
set -l color08 "48/4f/58" # Base 03 - Bright Black
...
set -l color15 "f0/f6/fc" # Base 07 - Bright White
set -l color16 "f0/88/3e" # Base 09
set -l color17 "bd/56/1d" # Base 0F
set -l color18 "21/26/2d" # Base 01
set -l color19 "30/36/3d" # Base 02
set -l color20 "8b/94/9e" # Base 04
set -l color21 "c9/d1/d9" # Base 06
set -l color_foreground "b1/ba/c4" # Base 05
set -l color_background "01/04/09" # Base 00
...
set -U fish_color_end b1bac4
set -U fish_color_error brred
set -U fish_color_param 8b949e
set -U fish_color_valid_path --underline
set -U fish_color_option brcyan
set -U fish_color_comment 484f58
set -U fish_color_selection c9d1d9 --bold --background=30363d
set -U fish_color_operator brblue
set -U fish_color_escape brcyan
set -U fish_color_autosuggestion 484f58
...
set -U fish_color_search_match bryellow --background=30363d
set -U fish_color_history_current --bold
set -U fish_pager_color_progress 21262d --background=8b949e
set -U fish_pager_color_background normal --background=010409
set -U fish_pager_color_prefix normal --bold
set -U fish_pager_color_completion normal
set -U fish_pager_color_description f0883e --dim
set -U fish_pager_color_selected_background c9d1d9 --background=30363d
set -U fish_pager_color_selected_prefix c9d1d9 --bold --background=30363d
set -U fish_pager_color_selected_completion c9d1d9
...
# Set theme
set -Ux BASE16_THEME primer-dark

# Optionally export variables
if test -n "$TINTED_SHELL_ENABLE_BASE16_VARS"; or test -n "$BASE16_SHELL_ENABLE_VARS"
  set -gx BASE16_COLOR_00_HEX "010409"
  set -gx BASE16_COLOR_01_HEX "21262d"
  set -gx BASE16_COLOR_02_HEX "30363d"
  set -gx BASE16_COLOR_03_HEX "484f58"
  set -gx BASE16_COLOR_04_HEX "8b949e"
  set -gx BASE16_COLOR_05_HEX "b1bac4"
  set -gx BASE16_COLOR_06_HEX "c9d1d9"
  set -gx BASE16_COLOR_07_HEX "f0f6fc"
  set -gx BASE16_COLOR_08_HEX "ff7b72"
  set -gx BASE16_COLOR_09_HEX "f0883e"
  set -gx BASE16_COLOR_0A_HEX "d29922"
  set -gx BASE16_COLOR_0B_HEX "3fb950"
  set -gx BASE16_COLOR_0C_HEX "a5d6ff"
  set -gx BASE16_COLOR_0D_HEX "58a6ff"
  set -gx BASE16_COLOR_0E_HEX "f778ba"
  set -gx BASE16_COLOR_0F_HEX "bd561d"
end
