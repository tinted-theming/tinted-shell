...
set -l color00 "19/17/24" # Base 00 - Black
set -l color01 "eb/6f/92" # Base 08 - Red
set -l color02 "31/74/8f" # Base 0B - Green
set -l color03 "eb/bc/ba" # Base 0A - Yellow
...
set -l color15 "52/4f/67" # Base 07 - Bright White
set -l color16 "f6/c1/77" # Base 09
set -l color17 "52/4f/67" # Base 0F
set -l color18 "1f/1d/2e" # Base 01
set -l color19 "26/23/3a" # Base 02
set -l color20 "90/8c/aa" # Base 04
set -l color21 "e0/de/f4" # Base 06
set -l color_foreground "e0/de/f4" # Base 05
set -l color_background "19/17/24" # Base 00
...
set -U fish_color_selection e0def4 --bold --background=26233a
...
set -U fish_pager_color_progress 1f1d2e --background=908caa
set -U fish_pager_color_background normal --background=191724
set -U fish_pager_color_prefix normal --bold
set -U fish_pager_color_completion normal
set -U fish_pager_color_description f6c177 --dim
set -U fish_pager_color_selected_background e0def4 --background=26233a
set -U fish_pager_color_selected_prefix e0def4 --bold --background=26233a
...
# Set theme
set -Ux BASE16_THEME rose-pine

# Optionally export variables
if test -n "$TINTED_SHELL_ENABLE_BASE16_VARS"; or test -n "$BASE16_SHELL_ENABLE_VARS"
  set -gx BASE16_COLOR_00_HEX "191724"
  set -gx BASE16_COLOR_01_HEX "1f1d2e"
  set -gx BASE16_COLOR_02_HEX "26233a"
