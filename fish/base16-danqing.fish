...
set -l color00 "2d/30/2f" # Base 00 - Black
...
set -l color07 "e0/f0/ef" # Base 05 - White
set -l color08 "9d/a8/a3" # Base 03 - Bright Black
...
set -l color15 "fc/fe/fd" # Base 07 - Bright White
set -l color16 "b3/8a/61" # Base 09
set -l color17 "ca/69/24" # Base 0F
set -l color18 "43/48/46" # Base 01
set -l color19 "5a/60/5d" # Base 02
set -l color20 "ca/d8/d2" # Base 04
set -l color21 "ec/f6/f2" # Base 06
set -l color_foreground "e0/f0/ef" # Base 05
set -l color_background "2d/30/2f" # Base 00
...
set -U fish_color_end e0f0ef
set -U fish_color_error brred
set -U fish_color_param cad8d2
set -U fish_color_valid_path --underline
set -U fish_color_option brcyan
set -U fish_color_comment 9da8a3
set -U fish_color_selection ecf6f2 --bold --background=5a605d
set -U fish_color_operator brblue
set -U fish_color_escape brcyan
set -U fish_color_autosuggestion 9da8a3
...
set -U fish_pager_color_progress 434846 --background=cad8d2
set -U fish_pager_color_background normal --background=2d302f
set -U fish_pager_color_prefix normal --bold
set -U fish_pager_color_completion normal
set -U fish_pager_color_description b38a61 --dim
set -U fish_pager_color_selected_background ecf6f2 --background=5a605d
set -U fish_pager_color_selected_prefix ecf6f2 --bold --background=5a605d
set -U fish_pager_color_selected_completion ecf6f2
...
# Set theme
set -Ux BASE16_THEME danqing

# Optionally export variables
if test -n "$TINTED_SHELL_ENABLE_BASE16_VARS"; or test -n "$BASE16_SHELL_ENABLE_VARS"
  set -gx BASE16_COLOR_00_HEX "2d302f"
  set -gx BASE16_COLOR_01_HEX "434846"
  set -gx BASE16_COLOR_02_HEX "5a605d"
  set -gx BASE16_COLOR_03_HEX "9da8a3"
  set -gx BASE16_COLOR_04_HEX "cad8d2"
  set -gx BASE16_COLOR_05_HEX "e0f0ef"
  set -gx BASE16_COLOR_06_HEX "ecf6f2"
  set -gx BASE16_COLOR_07_HEX "fcfefd"
