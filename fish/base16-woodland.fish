...
set -U fish_pager_color_background normal --background=231e18
set -U fish_pager_color_prefix normal --bold
set -U fish_pager_color_completion normal
set -U fish_pager_color_description ca7f32 --dim
set -U fish_pager_color_selected_background d7c8bc --background=48413a
set -U fish_pager_color_selected_prefix d7c8bc --bold --background=48413a
set -U fish_pager_color_selected_completion d7c8bc
