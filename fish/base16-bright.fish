...
set -l color01 "fb/01/20" # Base 08 - Red
set -l color02 "a1/c6/59" # Base 0B - Green
set -l color03 "fd/a3/31" # Base 0A - Yellow
set -l color04 "6f/b3/d2" # Base 0D - Blue
set -l color05 "d3/81/c3" # Base 0E - Magenta
set -l color06 "76/c7/b7" # Base 0C - Cyan
...
set -l color16 "fc/6d/24" # Base 09
set -l color17 "be/64/3c" # Base 0F
set -l color18 "30/30/30" # Base 01
set -l color19 "50/50/50" # Base 02
set -l color20 "d0/d0/d0" # Base 04
...
set -U fish_color_selection f5f5f5 --bold --background=505050
...
set -U fish_pager_color_progress 303030 --background=d0d0d0
set -U fish_pager_color_background normal --background=000000
set -U fish_pager_color_prefix normal --bold
set -U fish_pager_color_completion normal
set -U fish_pager_color_description fc6d24 --dim
set -U fish_pager_color_selected_background f5f5f5 --background=505050
set -U fish_pager_color_selected_prefix f5f5f5 --bold --background=505050
...
if test -n "$TINTED_SHELL_ENABLE_BASE16_VARS"; or test -n "$BASE16_SHELL_ENABLE_VARS"
  ...
  set -gx BASE16_COLOR_02_HEX "505050"
  set -gx BASE16_COLOR_03_HEX "b0b0b0"
  set -gx BASE16_COLOR_04_HEX "d0d0d0"
  set -gx BASE16_COLOR_05_HEX "e0e0e0"
  set -gx BASE16_COLOR_06_HEX "f5f5f5"
  set -gx BASE16_COLOR_07_HEX "ffffff"
  set -gx BASE16_COLOR_08_HEX "fb0120"
  set -gx BASE16_COLOR_09_HEX "fc6d24"
  set -gx BASE16_COLOR_0A_HEX "fda331"
  set -gx BASE16_COLOR_0B_HEX "a1c659"
  set -gx BASE16_COLOR_0C_HEX "76c7b7"
  set -gx BASE16_COLOR_0D_HEX "6fb3d2"
  set -gx BASE16_COLOR_0E_HEX "d381c3"
