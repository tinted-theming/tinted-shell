...
set -U fish_pager_color_description ffd24a --dim
set -U fish_pager_color_selected_background ffffff --background=323232
set -U fish_pager_color_selected_prefix ffffff --bold --background=323232
