...
set -l color02 "51/9f/50" # Base 0B - Green
set -l color03 "9f/ce/f0" # Base 0A - Yellow
set -l color04 "6d/9c/be" # Base 0D - Blue
set -l color05 "d0/d0/ff" # Base 0E - Magenta
set -l color06 "6e/9c/be" # Base 0C - Cyan
set -l color07 "cb/cb/cb" # Base 05 - White
set -l color08 "65/65/65" # Base 03 - Bright Black
...
set -U fish_color_comment 656565
set -U fish_color_selection ffffff --background=323232
set -U fish_color_operator magenta
set -U fish_color_escape ffd24a
set -U fish_color_autosuggestion 656565
...
set -U fish_pager_color_progress 000000 --background=989898
set -U fish_pager_color_background --background=2b2b2b
set -U fish_pager_color_prefix --bold --italics
set -U fish_pager_color_completion normal
set -U fish_pager_color_description ffd24a
...
# Set theme
set -Ux BASE24_THEME broadcast

# Optionally export variables
if test -n "$TINTED_SHELL_ENABLE_BASE24_VARS"; or test -n "$BASE24_SHELL_ENABLE_VARS"
  set -gx BASE24_COLOR_00_HEX "2b2b2b"
  set -gx BASE24_COLOR_01_HEX "000000"
  set -gx BASE24_COLOR_02_HEX "323232"
  set -gx BASE24_COLOR_03_HEX "656565"
  set -gx BASE24_COLOR_04_HEX "989898"
  set -gx BASE24_COLOR_05_HEX "cbcbcb"
  set -gx BASE24_COLOR_06_HEX "ffffff"
  set -gx BASE24_COLOR_07_HEX "ffffff"
  set -gx BASE24_COLOR_08_HEX "da4939"
  set -gx BASE24_COLOR_09_HEX "ffd24a"
  set -gx BASE24_COLOR_0A_HEX "9fcef0"
  set -gx BASE24_COLOR_0B_HEX "519f50"
  set -gx BASE24_COLOR_0C_HEX "6e9cbe"
  set -gx BASE24_COLOR_0D_HEX "6d9cbe"
  set -gx BASE24_COLOR_0E_HEX "d0d0ff"
  set -gx BASE24_COLOR_0F_HEX "6d241c"
end
