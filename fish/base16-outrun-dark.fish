...
set -l color00 "00/00/2a" # Base 00 - Black
set -l color01 "ff/42/42" # Base 08 - Red
set -l color02 "59/f1/76" # Base 0B - Green
set -l color03 "f3/e8/77" # Base 0A - Yellow
set -l color04 "66/b0/ff" # Base 0D - Blue
set -l color05 "f1/05/96" # Base 0E - Magenta
set -l color06 "0e/f0/f0" # Base 0C - Cyan
set -l color07 "d0/d0/fa" # Base 05 - White
set -l color08 "50/50/7a" # Base 03 - Bright Black
...
set -l color15 "f5/f5/ff" # Base 07 - Bright White
set -l color16 "fc/8d/28" # Base 09
set -l color17 "f0/03/ef" # Base 0F
set -l color18 "20/20/4a" # Base 01
set -l color19 "30/30/5a" # Base 02
set -l color20 "b0/b0/da" # Base 04
set -l color21 "e0/e0/ff" # Base 06
set -l color_foreground "d0/d0/fa" # Base 05
set -l color_background "00/00/2a" # Base 00
...
set -U fish_color_end d0d0fa
set -U fish_color_error brred
set -U fish_color_param b0b0da
set -U fish_color_valid_path --underline
set -U fish_color_option brcyan
set -U fish_color_comment 50507a
set -U fish_color_selection e0e0ff --bold --background=30305a
set -U fish_color_operator brblue
set -U fish_color_escape brcyan
set -U fish_color_autosuggestion 50507a
...
set -U fish_pager_color_progress 20204a --background=b0b0da
set -U fish_pager_color_background normal --background=00002a
set -U fish_pager_color_prefix normal --bold
set -U fish_pager_color_completion normal
set -U fish_pager_color_description fc8d28 --dim
set -U fish_pager_color_selected_background e0e0ff --background=30305a
set -U fish_pager_color_selected_prefix e0e0ff --bold --background=30305a
set -U fish_pager_color_selected_completion e0e0ff
...
# Set theme
set -Ux BASE16_THEME outrun-dark

# Optionally export variables
if test -n "$TINTED_SHELL_ENABLE_BASE16_VARS"; or test -n "$BASE16_SHELL_ENABLE_VARS"
  set -gx BASE16_COLOR_00_HEX "00002a"
  set -gx BASE16_COLOR_01_HEX "20204a"
  set -gx BASE16_COLOR_02_HEX "30305a"
  set -gx BASE16_COLOR_03_HEX "50507a"
  set -gx BASE16_COLOR_04_HEX "b0b0da"
  set -gx BASE16_COLOR_05_HEX "d0d0fa"
  set -gx BASE16_COLOR_06_HEX "e0e0ff"
  set -gx BASE16_COLOR_07_HEX "f5f5ff"
  set -gx BASE16_COLOR_08_HEX "ff4242"
  set -gx BASE16_COLOR_09_HEX "fc8d28"
  set -gx BASE16_COLOR_0A_HEX "f3e877"
  set -gx BASE16_COLOR_0B_HEX "59f176"
  set -gx BASE16_COLOR_0C_HEX "0ef0f0"
  set -gx BASE16_COLOR_0D_HEX "66b0ff"
  set -gx BASE16_COLOR_0E_HEX "f10596"
  set -gx BASE16_COLOR_0F_HEX "f003ef"
end
