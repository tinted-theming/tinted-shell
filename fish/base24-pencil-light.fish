...
set -U fish_pager_color_description a89c14 --dim
set -U fish_pager_color_selected_background d9d9d9 --background=424242
set -U fish_pager_color_selected_prefix d9d9d9 --bold --background=424242
