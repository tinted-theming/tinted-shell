...
set -l color01 "a8/2e/e6" # Base 08 - Red
set -l color02 "45/95/e6" # Base 0B - Green
set -l color03 "f2/9d/f2" # Base 0A - Yellow
set -l color04 "41/36/d9" # Base 0D - Blue
set -l color05 "7e/5c/e6" # Base 0E - Magenta
set -l color06 "40/df/ff" # Base 0C - Cyan
set -l color07 "b0/8a/e6" # Base 05 - White
set -l color08 "59/33/80" # Base 03 - Bright Black
...
set -l color15 "a3/66/ff" # Base 07 - Bright White
set -l color16 "bb/66/cc" # Base 09
set -l color17 "a8/86/bf" # Base 0F
set -l color18 "23/1a/40" # Base 01
set -l color19 "43/2d/59" # Base 02
set -l color20 "00/ff/00" # Base 04
set -l color21 "90/45/e6" # Base 06
set -l color_foreground "b0/8a/e6" # Base 05
...
set -U fish_color_end b08ae6
set -U fish_color_error brred
set -U fish_color_param 00ff00
set -U fish_color_valid_path --underline
set -U fish_color_option brcyan
set -U fish_color_comment 593380
set -U fish_color_selection 9045e6 --bold --background=432d59
set -U fish_color_operator brblue
set -U fish_color_escape brcyan
set -U fish_color_autosuggestion 593380
...
set -U fish_pager_color_progress 231a40 --background=00ff00
set -U fish_pager_color_background normal --background=000000
set -U fish_pager_color_prefix normal --bold
set -U fish_pager_color_completion normal
set -U fish_pager_color_description bb66cc --dim
set -U fish_pager_color_selected_background 9045e6 --background=432d59
set -U fish_pager_color_selected_prefix 9045e6 --bold --background=432d59
set -U fish_pager_color_selected_completion 9045e6
...
# Set theme
set -Ux BASE16_THEME darkviolet

# Optionally export variables
if test -n "$TINTED_SHELL_ENABLE_BASE16_VARS"; or test -n "$BASE16_SHELL_ENABLE_VARS"
  set -gx BASE16_COLOR_00_HEX "000000"
  set -gx BASE16_COLOR_01_HEX "231a40"
  set -gx BASE16_COLOR_02_HEX "432d59"
  set -gx BASE16_COLOR_03_HEX "593380"
  set -gx BASE16_COLOR_04_HEX "00ff00"
  set -gx BASE16_COLOR_05_HEX "b08ae6"
  set -gx BASE16_COLOR_06_HEX "9045e6"
  set -gx BASE16_COLOR_07_HEX "a366ff"
  set -gx BASE16_COLOR_08_HEX "a82ee6"
  set -gx BASE16_COLOR_09_HEX "bb66cc"
  set -gx BASE16_COLOR_0A_HEX "f29df2"
  set -gx BASE16_COLOR_0B_HEX "4595e6"
  set -gx BASE16_COLOR_0C_HEX "40dfff"
  set -gx BASE16_COLOR_0D_HEX "4136d9"
  set -gx BASE16_COLOR_0E_HEX "7e5ce6"
  set -gx BASE16_COLOR_0F_HEX "a886bf"
end
