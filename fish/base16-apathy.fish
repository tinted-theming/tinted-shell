...
set -U fish_pager_color_background normal --background=031a16
set -U fish_pager_color_prefix normal --bold
set -U fish_pager_color_completion normal
set -U fish_pager_color_description 3e7996 --dim
set -U fish_pager_color_selected_background a7cec8 --background=184e45
set -U fish_pager_color_selected_prefix a7cec8 --bold --background=184e45
set -U fish_pager_color_selected_completion a7cec8
