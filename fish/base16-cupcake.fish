...
set -l color00 "fb/f1/f2" # Base 00 - Black
set -l color01 "d5/7e/85" # Base 08 - Red
set -l color02 "a3/b3/67" # Base 0B - Green
set -l color03 "dc/b1/6c" # Base 0A - Yellow
set -l color04 "72/97/b9" # Base 0D - Blue
set -l color05 "bb/99/b4" # Base 0E - Magenta
set -l color06 "69/a9/a7" # Base 0C - Cyan
set -l color07 "8b/81/98" # Base 05 - White
set -l color08 "bf/b9/c6" # Base 03 - Bright Black
...
set -l color15 "58/50/62" # Base 07 - Bright White
set -l color16 "eb/b7/90" # Base 09
set -l color17 "ba/a5/8c" # Base 0F
set -l color18 "f2/f1/f4" # Base 01
set -l color19 "d8/d5/dd" # Base 02
set -l color20 "a5/9d/af" # Base 04
set -l color21 "72/67/7e" # Base 06
set -l color_foreground "8b/81/98" # Base 05
set -l color_background "fb/f1/f2" # Base 00
...
set -U fish_color_end 8b8198
set -U fish_color_error brred
set -U fish_color_param a59daf
set -U fish_color_valid_path --underline
set -U fish_color_option brcyan
set -U fish_color_comment bfb9c6
set -U fish_color_selection 72677e --bold --background=d8d5dd
set -U fish_color_operator brblue
set -U fish_color_escape brcyan
set -U fish_color_autosuggestion bfb9c6
...
set -U fish_pager_color_progress f2f1f4 --background=a59daf
set -U fish_pager_color_background normal --background=fbf1f2
set -U fish_pager_color_prefix normal --bold
set -U fish_pager_color_completion normal
set -U fish_pager_color_description ebb790 --dim
set -U fish_pager_color_selected_background 72677e --background=d8d5dd
set -U fish_pager_color_selected_prefix 72677e --bold --background=d8d5dd
set -U fish_pager_color_selected_completion 72677e
...
# Set theme
set -Ux BASE16_THEME cupcake

# Optionally export variables
if test -n "$TINTED_SHELL_ENABLE_BASE16_VARS"; or test -n "$BASE16_SHELL_ENABLE_VARS"
  set -gx BASE16_COLOR_00_HEX "fbf1f2"
  set -gx BASE16_COLOR_01_HEX "f2f1f4"
  set -gx BASE16_COLOR_02_HEX "d8d5dd"
  set -gx BASE16_COLOR_03_HEX "bfb9c6"
  set -gx BASE16_COLOR_04_HEX "a59daf"
  set -gx BASE16_COLOR_05_HEX "8b8198"
  set -gx BASE16_COLOR_06_HEX "72677e"
  set -gx BASE16_COLOR_07_HEX "585062"
  set -gx BASE16_COLOR_08_HEX "d57e85"
  set -gx BASE16_COLOR_09_HEX "ebb790"
  set -gx BASE16_COLOR_0A_HEX "dcb16c"
  set -gx BASE16_COLOR_0B_HEX "a3b367"
  set -gx BASE16_COLOR_0C_HEX "69a9a7"
  set -gx BASE16_COLOR_0D_HEX "7297b9"
  set -gx BASE16_COLOR_0E_HEX "bb99b4"
  set -gx BASE16_COLOR_0F_HEX "baa58c"
end
