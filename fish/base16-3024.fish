...
set -l color00 "09/03/00" # Base 00 - Black
set -l color01 "db/2d/20" # Base 08 - Red
set -l color02 "01/a2/52" # Base 0B - Green
set -l color03 "fd/ed/02" # Base 0A - Yellow
set -l color04 "01/a0/e4" # Base 0D - Blue
set -l color05 "a1/6a/94" # Base 0E - Magenta
set -l color06 "b5/e4/f4" # Base 0C - Cyan
set -l color07 "a5/a2/a2" # Base 05 - White
set -l color08 "5c/58/55" # Base 03 - Bright Black
...
set -l color16 "e8/bb/d0" # Base 09
set -l color17 "cd/ab/53" # Base 0F
set -l color18 "3a/34/32" # Base 01
set -l color19 "4a/45/43" # Base 02
set -l color20 "80/7d/7c" # Base 04
set -l color21 "d6/d5/d4" # Base 06
set -l color_foreground "a5/a2/a2" # Base 05
set -l color_background "09/03/00" # Base 00
...
set -U fish_color_end a5a2a2
set -U fish_color_error brred
set -U fish_color_param 807d7c
set -U fish_color_valid_path --underline
set -U fish_color_option brcyan
set -U fish_color_comment 5c5855
set -U fish_color_selection d6d5d4 --bold --background=4a4543
set -U fish_color_operator brblue
set -U fish_color_escape brcyan
set -U fish_color_autosuggestion 5c5855
...
set -U fish_pager_color_progress 3a3432 --background=807d7c
set -U fish_pager_color_background normal --background=090300
set -U fish_pager_color_prefix normal --bold
set -U fish_pager_color_completion normal
set -U fish_pager_color_description e8bbd0 --dim
set -U fish_pager_color_selected_background d6d5d4 --background=4a4543
set -U fish_pager_color_selected_prefix d6d5d4 --bold --background=4a4543
set -U fish_pager_color_selected_completion d6d5d4
...
# Set theme
set -Ux BASE16_THEME 3024

# Optionally export variables
if test -n "$TINTED_SHELL_ENABLE_BASE16_VARS"; or test -n "$BASE16_SHELL_ENABLE_VARS"
  set -gx BASE16_COLOR_00_HEX "090300"
  set -gx BASE16_COLOR_01_HEX "3a3432"
  set -gx BASE16_COLOR_02_HEX "4a4543"
  set -gx BASE16_COLOR_03_HEX "5c5855"
  set -gx BASE16_COLOR_04_HEX "807d7c"
  set -gx BASE16_COLOR_05_HEX "a5a2a2"
  set -gx BASE16_COLOR_06_HEX "d6d5d4"
  set -gx BASE16_COLOR_07_HEX "f7f7f7"
  set -gx BASE16_COLOR_08_HEX "db2d20"
  set -gx BASE16_COLOR_09_HEX "e8bbd0"
  set -gx BASE16_COLOR_0A_HEX "fded02"
  set -gx BASE16_COLOR_0B_HEX "01a252"
  set -gx BASE16_COLOR_0C_HEX "b5e4f4"
  set -gx BASE16_COLOR_0D_HEX "01a0e4"
  set -gx BASE16_COLOR_0E_HEX "a16a94"
  set -gx BASE16_COLOR_0F_HEX "cdab53"
end
