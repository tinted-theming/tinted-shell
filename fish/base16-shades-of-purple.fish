...
set -l color00 "1e/1e/3f" # Base 00 - Black
set -l color01 "d9/04/29" # Base 08 - Red
set -l color02 "3a/d9/00" # Base 0B - Green
set -l color03 "ff/e7/00" # Base 0A - Yellow
set -l color04 "69/43/ff" # Base 0D - Blue
set -l color05 "ff/2c/70" # Base 0E - Magenta
set -l color06 "00/c5/c7" # Base 0C - Cyan
set -l color07 "c7/c7/c7" # Base 05 - White
set -l color08 "80/80/80" # Base 03 - Bright Black
...
set -l color16 "f9/2a/1c" # Base 09
set -l color17 "79/e8/fb" # Base 0F
set -l color18 "43/d4/26" # Base 01
set -l color19 "f1/d0/00" # Base 02
set -l color20 "68/71/ff" # Base 04
set -l color21 "ff/77/ff" # Base 06
set -l color_foreground "c7/c7/c7" # Base 05
set -l color_background "1e/1e/3f" # Base 00
...
set -U fish_pager_color_progress 43d426 --background=6871ff
set -U fish_pager_color_background normal --background=1e1e3f
set -U fish_pager_color_prefix normal --bold
set -U fish_pager_color_completion normal
set -U fish_pager_color_description f92a1c --dim
set -U fish_pager_color_selected_background ff77ff --background=f1d000
set -U fish_pager_color_selected_prefix ff77ff --bold --background=f1d000
set -U fish_pager_color_selected_completion ff77ff
...
# Set theme
set -Ux BASE16_THEME shades-of-purple

# Optionally export variables
if test -n "$TINTED_SHELL_ENABLE_BASE16_VARS"; or test -n "$BASE16_SHELL_ENABLE_VARS"
  set -gx BASE16_COLOR_00_HEX "1e1e3f"
  set -gx BASE16_COLOR_01_HEX "43d426"
  set -gx BASE16_COLOR_02_HEX "f1d000"
  set -gx BASE16_COLOR_03_HEX "808080"
  set -gx BASE16_COLOR_04_HEX "6871ff"
  set -gx BASE16_COLOR_05_HEX "c7c7c7"
  set -gx BASE16_COLOR_06_HEX "ff77ff"
  set -gx BASE16_COLOR_07_HEX "ffffff"
  set -gx BASE16_COLOR_08_HEX "d90429"
  set -gx BASE16_COLOR_09_HEX "f92a1c"
  set -gx BASE16_COLOR_0A_HEX "ffe700"
  set -gx BASE16_COLOR_0B_HEX "3ad900"
  set -gx BASE16_COLOR_0C_HEX "00c5c7"
  set -gx BASE16_COLOR_0D_HEX "6943ff"
  set -gx BASE16_COLOR_0E_HEX "ff2c70"
  set -gx BASE16_COLOR_0F_HEX "79e8fb"
end
