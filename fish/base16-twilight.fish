...
set -l color02 "8f/9d/6a" # Base 0B - Green
set -l color03 "f9/ee/98" # Base 0A - Yellow
set -l color04 "75/87/a6" # Base 0D - Blue
...
set -l color16 "cd/a8/69" # Base 09
set -l color17 "9b/70/3f" # Base 0F
set -l color18 "32/35/37" # Base 01
set -l color19 "46/4b/50" # Base 02
set -l color20 "83/81/84" # Base 04
set -l color21 "c3/c3/c3" # Base 06
...
set -U fish_color_selection c3c3c3 --bold --background=464b50
...
set -U fish_pager_color_progress 323537 --background=838184
set -U fish_pager_color_background normal --background=1e1e1e
set -U fish_pager_color_prefix normal --bold
set -U fish_pager_color_completion normal
set -U fish_pager_color_description cda869 --dim
set -U fish_pager_color_selected_background c3c3c3 --background=464b50
set -U fish_pager_color_selected_prefix c3c3c3 --bold --background=464b50
set -U fish_pager_color_selected_completion c3c3c3
...
# Set theme
set -Ux BASE16_THEME twilight

# Optionally export variables
if test -n "$TINTED_SHELL_ENABLE_BASE16_VARS"; or test -n "$BASE16_SHELL_ENABLE_VARS"
  set -gx BASE16_COLOR_00_HEX "1e1e1e"
  set -gx BASE16_COLOR_01_HEX "323537"
  set -gx BASE16_COLOR_02_HEX "464b50"
  set -gx BASE16_COLOR_03_HEX "5f5a60"
  set -gx BASE16_COLOR_04_HEX "838184"
  set -gx BASE16_COLOR_05_HEX "a7a7a7"
  set -gx BASE16_COLOR_06_HEX "c3c3c3"
  set -gx BASE16_COLOR_07_HEX "ffffff"
  set -gx BASE16_COLOR_08_HEX "cf6a4c"
  set -gx BASE16_COLOR_09_HEX "cda869"
  set -gx BASE16_COLOR_0A_HEX "f9ee98"
  set -gx BASE16_COLOR_0B_HEX "8f9d6a"
  set -gx BASE16_COLOR_0C_HEX "afc4db"
  set -gx BASE16_COLOR_0D_HEX "7587a6"
  set -gx BASE16_COLOR_0E_HEX "9b859d"
  set -gx BASE16_COLOR_0F_HEX "9b703f"
end
