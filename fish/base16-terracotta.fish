...
set -l color00 "ef/ea/e8" # Base 00 - Black
set -l color01 "a7/50/45" # Base 08 - Red
set -l color02 "7a/89/4a" # Base 0B - Green
set -l color03 "ce/94/3e" # Base 0A - Yellow
set -l color04 "62/55/74" # Base 0D - Blue
set -l color05 "8d/59/68" # Base 0E - Magenta
set -l color06 "84/7f/9e" # Base 0C - Cyan
set -l color07 "47/37/31" # Base 05 - White
set -l color08 "c0/ac/a4" # Base 03 - Bright Black
...
set -l color15 "24/1c/19" # Base 07 - Bright White
set -l color16 "bd/69/42" # Base 09
set -l color17 "b0/71/58" # Base 0F
set -l color18 "df/d6/d1" # Base 01
set -l color19 "d0/c1/bb" # Base 02
set -l color20 "59/45/3d" # Base 04
set -l color21 "35/2a/25" # Base 06
set -l color_foreground "47/37/31" # Base 05
set -l color_background "ef/ea/e8" # Base 00
...
set -U fish_color_end 473731
set -U fish_color_error brred
set -U fish_color_param 59453d
set -U fish_color_valid_path --underline
set -U fish_color_option brcyan
set -U fish_color_comment c0aca4
set -U fish_color_selection 352a25 --bold --background=d0c1bb
set -U fish_color_operator brblue
set -U fish_color_escape brcyan
set -U fish_color_autosuggestion c0aca4
...
set -U fish_pager_color_progress dfd6d1 --background=59453d
set -U fish_pager_color_background normal --background=efeae8
set -U fish_pager_color_prefix normal --bold
set -U fish_pager_color_completion normal
set -U fish_pager_color_description bd6942 --dim
set -U fish_pager_color_selected_background 352a25 --background=d0c1bb
set -U fish_pager_color_selected_prefix 352a25 --bold --background=d0c1bb
set -U fish_pager_color_selected_completion 352a25
...
# Set theme
set -Ux BASE16_THEME terracotta

# Optionally export variables
if test -n "$TINTED_SHELL_ENABLE_BASE16_VARS"; or test -n "$BASE16_SHELL_ENABLE_VARS"
  set -gx BASE16_COLOR_00_HEX "efeae8"
  set -gx BASE16_COLOR_01_HEX "dfd6d1"
  set -gx BASE16_COLOR_02_HEX "d0c1bb"
  set -gx BASE16_COLOR_03_HEX "c0aca4"
  set -gx BASE16_COLOR_04_HEX "59453d"
  set -gx BASE16_COLOR_05_HEX "473731"
  set -gx BASE16_COLOR_06_HEX "352a25"
  set -gx BASE16_COLOR_07_HEX "241c19"
  set -gx BASE16_COLOR_08_HEX "a75045"
  set -gx BASE16_COLOR_09_HEX "bd6942"
  set -gx BASE16_COLOR_0A_HEX "ce943e"
  set -gx BASE16_COLOR_0B_HEX "7a894a"
  set -gx BASE16_COLOR_0C_HEX "847f9e"
  set -gx BASE16_COLOR_0D_HEX "625574"
  set -gx BASE16_COLOR_0E_HEX "8d5968"
  set -gx BASE16_COLOR_0F_HEX "b07158"
end
