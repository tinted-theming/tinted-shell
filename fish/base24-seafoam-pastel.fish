...
set -U fish_color_selection e0e0e0 --background=8a8a8a
set -U fish_color_operator magenta
set -U fish_color_escape ada16d
...
set -U fish_color_search_match yellow --background=8a8a8a
set -U fish_color_history_current --underline=curly
set -U fish_pager_color_progress 757575 --background=b5b5b5
set -U fish_pager_color_background --background=243434
set -U fish_pager_color_prefix --bold --italics
set -U fish_pager_color_completion normal
set -U fish_pager_color_description ada16d
set -U fish_pager_color_selected_background --background=8a8a8a
set -U fish_pager_color_selected_prefix --bold --italics --background=8a8a8a
