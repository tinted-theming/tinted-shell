...
set -l color00 "24/34/34" # Base 00 - Black
set -l color01 "82/5d/4d" # Base 08 - Red
set -l color02 "71/8c/61" # Base 0B - Green
set -l color03 "79/c3/cf" # Base 0A - Yellow
set -l color04 "4d/7b/82" # Base 0D - Blue
set -l color05 "8a/71/67" # Base 0E - Magenta
set -l color06 "71/93/93" # Base 0C - Cyan
set -l color07 "ca/ca/ca" # Base 05 - White
set -l color08 "9f/9f/9f" # Base 03 - Bright Black
...
set -l color15 "e0/e0/e0" # Base 07 - Bright White
set -l color16 "ad/a1/6d" # Base 09
set -l color17 "41/2e/26" # Base 0F
set -l color18 "75/75/75" # Base 01
set -l color19 "8a/8a/8a" # Base 02
set -l color20 "b5/b5/b5" # Base 04
set -l color21 "e0/e0/e0" # Base 06
set -l color_foreground "ca/ca/ca" # Base 05
set -l color_background "24/34/34" # Base 00
...
set -U fish_color_end cacaca
set -U fish_color_error brred
set -U fish_color_param b5b5b5
set -U fish_color_valid_path --underline
set -U fish_color_option brcyan
set -U fish_color_comment 9f9f9f
set -U fish_color_selection e0e0e0 --bold --background=8a8a8a
set -U fish_color_operator brblue
set -U fish_color_escape brcyan
set -U fish_color_autosuggestion 9f9f9f
...
set -U fish_color_search_match bryellow --background=8a8a8a
set -U fish_color_history_current --bold
set -U fish_pager_color_progress 757575 --background=b5b5b5
set -U fish_pager_color_background normal --background=243434
set -U fish_pager_color_prefix normal --bold
set -U fish_pager_color_completion normal
set -U fish_pager_color_description ada16d --dim
set -U fish_pager_color_selected_background e0e0e0 --background=8a8a8a
set -U fish_pager_color_selected_prefix e0e0e0 --bold --background=8a8a8a
set -U fish_pager_color_selected_completion e0e0e0
...
# Set theme
set -Ux BASE24_THEME seafoam-pastel

# Optionally export variables
if test -n "$TINTED_SHELL_ENABLE_BASE24_VARS"; or test -n "$BASE24_SHELL_ENABLE_VARS"
  set -gx BASE24_COLOR_00_HEX "243434"
  set -gx BASE24_COLOR_01_HEX "757575"
  set -gx BASE24_COLOR_02_HEX "8a8a8a"
  set -gx BASE24_COLOR_03_HEX "9f9f9f"
  set -gx BASE24_COLOR_04_HEX "b5b5b5"
  set -gx BASE24_COLOR_05_HEX "cacaca"
  set -gx BASE24_COLOR_06_HEX "e0e0e0"
  set -gx BASE24_COLOR_07_HEX "e0e0e0"
  set -gx BASE24_COLOR_08_HEX "825d4d"
  set -gx BASE24_COLOR_09_HEX "ada16d"
  set -gx BASE24_COLOR_0A_HEX "79c3cf"
  set -gx BASE24_COLOR_0B_HEX "718c61"
  set -gx BASE24_COLOR_0C_HEX "719393"
  set -gx BASE24_COLOR_0D_HEX "4d7b82"
  set -gx BASE24_COLOR_0E_HEX "8a7167"
  set -gx BASE24_COLOR_0F_HEX "412e26"
end
