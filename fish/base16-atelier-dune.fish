...
set -l color00 "20/20/1d" # Base 00 - Black
...
set -l color07 "a6/a2/8c" # Base 05 - White
set -l color08 "7d/7a/68" # Base 03 - Bright Black
...
set -l color15 "fe/fb/ec" # Base 07 - Bright White
set -l color16 "b6/56/11" # Base 09
set -l color17 "d4/35/52" # Base 0F
set -l color18 "29/28/24" # Base 01
set -l color19 "6e/6b/5e" # Base 02
set -l color20 "99/95/80" # Base 04
set -l color21 "e8/e4/cf" # Base 06
set -l color_foreground "a6/a2/8c" # Base 05
set -l color_background "20/20/1d" # Base 00
...
set -U fish_color_end a6a28c
set -U fish_color_error brred
set -U fish_color_param 999580
set -U fish_color_valid_path --underline
set -U fish_color_option brcyan
set -U fish_color_comment 7d7a68
set -U fish_color_selection e8e4cf --bold --background=6e6b5e
set -U fish_color_operator brblue
set -U fish_color_escape brcyan
set -U fish_color_autosuggestion 7d7a68
...
set -U fish_pager_color_progress 292824 --background=999580
set -U fish_pager_color_background normal --background=20201d
set -U fish_pager_color_prefix normal --bold
set -U fish_pager_color_completion normal
set -U fish_pager_color_description b65611 --dim
set -U fish_pager_color_selected_background e8e4cf --background=6e6b5e
set -U fish_pager_color_selected_prefix e8e4cf --bold --background=6e6b5e
set -U fish_pager_color_selected_completion e8e4cf
...
# Set theme
set -Ux BASE16_THEME atelier-dune

# Optionally export variables
if test -n "$TINTED_SHELL_ENABLE_BASE16_VARS"; or test -n "$BASE16_SHELL_ENABLE_VARS"
  set -gx BASE16_COLOR_00_HEX "20201d"
  set -gx BASE16_COLOR_01_HEX "292824"
  set -gx BASE16_COLOR_02_HEX "6e6b5e"
  set -gx BASE16_COLOR_03_HEX "7d7a68"
  set -gx BASE16_COLOR_04_HEX "999580"
  set -gx BASE16_COLOR_05_HEX "a6a28c"
  set -gx BASE16_COLOR_06_HEX "e8e4cf"
  set -gx BASE16_COLOR_07_HEX "fefbec"
