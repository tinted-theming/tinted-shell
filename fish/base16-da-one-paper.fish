...
set -l color00 "fa/f0/dc" # Base 00 - Black
set -l color01 "de/5d/6e" # Base 08 - Red
set -l color02 "76/a8/5d" # Base 0B - Green
set -l color03 "b3/68/4f" # Base 0A - Yellow
set -l color04 "58/90/f8" # Base 0D - Blue
set -l color05 "c1/73/d1" # Base 0E - Magenta
set -l color06 "64/b5/a7" # Base 0C - Cyan
set -l color07 "18/18/18" # Base 05 - White
...
set -l color16 "ff/94/70" # Base 09
set -l color17 "b3/68/4f" # Base 0F
set -l color18 "c8/c8/c8" # Base 01
set -l color19 "88/88/88" # Base 02
set -l color20 "28/28/28" # Base 04
set -l color21 "00/00/00" # Base 06
set -l color_foreground "18/18/18" # Base 05
set -l color_background "fa/f0/dc" # Base 00
...
if test -n "$ITERM_SESSION_ID"
  ...
  put_template_custom Ph faf0dc # background
  ...
  put_template_custom Pm faf0dc # cursor text
else
...
set -U fish_color_end 181818
set -U fish_color_error brred
set -U fish_color_param 282828
set -U fish_color_valid_path --underline
set -U fish_color_option brcyan
set -U fish_color_comment 585858
set -U fish_color_selection 000000 --bold --background=888888
...
set -U fish_color_search_match bryellow --background=888888
set -U fish_color_history_current --bold
set -U fish_pager_color_progress c8c8c8 --background=282828
set -U fish_pager_color_background normal --background=faf0dc
set -U fish_pager_color_prefix normal --bold
set -U fish_pager_color_completion normal
set -U fish_pager_color_description ff9470 --dim
set -U fish_pager_color_selected_background 000000 --background=888888
set -U fish_pager_color_selected_prefix 000000 --bold --background=888888
...
# Set theme
set -Ux BASE16_THEME da-one-paper

# Optionally export variables
if test -n "$TINTED_SHELL_ENABLE_BASE16_VARS"; or test -n "$BASE16_SHELL_ENABLE_VARS"
  set -gx BASE16_COLOR_00_HEX "faf0dc"
  set -gx BASE16_COLOR_01_HEX "c8c8c8"
  set -gx BASE16_COLOR_02_HEX "888888"
  set -gx BASE16_COLOR_03_HEX "585858"
  set -gx BASE16_COLOR_04_HEX "282828"
  set -gx BASE16_COLOR_05_HEX "181818"
  set -gx BASE16_COLOR_06_HEX "000000"
  set -gx BASE16_COLOR_07_HEX "000000"
  set -gx BASE16_COLOR_08_HEX "de5d6e"
  set -gx BASE16_COLOR_09_HEX "ff9470"
  set -gx BASE16_COLOR_0A_HEX "b3684f"
  set -gx BASE16_COLOR_0B_HEX "76a85d"
  set -gx BASE16_COLOR_0C_HEX "64b5a7"
  set -gx BASE16_COLOR_0D_HEX "5890f8"
  set -gx BASE16_COLOR_0E_HEX "c173d1"
  set -gx BASE16_COLOR_0F_HEX "b3684f"
end
