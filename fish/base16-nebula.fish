...
set -U fish_pager_color_background normal --background=22273b
set -U fish_pager_color_prefix normal --bold
set -U fish_pager_color_completion normal
set -U fish_pager_color_description 94929e --dim
set -U fish_pager_color_selected_background c7c9cd --background=5a8380
set -U fish_pager_color_selected_prefix c7c9cd --bold --background=5a8380
set -U fish_pager_color_selected_completion c7c9cd
