...
set -U fish_color_selection e6e6e6 --background=4f5666
set -U fish_color_operator magenta
set -U fish_color_escape d18f52
...
set -U fish_color_search_match yellow --background=4f5666
set -U fish_color_history_current --underline=curly
set -U fish_pager_color_progress 3f4451 --background=9196a1
set -U fish_pager_color_background --background=282c34
set -U fish_pager_color_prefix --bold --italics
set -U fish_pager_color_completion normal
set -U fish_pager_color_description d18f52
set -U fish_pager_color_selected_background --background=4f5666
set -U fish_pager_color_selected_prefix --bold --italics --background=4f5666
