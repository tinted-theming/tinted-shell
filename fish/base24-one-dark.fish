...
set -l color00 "28/2c/34" # Base 00 - Black
set -l color01 "e0/55/61" # Base 08 - Red
set -l color02 "8c/c2/65" # Base 0B - Green
set -l color03 "e6/b9/65" # Base 0A - Yellow
set -l color04 "4a/a5/f0" # Base 0D - Blue
set -l color05 "c1/62/de" # Base 0E - Magenta
set -l color06 "42/b3/c2" # Base 0C - Cyan
set -l color07 "ab/b2/bf" # Base 05 - White
set -l color08 "54/58/62" # Base 03 - Bright Black
...
set -l color16 "d1/8f/52" # Base 09
set -l color17 "bf/40/34" # Base 0F
set -l color18 "3f/44/51" # Base 01
set -l color19 "4f/56/66" # Base 02
set -l color20 "91/96/a1" # Base 04
set -l color21 "e6/e6/e6" # Base 06
set -l color_foreground "ab/b2/bf" # Base 05
set -l color_background "28/2c/34" # Base 00
...
set -U fish_color_param 9196a1
set -U fish_color_valid_path --underline
set -U fish_color_option brcyan
set -U fish_color_comment 545862
set -U fish_color_selection e6e6e6 --bold --background=4f5666
set -U fish_color_operator brblue
set -U fish_color_escape brcyan
set -U fish_color_autosuggestion 545862
...
set -U fish_color_search_match bryellow --background=4f5666
set -U fish_color_history_current --bold
set -U fish_pager_color_progress 3f4451 --background=9196a1
set -U fish_pager_color_background normal --background=282c34
set -U fish_pager_color_prefix normal --bold
set -U fish_pager_color_completion normal
set -U fish_pager_color_description d18f52 --dim
set -U fish_pager_color_selected_background e6e6e6 --background=4f5666
set -U fish_pager_color_selected_prefix e6e6e6 --bold --background=4f5666
set -U fish_pager_color_selected_completion e6e6e6
...
# Set theme
set -Ux BASE24_THEME one-dark

# Optionally export variables
if test -n "$TINTED_SHELL_ENABLE_BASE24_VARS"; or test -n "$BASE24_SHELL_ENABLE_VARS"
  set -gx BASE24_COLOR_00_HEX "282c34"
  set -gx BASE24_COLOR_01_HEX "3f4451"
  set -gx BASE24_COLOR_02_HEX "4f5666"
  set -gx BASE24_COLOR_03_HEX "545862"
  set -gx BASE24_COLOR_04_HEX "9196a1"
  set -gx BASE24_COLOR_05_HEX "abb2bf"
  set -gx BASE24_COLOR_06_HEX "e6e6e6"
  set -gx BASE24_COLOR_07_HEX "ffffff"
  set -gx BASE24_COLOR_08_HEX "e05561"
  set -gx BASE24_COLOR_09_HEX "d18f52"
  set -gx BASE24_COLOR_0A_HEX "e6b965"
  set -gx BASE24_COLOR_0B_HEX "8cc265"
  set -gx BASE24_COLOR_0C_HEX "42b3c2"
  set -gx BASE24_COLOR_0D_HEX "4aa5f0"
  set -gx BASE24_COLOR_0E_HEX "c162de"
  set -gx BASE24_COLOR_0F_HEX "bf4034"
end
