...
set -l color00 "f4/f3/ec" # Base 00 - Black
set -l color01 "ba/62/36" # Base 08 - Red
set -l color02 "7d/97/26" # Base 0B - Green
set -l color03 "a5/98/0d" # Base 0A - Yellow
set -l color04 "36/a1/66" # Base 0D - Blue
set -l color05 "5f/91/82" # Base 0E - Magenta
set -l color06 "5b/9d/48" # Base 0C - Cyan
set -l color07 "5f/5e/4e" # Base 05 - White
set -l color08 "87/85/73" # Base 03 - Bright Black
...
set -l color15 "22/22/1b" # Base 07 - Bright White
set -l color16 "ae/73/13" # Base 09
set -l color17 "9d/6c/7c" # Base 0F
set -l color18 "e7/e6/df" # Base 01
set -l color19 "92/91/81" # Base 02
set -l color20 "6c/6b/5a" # Base 04
set -l color21 "30/2f/27" # Base 06
set -l color_foreground "5f/5e/4e" # Base 05
set -l color_background "f4/f3/ec" # Base 00
...
set -U fish_color_end 5f5e4e
set -U fish_color_error brred
set -U fish_color_param 6c6b5a
set -U fish_color_valid_path --underline
set -U fish_color_option brcyan
set -U fish_color_comment 878573
set -U fish_color_selection 302f27 --bold --background=929181
set -U fish_color_operator brblue
set -U fish_color_escape brcyan
set -U fish_color_autosuggestion 878573
...
set -U fish_pager_color_progress e7e6df --background=6c6b5a
set -U fish_pager_color_background normal --background=f4f3ec
set -U fish_pager_color_prefix normal --bold
set -U fish_pager_color_completion normal
set -U fish_pager_color_description ae7313 --dim
set -U fish_pager_color_selected_background 302f27 --background=929181
set -U fish_pager_color_selected_prefix 302f27 --bold --background=929181
set -U fish_pager_color_selected_completion 302f27
...
# Set theme
set -Ux BASE16_THEME atelier-estuary-light

# Optionally export variables
if test -n "$TINTED_SHELL_ENABLE_BASE16_VARS"; or test -n "$BASE16_SHELL_ENABLE_VARS"
  set -gx BASE16_COLOR_00_HEX "f4f3ec"
  set -gx BASE16_COLOR_01_HEX "e7e6df"
  set -gx BASE16_COLOR_02_HEX "929181"
  set -gx BASE16_COLOR_03_HEX "878573"
  set -gx BASE16_COLOR_04_HEX "6c6b5a"
  set -gx BASE16_COLOR_05_HEX "5f5e4e"
  set -gx BASE16_COLOR_06_HEX "302f27"
  set -gx BASE16_COLOR_07_HEX "22221b"
  set -gx BASE16_COLOR_08_HEX "ba6236"
  set -gx BASE16_COLOR_09_HEX "ae7313"
  set -gx BASE16_COLOR_0A_HEX "a5980d"
  set -gx BASE16_COLOR_0B_HEX "7d9726"
  set -gx BASE16_COLOR_0C_HEX "5b9d48"
  set -gx BASE16_COLOR_0D_HEX "36a166"
  set -gx BASE16_COLOR_0E_HEX "5f9182"
  set -gx BASE16_COLOR_0F_HEX "9d6c7c"
end
