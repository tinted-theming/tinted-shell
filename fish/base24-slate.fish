...
set -l color01 "e1/a7/bf" # Base 08 - Red
set -l color02 "80/d7/78" # Base 0B - Green
set -l color03 "79/af/d2" # Base 0A - Yellow
set -l color04 "25/4a/49" # Base 0D - Blue
set -l color05 "a3/80/d3" # Base 0E - Magenta
set -l color06 "14/ab/9c" # Base 0C - Cyan
set -l color07 "42/d3/e8" # Base 05 - White
set -l color08 "c0/f1/f8" # Base 03 - Bright Black
...
set -l color16 "c4/c9/bf" # Base 09
set -l color17 "70/53/5f" # Base 0F
set -l color18 "21/21/21" # Base 01
set -l color19 "ff/ff/ff" # Base 02
set -l color20 "81/e2/f0" # Base 04
set -l color21 "02/c4/e0" # Base 06
set -l color_foreground "42/d3/e8" # Base 05
...
set -U fish_color_end 42d3e8
set -U fish_color_error brred
set -U fish_color_param 81e2f0
set -U fish_color_valid_path --underline
set -U fish_color_option brcyan
set -U fish_color_comment c0f1f8
set -U fish_color_selection 02c4e0 --bold --background=ffffff
set -U fish_color_operator brblue
set -U fish_color_escape brcyan
set -U fish_color_autosuggestion c0f1f8
...
set -U fish_color_search_match bryellow --background=ffffff
set -U fish_color_history_current --bold
set -U fish_pager_color_progress 212121 --background=81e2f0
set -U fish_pager_color_background normal --background=212121
set -U fish_pager_color_prefix normal --bold
set -U fish_pager_color_completion normal
set -U fish_pager_color_description c4c9bf --dim
set -U fish_pager_color_selected_background 02c4e0 --background=ffffff
set -U fish_pager_color_selected_prefix 02c4e0 --bold --background=ffffff
set -U fish_pager_color_selected_completion 02c4e0
...
if test -n "$TINTED_SHELL_ENABLE_BASE24_VARS"; or test -n "$BASE24_SHELL_ENABLE_VARS"
  ...
  set -gx BASE24_COLOR_02_HEX "ffffff"
  set -gx BASE24_COLOR_03_HEX "c0f1f8"
  set -gx BASE24_COLOR_04_HEX "81e2f0"
  set -gx BASE24_COLOR_05_HEX "42d3e8"
  set -gx BASE24_COLOR_06_HEX "02c4e0"
  set -gx BASE24_COLOR_07_HEX "e0e0e0"
  set -gx BASE24_COLOR_08_HEX "e1a7bf"
  set -gx BASE24_COLOR_09_HEX "c4c9bf"
  set -gx BASE24_COLOR_0A_HEX "79afd2"
  set -gx BASE24_COLOR_0B_HEX "80d778"
  set -gx BASE24_COLOR_0C_HEX "14ab9c"
  set -gx BASE24_COLOR_0D_HEX "254a49"
  set -gx BASE24_COLOR_0E_HEX "a380d3"
  set -gx BASE24_COLOR_0F_HEX "70535f"
end
