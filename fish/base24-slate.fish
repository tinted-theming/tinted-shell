...
set -U fish_color_selection 02c4e0 --background=ffffff
set -U fish_color_operator magenta
set -U fish_color_escape c4c9bf
...
set -U fish_color_search_match yellow --background=ffffff
...
set -U fish_pager_color_description c4c9bf
set -U fish_pager_color_selected_background --background=ffffff
set -U fish_pager_color_selected_prefix --bold --italics --background=ffffff
