...
set -l color00 "f1/f1/f1" # Base 00 - Black
...
set -l color07 "47/47/47" # Base 05 - White
...
set -l color15 "1b/1b/1b" # Base 07 - Bright White
set -l color16 "bf/3e/05" # Base 09
set -l color17 "c4/27/75" # Base 0F
set -l color18 "e2/e2/e2" # Base 01
set -l color19 "d4/d4/d4" # Base 02
set -l color20 "5e/5e/5e" # Base 04
set -l color21 "30/30/30" # Base 06
set -l color_foreground "47/47/47" # Base 05
set -l color_background "f1/f1/f1" # Base 00
...
set -U fish_pager_color_progress e2e2e2 --background=5e5e5e
set -U fish_pager_color_background normal --background=f1f1f1
set -U fish_pager_color_prefix normal --bold
set -U fish_pager_color_completion normal
set -U fish_pager_color_description bf3e05 --dim
set -U fish_pager_color_selected_background 303030 --background=d4d4d4
set -U fish_pager_color_selected_prefix 303030 --bold --background=d4d4d4
set -U fish_pager_color_selected_completion 303030
...
# Set theme
set -Ux BASE16_THEME equilibrium-gray-light

# Optionally export variables
if test -n "$TINTED_SHELL_ENABLE_BASE16_VARS"; or test -n "$BASE16_SHELL_ENABLE_VARS"
  set -gx BASE16_COLOR_00_HEX "f1f1f1"
  set -gx BASE16_COLOR_01_HEX "e2e2e2"
  set -gx BASE16_COLOR_02_HEX "d4d4d4"
  set -gx BASE16_COLOR_03_HEX "777777"
  set -gx BASE16_COLOR_04_HEX "5e5e5e"
  set -gx BASE16_COLOR_05_HEX "474747"
  set -gx BASE16_COLOR_06_HEX "303030"
  set -gx BASE16_COLOR_07_HEX "1b1b1b"
