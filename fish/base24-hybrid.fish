...
set -l color00 "16/17/18" # Base 00 - Black
set -l color01 "b7/4d/50" # Base 08 - Red
set -l color02 "b3/be/5a" # Base 0B - Green
set -l color03 "4b/6b/88" # Base 0A - Yellow
set -l color04 "6d/90/b0" # Base 0D - Blue
set -l color05 "a0/7e/ab" # Base 0E - Magenta
set -l color06 "7f/be/b3" # Base 0C - Cyan
set -l color07 "8f/91/90" # Base 05 - White
set -l color08 "43/44/46" # Base 03 - Bright Black
...
set -l color15 "5a/61/69" # Base 07 - Bright White
set -l color16 "e3/b5/5e" # Base 09
set -l color17 "5b/26/28" # Base 0F
set -l color18 "2a/2e/33" # Base 01
set -l color19 "1d/1e/21" # Base 02
set -l color20 "69/6b/6b" # Base 04
set -l color21 "b5/b8/b6" # Base 06
set -l color_foreground "8f/91/90" # Base 05
set -l color_background "16/17/18" # Base 00
...
set -U fish_color_end 8f9190
set -U fish_color_error brred
set -U fish_color_param 696b6b
set -U fish_color_valid_path --underline
set -U fish_color_option brcyan
set -U fish_color_comment 434446
set -U fish_color_selection b5b8b6 --bold --background=1d1e21
set -U fish_color_operator brblue
set -U fish_color_escape brcyan
set -U fish_color_autosuggestion 434446
...
set -U fish_color_search_match bryellow --background=1d1e21
set -U fish_color_history_current --bold
set -U fish_pager_color_progress 2a2e33 --background=696b6b
set -U fish_pager_color_background normal --background=161718
set -U fish_pager_color_prefix normal --bold
set -U fish_pager_color_completion normal
set -U fish_pager_color_description e3b55e --dim
set -U fish_pager_color_selected_background b5b8b6 --background=1d1e21
set -U fish_pager_color_selected_prefix b5b8b6 --bold --background=1d1e21
set -U fish_pager_color_selected_completion b5b8b6
...
# Set theme
set -Ux BASE24_THEME hybrid

# Optionally export variables
if test -n "$TINTED_SHELL_ENABLE_BASE24_VARS"; or test -n "$BASE24_SHELL_ENABLE_VARS"
  set -gx BASE24_COLOR_00_HEX "161718"
  set -gx BASE24_COLOR_01_HEX "2a2e33"
  set -gx BASE24_COLOR_02_HEX "1d1e21"
  set -gx BASE24_COLOR_03_HEX "434446"
  set -gx BASE24_COLOR_04_HEX "696b6b"
  set -gx BASE24_COLOR_05_HEX "8f9190"
  set -gx BASE24_COLOR_06_HEX "b5b8b6"
  set -gx BASE24_COLOR_07_HEX "5a6169"
  set -gx BASE24_COLOR_08_HEX "b74d50"
  set -gx BASE24_COLOR_09_HEX "e3b55e"
  set -gx BASE24_COLOR_0A_HEX "4b6b88"
  set -gx BASE24_COLOR_0B_HEX "b3be5a"
  set -gx BASE24_COLOR_0C_HEX "7fbeb3"
  set -gx BASE24_COLOR_0D_HEX "6d90b0"
  set -gx BASE24_COLOR_0E_HEX "a07eab"
  set -gx BASE24_COLOR_0F_HEX "5b2628"
end
