...
set -U fish_color_selection b5b8b6 --background=1d1e21
set -U fish_color_operator magenta
set -U fish_color_escape e3b55e
...
set -U fish_color_search_match yellow --background=1d1e21
set -U fish_color_history_current --underline=curly
set -U fish_pager_color_progress 2a2e33 --background=696b6b
set -U fish_pager_color_background --background=161718
set -U fish_pager_color_prefix --bold --italics
set -U fish_pager_color_completion normal
set -U fish_pager_color_description e3b55e
set -U fish_pager_color_selected_background --background=1d1e21
set -U fish_pager_color_selected_prefix --bold --italics --background=1d1e21
