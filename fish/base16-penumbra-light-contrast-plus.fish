...
set -l color01 "df/7f/78" # Base 08 - Red
set -l color02 "50/b5/84" # Base 0B - Green
set -l color03 "9c/a7/48" # Base 0A - Yellow
set -l color04 "61/a3/e6" # Base 0D - Blue
set -l color05 "a4/8f/e1" # Base 0E - Magenta
set -l color06 "00/b3/c2" # Base 0C - Cyan
set -l color07 "63/63/63" # Base 05 - White
set -l color08 "ce/ce/ce" # Base 03 - Bright Black
...
set -l color15 "18/1b/1f" # Base 07 - Bright White
set -l color16 "ce/90/42" # Base 09
set -l color17 "d0/80/b6" # Base 0F
set -l color18 "ff/f7/ed" # Base 01
set -l color19 "f2/e6/d4" # Base 02
set -l color20 "9e/9e/9e" # Base 04
set -l color21 "24/27/2b" # Base 06
...
set -U fish_color_param 9e9e9e
set -U fish_color_valid_path --underline
set -U fish_color_option brcyan
set -U fish_color_comment cecece
set -U fish_color_selection 24272b --bold --background=f2e6d4
set -U fish_color_operator brblue
set -U fish_color_escape brcyan
set -U fish_color_autosuggestion cecece
...
set -U fish_pager_color_progress fff7ed --background=9e9e9e
set -U fish_pager_color_background normal --background=fffdfb
set -U fish_pager_color_prefix normal --bold
set -U fish_pager_color_completion normal
set -U fish_pager_color_description ce9042 --dim
set -U fish_pager_color_selected_background 24272b --background=f2e6d4
set -U fish_pager_color_selected_prefix 24272b --bold --background=f2e6d4
set -U fish_pager_color_selected_completion 24272b
...
# Set theme
set -Ux BASE16_THEME penumbra-light-contrast-plus
...
if test -n "$TINTED_SHELL_ENABLE_BASE16_VARS"; or test -n "$BASE16_SHELL_ENABLE_VARS"
  ...
  set -gx BASE16_COLOR_03_HEX "cecece"
  set -gx BASE16_COLOR_04_HEX "9e9e9e"
  set -gx BASE16_COLOR_05_HEX "636363"
  set -gx BASE16_COLOR_06_HEX "24272b"
  set -gx BASE16_COLOR_07_HEX "181b1f"
  set -gx BASE16_COLOR_08_HEX "df7f78"
  set -gx BASE16_COLOR_09_HEX "ce9042"
  set -gx BASE16_COLOR_0A_HEX "9ca748"
  set -gx BASE16_COLOR_0B_HEX "50b584"
  set -gx BASE16_COLOR_0C_HEX "00b3c2"
  set -gx BASE16_COLOR_0D_HEX "61a3e6"
  set -gx BASE16_COLOR_0E_HEX "a48fe1"
  set -gx BASE16_COLOR_0F_HEX "d080b6"
end
