...
set -l color00 "00/10/15" # Base 00 - Black
...
set -l color16 "58/80/9c" # Base 09
set -l color17 "58/17/16" # Base 0F
set -l color18 "02/20/26" # Base 01
...
set -l color_background "00/10/15" # Base 00
...
set -U fish_color_end 3d5053
set -U fish_color_error brred
set -U fish_color_param 3b4c52
set -U fish_color_valid_path --underline
set -U fish_color_option brcyan
set -U fish_color_comment 394751
set -U fish_color_selection 405554 --bold --background=374350
...
set -U fish_color_search_match bryellow --background=374350
set -U fish_color_history_current --bold
set -U fish_pager_color_progress 022026 --background=3b4c52
set -U fish_pager_color_background normal --background=001015
set -U fish_pager_color_prefix normal --bold
set -U fish_pager_color_completion normal
set -U fish_pager_color_description 58809c --dim
set -U fish_pager_color_selected_background 405554 --background=374350
set -U fish_pager_color_selected_prefix 405554 --bold --background=374350
set -U fish_pager_color_selected_completion 405554
...
# Set theme
set -Ux BASE24_THEME under-the-sea

# Optionally export variables
if test -n "$TINTED_SHELL_ENABLE_BASE24_VARS"; or test -n "$BASE24_SHELL_ENABLE_VARS"
  set -gx BASE24_COLOR_00_HEX "001015"
  set -gx BASE24_COLOR_01_HEX "022026"
  ...
  set -gx BASE24_COLOR_09_HEX "58809c"
