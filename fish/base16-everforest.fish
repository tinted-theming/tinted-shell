...
set -l color19 "47/52/58" # Base 02
set -l color20 "9d/a9/a0" # Base 04
set -l color21 "e6/e2/cc" # Base 06
...
set -U fish_color_selection e6e2cc --bold --background=475258
...
set -U fish_color_search_match bryellow --background=475258
set -U fish_color_history_current --bold
set -U fish_pager_color_progress 343f44 --background=9da9a0
...
set -U fish_pager_color_selected_background e6e2cc --background=475258
set -U fish_pager_color_selected_prefix e6e2cc --bold --background=475258
set -U fish_pager_color_selected_completion e6e2cc
...
# Set theme
set -Ux BASE16_THEME everforest
...
if test -n "$TINTED_SHELL_ENABLE_BASE16_VARS"; or test -n "$BASE16_SHELL_ENABLE_VARS"
  ...
  set -gx BASE16_COLOR_02_HEX "475258"
  set -gx BASE16_COLOR_03_HEX "859289"
  set -gx BASE16_COLOR_04_HEX "9da9a0"
  set -gx BASE16_COLOR_05_HEX "d3c6aa"
  set -gx BASE16_COLOR_06_HEX "e6e2cc"
  set -gx BASE16_COLOR_07_HEX "fdf6e3"
