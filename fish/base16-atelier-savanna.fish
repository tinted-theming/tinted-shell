...
set -l color00 "17/1c/19" # Base 00 - Black
...
set -l color07 "87/92/8a" # Base 05 - White
set -l color08 "5f/6d/64" # Base 03 - Bright Black
...
set -l color15 "ec/f4/ee" # Base 07 - Bright White
set -l color16 "9f/71/3c" # Base 09
set -l color17 "86/74/69" # Base 0F
set -l color18 "23/2a/25" # Base 01
set -l color19 "52/60/57" # Base 02
set -l color20 "78/87/7d" # Base 04
set -l color21 "df/e7/e2" # Base 06
set -l color_foreground "87/92/8a" # Base 05
set -l color_background "17/1c/19" # Base 00
...
set -U fish_color_end 87928a
set -U fish_color_error brred
set -U fish_color_param 78877d
set -U fish_color_valid_path --underline
set -U fish_color_option brcyan
set -U fish_color_comment 5f6d64
set -U fish_color_selection dfe7e2 --bold --background=526057
set -U fish_color_operator brblue
set -U fish_color_escape brcyan
set -U fish_color_autosuggestion 5f6d64
...
set -U fish_pager_color_progress 232a25 --background=78877d
set -U fish_pager_color_background normal --background=171c19
set -U fish_pager_color_prefix normal --bold
set -U fish_pager_color_completion normal
set -U fish_pager_color_description 9f713c --dim
set -U fish_pager_color_selected_background dfe7e2 --background=526057
set -U fish_pager_color_selected_prefix dfe7e2 --bold --background=526057
set -U fish_pager_color_selected_completion dfe7e2
...
# Set theme
set -Ux BASE16_THEME atelier-savanna

# Optionally export variables
if test -n "$TINTED_SHELL_ENABLE_BASE16_VARS"; or test -n "$BASE16_SHELL_ENABLE_VARS"
  set -gx BASE16_COLOR_00_HEX "171c19"
  set -gx BASE16_COLOR_01_HEX "232a25"
  set -gx BASE16_COLOR_02_HEX "526057"
  set -gx BASE16_COLOR_03_HEX "5f6d64"
  set -gx BASE16_COLOR_04_HEX "78877d"
  set -gx BASE16_COLOR_05_HEX "87928a"
  set -gx BASE16_COLOR_06_HEX "dfe7e2"
  set -gx BASE16_COLOR_07_HEX "ecf4ee"
