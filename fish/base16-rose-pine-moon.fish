...
set -l color00 "23/21/36" # Base 00 - Black
set -l color01 "eb/6f/92" # Base 08 - Red
set -l color02 "3e/8f/b0" # Base 0B - Green
set -l color03 "ea/9a/97" # Base 0A - Yellow
set -l color04 "c4/a7/e7" # Base 0D - Blue
set -l color05 "f6/c1/77" # Base 0E - Magenta
set -l color06 "9c/cf/d8" # Base 0C - Cyan
set -l color07 "e0/de/f4" # Base 05 - White
set -l color08 "6e/6a/86" # Base 03 - Bright Black
...
set -l color15 "56/52/6e" # Base 07 - Bright White
set -l color16 "f6/c1/77" # Base 09
set -l color17 "56/52/6e" # Base 0F
set -l color18 "2a/27/3f" # Base 01
set -l color19 "39/35/52" # Base 02
set -l color20 "90/8c/aa" # Base 04
set -l color21 "e0/de/f4" # Base 06
set -l color_foreground "e0/de/f4" # Base 05
set -l color_background "23/21/36" # Base 00
...
set -U fish_pager_color_progress 2a273f --background=908caa
set -U fish_pager_color_background normal --background=232136
set -U fish_pager_color_prefix normal --bold
set -U fish_pager_color_completion normal
set -U fish_pager_color_description f6c177 --dim
set -U fish_pager_color_selected_background e0def4 --background=393552
set -U fish_pager_color_selected_prefix e0def4 --bold --background=393552
...
# Set theme
set -Ux BASE16_THEME rose-pine-moon

# Optionally export variables
if test -n "$TINTED_SHELL_ENABLE_BASE16_VARS"; or test -n "$BASE16_SHELL_ENABLE_VARS"
  set -gx BASE16_COLOR_00_HEX "232136"
  set -gx BASE16_COLOR_01_HEX "2a273f"
  set -gx BASE16_COLOR_02_HEX "393552"
  set -gx BASE16_COLOR_03_HEX "6e6a86"
  set -gx BASE16_COLOR_04_HEX "908caa"
  set -gx BASE16_COLOR_05_HEX "e0def4"
  set -gx BASE16_COLOR_06_HEX "e0def4"
  set -gx BASE16_COLOR_07_HEX "56526e"
  set -gx BASE16_COLOR_08_HEX "eb6f92"
  set -gx BASE16_COLOR_09_HEX "f6c177"
  set -gx BASE16_COLOR_0A_HEX "ea9a97"
  set -gx BASE16_COLOR_0B_HEX "3e8fb0"
  set -gx BASE16_COLOR_0C_HEX "9ccfd8"
  set -gx BASE16_COLOR_0D_HEX "c4a7e7"
  set -gx BASE16_COLOR_0E_HEX "f6c177"
  set -gx BASE16_COLOR_0F_HEX "56526e"
end
