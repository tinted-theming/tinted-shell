...
set -l color00 "12/26/37" # Base 00 - Black
set -l color01 "ff/00/00" # Base 08 - Red
set -l color02 "37/dd/21" # Base 0B - Green
set -l color03 "55/55/ff" # Base 0A - Yellow
set -l color04 "14/60/d2" # Base 0D - Blue
set -l color05 "ff/00/5d" # Base 0E - Magenta
...
set -l color16 "fe/e4/09" # Base 09
...
set -l color_background "12/26/37" # Base 00
...
set -U fish_pager_color_background normal --background=122637
set -U fish_pager_color_prefix normal --bold
set -U fish_pager_color_completion normal
set -U fish_pager_color_description fee409 --dim
...
if test -n "$TINTED_SHELL_ENABLE_BASE24_VARS"; or test -n "$BASE24_SHELL_ENABLE_VARS"
  ...
  set -gx BASE24_COLOR_09_HEX "fee409"
  set -gx BASE24_COLOR_0A_HEX "5555ff"
  set -gx BASE24_COLOR_0B_HEX "37dd21"
  set -gx BASE24_COLOR_0C_HEX "00bbbb"
  set -gx BASE24_COLOR_0D_HEX "1460d2"
  set -gx BASE24_COLOR_0E_HEX "ff005d"
