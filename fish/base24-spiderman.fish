...
set -l color01 "e6/07/12" # Base 08 - Red
set -l color02 "e2/28/28" # Base 0B - Green
set -l color03 "1d/4f/ff" # Base 0A - Yellow
set -l color04 "2b/3f/ff" # Base 0D - Blue
set -l color05 "24/35/db" # Base 0E - Magenta
set -l color06 "32/55/ff" # Base 0C - Cyan
set -l color07 "d3/d3/cd" # Base 05 - White
set -l color08 "7b/7d/7c" # Base 03 - Bright Black
...
set -l color15 "fe/ff/f9" # Base 07 - Bright White
set -l color16 "e2/46/55" # Base 09
set -l color17 "73/03/09" # Base 0F
set -l color18 "1b/1d/1e" # Base 01
set -l color19 "50/53/54" # Base 02
set -l color20 "a7/a8/a5" # Base 04
set -l color21 "ff/fe/f6" # Base 06
set -l color_foreground "d3/d3/cd" # Base 05
...
set -U fish_color_end d3d3cd
set -U fish_color_error brred
set -U fish_color_param a7a8a5
set -U fish_color_valid_path --underline
set -U fish_color_option brcyan
set -U fish_color_comment 7b7d7c
set -U fish_color_selection fffef6 --bold --background=505354
set -U fish_color_operator brblue
set -U fish_color_escape brcyan
set -U fish_color_autosuggestion 7b7d7c
...
set -U fish_pager_color_progress 1b1d1e --background=a7a8a5
set -U fish_pager_color_background normal --background=1b1d1e
set -U fish_pager_color_prefix normal --bold
set -U fish_pager_color_completion normal
set -U fish_pager_color_description e24655 --dim
set -U fish_pager_color_selected_background fffef6 --background=505354
set -U fish_pager_color_selected_prefix fffef6 --bold --background=505354
set -U fish_pager_color_selected_completion fffef6
...
if test -n "$TINTED_SHELL_ENABLE_BASE24_VARS"; or test -n "$BASE24_SHELL_ENABLE_VARS"
  ...
  set -gx BASE24_COLOR_03_HEX "7b7d7c"
  set -gx BASE24_COLOR_04_HEX "a7a8a5"
  set -gx BASE24_COLOR_05_HEX "d3d3cd"
  set -gx BASE24_COLOR_06_HEX "fffef6"
  set -gx BASE24_COLOR_07_HEX "fefff9"
  set -gx BASE24_COLOR_08_HEX "e60712"
  set -gx BASE24_COLOR_09_HEX "e24655"
  set -gx BASE24_COLOR_0A_HEX "1d4fff"
  set -gx BASE24_COLOR_0B_HEX "e22828"
  set -gx BASE24_COLOR_0C_HEX "3255ff"
  set -gx BASE24_COLOR_0D_HEX "2b3fff"
  set -gx BASE24_COLOR_0E_HEX "2435db"
  set -gx BASE24_COLOR_0F_HEX "730309"
end
