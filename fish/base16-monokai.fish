...
set -l color00 "27/28/22" # Base 00 - Black
set -l color01 "f9/26/72" # Base 08 - Red
set -l color02 "a6/e2/2e" # Base 0B - Green
set -l color03 "f4/bf/75" # Base 0A - Yellow
set -l color04 "66/d9/ef" # Base 0D - Blue
set -l color05 "ae/81/ff" # Base 0E - Magenta
set -l color06 "a1/ef/e4" # Base 0C - Cyan
set -l color07 "f8/f8/f2" # Base 05 - White
set -l color08 "75/71/5e" # Base 03 - Bright Black
...
set -l color15 "f9/f8/f5" # Base 07 - Bright White
set -l color16 "fd/97/1f" # Base 09
set -l color17 "cc/66/33" # Base 0F
set -l color18 "38/38/30" # Base 01
set -l color19 "49/48/3e" # Base 02
set -l color20 "a5/9f/85" # Base 04
set -l color21 "f5/f4/f1" # Base 06
set -l color_foreground "f8/f8/f2" # Base 05
set -l color_background "27/28/22" # Base 00
...
set -U fish_color_comment 75715e
set -U fish_color_selection f5f4f1 --bold --background=49483e
set -U fish_color_operator brblue
set -U fish_color_escape brcyan
set -U fish_color_autosuggestion 75715e
...
set -U fish_pager_color_progress 383830 --background=a59f85
set -U fish_pager_color_background normal --background=272822
set -U fish_pager_color_prefix normal --bold
set -U fish_pager_color_completion normal
set -U fish_pager_color_description fd971f --dim
set -U fish_pager_color_selected_background f5f4f1 --background=49483e
set -U fish_pager_color_selected_prefix f5f4f1 --bold --background=49483e
set -U fish_pager_color_selected_completion f5f4f1
...
# Set theme
set -Ux BASE16_THEME monokai

# Optionally export variables
if test -n "$TINTED_SHELL_ENABLE_BASE16_VARS"; or test -n "$BASE16_SHELL_ENABLE_VARS"
  set -gx BASE16_COLOR_00_HEX "272822"
  set -gx BASE16_COLOR_01_HEX "383830"
  set -gx BASE16_COLOR_02_HEX "49483e"
  set -gx BASE16_COLOR_03_HEX "75715e"
  set -gx BASE16_COLOR_04_HEX "a59f85"
  set -gx BASE16_COLOR_05_HEX "f8f8f2"
  set -gx BASE16_COLOR_06_HEX "f5f4f1"
  set -gx BASE16_COLOR_07_HEX "f9f8f5"
  set -gx BASE16_COLOR_08_HEX "f92672"
  set -gx BASE16_COLOR_09_HEX "fd971f"
  set -gx BASE16_COLOR_0A_HEX "f4bf75"
  set -gx BASE16_COLOR_0B_HEX "a6e22e"
  set -gx BASE16_COLOR_0C_HEX "a1efe4"
  set -gx BASE16_COLOR_0D_HEX "66d9ef"
  set -gx BASE16_COLOR_0E_HEX "ae81ff"
  set -gx BASE16_COLOR_0F_HEX "cc6633"
end
