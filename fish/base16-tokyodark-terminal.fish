...
set -l color00 "11/12/1d" # Base 00 - Black
set -l color01 "ee/6d/85" # Base 08 - Red
set -l color02 "95/c5/61" # Base 0B - Green
set -l color03 "d7/a6/5f" # Base 0A - Yellow
set -l color04 "71/99/ee" # Base 0D - Blue
set -l color05 "a4/85/dd" # Base 0E - Magenta
set -l color06 "38/a8/9d" # Base 0C - Cyan
set -l color07 "a0/a8/cd" # Base 05 - White
set -l color08 "28/2c/34" # Base 03 - Bright Black
...
set -l color15 "a0/a8/cd" # Base 07 - Bright White
set -l color16 "f6/95/5b" # Base 09
set -l color17 "77/34/40" # Base 0F
set -l color18 "1a/1b/2a" # Base 01
set -l color19 "21/22/34" # Base 02
set -l color20 "4a/50/57" # Base 04
set -l color21 "a0/a8/cd" # Base 06
set -l color_foreground "a0/a8/cd" # Base 05
set -l color_background "11/12/1d" # Base 00
...
set -U fish_color_end a0a8cd
set -U fish_color_error brred
set -U fish_color_param 4a5057
set -U fish_color_valid_path --underline
set -U fish_color_option brcyan
set -U fish_color_comment 282c34
set -U fish_color_selection a0a8cd --bold --background=212234
set -U fish_color_operator brblue
set -U fish_color_escape brcyan
set -U fish_color_autosuggestion 282c34
...
set -U fish_color_search_match bryellow --background=212234
set -U fish_color_history_current --bold
set -U fish_pager_color_progress 1a1b2a --background=4a5057
set -U fish_pager_color_background normal --background=11121d
set -U fish_pager_color_prefix normal --bold
set -U fish_pager_color_completion normal
set -U fish_pager_color_description f6955b --dim
set -U fish_pager_color_selected_background a0a8cd --background=212234
set -U fish_pager_color_selected_prefix a0a8cd --bold --background=212234
set -U fish_pager_color_selected_completion a0a8cd
...
# Set theme
set -Ux BASE16_THEME tokyodark-terminal

# Optionally export variables
if test -n "$TINTED_SHELL_ENABLE_BASE16_VARS"; or test -n "$BASE16_SHELL_ENABLE_VARS"
  set -gx BASE16_COLOR_00_HEX "11121d"
  set -gx BASE16_COLOR_01_HEX "1a1b2a"
  set -gx BASE16_COLOR_02_HEX "212234"
  set -gx BASE16_COLOR_03_HEX "282c34"
  set -gx BASE16_COLOR_04_HEX "4a5057"
  set -gx BASE16_COLOR_05_HEX "a0a8cd"
  set -gx BASE16_COLOR_06_HEX "a0a8cd"
  set -gx BASE16_COLOR_07_HEX "a0a8cd"
  set -gx BASE16_COLOR_08_HEX "ee6d85"
  set -gx BASE16_COLOR_09_HEX "f6955b"
  set -gx BASE16_COLOR_0A_HEX "d7a65f"
  set -gx BASE16_COLOR_0B_HEX "95c561"
  set -gx BASE16_COLOR_0C_HEX "38a89d"
  set -gx BASE16_COLOR_0D_HEX "7199ee"
  set -gx BASE16_COLOR_0E_HEX "a485dd"
  set -gx BASE16_COLOR_0F_HEX "773440"
end
