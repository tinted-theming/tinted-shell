...
set -U fish_color_selection 3f4141 --background=cbcdcd
set -U fish_color_operator magenta
set -U fish_color_escape daaa01
...
set -U fish_color_search_match yellow --background=cbcdcd
...
set -U fish_pager_color_description daaa01
set -U fish_pager_color_selected_background --background=cbcdcd
set -U fish_pager_color_selected_prefix --bold --italics --background=cbcdcd
