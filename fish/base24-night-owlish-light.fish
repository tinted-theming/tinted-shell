...
set -l color01 "d3/42/3e" # Base 08 - Red
set -l color02 "2a/a2/98" # Base 0B - Green
set -l color03 "da/c8/01" # Base 0A - Yellow
set -l color04 "48/76/d6" # Base 0D - Blue
set -l color05 "40/3f/53" # Base 0E - Magenta
set -l color06 "08/91/6a" # Base 0C - Cyan
set -l color07 "58/5b/5b" # Base 05 - White
set -l color08 "b1/b4/b4" # Base 03 - Bright Black
...
set -l color15 "01/16/27" # Base 07 - Bright White
set -l color16 "da/aa/01" # Base 09
set -l color17 "69/21/1f" # Base 0F
set -l color18 "e5/e6/e6" # Base 01
set -l color19 "cb/cd/cd" # Base 02
set -l color20 "71/75/75" # Base 04
set -l color21 "3f/41/41" # Base 06
set -l color_foreground "58/5b/5b" # Base 05
...
set -U fish_color_end 585b5b
set -U fish_color_error brred
set -U fish_color_param 717575
set -U fish_color_valid_path --underline
set -U fish_color_option brcyan
set -U fish_color_comment b1b4b4
set -U fish_color_selection 3f4141 --bold --background=cbcdcd
set -U fish_color_operator brblue
set -U fish_color_escape brcyan
set -U fish_color_autosuggestion b1b4b4
...
set -U fish_color_search_match bryellow --background=cbcdcd
set -U fish_color_history_current --bold
set -U fish_pager_color_progress e5e6e6 --background=717575
set -U fish_pager_color_background normal --background=ffffff
set -U fish_pager_color_prefix normal --bold
set -U fish_pager_color_completion normal
set -U fish_pager_color_description daaa01 --dim
set -U fish_pager_color_selected_background 3f4141 --background=cbcdcd
set -U fish_pager_color_selected_prefix 3f4141 --bold --background=cbcdcd
set -U fish_pager_color_selected_completion 3f4141
...
# Set theme
set -Ux BASE24_THEME night-owlish-light

# Optionally export variables
if test -n "$TINTED_SHELL_ENABLE_BASE24_VARS"; or test -n "$BASE24_SHELL_ENABLE_VARS"
  set -gx BASE24_COLOR_00_HEX "ffffff"
  set -gx BASE24_COLOR_01_HEX "e5e6e6"
  set -gx BASE24_COLOR_02_HEX "cbcdcd"
  set -gx BASE24_COLOR_03_HEX "b1b4b4"
  set -gx BASE24_COLOR_04_HEX "717575"
  set -gx BASE24_COLOR_05_HEX "585b5b"
  set -gx BASE24_COLOR_06_HEX "3f4141"
  set -gx BASE24_COLOR_07_HEX "011627"
  set -gx BASE24_COLOR_08_HEX "d3423e"
  set -gx BASE24_COLOR_09_HEX "daaa01"
  set -gx BASE24_COLOR_0A_HEX "dac801"
  set -gx BASE24_COLOR_0B_HEX "2aa298"
  set -gx BASE24_COLOR_0C_HEX "08916a"
  set -gx BASE24_COLOR_0D_HEX "4876d6"
  set -gx BASE24_COLOR_0E_HEX "403f53"
  set -gx BASE24_COLOR_0F_HEX "69211f"
end
