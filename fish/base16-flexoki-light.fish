...
set -U fish_color_end 403e3c
set -U fish_color_error brred
set -U fish_color_param 9f9d96
set -U fish_color_valid_path --underline
set -U fish_color_option brcyan
set -U fish_color_comment cecdc3
set -U fish_color_selection 282726 --bold --background=e6e4d9
...
set -U fish_color_search_match bryellow --background=e6e4d9
set -U fish_color_history_current --bold
set -U fish_pager_color_progress f2f0e5 --background=9f9d96
set -U fish_pager_color_background normal --background=fffcf0
set -U fish_pager_color_prefix normal --bold
set -U fish_pager_color_completion normal
set -U fish_pager_color_description bc5215 --dim
set -U fish_pager_color_selected_background 282726 --background=e6e4d9
set -U fish_pager_color_selected_prefix 282726 --bold --background=e6e4d9
set -U fish_pager_color_selected_completion 282726
...
# Set theme
set -Ux BASE16_THEME flexoki-light

# Optionally export variables
if test -n "$TINTED_SHELL_ENABLE_BASE16_VARS"; or test -n "$BASE16_SHELL_ENABLE_VARS"
  set -gx BASE16_COLOR_00_HEX "fffcf0"
  set -gx BASE16_COLOR_01_HEX "f2f0e5"
  set -gx BASE16_COLOR_02_HEX "e6e4d9"
  set -gx BASE16_COLOR_03_HEX "cecdc3"
  set -gx BASE16_COLOR_04_HEX "9f9d96"
  set -gx BASE16_COLOR_05_HEX "403e3c"
  set -gx BASE16_COLOR_06_HEX "282726"
  set -gx BASE16_COLOR_07_HEX "100f0f"
  set -gx BASE16_COLOR_08_HEX "af3029"
  set -gx BASE16_COLOR_09_HEX "bc5215"
  set -gx BASE16_COLOR_0A_HEX "ad8301"
  set -gx BASE16_COLOR_0B_HEX "66800b"
  set -gx BASE16_COLOR_0C_HEX "24837b"
  set -gx BASE16_COLOR_0D_HEX "205ea6"
  set -gx BASE16_COLOR_0E_HEX "5e409d"
  set -gx BASE16_COLOR_0F_HEX "a02f6f"
end
