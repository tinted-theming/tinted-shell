...
set -l color00 "0f/0f/0f" # Base 00 - Black
set -l color01 "ac/8a/8c" # Base 08 - Red
set -l color02 "8a/ac/8b" # Base 0B - Green
set -l color03 "ac/a9/8a" # Base 0A - Yellow
set -l color04 "8f/8a/ac" # Base 0D - Blue
set -l color05 "ac/8a/ac" # Base 0E - Magenta
set -l color06 "8a/ab/ac" # Base 0C - Cyan
set -l color07 "ca/ca/ca" # Base 05 - White
set -l color08 "39/39/39" # Base 03 - Bright Black
...
set -l color15 "f0/f0/f0" # Base 07 - Bright White
set -l color16 "ce/b1/88" # Base 09
set -l color17 "ac/8a/8c" # Base 0F
set -l color18 "19/19/19" # Base 01
set -l color19 "26/26/26" # Base 02
set -l color20 "4c/4c/4c" # Base 04
set -l color21 "e7/e7/e7" # Base 06
set -l color_foreground "ca/ca/ca" # Base 05
set -l color_background "0f/0f/0f" # Base 00
...
set -U fish_color_param 4c4c4c
set -U fish_color_valid_path --underline
set -U fish_color_option brcyan
set -U fish_color_comment 393939
set -U fish_color_selection e7e7e7 --bold --background=262626
set -U fish_color_operator brblue
set -U fish_color_escape brcyan
set -U fish_color_autosuggestion 393939
...
set -U fish_pager_color_progress 191919 --background=4c4c4c
set -U fish_pager_color_background normal --background=0f0f0f
set -U fish_pager_color_prefix normal --bold
set -U fish_pager_color_completion normal
set -U fish_pager_color_description ceb188 --dim
set -U fish_pager_color_selected_background e7e7e7 --background=262626
set -U fish_pager_color_selected_prefix e7e7e7 --bold --background=262626
set -U fish_pager_color_selected_completion e7e7e7
...
# Set theme
set -Ux BASE16_THEME mountain

# Optionally export variables
if test -n "$TINTED_SHELL_ENABLE_BASE16_VARS"; or test -n "$BASE16_SHELL_ENABLE_VARS"
  set -gx BASE16_COLOR_00_HEX "0f0f0f"
  set -gx BASE16_COLOR_01_HEX "191919"
  set -gx BASE16_COLOR_02_HEX "262626"
  set -gx BASE16_COLOR_03_HEX "393939"
  set -gx BASE16_COLOR_04_HEX "4c4c4c"
  set -gx BASE16_COLOR_05_HEX "cacaca"
  set -gx BASE16_COLOR_06_HEX "e7e7e7"
  set -gx BASE16_COLOR_07_HEX "f0f0f0"
  set -gx BASE16_COLOR_08_HEX "ac8a8c"
  set -gx BASE16_COLOR_09_HEX "ceb188"
  set -gx BASE16_COLOR_0A_HEX "aca98a"
  set -gx BASE16_COLOR_0B_HEX "8aac8b"
  set -gx BASE16_COLOR_0C_HEX "8aabac"
  set -gx BASE16_COLOR_0D_HEX "8f8aac"
  set -gx BASE16_COLOR_0E_HEX "ac8aac"
  set -gx BASE16_COLOR_0F_HEX "ac8a8c"
end
