...
set -l color01 "c4/1a/15" # Base 08 - Red
set -l color02 "00/74/00" # Base 0B - Green
set -l color03 "82/6b/28" # Base 0A - Yellow
set -l color04 "00/00/ff" # Base 0D - Blue
set -l color05 "a9/0d/91" # Base 0E - Magenta
set -l color06 "31/84/95" # Base 0C - Cyan
set -l color07 "40/40/40" # Base 05 - White
...
set -l color15 "5e/5e/5e" # Base 07 - Bright White
set -l color16 "eb/85/00" # Base 09
set -l color17 "82/6b/28" # Base 0F
set -l color18 "c0/c0/c0" # Base 01
set -l color19 "c0/c0/c0" # Base 02
set -l color20 "80/80/80" # Base 04
set -l color21 "40/40/40" # Base 06
set -l color_foreground "40/40/40" # Base 05
...
set -U fish_pager_color_progress c0c0c0 --background=808080
set -U fish_pager_color_background normal --background=ffffff
set -U fish_pager_color_prefix normal --bold
set -U fish_pager_color_completion normal
set -U fish_pager_color_description eb8500 --dim
set -U fish_pager_color_selected_background 404040 --background=c0c0c0
set -U fish_pager_color_selected_prefix 404040 --bold --background=c0c0c0
set -U fish_pager_color_selected_completion 404040
...
# Set theme
set -Ux BASE16_THEME cupertino

# Optionally export variables
if test -n "$TINTED_SHELL_ENABLE_BASE16_VARS"; or test -n "$BASE16_SHELL_ENABLE_VARS"
  set -gx BASE16_COLOR_00_HEX "ffffff"
  set -gx BASE16_COLOR_01_HEX "c0c0c0"
  set -gx BASE16_COLOR_02_HEX "c0c0c0"
  set -gx BASE16_COLOR_03_HEX "808080"
  set -gx BASE16_COLOR_04_HEX "808080"
  set -gx BASE16_COLOR_05_HEX "404040"
  set -gx BASE16_COLOR_06_HEX "404040"
  set -gx BASE16_COLOR_07_HEX "5e5e5e"
  set -gx BASE16_COLOR_08_HEX "c41a15"
  set -gx BASE16_COLOR_09_HEX "eb8500"
  set -gx BASE16_COLOR_0A_HEX "826b28"
  set -gx BASE16_COLOR_0B_HEX "007400"
  set -gx BASE16_COLOR_0C_HEX "318495"
  set -gx BASE16_COLOR_0D_HEX "0000ff"
  set -gx BASE16_COLOR_0E_HEX "a90d91"
  set -gx BASE16_COLOR_0F_HEX "826b28"
end
