...
# Set theme
set -Ux BASE24_THEME tokyo-night-dark

# Optionally export variables
if test -n "$TINTED_SHELL_ENABLE_BASE24_VARS"; or test -n "$BASE24_SHELL_ENABLE_VARS"
  set -gx BASE24_COLOR_00_HEX "1a1b26"
  set -gx BASE24_COLOR_01_HEX "16161e"
  set -gx BASE24_COLOR_02_HEX "2f3549"
  set -gx BASE24_COLOR_03_HEX "444b6a"
  set -gx BASE24_COLOR_04_HEX "787c99"
  set -gx BASE24_COLOR_05_HEX "a9b1d6"
  set -gx BASE24_COLOR_06_HEX "cbccd1"
  set -gx BASE24_COLOR_07_HEX "d5d6db"
  set -gx BASE24_COLOR_08_HEX "c0caf5"
  set -gx BASE24_COLOR_09_HEX "a9b1d6"
  set -gx BASE24_COLOR_0A_HEX "0db9d7"
  set -gx BASE24_COLOR_0B_HEX "9ece6a"
  set -gx BASE24_COLOR_0C_HEX "b4f9f8"
  set -gx BASE24_COLOR_0D_HEX "2ac3de"
  set -gx BASE24_COLOR_0E_HEX "bb9af7"
  set -gx BASE24_COLOR_0F_HEX "f7768e"
end
