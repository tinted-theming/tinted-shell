...
set -l color01 "eb/00/8a" # Base 08 - Red
set -l color02 "37/b3/49" # Base 0B - Green
set -l color03 "f8/ca/12" # Base 0A - Yellow
set -l color04 "0e/5a/94" # Base 0D - Blue
set -l color05 "b3/1e/8d" # Base 0E - Magenta
set -l color06 "00/aa/bb" # Base 0C - Cyan
...
set -l color16 "f2/93/33" # Base 09
set -l color17 "7a/2d/00" # Base 0F
...
set -U fish_pager_color_description f29333 --dim
...
if test -n "$TINTED_SHELL_ENABLE_BASE16_VARS"; or test -n "$BASE16_SHELL_ENABLE_VARS"
  ...
  set -gx BASE16_COLOR_08_HEX "eb008a"
  set -gx BASE16_COLOR_09_HEX "f29333"
  set -gx BASE16_COLOR_0A_HEX "f8ca12"
  set -gx BASE16_COLOR_0B_HEX "37b349"
  set -gx BASE16_COLOR_0C_HEX "00aabb"
  set -gx BASE16_COLOR_0D_HEX "0e5a94"
  set -gx BASE16_COLOR_0E_HEX "b31e8d"
  set -gx BASE16_COLOR_0F_HEX "7a2d00"
end
