...
set -U fish_color_selection abb9c4 --background=4d606f
set -U fish_color_operator magenta
set -U fish_color_escape f2db78
...
set -U fish_color_search_match yellow --background=4d606f
set -U fish_color_history_current --underline=curly
set -U fish_pager_color_progress 3b4954 --background=788ea1
set -U fish_pager_color_background --background=283139
set -U fish_pager_color_prefix --bold --italics
set -U fish_pager_color_completion normal
set -U fish_pager_color_description f2db78
set -U fish_pager_color_selected_background --background=4d606f
set -U fish_pager_color_selected_prefix --bold --italics --background=4d606f
