...
set -l color00 "28/31/39" # Base 00 - Black
set -l color01 "ef/a9/a9" # Base 08 - Red
set -l color02 "8c/d4/b0" # Base 0B - Green
set -l color03 "e0/b8/8a" # Base 0A - Yellow
set -l color04 "a2/c5/fd" # Base 0D - Blue
set -l color05 "cc/b7/db" # Base 0E - Magenta
set -l color06 "93/df/ec" # Base 0C - Cyan
set -l color07 "93/a5/b4" # Base 05 - White
set -l color08 "60/77/8a" # Base 03 - Bright Black
...
set -l color15 "e7/eb/ee" # Base 07 - Bright White
set -l color16 "f2/db/78" # Base 09
set -l color17 "8e/9e/cb" # Base 0F
set -l color18 "3b/49/54" # Base 01
set -l color19 "4d/60/6f" # Base 02
set -l color20 "78/8e/a1" # Base 04
set -l color21 "ab/b9/c4" # Base 06
set -l color_foreground "93/a5/b4" # Base 05
set -l color_background "28/31/39" # Base 00
...
set -U fish_color_end 93a5b4
set -U fish_color_error brred
set -U fish_color_param 788ea1
set -U fish_color_valid_path --underline
set -U fish_color_option brcyan
set -U fish_color_comment 60778a
set -U fish_color_selection abb9c4 --bold --background=4d606f
set -U fish_color_operator brblue
set -U fish_color_escape brcyan
set -U fish_color_autosuggestion 60778a
...
set -U fish_color_search_match bryellow --background=4d606f
set -U fish_color_history_current --bold
set -U fish_pager_color_progress 3b4954 --background=788ea1
set -U fish_pager_color_background normal --background=283139
set -U fish_pager_color_prefix normal --bold
set -U fish_pager_color_completion normal
set -U fish_pager_color_description f2db78 --dim
set -U fish_pager_color_selected_background abb9c4 --background=4d606f
set -U fish_pager_color_selected_prefix abb9c4 --bold --background=4d606f
set -U fish_pager_color_selected_completion abb9c4
...
# Set theme
set -Ux BASE24_THEME mission-brogue

# Optionally export variables
if test -n "$TINTED_SHELL_ENABLE_BASE24_VARS"; or test -n "$BASE24_SHELL_ENABLE_VARS"
  set -gx BASE24_COLOR_00_HEX "283139"
  set -gx BASE24_COLOR_01_HEX "3b4954"
  set -gx BASE24_COLOR_02_HEX "4d606f"
  set -gx BASE24_COLOR_03_HEX "60778a"
  set -gx BASE24_COLOR_04_HEX "788ea1"
  set -gx BASE24_COLOR_05_HEX "93a5b4"
  set -gx BASE24_COLOR_06_HEX "abb9c4"
  set -gx BASE24_COLOR_07_HEX "e7ebee"
  set -gx BASE24_COLOR_08_HEX "efa9a9"
  set -gx BASE24_COLOR_09_HEX "f2db78"
  set -gx BASE24_COLOR_0A_HEX "e0b88a"
  set -gx BASE24_COLOR_0B_HEX "8cd4b0"
  set -gx BASE24_COLOR_0C_HEX "93dfec"
  set -gx BASE24_COLOR_0D_HEX "a2c5fd"
  set -gx BASE24_COLOR_0E_HEX "ccb7db"
  set -gx BASE24_COLOR_0F_HEX "8e9ecb"
end
