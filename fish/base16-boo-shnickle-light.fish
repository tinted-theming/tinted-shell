...
set -l color15 "19/19/14" # Base 07 - Bright White
set -l color16 "ff/dc/99" # Base 09
set -l color17 "e5/d6/a6" # Base 0F
set -l color18 "de/de/b2" # Base 01
set -l color19 "bd/bd/97" # Base 02
set -l color20 "7c/7c/63" # Base 04
set -l color21 "3a/3a/2e" # Base 06
set -l color_foreground "5b/5b/49" # Base 05
set -l color_background "ff/ff/cc" # Base 00
...
if test -n "$ITERM_SESSION_ID"
  put_template_custom Pg 5b5b49 # foreground
  put_template_custom Ph ffffcc # background
  put_template_custom Pi 5b5b49 # bold color
  put_template_custom Pj bdbd97 # selection color
  put_template_custom Pk 5b5b49 # selected text color
  put_template_custom Pl 5b5b49 # cursor
  put_template_custom Pm ffffcc # cursor text
else
...
set -U fish_color_end 5b5b49
set -U fish_color_error brred
set -U fish_color_param 7c7c63
set -U fish_color_valid_path --underline
set -U fish_color_option brcyan
set -U fish_color_comment 9c9c7d
set -U fish_color_selection 3a3a2e --bold --background=bdbd97
set -U fish_color_operator brblue
set -U fish_color_escape brcyan
set -U fish_color_autosuggestion 9c9c7d
...
set -U fish_color_search_match bryellow --background=bdbd97
set -U fish_color_history_current --bold
set -U fish_pager_color_progress dedeb2 --background=7c7c63
set -U fish_pager_color_background normal --background=ffffcc
set -U fish_pager_color_prefix normal --bold
set -U fish_pager_color_completion normal
set -U fish_pager_color_description ffdc99 --dim
set -U fish_pager_color_selected_background 3a3a2e --background=bdbd97
set -U fish_pager_color_selected_prefix 3a3a2e --bold --background=bdbd97
set -U fish_pager_color_selected_completion 3a3a2e
...
# Set theme
set -Ux BASE16_THEME boo-shnickle-light

# Optionally export variables
if test -n "$TINTED_SHELL_ENABLE_BASE16_VARS"; or test -n "$BASE16_SHELL_ENABLE_VARS"
  set -gx BASE16_COLOR_00_HEX "ffffcc"
  set -gx BASE16_COLOR_01_HEX "dedeb2"
  set -gx BASE16_COLOR_02_HEX "bdbd97"
  set -gx BASE16_COLOR_03_HEX "9c9c7d"
  set -gx BASE16_COLOR_04_HEX "7c7c63"
  set -gx BASE16_COLOR_05_HEX "5b5b49"
  set -gx BASE16_COLOR_06_HEX "3a3a2e"
  set -gx BASE16_COLOR_07_HEX "191914"
  ...
  set -gx BASE16_COLOR_0D_HEX "bfbfd9"
