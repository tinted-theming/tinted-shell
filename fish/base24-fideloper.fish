...
set -U fish_color_end b1b1a3
set -U fish_color_error brred
set -U fish_color_param 79817a
set -U fish_color_valid_path --underline
set -U fish_color_option brcyan
set -U fish_color_comment 415050
set -U fish_color_selection e9e2cd --bold --background=092027
...
set -U fish_color_search_match bryellow --background=092027
set -U fish_color_history_current --bold
set -U fish_pager_color_progress 282f32 --background=79817a
set -U fish_pager_color_background normal --background=282f32
set -U fish_pager_color_prefix normal --bold
set -U fish_pager_color_completion normal
set -U fish_pager_color_description b7aa9a --dim
set -U fish_pager_color_selected_background e9e2cd --background=092027
set -U fish_pager_color_selected_prefix e9e2cd --bold --background=092027
set -U fish_pager_color_selected_completion e9e2cd
