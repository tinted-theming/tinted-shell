...
set -l color00 "29/2a/44" # Base 00 - Black
set -l color01 "dd/76/55" # Base 08 - Red
set -l color02 "04/db/b4" # Base 0B - Green
set -l color03 "69/bf/fa" # Base 0A - Yellow
set -l color04 "7a/a5/ff" # Base 0D - Blue
set -l color05 "be/9b/f8" # Base 0E - Magenta
set -l color06 "56/d3/c1" # Base 0C - Cyan
set -l color07 "c3/c3/d4" # Base 05 - White
set -l color08 "85/85/ac" # Base 03 - Bright Black
...
set -l color15 "f3/f2/f8" # Base 07 - Bright White
set -l color16 "f2/e7/b7" # Base 09
set -l color17 "6e/3b/2a" # Base 0F
set -l color18 "12/13/1d" # Base 01
set -l color19 "66/66/99" # Base 02
set -l color20 "a4/a4/c0" # Base 04
set -l color21 "e3/e2/e8" # Base 06
set -l color_foreground "c3/c3/d4" # Base 05
set -l color_background "29/2a/44" # Base 00
...
set -U fish_color_end c3c3d4
set -U fish_color_error brred
set -U fish_color_param a4a4c0
set -U fish_color_valid_path --underline
set -U fish_color_option brcyan
set -U fish_color_comment 8585ac
set -U fish_color_selection e3e2e8 --bold --background=666699
set -U fish_color_operator brblue
set -U fish_color_escape brcyan
set -U fish_color_autosuggestion 8585ac
...
set -U fish_color_search_match bryellow --background=666699
set -U fish_color_history_current --bold
set -U fish_pager_color_progress 12131d --background=a4a4c0
set -U fish_pager_color_background normal --background=292a44
set -U fish_pager_color_prefix normal --bold
set -U fish_pager_color_completion normal
set -U fish_pager_color_description f2e7b7 --dim
set -U fish_pager_color_selected_background e3e2e8 --background=666699
set -U fish_pager_color_selected_prefix e3e2e8 --bold --background=666699
set -U fish_pager_color_selected_completion e3e2e8
...
# Set theme
set -Ux BASE24_THEME rebecca

# Optionally export variables
if test -n "$TINTED_SHELL_ENABLE_BASE24_VARS"; or test -n "$BASE24_SHELL_ENABLE_VARS"
  set -gx BASE24_COLOR_00_HEX "292a44"
  set -gx BASE24_COLOR_01_HEX "12131d"
  set -gx BASE24_COLOR_02_HEX "666699"
  set -gx BASE24_COLOR_03_HEX "8585ac"
  set -gx BASE24_COLOR_04_HEX "a4a4c0"
  set -gx BASE24_COLOR_05_HEX "c3c3d4"
  set -gx BASE24_COLOR_06_HEX "e3e2e8"
  set -gx BASE24_COLOR_07_HEX "f3f2f8"
  set -gx BASE24_COLOR_08_HEX "dd7655"
  set -gx BASE24_COLOR_09_HEX "f2e7b7"
  set -gx BASE24_COLOR_0A_HEX "69bffa"
  set -gx BASE24_COLOR_0B_HEX "04dbb4"
  set -gx BASE24_COLOR_0C_HEX "56d3c1"
  set -gx BASE24_COLOR_0D_HEX "7aa5ff"
  set -gx BASE24_COLOR_0E_HEX "be9bf8"
  set -gx BASE24_COLOR_0F_HEX "6e3b2a"
end
