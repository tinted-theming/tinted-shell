...
set -l color00 "0e/0e/0e" # Base 00 - Black
set -l color01 "cd/31/31" # Base 08 - Red
set -l color02 "0d/bc/79" # Base 0B - Green
set -l color03 "3b/8e/ea" # Base 0A - Yellow
set -l color04 "24/72/c8" # Base 0D - Blue
set -l color05 "bc/3f/bc" # Base 0E - Magenta
set -l color06 "11/a8/cd" # Base 0C - Cyan
...
set -l color16 "e5/e5/10" # Base 09
set -l color17 "66/18/18" # Base 0F
set -l color18 "00/00/00" # Base 01
set -l color19 "66/66/66" # Base 02
set -l color20 "a5/a5/a5" # Base 04
set -l color21 "e5/e5/e5" # Base 06
set -l color_foreground "c5/c5/c5" # Base 05
set -l color_background "0e/0e/0e" # Base 00
...
set -U fish_color_param a5a5a5
set -U fish_color_valid_path --underline
set -U fish_color_option brcyan
set -U fish_color_comment 858585
set -U fish_color_selection e5e5e5 --bold --background=666666
...
set -U fish_color_search_match bryellow --background=666666
set -U fish_color_history_current --bold
set -U fish_pager_color_progress 000000 --background=a5a5a5
set -U fish_pager_color_background normal --background=0e0e0e
set -U fish_pager_color_prefix normal --bold
set -U fish_pager_color_completion normal
set -U fish_pager_color_description e5e510 --dim
set -U fish_pager_color_selected_background e5e5e5 --background=666666
set -U fish_pager_color_selected_prefix e5e5e5 --bold --background=666666
set -U fish_pager_color_selected_completion e5e5e5
...
# Set theme
set -Ux BASE24_THEME dark-plus

# Optionally export variables
if test -n "$TINTED_SHELL_ENABLE_BASE24_VARS"; or test -n "$BASE24_SHELL_ENABLE_VARS"
  set -gx BASE24_COLOR_00_HEX "0e0e0e"
  set -gx BASE24_COLOR_01_HEX "000000"
  set -gx BASE24_COLOR_02_HEX "666666"
  set -gx BASE24_COLOR_03_HEX "858585"
  set -gx BASE24_COLOR_04_HEX "a5a5a5"
  set -gx BASE24_COLOR_05_HEX "c5c5c5"
  set -gx BASE24_COLOR_06_HEX "e5e5e5"
  set -gx BASE24_COLOR_07_HEX "e5e5e5"
  set -gx BASE24_COLOR_08_HEX "cd3131"
  set -gx BASE24_COLOR_09_HEX "e5e510"
  set -gx BASE24_COLOR_0A_HEX "3b8eea"
  set -gx BASE24_COLOR_0B_HEX "0dbc79"
  set -gx BASE24_COLOR_0C_HEX "11a8cd"
  set -gx BASE24_COLOR_0D_HEX "2472c8"
  set -gx BASE24_COLOR_0E_HEX "bc3fbc"
  set -gx BASE24_COLOR_0F_HEX "661818"
end
