...
set -U fish_color_selection e5e5e5 --background=666666
set -U fish_color_operator magenta
set -U fish_color_escape e5e510
...
set -U fish_pager_color_background --background=0e0e0e
set -U fish_pager_color_prefix --bold --italics
set -U fish_pager_color_completion normal
set -U fish_pager_color_description e5e510
