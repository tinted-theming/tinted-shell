...
set -l color00 "06/12/29" # Base 00 - Black
set -l color01 "d0/73/46" # Base 08 - Red
set -l color02 "99/bf/52" # Base 0B - Green
set -l color03 "fb/d4/61" # Base 0A - Yellow
set -l color04 "52/99/bf" # Base 0D - Blue
set -l color05 "99/89/cc" # Base 0E - Magenta
set -l color06 "72/b9/bf" # Base 0C - Cyan
set -l color07 "b8/bb/c2" # Base 05 - White
set -l color08 "71/78/85" # Base 03 - Bright Black
...
set -l color16 "f0/a0/00" # Base 09
set -l color17 "b0/80/60" # Base 0F
set -l color18 "2a/34/48" # Base 01
set -l color19 "4d/56/66" # Base 02
set -l color20 "9a/99/a3" # Base 04
set -l color21 "db/dd/e0" # Base 06
set -l color_foreground "b8/bb/c2" # Base 05
set -l color_background "06/12/29" # Base 00
...
set -U fish_color_end b8bbc2
set -U fish_color_error brred
set -U fish_color_param 9a99a3
set -U fish_color_valid_path --underline
set -U fish_color_option brcyan
set -U fish_color_comment 717885
set -U fish_color_selection dbdde0 --bold --background=4d5666
set -U fish_color_operator brblue
set -U fish_color_escape brcyan
set -U fish_color_autosuggestion 717885
...
set -U fish_pager_color_progress 2a3448 --background=9a99a3
set -U fish_pager_color_background normal --background=061229
set -U fish_pager_color_prefix normal --bold
set -U fish_pager_color_completion normal
set -U fish_pager_color_description f0a000 --dim
set -U fish_pager_color_selected_background dbdde0 --background=4d5666
set -U fish_pager_color_selected_prefix dbdde0 --bold --background=4d5666
set -U fish_pager_color_selected_completion dbdde0
...
# Set theme
set -Ux BASE16_THEME phd

# Optionally export variables
if test -n "$TINTED_SHELL_ENABLE_BASE16_VARS"; or test -n "$BASE16_SHELL_ENABLE_VARS"
  set -gx BASE16_COLOR_00_HEX "061229"
  set -gx BASE16_COLOR_01_HEX "2a3448"
  set -gx BASE16_COLOR_02_HEX "4d5666"
  set -gx BASE16_COLOR_03_HEX "717885"
  set -gx BASE16_COLOR_04_HEX "9a99a3"
  set -gx BASE16_COLOR_05_HEX "b8bbc2"
  set -gx BASE16_COLOR_06_HEX "dbdde0"
  set -gx BASE16_COLOR_07_HEX "ffffff"
  set -gx BASE16_COLOR_08_HEX "d07346"
  set -gx BASE16_COLOR_09_HEX "f0a000"
  set -gx BASE16_COLOR_0A_HEX "fbd461"
  set -gx BASE16_COLOR_0B_HEX "99bf52"
  set -gx BASE16_COLOR_0C_HEX "72b9bf"
  set -gx BASE16_COLOR_0D_HEX "5299bf"
  set -gx BASE16_COLOR_0E_HEX "9989cc"
  set -gx BASE16_COLOR_0F_HEX "b08060"
end
