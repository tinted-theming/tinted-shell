...
# Set theme
set -Ux BASE24_THEME tomorrow-night

# Optionally export variables
if test -n "$TINTED_SHELL_ENABLE_BASE24_VARS"; or test -n "$BASE24_SHELL_ENABLE_VARS"
  set -gx BASE24_COLOR_00_HEX "1d1f21"
  set -gx BASE24_COLOR_01_HEX "282a2e"
  set -gx BASE24_COLOR_02_HEX "373b41"
  set -gx BASE24_COLOR_03_HEX "969896"
  set -gx BASE24_COLOR_04_HEX "b4b7b4"
  set -gx BASE24_COLOR_05_HEX "c5c8c6"
  set -gx BASE24_COLOR_06_HEX "e0e0e0"
  set -gx BASE24_COLOR_07_HEX "ffffff"
  set -gx BASE24_COLOR_08_HEX "cc6666"
  set -gx BASE24_COLOR_09_HEX "de935f"
  set -gx BASE24_COLOR_0A_HEX "f0c674"
  set -gx BASE24_COLOR_0B_HEX "b5bd68"
  set -gx BASE24_COLOR_0C_HEX "8abeb7"
  set -gx BASE24_COLOR_0D_HEX "81a2be"
  set -gx BASE24_COLOR_0E_HEX "b294bb"
  set -gx BASE24_COLOR_0F_HEX "a3685a"
end
