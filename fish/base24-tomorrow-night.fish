...
set -U fish_color_selection e0e0e0 --background=373b41
set -U fish_color_operator magenta
set -U fish_color_escape de935f
...
set -U fish_color_search_match yellow --background=373b41
set -U fish_color_history_current --underline=curly
set -U fish_pager_color_progress 282a2e --background=b4b7b4
set -U fish_pager_color_background --background=1d1f21
set -U fish_pager_color_prefix --bold --italics
set -U fish_pager_color_completion normal
set -U fish_pager_color_description de935f
set -U fish_pager_color_selected_background --background=373b41
set -U fish_pager_color_selected_prefix --bold --italics --background=373b41
