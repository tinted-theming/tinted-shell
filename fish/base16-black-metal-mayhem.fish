...
set -l color02 "f3/ec/d4" # Base 0B - Green
set -l color03 "ee/cc/6c" # Base 0A - Yellow
...
# Set theme
set -Ux BASE16_THEME black-metal-mayhem
...
if test -n "$TINTED_SHELL_ENABLE_BASE16_VARS"; or test -n "$BASE16_SHELL_ENABLE_VARS"
  ...
  set -gx BASE16_COLOR_0A_HEX "eecc6c"
  set -gx BASE16_COLOR_0B_HEX "f3ecd4"
