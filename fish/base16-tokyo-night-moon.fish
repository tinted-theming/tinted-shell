...
set -l color01 "ff/75/7f" # Base 08 - Red
set -l color02 "c3/e8/8d" # Base 0B - Green
set -l color03 "ff/df/77" # Base 0A - Yellow
set -l color04 "82/aa/ff" # Base 0D - Blue
set -l color05 "fc/a7/ea" # Base 0E - Magenta
set -l color06 "86/e1/fc" # Base 0C - Cyan
set -l color07 "82/8b/b8" # Base 05 - White
set -l color08 "3b/42/61" # Base 03 - Bright Black
...
set -l color15 "c8/d3/f5" # Base 07 - Bright White
set -l color16 "ff/c7/77" # Base 09
set -l color17 "c5/3b/53" # Base 0F
set -l color18 "1e/20/30" # Base 01
set -l color19 "2d/3f/76" # Base 02
set -l color20 "63/6d/a6" # Base 04
set -l color21 "ae/b4/d1" # Base 06
set -l color_foreground "82/8b/b8" # Base 05
...
set -U fish_color_end 828bb8
set -U fish_color_error brred
set -U fish_color_param 636da6
set -U fish_color_valid_path --underline
set -U fish_color_option brcyan
set -U fish_color_comment 3b4261
set -U fish_color_selection aeb4d1 --bold --background=2d3f76
set -U fish_color_operator brblue
set -U fish_color_escape brcyan
set -U fish_color_autosuggestion 3b4261
...
set -U fish_color_search_match bryellow --background=2d3f76
set -U fish_color_history_current --bold
set -U fish_pager_color_progress 1e2030 --background=636da6
set -U fish_pager_color_background normal --background=222436
set -U fish_pager_color_prefix normal --bold
set -U fish_pager_color_completion normal
set -U fish_pager_color_description ffc777 --dim
set -U fish_pager_color_selected_background aeb4d1 --background=2d3f76
set -U fish_pager_color_selected_prefix aeb4d1 --bold --background=2d3f76
set -U fish_pager_color_selected_completion aeb4d1
...
# Set theme
set -Ux BASE16_THEME tokyo-night-moon

# Optionally export variables
if test -n "$TINTED_SHELL_ENABLE_BASE16_VARS"; or test -n "$BASE16_SHELL_ENABLE_VARS"
  set -gx BASE16_COLOR_00_HEX "222436"
  set -gx BASE16_COLOR_01_HEX "1e2030"
  set -gx BASE16_COLOR_02_HEX "2d3f76"
  set -gx BASE16_COLOR_03_HEX "3b4261"
  set -gx BASE16_COLOR_04_HEX "636da6"
  set -gx BASE16_COLOR_05_HEX "828bb8"
  set -gx BASE16_COLOR_06_HEX "aeb4d1"
  set -gx BASE16_COLOR_07_HEX "c8d3f5"
  set -gx BASE16_COLOR_08_HEX "ff757f"
  set -gx BASE16_COLOR_09_HEX "ffc777"
  set -gx BASE16_COLOR_0A_HEX "ffdf77"
  set -gx BASE16_COLOR_0B_HEX "c3e88d"
  set -gx BASE16_COLOR_0C_HEX "86e1fc"
  set -gx BASE16_COLOR_0D_HEX "82aaff"
  set -gx BASE16_COLOR_0E_HEX "fca7ea"
  set -gx BASE16_COLOR_0F_HEX "c53b53"
end
