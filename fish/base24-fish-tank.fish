...
set -l color00 "22/24/36" # Base 00 - Black
set -l color01 "c6/00/49" # Base 08 - Red
set -l color02 "ab/f1/57" # Base 0B - Green
set -l color03 "b1/bd/f9" # Base 0A - Yellow
set -l color04 "52/5f/b8" # Base 0D - Blue
set -l color05 "97/6f/81" # Base 0E - Magenta
set -l color06 "96/86/62" # Base 0C - Cyan
set -l color07 "cc/c9/c9" # Base 05 - White
set -l color08 "8c/7f/63" # Base 03 - Bright Black
...
set -l color15 "f6/ff/ec" # Base 07 - Bright White
set -l color16 "fd/cd/5e" # Base 09
set -l color17 "63/00/24" # Base 0F
set -l color18 "03/06/3c" # Base 01
set -l color19 "6c/5a/30" # Base 02
set -l color20 "ac/a4/96" # Base 04
set -l color21 "ec/ef/fc" # Base 06
set -l color_foreground "cc/c9/c9" # Base 05
set -l color_background "22/24/36" # Base 00
...
set -U fish_color_end ccc9c9
set -U fish_color_error brred
set -U fish_color_param aca496
set -U fish_color_valid_path --underline
set -U fish_color_option brcyan
set -U fish_color_comment 8c7f63
set -U fish_color_selection eceffc --bold --background=6c5a30
set -U fish_color_operator brblue
set -U fish_color_escape brcyan
set -U fish_color_autosuggestion 8c7f63
...
set -U fish_color_search_match bryellow --background=6c5a30
set -U fish_color_history_current --bold
set -U fish_pager_color_progress 03063c --background=aca496
set -U fish_pager_color_background normal --background=222436
set -U fish_pager_color_prefix normal --bold
set -U fish_pager_color_completion normal
set -U fish_pager_color_description fdcd5e --dim
set -U fish_pager_color_selected_background eceffc --background=6c5a30
set -U fish_pager_color_selected_prefix eceffc --bold --background=6c5a30
set -U fish_pager_color_selected_completion eceffc
...
# Set theme
set -Ux BASE24_THEME fish-tank

# Optionally export variables
if test -n "$TINTED_SHELL_ENABLE_BASE24_VARS"; or test -n "$BASE24_SHELL_ENABLE_VARS"
  set -gx BASE24_COLOR_00_HEX "222436"
  set -gx BASE24_COLOR_01_HEX "03063c"
  set -gx BASE24_COLOR_02_HEX "6c5a30"
  set -gx BASE24_COLOR_03_HEX "8c7f63"
  set -gx BASE24_COLOR_04_HEX "aca496"
  set -gx BASE24_COLOR_05_HEX "ccc9c9"
  set -gx BASE24_COLOR_06_HEX "eceffc"
  set -gx BASE24_COLOR_07_HEX "f6ffec"
  set -gx BASE24_COLOR_08_HEX "c60049"
  set -gx BASE24_COLOR_09_HEX "fdcd5e"
  set -gx BASE24_COLOR_0A_HEX "b1bdf9"
  set -gx BASE24_COLOR_0B_HEX "abf157"
  set -gx BASE24_COLOR_0C_HEX "968662"
  set -gx BASE24_COLOR_0D_HEX "525fb8"
  set -gx BASE24_COLOR_0E_HEX "976f81"
  set -gx BASE24_COLOR_0F_HEX "630024"
end
