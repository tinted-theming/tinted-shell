...
set -U fish_color_selection eceffc --background=6c5a30
set -U fish_color_operator magenta
set -U fish_color_escape fdcd5e
...
set -U fish_color_search_match yellow --background=6c5a30
set -U fish_color_history_current --underline=curly
set -U fish_pager_color_progress 03063c --background=aca496
set -U fish_pager_color_background --background=222436
set -U fish_pager_color_prefix --bold --italics
set -U fish_pager_color_completion normal
set -U fish_pager_color_description fdcd5e
set -U fish_pager_color_selected_background --background=6c5a30
set -U fish_pager_color_selected_prefix --bold --italics --background=6c5a30
