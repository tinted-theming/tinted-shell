...
set -l color00 "22/22/21" # Base 00 - Black
set -l color01 "b7/14/1e" # Base 08 - Red
set -l color02 "45/7b/23" # Base 0B - Green
set -l color03 "53/a4/f3" # Base 0A - Yellow
set -l color04 "13/4e/b2" # Base 0D - Blue
set -l color05 "55/00/87" # Base 0E - Magenta
set -l color06 "0e/70/7c" # Base 0C - Cyan
set -l color07 "c3/c3/c3" # Base 05 - White
set -l color08 "6d/6d/6d" # Base 03 - Bright Black
...
set -l color15 "d8/d8/d8" # Base 07 - Bright White
set -l color16 "f5/97/1d" # Base 09
set -l color17 "5b/0a/0f" # Base 0F
set -l color18 "21/21/21" # Base 01
set -l color19 "42/42/42" # Base 02
set -l color20 "98/98/98" # Base 04
set -l color21 "ee/ee/ee" # Base 06
set -l color_foreground "c3/c3/c3" # Base 05
set -l color_background "22/22/21" # Base 00
...
if test -n "$ITERM_SESSION_ID"
  ...
  put_template_custom Ph 222221 # background
  ...
  put_template_custom Pm 222221 # cursor text
else
...
set -U fish_color_end c3c3c3
set -U fish_color_error brred
set -U fish_color_param 989898
set -U fish_color_valid_path --underline
set -U fish_color_option brcyan
set -U fish_color_comment 6d6d6d
set -U fish_color_selection eeeeee --bold --background=424242
...
set -U fish_pager_color_progress 212121 --background=989898
set -U fish_pager_color_background normal --background=222221
set -U fish_pager_color_prefix normal --bold
set -U fish_pager_color_completion normal
set -U fish_pager_color_description f5971d --dim
set -U fish_pager_color_selected_background eeeeee --background=424242
set -U fish_pager_color_selected_prefix eeeeee --bold --background=424242
...
# Set theme
set -Ux BASE24_THEME material-dark

# Optionally export variables
if test -n "$TINTED_SHELL_ENABLE_BASE24_VARS"; or test -n "$BASE24_SHELL_ENABLE_VARS"
  set -gx BASE24_COLOR_00_HEX "222221"
  set -gx BASE24_COLOR_01_HEX "212121"
  set -gx BASE24_COLOR_02_HEX "424242"
  set -gx BASE24_COLOR_03_HEX "6d6d6d"
  set -gx BASE24_COLOR_04_HEX "989898"
  set -gx BASE24_COLOR_05_HEX "c3c3c3"
  set -gx BASE24_COLOR_06_HEX "eeeeee"
  set -gx BASE24_COLOR_07_HEX "d8d8d8"
  set -gx BASE24_COLOR_08_HEX "b7141e"
  set -gx BASE24_COLOR_09_HEX "f5971d"
  set -gx BASE24_COLOR_0A_HEX "53a4f3"
  set -gx BASE24_COLOR_0B_HEX "457b23"
  set -gx BASE24_COLOR_0C_HEX "0e707c"
  set -gx BASE24_COLOR_0D_HEX "134eb2"
  set -gx BASE24_COLOR_0E_HEX "550087"
  set -gx BASE24_COLOR_0F_HEX "5b0a0f"
end
