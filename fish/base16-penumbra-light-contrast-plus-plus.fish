...
set -l color00 "ff/fd/fb" # Base 00 - Black
set -l color01 "f5/8c/81" # Base 08 - Red
set -l color02 "54/c7/94" # Base 0B - Green
set -l color03 "a9/b8/52" # Base 0A - Yellow
set -l color04 "6e/b2/fd" # Base 0D - Blue
set -l color05 "b6/9c/f6" # Base 0E - Magenta
set -l color06 "00/c4/d7" # Base 0C - Cyan
set -l color07 "63/63/63" # Base 05 - White
set -l color08 "de/de/de" # Base 03 - Bright Black
...
set -l color15 "0d/0f/13" # Base 07 - Bright White
set -l color16 "e0/9f/47" # Base 09
set -l color17 "e5/8c/c5" # Base 0F
set -l color18 "ff/f7/ed" # Base 01
set -l color19 "f2/e6/d4" # Base 02
set -l color20 "ae/ae/ae" # Base 04
set -l color21 "18/1b/1f" # Base 06
set -l color_foreground "63/63/63" # Base 05
set -l color_background "ff/fd/fb" # Base 00
...
set -U fish_color_end 636363
set -U fish_color_error brred
set -U fish_color_param aeaeae
set -U fish_color_valid_path --underline
set -U fish_color_option brcyan
set -U fish_color_comment dedede
set -U fish_color_selection 181b1f --bold --background=f2e6d4
set -U fish_color_operator brblue
set -U fish_color_escape brcyan
set -U fish_color_autosuggestion dedede
...
set -U fish_color_search_match bryellow --background=f2e6d4
set -U fish_color_history_current --bold
set -U fish_pager_color_progress fff7ed --background=aeaeae
set -U fish_pager_color_background normal --background=fffdfb
set -U fish_pager_color_prefix normal --bold
set -U fish_pager_color_completion normal
set -U fish_pager_color_description e09f47 --dim
set -U fish_pager_color_selected_background 181b1f --background=f2e6d4
set -U fish_pager_color_selected_prefix 181b1f --bold --background=f2e6d4
set -U fish_pager_color_selected_completion 181b1f
...
# Set theme
set -Ux BASE16_THEME penumbra-light-contrast-plus-plus

# Optionally export variables
if test -n "$TINTED_SHELL_ENABLE_BASE16_VARS"; or test -n "$BASE16_SHELL_ENABLE_VARS"
  set -gx BASE16_COLOR_00_HEX "fffdfb"
  set -gx BASE16_COLOR_01_HEX "fff7ed"
  set -gx BASE16_COLOR_02_HEX "f2e6d4"
  set -gx BASE16_COLOR_03_HEX "dedede"
  set -gx BASE16_COLOR_04_HEX "aeaeae"
  set -gx BASE16_COLOR_05_HEX "636363"
  set -gx BASE16_COLOR_06_HEX "181b1f"
  set -gx BASE16_COLOR_07_HEX "0d0f13"
  set -gx BASE16_COLOR_08_HEX "f58c81"
  set -gx BASE16_COLOR_09_HEX "e09f47"
  set -gx BASE16_COLOR_0A_HEX "a9b852"
  set -gx BASE16_COLOR_0B_HEX "54c794"
  set -gx BASE16_COLOR_0C_HEX "00c4d7"
  set -gx BASE16_COLOR_0D_HEX "6eb2fd"
  set -gx BASE16_COLOR_0E_HEX "b69cf6"
  set -gx BASE16_COLOR_0F_HEX "e58cc5"
end
