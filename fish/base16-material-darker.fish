...
set -l color08 "4a/4a/4a" # Base 03 - Bright Black
...
set -l color19 "35/35/35" # Base 02
...
set -U fish_color_selection eeffff --bold --background=353535
...
set -U fish_pager_color_progress 303030 --background=b2ccd6
...
set -U fish_pager_color_selected_background eeffff --background=353535
set -U fish_pager_color_selected_prefix eeffff --bold --background=353535
...
# Set theme
set -Ux BASE16_THEME material-darker

# Optionally export variables
if test -n "$TINTED_SHELL_ENABLE_BASE16_VARS"; or test -n "$BASE16_SHELL_ENABLE_VARS"
  set -gx BASE16_COLOR_00_HEX "212121"
  set -gx BASE16_COLOR_01_HEX "303030"
  set -gx BASE16_COLOR_02_HEX "353535"
  set -gx BASE16_COLOR_03_HEX "4a4a4a"
