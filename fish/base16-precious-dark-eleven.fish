...
set -l color00 "1c/1e/20" # Base 00 - Black
set -l color01 "ff/87/82" # Base 08 - Red
set -l color02 "95/b6/58" # Base 0B - Green
set -l color03 "d0/a5/43" # Base 0A - Yellow
set -l color04 "68/b0/ee" # Base 0D - Blue
set -l color05 "b7/99/fe" # Base 0E - Magenta
set -l color06 "42/bd/a7" # Base 0C - Cyan
set -l color07 "b8/b7/b6" # Base 05 - White
...
set -l color15 "b8/b7/b6" # Base 07 - Bright White
set -l color16 "ea/97/55" # Base 09
set -l color17 "f3/82/d8" # Base 0F
set -l color18 "29/2b/2d" # Base 01
set -l color19 "37/39/3a" # Base 02
set -l color20 "a8/a8/a7" # Base 04
set -l color21 "b8/b7/b6" # Base 06
set -l color_foreground "b8/b7/b6" # Base 05
set -l color_background "1c/1e/20" # Base 00
...
set -U fish_color_end b8b7b6
set -U fish_color_error brred
set -U fish_color_param a8a8a7
set -U fish_color_valid_path --underline
set -U fish_color_option brcyan
set -U fish_color_comment 858585
set -U fish_color_selection b8b7b6 --bold --background=37393a
...
set -U fish_color_search_match bryellow --background=37393a
set -U fish_color_history_current --bold
set -U fish_pager_color_progress 292b2d --background=a8a8a7
set -U fish_pager_color_background normal --background=1c1e20
set -U fish_pager_color_prefix normal --bold
set -U fish_pager_color_completion normal
set -U fish_pager_color_description ea9755 --dim
set -U fish_pager_color_selected_background b8b7b6 --background=37393a
set -U fish_pager_color_selected_prefix b8b7b6 --bold --background=37393a
set -U fish_pager_color_selected_completion b8b7b6
...
# Set theme
set -Ux BASE16_THEME precious-dark-eleven

# Optionally export variables
if test -n "$TINTED_SHELL_ENABLE_BASE16_VARS"; or test -n "$BASE16_SHELL_ENABLE_VARS"
  set -gx BASE16_COLOR_00_HEX "1c1e20"
  set -gx BASE16_COLOR_01_HEX "292b2d"
  set -gx BASE16_COLOR_02_HEX "37393a"
  set -gx BASE16_COLOR_03_HEX "858585"
  set -gx BASE16_COLOR_04_HEX "a8a8a7"
  set -gx BASE16_COLOR_05_HEX "b8b7b6"
  set -gx BASE16_COLOR_06_HEX "b8b7b6"
  set -gx BASE16_COLOR_07_HEX "b8b7b6"
  set -gx BASE16_COLOR_08_HEX "ff8782"
  set -gx BASE16_COLOR_09_HEX "ea9755"
  set -gx BASE16_COLOR_0A_HEX "d0a543"
  set -gx BASE16_COLOR_0B_HEX "95b658"
  set -gx BASE16_COLOR_0C_HEX "42bda7"
  set -gx BASE16_COLOR_0D_HEX "68b0ee"
  set -gx BASE16_COLOR_0E_HEX "b799fe"
