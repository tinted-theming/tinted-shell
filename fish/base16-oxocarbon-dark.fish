...
set -l color00 "16/16/16" # Base 00 - Black
set -l color01 "ee/53/96" # Base 08 - Red
set -l color02 "42/be/65" # Base 0B - Green
set -l color03 "ff/6f/00" # Base 0A - Yellow
set -l color04 "33/b1/ff" # Base 0D - Blue
set -l color05 "be/95/ff" # Base 0E - Magenta
set -l color06 "3d/db/d9" # Base 0C - Cyan
set -l color07 "f2/f4/f8" # Base 05 - White
...
set -l color15 "08/bd/ba" # Base 07 - Bright White
set -l color16 "ff/7e/b6" # Base 09
set -l color17 "82/cf/ff" # Base 0F
set -l color18 "26/26/26" # Base 01
set -l color19 "39/39/39" # Base 02
set -l color20 "dd/e1/e6" # Base 04
set -l color21 "ff/ff/ff" # Base 06
set -l color_foreground "f2/f4/f8" # Base 05
set -l color_background "16/16/16" # Base 00
...
set -U fish_color_end f2f4f8
set -U fish_color_error brred
set -U fish_color_param dde1e6
set -U fish_color_valid_path --underline
set -U fish_color_option brcyan
set -U fish_color_comment 525252
set -U fish_color_selection ffffff --bold --background=393939
...
set -U fish_color_search_match bryellow --background=393939
set -U fish_color_history_current --bold
set -U fish_pager_color_progress 262626 --background=dde1e6
set -U fish_pager_color_background normal --background=161616
set -U fish_pager_color_prefix normal --bold
set -U fish_pager_color_completion normal
set -U fish_pager_color_description ff7eb6 --dim
set -U fish_pager_color_selected_background ffffff --background=393939
set -U fish_pager_color_selected_prefix ffffff --bold --background=393939
...
# Set theme
set -Ux BASE16_THEME oxocarbon-dark

# Optionally export variables
if test -n "$TINTED_SHELL_ENABLE_BASE16_VARS"; or test -n "$BASE16_SHELL_ENABLE_VARS"
  set -gx BASE16_COLOR_00_HEX "161616"
  set -gx BASE16_COLOR_01_HEX "262626"
  set -gx BASE16_COLOR_02_HEX "393939"
  set -gx BASE16_COLOR_03_HEX "525252"
  set -gx BASE16_COLOR_04_HEX "dde1e6"
  set -gx BASE16_COLOR_05_HEX "f2f4f8"
  set -gx BASE16_COLOR_06_HEX "ffffff"
  set -gx BASE16_COLOR_07_HEX "08bdba"
  set -gx BASE16_COLOR_08_HEX "ee5396"
  set -gx BASE16_COLOR_09_HEX "ff7eb6"
  set -gx BASE16_COLOR_0A_HEX "ff6f00"
  set -gx BASE16_COLOR_0B_HEX "42be65"
  set -gx BASE16_COLOR_0C_HEX "3ddbd9"
  set -gx BASE16_COLOR_0D_HEX "33b1ff"
  set -gx BASE16_COLOR_0E_HEX "be95ff"
  set -gx BASE16_COLOR_0F_HEX "82cfff"
end
