...
set -l color00 "24/20/15" # Base 00 - Black
set -l color01 "db/93/0d" # Base 08 - Red
set -l color02 "7a/76/53" # Base 0B - Green
set -l color03 "a8/2d/56" # Base 0A - Yellow
set -l color04 "c1/66/6b" # Base 0D - Blue
set -l color05 "91/50/6c" # Base 0E - Magenta
set -l color06 "db/93/0d" # Base 0C - Cyan
set -l color07 "d2/c3/a4" # Base 05 - White
set -l color08 "5f/4e/41" # Base 03 - Bright Black
...
set -l color15 "f1/e9/d0" # Base 07 - Bright White
set -l color16 "eb/e0/bb" # Base 09
set -l color17 "61/a0/a8" # Base 0F
set -l color18 "3a/31/24" # Base 01
set -l color19 "4d/3f/32" # Base 02
set -l color20 "b8/a5/8c" # Base 04
set -l color21 "eb/e0/bb" # Base 06
set -l color_foreground "d2/c3/a4" # Base 05
set -l color_background "24/20/15" # Base 00
...
set -U fish_color_end d2c3a4
set -U fish_color_error brred
set -U fish_color_param b8a58c
set -U fish_color_valid_path --underline
set -U fish_color_option brcyan
set -U fish_color_comment 5f4e41
set -U fish_color_selection ebe0bb --bold --background=4d3f32
set -U fish_color_operator brblue
set -U fish_color_escape brcyan
set -U fish_color_autosuggestion 5f4e41
...
set -U fish_color_search_match bryellow --background=4d3f32
set -U fish_color_history_current --bold
set -U fish_pager_color_progress 3a3124 --background=b8a58c
set -U fish_pager_color_background normal --background=242015
set -U fish_pager_color_prefix normal --bold
set -U fish_pager_color_completion normal
set -U fish_pager_color_description ebe0bb --dim
set -U fish_pager_color_selected_background ebe0bb --background=4d3f32
set -U fish_pager_color_selected_prefix ebe0bb --bold --background=4d3f32
set -U fish_pager_color_selected_completion ebe0bb
...
# Set theme
set -Ux BASE16_THEME swamp-dark

# Optionally export variables
if test -n "$TINTED_SHELL_ENABLE_BASE16_VARS"; or test -n "$BASE16_SHELL_ENABLE_VARS"
  set -gx BASE16_COLOR_00_HEX "242015"
  set -gx BASE16_COLOR_01_HEX "3a3124"
  set -gx BASE16_COLOR_02_HEX "4d3f32"
  set -gx BASE16_COLOR_03_HEX "5f4e41"
  set -gx BASE16_COLOR_04_HEX "b8a58c"
  set -gx BASE16_COLOR_05_HEX "d2c3a4"
  set -gx BASE16_COLOR_06_HEX "ebe0bb"
  set -gx BASE16_COLOR_07_HEX "f1e9d0"
  set -gx BASE16_COLOR_08_HEX "db930d"
  set -gx BASE16_COLOR_09_HEX "ebe0bb"
  set -gx BASE16_COLOR_0A_HEX "a82d56"
  set -gx BASE16_COLOR_0B_HEX "7a7653"
  set -gx BASE16_COLOR_0C_HEX "db930d"
  set -gx BASE16_COLOR_0D_HEX "c1666b"
  set -gx BASE16_COLOR_0E_HEX "91506c"
  set -gx BASE16_COLOR_0F_HEX "61a0a8"
end
