...
set -l color01 "b2/37/71" # Base 08 - Red
set -l color02 "66/78/1e" # Base 0B - Green
set -l color03 "cd/a4/34" # Base 0A - Yellow
set -l color04 "3c/5e/a8" # Base 0D - Blue
set -l color05 "a4/54/b2" # Base 0E - Magenta
set -l color06 "1e/78/78" # Base 0C - Cyan
set -l color07 "51/51/51" # Base 05 - White
set -l color08 "c1/c1/c1" # Base 03 - Bright Black
...
set -l color15 "21/21/21" # Base 07 - Bright White
set -l color16 "cd/6f/34" # Base 09
set -l color17 "59/1b/38" # Base 0F
set -l color18 "f1/f1/f1" # Base 01
set -l color19 "e1/e1/e1" # Base 02
set -l color20 "71/71/71" # Base 04
set -l color21 "41/41/41" # Base 06
...
set -U fish_color_param 717171
set -U fish_color_valid_path --underline
set -U fish_color_option brcyan
set -U fish_color_comment c1c1c1
set -U fish_color_selection 414141 --bold --background=e1e1e1
set -U fish_color_operator brblue
set -U fish_color_escape brcyan
set -U fish_color_autosuggestion c1c1c1
...
set -U fish_color_search_match bryellow --background=e1e1e1
set -U fish_color_history_current --bold
set -U fish_pager_color_progress f1f1f1 --background=717171
set -U fish_pager_color_background normal --background=ffffff
set -U fish_pager_color_prefix normal --bold
set -U fish_pager_color_completion normal
set -U fish_pager_color_description cd6f34 --dim
set -U fish_pager_color_selected_background 414141 --background=e1e1e1
set -U fish_pager_color_selected_prefix 414141 --bold --background=e1e1e1
set -U fish_pager_color_selected_completion 414141
...
# Set theme
set -Ux BASE24_THEME piatto-light
...
if test -n "$TINTED_SHELL_ENABLE_BASE24_VARS"; or test -n "$BASE24_SHELL_ENABLE_VARS"
  ...
  set -gx BASE24_COLOR_02_HEX "e1e1e1"
  set -gx BASE24_COLOR_03_HEX "c1c1c1"
  set -gx BASE24_COLOR_04_HEX "717171"
  set -gx BASE24_COLOR_05_HEX "515151"
  set -gx BASE24_COLOR_06_HEX "414141"
  set -gx BASE24_COLOR_07_HEX "212121"
  set -gx BASE24_COLOR_08_HEX "b23771"
  set -gx BASE24_COLOR_09_HEX "cd6f34"
  set -gx BASE24_COLOR_0A_HEX "cda434"
  set -gx BASE24_COLOR_0B_HEX "66781e"
  set -gx BASE24_COLOR_0C_HEX "1e7878"
  set -gx BASE24_COLOR_0D_HEX "3c5ea8"
  set -gx BASE24_COLOR_0E_HEX "a454b2"
  set -gx BASE24_COLOR_0F_HEX "591b38"
end
