...
set -U fish_color_selection 414141 --background=e1e1e1
set -U fish_color_operator magenta
set -U fish_color_escape cd6f34
...
set -U fish_color_search_match yellow --background=e1e1e1
...
set -U fish_pager_color_description cd6f34
set -U fish_pager_color_selected_background --background=e1e1e1
set -U fish_pager_color_selected_prefix --bold --italics --background=e1e1e1
