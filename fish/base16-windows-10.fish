...
set -l color00 "0c/0c/0c" # Base 00 - Black
set -l color01 "e7/48/56" # Base 08 - Red
set -l color02 "16/c6/0c" # Base 0B - Green
set -l color03 "f9/f1/a5" # Base 0A - Yellow
set -l color04 "3b/78/ff" # Base 0D - Blue
set -l color05 "b4/00/9e" # Base 0E - Magenta
set -l color06 "61/d6/d6" # Base 0C - Cyan
...
set -l color15 "f2/f2/f2" # Base 07 - Bright White
set -l color16 "c1/9c/00" # Base 09
set -l color17 "13/a1/0e" # Base 0F
set -l color18 "2f/2f/2f" # Base 01
...
set -l color_background "0c/0c/0c" # Base 00
...
set -U fish_color_selection dfdfdf --bold --background=535353
...
set -U fish_pager_color_progress 2f2f2f --background=b9b9b9
set -U fish_pager_color_background normal --background=0c0c0c
set -U fish_pager_color_prefix normal --bold
set -U fish_pager_color_completion normal
set -U fish_pager_color_description c19c00 --dim
set -U fish_pager_color_selected_background dfdfdf --background=535353
set -U fish_pager_color_selected_prefix dfdfdf --bold --background=535353
set -U fish_pager_color_selected_completion dfdfdf
...
# Set theme
set -Ux BASE16_THEME windows-10

# Optionally export variables
if test -n "$TINTED_SHELL_ENABLE_BASE16_VARS"; or test -n "$BASE16_SHELL_ENABLE_VARS"
  set -gx BASE16_COLOR_00_HEX "0c0c0c"
  set -gx BASE16_COLOR_01_HEX "2f2f2f"
  set -gx BASE16_COLOR_02_HEX "535353"
  ...
  set -gx BASE16_COLOR_07_HEX "f2f2f2"
  set -gx BASE16_COLOR_08_HEX "e74856"
  set -gx BASE16_COLOR_09_HEX "c19c00"
  set -gx BASE16_COLOR_0A_HEX "f9f1a5"
  set -gx BASE16_COLOR_0B_HEX "16c60c"
  set -gx BASE16_COLOR_0C_HEX "61d6d6"
  set -gx BASE16_COLOR_0D_HEX "3b78ff"
  set -gx BASE16_COLOR_0E_HEX "b4009e"
  set -gx BASE16_COLOR_0F_HEX "13a10e"
end
