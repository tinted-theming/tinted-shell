...
set -l color00 "27/30/32" # Base 00 - Black
set -l color01 "a5/00/01" # Base 08 - Red
set -l color02 "00/bb/00" # Base 0B - Green
set -l color03 "a0/d6/ff" # Base 0A - Yellow
set -l color04 "39/9b/da" # Base 0D - Blue
...
set -l color16 "fe/cc/22" # Base 09
set -l color17 "52/00/00" # Base 0F
...
set -l color_background "27/30/32" # Base 00
...
if test -n "$ITERM_SESSION_ID"
  ...
  put_template_custom Ph 273032 # background
  ...
  put_template_custom Pm 273032 # cursor text
else
...
set -U fish_pager_color_background normal --background=273032
set -U fish_pager_color_prefix normal --bold
set -U fish_pager_color_completion normal
set -U fish_pager_color_description fecc22 --dim
...
if test -n "$TINTED_SHELL_ENABLE_BASE24_VARS"; or test -n "$BASE24_SHELL_ENABLE_VARS"
  ...
  set -gx BASE24_COLOR_08_HEX "a50001"
  set -gx BASE24_COLOR_09_HEX "fecc22"
  set -gx BASE24_COLOR_0A_HEX "a0d6ff"
  set -gx BASE24_COLOR_0B_HEX "00bb00"
  set -gx BASE24_COLOR_0C_HEX "00bbbb"
  set -gx BASE24_COLOR_0D_HEX "399bda"
  set -gx BASE24_COLOR_0E_HEX "bb00bb"
  set -gx BASE24_COLOR_0F_HEX "520000"
end
