...
set -l color02 "ec/ee/e3" # Base 0B - Green
set -l color03 "97/4b/46" # Base 0A - Yellow
...
# Set theme
set -Ux BASE16_THEME black-metal-khold
...
if test -n "$TINTED_SHELL_ENABLE_BASE16_VARS"; or test -n "$BASE16_SHELL_ENABLE_VARS"
  ...
  set -gx BASE16_COLOR_0A_HEX "974b46"
  set -gx BASE16_COLOR_0B_HEX "eceee3"
