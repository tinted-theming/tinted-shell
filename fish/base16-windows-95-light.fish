...
set -l color00 "fc/fc/fc" # Base 00 - Black
set -l color01 "a8/00/00" # Base 08 - Red
set -l color02 "00/a8/00" # Base 0B - Green
set -l color03 "a8/54/00" # Base 0A - Yellow
set -l color04 "00/00/a8" # Base 0D - Blue
set -l color05 "a8/00/a8" # Base 0E - Magenta
set -l color06 "00/a8/a8" # Base 0C - Cyan
set -l color07 "54/54/54" # Base 05 - White
set -l color08 "a8/a8/a8" # Base 03 - Bright Black
...
set -l color16 "fc/fc/54" # Base 09
set -l color17 "54/fc/54" # Base 0F
set -l color18 "e0/e0/e0" # Base 01
set -l color19 "c4/c4/c4" # Base 02
set -l color20 "7e/7e/7e" # Base 04
set -l color21 "2a/2a/2a" # Base 06
set -l color_foreground "54/54/54" # Base 05
set -l color_background "fc/fc/fc" # Base 00
...
set -U fish_pager_color_progress e0e0e0 --background=7e7e7e
set -U fish_pager_color_background normal --background=fcfcfc
set -U fish_pager_color_prefix normal --bold
set -U fish_pager_color_completion normal
set -U fish_pager_color_description fcfc54 --dim
set -U fish_pager_color_selected_background 2a2a2a --background=c4c4c4
set -U fish_pager_color_selected_prefix 2a2a2a --bold --background=c4c4c4
set -U fish_pager_color_selected_completion 2a2a2a
...
# Set theme
set -Ux BASE16_THEME windows-95-light

# Optionally export variables
if test -n "$TINTED_SHELL_ENABLE_BASE16_VARS"; or test -n "$BASE16_SHELL_ENABLE_VARS"
  set -gx BASE16_COLOR_00_HEX "fcfcfc"
  set -gx BASE16_COLOR_01_HEX "e0e0e0"
  set -gx BASE16_COLOR_02_HEX "c4c4c4"
  set -gx BASE16_COLOR_03_HEX "a8a8a8"
  set -gx BASE16_COLOR_04_HEX "7e7e7e"
  set -gx BASE16_COLOR_05_HEX "545454"
  set -gx BASE16_COLOR_06_HEX "2a2a2a"
  set -gx BASE16_COLOR_07_HEX "000000"
  set -gx BASE16_COLOR_08_HEX "a80000"
  set -gx BASE16_COLOR_09_HEX "fcfc54"
  set -gx BASE16_COLOR_0A_HEX "a85400"
  set -gx BASE16_COLOR_0B_HEX "00a800"
  set -gx BASE16_COLOR_0C_HEX "00a8a8"
  set -gx BASE16_COLOR_0D_HEX "0000a8"
  set -gx BASE16_COLOR_0E_HEX "a800a8"
  set -gx BASE16_COLOR_0F_HEX "54fc54"
end
