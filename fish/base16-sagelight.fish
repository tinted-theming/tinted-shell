...
set -l color01 "fa/84/80" # Base 08 - Red
set -l color02 "a0/d2/c8" # Base 0B - Green
set -l color03 "ff/dc/61" # Base 0A - Yellow
set -l color04 "a0/a7/d2" # Base 0D - Blue
set -l color05 "c8/a0/d2" # Base 0E - Magenta
set -l color06 "a2/d6/f5" # Base 0C - Cyan
...
set -l color16 "ff/aa/61" # Base 09
set -l color17 "d2/b2/a0" # Base 0F
...
set -U fish_pager_color_description ffaa61 --dim
...
if test -n "$TINTED_SHELL_ENABLE_BASE16_VARS"; or test -n "$BASE16_SHELL_ENABLE_VARS"
  ...
  set -gx BASE16_COLOR_08_HEX "fa8480"
  set -gx BASE16_COLOR_09_HEX "ffaa61"
  set -gx BASE16_COLOR_0A_HEX "ffdc61"
  set -gx BASE16_COLOR_0B_HEX "a0d2c8"
  set -gx BASE16_COLOR_0C_HEX "a2d6f5"
  set -gx BASE16_COLOR_0D_HEX "a0a7d2"
  set -gx BASE16_COLOR_0E_HEX "c8a0d2"
  set -gx BASE16_COLOR_0F_HEX "d2b2a0"
end
