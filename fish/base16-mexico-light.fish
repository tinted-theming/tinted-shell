...
set -l color02 "53/89/47" # Base 0B - Green
set -l color03 "f7/9a/0e" # Base 0A - Yellow
set -l color04 "7c/af/c2" # Base 0D - Blue
set -l color05 "96/60/9e" # Base 0E - Magenta
set -l color06 "4b/80/93" # Base 0C - Cyan
...
# Set theme
set -Ux BASE16_THEME mexico-light
...
if test -n "$TINTED_SHELL_ENABLE_BASE16_VARS"; or test -n "$BASE16_SHELL_ENABLE_VARS"
  ...
  set -gx BASE16_COLOR_0A_HEX "f79a0e"
  set -gx BASE16_COLOR_0B_HEX "538947"
  set -gx BASE16_COLOR_0C_HEX "4b8093"
  set -gx BASE16_COLOR_0D_HEX "7cafc2"
  set -gx BASE16_COLOR_0E_HEX "96609e"
