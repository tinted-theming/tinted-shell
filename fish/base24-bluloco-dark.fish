...
set -U fish_color_end b1bac9
set -U fish_color_error brred
set -U fish_color_param 969faf
set -U fish_color_valid_path --underline
set -U fish_color_option brcyan
set -U fish_color_comment 7b8494
set -U fish_color_selection ccd5e4 --bold --background=60697a
...
set -U fish_color_search_match bryellow --background=60697a
set -U fish_color_history_current --bold
set -U fish_pager_color_progress 494f5c --background=969faf
set -U fish_pager_color_background normal --background=1e2027
set -U fish_pager_color_prefix normal --bold
set -U fish_pager_color_completion normal
set -U fish_pager_color_description fc7e57 --dim
set -U fish_pager_color_selected_background ccd5e4 --background=60697a
set -U fish_pager_color_selected_prefix ccd5e4 --bold --background=60697a
set -U fish_pager_color_selected_completion ccd5e4
