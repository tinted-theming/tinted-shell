...
set -l color01 "de/6e/6e" # Base 08 - Red
set -l color02 "5f/87/87" # Base 0B - Green
set -l color03 "ff/c7/99" # Base 0A - Yellow
set -l color04 "8e/aa/aa" # Base 0D - Blue
set -l color05 "d6/90/94" # Base 0E - Magenta
set -l color06 "60/a5/92" # Base 0C - Cyan
set -l color07 "b7/b7/b7" # Base 05 - White
set -l color08 "33/33/33" # Base 03 - Bright Black
...
set -l color15 "d5/d5/d5" # Base 07 - Bright White
set -l color16 "da/b0/83" # Base 09
set -l color17 "87/6c/4f" # Base 0F
set -l color18 "23/23/23" # Base 01
set -l color19 "22/22/22" # Base 02
set -l color20 "99/99/99" # Base 04
set -l color21 "c1/c1/c1" # Base 06
set -l color_foreground "b7/b7/b7" # Base 05
...
set -U fish_pager_color_progress 232323 --background=999999
set -U fish_pager_color_background normal --background=101010
set -U fish_pager_color_prefix normal --bold
set -U fish_pager_color_completion normal
set -U fish_pager_color_description dab083 --dim
set -U fish_pager_color_selected_background c1c1c1 --background=222222
set -U fish_pager_color_selected_prefix c1c1c1 --bold --background=222222
set -U fish_pager_color_selected_completion c1c1c1
...
# Set theme
set -Ux BASE16_THEME vesper

# Optionally export variables
if test -n "$TINTED_SHELL_ENABLE_BASE16_VARS"; or test -n "$BASE16_SHELL_ENABLE_VARS"
  set -gx BASE16_COLOR_00_HEX "101010"
  set -gx BASE16_COLOR_01_HEX "232323"
  set -gx BASE16_COLOR_02_HEX "222222"
  set -gx BASE16_COLOR_03_HEX "333333"
  set -gx BASE16_COLOR_04_HEX "999999"
  set -gx BASE16_COLOR_05_HEX "b7b7b7"
  set -gx BASE16_COLOR_06_HEX "c1c1c1"
  set -gx BASE16_COLOR_07_HEX "d5d5d5"
  set -gx BASE16_COLOR_08_HEX "de6e6e"
  set -gx BASE16_COLOR_09_HEX "dab083"
  set -gx BASE16_COLOR_0A_HEX "ffc799"
  set -gx BASE16_COLOR_0B_HEX "5f8787"
  set -gx BASE16_COLOR_0C_HEX "60a592"
  set -gx BASE16_COLOR_0D_HEX "8eaaaa"
  set -gx BASE16_COLOR_0E_HEX "d69094"
  set -gx BASE16_COLOR_0F_HEX "876c4f"
end
