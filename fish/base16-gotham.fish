...
set -l color00 "0c/10/14" # Base 00 - Black
set -l color01 "c2/31/27" # Base 08 - Red
set -l color02 "33/85/9e" # Base 0B - Green
set -l color03 "ed/b4/43" # Base 0A - Yellow
set -l color04 "19/54/66" # Base 0D - Blue
set -l color05 "88/8c/a6" # Base 0E - Magenta
set -l color06 "2a/a8/89" # Base 0C - Cyan
set -l color07 "59/9c/ab" # Base 05 - White
set -l color08 "0a/37/49" # Base 03 - Bright Black
...
set -l color15 "d3/eb/e9" # Base 07 - Bright White
set -l color16 "d2/69/37" # Base 09
set -l color17 "4e/51/66" # Base 0F
set -l color18 "11/15/1c" # Base 01
set -l color19 "09/1f/2e" # Base 02
set -l color20 "24/53/61" # Base 04
set -l color21 "99/d1/ce" # Base 06
set -l color_foreground "59/9c/ab" # Base 05
set -l color_background "0c/10/14" # Base 00
...
set -U fish_color_end 599cab
set -U fish_color_error brred
set -U fish_color_param 245361
set -U fish_color_valid_path --underline
set -U fish_color_option brcyan
set -U fish_color_comment 0a3749
set -U fish_color_selection 99d1ce --bold --background=091f2e
set -U fish_color_operator brblue
set -U fish_color_escape brcyan
set -U fish_color_autosuggestion 0a3749
...
set -U fish_pager_color_progress 11151c --background=245361
set -U fish_pager_color_background normal --background=0c1014
set -U fish_pager_color_prefix normal --bold
set -U fish_pager_color_completion normal
set -U fish_pager_color_description d26937 --dim
set -U fish_pager_color_selected_background 99d1ce --background=091f2e
set -U fish_pager_color_selected_prefix 99d1ce --bold --background=091f2e
set -U fish_pager_color_selected_completion 99d1ce
...
# Set theme
set -Ux BASE16_THEME gotham

# Optionally export variables
if test -n "$TINTED_SHELL_ENABLE_BASE16_VARS"; or test -n "$BASE16_SHELL_ENABLE_VARS"
  set -gx BASE16_COLOR_00_HEX "0c1014"
  set -gx BASE16_COLOR_01_HEX "11151c"
  set -gx BASE16_COLOR_02_HEX "091f2e"
  set -gx BASE16_COLOR_03_HEX "0a3749"
  set -gx BASE16_COLOR_04_HEX "245361"
  set -gx BASE16_COLOR_05_HEX "599cab"
  set -gx BASE16_COLOR_06_HEX "99d1ce"
  set -gx BASE16_COLOR_07_HEX "d3ebe9"
  set -gx BASE16_COLOR_08_HEX "c23127"
  set -gx BASE16_COLOR_09_HEX "d26937"
  set -gx BASE16_COLOR_0A_HEX "edb443"
  set -gx BASE16_COLOR_0B_HEX "33859e"
  set -gx BASE16_COLOR_0C_HEX "2aa889"
  set -gx BASE16_COLOR_0D_HEX "195466"
  set -gx BASE16_COLOR_0E_HEX "888ca6"
  set -gx BASE16_COLOR_0F_HEX "4e5166"
end
