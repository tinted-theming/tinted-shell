...
set -l color00 "21/22/24" # Base 00 - Black
set -l color01 "cf/0d/17" # Base 08 - Red
set -l color02 "12/80/33" # Base 0B - Green
set -l color03 "4f/c2/fd" # Base 0A - Yellow
set -l color04 "00/6a/b3" # Base 0D - Blue
set -l color05 "6a/26/74" # Base 0E - Magenta
set -l color06 "38/45/63" # Base 0C - Cyan
set -l color07 "c8/c5/c4" # Base 05 - White
set -l color08 "80/76/72" # Base 03 - Bright Black
...
set -l color16 "ff/ca/3d" # Base 09
set -l color17 "67/06/0b" # Base 0F
set -l color18 "00/00/00" # Base 01
set -l color19 "5c/4f/49" # Base 02
set -l color20 "a4/9e/9b" # Base 04
set -l color21 "ed/ed/ed" # Base 06
set -l color_foreground "c8/c5/c4" # Base 05
set -l color_background "21/22/24" # Base 00
...
set -U fish_color_end c8c5c4
set -U fish_color_error brred
set -U fish_color_param a49e9b
set -U fish_color_valid_path --underline
set -U fish_color_option brcyan
set -U fish_color_comment 807672
set -U fish_color_selection ededed --bold --background=5c4f49
set -U fish_color_operator brblue
set -U fish_color_escape brcyan
set -U fish_color_autosuggestion 807672
...
set -U fish_color_search_match bryellow --background=5c4f49
set -U fish_color_history_current --bold
set -U fish_pager_color_progress 000000 --background=a49e9b
set -U fish_pager_color_background normal --background=212224
set -U fish_pager_color_prefix normal --bold
set -U fish_pager_color_completion normal
set -U fish_pager_color_description ffca3d --dim
set -U fish_pager_color_selected_background ededed --background=5c4f49
set -U fish_pager_color_selected_prefix ededed --bold --background=5c4f49
set -U fish_pager_color_selected_completion ededed
...
# Set theme
set -Ux BASE24_THEME highway

# Optionally export variables
if test -n "$TINTED_SHELL_ENABLE_BASE24_VARS"; or test -n "$BASE24_SHELL_ENABLE_VARS"
  set -gx BASE24_COLOR_00_HEX "212224"
  set -gx BASE24_COLOR_01_HEX "000000"
  set -gx BASE24_COLOR_02_HEX "5c4f49"
  set -gx BASE24_COLOR_03_HEX "807672"
  set -gx BASE24_COLOR_04_HEX "a49e9b"
  set -gx BASE24_COLOR_05_HEX "c8c5c4"
  set -gx BASE24_COLOR_06_HEX "ededed"
  set -gx BASE24_COLOR_07_HEX "fefffe"
  set -gx BASE24_COLOR_08_HEX "cf0d17"
  set -gx BASE24_COLOR_09_HEX "ffca3d"
  set -gx BASE24_COLOR_0A_HEX "4fc2fd"
  set -gx BASE24_COLOR_0B_HEX "128033"
  set -gx BASE24_COLOR_0C_HEX "384563"
  set -gx BASE24_COLOR_0D_HEX "006ab3"
  set -gx BASE24_COLOR_0E_HEX "6a2674"
  set -gx BASE24_COLOR_0F_HEX "67060b"
end
