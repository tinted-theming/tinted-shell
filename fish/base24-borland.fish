...
set -l color00 "00/00/a4" # Base 00 - Black
set -l color01 "ff/6b/60" # Base 08 - Red
set -l color02 "a7/ff/60" # Base 0B - Green
set -l color03 "b5/dc/fe" # Base 0A - Yellow
set -l color04 "96/ca/fd" # Base 0D - Blue
set -l color05 "ff/73/fd" # Base 0E - Magenta
set -l color06 "c6/c4/fd" # Base 0C - Cyan
set -l color07 "d1/d1/d1" # Base 05 - White
set -l color08 "98/98/98" # Base 03 - Bright Black
...
set -l color16 "ff/ff/b6" # Base 09
set -l color17 "7f/35/30" # Base 0F
set -l color18 "4e/4e/4e" # Base 01
set -l color19 "7c/7c/7c" # Base 02
set -l color20 "b5/b5/b5" # Base 04
set -l color21 "ee/ee/ee" # Base 06
set -l color_foreground "d1/d1/d1" # Base 05
set -l color_background "00/00/a4" # Base 00
...
set -U fish_color_end d1d1d1
set -U fish_color_error brred
set -U fish_color_param b5b5b5
set -U fish_color_valid_path --underline
set -U fish_color_option brcyan
set -U fish_color_comment 989898
set -U fish_color_selection eeeeee --bold --background=7c7c7c
set -U fish_color_operator brblue
set -U fish_color_escape brcyan
set -U fish_color_autosuggestion 989898
...
set -U fish_color_search_match bryellow --background=7c7c7c
set -U fish_color_history_current --bold
set -U fish_pager_color_progress 4e4e4e --background=b5b5b5
set -U fish_pager_color_background normal --background=0000a4
set -U fish_pager_color_prefix normal --bold
set -U fish_pager_color_completion normal
set -U fish_pager_color_description ffffb6 --dim
set -U fish_pager_color_selected_background eeeeee --background=7c7c7c
set -U fish_pager_color_selected_prefix eeeeee --bold --background=7c7c7c
...
# Set theme
set -Ux BASE24_THEME borland

# Optionally export variables
if test -n "$TINTED_SHELL_ENABLE_BASE24_VARS"; or test -n "$BASE24_SHELL_ENABLE_VARS"
  set -gx BASE24_COLOR_00_HEX "0000a4"
  set -gx BASE24_COLOR_01_HEX "4e4e4e"
  set -gx BASE24_COLOR_02_HEX "7c7c7c"
  set -gx BASE24_COLOR_03_HEX "989898"
  set -gx BASE24_COLOR_04_HEX "b5b5b5"
  set -gx BASE24_COLOR_05_HEX "d1d1d1"
  set -gx BASE24_COLOR_06_HEX "eeeeee"
  set -gx BASE24_COLOR_07_HEX "ffffff"
  set -gx BASE24_COLOR_08_HEX "ff6b60"
  set -gx BASE24_COLOR_09_HEX "ffffb6"
  set -gx BASE24_COLOR_0A_HEX "b5dcfe"
  set -gx BASE24_COLOR_0B_HEX "a7ff60"
  set -gx BASE24_COLOR_0C_HEX "c6c4fd"
  set -gx BASE24_COLOR_0D_HEX "96cafd"
  set -gx BASE24_COLOR_0E_HEX "ff73fd"
  set -gx BASE24_COLOR_0F_HEX "7f3530"
end
