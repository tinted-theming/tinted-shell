...
set -U fish_color_selection eeeeee --background=7c7c7c
set -U fish_color_operator magenta
set -U fish_color_escape ffffb6
...
set -U fish_color_search_match yellow --background=7c7c7c
set -U fish_color_history_current --underline=curly
set -U fish_pager_color_progress 4e4e4e --background=b5b5b5
set -U fish_pager_color_background --background=0000a4
set -U fish_pager_color_prefix --bold --italics
set -U fish_pager_color_completion normal
set -U fish_pager_color_description ffffb6
set -U fish_pager_color_selected_background --background=7c7c7c
set -U fish_pager_color_selected_prefix --bold --italics --background=7c7c7c
