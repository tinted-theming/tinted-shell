...
set -l color01 "af/00/5f" # Base 08 - Red
set -l color02 "5f/af/00" # Base 0B - Green
set -l color03 "d7/af/5f" # Base 0A - Yellow
set -l color04 "5f/af/d7" # Base 0D - Blue
set -l color05 "af/87/d7" # Base 0E - Magenta
set -l color06 "ff/af/00" # Base 0C - Cyan
...
set -l color15 "c6/c6/c6" # Base 07 - Bright White
set -l color16 "5f/af/5f" # Base 09
set -l color17 "ff/5f/af" # Base 0F
set -l color18 "30/30/30" # Base 01
set -l color19 "3a/3a/3a" # Base 02
set -l color20 "58/58/58" # Base 04
set -l color21 "bc/bc/bc" # Base 06
...
set -U fish_color_selection bcbcbc --bold --background=3a3a3a
...
set -U fish_color_search_match bryellow --background=3a3a3a
set -U fish_color_history_current --bold
set -U fish_pager_color_progress 303030 --background=585858
set -U fish_pager_color_background normal --background=1c1c1c
set -U fish_pager_color_prefix normal --bold
set -U fish_pager_color_completion normal
set -U fish_pager_color_description 5faf5f --dim
set -U fish_pager_color_selected_background bcbcbc --background=3a3a3a
set -U fish_pager_color_selected_prefix bcbcbc --bold --background=3a3a3a
set -U fish_pager_color_selected_completion bcbcbc
...
# Set theme
set -Ux BASE24_THEME papercolor-dark
...
if test -n "$TINTED_SHELL_ENABLE_BASE24_VARS"; or test -n "$BASE24_SHELL_ENABLE_VARS"
  ...
  set -gx BASE24_COLOR_03_HEX "808080"
  set -gx BASE24_COLOR_04_HEX "585858"
  set -gx BASE24_COLOR_05_HEX "d0d0d0"
  set -gx BASE24_COLOR_06_HEX "bcbcbc"
  set -gx BASE24_COLOR_07_HEX "c6c6c6"
  set -gx BASE24_COLOR_08_HEX "af005f"
  set -gx BASE24_COLOR_09_HEX "5faf5f"
  set -gx BASE24_COLOR_0A_HEX "d7af5f"
  set -gx BASE24_COLOR_0B_HEX "5faf00"
  set -gx BASE24_COLOR_0C_HEX "ffaf00"
  set -gx BASE24_COLOR_0D_HEX "5fafd7"
  set -gx BASE24_COLOR_0E_HEX "af87d7"
  set -gx BASE24_COLOR_0F_HEX "ff5faf"
end
