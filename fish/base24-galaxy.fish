...
set -l color00 "1c/28/36" # Base 00 - Black
set -l color01 "f9/55/5f" # Base 08 - Red
set -l color02 "20/af/89" # Base 0B - Green
set -l color03 "fd/f0/29" # Base 0A - Yellow
set -l color04 "58/9c/f5" # Base 0D - Blue
set -l color05 "93/4d/95" # Base 0E - Magenta
set -l color06 "1e/9e/e6" # Base 0C - Cyan
...
set -l color16 "fd/ba/29" # Base 09
set -l color17 "7c/2a/2f" # Base 0F
...
set -l color_background "1c/28/36" # Base 00
...
if test -n "$ITERM_SESSION_ID"
  ...
  put_template_custom Ph 1c2836 # background
  ...
  put_template_custom Pm 1c2836 # cursor text
else
...
set -U fish_pager_color_background normal --background=1c2836
set -U fish_pager_color_prefix normal --bold
set -U fish_pager_color_completion normal
set -U fish_pager_color_description fdba29 --dim
...
if test -n "$TINTED_SHELL_ENABLE_BASE24_VARS"; or test -n "$BASE24_SHELL_ENABLE_VARS"
  ...
  set -gx BASE24_COLOR_08_HEX "f9555f"
  set -gx BASE24_COLOR_09_HEX "fdba29"
  set -gx BASE24_COLOR_0A_HEX "fdf029"
  set -gx BASE24_COLOR_0B_HEX "20af89"
  set -gx BASE24_COLOR_0C_HEX "1e9ee6"
  set -gx BASE24_COLOR_0D_HEX "589cf5"
  set -gx BASE24_COLOR_0E_HEX "934d95"
  set -gx BASE24_COLOR_0F_HEX "7c2a2f"
end
