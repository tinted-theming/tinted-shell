...
set -l color00 "19/01/34" # Base 00 - Black
set -l color01 "27/d9/d5" # Base 08 - Red
set -l color02 "c3/36/78" # Base 0B - Green
set -l color03 "8f/6c/97" # Base 0A - Yellow
set -l color04 "bd/01/52" # Base 0D - Blue
set -l color05 "82/03/4c" # Base 0E - Magenta
set -l color06 "f8/00/59" # Base 0C - Cyan
set -l color07 "bd/b6/c5" # Base 05 - White
set -l color08 "7b/6d/8b" # Base 03 - Bright Black
...
set -l color16 "5b/a2/b6" # Base 09
set -l color17 "47/05/46" # Base 0F
set -l color18 "39/25/51" # Base 01
set -l color19 "5a/49/6e" # Base 02
set -l color20 "9c/92/a8" # Base 04
set -l color21 "de/da/e2" # Base 06
set -l color_foreground "bd/b6/c5" # Base 05
set -l color_background "19/01/34" # Base 00
...
set -U fish_pager_color_progress 392551 --background=9c92a8
set -U fish_pager_color_background normal --background=190134
set -U fish_pager_color_prefix normal --bold
set -U fish_pager_color_completion normal
set -U fish_pager_color_description 5ba2b6 --dim
set -U fish_pager_color_selected_background dedae2 --background=5a496e
set -U fish_pager_color_selected_prefix dedae2 --bold --background=5a496e
set -U fish_pager_color_selected_completion dedae2
...
# Set theme
set -Ux BASE16_THEME heetch

# Optionally export variables
if test -n "$TINTED_SHELL_ENABLE_BASE16_VARS"; or test -n "$BASE16_SHELL_ENABLE_VARS"
  set -gx BASE16_COLOR_00_HEX "190134"
  set -gx BASE16_COLOR_01_HEX "392551"
  set -gx BASE16_COLOR_02_HEX "5a496e"
  set -gx BASE16_COLOR_03_HEX "7b6d8b"
  set -gx BASE16_COLOR_04_HEX "9c92a8"
  set -gx BASE16_COLOR_05_HEX "bdb6c5"
  set -gx BASE16_COLOR_06_HEX "dedae2"
  set -gx BASE16_COLOR_07_HEX "feffff"
  set -gx BASE16_COLOR_08_HEX "27d9d5"
  set -gx BASE16_COLOR_09_HEX "5ba2b6"
  set -gx BASE16_COLOR_0A_HEX "8f6c97"
  set -gx BASE16_COLOR_0B_HEX "c33678"
  set -gx BASE16_COLOR_0C_HEX "f80059"
  set -gx BASE16_COLOR_0D_HEX "bd0152"
  set -gx BASE16_COLOR_0E_HEX "82034c"
  set -gx BASE16_COLOR_0F_HEX "470546"
end
