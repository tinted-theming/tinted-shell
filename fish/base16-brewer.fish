...
set -U fish_pager_color_background normal --background=0c0d0e
set -U fish_pager_color_prefix normal --bold
set -U fish_pager_color_completion normal
set -U fish_pager_color_description e6550d --dim
set -U fish_pager_color_selected_background dadbdc --background=515253
set -U fish_pager_color_selected_prefix dadbdc --bold --background=515253
set -U fish_pager_color_selected_completion dadbdc
