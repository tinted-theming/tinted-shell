...
set -U fish_color_end cad3f5
set -U fish_color_error brred
set -U fish_color_param 5b6078
set -U fish_color_valid_path --underline
set -U fish_color_option brcyan
set -U fish_color_comment 494d64
set -U fish_color_selection f4dbd6 --bold --background=363a4f
...
set -U fish_color_search_match bryellow --background=363a4f
set -U fish_color_history_current --bold
set -U fish_pager_color_progress 1e2030 --background=5b6078
set -U fish_pager_color_background normal --background=24273a
set -U fish_pager_color_prefix normal --bold
set -U fish_pager_color_completion normal
set -U fish_pager_color_description f5a97f --dim
set -U fish_pager_color_selected_background f4dbd6 --background=363a4f
set -U fish_pager_color_selected_prefix f4dbd6 --bold --background=363a4f
set -U fish_pager_color_selected_completion f4dbd6
...
# Set theme
set -Ux BASE16_THEME catppuccin-macchiato

# Optionally export variables
if test -n "$TINTED_SHELL_ENABLE_BASE16_VARS"; or test -n "$BASE16_SHELL_ENABLE_VARS"
  set -gx BASE16_COLOR_00_HEX "24273a"
  set -gx BASE16_COLOR_01_HEX "1e2030"
  set -gx BASE16_COLOR_02_HEX "363a4f"
  set -gx BASE16_COLOR_03_HEX "494d64"
  set -gx BASE16_COLOR_04_HEX "5b6078"
  set -gx BASE16_COLOR_05_HEX "cad3f5"
  set -gx BASE16_COLOR_06_HEX "f4dbd6"
  set -gx BASE16_COLOR_07_HEX "b7bdf8"
  set -gx BASE16_COLOR_08_HEX "ed8796"
  set -gx BASE16_COLOR_09_HEX "f5a97f"
  set -gx BASE16_COLOR_0A_HEX "eed49f"
  set -gx BASE16_COLOR_0B_HEX "a6da95"
  set -gx BASE16_COLOR_0C_HEX "8bd5ca"
  set -gx BASE16_COLOR_0D_HEX "8aadf4"
  set -gx BASE16_COLOR_0E_HEX "c6a0f6"
  set -gx BASE16_COLOR_0F_HEX "f0c6c6"
end
