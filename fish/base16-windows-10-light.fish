...
set -l color00 "f2/f2/f2" # Base 00 - Black
set -l color01 "c5/0f/1f" # Base 08 - Red
set -l color02 "13/a1/0e" # Base 0B - Green
set -l color03 "c1/9c/00" # Base 0A - Yellow
set -l color04 "00/37/da" # Base 0D - Blue
set -l color05 "88/17/98" # Base 0E - Magenta
set -l color06 "3a/96/dd" # Base 0C - Cyan
set -l color07 "76/76/76" # Base 05 - White
...
set -l color15 "0c/0c/0c" # Base 07 - Bright White
set -l color16 "f9/f1/a5" # Base 09
set -l color17 "16/c6/0c" # Base 0F
set -l color18 "e5/e5/e5" # Base 01
set -l color19 "d9/d9/d9" # Base 02
set -l color20 "ab/ab/ab" # Base 04
set -l color21 "41/41/41" # Base 06
set -l color_foreground "76/76/76" # Base 05
set -l color_background "f2/f2/f2" # Base 00
...
set -U fish_color_selection 414141 --bold --background=d9d9d9
...
set -U fish_pager_color_progress e5e5e5 --background=ababab
set -U fish_pager_color_background normal --background=f2f2f2
set -U fish_pager_color_prefix normal --bold
set -U fish_pager_color_completion normal
set -U fish_pager_color_description f9f1a5 --dim
set -U fish_pager_color_selected_background 414141 --background=d9d9d9
set -U fish_pager_color_selected_prefix 414141 --bold --background=d9d9d9
...
# Set theme
set -Ux BASE16_THEME windows-10-light

# Optionally export variables
if test -n "$TINTED_SHELL_ENABLE_BASE16_VARS"; or test -n "$BASE16_SHELL_ENABLE_VARS"
  set -gx BASE16_COLOR_00_HEX "f2f2f2"
  set -gx BASE16_COLOR_01_HEX "e5e5e5"
  set -gx BASE16_COLOR_02_HEX "d9d9d9"
  set -gx BASE16_COLOR_03_HEX "cccccc"
  set -gx BASE16_COLOR_04_HEX "ababab"
  set -gx BASE16_COLOR_05_HEX "767676"
  set -gx BASE16_COLOR_06_HEX "414141"
  set -gx BASE16_COLOR_07_HEX "0c0c0c"
  set -gx BASE16_COLOR_08_HEX "c50f1f"
  set -gx BASE16_COLOR_09_HEX "f9f1a5"
  set -gx BASE16_COLOR_0A_HEX "c19c00"
  set -gx BASE16_COLOR_0B_HEX "13a10e"
  set -gx BASE16_COLOR_0C_HEX "3a96dd"
  set -gx BASE16_COLOR_0D_HEX "0037da"
  set -gx BASE16_COLOR_0E_HEX "881798"
  set -gx BASE16_COLOR_0F_HEX "16c60c"
end
