...
set -l color00 "02/10/12" # Base 00 - Black
set -l color01 "16/c1/d9" # Base 08 - Red
set -l color02 "4d/d0/e1" # Base 0B - Green
set -l color03 "80/de/ea" # Base 0A - Yellow
set -l color04 "00/bc/d4" # Base 0D - Blue
set -l color05 "00/ac/c1" # Base 0E - Magenta
set -l color06 "26/c6/da" # Base 0C - Cyan
set -l color07 "09/5b/67" # Base 05 - White
set -l color08 "05/2e/34" # Base 03 - Bright Black
...
set -l color15 "10/9c/b0" # Base 07 - Bright White
set -l color16 "b3/eb/f2" # Base 09
set -l color17 "00/97/a7" # Base 0F
set -l color18 "03/16/19" # Base 01
set -l color19 "04/1f/23" # Base 02
set -l color20 "06/40/48" # Base 04
set -l color21 "0c/7c/8c" # Base 06
set -l color_foreground "09/5b/67" # Base 05
set -l color_background "02/10/12" # Base 00
...
set -U fish_color_end 095b67
set -U fish_color_error brred
set -U fish_color_param 064048
set -U fish_color_valid_path --underline
set -U fish_color_option brcyan
set -U fish_color_comment 052e34
set -U fish_color_selection 0c7c8c --bold --background=041f23
set -U fish_color_operator brblue
set -U fish_color_escape brcyan
set -U fish_color_autosuggestion 052e34
...
set -U fish_pager_color_progress 031619 --background=064048
set -U fish_pager_color_background normal --background=021012
set -U fish_pager_color_prefix normal --bold
set -U fish_pager_color_completion normal
set -U fish_pager_color_description b3ebf2 --dim
set -U fish_pager_color_selected_background 0c7c8c --background=041f23
set -U fish_pager_color_selected_prefix 0c7c8c --bold --background=041f23
set -U fish_pager_color_selected_completion 0c7c8c
...
# Set theme
set -Ux BASE16_THEME icy

# Optionally export variables
if test -n "$TINTED_SHELL_ENABLE_BASE16_VARS"; or test -n "$BASE16_SHELL_ENABLE_VARS"
  set -gx BASE16_COLOR_00_HEX "021012"
  set -gx BASE16_COLOR_01_HEX "031619"
  set -gx BASE16_COLOR_02_HEX "041f23"
  set -gx BASE16_COLOR_03_HEX "052e34"
  set -gx BASE16_COLOR_04_HEX "064048"
  set -gx BASE16_COLOR_05_HEX "095b67"
  set -gx BASE16_COLOR_06_HEX "0c7c8c"
  set -gx BASE16_COLOR_07_HEX "109cb0"
  set -gx BASE16_COLOR_08_HEX "16c1d9"
  set -gx BASE16_COLOR_09_HEX "b3ebf2"
  set -gx BASE16_COLOR_0A_HEX "80deea"
  set -gx BASE16_COLOR_0B_HEX "4dd0e1"
  set -gx BASE16_COLOR_0C_HEX "26c6da"
  set -gx BASE16_COLOR_0D_HEX "00bcd4"
  set -gx BASE16_COLOR_0E_HEX "00acc1"
  set -gx BASE16_COLOR_0F_HEX "0097a7"
end
