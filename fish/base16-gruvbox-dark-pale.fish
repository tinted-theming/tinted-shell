...
set -l color01 "d7/5f/5f" # Base 08 - Red
set -l color02 "af/af/00" # Base 0B - Green
set -l color03 "ff/af/00" # Base 0A - Yellow
set -l color04 "83/ad/ad" # Base 0D - Blue
set -l color05 "d4/85/ad" # Base 0E - Magenta
set -l color06 "85/ad/85" # Base 0C - Cyan
set -l color07 "da/b9/97" # Base 05 - White
set -l color08 "8a/8a/8a" # Base 03 - Bright Black
...
set -l color15 "eb/db/b2" # Base 07 - Bright White
set -l color16 "ff/87/00" # Base 09
set -l color17 "d6/5d/0e" # Base 0F
set -l color18 "3a/3a/3a" # Base 01
set -l color19 "4e/4e/4e" # Base 02
set -l color20 "94/94/94" # Base 04
set -l color21 "d5/c4/a1" # Base 06
set -l color_foreground "da/b9/97" # Base 05
...
set -U fish_pager_color_progress 3a3a3a --background=949494
...
set -U fish_pager_color_selected_background d5c4a1 --background=4e4e4e
set -U fish_pager_color_selected_prefix d5c4a1 --bold --background=4e4e4e
...
# Set theme
set -Ux BASE16_THEME gruvbox-dark-pale

# Optionally export variables
if test -n "$TINTED_SHELL_ENABLE_BASE16_VARS"; or test -n "$BASE16_SHELL_ENABLE_VARS"
  set -gx BASE16_COLOR_00_HEX "262626"
  set -gx BASE16_COLOR_01_HEX "3a3a3a"
  set -gx BASE16_COLOR_02_HEX "4e4e4e"
  set -gx BASE16_COLOR_03_HEX "8a8a8a"
  set -gx BASE16_COLOR_04_HEX "949494"
  set -gx BASE16_COLOR_05_HEX "dab997"
  set -gx BASE16_COLOR_06_HEX "d5c4a1"
  set -gx BASE16_COLOR_07_HEX "ebdbb2"
  set -gx BASE16_COLOR_08_HEX "d75f5f"
  set -gx BASE16_COLOR_09_HEX "ff8700"
  set -gx BASE16_COLOR_0A_HEX "ffaf00"
  set -gx BASE16_COLOR_0B_HEX "afaf00"
  set -gx BASE16_COLOR_0C_HEX "85ad85"
  set -gx BASE16_COLOR_0D_HEX "83adad"
  set -gx BASE16_COLOR_0E_HEX "d485ad"
