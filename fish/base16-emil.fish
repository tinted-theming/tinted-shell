...
set -l color00 "ef/ef/ef" # Base 00 - Black
set -l color01 "f4/39/79" # Base 08 - Red
set -l color02 "00/73/a8" # Base 0B - Green
set -l color03 "ff/66/9b" # Base 0A - Yellow
set -l color04 "47/13/97" # Base 0D - Blue
set -l color05 "69/16/b6" # Base 0E - Magenta
set -l color06 "21/55/d6" # Base 0C - Cyan
set -l color07 "31/31/45" # Base 05 - White
set -l color08 "7c/7c/98" # Base 03 - Bright Black
...
set -l color15 "1a/1a/2f" # Base 07 - Bright White
set -l color16 "d2/2a/8b" # Base 09
set -l color17 "8d/17/a5" # Base 0F
set -l color18 "be/be/d2" # Base 01
set -l color19 "9e/9e/af" # Base 02
set -l color20 "50/50/63" # Base 04
set -l color21 "22/22/3a" # Base 06
set -l color_foreground "31/31/45" # Base 05
set -l color_background "ef/ef/ef" # Base 00
...
set -U fish_color_end 313145
set -U fish_color_error brred
set -U fish_color_param 505063
set -U fish_color_valid_path --underline
set -U fish_color_option brcyan
set -U fish_color_comment 7c7c98
set -U fish_color_selection 22223a --bold --background=9e9eaf
set -U fish_color_operator brblue
set -U fish_color_escape brcyan
set -U fish_color_autosuggestion 7c7c98
...
set -U fish_color_search_match bryellow --background=9e9eaf
set -U fish_color_history_current --bold
set -U fish_pager_color_progress bebed2 --background=505063
set -U fish_pager_color_background normal --background=efefef
set -U fish_pager_color_prefix normal --bold
set -U fish_pager_color_completion normal
set -U fish_pager_color_description d22a8b --dim
set -U fish_pager_color_selected_background 22223a --background=9e9eaf
set -U fish_pager_color_selected_prefix 22223a --bold --background=9e9eaf
set -U fish_pager_color_selected_completion 22223a
...
# Set theme
set -Ux BASE16_THEME emil

# Optionally export variables
if test -n "$TINTED_SHELL_ENABLE_BASE16_VARS"; or test -n "$BASE16_SHELL_ENABLE_VARS"
  set -gx BASE16_COLOR_00_HEX "efefef"
  set -gx BASE16_COLOR_01_HEX "bebed2"
  set -gx BASE16_COLOR_02_HEX "9e9eaf"
  set -gx BASE16_COLOR_03_HEX "7c7c98"
  set -gx BASE16_COLOR_04_HEX "505063"
  set -gx BASE16_COLOR_05_HEX "313145"
  set -gx BASE16_COLOR_06_HEX "22223a"
  set -gx BASE16_COLOR_07_HEX "1a1a2f"
  set -gx BASE16_COLOR_08_HEX "f43979"
  set -gx BASE16_COLOR_09_HEX "d22a8b"
  set -gx BASE16_COLOR_0A_HEX "ff669b"
  set -gx BASE16_COLOR_0B_HEX "0073a8"
  set -gx BASE16_COLOR_0C_HEX "2155d6"
  set -gx BASE16_COLOR_0D_HEX "471397"
  set -gx BASE16_COLOR_0E_HEX "6916b6"
  set -gx BASE16_COLOR_0F_HEX "8d17a5"
end
