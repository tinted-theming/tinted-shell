...
# Set theme
set -Ux BASE16_THEME ayu-mirage

# Optionally export variables
if test -n "$TINTED_SHELL_ENABLE_BASE16_VARS"; or test -n "$BASE16_SHELL_ENABLE_VARS"
  set -gx BASE16_COLOR_00_HEX "1f2430"
  set -gx BASE16_COLOR_01_HEX "242936"
  set -gx BASE16_COLOR_02_HEX "323844"
  set -gx BASE16_COLOR_03_HEX "4a5059"
  set -gx BASE16_COLOR_04_HEX "707a8c"
  set -gx BASE16_COLOR_05_HEX "cccac2"
  set -gx BASE16_COLOR_06_HEX "d9d7ce"
  set -gx BASE16_COLOR_07_HEX "f3f4f5"
  set -gx BASE16_COLOR_08_HEX "f28779"
  set -gx BASE16_COLOR_09_HEX "ffad66"
  set -gx BASE16_COLOR_0A_HEX "ffd173"
  set -gx BASE16_COLOR_0B_HEX "d5ff80"
  set -gx BASE16_COLOR_0C_HEX "95e6cb"
  set -gx BASE16_COLOR_0D_HEX "73d0ff"
  set -gx BASE16_COLOR_0E_HEX "d4bfff"
  set -gx BASE16_COLOR_0F_HEX "f27983"
end
