...
set -U fish_color_selection eeeeee --background=4a4a4a
set -U fish_color_operator magenta
set -U fish_color_escape fdb40b
...
set -U fish_color_search_match yellow --background=4a4a4a
set -U fish_color_history_current --underline=curly
set -U fish_pager_color_progress 242424 --background=9c9c9c
set -U fish_pager_color_background --background=181818
set -U fish_pager_color_prefix --bold --italics
set -U fish_pager_color_completion normal
set -U fish_pager_color_description fdb40b
set -U fish_pager_color_selected_background --background=4a4a4a
set -U fish_pager_color_selected_prefix --bold --italics --background=4a4a4a
