...
set -l color00 "18/18/18" # Base 00 - Black
set -l color01 "d6/1b/15" # Base 08 - Red
set -l color02 "59/a4/13" # Base 0B - Green
set -l color03 "08/55/fe" # Base 0A - Yellow
set -l color04 "05/3a/8c" # Base 0D - Blue
set -l color05 "e4/00/38" # Base 0E - Magenta
set -l color06 "25/94/e0" # Base 0C - Cyan
set -l color07 "c5/c5/c5" # Base 05 - White
set -l color08 "73/73/73" # Base 03 - Bright Black
...
set -l color15 "8c/00/eb" # Base 07 - Bright White
set -l color16 "fd/b4/0b" # Base 09
set -l color17 "6b/0d/0a" # Base 0F
set -l color18 "24/24/24" # Base 01
set -l color19 "4a/4a/4a" # Base 02
set -l color20 "9c/9c/9c" # Base 04
set -l color21 "ee/ee/ee" # Base 06
set -l color_foreground "c5/c5/c5" # Base 05
set -l color_background "18/18/18" # Base 00
...
set -U fish_color_end c5c5c5
set -U fish_color_error brred
set -U fish_color_param 9c9c9c
set -U fish_color_valid_path --underline
set -U fish_color_option brcyan
set -U fish_color_comment 737373
set -U fish_color_selection eeeeee --bold --background=4a4a4a
...
set -U fish_color_search_match bryellow --background=4a4a4a
set -U fish_color_history_current --bold
set -U fish_pager_color_progress 242424 --background=9c9c9c
set -U fish_pager_color_background normal --background=181818
set -U fish_pager_color_prefix normal --bold
set -U fish_pager_color_completion normal
set -U fish_pager_color_description fdb40b --dim
set -U fish_pager_color_selected_background eeeeee --background=4a4a4a
set -U fish_pager_color_selected_prefix eeeeee --bold --background=4a4a4a
set -U fish_pager_color_selected_completion eeeeee
...
# Set theme
set -Ux BASE24_THEME elementary

# Optionally export variables
if test -n "$TINTED_SHELL_ENABLE_BASE24_VARS"; or test -n "$BASE24_SHELL_ENABLE_VARS"
  set -gx BASE24_COLOR_00_HEX "181818"
  set -gx BASE24_COLOR_01_HEX "242424"
  set -gx BASE24_COLOR_02_HEX "4a4a4a"
  set -gx BASE24_COLOR_03_HEX "737373"
  set -gx BASE24_COLOR_04_HEX "9c9c9c"
  set -gx BASE24_COLOR_05_HEX "c5c5c5"
  set -gx BASE24_COLOR_06_HEX "eeeeee"
  set -gx BASE24_COLOR_07_HEX "8c00eb"
  set -gx BASE24_COLOR_08_HEX "d61b15"
  set -gx BASE24_COLOR_09_HEX "fdb40b"
  set -gx BASE24_COLOR_0A_HEX "0855fe"
  set -gx BASE24_COLOR_0B_HEX "59a413"
  set -gx BASE24_COLOR_0C_HEX "2594e0"
  set -gx BASE24_COLOR_0D_HEX "053a8c"
  set -gx BASE24_COLOR_0E_HEX "e40038"
  set -gx BASE24_COLOR_0F_HEX "6b0d0a"
end
