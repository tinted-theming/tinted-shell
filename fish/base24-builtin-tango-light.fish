...
set -l color02 "4e/9a/05" # Base 0B - Green
set -l color03 "71/9e/cf" # Base 0A - Yellow
set -l color04 "34/64/a4" # Base 0D - Blue
set -l color05 "74/50/7a" # Base 0E - Magenta
...
set -U fish_color_param 939791
set -U fish_color_valid_path --underline
set -U fish_color_option brcyan
set -U fish_color_comment 737772
set -U fish_color_selection d3d7cf --bold --background=545753
...
set -U fish_pager_color_selected_background d3d7cf --background=545753
set -U fish_pager_color_selected_prefix d3d7cf --bold --background=545753
...
# Set theme
set -Ux BASE24_THEME builtin-tango-light
...
if test -n "$TINTED_SHELL_ENABLE_BASE24_VARS"; or test -n "$BASE24_SHELL_ENABLE_VARS"
  ...
  set -gx BASE24_COLOR_0A_HEX "719ecf"
  set -gx BASE24_COLOR_0B_HEX "4e9a05"
  set -gx BASE24_COLOR_0C_HEX "05989a"
  set -gx BASE24_COLOR_0D_HEX "3464a4"
  set -gx BASE24_COLOR_0E_HEX "74507a"
