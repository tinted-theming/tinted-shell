...
set -l color01 "e4/49/2b" # Base 08 - Red
set -l color02 "50/d0/48" # Base 0B - Green
set -l color03 "c5/c3/40" # Base 0A - Yellow
set -l color04 "3a/75/ff" # Base 0D - Blue
set -l color05 "ec/65/e7" # Base 0E - Magenta
set -l color06 "4e/d1/dd" # Base 0C - Cyan
...
set -l color16 "c5/8e/40" # Base 09
set -l color17 "72/24/15" # Base 0F
...
set -U fish_color_end 4f4f4f
set -U fish_color_error brred
set -U fish_color_param 757575
set -U fish_color_valid_path --underline
set -U fish_color_option brcyan
set -U fish_color_comment cccccc
set -U fish_color_selection 323232 --bold --background=dcdcdc
...
set -U fish_color_search_match bryellow --background=dcdcdc
set -U fish_color_history_current --bold
set -U fish_pager_color_progress f1f1f1 --background=757575
set -U fish_pager_color_background normal --background=feffff
set -U fish_pager_color_prefix normal --bold
set -U fish_pager_color_completion normal
set -U fish_pager_color_description c58e40 --dim
set -U fish_pager_color_selected_background 323232 --background=dcdcdc
set -U fish_pager_color_selected_prefix 323232 --bold --background=dcdcdc
set -U fish_pager_color_selected_completion 323232
...
if test -n "$TINTED_SHELL_ENABLE_BASE24_VARS"; or test -n "$BASE24_SHELL_ENABLE_VARS"
  ...
  set -gx BASE24_COLOR_08_HEX "e4492b"
  set -gx BASE24_COLOR_09_HEX "c58e40"
  set -gx BASE24_COLOR_0A_HEX "c5c340"
  set -gx BASE24_COLOR_0B_HEX "50d048"
  set -gx BASE24_COLOR_0C_HEX "4ed1dd"
  set -gx BASE24_COLOR_0D_HEX "3a75ff"
  set -gx BASE24_COLOR_0E_HEX "ec65e7"
  set -gx BASE24_COLOR_0F_HEX "722415"
end
