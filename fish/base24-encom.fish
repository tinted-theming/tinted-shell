...
set -l color01 "9f/00/00" # Base 08 - Red
set -l color02 "00/8b/00" # Base 0B - Green
set -l color03 "00/00/ff" # Base 0A - Yellow
set -l color04 "00/81/ff" # Base 0D - Blue
set -l color05 "bc/00/ca" # Base 0E - Magenta
set -l color06 "00/8b/8b" # Base 0C - Cyan
...
set -l color16 "ff/cf/00" # Base 09
set -l color17 "4f/00/00" # Base 0F
...
set -U fish_pager_color_description ffcf00 --dim
...
if test -n "$TINTED_SHELL_ENABLE_BASE24_VARS"; or test -n "$BASE24_SHELL_ENABLE_VARS"
  ...
  set -gx BASE24_COLOR_08_HEX "9f0000"
  set -gx BASE24_COLOR_09_HEX "ffcf00"
  set -gx BASE24_COLOR_0A_HEX "0000ff"
  set -gx BASE24_COLOR_0B_HEX "008b00"
  set -gx BASE24_COLOR_0C_HEX "008b8b"
  set -gx BASE24_COLOR_0D_HEX "0081ff"
  set -gx BASE24_COLOR_0E_HEX "bc00ca"
  set -gx BASE24_COLOR_0F_HEX "4f0000"
end
