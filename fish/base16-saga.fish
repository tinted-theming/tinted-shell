...
set -l color00 "05/08/0a" # Base 00 - Black
set -l color01 "ff/d4/e9" # Base 08 - Red
set -l color02 "f7/dd/ff" # Base 0B - Green
set -l color03 "fb/eb/c8" # Base 0A - Yellow
set -l color04 "c9/ff/f7" # Base 0D - Blue
set -l color05 "dc/c3/f9" # Base 0E - Magenta
set -l color06 "c5/ed/c1" # Base 0C - Cyan
set -l color07 "dc/e2/f7" # Base 05 - White
set -l color08 "14/1f/27" # Base 03 - Bright Black
...
set -l color15 "cc/d3/fe" # Base 07 - Bright White
set -l color16 "fb/cb/ae" # Base 09
set -l color17 "f6/dd/dd" # Base 0F
set -l color18 "0a/10/14" # Base 01
set -l color19 "0f/18/1e" # Base 02
set -l color20 "19/26/30" # Base 04
set -l color21 "f8/ea/e7" # Base 06
set -l color_foreground "dc/e2/f7" # Base 05
set -l color_background "05/08/0a" # Base 00
...
set -U fish_color_end dce2f7
set -U fish_color_error brred
set -U fish_color_param 192630
set -U fish_color_valid_path --underline
set -U fish_color_option brcyan
set -U fish_color_comment 141f27
set -U fish_color_selection f8eae7 --bold --background=0f181e
set -U fish_color_operator brblue
set -U fish_color_escape brcyan
set -U fish_color_autosuggestion 141f27
...
set -U fish_color_search_match bryellow --background=0f181e
set -U fish_color_history_current --bold
set -U fish_pager_color_progress 0a1014 --background=192630
set -U fish_pager_color_background normal --background=05080a
set -U fish_pager_color_prefix normal --bold
set -U fish_pager_color_completion normal
set -U fish_pager_color_description fbcbae --dim
set -U fish_pager_color_selected_background f8eae7 --background=0f181e
set -U fish_pager_color_selected_prefix f8eae7 --bold --background=0f181e
set -U fish_pager_color_selected_completion f8eae7
...
# Set theme
set -Ux BASE16_THEME saga

# Optionally export variables
if test -n "$TINTED_SHELL_ENABLE_BASE16_VARS"; or test -n "$BASE16_SHELL_ENABLE_VARS"
  set -gx BASE16_COLOR_00_HEX "05080a"
  set -gx BASE16_COLOR_01_HEX "0a1014"
  set -gx BASE16_COLOR_02_HEX "0f181e"
  set -gx BASE16_COLOR_03_HEX "141f27"
  set -gx BASE16_COLOR_04_HEX "192630"
  set -gx BASE16_COLOR_05_HEX "dce2f7"
  set -gx BASE16_COLOR_06_HEX "f8eae7"
  set -gx BASE16_COLOR_07_HEX "ccd3fe"
  set -gx BASE16_COLOR_08_HEX "ffd4e9"
  set -gx BASE16_COLOR_09_HEX "fbcbae"
  set -gx BASE16_COLOR_0A_HEX "fbebc8"
  set -gx BASE16_COLOR_0B_HEX "f7ddff"
  set -gx BASE16_COLOR_0C_HEX "c5edc1"
  set -gx BASE16_COLOR_0D_HEX "c9fff7"
  set -gx BASE16_COLOR_0E_HEX "dcc3f9"
  set -gx BASE16_COLOR_0F_HEX "f6dddd"
end
