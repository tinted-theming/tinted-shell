...
set -l color00 "00/11/00" # Base 00 - Black
set -l color01 "00/77/00" # Base 08 - Red
set -l color02 "00/bb/00" # Base 0B - Green
set -l color03 "00/77/00" # Base 0A - Yellow
set -l color04 "00/99/00" # Base 0D - Blue
set -l color05 "00/bb/00" # Base 0E - Magenta
set -l color06 "00/55/00" # Base 0C - Cyan
set -l color07 "00/bb/00" # Base 05 - White
set -l color08 "00/77/00" # Base 03 - Bright Black
...
set -l color15 "00/ff/00" # Base 07 - Bright White
set -l color16 "00/99/00" # Base 09
set -l color17 "00/55/00" # Base 0F
set -l color18 "00/33/00" # Base 01
set -l color19 "00/55/00" # Base 02
set -l color20 "00/99/00" # Base 04
set -l color21 "00/dd/00" # Base 06
set -l color_foreground "00/bb/00" # Base 05
set -l color_background "00/11/00" # Base 00
...
set -U fish_color_end 00bb00
set -U fish_color_error brred
set -U fish_color_param 009900
set -U fish_color_valid_path --underline
set -U fish_color_option brcyan
set -U fish_color_comment 007700
set -U fish_color_selection 00dd00 --bold --background=005500
set -U fish_color_operator brblue
set -U fish_color_escape brcyan
set -U fish_color_autosuggestion 007700
...
set -U fish_pager_color_progress 003300 --background=009900
set -U fish_pager_color_background normal --background=001100
set -U fish_pager_color_prefix normal --bold
set -U fish_pager_color_completion normal
set -U fish_pager_color_description 009900 --dim
set -U fish_pager_color_selected_background 00dd00 --background=005500
set -U fish_pager_color_selected_prefix 00dd00 --bold --background=005500
set -U fish_pager_color_selected_completion 00dd00
...
# Set theme
set -Ux BASE16_THEME greenscreen

# Optionally export variables
if test -n "$TINTED_SHELL_ENABLE_BASE16_VARS"; or test -n "$BASE16_SHELL_ENABLE_VARS"
  set -gx BASE16_COLOR_00_HEX "001100"
  set -gx BASE16_COLOR_01_HEX "003300"
  set -gx BASE16_COLOR_02_HEX "005500"
  set -gx BASE16_COLOR_03_HEX "007700"
  set -gx BASE16_COLOR_04_HEX "009900"
  set -gx BASE16_COLOR_05_HEX "00bb00"
  set -gx BASE16_COLOR_06_HEX "00dd00"
  set -gx BASE16_COLOR_07_HEX "00ff00"
  set -gx BASE16_COLOR_08_HEX "007700"
  set -gx BASE16_COLOR_09_HEX "009900"
  set -gx BASE16_COLOR_0A_HEX "007700"
  set -gx BASE16_COLOR_0B_HEX "00bb00"
  set -gx BASE16_COLOR_0C_HEX "005500"
  set -gx BASE16_COLOR_0D_HEX "009900"
  set -gx BASE16_COLOR_0E_HEX "00bb00"
  set -gx BASE16_COLOR_0F_HEX "005500"
end
