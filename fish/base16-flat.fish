...
set -l color00 "2c/3e/50" # Base 00 - Black
set -l color01 "e7/4c/3c" # Base 08 - Red
set -l color02 "2e/cc/71" # Base 0B - Green
set -l color03 "f1/c4/0f" # Base 0A - Yellow
set -l color04 "34/98/db" # Base 0D - Blue
set -l color05 "9b/59/b6" # Base 0E - Magenta
set -l color06 "1a/bc/9c" # Base 0C - Cyan
set -l color07 "e0/e0/e0" # Base 05 - White
set -l color08 "95/a5/a6" # Base 03 - Bright Black
...
set -l color15 "ec/f0/f1" # Base 07 - Bright White
set -l color16 "e6/7e/22" # Base 09
set -l color17 "be/64/3c" # Base 0F
set -l color18 "34/49/5e" # Base 01
set -l color19 "7f/8c/8d" # Base 02
set -l color20 "bd/c3/c7" # Base 04
set -l color21 "f5/f5/f5" # Base 06
set -l color_foreground "e0/e0/e0" # Base 05
set -l color_background "2c/3e/50" # Base 00
...
set -U fish_color_end e0e0e0
set -U fish_color_error brred
set -U fish_color_param bdc3c7
set -U fish_color_valid_path --underline
set -U fish_color_option brcyan
set -U fish_color_comment 95a5a6
set -U fish_color_selection f5f5f5 --bold --background=7f8c8d
set -U fish_color_operator brblue
set -U fish_color_escape brcyan
set -U fish_color_autosuggestion 95a5a6
...
set -U fish_pager_color_progress 34495e --background=bdc3c7
set -U fish_pager_color_background normal --background=2c3e50
set -U fish_pager_color_prefix normal --bold
set -U fish_pager_color_completion normal
set -U fish_pager_color_description e67e22 --dim
set -U fish_pager_color_selected_background f5f5f5 --background=7f8c8d
set -U fish_pager_color_selected_prefix f5f5f5 --bold --background=7f8c8d
...
# Set theme
set -Ux BASE16_THEME flat

# Optionally export variables
if test -n "$TINTED_SHELL_ENABLE_BASE16_VARS"; or test -n "$BASE16_SHELL_ENABLE_VARS"
  set -gx BASE16_COLOR_00_HEX "2c3e50"
  set -gx BASE16_COLOR_01_HEX "34495e"
  set -gx BASE16_COLOR_02_HEX "7f8c8d"
  set -gx BASE16_COLOR_03_HEX "95a5a6"
  set -gx BASE16_COLOR_04_HEX "bdc3c7"
  set -gx BASE16_COLOR_05_HEX "e0e0e0"
  set -gx BASE16_COLOR_06_HEX "f5f5f5"
  set -gx BASE16_COLOR_07_HEX "ecf0f1"
  set -gx BASE16_COLOR_08_HEX "e74c3c"
  set -gx BASE16_COLOR_09_HEX "e67e22"
  set -gx BASE16_COLOR_0A_HEX "f1c40f"
  set -gx BASE16_COLOR_0B_HEX "2ecc71"
  set -gx BASE16_COLOR_0C_HEX "1abc9c"
  set -gx BASE16_COLOR_0D_HEX "3498db"
  set -gx BASE16_COLOR_0E_HEX "9b59b6"
  set -gx BASE16_COLOR_0F_HEX "be643c"
end
