...
set -l color00 "f1/ef/ee" # Base 00 - Black
set -l color01 "f2/2c/40" # Base 08 - Red
set -l color02 "7b/97/26" # Base 0B - Green
set -l color03 "c3/84/18" # Base 0A - Yellow
set -l color04 "40/7e/e7" # Base 0D - Blue
set -l color05 "66/66/ea" # Base 0E - Magenta
set -l color06 "3d/97/b8" # Base 0C - Cyan
set -l color07 "68/61/5e" # Base 05 - White
set -l color08 "9c/94/91" # Base 03 - Bright Black
...
set -l color15 "1b/19/18" # Base 07 - Bright White
set -l color16 "df/53/20" # Base 09
set -l color17 "c3/3f/f3" # Base 0F
set -l color18 "e6/e2/e0" # Base 01
set -l color19 "a8/a1/9f" # Base 02
set -l color20 "76/6e/6b" # Base 04
set -l color21 "2c/24/21" # Base 06
set -l color_foreground "68/61/5e" # Base 05
set -l color_background "f1/ef/ee" # Base 00
...
set -U fish_color_end 68615e
set -U fish_color_error brred
set -U fish_color_param 766e6b
set -U fish_color_valid_path --underline
set -U fish_color_option brcyan
set -U fish_color_comment 9c9491
set -U fish_color_selection 2c2421 --bold --background=a8a19f
set -U fish_color_operator brblue
set -U fish_color_escape brcyan
set -U fish_color_autosuggestion 9c9491
...
set -U fish_pager_color_progress e6e2e0 --background=766e6b
set -U fish_pager_color_background normal --background=f1efee
set -U fish_pager_color_prefix normal --bold
set -U fish_pager_color_completion normal
set -U fish_pager_color_description df5320 --dim
set -U fish_pager_color_selected_background 2c2421 --background=a8a19f
set -U fish_pager_color_selected_prefix 2c2421 --bold --background=a8a19f
set -U fish_pager_color_selected_completion 2c2421
...
# Set theme
set -Ux BASE16_THEME atelier-forest-light

# Optionally export variables
if test -n "$TINTED_SHELL_ENABLE_BASE16_VARS"; or test -n "$BASE16_SHELL_ENABLE_VARS"
  set -gx BASE16_COLOR_00_HEX "f1efee"
  set -gx BASE16_COLOR_01_HEX "e6e2e0"
  set -gx BASE16_COLOR_02_HEX "a8a19f"
  set -gx BASE16_COLOR_03_HEX "9c9491"
  set -gx BASE16_COLOR_04_HEX "766e6b"
  set -gx BASE16_COLOR_05_HEX "68615e"
  set -gx BASE16_COLOR_06_HEX "2c2421"
  set -gx BASE16_COLOR_07_HEX "1b1918"
  set -gx BASE16_COLOR_08_HEX "f22c40"
  set -gx BASE16_COLOR_09_HEX "df5320"
  set -gx BASE16_COLOR_0A_HEX "c38418"
  set -gx BASE16_COLOR_0B_HEX "7b9726"
  set -gx BASE16_COLOR_0C_HEX "3d97b8"
  set -gx BASE16_COLOR_0D_HEX "407ee7"
  set -gx BASE16_COLOR_0E_HEX "6666ea"
  set -gx BASE16_COLOR_0F_HEX "c33ff3"
end
