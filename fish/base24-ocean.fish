...
set -l color00 "22/4f/bc" # Base 00 - Black
set -l color01 "99/00/00" # Base 08 - Red
...
set -l color17 "4c/00/00" # Base 0F
...
set -l color_background "22/4f/bc" # Base 00
...
set -U fish_pager_color_background normal --background=224fbc
...
if test -n "$TINTED_SHELL_ENABLE_BASE24_VARS"; or test -n "$BASE24_SHELL_ENABLE_VARS"
  ...
  set -gx BASE24_COLOR_08_HEX "990000"
  ...
  set -gx BASE24_COLOR_0F_HEX "4c0000"
end
