...
set -l color00 "e3/ef/ef" # Base 00 - Black
...
set -l color07 "6d/82/8e" # Base 05 - White
set -l color08 "98/af/b5" # Base 03 - Bright Black
...
set -l color15 "48/58/67" # Base 07 - Bright White
set -l color16 "d8/bb/a2" # Base 09
set -l color17 "b3/9f/9f" # Base 0F
set -l color18 "c9/db/dc" # Base 01
set -l color19 "b0/c5/c8" # Base 02
set -l color20 "82/99/a1" # Base 04
set -l color21 "5a/6d/7a" # Base 06
set -l color_foreground "6d/82/8e" # Base 05
set -l color_background "e3/ef/ef" # Base 00
...
set -U fish_color_end 6d828e
set -U fish_color_error brred
set -U fish_color_param 8299a1
set -U fish_color_valid_path --underline
set -U fish_color_option brcyan
set -U fish_color_comment 98afb5
set -U fish_color_selection 5a6d7a --bold --background=b0c5c8
set -U fish_color_operator brblue
set -U fish_color_escape brcyan
set -U fish_color_autosuggestion 98afb5
...
set -U fish_pager_color_progress c9dbdc --background=8299a1
set -U fish_pager_color_background normal --background=e3efef
set -U fish_pager_color_prefix normal --bold
set -U fish_pager_color_completion normal
set -U fish_pager_color_description d8bba2 --dim
set -U fish_pager_color_selected_background 5a6d7a --background=b0c5c8
set -U fish_pager_color_selected_prefix 5a6d7a --bold --background=b0c5c8
set -U fish_pager_color_selected_completion 5a6d7a
...
# Set theme
set -Ux BASE16_THEME brushtrees

# Optionally export variables
if test -n "$TINTED_SHELL_ENABLE_BASE16_VARS"; or test -n "$BASE16_SHELL_ENABLE_VARS"
  set -gx BASE16_COLOR_00_HEX "e3efef"
  set -gx BASE16_COLOR_01_HEX "c9dbdc"
  set -gx BASE16_COLOR_02_HEX "b0c5c8"
  set -gx BASE16_COLOR_03_HEX "98afb5"
  set -gx BASE16_COLOR_04_HEX "8299a1"
  set -gx BASE16_COLOR_05_HEX "6d828e"
  set -gx BASE16_COLOR_06_HEX "5a6d7a"
  set -gx BASE16_COLOR_07_HEX "485867"
