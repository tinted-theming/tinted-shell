...
set -l color00 "2a/2b/32" # Base 00 - Black
set -l color01 "e4/56/49" # Base 08 - Red
set -l color02 "4f/a1/4f" # Base 0B - Green
set -l color03 "c0/aa/00" # Base 0A - Yellow
set -l color04 "00/84/bc" # Base 0D - Blue
set -l color05 "a6/25/a4" # Base 0E - Magenta
set -l color06 "09/96/b3" # Base 0C - Cyan
set -l color07 "cf/d0/d2" # Base 05 - White
set -l color08 "79/7c/84" # Base 03 - Bright Black
...
set -l color16 "c0/84/00" # Base 09
set -l color17 "72/2b/24" # Base 0F
set -l color18 "37/39/42" # Base 01
set -l color19 "4f/52/5d" # Base 02
set -l color20 "a4/a6/ab" # Base 04
set -l color21 "fa/fa/fa" # Base 06
set -l color_foreground "cf/d0/d2" # Base 05
set -l color_background "2a/2b/32" # Base 00
...
set -U fish_color_end cfd0d2
set -U fish_color_error brred
set -U fish_color_param a4a6ab
set -U fish_color_valid_path --underline
set -U fish_color_option brcyan
set -U fish_color_comment 797c84
set -U fish_color_selection fafafa --bold --background=4f525d
set -U fish_color_operator brblue
set -U fish_color_escape brcyan
set -U fish_color_autosuggestion 797c84
...
set -U fish_color_search_match bryellow --background=4f525d
set -U fish_color_history_current --bold
set -U fish_pager_color_progress 373942 --background=a4a6ab
set -U fish_pager_color_background normal --background=2a2b32
set -U fish_pager_color_prefix normal --bold
set -U fish_pager_color_completion normal
set -U fish_pager_color_description c08400 --dim
set -U fish_pager_color_selected_background fafafa --background=4f525d
set -U fish_pager_color_selected_prefix fafafa --bold --background=4f525d
set -U fish_pager_color_selected_completion fafafa
...
# Set theme
set -Ux BASE24_THEME one-half-light

# Optionally export variables
if test -n "$TINTED_SHELL_ENABLE_BASE24_VARS"; or test -n "$BASE24_SHELL_ENABLE_VARS"
  set -gx BASE24_COLOR_00_HEX "2a2b32"
  set -gx BASE24_COLOR_01_HEX "373942"
  set -gx BASE24_COLOR_02_HEX "4f525d"
  set -gx BASE24_COLOR_03_HEX "797c84"
  set -gx BASE24_COLOR_04_HEX "a4a6ab"
  set -gx BASE24_COLOR_05_HEX "cfd0d2"
  set -gx BASE24_COLOR_06_HEX "fafafa"
  set -gx BASE24_COLOR_07_HEX "ffffff"
  set -gx BASE24_COLOR_08_HEX "e45649"
  set -gx BASE24_COLOR_09_HEX "c08400"
  set -gx BASE24_COLOR_0A_HEX "c0aa00"
  set -gx BASE24_COLOR_0B_HEX "4fa14f"
  set -gx BASE24_COLOR_0C_HEX "0996b3"
  set -gx BASE24_COLOR_0D_HEX "0084bc"
  set -gx BASE24_COLOR_0E_HEX "a625a4"
  set -gx BASE24_COLOR_0F_HEX "722b24"
end
