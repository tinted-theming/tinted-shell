...
set -U fish_color_selection fafafa --background=4f525d
set -U fish_color_operator magenta
set -U fish_color_escape c08400
...
set -U fish_color_search_match yellow --background=4f525d
set -U fish_color_history_current --underline=curly
set -U fish_pager_color_progress 373942 --background=a4a6ab
set -U fish_pager_color_background --background=2a2b32
set -U fish_pager_color_prefix --bold --italics
set -U fish_pager_color_completion normal
set -U fish_pager_color_description c08400
set -U fish_pager_color_selected_background --background=4f525d
set -U fish_pager_color_selected_prefix --bold --italics --background=4f525d
