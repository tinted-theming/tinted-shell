...
set -U fish_color_end b2b8ad
set -U fish_color_error brred
set -U fish_color_param 778985
set -U fish_color_valid_path --underline
set -U fish_color_option brcyan
set -U fish_color_comment 3b5a5d
set -U fish_color_selection eee8d5 --bold --background=002b36
...
set -U fish_color_search_match bryellow --background=002b36
...
set -U fish_pager_color_description b58900 --dim
set -U fish_pager_color_selected_background eee8d5 --background=002b36
set -U fish_pager_color_selected_prefix eee8d5 --bold --background=002b36
...
if test -n "$TINTED_SHELL_ENABLE_BASE24_VARS"; or test -n "$BASE24_SHELL_ENABLE_VARS"
  ...
  set -gx BASE24_COLOR_0E_HEX "d33682"
  set -gx BASE24_COLOR_0F_HEX "6e1917"
end
