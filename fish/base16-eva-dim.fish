...
set -l color00 "2a/3b/4d" # Base 00 - Black
set -l color01 "c4/67/6c" # Base 08 - Red
set -l color02 "5d/e5/61" # Base 0B - Green
set -l color03 "cf/d0/5d" # Base 0A - Yellow
set -l color04 "1a/e1/dc" # Base 0D - Blue
set -l color05 "9c/6c/d3" # Base 0E - Magenta
set -l color06 "4b/8f/77" # Base 0C - Cyan
set -l color07 "9f/a2/a6" # Base 05 - White
set -l color08 "55/79/9c" # Base 03 - Bright Black
...
set -l color16 "ff/99/66" # Base 09
set -l color17 "bb/64/a9" # Base 0F
set -l color18 "3d/56/6f" # Base 01
set -l color19 "4b/69/88" # Base 02
set -l color20 "7e/90/a3" # Base 04
set -l color21 "d6/d7/d9" # Base 06
set -l color_foreground "9f/a2/a6" # Base 05
set -l color_background "2a/3b/4d" # Base 00
...
set -U fish_color_end 9fa2a6
set -U fish_color_error brred
set -U fish_color_param 7e90a3
set -U fish_color_valid_path --underline
set -U fish_color_option brcyan
set -U fish_color_comment 55799c
set -U fish_color_selection d6d7d9 --bold --background=4b6988
set -U fish_color_operator brblue
set -U fish_color_escape brcyan
set -U fish_color_autosuggestion 55799c
...
set -U fish_pager_color_progress 3d566f --background=7e90a3
set -U fish_pager_color_background normal --background=2a3b4d
set -U fish_pager_color_prefix normal --bold
set -U fish_pager_color_completion normal
set -U fish_pager_color_description ff9966 --dim
set -U fish_pager_color_selected_background d6d7d9 --background=4b6988
set -U fish_pager_color_selected_prefix d6d7d9 --bold --background=4b6988
set -U fish_pager_color_selected_completion d6d7d9
...
# Set theme
set -Ux BASE16_THEME eva-dim

# Optionally export variables
if test -n "$TINTED_SHELL_ENABLE_BASE16_VARS"; or test -n "$BASE16_SHELL_ENABLE_VARS"
  set -gx BASE16_COLOR_00_HEX "2a3b4d"
  set -gx BASE16_COLOR_01_HEX "3d566f"
  set -gx BASE16_COLOR_02_HEX "4b6988"
  set -gx BASE16_COLOR_03_HEX "55799c"
  set -gx BASE16_COLOR_04_HEX "7e90a3"
  set -gx BASE16_COLOR_05_HEX "9fa2a6"
  set -gx BASE16_COLOR_06_HEX "d6d7d9"
  set -gx BASE16_COLOR_07_HEX "ffffff"
  set -gx BASE16_COLOR_08_HEX "c4676c"
  set -gx BASE16_COLOR_09_HEX "ff9966"
  set -gx BASE16_COLOR_0A_HEX "cfd05d"
  set -gx BASE16_COLOR_0B_HEX "5de561"
  set -gx BASE16_COLOR_0C_HEX "4b8f77"
  set -gx BASE16_COLOR_0D_HEX "1ae1dc"
  set -gx BASE16_COLOR_0E_HEX "9c6cd3"
  set -gx BASE16_COLOR_0F_HEX "bb64a9"
end
