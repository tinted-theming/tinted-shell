...
set -l color00 "fa/f4/ed" # Base 00 - Black
set -l color01 "b4/63/7a" # Base 08 - Red
set -l color02 "28/69/83" # Base 0B - Green
set -l color03 "d7/82/7e" # Base 0A - Yellow
set -l color04 "90/7a/a9" # Base 0D - Blue
set -l color05 "ea/9d/34" # Base 0E - Magenta
set -l color06 "56/94/9f" # Base 0C - Cyan
set -l color07 "57/52/79" # Base 05 - White
set -l color08 "98/93/a5" # Base 03 - Bright Black
...
set -l color15 "ce/ca/cd" # Base 07 - Bright White
set -l color16 "ea/9d/34" # Base 09
set -l color17 "ce/ca/cd" # Base 0F
set -l color18 "ff/fa/f3" # Base 01
set -l color19 "f2/e9/de" # Base 02
set -l color20 "79/75/93" # Base 04
set -l color21 "57/52/79" # Base 06
set -l color_foreground "57/52/79" # Base 05
set -l color_background "fa/f4/ed" # Base 00
...
set -U fish_color_end 575279
set -U fish_color_error brred
set -U fish_color_param 797593
set -U fish_color_valid_path --underline
set -U fish_color_option brcyan
set -U fish_color_comment 9893a5
set -U fish_color_selection 575279 --bold --background=f2e9de
...
set -U fish_pager_color_progress fffaf3 --background=797593
set -U fish_pager_color_background normal --background=faf4ed
set -U fish_pager_color_prefix normal --bold
set -U fish_pager_color_completion normal
set -U fish_pager_color_description ea9d34 --dim
set -U fish_pager_color_selected_background 575279 --background=f2e9de
set -U fish_pager_color_selected_prefix 575279 --bold --background=f2e9de
set -U fish_pager_color_selected_completion 575279
...
# Set theme
set -Ux BASE16_THEME rose-pine-dawn

# Optionally export variables
if test -n "$TINTED_SHELL_ENABLE_BASE16_VARS"; or test -n "$BASE16_SHELL_ENABLE_VARS"
  set -gx BASE16_COLOR_00_HEX "faf4ed"
  set -gx BASE16_COLOR_01_HEX "fffaf3"
  set -gx BASE16_COLOR_02_HEX "f2e9de"
  set -gx BASE16_COLOR_03_HEX "9893a5"
  set -gx BASE16_COLOR_04_HEX "797593"
  set -gx BASE16_COLOR_05_HEX "575279"
  set -gx BASE16_COLOR_06_HEX "575279"
  set -gx BASE16_COLOR_07_HEX "cecacd"
  set -gx BASE16_COLOR_08_HEX "b4637a"
  set -gx BASE16_COLOR_09_HEX "ea9d34"
  set -gx BASE16_COLOR_0A_HEX "d7827e"
  set -gx BASE16_COLOR_0B_HEX "286983"
  set -gx BASE16_COLOR_0C_HEX "56949f"
  set -gx BASE16_COLOR_0D_HEX "907aa9"
  set -gx BASE16_COLOR_0E_HEX "ea9d34"
  set -gx BASE16_COLOR_0F_HEX "cecacd"
end
