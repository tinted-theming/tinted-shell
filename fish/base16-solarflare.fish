...
set -l color00 "18/26/2f" # Base 00 - Black
...
set -l color07 "a6/af/b8" # Base 05 - White
set -l color08 "66/75/81" # Base 03 - Bright Black
...
set -l color15 "f5/f7/fa" # Base 07 - Bright White
set -l color16 "e6/6b/2b" # Base 09
set -l color17 "d7/3c/9a" # Base 0F
set -l color18 "22/2e/38" # Base 01
set -l color19 "58/68/75" # Base 02
set -l color20 "85/93/9e" # Base 04
set -l color21 "e8/e9/ed" # Base 06
set -l color_foreground "a6/af/b8" # Base 05
set -l color_background "18/26/2f" # Base 00
...
set -U fish_color_end a6afb8
set -U fish_color_error brred
set -U fish_color_param 85939e
set -U fish_color_valid_path --underline
set -U fish_color_option brcyan
set -U fish_color_comment 667581
set -U fish_color_selection e8e9ed --bold --background=586875
set -U fish_color_operator brblue
set -U fish_color_escape brcyan
set -U fish_color_autosuggestion 667581
...
set -U fish_pager_color_progress 222e38 --background=85939e
set -U fish_pager_color_background normal --background=18262f
set -U fish_pager_color_prefix normal --bold
set -U fish_pager_color_completion normal
set -U fish_pager_color_description e66b2b --dim
set -U fish_pager_color_selected_background e8e9ed --background=586875
set -U fish_pager_color_selected_prefix e8e9ed --bold --background=586875
set -U fish_pager_color_selected_completion e8e9ed
...
# Set theme
set -Ux BASE16_THEME solarflare

# Optionally export variables
if test -n "$TINTED_SHELL_ENABLE_BASE16_VARS"; or test -n "$BASE16_SHELL_ENABLE_VARS"
  set -gx BASE16_COLOR_00_HEX "18262f"
  set -gx BASE16_COLOR_01_HEX "222e38"
  set -gx BASE16_COLOR_02_HEX "586875"
  set -gx BASE16_COLOR_03_HEX "667581"
  set -gx BASE16_COLOR_04_HEX "85939e"
  set -gx BASE16_COLOR_05_HEX "a6afb8"
  set -gx BASE16_COLOR_06_HEX "e8e9ed"
  set -gx BASE16_COLOR_07_HEX "f5f7fa"
