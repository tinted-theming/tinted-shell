...
set -U fish_color_selection 685259 --background=3c2a2e
set -U fish_color_operator magenta
set -U fish_color_escape aa301b
...
set -U fish_color_search_match yellow --background=3c2a2e
set -U fish_color_history_current --underline=curly
set -U fish_pager_color_progress 2a1a1c --background=523e43
set -U fish_pager_color_background --background=140607
set -U fish_pager_color_prefix --bold --italics
set -U fish_pager_color_completion normal
set -U fish_pager_color_description aa301b
set -U fish_pager_color_selected_background --background=3c2a2e
set -U fish_pager_color_selected_prefix --bold --italics --background=3c2a2e
