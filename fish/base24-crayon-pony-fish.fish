...
set -l color00 "14/06/07" # Base 00 - Black
set -l color01 "90/00/2a" # Base 08 - Red
set -l color02 "57/95/23" # Base 0B - Green
set -l color03 "cf/c9/ff" # Base 0A - Yellow
set -l color04 "8b/87/af" # Base 0D - Blue
set -l color05 "68/2e/50" # Base 0E - Magenta
set -l color06 "e8/a7/66" # Base 0C - Cyan
set -l color07 "5d/48/4e" # Base 05 - White
set -l color08 "47/34/38" # Base 03 - Bright Black
...
set -l color15 "af/94/9d" # Base 07 - Bright White
set -l color16 "aa/30/1b" # Base 09
set -l color17 "48/00/15" # Base 0F
set -l color18 "2a/1a/1c" # Base 01
set -l color19 "3c/2a/2e" # Base 02
set -l color20 "52/3e/43" # Base 04
set -l color21 "68/52/59" # Base 06
set -l color_foreground "5d/48/4e" # Base 05
set -l color_background "14/06/07" # Base 00
...
set -U fish_color_end 5d484e
set -U fish_color_error brred
set -U fish_color_param 523e43
set -U fish_color_valid_path --underline
set -U fish_color_option brcyan
set -U fish_color_comment 473438
set -U fish_color_selection 685259 --bold --background=3c2a2e
set -U fish_color_operator brblue
set -U fish_color_escape brcyan
set -U fish_color_autosuggestion 473438
...
set -U fish_color_search_match bryellow --background=3c2a2e
set -U fish_color_history_current --bold
set -U fish_pager_color_progress 2a1a1c --background=523e43
set -U fish_pager_color_background normal --background=140607
set -U fish_pager_color_prefix normal --bold
set -U fish_pager_color_completion normal
set -U fish_pager_color_description aa301b --dim
set -U fish_pager_color_selected_background 685259 --background=3c2a2e
set -U fish_pager_color_selected_prefix 685259 --bold --background=3c2a2e
set -U fish_pager_color_selected_completion 685259
...
# Set theme
set -Ux BASE24_THEME crayon-pony-fish

# Optionally export variables
if test -n "$TINTED_SHELL_ENABLE_BASE24_VARS"; or test -n "$BASE24_SHELL_ENABLE_VARS"
  set -gx BASE24_COLOR_00_HEX "140607"
  set -gx BASE24_COLOR_01_HEX "2a1a1c"
  set -gx BASE24_COLOR_02_HEX "3c2a2e"
  set -gx BASE24_COLOR_03_HEX "473438"
  set -gx BASE24_COLOR_04_HEX "523e43"
  set -gx BASE24_COLOR_05_HEX "5d484e"
  set -gx BASE24_COLOR_06_HEX "685259"
  set -gx BASE24_COLOR_07_HEX "af949d"
  set -gx BASE24_COLOR_08_HEX "90002a"
  set -gx BASE24_COLOR_09_HEX "aa301b"
  set -gx BASE24_COLOR_0A_HEX "cfc9ff"
  set -gx BASE24_COLOR_0B_HEX "579523"
  set -gx BASE24_COLOR_0C_HEX "e8a766"
  set -gx BASE24_COLOR_0D_HEX "8b87af"
  set -gx BASE24_COLOR_0E_HEX "682e50"
  set -gx BASE24_COLOR_0F_HEX "480015"
end
