...
set -l color01 "bf/00/00" # Base 08 - Red
set -l color02 "00/84/00" # Base 0B - Green
set -l color03 "af/85/00" # Base 0A - Yellow
set -l color04 "00/54/cf" # Base 0D - Blue
set -l color05 "6b/40/c3" # Base 0E - Magenta
set -l color06 "00/9a/8a" # Base 0C - Cyan
...
set -l color16 "ba/37/00" # Base 09
set -l color17 "dd/0f/9d" # Base 0F
set -l color18 "eb/eb/eb" # Base 01
set -l color19 "cd/cd/cd" # Base 02
set -l color20 "87/87/87" # Base 04
...
set -U fish_color_selection 282828 --bold --background=cdcdcd
...
set -U fish_pager_color_progress ebebeb --background=878787
set -U fish_pager_color_background normal --background=ffffff
set -U fish_pager_color_prefix normal --bold
set -U fish_pager_color_completion normal
set -U fish_pager_color_description ba3700 --dim
set -U fish_pager_color_selected_background 282828 --background=cdcdcd
set -U fish_pager_color_selected_prefix 282828 --bold --background=cdcdcd
...
# Set theme
set -Ux BASE16_THEME selenized-white

# Optionally export variables
if test -n "$TINTED_SHELL_ENABLE_BASE16_VARS"; or test -n "$BASE16_SHELL_ENABLE_VARS"
  set -gx BASE16_COLOR_00_HEX "ffffff"
  set -gx BASE16_COLOR_01_HEX "ebebeb"
  set -gx BASE16_COLOR_02_HEX "cdcdcd"
  set -gx BASE16_COLOR_03_HEX "878787"
  set -gx BASE16_COLOR_04_HEX "878787"
  set -gx BASE16_COLOR_05_HEX "474747"
  set -gx BASE16_COLOR_06_HEX "282828"
  set -gx BASE16_COLOR_07_HEX "282828"
  set -gx BASE16_COLOR_08_HEX "bf0000"
  set -gx BASE16_COLOR_09_HEX "ba3700"
  set -gx BASE16_COLOR_0A_HEX "af8500"
  set -gx BASE16_COLOR_0B_HEX "008400"
  set -gx BASE16_COLOR_0C_HEX "009a8a"
  set -gx BASE16_COLOR_0D_HEX "0054cf"
  set -gx BASE16_COLOR_0E_HEX "6b40c3"
  set -gx BASE16_COLOR_0F_HEX "dd0f9d"
end
