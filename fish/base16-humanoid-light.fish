...
set -l color00 "f8/f8/f2" # Base 00 - Black
set -l color01 "b0/15/1a" # Base 08 - Red
set -l color02 "38/8e/3c" # Base 0B - Green
set -l color03 "ff/b6/27" # Base 0A - Yellow
set -l color04 "00/82/c9" # Base 0D - Blue
set -l color05 "70/0f/98" # Base 0E - Magenta
set -l color06 "00/8e/8e" # Base 0C - Cyan
set -l color07 "23/26/29" # Base 05 - White
set -l color08 "c0/c0/bd" # Base 03 - Bright Black
...
set -l color15 "07/07/08" # Base 07 - Bright White
set -l color16 "ff/3d/00" # Base 09
set -l color17 "b2/77/01" # Base 0F
set -l color18 "ef/ef/e9" # Base 01
set -l color19 "de/de/d8" # Base 02
set -l color20 "60/61/5d" # Base 04
set -l color21 "2f/33/37" # Base 06
set -l color_foreground "23/26/29" # Base 05
set -l color_background "f8/f8/f2" # Base 00
...
set -U fish_color_end 232629
set -U fish_color_error brred
set -U fish_color_param 60615d
set -U fish_color_valid_path --underline
set -U fish_color_option brcyan
set -U fish_color_comment c0c0bd
set -U fish_color_selection 2f3337 --bold --background=deded8
set -U fish_color_operator brblue
set -U fish_color_escape brcyan
set -U fish_color_autosuggestion c0c0bd
...
set -U fish_pager_color_progress efefe9 --background=60615d
set -U fish_pager_color_background normal --background=f8f8f2
set -U fish_pager_color_prefix normal --bold
set -U fish_pager_color_completion normal
set -U fish_pager_color_description ff3d00 --dim
set -U fish_pager_color_selected_background 2f3337 --background=deded8
set -U fish_pager_color_selected_prefix 2f3337 --bold --background=deded8
set -U fish_pager_color_selected_completion 2f3337
...
# Set theme
set -Ux BASE16_THEME humanoid-light

# Optionally export variables
if test -n "$TINTED_SHELL_ENABLE_BASE16_VARS"; or test -n "$BASE16_SHELL_ENABLE_VARS"
  set -gx BASE16_COLOR_00_HEX "f8f8f2"
  set -gx BASE16_COLOR_01_HEX "efefe9"
  set -gx BASE16_COLOR_02_HEX "deded8"
  set -gx BASE16_COLOR_03_HEX "c0c0bd"
  set -gx BASE16_COLOR_04_HEX "60615d"
  set -gx BASE16_COLOR_05_HEX "232629"
  set -gx BASE16_COLOR_06_HEX "2f3337"
  set -gx BASE16_COLOR_07_HEX "070708"
  set -gx BASE16_COLOR_08_HEX "b0151a"
  set -gx BASE16_COLOR_09_HEX "ff3d00"
  set -gx BASE16_COLOR_0A_HEX "ffb627"
  set -gx BASE16_COLOR_0B_HEX "388e3c"
  set -gx BASE16_COLOR_0C_HEX "008e8e"
  set -gx BASE16_COLOR_0D_HEX "0082c9"
  set -gx BASE16_COLOR_0E_HEX "700f98"
  set -gx BASE16_COLOR_0F_HEX "b27701"
end
