...
set -l color00 "20/16/02" # Base 00 - Black
set -l color01 "c3/53/59" # Base 08 - Red
set -l color02 "18/97/4e" # Base 0B - Green
set -l color03 "a8/83/39" # Base 0A - Yellow
set -l color04 "47/7c/a1" # Base 0D - Blue
set -l color05 "88/68/b3" # Base 0E - Magenta
set -l color06 "75/a7/38" # Base 0C - Cyan
set -l color07 "94/8e/48" # Base 05 - White
set -l color08 "6c/68/23" # Base 03 - Bright Black
...
set -l color15 "fa/f0/a5" # Base 07 - Bright White
set -l color16 "b3/61/44" # Base 09
set -l color17 "b3/58/8e" # Base 0F
set -l color18 "30/2e/00" # Base 01
set -l color19 "5f/5b/17" # Base 02
set -l color20 "86/81/3b" # Base 04
set -l color21 "cc/c3/7a" # Base 06
set -l color_foreground "94/8e/48" # Base 05
set -l color_background "20/16/02" # Base 00
...
set -U fish_color_end 948e48
set -U fish_color_error brred
set -U fish_color_param 86813b
set -U fish_color_valid_path --underline
set -U fish_color_option brcyan
set -U fish_color_comment 6c6823
set -U fish_color_selection ccc37a --bold --background=5f5b17
set -U fish_color_operator brblue
set -U fish_color_escape brcyan
set -U fish_color_autosuggestion 6c6823
...
set -U fish_pager_color_progress 302e00 --background=86813b
set -U fish_pager_color_background normal --background=201602
set -U fish_pager_color_prefix normal --bold
set -U fish_pager_color_completion normal
set -U fish_pager_color_description b36144 --dim
set -U fish_pager_color_selected_background ccc37a --background=5f5b17
set -U fish_pager_color_selected_prefix ccc37a --bold --background=5f5b17
set -U fish_pager_color_selected_completion ccc37a
...
# Set theme
set -Ux BASE16_THEME marrakesh

# Optionally export variables
if test -n "$TINTED_SHELL_ENABLE_BASE16_VARS"; or test -n "$BASE16_SHELL_ENABLE_VARS"
  set -gx BASE16_COLOR_00_HEX "201602"
  set -gx BASE16_COLOR_01_HEX "302e00"
  set -gx BASE16_COLOR_02_HEX "5f5b17"
  set -gx BASE16_COLOR_03_HEX "6c6823"
  set -gx BASE16_COLOR_04_HEX "86813b"
  set -gx BASE16_COLOR_05_HEX "948e48"
  set -gx BASE16_COLOR_06_HEX "ccc37a"
  set -gx BASE16_COLOR_07_HEX "faf0a5"
  set -gx BASE16_COLOR_08_HEX "c35359"
  set -gx BASE16_COLOR_09_HEX "b36144"
  set -gx BASE16_COLOR_0A_HEX "a88339"
  set -gx BASE16_COLOR_0B_HEX "18974e"
  set -gx BASE16_COLOR_0C_HEX "75a738"
  set -gx BASE16_COLOR_0D_HEX "477ca1"
  set -gx BASE16_COLOR_0E_HEX "8868b3"
  set -gx BASE16_COLOR_0F_HEX "b3588e"
end
