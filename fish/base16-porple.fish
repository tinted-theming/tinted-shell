...
set -l color00 "29/2c/36" # Base 00 - Black
set -l color01 "f8/45/47" # Base 08 - Red
set -l color02 "95/c7/6f" # Base 0B - Green
set -l color03 "ef/a1/6b" # Base 0A - Yellow
set -l color04 "84/85/ce" # Base 0D - Blue
set -l color05 "b7/49/89" # Base 0E - Magenta
set -l color06 "64/87/8f" # Base 0C - Cyan
set -l color07 "d8/d8/d8" # Base 05 - White
set -l color08 "65/56/8a" # Base 03 - Bright Black
...
set -l color16 "d2/8e/5d" # Base 09
set -l color17 "98/68/41" # Base 0F
set -l color18 "33/33/44" # Base 01
set -l color19 "47/41/60" # Base 02
set -l color20 "b8/b8/b8" # Base 04
set -l color21 "e8/e8/e8" # Base 06
set -l color_foreground "d8/d8/d8" # Base 05
set -l color_background "29/2c/36" # Base 00
...
set -U fish_color_comment 65568a
set -U fish_color_selection e8e8e8 --bold --background=474160
set -U fish_color_operator brblue
set -U fish_color_escape brcyan
set -U fish_color_autosuggestion 65568a
...
set -U fish_pager_color_progress 333344 --background=b8b8b8
set -U fish_pager_color_background normal --background=292c36
set -U fish_pager_color_prefix normal --bold
set -U fish_pager_color_completion normal
set -U fish_pager_color_description d28e5d --dim
set -U fish_pager_color_selected_background e8e8e8 --background=474160
set -U fish_pager_color_selected_prefix e8e8e8 --bold --background=474160
...
# Set theme
set -Ux BASE16_THEME porple

# Optionally export variables
if test -n "$TINTED_SHELL_ENABLE_BASE16_VARS"; or test -n "$BASE16_SHELL_ENABLE_VARS"
  set -gx BASE16_COLOR_00_HEX "292c36"
  set -gx BASE16_COLOR_01_HEX "333344"
  set -gx BASE16_COLOR_02_HEX "474160"
  set -gx BASE16_COLOR_03_HEX "65568a"
  set -gx BASE16_COLOR_04_HEX "b8b8b8"
  set -gx BASE16_COLOR_05_HEX "d8d8d8"
  set -gx BASE16_COLOR_06_HEX "e8e8e8"
  set -gx BASE16_COLOR_07_HEX "f8f8f8"
  set -gx BASE16_COLOR_08_HEX "f84547"
  set -gx BASE16_COLOR_09_HEX "d28e5d"
  set -gx BASE16_COLOR_0A_HEX "efa16b"
  set -gx BASE16_COLOR_0B_HEX "95c76f"
  set -gx BASE16_COLOR_0C_HEX "64878f"
  set -gx BASE16_COLOR_0D_HEX "8485ce"
  set -gx BASE16_COLOR_0E_HEX "b74989"
  set -gx BASE16_COLOR_0F_HEX "986841"
end
