...
set -l color00 "18/1c/27" # Base 00 - Black
set -l color01 "80/00/09" # Base 08 - Red
set -l color02 "48/51/3b" # Base 0B - Green
set -l color03 "2f/97/c6" # Base 0A - Yellow
set -l color04 "56/6d/8c" # Base 0D - Blue
set -l color05 "72/4c/7c" # Base 0E - Magenta
set -l color06 "5b/4f/4a" # Base 0C - Cyan
set -l color07 "97/8f/73" # Base 05 - White
set -l color08 "6b/68/5f" # Base 03 - Bright Black
...
set -l color15 "f3/f3/f3" # Base 07 - Bright White
set -l color16 "cc/8a/3e" # Base 09
set -l color17 "40/00/04" # Base 0F
set -l color18 "18/18/18" # Base 01
set -l color19 "55/55/55" # Base 02
set -l color20 "81/7c/69" # Base 04
set -l color21 "ad/a3/7e" # Base 06
set -l color_foreground "97/8f/73" # Base 05
set -l color_background "18/1c/27" # Base 00
...
set -U fish_color_end 978f73
set -U fish_color_error brred
set -U fish_color_param 817c69
set -U fish_color_valid_path --underline
set -U fish_color_option brcyan
set -U fish_color_comment 6b685f
set -U fish_color_selection ada37e --bold --background=555555
set -U fish_color_operator brblue
set -U fish_color_escape brcyan
set -U fish_color_autosuggestion 6b685f
...
set -U fish_pager_color_progress 181818 --background=817c69
set -U fish_pager_color_background normal --background=181c27
set -U fish_pager_color_prefix normal --bold
set -U fish_pager_color_completion normal
set -U fish_pager_color_description cc8a3e --dim
set -U fish_pager_color_selected_background ada37e --background=555555
set -U fish_pager_color_selected_prefix ada37e --bold --background=555555
set -U fish_pager_color_selected_completion ada37e
...
# Set theme
set -Ux BASE24_THEME ciapre

# Optionally export variables
if test -n "$TINTED_SHELL_ENABLE_BASE24_VARS"; or test -n "$BASE24_SHELL_ENABLE_VARS"
  set -gx BASE24_COLOR_00_HEX "181c27"
  set -gx BASE24_COLOR_01_HEX "181818"
  set -gx BASE24_COLOR_02_HEX "555555"
  set -gx BASE24_COLOR_03_HEX "6b685f"
  set -gx BASE24_COLOR_04_HEX "817c69"
  set -gx BASE24_COLOR_05_HEX "978f73"
  set -gx BASE24_COLOR_06_HEX "ada37e"
  set -gx BASE24_COLOR_07_HEX "f3f3f3"
  set -gx BASE24_COLOR_08_HEX "800009"
  set -gx BASE24_COLOR_09_HEX "cc8a3e"
  set -gx BASE24_COLOR_0A_HEX "2f97c6"
  set -gx BASE24_COLOR_0B_HEX "48513b"
  set -gx BASE24_COLOR_0C_HEX "5b4f4a"
  set -gx BASE24_COLOR_0D_HEX "566d8c"
  set -gx BASE24_COLOR_0E_HEX "724c7c"
  set -gx BASE24_COLOR_0F_HEX "400004"
end
