...
set -l color00 "14/14/14" # Base 00 - Black
set -l color01 "b3/45/38" # Base 08 - Red
set -l color02 "58/77/44" # Base 0B - Green
set -l color03 "53/89/c5" # Base 0A - Yellow
set -l color04 "20/6e/c5" # Base 0D - Blue
set -l color05 "86/46/51" # Base 0E - Magenta
set -l color06 "ac/91/66" # Base 0C - Cyan
set -l color07 "bf/bd/b7" # Base 05 - White
set -l color08 "5d/5b/59" # Base 03 - Bright Black
...
set -l color16 "d0/89/49" # Base 09
set -l color17 "59/22/1c" # Base 0F
set -l color18 "19/19/18" # Base 01
set -l color19 "2c/2b/2a" # Base 02
set -l color20 "8e/8c/88" # Base 04
set -l color21 "f1/ee/e7" # Base 06
set -l color_foreground "bf/bd/b7" # Base 05
set -l color_background "14/14/14" # Base 00
...
set -U fish_color_end bfbdb7
set -U fish_color_error brred
set -U fish_color_param 8e8c88
set -U fish_color_valid_path --underline
set -U fish_color_option brcyan
set -U fish_color_comment 5d5b59
set -U fish_color_selection f1eee7 --bold --background=2c2b2a
set -U fish_color_operator brblue
set -U fish_color_escape brcyan
set -U fish_color_autosuggestion 5d5b59
...
set -U fish_color_search_match bryellow --background=2c2b2a
set -U fish_color_history_current --bold
set -U fish_pager_color_progress 191918 --background=8e8c88
set -U fish_pager_color_background normal --background=141414
set -U fish_pager_color_prefix normal --bold
set -U fish_pager_color_completion normal
set -U fish_pager_color_description d08949 --dim
set -U fish_pager_color_selected_background f1eee7 --background=2c2b2a
set -U fish_pager_color_selected_prefix f1eee7 --bold --background=2c2b2a
set -U fish_pager_color_selected_completion f1eee7
...
# Set theme
set -Ux BASE24_THEME hacktober

# Optionally export variables
if test -n "$TINTED_SHELL_ENABLE_BASE24_VARS"; or test -n "$BASE24_SHELL_ENABLE_VARS"
  set -gx BASE24_COLOR_00_HEX "141414"
  set -gx BASE24_COLOR_01_HEX "191918"
  set -gx BASE24_COLOR_02_HEX "2c2b2a"
  set -gx BASE24_COLOR_03_HEX "5d5b59"
  set -gx BASE24_COLOR_04_HEX "8e8c88"
  set -gx BASE24_COLOR_05_HEX "bfbdb7"
  set -gx BASE24_COLOR_06_HEX "f1eee7"
  set -gx BASE24_COLOR_07_HEX "ffffff"
  set -gx BASE24_COLOR_08_HEX "b34538"
  set -gx BASE24_COLOR_09_HEX "d08949"
  set -gx BASE24_COLOR_0A_HEX "5389c5"
  set -gx BASE24_COLOR_0B_HEX "587744"
  set -gx BASE24_COLOR_0C_HEX "ac9166"
  set -gx BASE24_COLOR_0D_HEX "206ec5"
  set -gx BASE24_COLOR_0E_HEX "864651"
  set -gx BASE24_COLOR_0F_HEX "59221c"
end
