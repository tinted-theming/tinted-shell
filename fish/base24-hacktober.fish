...
set -U fish_color_selection f1eee7 --background=2c2b2a
set -U fish_color_operator magenta
set -U fish_color_escape d08949
...
set -U fish_color_search_match yellow --background=2c2b2a
set -U fish_color_history_current --underline=curly
set -U fish_pager_color_progress 191918 --background=8e8c88
set -U fish_pager_color_background --background=141414
set -U fish_pager_color_prefix --bold --italics
set -U fish_pager_color_completion normal
set -U fish_pager_color_description d08949
set -U fish_pager_color_selected_background --background=2c2b2a
set -U fish_pager_color_selected_prefix --bold --italics --background=2c2b2a
