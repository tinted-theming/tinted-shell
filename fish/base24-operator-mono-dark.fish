...
set -U fish_color_selection cdd3cd --background=9a9a99
set -U fish_color_operator magenta
set -U fish_color_escape d4d697
...
set -U fish_color_search_match yellow --background=9a9a99
...
set -U fish_pager_color_description d4d697
set -U fish_pager_color_selected_background --background=9a9a99
set -U fish_pager_color_selected_prefix --bold --italics --background=9a9a99
