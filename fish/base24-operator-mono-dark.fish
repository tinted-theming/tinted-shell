...
set -l color01 "ca/37/2d" # Base 08 - Red
set -l color02 "4d/7b/3a" # Base 0B - Green
set -l color03 "89/d3/f6" # Base 0A - Yellow
set -l color04 "43/87/cf" # Base 0D - Blue
set -l color05 "b8/6c/b4" # Base 0E - Magenta
set -l color06 "72/d4/c6" # Base 0C - Cyan
set -l color07 "c0/c4/c0" # Base 05 - White
set -l color08 "a6/a8/a6" # Base 03 - Bright Black
...
set -l color15 "fd/fd/f6" # Base 07 - Bright White
set -l color16 "d4/d6/97" # Base 09
set -l color17 "65/1b/16" # Base 0F
set -l color18 "5a/5a/5a" # Base 01
set -l color19 "9a/9a/99" # Base 02
set -l color20 "b3/b6/b3" # Base 04
set -l color21 "cd/d3/cd" # Base 06
set -l color_foreground "c0/c4/c0" # Base 05
...
set -U fish_color_end c0c4c0
set -U fish_color_error brred
set -U fish_color_param b3b6b3
set -U fish_color_valid_path --underline
set -U fish_color_option brcyan
set -U fish_color_comment a6a8a6
set -U fish_color_selection cdd3cd --bold --background=9a9a99
set -U fish_color_operator brblue
set -U fish_color_escape brcyan
set -U fish_color_autosuggestion a6a8a6
...
set -U fish_color_search_match bryellow --background=9a9a99
set -U fish_color_history_current --bold
set -U fish_pager_color_progress 5a5a5a --background=b3b6b3
set -U fish_pager_color_background normal --background=191919
set -U fish_pager_color_prefix normal --bold
set -U fish_pager_color_completion normal
set -U fish_pager_color_description d4d697 --dim
set -U fish_pager_color_selected_background cdd3cd --background=9a9a99
set -U fish_pager_color_selected_prefix cdd3cd --bold --background=9a9a99
set -U fish_pager_color_selected_completion cdd3cd
...
# Set theme
set -Ux BASE24_THEME operator-mono-dark

# Optionally export variables
if test -n "$TINTED_SHELL_ENABLE_BASE24_VARS"; or test -n "$BASE24_SHELL_ENABLE_VARS"
  set -gx BASE24_COLOR_00_HEX "191919"
  set -gx BASE24_COLOR_01_HEX "5a5a5a"
  set -gx BASE24_COLOR_02_HEX "9a9a99"
  set -gx BASE24_COLOR_03_HEX "a6a8a6"
  set -gx BASE24_COLOR_04_HEX "b3b6b3"
  set -gx BASE24_COLOR_05_HEX "c0c4c0"
  set -gx BASE24_COLOR_06_HEX "cdd3cd"
  set -gx BASE24_COLOR_07_HEX "fdfdf6"
  set -gx BASE24_COLOR_08_HEX "ca372d"
  set -gx BASE24_COLOR_09_HEX "d4d697"
  set -gx BASE24_COLOR_0A_HEX "89d3f6"
  set -gx BASE24_COLOR_0B_HEX "4d7b3a"
  set -gx BASE24_COLOR_0C_HEX "72d4c6"
  set -gx BASE24_COLOR_0D_HEX "4387cf"
  set -gx BASE24_COLOR_0E_HEX "b86cb4"
  set -gx BASE24_COLOR_0F_HEX "651b16"
end
