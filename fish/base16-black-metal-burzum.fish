...
set -l color02 "dd/ee/cc" # Base 0B - Green
set -l color03 "99/bb/aa" # Base 0A - Yellow
...
# Set theme
set -Ux BASE16_THEME black-metal-burzum
...
if test -n "$TINTED_SHELL_ENABLE_BASE16_VARS"; or test -n "$BASE16_SHELL_ENABLE_VARS"
  ...
  set -gx BASE16_COLOR_0A_HEX "99bbaa"
  set -gx BASE16_COLOR_0B_HEX "ddeecc"
