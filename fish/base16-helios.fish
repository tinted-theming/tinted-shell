...
set -l color00 "1d/20/21" # Base 00 - Black
set -l color01 "d7/26/38" # Base 08 - Red
set -l color02 "88/b9/2d" # Base 0B - Green
set -l color03 "f1/9d/1a" # Base 0A - Yellow
set -l color04 "1e/8b/ac" # Base 0D - Blue
set -l color05 "be/42/64" # Base 0E - Magenta
set -l color06 "1b/a5/95" # Base 0C - Cyan
set -l color07 "d5/d5/d5" # Base 05 - White
set -l color08 "6f/75/79" # Base 03 - Bright Black
...
set -l color16 "eb/84/13" # Base 09
set -l color17 "c8/5e/0d" # Base 0F
set -l color18 "38/3c/3e" # Base 01
set -l color19 "53/58/5b" # Base 02
set -l color20 "cd/cd/cd" # Base 04
set -l color21 "dd/dd/dd" # Base 06
set -l color_foreground "d5/d5/d5" # Base 05
set -l color_background "1d/20/21" # Base 00
...
set -U fish_color_end d5d5d5
set -U fish_color_error brred
set -U fish_color_param cdcdcd
set -U fish_color_valid_path --underline
set -U fish_color_option brcyan
set -U fish_color_comment 6f7579
set -U fish_color_selection dddddd --bold --background=53585b
set -U fish_color_operator brblue
set -U fish_color_escape brcyan
set -U fish_color_autosuggestion 6f7579
...
set -U fish_pager_color_progress 383c3e --background=cdcdcd
set -U fish_pager_color_background normal --background=1d2021
set -U fish_pager_color_prefix normal --bold
set -U fish_pager_color_completion normal
set -U fish_pager_color_description eb8413 --dim
set -U fish_pager_color_selected_background dddddd --background=53585b
set -U fish_pager_color_selected_prefix dddddd --bold --background=53585b
set -U fish_pager_color_selected_completion dddddd
...
# Set theme
set -Ux BASE16_THEME helios

# Optionally export variables
if test -n "$TINTED_SHELL_ENABLE_BASE16_VARS"; or test -n "$BASE16_SHELL_ENABLE_VARS"
  set -gx BASE16_COLOR_00_HEX "1d2021"
  set -gx BASE16_COLOR_01_HEX "383c3e"
  set -gx BASE16_COLOR_02_HEX "53585b"
  set -gx BASE16_COLOR_03_HEX "6f7579"
  set -gx BASE16_COLOR_04_HEX "cdcdcd"
  set -gx BASE16_COLOR_05_HEX "d5d5d5"
  set -gx BASE16_COLOR_06_HEX "dddddd"
  set -gx BASE16_COLOR_07_HEX "e5e5e5"
  set -gx BASE16_COLOR_08_HEX "d72638"
  set -gx BASE16_COLOR_09_HEX "eb8413"
  set -gx BASE16_COLOR_0A_HEX "f19d1a"
  set -gx BASE16_COLOR_0B_HEX "88b92d"
  set -gx BASE16_COLOR_0C_HEX "1ba595"
  set -gx BASE16_COLOR_0D_HEX "1e8bac"
  set -gx BASE16_COLOR_0E_HEX "be4264"
  set -gx BASE16_COLOR_0F_HEX "c85e0d"
end
