...
set -l color04 "00/00/bb" # Base 0D - Blue
...
set -l color16 "bb/bb/00" # Base 09
...
set -U fish_pager_color_description bbbb00 --dim
...
# Set theme
set -Ux BASE24_THEME builtin-light
