...
set -l color07 "3c/38/36" # Base 05 - White
...
set -U fish_color_end 3c3836
set -U fish_color_error brred
set -U fish_color_param 7c6f64
set -U fish_color_valid_path --underline
set -U fish_color_option brcyan
set -U fish_color_comment bdae93
set -U fish_color_selection 282828 --bold --background=d5c4a1
...
set -U fish_pager_color_progress ebdbb2 --background=7c6f64
set -U fish_pager_color_background normal --background=fbf1c7
set -U fish_pager_color_prefix normal --bold
set -U fish_pager_color_completion normal
set -U fish_pager_color_description d65d0e --dim
set -U fish_pager_color_selected_background 282828 --background=d5c4a1
set -U fish_pager_color_selected_prefix 282828 --bold --background=d5c4a1
...
# Set theme
set -Ux BASE24_THEME gruvbox-light

# Optionally export variables
if test -n "$TINTED_SHELL_ENABLE_BASE24_VARS"; or test -n "$BASE24_SHELL_ENABLE_VARS"
  set -gx BASE24_COLOR_00_HEX "fbf1c7"
  set -gx BASE24_COLOR_01_HEX "ebdbb2"
  set -gx BASE24_COLOR_02_HEX "d5c4a1"
  set -gx BASE24_COLOR_03_HEX "bdae93"
  set -gx BASE24_COLOR_04_HEX "7c6f64"
  set -gx BASE24_COLOR_05_HEX "3c3836"
  set -gx BASE24_COLOR_06_HEX "282828"
  set -gx BASE24_COLOR_07_HEX "1d2021"
