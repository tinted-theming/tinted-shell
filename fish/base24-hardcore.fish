...
set -l color00 "11/11/11" # Base 00 - Black
set -l color01 "ff/55/55" # Base 08 - Red
set -l color02 "98/ec/65" # Base 0B - Green
set -l color03 "33/bb/ff" # Base 0A - Yellow
set -l color04 "00/aa/ff" # Base 0D - Blue
set -l color05 "aa/88/ff" # Base 0E - Magenta
set -l color06 "88/dd/ff" # Base 0C - Cyan
set -l color07 "a9/a9/a9" # Base 05 - White
...
set -l color16 "ff/cc/33" # Base 09
set -l color17 "7f/2a/2a" # Base 0F
set -l color18 "14/14/14" # Base 01
set -l color19 "41/41/41" # Base 02
set -l color20 "86/86/86" # Base 04
set -l color21 "cc/cc/cc" # Base 06
set -l color_foreground "a9/a9/a9" # Base 05
set -l color_background "11/11/11" # Base 00
...
set -U fish_color_end a9a9a9
set -U fish_color_error brred
set -U fish_color_param 868686
set -U fish_color_valid_path --underline
set -U fish_color_option brcyan
set -U fish_color_comment 636363
set -U fish_color_selection cccccc --bold --background=414141
...
set -U fish_color_search_match bryellow --background=414141
set -U fish_color_history_current --bold
set -U fish_pager_color_progress 141414 --background=868686
set -U fish_pager_color_background normal --background=111111
set -U fish_pager_color_prefix normal --bold
set -U fish_pager_color_completion normal
set -U fish_pager_color_description ffcc33 --dim
set -U fish_pager_color_selected_background cccccc --background=414141
set -U fish_pager_color_selected_prefix cccccc --bold --background=414141
set -U fish_pager_color_selected_completion cccccc
...
# Set theme
set -Ux BASE24_THEME hardcore

# Optionally export variables
if test -n "$TINTED_SHELL_ENABLE_BASE24_VARS"; or test -n "$BASE24_SHELL_ENABLE_VARS"
  set -gx BASE24_COLOR_00_HEX "111111"
  set -gx BASE24_COLOR_01_HEX "141414"
  set -gx BASE24_COLOR_02_HEX "414141"
  set -gx BASE24_COLOR_03_HEX "636363"
  set -gx BASE24_COLOR_04_HEX "868686"
  set -gx BASE24_COLOR_05_HEX "a9a9a9"
  set -gx BASE24_COLOR_06_HEX "cccccc"
  set -gx BASE24_COLOR_07_HEX "ffffff"
  set -gx BASE24_COLOR_08_HEX "ff5555"
  set -gx BASE24_COLOR_09_HEX "ffcc33"
  set -gx BASE24_COLOR_0A_HEX "33bbff"
  set -gx BASE24_COLOR_0B_HEX "98ec65"
  set -gx BASE24_COLOR_0C_HEX "88ddff"
  set -gx BASE24_COLOR_0D_HEX "00aaff"
  set -gx BASE24_COLOR_0E_HEX "aa88ff"
  set -gx BASE24_COLOR_0F_HEX "7f2a2a"
end
