...
set -l color02 "61/ce/3c" # Base 0B - Green
set -l color03 "ff/ff/00" # Base 0A - Yellow
set -l color04 "4c/83/ff" # Base 0D - Blue
set -l color05 "ff/14/93" # Base 0E - Magenta
set -l color06 "93/e0/e3" # Base 0C - Cyan
set -l color07 "dc/dc/cc" # Base 05 - White
set -l color08 "4f/4f/4f" # Base 03 - Bright Black
...
set -l color17 "ff/8c/00" # Base 0F
set -l color18 "2b/2b/2b" # Base 01
set -l color19 "38/38/38" # Base 02
set -l color20 "8b/89/89" # Base 04
...
set -U fish_color_param 8b8989
set -U fish_color_valid_path --underline
set -U fish_color_option brcyan
set -U fish_color_comment 4f4f4f
set -U fish_color_selection f8f8f8 --bold --background=383838
set -U fish_color_operator brblue
set -U fish_color_escape brcyan
set -U fish_color_autosuggestion 4f4f4f
...
set -U fish_pager_color_progress 2b2b2b --background=8b8989
...
set -U fish_pager_color_selected_background f8f8f8 --background=383838
set -U fish_pager_color_selected_prefix f8f8f8 --bold --background=383838
...
# Set theme
set -Ux BASE16_THEME cyberpunk

# Optionally export variables
if test -n "$TINTED_SHELL_ENABLE_BASE16_VARS"; or test -n "$BASE16_SHELL_ENABLE_VARS"
  set -gx BASE16_COLOR_00_HEX "000000"
  set -gx BASE16_COLOR_01_HEX "2b2b2b"
  set -gx BASE16_COLOR_02_HEX "383838"
  set -gx BASE16_COLOR_03_HEX "4f4f4f"
  set -gx BASE16_COLOR_04_HEX "8b8989"
  set -gx BASE16_COLOR_05_HEX "dcdccc"
  set -gx BASE16_COLOR_06_HEX "f8f8f8"
  set -gx BASE16_COLOR_07_HEX "ffffff"
  set -gx BASE16_COLOR_08_HEX "ff0000"
  set -gx BASE16_COLOR_09_HEX "ffa500"
  set -gx BASE16_COLOR_0A_HEX "ffff00"
  set -gx BASE16_COLOR_0B_HEX "61ce3c"
  set -gx BASE16_COLOR_0C_HEX "93e0e3"
  set -gx BASE16_COLOR_0D_HEX "4c83ff"
  set -gx BASE16_COLOR_0E_HEX "ff1493"
  set -gx BASE16_COLOR_0F_HEX "ff8c00"
end
