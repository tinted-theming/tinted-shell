...
set -l color00 "1c/20/23" # Base 00 - Black
set -l color01 "c7/ae/95" # Base 08 - Red
set -l color02 "95/c7/ae" # Base 0B - Green
set -l color03 "ae/c7/95" # Base 0A - Yellow
set -l color04 "ae/95/c7" # Base 0D - Blue
set -l color05 "c7/95/ae" # Base 0E - Magenta
set -l color06 "95/ae/c7" # Base 0C - Cyan
set -l color07 "c7/cc/d1" # Base 05 - White
set -l color08 "74/7c/84" # Base 03 - Bright Black
...
set -l color16 "c7/c7/95" # Base 09
set -l color17 "c7/95/95" # Base 0F
set -l color18 "39/3f/45" # Base 01
set -l color19 "56/5e/65" # Base 02
set -l color20 "ad/b3/ba" # Base 04
set -l color21 "df/e2/e5" # Base 06
set -l color_foreground "c7/cc/d1" # Base 05
set -l color_background "1c/20/23" # Base 00
...
set -U fish_color_end c7ccd1
set -U fish_color_error brred
set -U fish_color_param adb3ba
set -U fish_color_valid_path --underline
set -U fish_color_option brcyan
set -U fish_color_comment 747c84
set -U fish_color_selection dfe2e5 --bold --background=565e65
set -U fish_color_operator brblue
set -U fish_color_escape brcyan
set -U fish_color_autosuggestion 747c84
...
set -U fish_pager_color_progress 393f45 --background=adb3ba
set -U fish_pager_color_background normal --background=1c2023
set -U fish_pager_color_prefix normal --bold
set -U fish_pager_color_completion normal
set -U fish_pager_color_description c7c795 --dim
set -U fish_pager_color_selected_background dfe2e5 --background=565e65
set -U fish_pager_color_selected_prefix dfe2e5 --bold --background=565e65
set -U fish_pager_color_selected_completion dfe2e5
...
# Set theme
set -Ux BASE16_THEME ashes

# Optionally export variables
if test -n "$TINTED_SHELL_ENABLE_BASE16_VARS"; or test -n "$BASE16_SHELL_ENABLE_VARS"
  set -gx BASE16_COLOR_00_HEX "1c2023"
  set -gx BASE16_COLOR_01_HEX "393f45"
  set -gx BASE16_COLOR_02_HEX "565e65"
  set -gx BASE16_COLOR_03_HEX "747c84"
  set -gx BASE16_COLOR_04_HEX "adb3ba"
  set -gx BASE16_COLOR_05_HEX "c7ccd1"
  set -gx BASE16_COLOR_06_HEX "dfe2e5"
  set -gx BASE16_COLOR_07_HEX "f3f4f5"
  set -gx BASE16_COLOR_08_HEX "c7ae95"
  set -gx BASE16_COLOR_09_HEX "c7c795"
  set -gx BASE16_COLOR_0A_HEX "aec795"
  set -gx BASE16_COLOR_0B_HEX "95c7ae"
  set -gx BASE16_COLOR_0C_HEX "95aec7"
  set -gx BASE16_COLOR_0D_HEX "ae95c7"
  set -gx BASE16_COLOR_0E_HEX "c795ae"
  set -gx BASE16_COLOR_0F_HEX "c79595"
end
