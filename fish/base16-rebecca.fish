...
set -l color01 "a0/a0/c5" # Base 08 - Red
set -l color02 "6d/fe/df" # Base 0B - Green
set -l color03 "ae/81/ff" # Base 0A - Yellow
set -l color04 "2d/e0/a7" # Base 0D - Blue
set -l color05 "7a/a5/ff" # Base 0E - Magenta
set -l color06 "8e/ae/e0" # Base 0C - Cyan
set -l color07 "f1/ef/f8" # Base 05 - White
set -l color08 "66/66/99" # Base 03 - Bright Black
...
set -l color15 "53/49/5d" # Base 07 - Bright White
set -l color16 "ef/e4/a1" # Base 09
set -l color17 "ff/79/c6" # Base 0F
set -l color18 "66/33/99" # Base 01
set -l color19 "38/3a/62" # Base 02
set -l color20 "a0/a0/c5" # Base 04
set -l color21 "cc/cc/ff" # Base 06
set -l color_foreground "f1/ef/f8" # Base 05
...
set -U fish_color_end f1eff8
set -U fish_color_error brred
set -U fish_color_param a0a0c5
set -U fish_color_valid_path --underline
set -U fish_color_option brcyan
set -U fish_color_comment 666699
set -U fish_color_selection ccccff --bold --background=383a62
set -U fish_color_operator brblue
set -U fish_color_escape brcyan
set -U fish_color_autosuggestion 666699
...
set -U fish_pager_color_progress 663399 --background=a0a0c5
set -U fish_pager_color_background normal --background=292a44
set -U fish_pager_color_prefix normal --bold
set -U fish_pager_color_completion normal
set -U fish_pager_color_description efe4a1 --dim
set -U fish_pager_color_selected_background ccccff --background=383a62
set -U fish_pager_color_selected_prefix ccccff --bold --background=383a62
set -U fish_pager_color_selected_completion ccccff
...
# Set theme
set -Ux BASE16_THEME rebecca

# Optionally export variables
if test -n "$TINTED_SHELL_ENABLE_BASE16_VARS"; or test -n "$BASE16_SHELL_ENABLE_VARS"
  set -gx BASE16_COLOR_00_HEX "292a44"
  set -gx BASE16_COLOR_01_HEX "663399"
  set -gx BASE16_COLOR_02_HEX "383a62"
  set -gx BASE16_COLOR_03_HEX "666699"
  set -gx BASE16_COLOR_04_HEX "a0a0c5"
  set -gx BASE16_COLOR_05_HEX "f1eff8"
  set -gx BASE16_COLOR_06_HEX "ccccff"
  set -gx BASE16_COLOR_07_HEX "53495d"
  set -gx BASE16_COLOR_08_HEX "a0a0c5"
  set -gx BASE16_COLOR_09_HEX "efe4a1"
  set -gx BASE16_COLOR_0A_HEX "ae81ff"
  set -gx BASE16_COLOR_0B_HEX "6dfedf"
  set -gx BASE16_COLOR_0C_HEX "8eaee0"
  set -gx BASE16_COLOR_0D_HEX "2de0a7"
  set -gx BASE16_COLOR_0E_HEX "7aa5ff"
  set -gx BASE16_COLOR_0F_HEX "ff79c6"
end
