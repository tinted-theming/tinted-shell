...
set -l color01 "db/70/70" # Base 08 - Red
set -l color02 "7c/9f/4b" # Base 0B - Green
set -l color03 "eb/cc/1a" # Base 0A - Yellow
set -l color04 "65/87/bf" # Base 0D - Blue
set -l color05 "b8/70/ce" # Base 0E - Magenta
set -l color06 "50/9c/93" # Base 0C - Cyan
set -l color07 "47/47/52" # Base 05 - White
set -l color08 "91/97/a1" # Base 03 - Bright Black
...
set -l color15 "2e/2e/38" # Base 07 - Bright White
set -l color16 "eb/a3/1a" # Base 09
set -l color17 "50/9c/93" # Base 0F
set -l color18 "e3/e5/e8" # Base 01
set -l color19 "ac/b1/b9" # Base 02
set -l color20 "5e/64/6f" # Base 04
set -l color21 "3a/3a/46" # Base 06
set -l color_foreground "47/47/52" # Base 05
...
set -U fish_color_end 474752
set -U fish_color_error brred
set -U fish_color_param 5e646f
set -U fish_color_valid_path --underline
set -U fish_color_option brcyan
set -U fish_color_comment 9197a1
set -U fish_color_selection 3a3a46 --bold --background=acb1b9
set -U fish_color_operator brblue
set -U fish_color_escape brcyan
set -U fish_color_autosuggestion 9197a1
...
set -U fish_color_search_match bryellow --background=acb1b9
set -U fish_color_history_current --bold
set -U fish_pager_color_progress e3e5e8 --background=5e646f
set -U fish_pager_color_background normal --background=fafafa
set -U fish_pager_color_prefix normal --bold
set -U fish_pager_color_completion normal
set -U fish_pager_color_description eba31a --dim
set -U fish_pager_color_selected_background 3a3a46 --background=acb1b9
set -U fish_pager_color_selected_prefix 3a3a46 --bold --background=acb1b9
set -U fish_pager_color_selected_completion 3a3a46
...
# Set theme
set -Ux BASE16_THEME edge-light

# Optionally export variables
if test -n "$TINTED_SHELL_ENABLE_BASE16_VARS"; or test -n "$BASE16_SHELL_ENABLE_VARS"
  set -gx BASE16_COLOR_00_HEX "fafafa"
  set -gx BASE16_COLOR_01_HEX "e3e5e8"
  set -gx BASE16_COLOR_02_HEX "acb1b9"
  set -gx BASE16_COLOR_03_HEX "9197a1"
  set -gx BASE16_COLOR_04_HEX "5e646f"
  set -gx BASE16_COLOR_05_HEX "474752"
  set -gx BASE16_COLOR_06_HEX "3a3a46"
  set -gx BASE16_COLOR_07_HEX "2e2e38"
  set -gx BASE16_COLOR_08_HEX "db7070"
  set -gx BASE16_COLOR_09_HEX "eba31a"
  set -gx BASE16_COLOR_0A_HEX "ebcc1a"
  set -gx BASE16_COLOR_0B_HEX "7c9f4b"
  set -gx BASE16_COLOR_0C_HEX "509c93"
  set -gx BASE16_COLOR_0D_HEX "6587bf"
  set -gx BASE16_COLOR_0E_HEX "b870ce"
  set -gx BASE16_COLOR_0F_HEX "509c93"
end
