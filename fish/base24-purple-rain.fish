...
set -l color00 "20/08/4a" # Base 00 - Black
set -l color01 "ff/26/0d" # Base 08 - Red
set -l color02 "9a/e2/04" # Base 0B - Green
set -l color03 "00/a5/ff" # Base 0A - Yellow
set -l color04 "00/a1/f9" # Base 0D - Blue
set -l color05 "80/5b/b5" # Base 0E - Magenta
set -l color06 "00/dd/ef" # Base 0C - Cyan
set -l color07 "d3/d4/d4" # Base 05 - White
...
set -l color16 "ff/c4/00" # Base 09
set -l color17 "7f/13/06" # Base 0F
set -l color18 "00/00/00" # Base 01
set -l color19 "55/55/55" # Base 02
set -l color20 "a9/aa/aa" # Base 04
set -l color21 "fe/ff/ff" # Base 06
set -l color_foreground "d3/d4/d4" # Base 05
set -l color_background "20/08/4a" # Base 00
...
set -U fish_color_end d3d4d4
set -U fish_color_error brred
set -U fish_color_param a9aaaa
set -U fish_color_valid_path --underline
set -U fish_color_option brcyan
set -U fish_color_comment 7f7f7f
set -U fish_color_selection feffff --bold --background=555555
...
set -U fish_pager_color_progress 000000 --background=a9aaaa
set -U fish_pager_color_background normal --background=20084a
set -U fish_pager_color_prefix normal --bold
set -U fish_pager_color_completion normal
set -U fish_pager_color_description ffc400 --dim
set -U fish_pager_color_selected_background feffff --background=555555
set -U fish_pager_color_selected_prefix feffff --bold --background=555555
...
# Set theme
set -Ux BASE24_THEME purple-rain

# Optionally export variables
if test -n "$TINTED_SHELL_ENABLE_BASE24_VARS"; or test -n "$BASE24_SHELL_ENABLE_VARS"
  set -gx BASE24_COLOR_00_HEX "20084a"
  set -gx BASE24_COLOR_01_HEX "000000"
  set -gx BASE24_COLOR_02_HEX "555555"
  set -gx BASE24_COLOR_03_HEX "7f7f7f"
  set -gx BASE24_COLOR_04_HEX "a9aaaa"
  set -gx BASE24_COLOR_05_HEX "d3d4d4"
  set -gx BASE24_COLOR_06_HEX "feffff"
  set -gx BASE24_COLOR_07_HEX "feffff"
  set -gx BASE24_COLOR_08_HEX "ff260d"
  set -gx BASE24_COLOR_09_HEX "ffc400"
  set -gx BASE24_COLOR_0A_HEX "00a5ff"
  set -gx BASE24_COLOR_0B_HEX "9ae204"
  set -gx BASE24_COLOR_0C_HEX "00ddef"
  set -gx BASE24_COLOR_0D_HEX "00a1f9"
  set -gx BASE24_COLOR_0E_HEX "805bb5"
  set -gx BASE24_COLOR_0F_HEX "7f1306"
end
