...
set -l color03 "e6/db/74" # Base 0A - Yellow
set -l color04 "66/d9/ef" # Base 0D - Blue
set -l color05 "9e/6f/fe" # Base 0E - Magenta
set -l color06 "70/83/87" # Base 0C - Cyan
set -l color07 "cd/cd/cd" # Base 05 - White
...
set -l color17 "e8/b8/82" # Base 0F
set -l color18 "30/30/30" # Base 01
set -l color19 "35/35/35" # Base 02
set -l color20 "70/70/70" # Base 04
set -l color21 "e5/e5/e5" # Base 06
set -l color_foreground "cd/cd/cd" # Base 05
...
set -U fish_pager_color_progress 303030 --background=707070
...
set -U fish_pager_color_selected_background e5e5e5 --background=353535
set -U fish_pager_color_selected_prefix e5e5e5 --bold --background=353535
...
if test -n "$TINTED_SHELL_ENABLE_BASE16_VARS"; or test -n "$BASE16_SHELL_ENABLE_VARS"
  ...
  set -gx BASE16_COLOR_04_HEX "707070"
  set -gx BASE16_COLOR_05_HEX "cdcdcd"
  set -gx BASE16_COLOR_06_HEX "e5e5e5"
  set -gx BASE16_COLOR_07_HEX "ffffff"
  set -gx BASE16_COLOR_08_HEX "f92672"
  set -gx BASE16_COLOR_09_HEX "fd971f"
  set -gx BASE16_COLOR_0A_HEX "e6db74"
  set -gx BASE16_COLOR_0B_HEX "a6e22e"
  set -gx BASE16_COLOR_0C_HEX "708387"
  set -gx BASE16_COLOR_0D_HEX "66d9ef"
  set -gx BASE16_COLOR_0E_HEX "9e6ffe"
  set -gx BASE16_COLOR_0F_HEX "e8b882"
end
