...
set -l color01 "cc/55/55" # Base 08 - Red
set -l color02 "55/cc/55" # Base 0B - Green
set -l color03 "55/55/ff" # Base 0A - Yellow
set -l color04 "54/55/cb" # Base 0D - Blue
set -l color05 "cc/55/cc" # Base 0E - Magenta
...
set -l color_foreground "ae/ae/ae" # Base 05
...
set -U fish_pager_color_progress 000000 --background=909090
set -U fish_pager_color_background normal --background=000000
set -U fish_pager_color_prefix normal --bold
set -U fish_pager_color_completion normal
set -U fish_pager_color_description cdcd55 --dim
set -U fish_pager_color_selected_background cccccc --background=555555
set -U fish_pager_color_selected_prefix cccccc --bold --background=555555
...
if test -n "$TINTED_SHELL_ENABLE_BASE24_VARS"; or test -n "$BASE24_SHELL_ENABLE_VARS"
  ...
  set -gx BASE24_COLOR_05_HEX "aeaeae"
  set -gx BASE24_COLOR_06_HEX "cccccc"
  set -gx BASE24_COLOR_07_HEX "ffffff"
  set -gx BASE24_COLOR_08_HEX "cc5555"
  set -gx BASE24_COLOR_09_HEX "cdcd55"
  set -gx BASE24_COLOR_0A_HEX "5555ff"
  set -gx BASE24_COLOR_0B_HEX "55cc55"
  set -gx BASE24_COLOR_0C_HEX "7acaca"
  set -gx BASE24_COLOR_0D_HEX "5455cb"
  set -gx BASE24_COLOR_0E_HEX "cc55cc"
  set -gx BASE24_COLOR_0F_HEX "662a2a"
end
