...
set -l color01 "c8/28/29" # Base 08 - Red
set -l color02 "71/8c/00" # Base 0B - Green
set -l color03 "ea/b7/00" # Base 0A - Yellow
set -l color04 "42/71/ae" # Base 0D - Blue
set -l color05 "89/59/a8" # Base 0E - Magenta
set -l color06 "3e/99/9f" # Base 0C - Cyan
...
set -l color16 "f5/87/1f" # Base 09
...
set -U fish_pager_color_description f5871f --dim
...
if test -n "$TINTED_SHELL_ENABLE_BASE16_VARS"; or test -n "$BASE16_SHELL_ENABLE_VARS"
  ...
  set -gx BASE16_COLOR_08_HEX "c82829"
  set -gx BASE16_COLOR_09_HEX "f5871f"
  set -gx BASE16_COLOR_0A_HEX "eab700"
  set -gx BASE16_COLOR_0B_HEX "718c00"
  set -gx BASE16_COLOR_0C_HEX "3e999f"
  set -gx BASE16_COLOR_0D_HEX "4271ae"
  set -gx BASE16_COLOR_0E_HEX "8959a8"
  set -gx BASE16_COLOR_0F_HEX "a3685a"
end
