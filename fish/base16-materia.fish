...
set -l color02 "8b/d6/49" # Base 0B - Green
set -l color03 "ff/cc/00" # Base 0A - Yellow
set -l color04 "89/dd/ff" # Base 0D - Blue
set -l color05 "82/aa/ff" # Base 0E - Magenta
set -l color06 "80/cb/c4" # Base 0C - Cyan
set -l color07 "cd/d3/de" # Base 05 - White
set -l color08 "70/78/80" # Base 03 - Bright Black
...
set -l color16 "ea/95/60" # Base 09
set -l color17 "ec/5f/67" # Base 0F
set -l color18 "2c/39/3f" # Base 01
set -l color19 "37/47/4f" # Base 02
set -l color20 "c9/cc/d3" # Base 04
set -l color21 "d5/db/e5" # Base 06
set -l color_foreground "cd/d3/de" # Base 05
...
set -U fish_color_end cdd3de
set -U fish_color_error brred
set -U fish_color_param c9ccd3
set -U fish_color_valid_path --underline
set -U fish_color_option brcyan
set -U fish_color_comment 707880
set -U fish_color_selection d5dbe5 --bold --background=37474f
set -U fish_color_operator brblue
set -U fish_color_escape brcyan
set -U fish_color_autosuggestion 707880
...
set -U fish_pager_color_progress 2c393f --background=c9ccd3
set -U fish_pager_color_background normal --background=263238
set -U fish_pager_color_prefix normal --bold
set -U fish_pager_color_completion normal
set -U fish_pager_color_description ea9560 --dim
set -U fish_pager_color_selected_background d5dbe5 --background=37474f
set -U fish_pager_color_selected_prefix d5dbe5 --bold --background=37474f
set -U fish_pager_color_selected_completion d5dbe5
...
# Set theme
set -Ux BASE16_THEME materia

# Optionally export variables
if test -n "$TINTED_SHELL_ENABLE_BASE16_VARS"; or test -n "$BASE16_SHELL_ENABLE_VARS"
  set -gx BASE16_COLOR_00_HEX "263238"
  set -gx BASE16_COLOR_01_HEX "2c393f"
  set -gx BASE16_COLOR_02_HEX "37474f"
  set -gx BASE16_COLOR_03_HEX "707880"
  set -gx BASE16_COLOR_04_HEX "c9ccd3"
  set -gx BASE16_COLOR_05_HEX "cdd3de"
  set -gx BASE16_COLOR_06_HEX "d5dbe5"
  set -gx BASE16_COLOR_07_HEX "ffffff"
  set -gx BASE16_COLOR_08_HEX "ec5f67"
  set -gx BASE16_COLOR_09_HEX "ea9560"
  set -gx BASE16_COLOR_0A_HEX "ffcc00"
  set -gx BASE16_COLOR_0B_HEX "8bd649"
  set -gx BASE16_COLOR_0C_HEX "80cbc4"
  set -gx BASE16_COLOR_0D_HEX "89ddff"
  set -gx BASE16_COLOR_0E_HEX "82aaff"
  set -gx BASE16_COLOR_0F_HEX "ec5f67"
end
