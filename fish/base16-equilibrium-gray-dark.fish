...
set -l color07 "ab/ab/ab" # Base 05 - White
...
set -l color18 "1b/1b/1b" # Base 01
set -l color19 "26/26/26" # Base 02
set -l color20 "91/91/91" # Base 04
set -l color21 "c6/c6/c6" # Base 06
set -l color_foreground "ab/ab/ab" # Base 05
...
set -U fish_pager_color_progress 1b1b1b --background=919191
set -U fish_pager_color_background normal --background=111111
set -U fish_pager_color_prefix normal --bold
set -U fish_pager_color_completion normal
set -U fish_pager_color_description df5923 --dim
set -U fish_pager_color_selected_background c6c6c6 --background=262626
set -U fish_pager_color_selected_prefix c6c6c6 --bold --background=262626
set -U fish_pager_color_selected_completion c6c6c6
...
# Set theme
set -Ux BASE16_THEME equilibrium-gray-dark

# Optionally export variables
if test -n "$TINTED_SHELL_ENABLE_BASE16_VARS"; or test -n "$BASE16_SHELL_ENABLE_VARS"
  set -gx BASE16_COLOR_00_HEX "111111"
  set -gx BASE16_COLOR_01_HEX "1b1b1b"
  set -gx BASE16_COLOR_02_HEX "262626"
  set -gx BASE16_COLOR_03_HEX "777777"
  set -gx BASE16_COLOR_04_HEX "919191"
  set -gx BASE16_COLOR_05_HEX "ababab"
  set -gx BASE16_COLOR_06_HEX "c6c6c6"
  set -gx BASE16_COLOR_07_HEX "e2e2e2"
