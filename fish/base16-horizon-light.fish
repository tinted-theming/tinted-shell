...
set -l color00 "fd/f0/ed" # Base 00 - Black
set -l color01 "f7/93/9b" # Base 08 - Red
set -l color02 "94/e1/b0" # Base 0B - Green
set -l color03 "fb/e0/d9" # Base 0A - Yellow
set -l color04 "da/10/3f" # Base 0D - Blue
set -l color05 "1d/89/91" # Base 0E - Magenta
set -l color06 "dc/33/18" # Base 0C - Cyan
set -l color07 "40/3c/3d" # Base 05 - White
set -l color08 "bd/b3/b1" # Base 03 - Bright Black
...
set -l color15 "20/1c/1d" # Base 07 - Bright White
set -l color16 "f6/66/1e" # Base 09
set -l color17 "e5/8c/92" # Base 0F
set -l color18 "fa/da/d1" # Base 01
set -l color19 "f9/cb/be" # Base 02
set -l color20 "94/8c/8a" # Base 04
set -l color21 "30/2c/2d" # Base 06
set -l color_foreground "40/3c/3d" # Base 05
set -l color_background "fd/f0/ed" # Base 00
...
# Set theme
set -Ux BASE16_THEME horizon-light

# Optionally export variables
if test -n "$TINTED_SHELL_ENABLE_BASE16_VARS"; or test -n "$BASE16_SHELL_ENABLE_VARS"
  set -gx BASE16_COLOR_00_HEX "fdf0ed"
  set -gx BASE16_COLOR_01_HEX "fadad1"
  set -gx BASE16_COLOR_02_HEX "f9cbbe"
  set -gx BASE16_COLOR_03_HEX "bdb3b1"
  set -gx BASE16_COLOR_04_HEX "948c8a"
  set -gx BASE16_COLOR_05_HEX "403c3d"
  set -gx BASE16_COLOR_06_HEX "302c2d"
  set -gx BASE16_COLOR_07_HEX "201c1d"
  set -gx BASE16_COLOR_08_HEX "f7939b"
  set -gx BASE16_COLOR_09_HEX "f6661e"
  set -gx BASE16_COLOR_0A_HEX "fbe0d9"
  set -gx BASE16_COLOR_0B_HEX "94e1b0"
  set -gx BASE16_COLOR_0C_HEX "dc3318"
  set -gx BASE16_COLOR_0D_HEX "da103f"
  set -gx BASE16_COLOR_0E_HEX "1d8991"
  set -gx BASE16_COLOR_0F_HEX "e58c92"
end
