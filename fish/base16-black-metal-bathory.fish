...
set -l color02 "fb/cb/97" # Base 0B - Green
set -l color03 "e7/8a/53" # Base 0A - Yellow
...
# Set theme
set -Ux BASE16_THEME black-metal-bathory
...
if test -n "$TINTED_SHELL_ENABLE_BASE16_VARS"; or test -n "$BASE16_SHELL_ENABLE_VARS"
  ...
  set -gx BASE16_COLOR_0A_HEX "e78a53"
  set -gx BASE16_COLOR_0B_HEX "fbcb97"
