...
set -U fish_color_selection deb88d --background=424b52
set -U fish_color_operator magenta
set -U fish_color_escape fca02f
...
set -U fish_color_search_match yellow --background=424b52
set -U fish_color_history_current --underline=curly
set -U fish_pager_color_progress 17384c --background=90816f
set -U fish_pager_color_background --background=08131a
set -U fish_pager_color_prefix --bold --italics
set -U fish_pager_color_completion normal
set -U fish_pager_color_description fca02f
set -U fish_pager_color_selected_background --background=424b52
set -U fish_pager_color_selected_prefix --bold --italics --background=424b52
