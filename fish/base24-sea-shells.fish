...
set -l color00 "08/13/1a" # Base 00 - Black
set -l color01 "d1/50/23" # Base 08 - Red
set -l color02 "02/7c/9b" # Base 0B - Green
set -l color03 "1b/bc/dd" # Base 0A - Yellow
set -l color04 "1e/49/50" # Base 0D - Blue
set -l color05 "68/d3/f1" # Base 0E - Magenta
set -l color06 "50/a3/b5" # Base 0C - Cyan
set -l color07 "b7/9c/7e" # Base 05 - White
set -l color08 "69/66/60" # Base 03 - Bright Black
...
set -l color15 "fe/e3/cd" # Base 07 - Bright White
set -l color16 "fc/a0/2f" # Base 09
set -l color17 "68/28/11" # Base 0F
set -l color18 "17/38/4c" # Base 01
set -l color19 "42/4b/52" # Base 02
set -l color20 "90/81/6f" # Base 04
set -l color21 "de/b8/8d" # Base 06
set -l color_foreground "b7/9c/7e" # Base 05
set -l color_background "08/13/1a" # Base 00
...
set -U fish_color_end b79c7e
set -U fish_color_error brred
set -U fish_color_param 90816f
set -U fish_color_valid_path --underline
set -U fish_color_option brcyan
set -U fish_color_comment 696660
set -U fish_color_selection deb88d --bold --background=424b52
set -U fish_color_operator brblue
set -U fish_color_escape brcyan
set -U fish_color_autosuggestion 696660
...
set -U fish_color_search_match bryellow --background=424b52
set -U fish_color_history_current --bold
set -U fish_pager_color_progress 17384c --background=90816f
set -U fish_pager_color_background normal --background=08131a
set -U fish_pager_color_prefix normal --bold
set -U fish_pager_color_completion normal
set -U fish_pager_color_description fca02f --dim
set -U fish_pager_color_selected_background deb88d --background=424b52
set -U fish_pager_color_selected_prefix deb88d --bold --background=424b52
set -U fish_pager_color_selected_completion deb88d
...
# Set theme
set -Ux BASE24_THEME sea-shells

# Optionally export variables
if test -n "$TINTED_SHELL_ENABLE_BASE24_VARS"; or test -n "$BASE24_SHELL_ENABLE_VARS"
  set -gx BASE24_COLOR_00_HEX "08131a"
  set -gx BASE24_COLOR_01_HEX "17384c"
  set -gx BASE24_COLOR_02_HEX "424b52"
  set -gx BASE24_COLOR_03_HEX "696660"
  set -gx BASE24_COLOR_04_HEX "90816f"
  set -gx BASE24_COLOR_05_HEX "b79c7e"
  set -gx BASE24_COLOR_06_HEX "deb88d"
  set -gx BASE24_COLOR_07_HEX "fee3cd"
  set -gx BASE24_COLOR_08_HEX "d15023"
  set -gx BASE24_COLOR_09_HEX "fca02f"
  set -gx BASE24_COLOR_0A_HEX "1bbcdd"
  set -gx BASE24_COLOR_0B_HEX "027c9b"
  set -gx BASE24_COLOR_0C_HEX "50a3b5"
  set -gx BASE24_COLOR_0D_HEX "1e4950"
  set -gx BASE24_COLOR_0E_HEX "68d3f1"
  set -gx BASE24_COLOR_0F_HEX "682811"
end
