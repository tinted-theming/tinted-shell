...
set -l color17 "7f/2a/1d" # Base 0F
set -l color18 "28/2a/2e" # Base 01
set -l color19 "4d/4d/4c" # Base 02
set -l color20 "8e/90/8c" # Base 04
...
set -U fish_color_param 8e908c
set -U fish_color_valid_path --underline
set -U fish_color_option brcyan
set -U fish_color_comment 969896
set -U fish_color_selection efefef --bold --background=4d4d4c
...
set -U fish_color_search_match bryellow --background=4d4d4c
set -U fish_color_history_current --bold
set -U fish_pager_color_progress 282a2e --background=8e908c
set -U fish_pager_color_background normal --background=1d1f21
set -U fish_pager_color_prefix normal --bold
set -U fish_pager_color_completion normal
set -U fish_pager_color_description f5871f --dim
set -U fish_pager_color_selected_background efefef --background=4d4d4c
set -U fish_pager_color_selected_prefix efefef --bold --background=4d4d4c
...
# Set theme
set -Ux BASE16_THEME yesterday

# Optionally export variables
if test -n "$TINTED_SHELL_ENABLE_BASE16_VARS"; or test -n "$BASE16_SHELL_ENABLE_VARS"
  set -gx BASE16_COLOR_00_HEX "1d1f21"
  set -gx BASE16_COLOR_01_HEX "282a2e"
  set -gx BASE16_COLOR_02_HEX "4d4d4c"
  set -gx BASE16_COLOR_03_HEX "969896"
  set -gx BASE16_COLOR_04_HEX "8e908c"
  ...
  set -gx BASE16_COLOR_0F_HEX "7f2a1d"
end
