...
set -l color00 "16/16/1e" # Base 00 - Black
set -l color01 "f7/76/8e" # Base 08 - Red
set -l color02 "41/a6/b5" # Base 0B - Green
set -l color03 "e0/af/68" # Base 0A - Yellow
set -l color04 "7a/a2/f7" # Base 0D - Blue
set -l color05 "bb/9a/f7" # Base 0E - Magenta
set -l color06 "7d/cf/ff" # Base 0C - Cyan
set -l color07 "78/7c/99" # Base 05 - White
...
set -l color17 "d1/86/16" # Base 0F
set -l color18 "1a/1b/26" # Base 01
set -l color19 "2f/35/49" # Base 02
set -l color20 "78/7c/99" # Base 04
set -l color21 "cb/cc/d1" # Base 06
set -l color_foreground "78/7c/99" # Base 05
set -l color_background "16/16/1e" # Base 00
...
set -U fish_pager_color_progress 1a1b26 --background=787c99
set -U fish_pager_color_background normal --background=16161e
set -U fish_pager_color_prefix normal --bold
set -U fish_pager_color_completion normal
set -U fish_pager_color_description ff9e64 --dim
...
# Set theme
set -Ux BASE16_THEME tokyo-night-terminal-dark

# Optionally export variables
if test -n "$TINTED_SHELL_ENABLE_BASE16_VARS"; or test -n "$BASE16_SHELL_ENABLE_VARS"
  set -gx BASE16_COLOR_00_HEX "16161e"
  set -gx BASE16_COLOR_01_HEX "1a1b26"
  set -gx BASE16_COLOR_02_HEX "2f3549"
  set -gx BASE16_COLOR_03_HEX "444b6a"
  set -gx BASE16_COLOR_04_HEX "787c99"
  set -gx BASE16_COLOR_05_HEX "787c99"
  set -gx BASE16_COLOR_06_HEX "cbccd1"
  set -gx BASE16_COLOR_07_HEX "d5d6db"
  set -gx BASE16_COLOR_08_HEX "f7768e"
  set -gx BASE16_COLOR_09_HEX "ff9e64"
  set -gx BASE16_COLOR_0A_HEX "e0af68"
  set -gx BASE16_COLOR_0B_HEX "41a6b5"
  set -gx BASE16_COLOR_0C_HEX "7dcfff"
  set -gx BASE16_COLOR_0D_HEX "7aa2f7"
  set -gx BASE16_COLOR_0E_HEX "bb9af7"
  set -gx BASE16_COLOR_0F_HEX "d18616"
end
