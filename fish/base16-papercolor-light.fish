...
set -l color01 "d7/00/00" # Base 08 - Red
set -l color02 "00/87/00" # Base 0B - Green
set -l color03 "d7/5f/00" # Base 0A - Yellow
set -l color04 "00/5f/87" # Base 0D - Blue
set -l color05 "87/00/af" # Base 0E - Magenta
set -l color06 "00/87/af" # Base 0C - Cyan
set -l color07 "5e/5e/5e" # Base 05 - White
set -l color08 "85/85/85" # Base 03 - Bright Black
...
set -l color15 "44/44/44" # Base 07 - Bright White
set -l color16 "d7/5f/00" # Base 09
set -l color17 "af/00/00" # Base 0F
set -l color18 "c4/c4/c4" # Base 01
set -l color19 "9e/9e/9e" # Base 02
set -l color20 "6b/6b/6b" # Base 04
set -l color21 "52/52/52" # Base 06
set -l color_foreground "5e/5e/5e" # Base 05
...
if test -n "$ITERM_SESSION_ID"
  put_template_custom Pg 5e5e5e # foreground
  put_template_custom Ph eeeeee # background
  put_template_custom Pi 5e5e5e # bold color
  put_template_custom Pj 9e9e9e # selection color
  put_template_custom Pk 5e5e5e # selected text color
  put_template_custom Pl 5e5e5e # cursor
...
set -U fish_color_end 5e5e5e
set -U fish_color_error brred
set -U fish_color_param 6b6b6b
set -U fish_color_valid_path --underline
set -U fish_color_option brcyan
set -U fish_color_comment 858585
set -U fish_color_selection 525252 --bold --background=9e9e9e
set -U fish_color_operator brblue
set -U fish_color_escape brcyan
set -U fish_color_autosuggestion 858585
...
set -U fish_color_search_match bryellow --background=9e9e9e
set -U fish_color_history_current --bold
set -U fish_pager_color_progress c4c4c4 --background=6b6b6b
set -U fish_pager_color_background normal --background=eeeeee
set -U fish_pager_color_prefix normal --bold
set -U fish_pager_color_completion normal
set -U fish_pager_color_description d75f00 --dim
set -U fish_pager_color_selected_background 525252 --background=9e9e9e
set -U fish_pager_color_selected_prefix 525252 --bold --background=9e9e9e
set -U fish_pager_color_selected_completion 525252
...
# Set theme
set -Ux BASE16_THEME papercolor-light

# Optionally export variables
if test -n "$TINTED_SHELL_ENABLE_BASE16_VARS"; or test -n "$BASE16_SHELL_ENABLE_VARS"
  set -gx BASE16_COLOR_00_HEX "eeeeee"
  set -gx BASE16_COLOR_01_HEX "c4c4c4"
  set -gx BASE16_COLOR_02_HEX "9e9e9e"
  set -gx BASE16_COLOR_03_HEX "858585"
  set -gx BASE16_COLOR_04_HEX "6b6b6b"
  set -gx BASE16_COLOR_05_HEX "5e5e5e"
  set -gx BASE16_COLOR_06_HEX "525252"
  set -gx BASE16_COLOR_07_HEX "444444"
  set -gx BASE16_COLOR_08_HEX "d70000"
  set -gx BASE16_COLOR_09_HEX "d75f00"
  set -gx BASE16_COLOR_0A_HEX "d75f00"
  set -gx BASE16_COLOR_0B_HEX "008700"
  set -gx BASE16_COLOR_0C_HEX "0087af"
  set -gx BASE16_COLOR_0D_HEX "005f87"
  set -gx BASE16_COLOR_0E_HEX "8700af"
  set -gx BASE16_COLOR_0F_HEX "af0000"
end
