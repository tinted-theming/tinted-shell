...
set -l color00 "fd/f9/f5" # Base 00 - Black
set -l color01 "ac/1f/35" # Base 08 - Red
set -l color02 "0c/68/0c" # Base 0B - Green
set -l color03 "64/5a/00" # Base 0A - Yellow
set -l color04 "01/58/ad" # Base 0D - Blue
set -l color05 "66/45/c2" # Base 0E - Magenta
set -l color06 "01/71/6f" # Base 0C - Cyan
set -l color07 "29/29/29" # Base 05 - White
set -l color08 "5a/5a/5a" # Base 03 - Bright Black
...
set -l color16 "ad/56/01" # Base 09
set -l color17 "a8/1a/66" # Base 0F
set -l color18 "f9/f5/f1" # Base 01
set -l color19 "ff/ea/da" # Base 02
set -l color20 "40/40/40" # Base 04
set -l color21 "18/18/18" # Base 06
set -l color_foreground "29/29/29" # Base 05
set -l color_background "fd/f9/f5" # Base 00
...
set -U fish_color_end 292929
set -U fish_color_error brred
set -U fish_color_param 404040
set -U fish_color_valid_path --underline
set -U fish_color_option brcyan
set -U fish_color_comment 5a5a5a
set -U fish_color_selection 181818 --bold --background=ffeada
set -U fish_color_operator brblue
set -U fish_color_escape brcyan
set -U fish_color_autosuggestion 5a5a5a
...
set -U fish_color_search_match bryellow --background=ffeada
set -U fish_color_history_current --bold
set -U fish_pager_color_progress f9f5f1 --background=404040
set -U fish_pager_color_background normal --background=fdf9f5
set -U fish_pager_color_prefix normal --bold
set -U fish_pager_color_completion normal
set -U fish_pager_color_description ad5601 --dim
set -U fish_pager_color_selected_background 181818 --background=ffeada
set -U fish_pager_color_selected_prefix 181818 --bold --background=ffeada
set -U fish_pager_color_selected_completion 181818
...
# Set theme
set -Ux BASE16_THEME measured-light

# Optionally export variables
if test -n "$TINTED_SHELL_ENABLE_BASE16_VARS"; or test -n "$BASE16_SHELL_ENABLE_VARS"
  set -gx BASE16_COLOR_00_HEX "fdf9f5"
  set -gx BASE16_COLOR_01_HEX "f9f5f1"
  set -gx BASE16_COLOR_02_HEX "ffeada"
  set -gx BASE16_COLOR_03_HEX "5a5a5a"
  set -gx BASE16_COLOR_04_HEX "404040"
  set -gx BASE16_COLOR_05_HEX "292929"
  set -gx BASE16_COLOR_06_HEX "181818"
  set -gx BASE16_COLOR_07_HEX "000000"
  set -gx BASE16_COLOR_08_HEX "ac1f35"
  set -gx BASE16_COLOR_09_HEX "ad5601"
  set -gx BASE16_COLOR_0A_HEX "645a00"
  set -gx BASE16_COLOR_0B_HEX "0c680c"
  set -gx BASE16_COLOR_0C_HEX "01716f"
  set -gx BASE16_COLOR_0D_HEX "0158ad"
  set -gx BASE16_COLOR_0E_HEX "6645c2"
  set -gx BASE16_COLOR_0F_HEX "a81a66"
end
