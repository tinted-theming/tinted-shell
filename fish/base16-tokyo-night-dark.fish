...
set -l color00 "1a/1b/26" # Base 00 - Black
set -l color01 "c0/ca/f5" # Base 08 - Red
set -l color02 "9e/ce/6a" # Base 0B - Green
set -l color03 "0d/b9/d7" # Base 0A - Yellow
set -l color04 "2a/c3/de" # Base 0D - Blue
set -l color05 "bb/9a/f7" # Base 0E - Magenta
set -l color06 "b4/f9/f8" # Base 0C - Cyan
set -l color07 "a9/b1/d6" # Base 05 - White
set -l color08 "44/4b/6a" # Base 03 - Bright Black
...
set -l color15 "d5/d6/db" # Base 07 - Bright White
set -l color16 "a9/b1/d6" # Base 09
set -l color17 "f7/76/8e" # Base 0F
set -l color18 "16/16/1e" # Base 01
set -l color19 "2f/35/49" # Base 02
set -l color20 "78/7c/99" # Base 04
set -l color21 "cb/cc/d1" # Base 06
set -l color_foreground "a9/b1/d6" # Base 05
set -l color_background "1a/1b/26" # Base 00
...
set -U fish_color_comment 444b6a
set -U fish_color_selection cbccd1 --bold --background=2f3549
set -U fish_color_operator brblue
set -U fish_color_escape brcyan
set -U fish_color_autosuggestion 444b6a
...
set -U fish_color_search_match bryellow --background=2f3549
set -U fish_color_history_current --bold
set -U fish_pager_color_progress 16161e --background=787c99
set -U fish_pager_color_background normal --background=1a1b26
set -U fish_pager_color_prefix normal --bold
set -U fish_pager_color_completion normal
set -U fish_pager_color_description a9b1d6 --dim
set -U fish_pager_color_selected_background cbccd1 --background=2f3549
set -U fish_pager_color_selected_prefix cbccd1 --bold --background=2f3549
set -U fish_pager_color_selected_completion cbccd1
...
# Set theme
set -Ux BASE16_THEME tokyo-night-dark

# Optionally export variables
if test -n "$TINTED_SHELL_ENABLE_BASE16_VARS"; or test -n "$BASE16_SHELL_ENABLE_VARS"
  set -gx BASE16_COLOR_00_HEX "1a1b26"
  set -gx BASE16_COLOR_01_HEX "16161e"
  set -gx BASE16_COLOR_02_HEX "2f3549"
  set -gx BASE16_COLOR_03_HEX "444b6a"
  set -gx BASE16_COLOR_04_HEX "787c99"
  set -gx BASE16_COLOR_05_HEX "a9b1d6"
  set -gx BASE16_COLOR_06_HEX "cbccd1"
  set -gx BASE16_COLOR_07_HEX "d5d6db"
  set -gx BASE16_COLOR_08_HEX "c0caf5"
  set -gx BASE16_COLOR_09_HEX "a9b1d6"
  set -gx BASE16_COLOR_0A_HEX "0db9d7"
  set -gx BASE16_COLOR_0B_HEX "9ece6a"
  set -gx BASE16_COLOR_0C_HEX "b4f9f8"
  set -gx BASE16_COLOR_0D_HEX "2ac3de"
  set -gx BASE16_COLOR_0E_HEX "bb9af7"
  set -gx BASE16_COLOR_0F_HEX "f7768e"
end
