...
set -l color01 "b1/49/56" # Base 08 - Red
set -l color02 "91/b3/77" # Base 0B - Green
set -l color03 "54/85/c0" # Base 0A - Yellow
set -l color04 "7b/8f/a4" # Base 0D - Blue
set -l color05 "a5/77/9e" # Base 0E - Magenta
set -l color06 "7f/cc/cb" # Base 0C - Cyan
set -l color07 "9a/9f/a6" # Base 05 - White
set -l color08 "6c/6d/70" # Base 03 - Bright Black
...
set -l color16 "c6/72/5a" # Base 09
set -l color17 "58/24/2b" # Base 0F
set -l color18 "15/17/1c" # Base 01
set -l color19 "55/55/55" # Base 02
set -l color20 "83/86/8b" # Base 04
set -l color21 "b2/b8/c2" # Base 06
set -l color_foreground "9a/9f/a6" # Base 05
...
set -U fish_color_end 9a9fa6
set -U fish_color_error brred
set -U fish_color_param 83868b
set -U fish_color_valid_path --underline
set -U fish_color_option brcyan
set -U fish_color_comment 6c6d70
set -U fish_color_selection b2b8c2 --bold --background=555555
set -U fish_color_operator brblue
set -U fish_color_escape brcyan
set -U fish_color_autosuggestion 6c6d70
...
set -U fish_pager_color_progress 15171c --background=83868b
set -U fish_pager_color_background normal --background=212121
set -U fish_pager_color_prefix normal --bold
set -U fish_pager_color_completion normal
set -U fish_pager_color_description c6725a --dim
set -U fish_pager_color_selected_background b2b8c2 --background=555555
set -U fish_pager_color_selected_prefix b2b8c2 --bold --background=555555
set -U fish_pager_color_selected_completion b2b8c2
...
# Set theme
set -Ux BASE24_THEME space-gray-eighties-dull

# Optionally export variables
if test -n "$TINTED_SHELL_ENABLE_BASE24_VARS"; or test -n "$BASE24_SHELL_ENABLE_VARS"
  set -gx BASE24_COLOR_00_HEX "212121"
  set -gx BASE24_COLOR_01_HEX "15171c"
  set -gx BASE24_COLOR_02_HEX "555555"
  set -gx BASE24_COLOR_03_HEX "6c6d70"
  set -gx BASE24_COLOR_04_HEX "83868b"
  set -gx BASE24_COLOR_05_HEX "9a9fa6"
  set -gx BASE24_COLOR_06_HEX "b2b8c2"
  set -gx BASE24_COLOR_07_HEX "ffffff"
  set -gx BASE24_COLOR_08_HEX "b14956"
  set -gx BASE24_COLOR_09_HEX "c6725a"
  set -gx BASE24_COLOR_0A_HEX "5485c0"
  set -gx BASE24_COLOR_0B_HEX "91b377"
  set -gx BASE24_COLOR_0C_HEX "7fcccb"
  set -gx BASE24_COLOR_0D_HEX "7b8fa4"
  set -gx BASE24_COLOR_0E_HEX "a5779e"
  set -gx BASE24_COLOR_0F_HEX "58242b"
end
