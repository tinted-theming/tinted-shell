...
set -l color00 "0e/10/0a" # Base 00 - Black
set -l color01 "c7/00/31" # Base 08 - Red
set -l color02 "29/cf/13" # Base 0B - Green
set -l color03 "97/a4/f7" # Base 0A - Yellow
set -l color04 "34/49/d1" # Base 0D - Blue
set -l color05 "84/00/ff" # Base 0E - Magenta
set -l color06 "07/98/ab" # Base 0C - Cyan
set -l color07 "c0/b3/c0" # Base 05 - White
set -l color08 "7c/77/7c" # Base 03 - Bright Black
...
set -l color16 "d8/e3/0e" # Base 09
set -l color17 "63/00/18" # Base 0F
set -l color18 "4d/4d/4d" # Base 01
set -l color19 "5a/5a/5a" # Base 02
set -l color20 "9e/95/9e" # Base 04
set -l color21 "e2/d1/e3" # Base 06
set -l color_foreground "c0/b3/c0" # Base 05
set -l color_background "0e/10/0a" # Base 00
...
set -U fish_color_end c0b3c0
set -U fish_color_error brred
set -U fish_color_param 9e959e
set -U fish_color_valid_path --underline
set -U fish_color_option brcyan
set -U fish_color_comment 7c777c
set -U fish_color_selection e2d1e3 --bold --background=5a5a5a
set -U fish_color_operator brblue
set -U fish_color_escape brcyan
set -U fish_color_autosuggestion 7c777c
...
set -U fish_color_search_match bryellow --background=5a5a5a
set -U fish_color_history_current --bold
set -U fish_pager_color_progress 4d4d4d --background=9e959e
set -U fish_pager_color_background normal --background=0e100a
set -U fish_pager_color_prefix normal --bold
set -U fish_pager_color_completion normal
set -U fish_pager_color_description d8e30e --dim
set -U fish_pager_color_selected_background e2d1e3 --background=5a5a5a
set -U fish_pager_color_selected_prefix e2d1e3 --bold --background=5a5a5a
set -U fish_pager_color_selected_completion e2d1e3
...
# Set theme
set -Ux BASE24_THEME kibble

# Optionally export variables
if test -n "$TINTED_SHELL_ENABLE_BASE24_VARS"; or test -n "$BASE24_SHELL_ENABLE_VARS"
  set -gx BASE24_COLOR_00_HEX "0e100a"
  set -gx BASE24_COLOR_01_HEX "4d4d4d"
  set -gx BASE24_COLOR_02_HEX "5a5a5a"
  set -gx BASE24_COLOR_03_HEX "7c777c"
  set -gx BASE24_COLOR_04_HEX "9e959e"
  set -gx BASE24_COLOR_05_HEX "c0b3c0"
  set -gx BASE24_COLOR_06_HEX "e2d1e3"
  set -gx BASE24_COLOR_07_HEX "ffffff"
  set -gx BASE24_COLOR_08_HEX "c70031"
  set -gx BASE24_COLOR_09_HEX "d8e30e"
  set -gx BASE24_COLOR_0A_HEX "97a4f7"
  set -gx BASE24_COLOR_0B_HEX "29cf13"
  set -gx BASE24_COLOR_0C_HEX "0798ab"
  set -gx BASE24_COLOR_0D_HEX "3449d1"
  set -gx BASE24_COLOR_0E_HEX "8400ff"
  set -gx BASE24_COLOR_0F_HEX "630018"
end
