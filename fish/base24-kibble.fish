...
set -U fish_color_selection e2d1e3 --background=5a5a5a
set -U fish_color_operator magenta
set -U fish_color_escape d8e30e
...
set -U fish_color_search_match yellow --background=5a5a5a
set -U fish_color_history_current --underline=curly
set -U fish_pager_color_progress 4d4d4d --background=9e959e
set -U fish_pager_color_background --background=0e100a
set -U fish_pager_color_prefix --bold --italics
set -U fish_pager_color_completion normal
set -U fish_pager_color_description d8e30e
set -U fish_pager_color_selected_background --background=5a5a5a
set -U fish_pager_color_selected_prefix --bold --italics --background=5a5a5a
