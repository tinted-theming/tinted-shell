...
set -l color00 "31/36/3b" # Base 00 - Black
set -l color01 "ed/15/15" # Base 08 - Red
set -l color02 "11/d1/16" # Base 0B - Green
set -l color03 "3d/ae/e9" # Base 0A - Yellow
set -l color04 "1d/99/f3" # Base 0D - Blue
set -l color05 "9b/59/b6" # Base 0E - Magenta
set -l color06 "1a/bc/9c" # Base 0C - Cyan
set -l color07 "d3/d7/d8" # Base 05 - White
set -l color08 "9b/a5/a6" # Base 03 - Bright Black
...
set -l color16 "f6/74/00" # Base 09
set -l color17 "76/0a/0a" # Base 0F
set -l color18 "31/36/3b" # Base 01
set -l color19 "7f/8c/8d" # Base 02
set -l color20 "b7/be/bf" # Base 04
set -l color21 "ef/f0/f1" # Base 06
set -l color_foreground "d3/d7/d8" # Base 05
set -l color_background "31/36/3b" # Base 00
...
set -U fish_color_end d3d7d8
set -U fish_color_error brred
set -U fish_color_param b7bebf
set -U fish_color_valid_path --underline
set -U fish_color_option brcyan
set -U fish_color_comment 9ba5a6
set -U fish_color_selection eff0f1 --bold --background=7f8c8d
set -U fish_color_operator brblue
set -U fish_color_escape brcyan
set -U fish_color_autosuggestion 9ba5a6
...
set -U fish_pager_color_progress 31363b --background=b7bebf
set -U fish_pager_color_background normal --background=31363b
set -U fish_pager_color_prefix normal --bold
set -U fish_pager_color_completion normal
set -U fish_pager_color_description f67400 --dim
set -U fish_pager_color_selected_background eff0f1 --background=7f8c8d
set -U fish_pager_color_selected_prefix eff0f1 --bold --background=7f8c8d
set -U fish_pager_color_selected_completion eff0f1
...
# Set theme
set -Ux BASE24_THEME breeze

# Optionally export variables
if test -n "$TINTED_SHELL_ENABLE_BASE24_VARS"; or test -n "$BASE24_SHELL_ENABLE_VARS"
  set -gx BASE24_COLOR_00_HEX "31363b"
  set -gx BASE24_COLOR_01_HEX "31363b"
  set -gx BASE24_COLOR_02_HEX "7f8c8d"
  set -gx BASE24_COLOR_03_HEX "9ba5a6"
  set -gx BASE24_COLOR_04_HEX "b7bebf"
  set -gx BASE24_COLOR_05_HEX "d3d7d8"
  set -gx BASE24_COLOR_06_HEX "eff0f1"
  set -gx BASE24_COLOR_07_HEX "fcfcfc"
  set -gx BASE24_COLOR_08_HEX "ed1515"
  set -gx BASE24_COLOR_09_HEX "f67400"
  set -gx BASE24_COLOR_0A_HEX "3daee9"
  set -gx BASE24_COLOR_0B_HEX "11d116"
  set -gx BASE24_COLOR_0C_HEX "1abc9c"
  set -gx BASE24_COLOR_0D_HEX "1d99f3"
  set -gx BASE24_COLOR_0E_HEX "9b59b6"
  set -gx BASE24_COLOR_0F_HEX "760a0a"
end
