...
set -U fish_color_selection eff0f1 --background=7f8c8d
set -U fish_color_operator magenta
set -U fish_color_escape f67400
...
set -U fish_color_search_match yellow --background=7f8c8d
set -U fish_color_history_current --underline=curly
set -U fish_pager_color_progress 31363b --background=b7bebf
set -U fish_pager_color_background --background=31363b
set -U fish_pager_color_prefix --bold --italics
set -U fish_pager_color_completion normal
set -U fish_pager_color_description f67400
set -U fish_pager_color_selected_background --background=7f8c8d
set -U fish_pager_color_selected_prefix --bold --italics --background=7f8c8d
