...
set -l color01 "70/50/50" # Base 08 - Red
set -l color02 "60/b4/8a" # Base 0B - Green
set -l color03 "94/bf/f3" # Base 0A - Yellow
set -l color04 "50/60/70" # Base 0D - Blue
set -l color05 "dc/8c/c3" # Base 0E - Magenta
set -l color06 "8c/d0/d3" # Base 0C - Cyan
set -l color07 "c1/c9/b9" # Base 05 - White
set -l color08 "8b/a3/93" # Base 03 - Bright Black
...
set -l color16 "f0/df/af" # Base 09
set -l color17 "38/28/28" # Base 0F
set -l color18 "4d/4d/4d" # Base 01
set -l color19 "70/90/80" # Base 02
set -l color20 "a6/b6/a6" # Base 04
set -l color21 "dc/dc/cc" # Base 06
set -l color_foreground "c1/c9/b9" # Base 05
...
set -U fish_color_end c1c9b9
set -U fish_color_error brred
set -U fish_color_param a6b6a6
set -U fish_color_valid_path --underline
set -U fish_color_option brcyan
set -U fish_color_comment 8ba393
set -U fish_color_selection dcdccc --bold --background=709080
set -U fish_color_operator brblue
set -U fish_color_escape brcyan
set -U fish_color_autosuggestion 8ba393
...
set -U fish_color_search_match bryellow --background=709080
set -U fish_color_history_current --bold
set -U fish_pager_color_progress 4d4d4d --background=a6b6a6
set -U fish_pager_color_background normal --background=3f3f3f
set -U fish_pager_color_prefix normal --bold
set -U fish_pager_color_completion normal
set -U fish_pager_color_description f0dfaf --dim
set -U fish_pager_color_selected_background dcdccc --background=709080
set -U fish_pager_color_selected_prefix dcdccc --bold --background=709080
set -U fish_pager_color_selected_completion dcdccc
...
if test -n "$TINTED_SHELL_ENABLE_BASE24_VARS"; or test -n "$BASE24_SHELL_ENABLE_VARS"
  ...
  set -gx BASE24_COLOR_02_HEX "709080"
  set -gx BASE24_COLOR_03_HEX "8ba393"
  set -gx BASE24_COLOR_04_HEX "a6b6a6"
  set -gx BASE24_COLOR_05_HEX "c1c9b9"
  set -gx BASE24_COLOR_06_HEX "dcdccc"
  set -gx BASE24_COLOR_07_HEX "ffffff"
  set -gx BASE24_COLOR_08_HEX "705050"
  set -gx BASE24_COLOR_09_HEX "f0dfaf"
  set -gx BASE24_COLOR_0A_HEX "94bff3"
  set -gx BASE24_COLOR_0B_HEX "60b48a"
  set -gx BASE24_COLOR_0C_HEX "8cd0d3"
  set -gx BASE24_COLOR_0D_HEX "506070"
  set -gx BASE24_COLOR_0E_HEX "dc8cc3"
  set -gx BASE24_COLOR_0F_HEX "382828"
end
