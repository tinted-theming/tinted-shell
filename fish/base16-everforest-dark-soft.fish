...
set -l color00 "33/3c/43" # Base 00 - Black
...
set -l color07 "d3/c6/aa" # Base 05 - White
set -l color08 "85/92/89" # Base 03 - Bright Black
...
set -l color15 "f3/ea/d3" # Base 07 - Bright White
set -l color16 "e6/98/75" # Base 09
set -l color17 "9d/a9/a0" # Base 0F
set -l color18 "3a/46/4c" # Base 01
set -l color19 "4d/59/60" # Base 02
set -l color20 "9d/a9/a0" # Base 04
set -l color21 "dd/d8/be" # Base 06
set -l color_foreground "d3/c6/aa" # Base 05
set -l color_background "33/3c/43" # Base 00
...
set -U fish_color_end d3c6aa
set -U fish_color_error brred
set -U fish_color_param 9da9a0
set -U fish_color_valid_path --underline
set -U fish_color_option brcyan
set -U fish_color_comment 859289
set -U fish_color_selection ddd8be --bold --background=4d5960
...
set -U fish_color_search_match bryellow --background=4d5960
set -U fish_color_history_current --bold
set -U fish_pager_color_progress 3a464c --background=9da9a0
set -U fish_pager_color_background normal --background=333c43
set -U fish_pager_color_prefix normal --bold
set -U fish_pager_color_completion normal
set -U fish_pager_color_description e69875 --dim
set -U fish_pager_color_selected_background ddd8be --background=4d5960
set -U fish_pager_color_selected_prefix ddd8be --bold --background=4d5960
set -U fish_pager_color_selected_completion ddd8be
...
# Set theme
set -Ux BASE16_THEME everforest-dark-soft

# Optionally export variables
if test -n "$TINTED_SHELL_ENABLE_BASE16_VARS"; or test -n "$BASE16_SHELL_ENABLE_VARS"
  set -gx BASE16_COLOR_00_HEX "333c43"
  set -gx BASE16_COLOR_01_HEX "3a464c"
  set -gx BASE16_COLOR_02_HEX "4d5960"
  set -gx BASE16_COLOR_03_HEX "859289"
  set -gx BASE16_COLOR_04_HEX "9da9a0"
  set -gx BASE16_COLOR_05_HEX "d3c6aa"
  set -gx BASE16_COLOR_06_HEX "ddd8be"
  set -gx BASE16_COLOR_07_HEX "f3ead3"
  ...
  set -gx BASE16_COLOR_0F_HEX "9da9a0"
end
