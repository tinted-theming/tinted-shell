...
set -l color00 "07/2b/31" # Base 00 - Black
set -l color01 "ff/58/5d" # Base 08 - Red
set -l color02 "78/d6/4b" # Base 0B - Green
set -l color03 "fb/dd/40" # Base 0A - Yellow
set -l color04 "46/98/cb" # Base 0D - Blue
set -l color05 "d5/9e/d7" # Base 0E - Magenta
set -l color06 "2d/cc/d3" # Base 0C - Cyan
set -l color07 "f4/f5/f0" # Base 05 - White
set -l color08 "00/3b/49" # Base 03 - Bright Black
...
set -l color16 "ff/8f/1c" # Base 09
set -l color17 "9b/70/4d" # Base 0F
set -l color18 "00/31/3c" # Base 01
set -l color19 "00/3c/46" # Base 02
set -l color20 "00/77/8b" # Base 04
set -l color21 "f5/f5/f1" # Base 06
set -l color_foreground "f4/f5/f0" # Base 05
set -l color_background "07/2b/31" # Base 00
...
set -U fish_color_end f4f5f0
set -U fish_color_error brred
set -U fish_color_param 00778b
set -U fish_color_valid_path --underline
set -U fish_color_option brcyan
set -U fish_color_comment 003b49
set -U fish_color_selection f5f5f1 --bold --background=003c46
set -U fish_color_operator brblue
set -U fish_color_escape brcyan
set -U fish_color_autosuggestion 003b49
...
set -U fish_color_search_match bryellow --background=003c46
set -U fish_color_history_current --bold
set -U fish_pager_color_progress 00313c --background=00778b
set -U fish_pager_color_background normal --background=072b31
set -U fish_pager_color_prefix normal --bold
set -U fish_pager_color_completion normal
set -U fish_pager_color_description ff8f1c --dim
set -U fish_pager_color_selected_background f5f5f1 --background=003c46
set -U fish_pager_color_selected_prefix f5f5f1 --bold --background=003c46
set -U fish_pager_color_selected_completion f5f5f1
...
# Set theme
set -Ux BASE16_THEME sparky

# Optionally export variables
if test -n "$TINTED_SHELL_ENABLE_BASE16_VARS"; or test -n "$BASE16_SHELL_ENABLE_VARS"
  set -gx BASE16_COLOR_00_HEX "072b31"
  set -gx BASE16_COLOR_01_HEX "00313c"
  set -gx BASE16_COLOR_02_HEX "003c46"
  set -gx BASE16_COLOR_03_HEX "003b49"
  set -gx BASE16_COLOR_04_HEX "00778b"
  set -gx BASE16_COLOR_05_HEX "f4f5f0"
  set -gx BASE16_COLOR_06_HEX "f5f5f1"
  set -gx BASE16_COLOR_07_HEX "ffffff"
  set -gx BASE16_COLOR_08_HEX "ff585d"
  set -gx BASE16_COLOR_09_HEX "ff8f1c"
  set -gx BASE16_COLOR_0A_HEX "fbdd40"
  set -gx BASE16_COLOR_0B_HEX "78d64b"
  set -gx BASE16_COLOR_0C_HEX "2dccd3"
  set -gx BASE16_COLOR_0D_HEX "4698cb"
  set -gx BASE16_COLOR_0E_HEX "d59ed7"
  set -gx BASE16_COLOR_0F_HEX "9b704d"
end
