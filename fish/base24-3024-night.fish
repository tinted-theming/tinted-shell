...
set -l color03 "80/7d/7c" # Base 0A - Yellow
set -l color04 "01/a0/e4" # Base 0D - Blue
set -l color05 "a1/6a/94" # Base 0E - Magenta
set -l color06 "b5/e4/f4" # Base 0C - Cyan
set -l color07 "92/8f/8e" # Base 05 - White
set -l color08 "6e/6a/68" # Base 03 - Bright Black
...
set -l color19 "5c/58/55" # Base 02
set -l color20 "80/7d/7b" # Base 04
set -l color21 "a5/a2/a2" # Base 06
set -l color_foreground "92/8f/8e" # Base 05
...
set -U fish_color_end 928f8e
set -U fish_color_error brred
set -U fish_color_param 807d7b
set -U fish_color_valid_path --underline
set -U fish_color_option brcyan
set -U fish_color_comment 6e6a68
set -U fish_color_selection a5a2a2 --bold --background=5c5855
set -U fish_color_operator brblue
set -U fish_color_escape brcyan
set -U fish_color_autosuggestion 6e6a68
...
set -U fish_color_search_match bryellow --background=5c5855
set -U fish_color_history_current --bold
set -U fish_pager_color_progress 090300 --background=807d7b
set -U fish_pager_color_background normal --background=090300
set -U fish_pager_color_prefix normal --bold
set -U fish_pager_color_completion normal
set -U fish_pager_color_description fded02 --dim
set -U fish_pager_color_selected_background a5a2a2 --background=5c5855
set -U fish_pager_color_selected_prefix a5a2a2 --bold --background=5c5855
set -U fish_pager_color_selected_completion a5a2a2
...
# Set theme
set -Ux BASE24_THEME 3024-night

# Optionally export variables
if test -n "$TINTED_SHELL_ENABLE_BASE24_VARS"; or test -n "$BASE24_SHELL_ENABLE_VARS"
  set -gx BASE24_COLOR_00_HEX "090300"
  set -gx BASE24_COLOR_01_HEX "090300"
  set -gx BASE24_COLOR_02_HEX "5c5855"
  set -gx BASE24_COLOR_03_HEX "6e6a68"
  ...
  set -gx BASE24_COLOR_0B_HEX "01a252"
  set -gx BASE24_COLOR_0C_HEX "b5e4f4"
  set -gx BASE24_COLOR_0D_HEX "01a0e4"
  set -gx BASE24_COLOR_0E_HEX "a16a94"
  set -gx BASE24_COLOR_0F_HEX "6d1610"
end
