...
set -U fish_color_selection a5a2a2 --background=5c5855
set -U fish_color_operator magenta
set -U fish_color_escape fded02
...
set -U fish_color_search_match yellow --background=5c5855
set -U fish_color_history_current --underline=curly
set -U fish_pager_color_progress 090300 --background=807d7b
set -U fish_pager_color_background --background=090300
set -U fish_pager_color_prefix --bold --italics
set -U fish_pager_color_completion normal
set -U fish_pager_color_description fded02
set -U fish_pager_color_selected_background --background=5c5855
set -U fish_pager_color_selected_prefix --bold --italics --background=5c5855
