...
set -l color00 "23/26/29" # Base 00 - Black
set -l color01 "f1/12/35" # Base 08 - Red
set -l color02 "02/d8/49" # Base 0B - Green
set -l color03 "ff/b6/27" # Base 0A - Yellow
set -l color04 "00/a6/fb" # Base 0D - Blue
set -l color05 "f1/5e/e3" # Base 0E - Magenta
set -l color06 "0d/d9/d6" # Base 0C - Cyan
set -l color07 "f8/f8/f2" # Base 05 - White
set -l color08 "60/61/5d" # Base 03 - Bright Black
...
set -l color16 "ff/95/05" # Base 09
set -l color17 "b2/77/01" # Base 0F
set -l color18 "33/3b/3d" # Base 01
set -l color19 "48/4e/54" # Base 02
set -l color20 "c0/c0/bd" # Base 04
set -l color21 "fc/fc/f6" # Base 06
set -l color_foreground "f8/f8/f2" # Base 05
set -l color_background "23/26/29" # Base 00
...
set -U fish_color_comment 60615d
set -U fish_color_selection fcfcf6 --bold --background=484e54
set -U fish_color_operator brblue
set -U fish_color_escape brcyan
set -U fish_color_autosuggestion 60615d
...
set -U fish_pager_color_progress 333b3d --background=c0c0bd
set -U fish_pager_color_background normal --background=232629
set -U fish_pager_color_prefix normal --bold
set -U fish_pager_color_completion normal
set -U fish_pager_color_description ff9505 --dim
set -U fish_pager_color_selected_background fcfcf6 --background=484e54
set -U fish_pager_color_selected_prefix fcfcf6 --bold --background=484e54
set -U fish_pager_color_selected_completion fcfcf6
...
# Set theme
set -Ux BASE16_THEME humanoid-dark

# Optionally export variables
if test -n "$TINTED_SHELL_ENABLE_BASE16_VARS"; or test -n "$BASE16_SHELL_ENABLE_VARS"
  set -gx BASE16_COLOR_00_HEX "232629"
  set -gx BASE16_COLOR_01_HEX "333b3d"
  set -gx BASE16_COLOR_02_HEX "484e54"
  set -gx BASE16_COLOR_03_HEX "60615d"
  set -gx BASE16_COLOR_04_HEX "c0c0bd"
  set -gx BASE16_COLOR_05_HEX "f8f8f2"
  set -gx BASE16_COLOR_06_HEX "fcfcf6"
  set -gx BASE16_COLOR_07_HEX "fcfcfc"
  set -gx BASE16_COLOR_08_HEX "f11235"
  set -gx BASE16_COLOR_09_HEX "ff9505"
  set -gx BASE16_COLOR_0A_HEX "ffb627"
  set -gx BASE16_COLOR_0B_HEX "02d849"
  set -gx BASE16_COLOR_0C_HEX "0dd9d6"
  set -gx BASE16_COLOR_0D_HEX "00a6fb"
  set -gx BASE16_COLOR_0E_HEX "f15ee3"
