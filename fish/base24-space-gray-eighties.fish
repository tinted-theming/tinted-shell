...
set -l color02 "80/a7/63" # Base 0B - Green
set -l color03 "4d/83/d0" # Base 0A - Yellow
set -l color04 "54/85/c0" # Base 0D - Blue
set -l color05 "bf/83/c0" # Base 0E - Magenta
set -l color06 "57/c2/c0" # Base 0C - Cyan
set -l color07 "c7/c6/c2" # Base 05 - White
set -l color08 "7b/7a/79" # Base 03 - Bright Black
...
set -l color16 "fd/c2/53" # Base 09
set -l color17 "76/2f/33" # Base 0F
set -l color18 "15/17/1c" # Base 01
set -l color19 "55/55/55" # Base 02
set -l color20 "a1/a0/9e" # Base 04
set -l color21 "ee/ec/e7" # Base 06
set -l color_foreground "c7/c6/c2" # Base 05
...
set -U fish_color_end c7c6c2
set -U fish_color_error brred
set -U fish_color_param a1a09e
set -U fish_color_valid_path --underline
set -U fish_color_option brcyan
set -U fish_color_comment 7b7a79
set -U fish_color_selection eeece7 --bold --background=555555
set -U fish_color_operator brblue
set -U fish_color_escape brcyan
set -U fish_color_autosuggestion 7b7a79
...
set -U fish_pager_color_progress 15171c --background=a1a09e
set -U fish_pager_color_background normal --background=212121
set -U fish_pager_color_prefix normal --bold
set -U fish_pager_color_completion normal
set -U fish_pager_color_description fdc253 --dim
set -U fish_pager_color_selected_background eeece7 --background=555555
set -U fish_pager_color_selected_prefix eeece7 --bold --background=555555
set -U fish_pager_color_selected_completion eeece7
...
# Set theme
set -Ux BASE24_THEME space-gray-eighties
...
if test -n "$TINTED_SHELL_ENABLE_BASE24_VARS"; or test -n "$BASE24_SHELL_ENABLE_VARS"
  ...
  set -gx BASE24_COLOR_03_HEX "7b7a79"
  set -gx BASE24_COLOR_04_HEX "a1a09e"
  set -gx BASE24_COLOR_05_HEX "c7c6c2"
  set -gx BASE24_COLOR_06_HEX "eeece7"
  set -gx BASE24_COLOR_07_HEX "ffffff"
  set -gx BASE24_COLOR_08_HEX "ec5f67"
  set -gx BASE24_COLOR_09_HEX "fdc253"
  set -gx BASE24_COLOR_0A_HEX "4d83d0"
  set -gx BASE24_COLOR_0B_HEX "80a763"
  set -gx BASE24_COLOR_0C_HEX "57c2c0"
  set -gx BASE24_COLOR_0D_HEX "5485c0"
  set -gx BASE24_COLOR_0E_HEX "bf83c0"
  set -gx BASE24_COLOR_0F_HEX "762f33"
end
