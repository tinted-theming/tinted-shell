...
set -l color00 "1b/1b/1d" # Base 00 - Black
set -l color01 "f8/50/1a" # Base 08 - Red
set -l color02 "56/57/46" # Base 0B - Green
set -l color03 "33/93/c9" # Base 0A - Yellow
set -l color04 "2c/70/b7" # Base 0D - Blue
set -l color05 "f0/2d/4e" # Base 0E - Magenta
set -l color06 "3b/a0/a5" # Base 0C - Cyan
set -l color07 "98/ac/9c" # Base 05 - White
set -l color08 "71/ac/7c" # Base 03 - Bright Black
...
set -l color15 "8b/73/5a" # Base 07 - Bright White
set -l color16 "f9/76/1d" # Base 09
set -l color17 "7c/28/0d" # Base 0F
set -l color18 "24/24/26" # Base 01
set -l color19 "5e/ac/6c" # Base 02
set -l color20 "85/ac/8c" # Base 04
set -l color21 "ac/ac/ac" # Base 06
set -l color_foreground "98/ac/9c" # Base 05
set -l color_background "1b/1b/1d" # Base 00
...
set -U fish_color_end 98ac9c
set -U fish_color_error brred
set -U fish_color_param 85ac8c
set -U fish_color_valid_path --underline
set -U fish_color_option brcyan
set -U fish_color_comment 71ac7c
set -U fish_color_selection acacac --bold --background=5eac6c
set -U fish_color_operator brblue
set -U fish_color_escape brcyan
set -U fish_color_autosuggestion 71ac7c
...
set -U fish_color_search_match bryellow --background=5eac6c
set -U fish_color_history_current --bold
set -U fish_pager_color_progress 242426 --background=85ac8c
set -U fish_pager_color_background normal --background=1b1b1d
set -U fish_pager_color_prefix normal --bold
set -U fish_pager_color_completion normal
set -U fish_pager_color_description f9761d --dim
set -U fish_pager_color_selected_background acacac --background=5eac6c
set -U fish_pager_color_selected_prefix acacac --bold --background=5eac6c
set -U fish_pager_color_selected_completion acacac
...
# Set theme
set -Ux BASE24_THEME front-end-delight

# Optionally export variables
if test -n "$TINTED_SHELL_ENABLE_BASE24_VARS"; or test -n "$BASE24_SHELL_ENABLE_VARS"
  set -gx BASE24_COLOR_00_HEX "1b1b1d"
  set -gx BASE24_COLOR_01_HEX "242426"
  set -gx BASE24_COLOR_02_HEX "5eac6c"
  set -gx BASE24_COLOR_03_HEX "71ac7c"
  set -gx BASE24_COLOR_04_HEX "85ac8c"
  set -gx BASE24_COLOR_05_HEX "98ac9c"
  set -gx BASE24_COLOR_06_HEX "acacac"
  set -gx BASE24_COLOR_07_HEX "8b735a"
  set -gx BASE24_COLOR_08_HEX "f8501a"
  set -gx BASE24_COLOR_09_HEX "f9761d"
  set -gx BASE24_COLOR_0A_HEX "3393c9"
  set -gx BASE24_COLOR_0B_HEX "565746"
  set -gx BASE24_COLOR_0C_HEX "3ba0a5"
  set -gx BASE24_COLOR_0D_HEX "2c70b7"
  set -gx BASE24_COLOR_0E_HEX "f02d4e"
  set -gx BASE24_COLOR_0F_HEX "7c280d"
end
