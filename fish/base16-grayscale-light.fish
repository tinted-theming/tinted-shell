...
set -l color01 "7c/7c/7c" # Base 08 - Red
set -l color02 "8e/8e/8e" # Base 0B - Green
set -l color03 "a0/a0/a0" # Base 0A - Yellow
set -l color04 "68/68/68" # Base 0D - Blue
set -l color05 "74/74/74" # Base 0E - Magenta
set -l color06 "86/86/86" # Base 0C - Cyan
set -l color07 "46/46/46" # Base 05 - White
...
set -l color15 "10/10/10" # Base 07 - Bright White
set -l color16 "99/99/99" # Base 09
set -l color17 "5e/5e/5e" # Base 0F
set -l color18 "e3/e3/e3" # Base 01
set -l color19 "b9/b9/b9" # Base 02
set -l color20 "52/52/52" # Base 04
set -l color21 "25/25/25" # Base 06
set -l color_foreground "46/46/46" # Base 05
...
set -U fish_pager_color_progress e3e3e3 --background=525252
set -U fish_pager_color_background normal --background=f7f7f7
set -U fish_pager_color_prefix normal --bold
set -U fish_pager_color_completion normal
set -U fish_pager_color_description 999999 --dim
set -U fish_pager_color_selected_background 252525 --background=b9b9b9
set -U fish_pager_color_selected_prefix 252525 --bold --background=b9b9b9
set -U fish_pager_color_selected_completion 252525
...
# Set theme
set -Ux BASE16_THEME grayscale-light

# Optionally export variables
if test -n "$TINTED_SHELL_ENABLE_BASE16_VARS"; or test -n "$BASE16_SHELL_ENABLE_VARS"
  set -gx BASE16_COLOR_00_HEX "f7f7f7"
  set -gx BASE16_COLOR_01_HEX "e3e3e3"
  set -gx BASE16_COLOR_02_HEX "b9b9b9"
  set -gx BASE16_COLOR_03_HEX "ababab"
  set -gx BASE16_COLOR_04_HEX "525252"
  set -gx BASE16_COLOR_05_HEX "464646"
  set -gx BASE16_COLOR_06_HEX "252525"
  set -gx BASE16_COLOR_07_HEX "101010"
  set -gx BASE16_COLOR_08_HEX "7c7c7c"
  set -gx BASE16_COLOR_09_HEX "999999"
  set -gx BASE16_COLOR_0A_HEX "a0a0a0"
  set -gx BASE16_COLOR_0B_HEX "8e8e8e"
  set -gx BASE16_COLOR_0C_HEX "868686"
  set -gx BASE16_COLOR_0D_HEX "686868"
  set -gx BASE16_COLOR_0E_HEX "747474"
  set -gx BASE16_COLOR_0F_HEX "5e5e5e"
end
