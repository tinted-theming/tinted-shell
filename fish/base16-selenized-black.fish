...
set -l color01 "ed/4a/46" # Base 08 - Red
set -l color02 "70/b4/33" # Base 0B - Green
set -l color03 "db/b3/2d" # Base 0A - Yellow
set -l color04 "36/8a/eb" # Base 0D - Blue
set -l color05 "a5/80/e2" # Base 0E - Magenta
set -l color06 "3f/c5/b7" # Base 0C - Cyan
set -l color07 "b9/b9/b9" # Base 05 - White
set -l color08 "77/77/77" # Base 03 - Bright Black
...
set -l color15 "de/de/de" # Base 07 - Bright White
set -l color16 "e6/7f/43" # Base 09
set -l color17 "eb/6e/b7" # Base 0F
set -l color18 "25/25/25" # Base 01
set -l color19 "3b/3b/3b" # Base 02
set -l color20 "77/77/77" # Base 04
set -l color21 "de/de/de" # Base 06
set -l color_foreground "b9/b9/b9" # Base 05
...
set -U fish_color_end b9b9b9
set -U fish_color_error brred
set -U fish_color_param 777777
set -U fish_color_valid_path --underline
set -U fish_color_option brcyan
set -U fish_color_comment 777777
set -U fish_color_selection dedede --bold --background=3b3b3b
...
set -U fish_color_search_match bryellow --background=3b3b3b
set -U fish_color_history_current --bold
set -U fish_pager_color_progress 252525 --background=777777
set -U fish_pager_color_background normal --background=181818
set -U fish_pager_color_prefix normal --bold
set -U fish_pager_color_completion normal
set -U fish_pager_color_description e67f43 --dim
set -U fish_pager_color_selected_background dedede --background=3b3b3b
set -U fish_pager_color_selected_prefix dedede --bold --background=3b3b3b
set -U fish_pager_color_selected_completion dedede
...
# Set theme
set -Ux BASE16_THEME selenized-black

# Optionally export variables
if test -n "$TINTED_SHELL_ENABLE_BASE16_VARS"; or test -n "$BASE16_SHELL_ENABLE_VARS"
  set -gx BASE16_COLOR_00_HEX "181818"
  set -gx BASE16_COLOR_01_HEX "252525"
  set -gx BASE16_COLOR_02_HEX "3b3b3b"
  set -gx BASE16_COLOR_03_HEX "777777"
  set -gx BASE16_COLOR_04_HEX "777777"
  set -gx BASE16_COLOR_05_HEX "b9b9b9"
  set -gx BASE16_COLOR_06_HEX "dedede"
  set -gx BASE16_COLOR_07_HEX "dedede"
  set -gx BASE16_COLOR_08_HEX "ed4a46"
  set -gx BASE16_COLOR_09_HEX "e67f43"
  set -gx BASE16_COLOR_0A_HEX "dbb32d"
  set -gx BASE16_COLOR_0B_HEX "70b433"
  set -gx BASE16_COLOR_0C_HEX "3fc5b7"
  set -gx BASE16_COLOR_0D_HEX "368aeb"
  set -gx BASE16_COLOR_0E_HEX "a580e2"
  set -gx BASE16_COLOR_0F_HEX "eb6eb7"
end
