...
set -l color01 "80/00/00" # Base 08 - Red
set -l color02 "00/80/00" # Base 0B - Green
set -l color03 "80/80/00" # Base 0A - Yellow
set -l color04 "00/00/80" # Base 0D - Blue
set -l color05 "80/00/80" # Base 0E - Magenta
set -l color06 "00/80/80" # Base 0C - Cyan
...
set -U fish_color_selection 2a2a2a --bold --background=d4d4d4
...
set -U fish_pager_color_progress e8e8e8 --background=7e7e7e
...
set -U fish_pager_color_selected_background 2a2a2a --background=d4d4d4
set -U fish_pager_color_selected_prefix 2a2a2a --bold --background=d4d4d4
...
# Set theme
set -Ux BASE16_THEME windows-highcontrast-light
...
if test -n "$TINTED_SHELL_ENABLE_BASE16_VARS"; or test -n "$BASE16_SHELL_ENABLE_VARS"
  ...
  set -gx BASE16_COLOR_08_HEX "800000"
  set -gx BASE16_COLOR_09_HEX "fcfc54"
  set -gx BASE16_COLOR_0A_HEX "808000"
  set -gx BASE16_COLOR_0B_HEX "008000"
  set -gx BASE16_COLOR_0C_HEX "008080"
  set -gx BASE16_COLOR_0D_HEX "000080"
  set -gx BASE16_COLOR_0E_HEX "800080"
