...
set -U fish_pager_color_background normal --background=2e3436
set -U fish_pager_color_prefix normal --bold
set -U fish_pager_color_completion normal
set -U fish_pager_color_description ef2929 --dim
set -U fish_pager_color_selected_background ad7fa8 --background=fce94f
set -U fish_pager_color_selected_prefix ad7fa8 --bold --background=fce94f
set -U fish_pager_color_selected_completion ad7fa8
