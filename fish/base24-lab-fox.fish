...
set -l color00 "2e/2e/2e" # Base 00 - Black
set -l color01 "fc/6d/26" # Base 08 - Red
set -l color02 "3e/b3/83" # Base 0B - Green
set -l color03 "db/50/1f" # Base 0A - Yellow
set -l color04 "db/3b/21" # Base 0D - Blue
set -l color05 "38/0d/75" # Base 0E - Magenta
set -l color06 "6e/49/cb" # Base 0C - Cyan
set -l color07 "cf/d0/d0" # Base 05 - White
...
set -l color16 "fc/a1/21" # Base 09
set -l color17 "7e/36/13" # Base 0F
set -l color18 "2e/2e/2e" # Base 01
set -l color19 "45/45/45" # Base 02
set -l color20 "a1/a2/a2" # Base 04
set -l color21 "fe/ff/ff" # Base 06
set -l color_foreground "cf/d0/d0" # Base 05
set -l color_background "2e/2e/2e" # Base 00
...
set -U fish_color_end cfd0d0
set -U fish_color_error brred
set -U fish_color_param a1a2a2
set -U fish_color_valid_path --underline
set -U fish_color_option brcyan
set -U fish_color_comment 737373
set -U fish_color_selection feffff --bold --background=454545
...
set -U fish_pager_color_progress 2e2e2e --background=a1a2a2
set -U fish_pager_color_background normal --background=2e2e2e
set -U fish_pager_color_prefix normal --bold
set -U fish_pager_color_completion normal
set -U fish_pager_color_description fca121 --dim
set -U fish_pager_color_selected_background feffff --background=454545
set -U fish_pager_color_selected_prefix feffff --bold --background=454545
set -U fish_pager_color_selected_completion feffff
...
# Set theme
set -Ux BASE24_THEME lab-fox

# Optionally export variables
if test -n "$TINTED_SHELL_ENABLE_BASE24_VARS"; or test -n "$BASE24_SHELL_ENABLE_VARS"
  set -gx BASE24_COLOR_00_HEX "2e2e2e"
  set -gx BASE24_COLOR_01_HEX "2e2e2e"
  set -gx BASE24_COLOR_02_HEX "454545"
  set -gx BASE24_COLOR_03_HEX "737373"
  set -gx BASE24_COLOR_04_HEX "a1a2a2"
  set -gx BASE24_COLOR_05_HEX "cfd0d0"
  set -gx BASE24_COLOR_06_HEX "feffff"
  set -gx BASE24_COLOR_07_HEX "feffff"
  set -gx BASE24_COLOR_08_HEX "fc6d26"
  set -gx BASE24_COLOR_09_HEX "fca121"
  set -gx BASE24_COLOR_0A_HEX "db501f"
  set -gx BASE24_COLOR_0B_HEX "3eb383"
  set -gx BASE24_COLOR_0C_HEX "6e49cb"
  set -gx BASE24_COLOR_0D_HEX "db3b21"
  set -gx BASE24_COLOR_0E_HEX "380d75"
  set -gx BASE24_COLOR_0F_HEX "7e3613"
end
