...
set -U fish_color_selection feffff --background=454545
set -U fish_color_operator magenta
set -U fish_color_escape fca121
...
set -U fish_color_search_match yellow --background=454545
set -U fish_color_history_current --underline=curly
set -U fish_pager_color_progress 2e2e2e --background=a1a2a2
set -U fish_pager_color_background --background=2e2e2e
set -U fish_pager_color_prefix --bold --italics
set -U fish_pager_color_completion normal
set -U fish_pager_color_description fca121
set -U fish_pager_color_selected_background --background=454545
set -U fish_pager_color_selected_prefix --bold --italics --background=454545
