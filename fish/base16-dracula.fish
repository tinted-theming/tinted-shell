...
set -U fish_color_param 9ea8c7
set -U fish_color_valid_path --underline
set -U fish_color_option brcyan
set -U fish_color_comment 6272a4
set -U fish_color_selection f8f8f2 --bold --background=44475a
...
set -U fish_color_search_match bryellow --background=44475a
...
set -U fish_pager_color_description ffb86c --dim
set -U fish_pager_color_selected_background f8f8f2 --background=44475a
set -U fish_pager_color_selected_prefix f8f8f2 --bold --background=44475a
...
# Set theme
set -Ux BASE16_THEME dracula

# Optionally export variables
if test -n "$TINTED_SHELL_ENABLE_BASE16_VARS"; or test -n "$BASE16_SHELL_ENABLE_VARS"
  set -gx BASE16_COLOR_00_HEX "282a36"
  set -gx BASE16_COLOR_01_HEX "21222c"
  set -gx BASE16_COLOR_02_HEX "44475a"
  set -gx BASE16_COLOR_03_HEX "6272a4"
  set -gx BASE16_COLOR_04_HEX "9ea8c7"
  set -gx BASE16_COLOR_05_HEX "f8f8f2"
  set -gx BASE16_COLOR_06_HEX "f8f8f2"
  set -gx BASE16_COLOR_07_HEX "ffffff"
  set -gx BASE16_COLOR_08_HEX "ff5555"
  set -gx BASE16_COLOR_09_HEX "ffb86c"
  set -gx BASE16_COLOR_0A_HEX "f1fa8c"
  set -gx BASE16_COLOR_0B_HEX "50fa7b"
  set -gx BASE16_COLOR_0C_HEX "8be9fd"
  set -gx BASE16_COLOR_0D_HEX "bd93f9"
  set -gx BASE16_COLOR_0E_HEX "ff79c6"
  set -gx BASE16_COLOR_0F_HEX "993333"
end
